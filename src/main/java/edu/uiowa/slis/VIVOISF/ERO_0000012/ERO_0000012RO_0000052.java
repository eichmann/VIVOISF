...
public class ERO_0000012RO_0000052 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000012RO_0000052 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000012RO_0000052.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000012RO_0000052Iterator.getRO_0000052());
		} catch (Exception e) {
