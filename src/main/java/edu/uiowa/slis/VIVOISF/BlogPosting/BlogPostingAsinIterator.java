...
public class BlogPostingAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingAsinIterator.class);
