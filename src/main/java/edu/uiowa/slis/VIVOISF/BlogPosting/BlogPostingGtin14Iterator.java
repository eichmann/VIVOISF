...
public class BlogPostingGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingGtin14Iterator.class);
