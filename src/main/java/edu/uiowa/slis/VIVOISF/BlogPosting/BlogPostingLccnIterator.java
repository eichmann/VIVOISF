...
public class BlogPostingLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingLccnIterator.class);
