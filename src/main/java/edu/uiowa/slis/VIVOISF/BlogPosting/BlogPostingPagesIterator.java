...
public class BlogPostingPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingPagesIterator.class);
