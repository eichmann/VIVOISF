...
public class BlogPostingDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingDoiIterator.class);
