...
public class BlogPostingNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingNumPagesIterator.class);
