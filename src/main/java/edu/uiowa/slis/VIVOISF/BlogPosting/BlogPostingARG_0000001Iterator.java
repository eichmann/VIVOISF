...
public class BlogPostingARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingARG_0000001Iterator.class);
