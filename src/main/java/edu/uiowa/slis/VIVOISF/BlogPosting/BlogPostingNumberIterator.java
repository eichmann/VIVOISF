...
public class BlogPostingNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingNumberIterator.class);
