...
public class BlogPostingUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingUriIterator.class);
