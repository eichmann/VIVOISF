...
public class BlogPostingProducerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingProducerType currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingProducerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogPostingProducerIterator.getType());
		} catch (Exception e) {
