...
public class BlogPostingSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingSectionIterator.class);
