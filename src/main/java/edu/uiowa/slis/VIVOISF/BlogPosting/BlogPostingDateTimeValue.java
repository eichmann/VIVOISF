...
public class BlogPostingDateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingDateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingDateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogPostingDateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
