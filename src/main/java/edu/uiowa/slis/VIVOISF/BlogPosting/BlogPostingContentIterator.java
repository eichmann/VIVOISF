...
public class BlogPostingContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingContentIterator.class);
