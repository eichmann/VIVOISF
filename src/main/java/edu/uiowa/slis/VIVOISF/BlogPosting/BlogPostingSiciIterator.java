...
public class BlogPostingSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingSiciIterator.class);
