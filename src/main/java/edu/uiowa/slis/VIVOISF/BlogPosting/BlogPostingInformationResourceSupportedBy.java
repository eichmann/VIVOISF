...
public class BlogPostingInformationResourceSupportedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingInformationResourceSupportedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingInformationResourceSupportedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogPostingInformationResourceSupportedByIterator.getInformationResourceSupportedBy());
		} catch (Exception e) {
