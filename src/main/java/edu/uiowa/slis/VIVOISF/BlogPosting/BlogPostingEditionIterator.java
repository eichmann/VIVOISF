...
public class BlogPostingEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingEditionIterator.class);
