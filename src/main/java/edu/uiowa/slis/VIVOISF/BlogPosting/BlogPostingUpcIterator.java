...
public class BlogPostingUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingUpcIterator.class);
