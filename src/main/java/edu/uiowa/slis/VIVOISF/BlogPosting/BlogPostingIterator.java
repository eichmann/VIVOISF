...
public class BlogPostingIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#BlogPosting> . "+
