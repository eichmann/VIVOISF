...
public class BlogPostingDistributorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingDistributorType currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingDistributorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogPostingDistributorIterator.getType());
		} catch (Exception e) {
