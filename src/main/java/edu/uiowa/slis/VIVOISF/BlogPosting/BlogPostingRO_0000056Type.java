...
public class BlogPostingRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogPostingRO_0000056Iterator.getType());
		} catch (Exception e) {
