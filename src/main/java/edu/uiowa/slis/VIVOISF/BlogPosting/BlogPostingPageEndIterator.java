...
public class BlogPostingPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingPageEndIterator.class);
