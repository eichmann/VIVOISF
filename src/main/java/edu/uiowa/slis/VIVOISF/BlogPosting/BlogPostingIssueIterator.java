...
public class BlogPostingIssueIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingIssueIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingIssueIterator.class);
