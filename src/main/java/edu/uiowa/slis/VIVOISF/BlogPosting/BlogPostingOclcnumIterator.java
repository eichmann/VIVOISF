...
public class BlogPostingOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingOclcnumIterator.class);
