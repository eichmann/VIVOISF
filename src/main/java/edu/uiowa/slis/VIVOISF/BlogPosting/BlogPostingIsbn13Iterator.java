...
public class BlogPostingIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingIsbn13Iterator.class);
