...
public class BlogPostingShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingShortDescriptionIterator.class);
