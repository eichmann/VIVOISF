...
public class BlogPostingPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingPmidIterator.class);
