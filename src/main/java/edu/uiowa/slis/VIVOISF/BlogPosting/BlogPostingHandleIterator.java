...
public class BlogPostingHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingHandleIterator.class);
