...
public class BlogPostingTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingTheAbstractIterator.class);
