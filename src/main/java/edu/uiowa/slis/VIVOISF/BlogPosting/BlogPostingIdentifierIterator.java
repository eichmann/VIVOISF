...
public class BlogPostingIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingIdentifierIterator.class);
