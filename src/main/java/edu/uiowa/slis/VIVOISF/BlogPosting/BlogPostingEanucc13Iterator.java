...
public class BlogPostingEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingEanucc13Iterator.class);
