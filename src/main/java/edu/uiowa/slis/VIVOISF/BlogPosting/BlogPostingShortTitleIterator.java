...
public class BlogPostingShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingShortTitleIterator.class);
