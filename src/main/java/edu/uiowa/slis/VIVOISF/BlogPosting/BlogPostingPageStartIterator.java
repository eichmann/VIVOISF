...
public class BlogPostingPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingPageStartIterator.class);
