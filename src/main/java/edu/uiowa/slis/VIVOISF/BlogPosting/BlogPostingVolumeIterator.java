...
public class BlogPostingVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingVolumeIterator.class);
