...
public class BlogPostingIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPostingIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPostingIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogPostingIAO_0000136Iterator.getType());
		} catch (Exception e) {
