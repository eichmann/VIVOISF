...
public class ERO_0000071RO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000071RO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000071RO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000071RO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
