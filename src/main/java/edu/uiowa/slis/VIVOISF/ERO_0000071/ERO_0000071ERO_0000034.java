...
public class ERO_0000071ERO_0000034 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000071ERO_0000034 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000071ERO_0000034.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000071ERO_0000034Iterator.getERO_0000034());
		} catch (Exception e) {
