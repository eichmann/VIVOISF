...
public class ERO_0000071OBI_0000304 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000071OBI_0000304 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000071OBI_0000304.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000071OBI_0000304Iterator.getOBI_0000304());
		} catch (Exception e) {
