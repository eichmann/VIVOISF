...
public class ERO_0000071ERO_0000482Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000071ERO_0000482Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000071ERO_0000482Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000071ERO_0000482InverseIterator.getERO_0000482Inverse());
		} catch (Exception e) {
