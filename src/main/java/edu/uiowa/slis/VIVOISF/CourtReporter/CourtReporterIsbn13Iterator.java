...
public class CourtReporterIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterIsbn13Iterator.class);
