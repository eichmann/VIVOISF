...
public class CourtReporterUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterUpcIterator.class);
