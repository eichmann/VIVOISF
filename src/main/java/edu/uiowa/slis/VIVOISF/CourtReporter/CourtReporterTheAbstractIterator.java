...
public class CourtReporterTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterTheAbstractIterator.class);
