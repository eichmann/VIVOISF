...
public class CourtReporterRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCourtReporterRO_0000056Iterator.getType());
		} catch (Exception e) {
