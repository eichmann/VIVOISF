...
public class CourtReporterEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterEanucc13Iterator.class);
