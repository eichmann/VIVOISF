...
public class CourtReporterIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/CourtReporter> . "+
