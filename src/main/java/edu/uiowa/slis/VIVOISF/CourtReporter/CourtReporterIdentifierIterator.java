...
public class CourtReporterIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterIdentifierIterator.class);
