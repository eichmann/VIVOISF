...
public class CourtReporterCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterCodenIterator.class);
