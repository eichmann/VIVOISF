...
public class CourtReporterIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterIsbn10Iterator.class);
