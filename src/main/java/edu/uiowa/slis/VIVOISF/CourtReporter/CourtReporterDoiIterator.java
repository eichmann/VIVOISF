...
public class CourtReporterDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterDoiIterator.class);
