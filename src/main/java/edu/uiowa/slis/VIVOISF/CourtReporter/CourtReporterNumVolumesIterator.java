...
public class CourtReporterNumVolumesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterNumVolumesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterNumVolumesIterator.class);
