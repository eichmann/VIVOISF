...
public class CourtReporterIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCourtReporterIAO_0000136Iterator.getType());
		} catch (Exception e) {
