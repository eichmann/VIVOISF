...
public class CourtReporterLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterLccnIterator.class);
