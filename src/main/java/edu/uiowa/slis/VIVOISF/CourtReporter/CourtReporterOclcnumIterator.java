...
public class CourtReporterOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterOclcnumIterator.class);
