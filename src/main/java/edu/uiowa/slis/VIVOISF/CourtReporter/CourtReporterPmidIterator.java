...
public class CourtReporterPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterPmidIterator.class);
