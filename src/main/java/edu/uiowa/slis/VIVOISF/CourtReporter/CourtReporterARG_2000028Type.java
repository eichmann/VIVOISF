...
public class CourtReporterARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCourtReporterARG_2000028Iterator.getType());
		} catch (Exception e) {
