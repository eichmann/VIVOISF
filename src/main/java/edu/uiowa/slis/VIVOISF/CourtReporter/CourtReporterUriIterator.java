...
public class CourtReporterUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourtReporterUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourtReporterUriIterator.class);
