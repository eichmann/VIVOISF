...
public class ObjectPropertyTerm_statusIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ObjectPropertyTerm_statusIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyTerm_statusIterator.class);
