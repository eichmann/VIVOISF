...
public class ObjectPropertySourceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ObjectPropertySourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertySourceIterator.class);
