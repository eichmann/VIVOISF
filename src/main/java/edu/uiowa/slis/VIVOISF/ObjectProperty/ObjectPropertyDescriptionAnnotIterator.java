...
public class ObjectPropertyDescriptionAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ObjectPropertyDescriptionAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyDescriptionAnnotIterator.class);
