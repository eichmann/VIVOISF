...
public class ObjectPropertyDisplayLimitAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ObjectPropertyDisplayLimitAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyDisplayLimitAnnotIterator.class);
