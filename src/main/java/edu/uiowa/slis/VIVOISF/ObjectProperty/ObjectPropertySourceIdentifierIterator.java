...
public class ObjectPropertySourceIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ObjectPropertySourceIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertySourceIdentifierIterator.class);
