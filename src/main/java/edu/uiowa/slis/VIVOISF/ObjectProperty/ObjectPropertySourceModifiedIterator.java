...
public class ObjectPropertySourceModifiedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ObjectPropertySourceModifiedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertySourceModifiedIterator.class);
