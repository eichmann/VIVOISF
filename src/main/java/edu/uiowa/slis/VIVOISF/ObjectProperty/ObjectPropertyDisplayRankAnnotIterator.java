...
public class ObjectPropertyDisplayRankAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ObjectPropertyDisplayRankAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyDisplayRankAnnotIterator.class);
