...
public class ObjectPropertyIAO_0000232Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ObjectPropertyIAO_0000232Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyIAO_0000232Iterator.class);

	static boolean firstInstance = false;
	static boolean lastInstance = false;

	String subjectURI = null;
	String IAO_0000232 = null;
	ResultSet rs = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://purl.obolibrary.org/obo/IAO_0000232> ?s } ");
			if(rs.hasNext()) {
				QuerySolution sol = rs.nextSolution();
				IAO_0000232 = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setIAO_0000232(String theIAO_0000232) {
		IAO_0000232 = theIAO_0000232;
	}

	public String getIAO_0000232() {
		return IAO_0000232;
	}
