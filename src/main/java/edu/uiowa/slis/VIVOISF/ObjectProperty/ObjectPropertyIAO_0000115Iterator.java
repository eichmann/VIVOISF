...
public class ObjectPropertyIAO_0000115Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ObjectPropertyIAO_0000115Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyIAO_0000115Iterator.class);
