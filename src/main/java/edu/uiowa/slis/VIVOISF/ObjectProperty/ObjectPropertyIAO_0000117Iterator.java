...
public class ObjectPropertyIAO_0000117Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ObjectPropertyIAO_0000117Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ObjectPropertyIAO_0000117Iterator.class);
