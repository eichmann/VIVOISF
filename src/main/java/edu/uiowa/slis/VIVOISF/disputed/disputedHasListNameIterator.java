...
public class disputedHasListNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static disputedHasListNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(disputedHasListNameIterator.class);
