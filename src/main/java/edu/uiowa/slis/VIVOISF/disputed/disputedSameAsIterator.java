...
public class disputedSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static disputedSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(disputedSameAsIterator.class);
