...
public class disputedHasCoordinateIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static disputedHasCoordinateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(disputedHasCoordinateIterator.class);
