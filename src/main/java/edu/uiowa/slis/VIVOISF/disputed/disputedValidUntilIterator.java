...
public class disputedValidUntilIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static disputedValidUntilIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(disputedValidUntilIterator.class);
