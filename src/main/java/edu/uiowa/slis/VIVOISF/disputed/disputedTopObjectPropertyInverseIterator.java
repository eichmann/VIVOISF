...
public class disputedTopObjectPropertyInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static disputedTopObjectPropertyInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(disputedTopObjectPropertyInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in disputedTopObjectPropertyInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in disputedTopObjectPropertyInverseIterator doStartTag");
		}
