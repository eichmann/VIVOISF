...
public class disputedHasCodeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static disputedHasCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(disputedHasCodeIterator.class);
