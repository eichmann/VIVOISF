...
public class disputedValidSinceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static disputedValidSinceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(disputedValidSinceIterator.class);
