...
public class IAO_0000102FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000102FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000102FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000102FeaturesIterator.getType());
		} catch (Exception e) {
