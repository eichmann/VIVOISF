...
public class IAO_0000102RO_0000056 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000102RO_0000056 currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000102RO_0000056.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000102RO_0000056Iterator.getRO_0000056());
		} catch (Exception e) {
