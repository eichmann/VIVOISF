...
public class GraduateAdvisingRelationshipRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GraduateAdvisingRelationshipRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GraduateAdvisingRelationshipRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGraduateAdvisingRelationshipRO_0000052Iterator.getType());
		} catch (Exception e) {
