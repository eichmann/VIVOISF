...
public class NewspaperPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperPmidIterator.class);
