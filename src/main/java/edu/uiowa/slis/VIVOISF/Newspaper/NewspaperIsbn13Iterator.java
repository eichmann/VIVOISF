...
public class NewspaperIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperIsbn13Iterator.class);
