...
public class NewspaperUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperUriIterator.class);
