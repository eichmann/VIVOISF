...
public class NewspaperIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewspaperIAO_0000136Iterator.getType());
		} catch (Exception e) {
