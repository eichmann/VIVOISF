...
public class NewspaperDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperDoiIterator.class);
