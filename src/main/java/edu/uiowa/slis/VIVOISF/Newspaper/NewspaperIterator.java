...
public class NewspaperIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/Newspaper> . "+
