...
public class NewspaperGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperGtin14Iterator.class);
