...
public class NewspaperHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperHandleIterator.class);
