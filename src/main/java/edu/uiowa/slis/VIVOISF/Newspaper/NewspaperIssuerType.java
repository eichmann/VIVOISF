...
public class NewspaperIssuerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperIssuerType currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperIssuerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewspaperIssuerIterator.getType());
		} catch (Exception e) {
