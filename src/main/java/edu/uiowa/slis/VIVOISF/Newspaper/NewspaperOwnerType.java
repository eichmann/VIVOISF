...
public class NewspaperOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewspaperOwnerIterator.getType());
		} catch (Exception e) {
