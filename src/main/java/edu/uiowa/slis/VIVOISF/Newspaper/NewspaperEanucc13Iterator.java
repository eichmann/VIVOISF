...
public class NewspaperEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperEanucc13Iterator.class);
