...
public class NewspaperTranslator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperTranslator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperTranslator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewspaperTranslatorIterator.getTranslator());
		} catch (Exception e) {
