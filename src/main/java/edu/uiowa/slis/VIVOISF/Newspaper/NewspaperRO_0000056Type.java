...
public class NewspaperRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewspaperRO_0000056Iterator.getType());
		} catch (Exception e) {
