...
public class NewspaperSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperSiciIterator.class);
