...
public class NewspaperUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperUpcIterator.class);
