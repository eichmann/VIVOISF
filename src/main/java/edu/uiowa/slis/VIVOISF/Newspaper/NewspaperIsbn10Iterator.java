...
public class NewspaperIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperIsbn10Iterator.class);
