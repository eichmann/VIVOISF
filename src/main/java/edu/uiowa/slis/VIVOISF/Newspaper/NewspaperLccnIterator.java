...
public class NewspaperLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperLccnIterator.class);
