...
public class NewspaperCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperCodenIterator.class);
