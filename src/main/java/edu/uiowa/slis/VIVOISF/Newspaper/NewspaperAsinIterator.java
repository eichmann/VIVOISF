...
public class NewspaperAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewspaperAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewspaperAsinIterator.class);
