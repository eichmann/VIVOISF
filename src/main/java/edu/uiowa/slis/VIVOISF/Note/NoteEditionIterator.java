...
public class NoteEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteEditionIterator.class);
