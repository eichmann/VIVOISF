...
public class NoteDocumentationFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteDocumentationFor currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteDocumentationFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNoteDocumentationForIterator.getDocumentationFor());
		} catch (Exception e) {
