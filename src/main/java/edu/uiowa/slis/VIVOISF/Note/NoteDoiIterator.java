...
public class NoteDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteDoiIterator.class);
