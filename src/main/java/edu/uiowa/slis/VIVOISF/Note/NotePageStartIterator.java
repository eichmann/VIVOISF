...
public class NotePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NotePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotePageStartIterator.class);
