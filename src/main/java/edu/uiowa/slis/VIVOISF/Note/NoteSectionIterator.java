...
public class NoteSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteSectionIterator.class);
