...
public class NoteTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteTheAbstractIterator.class);
