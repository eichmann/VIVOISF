...
public class NoteGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteGtin14Iterator.class);
