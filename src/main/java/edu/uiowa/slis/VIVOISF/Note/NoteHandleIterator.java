...
public class NoteHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteHandleIterator.class);
