...
public class NoteIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNoteIAO_0000136Iterator.getType());
		} catch (Exception e) {
