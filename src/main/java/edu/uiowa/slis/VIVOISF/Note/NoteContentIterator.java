...
public class NoteContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteContentIterator.class);
