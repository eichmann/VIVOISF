...
public class NoteUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteUpcIterator.class);
