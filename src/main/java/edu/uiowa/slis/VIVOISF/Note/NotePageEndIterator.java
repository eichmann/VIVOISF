...
public class NotePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NotePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NotePageEndIterator.class);
