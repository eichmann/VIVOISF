...
public class NoteSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteSiciIterator.class);
