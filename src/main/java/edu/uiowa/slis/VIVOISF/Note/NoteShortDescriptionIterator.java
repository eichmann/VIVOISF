...
public class NoteShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteShortDescriptionIterator.class);
