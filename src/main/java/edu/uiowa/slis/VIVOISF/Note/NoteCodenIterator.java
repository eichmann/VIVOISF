...
public class NoteCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteCodenIterator.class);
