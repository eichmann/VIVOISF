...
public class NoteIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.w3.org/2006/vcard/ns#Note> . "+
