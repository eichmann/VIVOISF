...
public class NoteReproduces extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteReproduces currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteReproduces.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNoteReproducesIterator.getReproduces());
		} catch (Exception e) {
