...
public class NoteNoteIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteNoteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteNoteIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://www.w3.org/2006/vcard/ns#note> ?s } ");
			if(rs.hasNext()) {
