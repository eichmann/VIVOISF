...
public class NoteEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteEanucc13Iterator.class);
