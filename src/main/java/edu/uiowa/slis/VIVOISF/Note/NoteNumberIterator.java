...
public class NoteNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteNumberIterator.class);
