...
public class NoteARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteARG_0000001Iterator.class);
