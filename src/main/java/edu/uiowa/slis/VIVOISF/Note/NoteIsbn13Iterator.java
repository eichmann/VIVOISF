...
public class NoteIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteIsbn13Iterator.class);
