...
public class NoteNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteNumPagesIterator.class);
