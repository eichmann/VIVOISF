...
public class NoteShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteShortTitleIterator.class);
