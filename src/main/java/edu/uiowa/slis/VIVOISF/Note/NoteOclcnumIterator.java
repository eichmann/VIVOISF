...
public class NoteOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteOclcnumIterator.class);
