...
public class NoteVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteVolumeIterator.class);
