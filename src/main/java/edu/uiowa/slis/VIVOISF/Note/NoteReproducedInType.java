...
public class NoteReproducedInType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteReproducedInType currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteReproducedInType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNoteReproducedInIterator.getType());
		} catch (Exception e) {
