...
public class NoteLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteLccnIterator.class);
