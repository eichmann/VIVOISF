...
public class NoteLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteLocatorIterator.class);
