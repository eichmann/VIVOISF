...
public class NoteUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteUriIterator.class);
