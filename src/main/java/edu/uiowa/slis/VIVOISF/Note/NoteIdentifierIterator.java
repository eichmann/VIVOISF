...
public class NoteIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NoteIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NoteIdentifierIterator.class);
