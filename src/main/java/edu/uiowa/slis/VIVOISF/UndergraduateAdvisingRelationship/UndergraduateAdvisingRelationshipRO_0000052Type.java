...
public class UndergraduateAdvisingRelationshipRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateAdvisingRelationshipRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateAdvisingRelationshipRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUndergraduateAdvisingRelationshipRO_0000052Iterator.getType());
		} catch (Exception e) {
