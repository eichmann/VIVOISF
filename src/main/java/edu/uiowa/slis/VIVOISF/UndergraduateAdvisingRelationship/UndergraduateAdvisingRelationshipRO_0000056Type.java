...
public class UndergraduateAdvisingRelationshipRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateAdvisingRelationshipRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateAdvisingRelationshipRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUndergraduateAdvisingRelationshipRO_0000056Iterator.getType());
		} catch (Exception e) {
