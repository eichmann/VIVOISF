...
public class NewsletterRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewsletterRO_0002353Iterator.getType());
		} catch (Exception e) {
