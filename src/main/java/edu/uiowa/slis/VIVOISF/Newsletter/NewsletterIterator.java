...
public class NewsletterIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Newsletter> . "+
