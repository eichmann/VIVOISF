...
public class NewsletterLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterLccnIterator.class);
