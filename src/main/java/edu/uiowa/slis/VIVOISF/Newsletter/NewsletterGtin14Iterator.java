...
public class NewsletterGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterGtin14Iterator.class);
