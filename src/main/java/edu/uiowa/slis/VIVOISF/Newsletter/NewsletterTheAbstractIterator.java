...
public class NewsletterTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterTheAbstractIterator.class);
