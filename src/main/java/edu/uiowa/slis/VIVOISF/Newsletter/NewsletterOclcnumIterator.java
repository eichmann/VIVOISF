...
public class NewsletterOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterOclcnumIterator.class);
