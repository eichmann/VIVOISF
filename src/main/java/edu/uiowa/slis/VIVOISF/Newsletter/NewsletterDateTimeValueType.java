...
public class NewsletterDateTimeValueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterDateTimeValueType currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterDateTimeValueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewsletterDateTimeValueIterator.getType());
		} catch (Exception e) {
