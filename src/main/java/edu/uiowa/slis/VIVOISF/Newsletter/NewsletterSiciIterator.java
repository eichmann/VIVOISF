...
public class NewsletterSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterSiciIterator.class);
