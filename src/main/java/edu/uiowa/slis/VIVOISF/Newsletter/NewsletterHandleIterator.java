...
public class NewsletterHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterHandleIterator.class);
