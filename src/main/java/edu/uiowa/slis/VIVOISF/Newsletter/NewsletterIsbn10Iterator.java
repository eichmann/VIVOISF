...
public class NewsletterIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterIsbn10Iterator.class);
