...
public class NewsletterEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterEanucc13Iterator.class);
