...
public class NewsletterIssnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterIssnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterIssnIterator.class);
