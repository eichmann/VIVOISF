...
public class NewsletterIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewsletterIAO_0000136Iterator.getType());
		} catch (Exception e) {
