...
public class NewsletterNumVolumesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterNumVolumesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterNumVolumesIterator.class);
