...
public class NewsletterEissnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterEissnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterEissnIterator.class);
