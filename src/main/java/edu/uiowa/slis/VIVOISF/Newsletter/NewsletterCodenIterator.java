...
public class NewsletterCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterCodenIterator.class);
