...
public class NewsletterAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterAsinIterator.class);
