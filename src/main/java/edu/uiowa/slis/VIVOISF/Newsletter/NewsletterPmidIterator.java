...
public class NewsletterPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterPmidIterator.class);
