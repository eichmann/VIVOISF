...
public class NewsletterUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterUpcIterator.class);
