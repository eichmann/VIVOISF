...
public class NewsletterUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterUriIterator.class);
