...
public class NewsletterIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsletterIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsletterIsbn13Iterator.class);
