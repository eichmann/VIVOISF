...
public class SynonymTypeIAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SynonymTypeIAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(SynonymTypeIAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSynonymTypeIAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
