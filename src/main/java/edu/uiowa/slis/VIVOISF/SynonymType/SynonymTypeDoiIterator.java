...
public class SynonymTypeDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SynonymTypeDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SynonymTypeDoiIterator.class);
