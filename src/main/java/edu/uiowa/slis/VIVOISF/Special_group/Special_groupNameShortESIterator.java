...
public class Special_groupNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Special_groupNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Special_groupNameShortESIterator.class);
