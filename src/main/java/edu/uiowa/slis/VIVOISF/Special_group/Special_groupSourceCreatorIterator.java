...
public class Special_groupSourceCreatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Special_groupSourceCreatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Special_groupSourceCreatorIterator.class);
