...
public class Special_groupNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Special_groupNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Special_groupNameOfficialRUIterator.class);
