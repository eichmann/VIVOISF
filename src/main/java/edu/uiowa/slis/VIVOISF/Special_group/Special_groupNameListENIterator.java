...
public class Special_groupNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Special_groupNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Special_groupNameListENIterator.class);
