...
public class Special_groupSourceModifiedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Special_groupSourceModifiedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Special_groupSourceModifiedIterator.class);
