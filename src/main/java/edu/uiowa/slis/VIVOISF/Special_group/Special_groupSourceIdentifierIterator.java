...
public class Special_groupSourceIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Special_groupSourceIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Special_groupSourceIdentifierIterator.class);
