...
public class Special_groupCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Special_groupCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Special_groupCodeAGROVOCIterator.class);
