...
public class Special_groupNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Special_groupNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Special_groupNameOfficialZHIterator.class);
