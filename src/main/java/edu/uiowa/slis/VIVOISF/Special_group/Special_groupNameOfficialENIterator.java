...
public class Special_groupNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Special_groupNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Special_groupNameOfficialENIterator.class);
