...
public class Special_groupNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Special_groupNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Special_groupNameShortZHIterator.class);
