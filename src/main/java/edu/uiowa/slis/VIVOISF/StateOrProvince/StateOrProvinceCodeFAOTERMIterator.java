...
public class StateOrProvinceCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCodeFAOTERMIterator.class);
