...
public class StateOrProvinceHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceHasMinLatitudeIterator.class);
