...
public class StateOrProvinceCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCodeCurrencyIterator.class);
