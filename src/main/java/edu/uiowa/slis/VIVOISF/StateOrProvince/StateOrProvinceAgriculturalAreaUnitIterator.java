...
public class StateOrProvinceAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceAgriculturalAreaUnitIterator.class);
