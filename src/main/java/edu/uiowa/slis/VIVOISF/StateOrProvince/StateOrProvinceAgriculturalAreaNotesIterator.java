...
public class StateOrProvinceAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceAgriculturalAreaNotesIterator.class);
