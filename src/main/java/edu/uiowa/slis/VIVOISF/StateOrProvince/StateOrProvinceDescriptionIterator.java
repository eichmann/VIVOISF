...
public class StateOrProvinceDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceDescriptionIterator.class);
