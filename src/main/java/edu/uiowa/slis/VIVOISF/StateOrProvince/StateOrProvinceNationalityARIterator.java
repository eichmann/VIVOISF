...
public class StateOrProvinceNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNationalityARIterator.class);
