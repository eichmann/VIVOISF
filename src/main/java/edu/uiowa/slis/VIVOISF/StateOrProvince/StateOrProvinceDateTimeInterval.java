...
public class StateOrProvinceDateTimeInterval extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceDateTimeInterval currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceDateTimeInterval.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStateOrProvinceDateTimeIntervalIterator.getDateTimeInterval());
		} catch (Exception e) {
