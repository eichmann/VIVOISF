...
public class StateOrProvinceGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceGDPUnitIterator.class);
