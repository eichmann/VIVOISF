...
public class StateOrProvinceAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceAgriculturalAreaYearIterator.class);
