...
public class StateOrProvinceCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCodeDBPediaIDIterator.class);
