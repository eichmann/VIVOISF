...
public class StateOrProvinceCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCountryAreaNotesIterator.class);
