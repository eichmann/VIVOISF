...
public class StateOrProvincePopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvincePopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvincePopulationTotalIterator.class);
