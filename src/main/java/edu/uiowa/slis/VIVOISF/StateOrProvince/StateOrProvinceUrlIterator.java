...
public class StateOrProvinceUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceUrlIterator.class);
