...
public class StateOrProvinceNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameShortENIterator.class);
