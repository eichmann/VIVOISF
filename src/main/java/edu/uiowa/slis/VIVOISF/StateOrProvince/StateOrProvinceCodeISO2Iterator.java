...
public class StateOrProvinceCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCodeISO2Iterator.class);
