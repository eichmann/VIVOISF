...
public class StateOrProvinceRO_0002234 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceRO_0002234 currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceRO_0002234.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStateOrProvinceRO_0002234Iterator.getRO_0002234());
		} catch (Exception e) {
