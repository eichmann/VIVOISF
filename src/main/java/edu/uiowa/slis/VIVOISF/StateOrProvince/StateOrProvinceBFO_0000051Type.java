...
public class StateOrProvinceBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStateOrProvinceBFO_0000051Iterator.getType());
		} catch (Exception e) {
