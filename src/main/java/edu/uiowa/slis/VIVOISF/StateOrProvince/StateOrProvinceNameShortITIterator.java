...
public class StateOrProvinceNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameShortITIterator.class);
