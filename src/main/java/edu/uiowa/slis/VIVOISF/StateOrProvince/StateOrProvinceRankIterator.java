...
public class StateOrProvinceRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceRankIterator.class);
