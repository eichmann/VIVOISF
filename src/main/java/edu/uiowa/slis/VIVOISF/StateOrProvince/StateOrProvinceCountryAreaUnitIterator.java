...
public class StateOrProvinceCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCountryAreaUnitIterator.class);
