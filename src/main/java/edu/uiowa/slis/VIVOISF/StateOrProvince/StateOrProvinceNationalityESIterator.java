...
public class StateOrProvinceNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNationalityESIterator.class);
