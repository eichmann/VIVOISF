...
public class StateOrProvinceHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceHasMinLongitudeIterator.class);
