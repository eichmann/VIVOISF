...
public class StateOrProvinceLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceLandAreaUnitIterator.class);
