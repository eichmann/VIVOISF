...
public class StateOrProvinceHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceHasMaxLongitudeIterator.class);
