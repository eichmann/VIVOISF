...
public class StateOrProvinceNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameListENIterator.class);
