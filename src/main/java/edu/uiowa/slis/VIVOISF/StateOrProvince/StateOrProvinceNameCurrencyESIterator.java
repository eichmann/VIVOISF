...
public class StateOrProvinceNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameCurrencyESIterator.class);
