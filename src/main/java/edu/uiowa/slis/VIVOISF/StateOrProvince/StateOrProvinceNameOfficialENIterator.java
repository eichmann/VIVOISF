...
public class StateOrProvinceNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameOfficialENIterator.class);
