...
public class StateOrProvinceCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCodeFAOSTATIterator.class);
