...
public class StateOrProvinceARG_2000028 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceARG_2000028 currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceARG_2000028.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStateOrProvinceARG_2000028Iterator.getARG_2000028());
		} catch (Exception e) {
