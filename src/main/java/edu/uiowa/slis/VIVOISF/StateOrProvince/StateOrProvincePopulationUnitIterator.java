...
public class StateOrProvincePopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvincePopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvincePopulationUnitIterator.class);
