...
public class StateOrProvinceCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCountryAreaTotalIterator.class);
