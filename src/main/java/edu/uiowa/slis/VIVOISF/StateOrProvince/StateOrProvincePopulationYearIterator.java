...
public class StateOrProvincePopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvincePopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvincePopulationYearIterator.class);
