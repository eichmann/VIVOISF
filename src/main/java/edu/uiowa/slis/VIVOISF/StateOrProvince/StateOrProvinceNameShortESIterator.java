...
public class StateOrProvinceNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameShortESIterator.class);
