...
public class StateOrProvinceAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceAgriculturalAreaTotalIterator.class);
