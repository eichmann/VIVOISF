...
public class StateOrProvinceHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceHasMaxLatitudeIterator.class);
