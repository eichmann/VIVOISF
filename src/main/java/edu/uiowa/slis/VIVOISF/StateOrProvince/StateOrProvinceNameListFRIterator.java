...
public class StateOrProvinceNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameListFRIterator.class);
