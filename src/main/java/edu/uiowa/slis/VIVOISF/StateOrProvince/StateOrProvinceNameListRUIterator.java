...
public class StateOrProvinceNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameListRUIterator.class);
