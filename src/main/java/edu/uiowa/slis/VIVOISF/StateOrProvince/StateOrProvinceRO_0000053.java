...
public class StateOrProvinceRO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceRO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceRO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStateOrProvinceRO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
