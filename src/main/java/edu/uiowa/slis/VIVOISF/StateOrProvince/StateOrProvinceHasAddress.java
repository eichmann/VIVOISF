...
public class StateOrProvinceHasAddress extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceHasAddress currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceHasAddress.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStateOrProvinceHasAddressIterator.getHasAddress());
		} catch (Exception e) {
