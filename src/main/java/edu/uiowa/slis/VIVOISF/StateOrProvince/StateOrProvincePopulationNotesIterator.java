...
public class StateOrProvincePopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvincePopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvincePopulationNotesIterator.class);
