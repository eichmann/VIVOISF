...
public class StateOrProvinceNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameListITIterator.class);
