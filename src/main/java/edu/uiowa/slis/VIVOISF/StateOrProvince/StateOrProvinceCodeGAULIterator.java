...
public class StateOrProvinceCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCodeGAULIterator.class);
