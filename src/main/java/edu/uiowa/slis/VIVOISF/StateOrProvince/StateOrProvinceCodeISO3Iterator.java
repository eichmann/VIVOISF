...
public class StateOrProvinceCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCodeISO3Iterator.class);
