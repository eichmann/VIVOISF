...
public class StateOrProvinceNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameCurrencyZHIterator.class);
