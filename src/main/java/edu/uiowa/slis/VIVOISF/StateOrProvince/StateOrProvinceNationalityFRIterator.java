...
public class StateOrProvinceNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNationalityFRIterator.class);
