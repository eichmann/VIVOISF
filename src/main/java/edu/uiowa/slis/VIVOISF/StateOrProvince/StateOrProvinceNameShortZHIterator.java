...
public class StateOrProvinceNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameShortZHIterator.class);
