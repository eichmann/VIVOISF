...
public class StateOrProvinceGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceGDPNotesIterator.class);
