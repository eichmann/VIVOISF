...
public class StateOrProvinceLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceLandAreaNotesIterator.class);
