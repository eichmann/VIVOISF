...
public class StateOrProvinceCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCodeAGROVOCIterator.class);
