...
public class StateOrProvinceCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCountryAreaYearIterator.class);
