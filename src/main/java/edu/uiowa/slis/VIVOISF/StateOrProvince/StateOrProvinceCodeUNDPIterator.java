...
public class StateOrProvinceCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCodeUNDPIterator.class);
