...
public class StateOrProvinceNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameOfficialZHIterator.class);
