...
public class StateOrProvinceHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceHDITotalIterator.class);
