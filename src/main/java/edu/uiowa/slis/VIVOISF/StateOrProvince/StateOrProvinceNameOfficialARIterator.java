...
public class StateOrProvinceNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameOfficialARIterator.class);
