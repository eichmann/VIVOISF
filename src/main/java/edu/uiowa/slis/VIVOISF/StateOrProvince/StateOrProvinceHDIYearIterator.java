...
public class StateOrProvinceHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceHDIYearIterator.class);
