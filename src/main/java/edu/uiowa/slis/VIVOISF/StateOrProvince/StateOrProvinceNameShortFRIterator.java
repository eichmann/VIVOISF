...
public class StateOrProvinceNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameShortFRIterator.class);
