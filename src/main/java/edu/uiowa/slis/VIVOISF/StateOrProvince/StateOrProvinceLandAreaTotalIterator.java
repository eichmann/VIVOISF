...
public class StateOrProvinceLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceLandAreaTotalIterator.class);
