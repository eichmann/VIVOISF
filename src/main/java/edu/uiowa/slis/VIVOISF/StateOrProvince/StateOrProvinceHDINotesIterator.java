...
public class StateOrProvinceHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceHDINotesIterator.class);
