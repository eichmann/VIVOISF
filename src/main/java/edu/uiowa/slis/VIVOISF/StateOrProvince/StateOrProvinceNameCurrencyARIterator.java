...
public class StateOrProvinceNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameCurrencyARIterator.class);
