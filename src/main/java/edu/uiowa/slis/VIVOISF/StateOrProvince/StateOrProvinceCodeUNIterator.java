...
public class StateOrProvinceCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceCodeUNIterator.class);
