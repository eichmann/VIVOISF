...
public class StateOrProvincePublicationVenueForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvincePublicationVenueForType currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvincePublicationVenueForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStateOrProvincePublicationVenueForIterator.getType());
		} catch (Exception e) {
