...
public class StateOrProvinceNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameOfficialRUIterator.class);
