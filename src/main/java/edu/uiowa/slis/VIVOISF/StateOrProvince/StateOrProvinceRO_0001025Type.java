...
public class StateOrProvinceRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStateOrProvinceRO_0001025Iterator.getType());
		} catch (Exception e) {
