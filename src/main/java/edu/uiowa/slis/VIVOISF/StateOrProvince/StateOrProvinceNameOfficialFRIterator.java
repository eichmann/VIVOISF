...
public class StateOrProvinceNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameOfficialFRIterator.class);
