...
public class StateOrProvinceRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStateOrProvinceRO_0000056Iterator.getType());
		} catch (Exception e) {
