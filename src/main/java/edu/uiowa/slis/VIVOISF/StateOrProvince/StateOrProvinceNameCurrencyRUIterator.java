...
public class StateOrProvinceNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameCurrencyRUIterator.class);
