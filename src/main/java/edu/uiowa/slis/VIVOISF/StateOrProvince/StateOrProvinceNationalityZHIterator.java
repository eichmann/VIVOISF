...
public class StateOrProvinceNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNationalityZHIterator.class);
