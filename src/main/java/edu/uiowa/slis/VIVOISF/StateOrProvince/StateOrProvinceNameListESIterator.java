...
public class StateOrProvinceNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StateOrProvinceNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StateOrProvinceNameListESIterator.class);
