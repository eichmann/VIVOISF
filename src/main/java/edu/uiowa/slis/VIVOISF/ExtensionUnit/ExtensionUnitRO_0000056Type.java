...
public class ExtensionUnitRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExtensionUnitRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ExtensionUnitRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExtensionUnitRO_0000056Iterator.getType());
		} catch (Exception e) {
