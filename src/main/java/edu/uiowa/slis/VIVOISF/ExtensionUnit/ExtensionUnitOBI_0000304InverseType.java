...
public class ExtensionUnitOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExtensionUnitOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ExtensionUnitOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExtensionUnitOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
