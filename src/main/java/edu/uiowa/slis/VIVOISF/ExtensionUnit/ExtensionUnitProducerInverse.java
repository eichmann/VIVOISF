...
public class ExtensionUnitProducerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExtensionUnitProducerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ExtensionUnitProducerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExtensionUnitProducerInverseIterator.getProducerInverse());
		} catch (Exception e) {
