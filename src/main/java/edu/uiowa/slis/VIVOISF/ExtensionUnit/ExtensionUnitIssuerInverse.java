...
public class ExtensionUnitIssuerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExtensionUnitIssuerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ExtensionUnitIssuerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExtensionUnitIssuerInverseIterator.getIssuerInverse());
		} catch (Exception e) {
