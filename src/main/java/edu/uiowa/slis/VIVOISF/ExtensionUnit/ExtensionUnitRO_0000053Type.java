...
public class ExtensionUnitRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExtensionUnitRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ExtensionUnitRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExtensionUnitRO_0000053Iterator.getType());
		} catch (Exception e) {
