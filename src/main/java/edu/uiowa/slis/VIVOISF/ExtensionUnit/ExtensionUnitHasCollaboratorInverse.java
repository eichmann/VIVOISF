...
public class ExtensionUnitHasCollaboratorInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExtensionUnitHasCollaboratorInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ExtensionUnitHasCollaboratorInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExtensionUnitHasCollaboratorInverseIterator.getHasCollaboratorInverse());
		} catch (Exception e) {
