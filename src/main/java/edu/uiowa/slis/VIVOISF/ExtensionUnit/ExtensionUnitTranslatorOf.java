...
public class ExtensionUnitTranslatorOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExtensionUnitTranslatorOf currentInstance = null;
	private static final Log log = LogFactory.getLog(ExtensionUnitTranslatorOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExtensionUnitTranslatorOfIterator.getTranslatorOf());
		} catch (Exception e) {
