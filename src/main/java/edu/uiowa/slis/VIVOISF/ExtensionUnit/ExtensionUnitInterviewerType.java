...
public class ExtensionUnitInterviewerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExtensionUnitInterviewerType currentInstance = null;
	private static final Log log = LogFactory.getLog(ExtensionUnitInterviewerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExtensionUnitInterviewerIterator.getType());
		} catch (Exception e) {
