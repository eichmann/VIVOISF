...
public class ExtensionUnitERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExtensionUnitERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ExtensionUnitERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExtensionUnitERO_0000037Iterator.getType());
		} catch (Exception e) {
