...
public class SoundIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SoundIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SoundIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.w3.org/2006/vcard/ns#Sound> . "+
