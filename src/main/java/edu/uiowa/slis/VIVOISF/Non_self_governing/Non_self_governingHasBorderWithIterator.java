	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				hasBorderWith = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
	...
	public void setHasBorderWith(String theHasBorderWith) {
		hasBorderWith = theHasBorderWith;
	}
