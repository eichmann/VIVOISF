...
public class Non_self_governingCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingCountryAreaYearIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				countryAreaYear = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setCountryAreaYear(String theCountryAreaYear) {
		countryAreaYear = theCountryAreaYear;
	}
