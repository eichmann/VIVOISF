...
public class Non_self_governingNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingNameCurrencyARIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nameCurrencyAR = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNameCurrencyAR(String theNameCurrencyAR) {
		nameCurrencyAR = theNameCurrencyAR;
	}
