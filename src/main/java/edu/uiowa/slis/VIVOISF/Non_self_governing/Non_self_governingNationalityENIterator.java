...
public class Non_self_governingNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingNationalityENIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nationalityEN = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNationalityEN(String theNationalityEN) {
		nationalityEN = theNationalityEN;
	}
