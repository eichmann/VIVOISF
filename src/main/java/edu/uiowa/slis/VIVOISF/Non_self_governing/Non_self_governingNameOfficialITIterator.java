...
public class Non_self_governingNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingNameOfficialITIterator.class);
