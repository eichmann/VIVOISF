...
public class Non_self_governingCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingCountryAreaNotesIterator.class);
