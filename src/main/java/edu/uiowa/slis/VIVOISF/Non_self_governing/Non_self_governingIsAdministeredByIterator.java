	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				isAdministeredBy = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
	...
	public void setIsAdministeredBy(String theIsAdministeredBy) {
		isAdministeredBy = theIsAdministeredBy;
	}
