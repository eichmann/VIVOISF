...
public class Non_self_governingCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingCodeCurrencyIterator.class);
