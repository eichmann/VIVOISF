...
public class Non_self_governingGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingGDPUnitIterator.class);
