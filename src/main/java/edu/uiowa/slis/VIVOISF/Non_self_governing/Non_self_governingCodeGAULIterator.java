...
public class Non_self_governingCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingCodeGAULIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				codeGAUL = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setCodeGAUL(String theCodeGAUL) {
		codeGAUL = theCodeGAUL;
	}
