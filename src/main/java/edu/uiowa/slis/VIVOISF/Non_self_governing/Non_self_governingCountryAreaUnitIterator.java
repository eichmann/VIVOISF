...
public class Non_self_governingCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingCountryAreaUnitIterator.class);
