...
public class Non_self_governingLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingLandAreaTotalIterator.class);
