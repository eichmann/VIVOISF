...
public class Non_self_governingNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingNameOfficialENIterator.class);
