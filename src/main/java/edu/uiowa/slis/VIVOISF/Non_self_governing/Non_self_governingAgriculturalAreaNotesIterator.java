...
public class Non_self_governingAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingAgriculturalAreaNotesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				agriculturalAreaNotes = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setAgriculturalAreaNotes(String theAgriculturalAreaNotes) {
		agriculturalAreaNotes = theAgriculturalAreaNotes;
	}
