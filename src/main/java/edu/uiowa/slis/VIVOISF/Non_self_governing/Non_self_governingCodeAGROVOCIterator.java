...
public class Non_self_governingCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingCodeAGROVOCIterator.class);
