...
public class Non_self_governingNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingNameCurrencyZHIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nameCurrencyZH = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNameCurrencyZH(String theNameCurrencyZH) {
		nameCurrencyZH = theNameCurrencyZH;
	}
