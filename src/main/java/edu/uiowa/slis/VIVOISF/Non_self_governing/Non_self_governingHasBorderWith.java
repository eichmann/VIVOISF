...
public class Non_self_governingHasBorderWith extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingHasBorderWith currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingHasBorderWith.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNon_self_governingHasBorderWithIterator.getHasBorderWith());
		} catch (Exception e) {
