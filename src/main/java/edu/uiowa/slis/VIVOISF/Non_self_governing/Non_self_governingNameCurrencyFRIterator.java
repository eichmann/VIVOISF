...
public class Non_self_governingNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingNameCurrencyFRIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nameCurrencyFR = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNameCurrencyFR(String theNameCurrencyFR) {
		nameCurrencyFR = theNameCurrencyFR;
	}
