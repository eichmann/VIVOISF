...
public class Non_self_governingNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingNameOfficialRUIterator.class);
