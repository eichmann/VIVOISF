...
public class Non_self_governingLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Non_self_governingLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Non_self_governingLandAreaNotesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				landAreaNotes = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setLandAreaNotes(String theLandAreaNotes) {
		landAreaNotes = theLandAreaNotes;
	}
