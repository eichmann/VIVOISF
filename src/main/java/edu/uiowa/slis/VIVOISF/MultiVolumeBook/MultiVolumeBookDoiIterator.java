...
public class MultiVolumeBookDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookDoiIterator.class);
