...
public class MultiVolumeBookUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookUpcIterator.class);
