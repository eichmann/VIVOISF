...
public class MultiVolumeBookEissnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookEissnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookEissnIterator.class);
