...
public class MultiVolumeBookRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultiVolumeBookRO_0000056Iterator.getType());
		} catch (Exception e) {
