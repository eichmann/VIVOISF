...
public class MultiVolumeBookFeatures extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookFeatures currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookFeatures.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultiVolumeBookFeaturesIterator.getFeatures());
		} catch (Exception e) {
