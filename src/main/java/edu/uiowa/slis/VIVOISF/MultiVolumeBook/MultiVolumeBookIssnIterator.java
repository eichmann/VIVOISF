...
public class MultiVolumeBookIssnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookIssnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookIssnIterator.class);
