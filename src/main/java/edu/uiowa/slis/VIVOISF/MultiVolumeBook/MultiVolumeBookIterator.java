...
public class MultiVolumeBookIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/MultiVolumeBook> . "+
