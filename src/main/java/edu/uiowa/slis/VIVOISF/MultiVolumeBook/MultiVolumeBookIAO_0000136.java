...
public class MultiVolumeBookIAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookIAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookIAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMultiVolumeBookIAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
