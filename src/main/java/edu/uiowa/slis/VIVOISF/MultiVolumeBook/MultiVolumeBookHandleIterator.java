...
public class MultiVolumeBookHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookHandleIterator.class);
