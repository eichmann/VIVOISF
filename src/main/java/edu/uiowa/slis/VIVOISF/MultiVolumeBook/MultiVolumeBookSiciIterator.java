...
public class MultiVolumeBookSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookSiciIterator.class);
