...
public class MultiVolumeBookNumVolumesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookNumVolumesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookNumVolumesIterator.class);
