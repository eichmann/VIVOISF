...
public class MultiVolumeBookEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookEanucc13Iterator.class);
