...
public class MultiVolumeBookAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookAsinIterator.class);
