...
public class MultiVolumeBookIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookIsbn13Iterator.class);
