...
public class MultiVolumeBookIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookIdentifierIterator.class);
