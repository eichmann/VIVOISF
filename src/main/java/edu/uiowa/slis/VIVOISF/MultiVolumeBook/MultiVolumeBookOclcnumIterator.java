...
public class MultiVolumeBookOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookOclcnumIterator.class);
