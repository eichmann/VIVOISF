...
public class MultiVolumeBookIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MultiVolumeBookIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MultiVolumeBookIsbn10Iterator.class);
