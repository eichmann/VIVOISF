...
public class LicensureRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LicensureRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LicensureRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLicensureRO_0000056Iterator.getType());
		} catch (Exception e) {
