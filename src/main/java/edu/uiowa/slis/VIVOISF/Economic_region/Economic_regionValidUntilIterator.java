...
public class Economic_regionValidUntilIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Economic_regionValidUntilIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Economic_regionValidUntilIterator.class);
