...
public class Economic_regionNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Economic_regionNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Economic_regionNameOfficialZHIterator.class);
