...
public class Economic_regionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Economic_regionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Economic_regionCodeAGROVOCIterator.class);
