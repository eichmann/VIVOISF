...
public class Economic_regionNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Economic_regionNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Economic_regionNameShortZHIterator.class);
