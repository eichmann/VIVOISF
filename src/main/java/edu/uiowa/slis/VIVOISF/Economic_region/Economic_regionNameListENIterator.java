...
public class Economic_regionNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Economic_regionNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Economic_regionNameListENIterator.class);
