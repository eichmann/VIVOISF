...
public class Economic_regionNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Economic_regionNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Economic_regionNameShortESIterator.class);
