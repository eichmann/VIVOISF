...
public class Economic_regionSourceIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Economic_regionSourceIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Economic_regionSourceIdentifierIterator.class);
