...
public class Economic_regionNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Economic_regionNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Economic_regionNameOfficialITIterator.class);
