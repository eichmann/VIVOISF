...
public class Economic_regionSourceModifiedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Economic_regionSourceModifiedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Economic_regionSourceModifiedIterator.class);
