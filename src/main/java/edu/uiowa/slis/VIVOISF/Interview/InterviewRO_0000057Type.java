...
public class InterviewRO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InterviewRO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(InterviewRO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInterviewRO_0000057Iterator.getType());
		} catch (Exception e) {
