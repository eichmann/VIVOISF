...
public class ThesisCitedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisCitedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisCitedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThesisCitedByIterator.getType());
		} catch (Exception e) {
