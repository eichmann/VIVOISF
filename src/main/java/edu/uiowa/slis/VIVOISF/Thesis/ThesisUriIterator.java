...
public class ThesisUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisUriIterator.class);
