...
public class ThesisStatusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisStatusType currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisStatusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThesisStatusIterator.getType());
		} catch (Exception e) {
