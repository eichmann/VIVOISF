...
public class ThesisIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisIsbn10Iterator.class);
