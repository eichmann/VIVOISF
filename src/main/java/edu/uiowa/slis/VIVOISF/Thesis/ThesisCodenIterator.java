...
public class ThesisCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisCodenIterator.class);
