...
public class ThesisOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThesisOwnerIterator.getType());
		} catch (Exception e) {
