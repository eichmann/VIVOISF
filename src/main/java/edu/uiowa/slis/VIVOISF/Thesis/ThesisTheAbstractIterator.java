...
public class ThesisTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisTheAbstractIterator.class);
