...
public class ThesisPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisPageStartIterator.class);
