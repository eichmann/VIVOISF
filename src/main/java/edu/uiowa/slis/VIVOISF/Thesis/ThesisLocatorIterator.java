...
public class ThesisLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisLocatorIterator.class);
