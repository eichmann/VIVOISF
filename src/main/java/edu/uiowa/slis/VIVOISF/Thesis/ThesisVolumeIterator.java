...
public class ThesisVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisVolumeIterator.class);
