...
public class ThesisOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisOclcnumIterator.class);
