...
public class ThesisReproduces extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisReproduces currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisReproduces.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThesisReproducesIterator.getReproduces());
		} catch (Exception e) {
