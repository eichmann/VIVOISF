...
public class ThesisLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisLccnIterator.class);
