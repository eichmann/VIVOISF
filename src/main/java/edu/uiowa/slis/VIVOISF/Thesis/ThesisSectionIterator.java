...
public class ThesisSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisSectionIterator.class);
