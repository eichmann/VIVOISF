...
public class ThesisEditorList extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisEditorList currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisEditorList.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThesisEditorListIterator.getEditorList());
		} catch (Exception e) {
