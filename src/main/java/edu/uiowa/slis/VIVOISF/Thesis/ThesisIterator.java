...
public class ThesisIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/Thesis> . "+
