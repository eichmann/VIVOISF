...
public class ThesisIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisIdentifierIterator.class);
