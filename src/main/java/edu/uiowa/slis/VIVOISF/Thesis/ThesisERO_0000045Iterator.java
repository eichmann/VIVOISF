...
public class ThesisERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisERO_0000045Iterator.class);
