...
public class ThesisAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisAsinIterator.class);
