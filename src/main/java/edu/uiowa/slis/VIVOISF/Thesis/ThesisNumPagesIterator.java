...
public class ThesisNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisNumPagesIterator.class);
