...
public class ThesisHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisHandleIterator.class);
