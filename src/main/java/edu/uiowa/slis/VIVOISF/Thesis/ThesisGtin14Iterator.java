...
public class ThesisGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisGtin14Iterator.class);
