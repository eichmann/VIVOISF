...
public class ThesisARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisARG_0000001Iterator.class);
