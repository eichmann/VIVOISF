...
public class ThesisEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisEanucc13Iterator.class);
