...
public class ThesisEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisEditionIterator.class);
