...
public class ThesisShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisShortTitleIterator.class);
