...
public class ThesisPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisPagesIterator.class);
