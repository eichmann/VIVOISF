...
public class ThesisSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisSiciIterator.class);
