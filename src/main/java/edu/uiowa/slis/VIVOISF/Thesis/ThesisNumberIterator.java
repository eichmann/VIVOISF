...
public class ThesisNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisNumberIterator.class);
