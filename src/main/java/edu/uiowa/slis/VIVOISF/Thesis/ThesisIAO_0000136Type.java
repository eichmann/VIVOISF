...
public class ThesisIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThesisIAO_0000136Iterator.getType());
		} catch (Exception e) {
