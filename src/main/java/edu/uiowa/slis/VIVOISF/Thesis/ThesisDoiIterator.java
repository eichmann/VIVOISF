...
public class ThesisDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisDoiIterator.class);
