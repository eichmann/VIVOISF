...
public class ThesisIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisIsbn13Iterator.class);
