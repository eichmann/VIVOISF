...
public class ThesisContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisContentIterator.class);
