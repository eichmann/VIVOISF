...
public class FormattedNameUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FormattedNameUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FormattedNameUrlIterator.class);
