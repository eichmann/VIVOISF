...
public class FormattedNameHasFormattedNameInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FormattedNameHasFormattedNameInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(FormattedNameHasFormattedNameInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFormattedNameHasFormattedNameInverseIterator.getType());
		} catch (Exception e) {
