...
public class ContinentNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameShortITIterator.class);
