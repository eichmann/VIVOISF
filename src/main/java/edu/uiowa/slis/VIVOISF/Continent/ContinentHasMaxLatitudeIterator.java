...
public class ContinentHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentHasMaxLatitudeIterator.class);
