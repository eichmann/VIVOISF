...
public class ContinentCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCodeFAOSTATIterator.class);
