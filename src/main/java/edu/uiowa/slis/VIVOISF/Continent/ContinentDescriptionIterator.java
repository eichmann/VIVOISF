...
public class ContinentDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentDescriptionIterator.class);
