...
public class ContinentGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentGDPYearIterator.class);
