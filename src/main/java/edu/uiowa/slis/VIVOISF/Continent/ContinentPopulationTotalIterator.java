...
public class ContinentPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentPopulationTotalIterator.class);
