...
public class ContinentHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentHDINotesIterator.class);
