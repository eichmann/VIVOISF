...
public class ContinentNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameOfficialENIterator.class);
