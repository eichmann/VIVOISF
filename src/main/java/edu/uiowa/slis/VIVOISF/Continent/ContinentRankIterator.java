...
public class ContinentRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentRankIterator.class);
