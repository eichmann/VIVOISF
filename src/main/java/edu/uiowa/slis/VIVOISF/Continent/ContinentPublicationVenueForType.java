...
public class ContinentPublicationVenueForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentPublicationVenueForType currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentPublicationVenueForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinentPublicationVenueForIterator.getType());
		} catch (Exception e) {
