...
public class ContinentRelates extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentRelates currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentRelates.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinentRelatesIterator.getRelates());
		} catch (Exception e) {
