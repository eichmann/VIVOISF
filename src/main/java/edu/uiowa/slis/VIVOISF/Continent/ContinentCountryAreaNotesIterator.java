...
public class ContinentCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCountryAreaNotesIterator.class);
