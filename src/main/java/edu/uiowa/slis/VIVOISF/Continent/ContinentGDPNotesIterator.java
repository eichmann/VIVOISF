...
public class ContinentGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentGDPNotesIterator.class);
