...
public class ContinentARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinentARG_2000028Iterator.getType());
		} catch (Exception e) {
