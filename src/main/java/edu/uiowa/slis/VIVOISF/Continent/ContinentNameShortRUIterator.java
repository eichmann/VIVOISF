...
public class ContinentNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameShortRUIterator.class);
