...
public class ContinentCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCountryAreaYearIterator.class);
