...
public class ContinentHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentHasMinLongitudeIterator.class);
