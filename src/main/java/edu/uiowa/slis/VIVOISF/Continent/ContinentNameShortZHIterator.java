...
public class ContinentNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameShortZHIterator.class);
