...
public class ContinentCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCountryAreaUnitIterator.class);
