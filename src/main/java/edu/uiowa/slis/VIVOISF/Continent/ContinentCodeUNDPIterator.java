...
public class ContinentCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCodeUNDPIterator.class);
