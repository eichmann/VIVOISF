...
public class ContinentPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentPopulationYearIterator.class);
