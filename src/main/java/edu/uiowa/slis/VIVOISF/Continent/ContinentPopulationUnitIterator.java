...
public class ContinentPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentPopulationUnitIterator.class);
