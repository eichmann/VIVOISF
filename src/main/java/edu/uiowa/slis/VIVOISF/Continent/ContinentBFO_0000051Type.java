...
public class ContinentBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinentBFO_0000051Iterator.getType());
		} catch (Exception e) {
