...
public class ContinentLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentLandAreaUnitIterator.class);
