...
public class ContinentBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinentBFO_0000050Iterator.getType());
		} catch (Exception e) {
