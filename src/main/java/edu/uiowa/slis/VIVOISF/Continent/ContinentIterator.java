...
public class ContinentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Continent> . "+
