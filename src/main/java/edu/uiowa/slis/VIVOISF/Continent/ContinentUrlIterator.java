...
public class ContinentUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentUrlIterator.class);
