...
public class ContinentNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameCurrencyARIterator.class);
