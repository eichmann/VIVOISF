...
public class ContinentGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentGDPUnitIterator.class);
