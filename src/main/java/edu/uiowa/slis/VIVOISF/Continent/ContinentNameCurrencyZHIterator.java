...
public class ContinentNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameCurrencyZHIterator.class);
