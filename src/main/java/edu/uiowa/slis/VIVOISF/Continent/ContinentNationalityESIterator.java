...
public class ContinentNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNationalityESIterator.class);
