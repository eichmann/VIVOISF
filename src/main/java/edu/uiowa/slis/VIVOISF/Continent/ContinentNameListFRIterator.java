...
public class ContinentNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameListFRIterator.class);
