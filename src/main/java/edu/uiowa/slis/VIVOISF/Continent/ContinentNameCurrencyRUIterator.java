...
public class ContinentNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameCurrencyRUIterator.class);
