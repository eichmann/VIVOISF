...
public class ContinentCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCodeUNIterator.class);
