...
public class ContinentCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCodeDBPediaIDIterator.class);
