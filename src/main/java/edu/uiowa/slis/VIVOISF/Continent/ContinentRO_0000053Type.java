...
public class ContinentRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinentRO_0000053Iterator.getType());
		} catch (Exception e) {
