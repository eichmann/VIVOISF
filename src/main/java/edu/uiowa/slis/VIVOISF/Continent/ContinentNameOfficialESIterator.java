...
public class ContinentNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameOfficialESIterator.class);
