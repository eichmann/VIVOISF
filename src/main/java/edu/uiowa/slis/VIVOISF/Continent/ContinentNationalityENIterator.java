...
public class ContinentNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNationalityENIterator.class);
