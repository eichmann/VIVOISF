...
public class ContinentDateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentDateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentDateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinentDateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
