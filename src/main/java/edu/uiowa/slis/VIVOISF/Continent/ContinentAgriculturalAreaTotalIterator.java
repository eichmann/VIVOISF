...
public class ContinentAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentAgriculturalAreaTotalIterator.class);
