...
public class ContinentAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentAgriculturalAreaNotesIterator.class);
