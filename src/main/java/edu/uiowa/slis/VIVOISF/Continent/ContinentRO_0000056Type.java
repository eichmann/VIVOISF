...
public class ContinentRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinentRO_0000056Iterator.getType());
		} catch (Exception e) {
