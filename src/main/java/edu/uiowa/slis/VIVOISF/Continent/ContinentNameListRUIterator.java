...
public class ContinentNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameListRUIterator.class);
