...
public class ContinentNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameListARIterator.class);
