...
public class ContinentRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContinentRO_0001025Iterator.getType());
		} catch (Exception e) {
