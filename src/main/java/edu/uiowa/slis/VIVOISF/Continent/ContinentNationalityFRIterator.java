...
public class ContinentNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNationalityFRIterator.class);
