...
public class ContinentValidSinceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentValidSinceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentValidSinceIterator.class);
