...
public class ContinentNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNationalityITIterator.class);
