...
public class ContinentNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameCurrencyITIterator.class);
