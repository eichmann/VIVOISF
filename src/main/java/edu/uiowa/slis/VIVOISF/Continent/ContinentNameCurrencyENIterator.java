...
public class ContinentNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameCurrencyENIterator.class);
