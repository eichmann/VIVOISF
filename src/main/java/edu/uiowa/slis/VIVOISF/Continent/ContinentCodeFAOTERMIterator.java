...
public class ContinentCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCodeFAOTERMIterator.class);
