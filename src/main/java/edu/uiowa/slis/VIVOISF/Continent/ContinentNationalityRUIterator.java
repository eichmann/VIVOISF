...
public class ContinentNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNationalityRUIterator.class);
