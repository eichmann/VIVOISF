...
public class ContinentHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentHDITotalIterator.class);
