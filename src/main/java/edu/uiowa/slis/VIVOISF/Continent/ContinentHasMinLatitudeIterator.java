...
public class ContinentHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentHasMinLatitudeIterator.class);
