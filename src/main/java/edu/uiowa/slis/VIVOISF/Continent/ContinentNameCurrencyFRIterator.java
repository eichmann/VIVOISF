...
public class ContinentNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameCurrencyFRIterator.class);
