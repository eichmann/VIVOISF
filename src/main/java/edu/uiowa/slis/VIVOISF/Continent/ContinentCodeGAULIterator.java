...
public class ContinentCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCodeGAULIterator.class);
