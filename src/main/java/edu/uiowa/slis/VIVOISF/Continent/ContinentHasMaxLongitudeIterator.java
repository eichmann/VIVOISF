...
public class ContinentHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentHasMaxLongitudeIterator.class);
