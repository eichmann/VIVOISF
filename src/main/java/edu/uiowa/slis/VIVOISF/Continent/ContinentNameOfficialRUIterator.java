...
public class ContinentNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameOfficialRUIterator.class);
