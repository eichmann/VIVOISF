...
public class ContinentLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentLandAreaNotesIterator.class);
