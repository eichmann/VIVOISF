...
public class ContinentNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameOfficialFRIterator.class);
