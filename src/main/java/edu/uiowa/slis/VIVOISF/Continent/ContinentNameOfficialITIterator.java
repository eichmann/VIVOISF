...
public class ContinentNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameOfficialITIterator.class);
