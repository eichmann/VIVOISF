...
public class ContinentLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentLandAreaTotalIterator.class);
