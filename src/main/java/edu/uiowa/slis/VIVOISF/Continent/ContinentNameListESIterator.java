...
public class ContinentNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameListESIterator.class);
