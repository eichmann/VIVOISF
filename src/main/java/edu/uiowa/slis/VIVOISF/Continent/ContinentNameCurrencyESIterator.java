...
public class ContinentNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameCurrencyESIterator.class);
