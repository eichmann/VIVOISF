...
public class ContinentCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCodeAGROVOCIterator.class);
