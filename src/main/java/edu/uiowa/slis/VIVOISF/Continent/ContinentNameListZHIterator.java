...
public class ContinentNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameListZHIterator.class);
