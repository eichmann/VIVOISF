...
public class ContinentHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentHDIYearIterator.class);
