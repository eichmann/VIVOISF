...
public class ContinentNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameShortARIterator.class);
