...
public class ContinentNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentNameOfficialZHIterator.class);
