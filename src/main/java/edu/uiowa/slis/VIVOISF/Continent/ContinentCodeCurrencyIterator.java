...
public class ContinentCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContinentCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ContinentCodeCurrencyIterator.class);
