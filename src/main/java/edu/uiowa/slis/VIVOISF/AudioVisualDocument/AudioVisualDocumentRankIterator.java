...
public class AudioVisualDocumentRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentRankIterator.class);
