...
public class AudioVisualDocumentCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentCountryAreaUnitIterator.class);
