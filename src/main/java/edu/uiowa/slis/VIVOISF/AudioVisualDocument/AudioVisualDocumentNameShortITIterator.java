...
public class AudioVisualDocumentNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNameShortITIterator.class);
