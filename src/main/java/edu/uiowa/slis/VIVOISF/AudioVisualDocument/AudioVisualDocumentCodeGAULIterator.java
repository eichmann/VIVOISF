...
public class AudioVisualDocumentCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentCodeGAULIterator.class);
