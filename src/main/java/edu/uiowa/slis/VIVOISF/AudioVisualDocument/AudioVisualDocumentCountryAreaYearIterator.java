...
public class AudioVisualDocumentCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentCountryAreaYearIterator.class);
