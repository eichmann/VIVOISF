...
public class AudioVisualDocumentShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentShortDescriptionIterator.class);
