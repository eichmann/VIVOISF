...
public class AudioVisualDocumentTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentTheAbstractIterator.class);
