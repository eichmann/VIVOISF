...
public class AudioVisualDocumentCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentCountryAreaTotalIterator.class);
