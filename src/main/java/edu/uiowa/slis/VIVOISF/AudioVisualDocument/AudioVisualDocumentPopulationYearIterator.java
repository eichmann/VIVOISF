...
public class AudioVisualDocumentPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentPopulationYearIterator.class);
