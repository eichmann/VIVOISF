...
public class AudioVisualDocumentRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioVisualDocumentRO_0000056Iterator.getType());
		} catch (Exception e) {
