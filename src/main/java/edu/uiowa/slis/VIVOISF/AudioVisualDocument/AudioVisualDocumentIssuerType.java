...
public class AudioVisualDocumentIssuerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentIssuerType currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentIssuerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioVisualDocumentIssuerIterator.getType());
		} catch (Exception e) {
