...
public class AudioVisualDocumentPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentPagesIterator.class);
