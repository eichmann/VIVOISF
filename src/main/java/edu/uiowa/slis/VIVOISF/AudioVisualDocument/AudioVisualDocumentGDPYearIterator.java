...
public class AudioVisualDocumentGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentGDPYearIterator.class);
