...
public class AudioVisualDocumentAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentAsinIterator.class);
