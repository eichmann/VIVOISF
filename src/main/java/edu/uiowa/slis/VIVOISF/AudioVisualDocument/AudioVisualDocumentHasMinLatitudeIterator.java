...
public class AudioVisualDocumentHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentHasMinLatitudeIterator.class);
