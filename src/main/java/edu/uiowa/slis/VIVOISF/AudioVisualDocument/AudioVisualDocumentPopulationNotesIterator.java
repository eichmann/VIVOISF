...
public class AudioVisualDocumentPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentPopulationNotesIterator.class);
