...
public class AudioVisualDocumentNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNationalityITIterator.class);
