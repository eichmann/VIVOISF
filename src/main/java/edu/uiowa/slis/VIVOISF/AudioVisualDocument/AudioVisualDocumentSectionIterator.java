...
public class AudioVisualDocumentSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentSectionIterator.class);
