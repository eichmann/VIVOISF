...
public class AudioVisualDocumentCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentCountryAreaNotesIterator.class);
