...
public class AudioVisualDocumentUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentUrlIterator.class);
