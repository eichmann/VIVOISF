...
public class AudioVisualDocumentNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNationalityZHIterator.class);
