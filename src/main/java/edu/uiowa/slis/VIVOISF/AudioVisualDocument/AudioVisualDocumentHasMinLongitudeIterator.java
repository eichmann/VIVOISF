...
public class AudioVisualDocumentHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentHasMinLongitudeIterator.class);
