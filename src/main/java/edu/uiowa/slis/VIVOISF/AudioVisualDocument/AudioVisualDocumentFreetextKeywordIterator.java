...
public class AudioVisualDocumentFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentFreetextKeywordIterator.class);
