...
public class AudioVisualDocumentPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentPageEndIterator.class);
