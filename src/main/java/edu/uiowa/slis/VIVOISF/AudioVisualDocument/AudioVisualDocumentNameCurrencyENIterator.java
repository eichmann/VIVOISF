...
public class AudioVisualDocumentNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNameCurrencyENIterator.class);
