...
public class AudioVisualDocumentRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioVisualDocumentRO_0001015Iterator.getType());
		} catch (Exception e) {
