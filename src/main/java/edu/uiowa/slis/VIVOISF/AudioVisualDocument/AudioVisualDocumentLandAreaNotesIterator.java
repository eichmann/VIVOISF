...
public class AudioVisualDocumentLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentLandAreaNotesIterator.class);
