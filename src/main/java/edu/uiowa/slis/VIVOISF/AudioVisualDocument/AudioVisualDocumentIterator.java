...
public class AudioVisualDocumentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/AudioVisualDocument> . "+
