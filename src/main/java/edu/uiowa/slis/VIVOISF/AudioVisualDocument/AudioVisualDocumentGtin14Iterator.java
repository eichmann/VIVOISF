...
public class AudioVisualDocumentGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentGtin14Iterator.class);
