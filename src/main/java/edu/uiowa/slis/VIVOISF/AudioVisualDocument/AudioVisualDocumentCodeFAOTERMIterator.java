...
public class AudioVisualDocumentCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentCodeFAOTERMIterator.class);
