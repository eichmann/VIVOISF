...
public class AudioVisualDocumentHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentHandleIterator.class);
