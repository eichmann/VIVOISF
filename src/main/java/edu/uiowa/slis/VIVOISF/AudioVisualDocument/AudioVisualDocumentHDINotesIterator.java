...
public class AudioVisualDocumentHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentHDINotesIterator.class);
