...
public class AudioVisualDocumentPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentPopulationUnitIterator.class);
