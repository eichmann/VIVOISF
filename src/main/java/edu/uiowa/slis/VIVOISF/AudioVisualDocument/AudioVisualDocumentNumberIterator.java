...
public class AudioVisualDocumentNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNumberIterator.class);
