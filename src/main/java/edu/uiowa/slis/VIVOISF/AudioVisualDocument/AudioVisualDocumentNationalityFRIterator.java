...
public class AudioVisualDocumentNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNationalityFRIterator.class);
