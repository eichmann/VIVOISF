...
public class AudioVisualDocumentNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNameOfficialITIterator.class);
