...
public class AudioVisualDocumentNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNameCurrencyITIterator.class);
