...
public class AudioVisualDocumentEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentEanucc13Iterator.class);
