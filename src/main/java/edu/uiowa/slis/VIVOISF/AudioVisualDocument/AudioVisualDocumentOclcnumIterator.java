...
public class AudioVisualDocumentOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentOclcnumIterator.class);
