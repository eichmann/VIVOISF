...
public class AudioVisualDocumentHasTranslation extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentHasTranslation currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentHasTranslation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioVisualDocumentHasTranslationIterator.getHasTranslation());
		} catch (Exception e) {
