...
public class AudioVisualDocumentLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentLccnIterator.class);
