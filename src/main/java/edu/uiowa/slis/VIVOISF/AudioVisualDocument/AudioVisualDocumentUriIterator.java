...
public class AudioVisualDocumentUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentUriIterator.class);
