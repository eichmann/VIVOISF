...
public class AudioVisualDocumentLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentLandAreaYearIterator.class);
