...
public class AudioVisualDocumentIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentIdentifierIterator.class);
