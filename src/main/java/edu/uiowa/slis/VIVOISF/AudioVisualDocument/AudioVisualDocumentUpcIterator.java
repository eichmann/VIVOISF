...
public class AudioVisualDocumentUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentUpcIterator.class);
