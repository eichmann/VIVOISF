...
public class AudioVisualDocumentPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentPmidIterator.class);
