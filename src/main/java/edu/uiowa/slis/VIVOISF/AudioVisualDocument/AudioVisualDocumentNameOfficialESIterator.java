...
public class AudioVisualDocumentNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNameOfficialESIterator.class);
