...
public class AudioVisualDocumentLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentLandAreaTotalIterator.class);
