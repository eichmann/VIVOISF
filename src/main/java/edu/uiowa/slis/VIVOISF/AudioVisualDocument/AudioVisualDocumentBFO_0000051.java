...
public class AudioVisualDocumentBFO_0000051 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentBFO_0000051 currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentBFO_0000051.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioVisualDocumentBFO_0000051Iterator.getBFO_0000051());
		} catch (Exception e) {
