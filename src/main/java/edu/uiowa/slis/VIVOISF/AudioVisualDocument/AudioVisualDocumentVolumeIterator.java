...
public class AudioVisualDocumentVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentVolumeIterator.class);
