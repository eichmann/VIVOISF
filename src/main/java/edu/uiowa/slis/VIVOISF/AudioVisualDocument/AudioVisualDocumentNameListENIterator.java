...
public class AudioVisualDocumentNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNameListENIterator.class);
