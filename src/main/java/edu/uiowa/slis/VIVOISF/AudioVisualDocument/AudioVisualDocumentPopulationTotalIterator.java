...
public class AudioVisualDocumentPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentPopulationTotalIterator.class);
