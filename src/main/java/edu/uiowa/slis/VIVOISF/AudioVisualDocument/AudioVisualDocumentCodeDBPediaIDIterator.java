...
public class AudioVisualDocumentCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentCodeDBPediaIDIterator.class);
