...
public class AudioVisualDocumentIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentIsbn13Iterator.class);
