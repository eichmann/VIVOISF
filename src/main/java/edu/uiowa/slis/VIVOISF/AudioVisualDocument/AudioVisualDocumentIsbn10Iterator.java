...
public class AudioVisualDocumentIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentIsbn10Iterator.class);
