...
public class AudioVisualDocumentLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentLocatorIterator.class);
