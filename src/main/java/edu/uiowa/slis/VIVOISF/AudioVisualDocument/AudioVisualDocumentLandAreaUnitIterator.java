...
public class AudioVisualDocumentLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentLandAreaUnitIterator.class);
