...
public class AudioVisualDocumentNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNationalityENIterator.class);
