...
public class AudioVisualDocumentARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentARG_0000001Iterator.class);
