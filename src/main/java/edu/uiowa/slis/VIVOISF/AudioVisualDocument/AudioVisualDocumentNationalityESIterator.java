...
public class AudioVisualDocumentNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentNationalityESIterator.class);
