...
public class AudioVisualDocumentIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioVisualDocumentIAO_0000136Iterator.getType());
		} catch (Exception e) {
