...
public class AudioVisualDocumentCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentCodeCurrencyIterator.class);
