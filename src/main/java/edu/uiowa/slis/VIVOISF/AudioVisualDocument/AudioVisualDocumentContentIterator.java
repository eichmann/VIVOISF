...
public class AudioVisualDocumentContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentContentIterator.class);
