...
public class AudioVisualDocumentGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentGDPUnitIterator.class);
