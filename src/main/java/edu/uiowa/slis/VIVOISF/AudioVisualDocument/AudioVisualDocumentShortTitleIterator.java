...
public class AudioVisualDocumentShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentShortTitleIterator.class);
