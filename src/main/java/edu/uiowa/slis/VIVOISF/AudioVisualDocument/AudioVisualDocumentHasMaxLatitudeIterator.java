...
public class AudioVisualDocumentHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentHasMaxLatitudeIterator.class);
