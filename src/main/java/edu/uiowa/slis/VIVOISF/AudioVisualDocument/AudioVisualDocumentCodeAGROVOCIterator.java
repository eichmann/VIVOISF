...
public class AudioVisualDocumentCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentCodeAGROVOCIterator.class);
