...
public class AudioVisualDocumentEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentEditionIterator.class);
