...
public class AudioVisualDocumentPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioVisualDocumentPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioVisualDocumentPageStartIterator.class);
