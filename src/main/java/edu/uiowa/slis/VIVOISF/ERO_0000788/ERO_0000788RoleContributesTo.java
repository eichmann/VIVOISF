...
public class ERO_0000788RoleContributesTo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000788RoleContributesTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000788RoleContributesTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000788RoleContributesToIterator.getRoleContributesTo());
		} catch (Exception e) {
