...
public class DateTimeValueNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameShortRUIterator.class);
