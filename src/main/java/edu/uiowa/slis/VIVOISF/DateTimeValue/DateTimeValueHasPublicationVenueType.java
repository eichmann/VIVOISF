...
public class DateTimeValueHasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueHasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueHasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeValueHasPublicationVenueIterator.getType());
		} catch (Exception e) {
