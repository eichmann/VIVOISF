...
public class DateTimeValueRO_0002234 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueRO_0002234 currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueRO_0002234.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeValueRO_0002234Iterator.getRO_0002234());
		} catch (Exception e) {
