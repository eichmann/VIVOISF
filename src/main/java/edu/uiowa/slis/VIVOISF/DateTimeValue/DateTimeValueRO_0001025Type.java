...
public class DateTimeValueRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeValueRO_0001025Iterator.getType());
		} catch (Exception e) {
