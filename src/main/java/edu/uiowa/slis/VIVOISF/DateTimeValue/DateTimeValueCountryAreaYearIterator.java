...
public class DateTimeValueCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCountryAreaYearIterator.class);
