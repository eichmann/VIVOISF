...
public class DateTimeValueNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameOfficialENIterator.class);
