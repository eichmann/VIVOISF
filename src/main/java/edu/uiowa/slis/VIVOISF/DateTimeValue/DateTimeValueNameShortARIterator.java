...
public class DateTimeValueNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameShortARIterator.class);
