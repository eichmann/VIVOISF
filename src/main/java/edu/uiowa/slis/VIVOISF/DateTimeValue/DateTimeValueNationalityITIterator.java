...
public class DateTimeValueNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNationalityITIterator.class);
