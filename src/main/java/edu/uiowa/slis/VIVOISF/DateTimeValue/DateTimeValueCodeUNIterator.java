...
public class DateTimeValueCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCodeUNIterator.class);
