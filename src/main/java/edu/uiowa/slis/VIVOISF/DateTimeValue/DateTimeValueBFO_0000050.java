...
public class DateTimeValueBFO_0000050 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueBFO_0000050 currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueBFO_0000050.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeValueBFO_0000050Iterator.getBFO_0000050());
		} catch (Exception e) {
