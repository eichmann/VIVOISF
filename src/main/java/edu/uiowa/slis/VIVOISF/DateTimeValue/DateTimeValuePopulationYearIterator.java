...
public class DateTimeValuePopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValuePopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValuePopulationYearIterator.class);
