...
public class DateTimeValueHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueHasMinLongitudeIterator.class);
