...
public class DateTimeValueNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameCurrencyARIterator.class);
