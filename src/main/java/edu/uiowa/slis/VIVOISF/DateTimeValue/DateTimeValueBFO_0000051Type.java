...
public class DateTimeValueBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeValueBFO_0000051Iterator.getType());
		} catch (Exception e) {
