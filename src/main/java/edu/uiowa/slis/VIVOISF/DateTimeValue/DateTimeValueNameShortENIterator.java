...
public class DateTimeValueNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameShortENIterator.class);
