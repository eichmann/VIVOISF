...
public class DateTimeValueCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCodeFAOSTATIterator.class);
