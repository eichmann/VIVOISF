...
public class DateTimeValuePopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValuePopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValuePopulationUnitIterator.class);
