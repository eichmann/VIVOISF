...
public class DateTimeValueCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCountryAreaUnitIterator.class);
