...
public class DateTimeValueNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNationalityRUIterator.class);
