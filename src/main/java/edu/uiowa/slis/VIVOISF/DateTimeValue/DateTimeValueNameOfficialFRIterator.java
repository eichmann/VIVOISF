...
public class DateTimeValueNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameOfficialFRIterator.class);
