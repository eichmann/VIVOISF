...
public class DateTimeValueLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueLandAreaTotalIterator.class);
