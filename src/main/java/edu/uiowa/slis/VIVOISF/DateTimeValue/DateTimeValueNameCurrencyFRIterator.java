...
public class DateTimeValueNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameCurrencyFRIterator.class);
