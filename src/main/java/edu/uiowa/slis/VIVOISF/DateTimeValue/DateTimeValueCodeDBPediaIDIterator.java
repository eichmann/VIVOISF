...
public class DateTimeValueCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCodeDBPediaIDIterator.class);
