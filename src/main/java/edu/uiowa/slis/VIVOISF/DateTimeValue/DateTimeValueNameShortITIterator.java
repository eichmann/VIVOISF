...
public class DateTimeValueNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameShortITIterator.class);
