...
public class DateTimeValueCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCodeUNDPIterator.class);
