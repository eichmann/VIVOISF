...
public class DateTimeValueHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueHasMinLatitudeIterator.class);
