...
public class DateTimeValueNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameOfficialITIterator.class);
