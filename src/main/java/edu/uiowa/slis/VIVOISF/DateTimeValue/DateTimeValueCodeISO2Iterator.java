...
public class DateTimeValueCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCodeISO2Iterator.class);
