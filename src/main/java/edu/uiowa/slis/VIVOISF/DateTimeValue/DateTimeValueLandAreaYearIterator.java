...
public class DateTimeValueLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueLandAreaYearIterator.class);
