...
public class DateTimeValueNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameShortESIterator.class);
