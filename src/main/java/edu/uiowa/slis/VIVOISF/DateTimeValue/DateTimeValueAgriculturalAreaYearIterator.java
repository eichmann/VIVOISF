...
public class DateTimeValueAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueAgriculturalAreaYearIterator.class);
