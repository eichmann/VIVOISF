...
public class DateTimeValueCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCodeFAOTERMIterator.class);
