...
public class DateTimeValueGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueGDPTotalInCurrentPricesIterator.class);
