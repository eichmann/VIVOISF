...
public class DateTimeValueHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueHasMaxLongitudeIterator.class);
