...
public class DateTimeValueNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameListITIterator.class);
