...
public class DateTimeValueCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCodeISO3Iterator.class);
