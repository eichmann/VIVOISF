...
public class DateTimeValueHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueHDIYearIterator.class);
