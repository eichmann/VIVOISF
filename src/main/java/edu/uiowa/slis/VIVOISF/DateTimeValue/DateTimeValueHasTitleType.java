...
public class DateTimeValueHasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueHasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueHasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeValueHasTitleIterator.getType());
		} catch (Exception e) {
