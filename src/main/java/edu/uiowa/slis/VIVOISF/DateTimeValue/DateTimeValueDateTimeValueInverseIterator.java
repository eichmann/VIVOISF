	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				dateTimeValueInverse = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
	...
	public void setDateTimeValueInverse(String theDateTimeValueInverse) {
		dateTimeValueInverse = theDateTimeValueInverse;
	}
