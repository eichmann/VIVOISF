...
public class DateTimeValueNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameCurrencyRUIterator.class);
