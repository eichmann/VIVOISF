...
public class DateTimeValuePublisher extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValuePublisher currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValuePublisher.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeValuePublisherIterator.getPublisher());
		} catch (Exception e) {
