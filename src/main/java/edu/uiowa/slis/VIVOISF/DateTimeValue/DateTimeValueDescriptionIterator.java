...
public class DateTimeValueDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueDescriptionIterator.class);
