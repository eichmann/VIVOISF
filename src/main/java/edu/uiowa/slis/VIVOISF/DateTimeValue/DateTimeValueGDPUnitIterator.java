...
public class DateTimeValueGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueGDPUnitIterator.class);
