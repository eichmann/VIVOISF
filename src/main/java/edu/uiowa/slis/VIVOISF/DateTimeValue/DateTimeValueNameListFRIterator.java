...
public class DateTimeValueNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameListFRIterator.class);
