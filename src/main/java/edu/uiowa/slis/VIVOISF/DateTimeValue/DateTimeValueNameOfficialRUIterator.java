...
public class DateTimeValueNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameOfficialRUIterator.class);
