...
public class DateTimeValueRO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueRO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueRO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeValueRO_0000057Iterator.getType());
		} catch (Exception e) {
