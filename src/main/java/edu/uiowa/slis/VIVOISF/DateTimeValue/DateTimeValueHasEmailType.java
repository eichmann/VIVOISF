...
public class DateTimeValueHasEmailType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueHasEmailType currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueHasEmailType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeValueHasEmailIterator.getType());
		} catch (Exception e) {
