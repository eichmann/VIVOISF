...
public class DateTimeValueGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueGDPNotesIterator.class);
