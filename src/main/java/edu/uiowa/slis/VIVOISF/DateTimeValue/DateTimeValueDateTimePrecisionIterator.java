	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				dateTimePrecision = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
	...
	public void setDateTimePrecision(String theDateTimePrecision) {
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DateTimeValueDateTimePrecisionIterator");
