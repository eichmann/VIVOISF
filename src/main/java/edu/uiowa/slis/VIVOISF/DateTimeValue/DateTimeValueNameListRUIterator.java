...
public class DateTimeValueNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameListRUIterator.class);
