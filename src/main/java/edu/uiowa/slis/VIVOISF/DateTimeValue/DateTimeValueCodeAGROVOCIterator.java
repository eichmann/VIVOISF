...
public class DateTimeValueCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCodeAGROVOCIterator.class);
