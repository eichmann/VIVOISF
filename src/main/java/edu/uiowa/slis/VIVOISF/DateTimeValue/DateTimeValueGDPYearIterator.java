...
public class DateTimeValueGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueGDPYearIterator.class);
