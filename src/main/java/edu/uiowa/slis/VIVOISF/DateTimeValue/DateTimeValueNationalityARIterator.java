...
public class DateTimeValueNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNationalityARIterator.class);
