...
public class DateTimeValueAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueAgriculturalAreaNotesIterator.class);
