...
public class DateTimeValueCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCountryAreaTotalIterator.class);
