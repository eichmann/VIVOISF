...
public class DateTimeValueNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameOfficialARIterator.class);
