...
public class DateTimeValueNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameListARIterator.class);
