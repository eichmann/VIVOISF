...
public class DateTimeValueLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueLandAreaNotesIterator.class);
