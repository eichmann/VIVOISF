...
public class DateTimeValueDateTimeValueIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueDateTimeValueIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueDateTimeValueIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DateTimeValueDateTimeValueIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DateTimeValueDateTimeValueIterator doStartTag");
		}
