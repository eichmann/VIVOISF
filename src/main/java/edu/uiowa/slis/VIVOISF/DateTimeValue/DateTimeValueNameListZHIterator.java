...
public class DateTimeValueNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameListZHIterator.class);
