...
public class DateTimeValueNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameOfficialESIterator.class);
