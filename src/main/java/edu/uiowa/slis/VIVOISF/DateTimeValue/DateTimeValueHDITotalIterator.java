...
public class DateTimeValueHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueHDITotalIterator.class);
