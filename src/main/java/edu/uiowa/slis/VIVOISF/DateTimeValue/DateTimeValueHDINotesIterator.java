...
public class DateTimeValueHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueHDINotesIterator.class);
