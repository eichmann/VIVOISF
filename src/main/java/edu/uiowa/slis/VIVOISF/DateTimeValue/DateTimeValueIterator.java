...
public class DateTimeValueIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#DateTimeValue> . "+
