...
public class DateTimeValueNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameOfficialZHIterator.class);
