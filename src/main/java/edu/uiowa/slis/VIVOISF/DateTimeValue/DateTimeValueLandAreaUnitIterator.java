...
public class DateTimeValueLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueLandAreaUnitIterator.class);
