...
public class DateTimeValueNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameListENIterator.class);
