...
public class DateTimeValueCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueCodeGAULIterator.class);
