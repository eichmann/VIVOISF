...
public class DateTimeValueNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNationalityFRIterator.class);
