...
public class DateTimeValuePopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValuePopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValuePopulationTotalIterator.class);
