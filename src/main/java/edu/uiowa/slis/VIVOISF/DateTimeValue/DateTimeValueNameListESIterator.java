...
public class DateTimeValueNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValueNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValueNameListESIterator.class);
