...
public class CertificateRelated extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CertificateRelated currentInstance = null;
	private static final Log log = LogFactory.getLog(CertificateRelated.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCertificateRelatedIterator.getRelated());
		} catch (Exception e) {
