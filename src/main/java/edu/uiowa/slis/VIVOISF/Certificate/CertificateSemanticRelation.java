...
public class CertificateSemanticRelation extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CertificateSemanticRelation currentInstance = null;
	private static final Log log = LogFactory.getLog(CertificateSemanticRelation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCertificateSemanticRelationIterator.getSemanticRelation());
		} catch (Exception e) {
