...
public class CertificateMemberInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CertificateMemberInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(CertificateMemberInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCertificateMemberInverseIterator.getMemberInverse());
		} catch (Exception e) {
