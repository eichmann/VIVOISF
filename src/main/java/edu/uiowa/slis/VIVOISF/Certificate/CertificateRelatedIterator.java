...
public class CertificateRelatedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CertificateRelatedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CertificateRelatedIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CertificateRelatedIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CertificateRelatedIterator doStartTag");
		}
