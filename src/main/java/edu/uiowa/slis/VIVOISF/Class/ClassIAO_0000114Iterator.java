...
public class ClassIAO_0000114Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClassIAO_0000114Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassIAO_0000114Iterator.class);
