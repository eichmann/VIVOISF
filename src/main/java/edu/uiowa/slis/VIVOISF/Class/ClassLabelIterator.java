...
public class ClassLabelIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClassLabelIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassLabelIterator.class);
