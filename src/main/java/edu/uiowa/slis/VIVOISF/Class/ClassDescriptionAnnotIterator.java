...
public class ClassDescriptionAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClassDescriptionAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassDescriptionAnnotIterator.class);
