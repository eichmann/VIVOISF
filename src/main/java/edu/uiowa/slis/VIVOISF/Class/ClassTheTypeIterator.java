...
public class ClassTheTypeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClassTheTypeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassTheTypeIterator.class);
