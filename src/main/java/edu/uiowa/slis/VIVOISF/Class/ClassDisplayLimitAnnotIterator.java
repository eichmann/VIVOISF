...
public class ClassDisplayLimitAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClassDisplayLimitAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassDisplayLimitAnnotIterator.class);
