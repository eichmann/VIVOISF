...
public class ClassIsDefinedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClassIsDefinedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClassIsDefinedByIterator.class);
