...
public class NonFacultyAcademicPositionARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicPositionARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicPositionARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicPositionARG_2000028Iterator.getType());
		} catch (Exception e) {
