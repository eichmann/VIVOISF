...
public class NonFacultyAcademicPositionGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicPositionGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicPositionGDPNotesIterator.class);
