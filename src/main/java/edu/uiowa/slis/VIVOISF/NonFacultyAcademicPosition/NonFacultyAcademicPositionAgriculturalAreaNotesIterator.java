...
public class NonFacultyAcademicPositionAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicPositionAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicPositionAgriculturalAreaNotesIterator.class);
