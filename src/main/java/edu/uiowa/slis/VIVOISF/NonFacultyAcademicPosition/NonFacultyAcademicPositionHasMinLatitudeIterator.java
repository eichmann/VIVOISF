...
public class NonFacultyAcademicPositionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicPositionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicPositionHasMinLatitudeIterator.class);
