...
public class NonFacultyAcademicPositionHasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicPositionHasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicPositionHasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicPositionHasResearchAreaIterator.getType());
		} catch (Exception e) {
