...
public class NonFacultyAcademicPositionPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicPositionPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicPositionPopulationUnitIterator.class);
