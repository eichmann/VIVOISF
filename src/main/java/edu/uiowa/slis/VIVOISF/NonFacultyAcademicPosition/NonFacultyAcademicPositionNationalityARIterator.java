...
public class NonFacultyAcademicPositionNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicPositionNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicPositionNationalityARIterator.class);
