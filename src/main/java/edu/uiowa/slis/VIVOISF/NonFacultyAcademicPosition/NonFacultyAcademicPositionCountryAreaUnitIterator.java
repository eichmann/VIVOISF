...
public class NonFacultyAcademicPositionCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicPositionCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicPositionCountryAreaUnitIterator.class);
