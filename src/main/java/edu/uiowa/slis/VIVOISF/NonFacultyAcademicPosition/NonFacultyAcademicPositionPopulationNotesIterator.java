...
public class NonFacultyAcademicPositionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicPositionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicPositionPopulationNotesIterator.class);
