...
public class NonFacultyAcademicPositionHasAddressType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicPositionHasAddressType currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicPositionHasAddressType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicPositionHasAddressIterator.getType());
		} catch (Exception e) {
