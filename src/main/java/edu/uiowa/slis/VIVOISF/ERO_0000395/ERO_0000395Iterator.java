...
public class ERO_0000395Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000395Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000395Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(Prefix_1_4+
					" SELECT ?s ?l where { "+
						"?s rdfs:label ?l . "+
						"?s rdf:type <http://purl.obolibrary.org/obo/ERO_0000395> . "+
					"} ORDER BY ?l");
			if(rs.hasNext()) {
