...
public class ERO_0000395TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000395TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000395TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000395TranslatorIterator.getType());
		} catch (Exception e) {
