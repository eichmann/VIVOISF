...
public class ERO_0000395ERO_0000390Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000395ERO_0000390Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000395ERO_0000390Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000395ERO_0000390Iterator.getType());
		} catch (Exception e) {
