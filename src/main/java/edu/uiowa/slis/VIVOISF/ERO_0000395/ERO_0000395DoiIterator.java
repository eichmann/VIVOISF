...
public class ERO_0000395DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000395DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000395DoiIterator.class);
