...
public class ARG_2000377RO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000377RO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000377RO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000377RO_0000056Iterator.getType());
		} catch (Exception e) {
