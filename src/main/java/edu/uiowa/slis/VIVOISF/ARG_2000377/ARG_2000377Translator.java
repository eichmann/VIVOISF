...
public class ARG_2000377Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000377Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000377Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000377TranslatorIterator.getTranslator());
		} catch (Exception e) {
