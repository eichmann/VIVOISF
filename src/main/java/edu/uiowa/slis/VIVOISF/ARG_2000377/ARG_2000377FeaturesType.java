...
public class ARG_2000377FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000377FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000377FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000377FeaturesIterator.getType());
		} catch (Exception e) {
