...
public class ARG_2000377ARG_2000029 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000377ARG_2000029 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000377ARG_2000029.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000377ARG_2000029Iterator.getARG_2000029());
		} catch (Exception e) {
