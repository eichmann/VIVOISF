...
public class ARG_2000377InformationResourceSupportedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000377InformationResourceSupportedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000377InformationResourceSupportedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000377InformationResourceSupportedByIterator.getInformationResourceSupportedBy());
		} catch (Exception e) {
