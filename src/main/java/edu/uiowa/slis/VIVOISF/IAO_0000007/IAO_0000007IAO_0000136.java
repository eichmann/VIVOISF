...
public class IAO_0000007IAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000007IAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000007IAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000007IAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
