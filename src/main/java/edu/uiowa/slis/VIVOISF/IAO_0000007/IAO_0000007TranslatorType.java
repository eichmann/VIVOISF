...
public class IAO_0000007TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000007TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000007TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000007TranslatorIterator.getType());
		} catch (Exception e) {
