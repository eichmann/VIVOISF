...
public class AddressingRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AddressingRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AddressingRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AddressingRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AddressingRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AddressingRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AddressingRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AddressingRelates doEndTag", e);
			throw new JspTagException("Exception raised in AddressingRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AddressingRelatesIterator");
