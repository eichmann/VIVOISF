...
public class AddressingRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AddressingRelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AddressingRelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AddressingRelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AddressingRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AddressingRelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AddressingRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AddressingRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in AddressingRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AddressingRelatedByIterator");
