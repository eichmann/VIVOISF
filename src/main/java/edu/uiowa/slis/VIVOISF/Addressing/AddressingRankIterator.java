...
public class AddressingRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AddressingRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AddressingRankIterator.class);
