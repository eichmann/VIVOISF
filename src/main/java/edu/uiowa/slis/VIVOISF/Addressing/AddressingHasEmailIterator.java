...
public class AddressingHasEmailIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AddressingHasEmailIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AddressingHasEmailIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AddressingHasEmailIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AddressingHasEmailIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AddressingHasEmailIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AddressingHasEmailIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AddressingHasEmail doEndTag", e);
			throw new JspTagException("Exception raised in AddressingHasEmail doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AddressingHasEmailIterator");
