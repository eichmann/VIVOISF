...
public class AddressingUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AddressingUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AddressingUrlIterator.class);
