...
public class AddressingHasURLIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AddressingHasURLIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AddressingHasURLIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AddressingHasURLIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AddressingHasURLIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AddressingHasURLIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AddressingHasURLIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AddressingHasURL doEndTag", e);
			throw new JspTagException("Exception raised in AddressingHasURL doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AddressingHasURLIterator");
