...
public class MapPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapPagesIterator.class);
