...
public class MapCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapCodenIterator.class);
