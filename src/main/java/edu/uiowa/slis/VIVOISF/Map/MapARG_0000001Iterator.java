...
public class MapARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapARG_0000001Iterator.class);
