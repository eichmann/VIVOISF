...
public class MapContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapContentIterator.class);
