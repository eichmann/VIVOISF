...
public class MapLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapLocatorIterator.class);
