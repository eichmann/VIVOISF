...
public class MapNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapNumberIterator.class);
