...
public class MapIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapIsbn13Iterator.class);
