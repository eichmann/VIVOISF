...
public class MapVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapVolumeIterator.class);
