...
public class MapRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(MapRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMapRO_0000056Iterator.getType());
		} catch (Exception e) {
