...
public class MapUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapUpcIterator.class);
