...
public class MapSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapSectionIterator.class);
