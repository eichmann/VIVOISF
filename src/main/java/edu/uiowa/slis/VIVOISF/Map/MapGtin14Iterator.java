...
public class MapGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapGtin14Iterator.class);
