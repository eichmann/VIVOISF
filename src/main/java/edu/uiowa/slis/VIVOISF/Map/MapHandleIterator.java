...
public class MapHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapHandleIterator.class);
