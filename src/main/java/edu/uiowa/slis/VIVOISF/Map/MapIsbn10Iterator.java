...
public class MapIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapIsbn10Iterator.class);
