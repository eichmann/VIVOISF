...
public class MapAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapAsinIterator.class);
