...
public class MapDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapDoiIterator.class);
