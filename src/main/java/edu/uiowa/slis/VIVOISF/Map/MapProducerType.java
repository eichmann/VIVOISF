...
public class MapProducerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapProducerType currentInstance = null;
	private static final Log log = LogFactory.getLog(MapProducerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMapProducerIterator.getType());
		} catch (Exception e) {
