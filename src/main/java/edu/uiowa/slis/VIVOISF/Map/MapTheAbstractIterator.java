...
public class MapTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapTheAbstractIterator.class);
