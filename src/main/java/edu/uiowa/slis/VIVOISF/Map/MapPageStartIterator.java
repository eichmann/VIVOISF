...
public class MapPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapPageStartIterator.class);
