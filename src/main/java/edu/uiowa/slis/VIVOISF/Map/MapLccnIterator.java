...
public class MapLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapLccnIterator.class);
