...
public class MapERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapERO_0000045Iterator.class);
