...
public class MapPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapPageEndIterator.class);
