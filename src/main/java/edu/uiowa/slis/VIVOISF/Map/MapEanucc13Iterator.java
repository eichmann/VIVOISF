...
public class MapEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapEanucc13Iterator.class);
