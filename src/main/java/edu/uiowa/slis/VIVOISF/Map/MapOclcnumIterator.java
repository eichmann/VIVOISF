...
public class MapOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapOclcnumIterator.class);
