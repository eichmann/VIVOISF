...
public class MapPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MapPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MapPmidIterator.class);
