...
public class BFO_0000002NationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NationalityRUIterator.class);
