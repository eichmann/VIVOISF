...
public class BFO_0000002HasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002HasTitleIterator.getType());
		} catch (Exception e) {
