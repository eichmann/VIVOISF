...
public class BFO_0000002CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002CodeUNIterator.class);
