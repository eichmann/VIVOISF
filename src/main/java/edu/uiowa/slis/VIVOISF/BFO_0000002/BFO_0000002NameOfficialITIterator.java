...
public class BFO_0000002NameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameOfficialITIterator.class);
