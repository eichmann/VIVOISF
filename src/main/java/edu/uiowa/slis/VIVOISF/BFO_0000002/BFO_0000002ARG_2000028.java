...
public class BFO_0000002ARG_2000028 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002ARG_2000028 currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002ARG_2000028.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002ARG_2000028Iterator.getARG_2000028());
		} catch (Exception e) {
