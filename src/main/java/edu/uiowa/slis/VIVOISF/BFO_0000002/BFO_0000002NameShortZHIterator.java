...
public class BFO_0000002NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameShortZHIterator.class);
