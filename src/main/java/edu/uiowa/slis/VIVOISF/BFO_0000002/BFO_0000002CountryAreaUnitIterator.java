...
public class BFO_0000002CountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002CountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002CountryAreaUnitIterator.class);
