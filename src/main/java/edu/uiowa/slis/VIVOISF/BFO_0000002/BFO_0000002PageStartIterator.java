...
public class BFO_0000002PageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002PageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002PageStartIterator.class);
