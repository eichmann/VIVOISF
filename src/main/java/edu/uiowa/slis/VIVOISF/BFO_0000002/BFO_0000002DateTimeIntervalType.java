...
public class BFO_0000002DateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002DateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002DateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002DateTimeIntervalIterator.getType());
		} catch (Exception e) {
