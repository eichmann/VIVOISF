...
public class BFO_0000002NameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameShortARIterator.class);
