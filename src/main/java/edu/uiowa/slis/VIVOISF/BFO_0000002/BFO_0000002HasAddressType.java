...
public class BFO_0000002HasAddressType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasAddressType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasAddressType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002HasAddressIterator.getType());
		} catch (Exception e) {
