...
public class BFO_0000002NameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameOfficialFRIterator.class);
