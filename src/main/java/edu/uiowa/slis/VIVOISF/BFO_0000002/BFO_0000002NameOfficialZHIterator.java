...
public class BFO_0000002NameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameOfficialZHIterator.class);
