...
public class BFO_0000002HasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasMinLongitudeIterator.class);
