...
public class BFO_0000002HasEmail extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasEmail currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasEmail.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002HasEmailIterator.getHasEmail());
		} catch (Exception e) {
