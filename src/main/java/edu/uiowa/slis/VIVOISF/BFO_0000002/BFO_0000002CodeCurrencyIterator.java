...
public class BFO_0000002CodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002CodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002CodeCurrencyIterator.class);
