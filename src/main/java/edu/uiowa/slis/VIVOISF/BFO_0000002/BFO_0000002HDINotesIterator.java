...
public class BFO_0000002HDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HDINotesIterator.class);
