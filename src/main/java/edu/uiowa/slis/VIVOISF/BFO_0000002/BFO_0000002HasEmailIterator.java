...
public class BFO_0000002HasEmailIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasEmailIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasEmailIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000002HasEmailIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000002HasEmailIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000002HasEmailIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000002HasEmailIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000002HasEmail doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000002HasEmail doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000002HasEmailIterator");
