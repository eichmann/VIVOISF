...
public class BFO_0000002IdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002IdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002IdentifierIterator.class);
