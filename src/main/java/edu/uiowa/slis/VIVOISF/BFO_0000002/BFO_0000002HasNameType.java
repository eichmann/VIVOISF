...
public class BFO_0000002HasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002HasNameIterator.getType());
		} catch (Exception e) {
