...
public class BFO_0000002HasGeoType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasGeoType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasGeoType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002HasGeoIterator.getType());
		} catch (Exception e) {
