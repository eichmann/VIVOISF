...
public class BFO_0000002HDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HDIYearIterator.class);
