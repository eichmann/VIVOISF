...
public class BFO_0000002EissnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002EissnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002EissnIterator.class);
