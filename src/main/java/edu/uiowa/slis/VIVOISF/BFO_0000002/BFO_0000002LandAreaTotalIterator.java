...
public class BFO_0000002LandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002LandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002LandAreaTotalIterator.class);
