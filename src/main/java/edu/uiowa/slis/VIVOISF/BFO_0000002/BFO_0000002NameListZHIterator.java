...
public class BFO_0000002NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameListZHIterator.class);
