...
public class BFO_0000002CodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002CodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002CodeFAOTERMIterator.class);
