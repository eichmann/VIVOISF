...
public class BFO_0000002GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002GDPYearIterator.class);
