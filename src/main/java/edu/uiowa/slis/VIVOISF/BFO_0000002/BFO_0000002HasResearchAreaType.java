...
public class BFO_0000002HasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002HasResearchAreaIterator.getType());
		} catch (Exception e) {
