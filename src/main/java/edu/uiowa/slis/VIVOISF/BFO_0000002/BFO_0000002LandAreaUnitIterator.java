...
public class BFO_0000002LandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002LandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002LandAreaUnitIterator.class);
