...
public class BFO_0000002HasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002HasPublicationVenueIterator.getType());
		} catch (Exception e) {
