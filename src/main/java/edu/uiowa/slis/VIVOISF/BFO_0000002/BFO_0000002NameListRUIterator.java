...
public class BFO_0000002NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameListRUIterator.class);
