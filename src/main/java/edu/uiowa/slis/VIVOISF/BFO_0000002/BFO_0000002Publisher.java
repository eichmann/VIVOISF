...
public class BFO_0000002Publisher extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002Publisher currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002Publisher.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002PublisherIterator.getPublisher());
		} catch (Exception e) {
