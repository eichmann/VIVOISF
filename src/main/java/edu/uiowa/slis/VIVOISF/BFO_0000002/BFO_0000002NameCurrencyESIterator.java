...
public class BFO_0000002NameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameCurrencyESIterator.class);
