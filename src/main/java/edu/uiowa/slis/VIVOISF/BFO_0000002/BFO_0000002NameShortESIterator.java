...
public class BFO_0000002NameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameShortESIterator.class);
