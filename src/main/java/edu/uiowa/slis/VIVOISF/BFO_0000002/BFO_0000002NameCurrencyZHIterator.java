...
public class BFO_0000002NameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameCurrencyZHIterator.class);
