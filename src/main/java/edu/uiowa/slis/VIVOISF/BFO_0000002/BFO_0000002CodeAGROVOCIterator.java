...
public class BFO_0000002CodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002CodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002CodeAGROVOCIterator.class);
