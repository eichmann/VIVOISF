...
public class BFO_0000002NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameListITIterator.class);
