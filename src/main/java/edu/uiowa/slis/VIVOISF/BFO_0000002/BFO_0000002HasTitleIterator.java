...
public class BFO_0000002HasTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasTitleIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000002HasTitleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000002HasTitleIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000002HasTitleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000002HasTitleIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000002HasTitle doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000002HasTitle doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000002HasTitleIterator");
