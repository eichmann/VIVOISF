...
public class BFO_0000002PageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002PageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002PageEndIterator.class);
