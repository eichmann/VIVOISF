...
public class BFO_0000002HasURLType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasURLType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasURLType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002HasURLIterator.getType());
		} catch (Exception e) {
