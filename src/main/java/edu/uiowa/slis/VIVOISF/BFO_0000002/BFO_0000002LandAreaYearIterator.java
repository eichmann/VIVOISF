...
public class BFO_0000002LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002LandAreaYearIterator.class);
