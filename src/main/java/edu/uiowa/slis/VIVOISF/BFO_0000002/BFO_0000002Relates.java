...
public class BFO_0000002Relates extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002Relates currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002Relates.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002RelatesIterator.getRelates());
		} catch (Exception e) {
