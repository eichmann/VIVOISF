...
public class BFO_0000002NumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NumPagesIterator.class);
