...
public class BFO_0000002NameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameListFRIterator.class);
