...
public class BFO_0000002HasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasMaxLongitudeIterator.class);
