...
public class BFO_0000002CodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002CodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002CodeUNDPIterator.class);
