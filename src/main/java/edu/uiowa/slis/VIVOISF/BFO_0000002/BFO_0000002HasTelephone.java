...
public class BFO_0000002HasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000002HasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
