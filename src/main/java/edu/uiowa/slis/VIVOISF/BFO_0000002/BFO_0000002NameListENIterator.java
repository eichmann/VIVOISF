...
public class BFO_0000002NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002NameListENIterator.class);
