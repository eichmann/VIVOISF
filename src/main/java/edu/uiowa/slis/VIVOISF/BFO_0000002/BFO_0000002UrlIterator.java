...
public class BFO_0000002UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002UrlIterator.class);
