...
public class BFO_0000002HasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000002HasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000002HasMaxLatitudeIterator.class);
