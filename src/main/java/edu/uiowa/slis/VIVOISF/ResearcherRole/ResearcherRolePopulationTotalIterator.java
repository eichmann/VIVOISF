...
public class ResearcherRolePopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRolePopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRolePopulationTotalIterator.class);
