...
public class ResearcherRoleGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleGDPUnitIterator.class);
