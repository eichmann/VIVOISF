...
public class ResearcherRoleNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameCurrencyRUIterator.class);
