...
public class ResearcherRoleNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameShortZHIterator.class);
