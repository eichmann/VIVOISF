...
public class ResearcherRoleHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleHasMaxLatitudeIterator.class);
