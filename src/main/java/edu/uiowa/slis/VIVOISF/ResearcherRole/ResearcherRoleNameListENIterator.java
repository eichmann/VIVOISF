...
public class ResearcherRoleNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameListENIterator.class);
