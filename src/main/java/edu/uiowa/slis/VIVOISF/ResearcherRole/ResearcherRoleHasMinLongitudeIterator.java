...
public class ResearcherRoleHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleHasMinLongitudeIterator.class);
