...
public class ResearcherRoleNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameCurrencyENIterator.class);
