...
public class ResearcherRoleNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameOfficialENIterator.class);
