...
public class ResearcherRoleCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCountryAreaUnitIterator.class);
