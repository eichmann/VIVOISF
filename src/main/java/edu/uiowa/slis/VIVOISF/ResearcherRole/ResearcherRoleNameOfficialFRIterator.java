...
public class ResearcherRoleNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameOfficialFRIterator.class);
