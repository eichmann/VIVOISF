...
public class ResearcherRoleNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNationalityENIterator.class);
