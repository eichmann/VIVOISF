...
public class ResearcherRoleCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCodeAGROVOCIterator.class);
