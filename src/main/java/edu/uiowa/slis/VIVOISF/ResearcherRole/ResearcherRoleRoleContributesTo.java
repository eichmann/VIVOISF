...
public class ResearcherRoleRoleContributesTo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleRoleContributesTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleRoleContributesTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearcherRoleRoleContributesToIterator.getRoleContributesTo());
		} catch (Exception e) {
