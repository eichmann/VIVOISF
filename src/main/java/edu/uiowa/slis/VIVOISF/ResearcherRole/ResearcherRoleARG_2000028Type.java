...
public class ResearcherRoleARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearcherRoleARG_2000028Iterator.getType());
		} catch (Exception e) {
