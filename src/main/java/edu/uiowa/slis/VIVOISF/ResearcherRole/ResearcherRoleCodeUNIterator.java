...
public class ResearcherRoleCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCodeUNIterator.class);
