...
public class ResearcherRoleNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameShortARIterator.class);
