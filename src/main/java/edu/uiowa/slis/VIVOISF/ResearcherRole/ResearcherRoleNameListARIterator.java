...
public class ResearcherRoleNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameListARIterator.class);
