...
public class ResearcherRoleNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameCurrencyARIterator.class);
