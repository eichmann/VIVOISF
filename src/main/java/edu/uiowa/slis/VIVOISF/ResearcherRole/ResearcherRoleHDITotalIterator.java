...
public class ResearcherRoleHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleHDITotalIterator.class);
