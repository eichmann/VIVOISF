...
public class ResearcherRoleCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCodeCurrencyIterator.class);
