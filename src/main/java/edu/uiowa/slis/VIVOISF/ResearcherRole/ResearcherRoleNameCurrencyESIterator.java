...
public class ResearcherRoleNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameCurrencyESIterator.class);
