...
public class ResearcherRoleNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameCurrencyZHIterator.class);
