...
public class ResearcherRoleGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleGDPYearIterator.class);
