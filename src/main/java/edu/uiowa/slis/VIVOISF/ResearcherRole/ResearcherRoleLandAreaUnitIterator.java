...
public class ResearcherRoleLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleLandAreaUnitIterator.class);
