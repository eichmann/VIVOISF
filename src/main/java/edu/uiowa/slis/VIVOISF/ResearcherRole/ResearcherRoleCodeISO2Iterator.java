...
public class ResearcherRoleCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCodeISO2Iterator.class);
