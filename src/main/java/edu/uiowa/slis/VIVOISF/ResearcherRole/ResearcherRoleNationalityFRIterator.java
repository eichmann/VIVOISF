...
public class ResearcherRoleNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNationalityFRIterator.class);
