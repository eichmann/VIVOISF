...
public class ResearcherRoleHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleHasMinLatitudeIterator.class);
