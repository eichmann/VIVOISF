...
public class ResearcherRoleHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleHDIYearIterator.class);
