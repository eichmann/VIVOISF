...
public class ResearcherRoleNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameOfficialRUIterator.class);
