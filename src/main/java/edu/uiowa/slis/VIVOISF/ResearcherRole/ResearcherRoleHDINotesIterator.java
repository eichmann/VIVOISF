...
public class ResearcherRoleHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleHDINotesIterator.class);
