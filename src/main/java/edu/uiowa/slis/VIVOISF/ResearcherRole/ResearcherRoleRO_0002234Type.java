...
public class ResearcherRoleRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearcherRoleRO_0002234Iterator.getType());
		} catch (Exception e) {
