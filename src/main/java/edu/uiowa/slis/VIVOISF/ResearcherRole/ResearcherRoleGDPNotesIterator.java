...
public class ResearcherRoleGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleGDPNotesIterator.class);
