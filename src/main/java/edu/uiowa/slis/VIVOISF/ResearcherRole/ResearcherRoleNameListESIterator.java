...
public class ResearcherRoleNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameListESIterator.class);
