...
public class ResearcherRoleNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameOfficialESIterator.class);
