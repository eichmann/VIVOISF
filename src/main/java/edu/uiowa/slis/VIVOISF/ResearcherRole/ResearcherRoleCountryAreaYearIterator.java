...
public class ResearcherRoleCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCountryAreaYearIterator.class);
