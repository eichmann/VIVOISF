...
public class ResearcherRoleHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleHasMaxLongitudeIterator.class);
