...
public class ResearcherRoleDateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleDateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleDateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearcherRoleDateTimeIntervalIterator.getType());
		} catch (Exception e) {
