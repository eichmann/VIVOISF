...
public class ResearcherRoleFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleFreetextKeywordIterator.class);
