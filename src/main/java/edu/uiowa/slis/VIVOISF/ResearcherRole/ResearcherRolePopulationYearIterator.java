...
public class ResearcherRolePopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRolePopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRolePopulationYearIterator.class);
