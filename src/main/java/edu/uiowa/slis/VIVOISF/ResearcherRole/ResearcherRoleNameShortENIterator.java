...
public class ResearcherRoleNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameShortENIterator.class);
