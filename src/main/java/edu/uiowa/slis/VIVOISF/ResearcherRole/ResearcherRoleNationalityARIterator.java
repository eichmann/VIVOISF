...
public class ResearcherRoleNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNationalityARIterator.class);
