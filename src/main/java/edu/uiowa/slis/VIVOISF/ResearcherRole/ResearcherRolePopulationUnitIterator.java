...
public class ResearcherRolePopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRolePopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRolePopulationUnitIterator.class);
