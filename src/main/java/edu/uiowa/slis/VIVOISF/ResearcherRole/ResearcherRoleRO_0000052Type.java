...
public class ResearcherRoleRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearcherRoleRO_0000052Iterator.getType());
		} catch (Exception e) {
