...
public class ResearcherRoleNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameShortITIterator.class);
