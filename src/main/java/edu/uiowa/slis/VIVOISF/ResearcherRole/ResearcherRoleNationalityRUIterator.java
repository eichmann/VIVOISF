...
public class ResearcherRoleNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNationalityRUIterator.class);
