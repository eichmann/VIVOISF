...
public class ResearcherRoleNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameListRUIterator.class);
