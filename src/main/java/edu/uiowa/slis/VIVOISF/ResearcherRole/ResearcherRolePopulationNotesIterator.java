...
public class ResearcherRolePopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRolePopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRolePopulationNotesIterator.class);
