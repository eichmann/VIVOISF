...
public class ResearcherRoleNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameListITIterator.class);
