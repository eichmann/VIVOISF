...
public class ResearcherRoleCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCountryAreaTotalIterator.class);
