...
public class ResearcherRoleCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCountryAreaNotesIterator.class);
