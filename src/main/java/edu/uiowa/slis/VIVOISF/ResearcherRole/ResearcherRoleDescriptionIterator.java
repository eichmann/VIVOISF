...
public class ResearcherRoleDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleDescriptionIterator.class);
