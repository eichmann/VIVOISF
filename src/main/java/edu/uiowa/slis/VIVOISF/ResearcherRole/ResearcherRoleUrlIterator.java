...
public class ResearcherRoleUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleUrlIterator.class);
