...
public class ResearcherRoleCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCodeISO3Iterator.class);
