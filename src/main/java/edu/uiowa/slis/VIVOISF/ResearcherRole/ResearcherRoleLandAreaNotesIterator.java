...
public class ResearcherRoleLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleLandAreaNotesIterator.class);
