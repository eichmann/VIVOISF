...
public class ResearcherRoleCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCodeUNDPIterator.class);
