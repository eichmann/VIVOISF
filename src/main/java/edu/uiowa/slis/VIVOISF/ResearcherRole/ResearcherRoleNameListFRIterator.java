...
public class ResearcherRoleNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameListFRIterator.class);
