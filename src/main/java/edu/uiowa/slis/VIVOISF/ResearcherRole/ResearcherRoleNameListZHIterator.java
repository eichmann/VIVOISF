...
public class ResearcherRoleNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleNameListZHIterator.class);
