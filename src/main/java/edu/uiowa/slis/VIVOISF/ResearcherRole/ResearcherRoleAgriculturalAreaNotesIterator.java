...
public class ResearcherRoleAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleAgriculturalAreaNotesIterator.class);
