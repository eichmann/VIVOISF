...
public class ResearcherRoleCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCodeFAOTERMIterator.class);
