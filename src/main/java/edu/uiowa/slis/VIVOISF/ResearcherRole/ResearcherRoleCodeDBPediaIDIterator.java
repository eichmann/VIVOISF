...
public class ResearcherRoleCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearcherRoleCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearcherRoleCodeDBPediaIDIterator.class);
