...
public class IAO_0000300Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000300Features currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000300Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000300FeaturesIterator.getFeatures());
		} catch (Exception e) {
