...
public class InternshipBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InternshipBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(InternshipBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInternshipBFO_0000055Iterator.getType());
		} catch (Exception e) {
