...
public class ARG_2000010OBI_0000299 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000010OBI_0000299 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000010OBI_0000299.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000010OBI_0000299Iterator.getOBI_0000299());
		} catch (Exception e) {
