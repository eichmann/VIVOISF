...
public class ARG_2000010RO_0000057 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000010RO_0000057 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000010RO_0000057.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000010RO_0000057Iterator.getRO_0000057());
		} catch (Exception e) {
