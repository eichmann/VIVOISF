...
public class ConceptDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConceptDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConceptDescriptionIterator.class);
