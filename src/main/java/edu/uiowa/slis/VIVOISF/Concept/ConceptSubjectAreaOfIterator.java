...
public class ConceptSubjectAreaOfIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConceptSubjectAreaOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConceptSubjectAreaOfIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				subjectAreaOf = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
			...
			log.error("Exception raised in ConceptSubjectAreaOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConceptSubjectAreaOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ConceptSubjectAreaOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConceptSubjectAreaOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ConceptSubjectAreaOf doEndTag", e);
			throw new JspTagException("Exception raised in ConceptSubjectAreaOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setSubjectAreaOf(String theSubjectAreaOf) {
		subjectAreaOf = theSubjectAreaOf;
	}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ConceptSubjectAreaOfIterator");
