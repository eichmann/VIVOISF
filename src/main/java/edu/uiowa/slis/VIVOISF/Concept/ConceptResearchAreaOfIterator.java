...
public class ConceptResearchAreaOfIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConceptResearchAreaOfIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConceptResearchAreaOfIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				researchAreaOf = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
			...
			log.error("Exception raised in ConceptResearchAreaOfIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConceptResearchAreaOfIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ConceptResearchAreaOfIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConceptResearchAreaOfIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ConceptResearchAreaOf doEndTag", e);
			throw new JspTagException("Exception raised in ConceptResearchAreaOf doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setResearchAreaOf(String theResearchAreaOf) {
		researchAreaOf = theResearchAreaOf;
	}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ConceptResearchAreaOfIterator");
