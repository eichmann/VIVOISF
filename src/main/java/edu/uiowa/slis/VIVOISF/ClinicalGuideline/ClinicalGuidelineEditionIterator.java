...
public class ClinicalGuidelineEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineEditionIterator.class);
