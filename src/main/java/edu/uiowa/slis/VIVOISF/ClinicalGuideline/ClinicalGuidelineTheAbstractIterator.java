...
public class ClinicalGuidelineTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineTheAbstractIterator.class);
