...
public class ClinicalGuidelineLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineLccnIterator.class);
