...
public class ClinicalGuidelineHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineHandleIterator.class);
