...
public class ClinicalGuidelineGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineGtin14Iterator.class);
