...
public class ClinicalGuidelineSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineSiciIterator.class);
