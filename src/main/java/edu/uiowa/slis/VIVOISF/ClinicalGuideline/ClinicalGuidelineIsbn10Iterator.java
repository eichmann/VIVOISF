...
public class ClinicalGuidelineIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineIsbn10Iterator.class);
