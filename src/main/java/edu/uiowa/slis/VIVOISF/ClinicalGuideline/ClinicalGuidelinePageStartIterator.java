...
public class ClinicalGuidelinePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelinePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelinePageStartIterator.class);
