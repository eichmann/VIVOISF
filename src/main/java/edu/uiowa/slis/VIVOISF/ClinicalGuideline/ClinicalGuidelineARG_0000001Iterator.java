...
public class ClinicalGuidelineARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineARG_0000001Iterator.class);
