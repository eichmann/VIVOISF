...
public class ClinicalGuidelineOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineOclcnumIterator.class);
