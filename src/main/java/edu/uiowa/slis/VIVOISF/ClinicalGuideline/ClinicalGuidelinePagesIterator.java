...
public class ClinicalGuidelinePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelinePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelinePagesIterator.class);
