...
public class ClinicalGuidelineLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineLocatorIterator.class);
