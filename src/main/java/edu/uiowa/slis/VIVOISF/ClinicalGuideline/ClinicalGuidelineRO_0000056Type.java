...
public class ClinicalGuidelineRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalGuidelineRO_0000056Iterator.getType());
		} catch (Exception e) {
