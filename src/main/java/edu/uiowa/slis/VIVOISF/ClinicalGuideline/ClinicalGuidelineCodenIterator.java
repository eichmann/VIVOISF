...
public class ClinicalGuidelineCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineCodenIterator.class);
