...
public class ClinicalGuidelineVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineVolumeIterator.class);
