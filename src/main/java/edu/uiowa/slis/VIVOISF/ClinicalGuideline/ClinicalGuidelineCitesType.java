...
public class ClinicalGuidelineCitesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineCitesType currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineCitesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalGuidelineCitesIterator.getType());
		} catch (Exception e) {
