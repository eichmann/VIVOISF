...
public class ClinicalGuidelineIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalGuidelineIAO_0000136Iterator.getType());
		} catch (Exception e) {
