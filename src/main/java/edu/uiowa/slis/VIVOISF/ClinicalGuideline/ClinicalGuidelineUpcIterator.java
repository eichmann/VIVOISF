...
public class ClinicalGuidelineUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineUpcIterator.class);
