...
public class ClinicalGuidelineUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineUriIterator.class);
