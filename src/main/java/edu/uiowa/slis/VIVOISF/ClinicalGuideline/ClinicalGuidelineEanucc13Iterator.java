...
public class ClinicalGuidelineEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineEanucc13Iterator.class);
