...
public class ClinicalGuidelineShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineShortTitleIterator.class);
