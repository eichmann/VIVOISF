...
public class ClinicalGuidelineContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineContentIterator.class);
