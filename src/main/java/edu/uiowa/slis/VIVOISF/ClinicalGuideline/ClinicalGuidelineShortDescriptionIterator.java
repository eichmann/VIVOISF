...
public class ClinicalGuidelineShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineShortDescriptionIterator.class);
