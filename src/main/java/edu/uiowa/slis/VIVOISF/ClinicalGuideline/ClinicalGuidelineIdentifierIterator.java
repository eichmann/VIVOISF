...
public class ClinicalGuidelineIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineIdentifierIterator.class);
