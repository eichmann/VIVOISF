...
public class ClinicalGuidelineIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineIsbn13Iterator.class);
