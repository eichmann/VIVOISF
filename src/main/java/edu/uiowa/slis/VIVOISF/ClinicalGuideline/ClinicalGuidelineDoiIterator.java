...
public class ClinicalGuidelineDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineDoiIterator.class);
