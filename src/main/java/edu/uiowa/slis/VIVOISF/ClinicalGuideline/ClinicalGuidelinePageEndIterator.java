...
public class ClinicalGuidelinePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelinePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelinePageEndIterator.class);
