...
public class ClinicalGuidelineNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalGuidelineNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalGuidelineNumberIterator.class);
