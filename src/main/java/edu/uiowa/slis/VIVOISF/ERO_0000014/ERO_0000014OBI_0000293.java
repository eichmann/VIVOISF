...
public class ERO_0000014OBI_0000293 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000014OBI_0000293 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000014OBI_0000293.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000014OBI_0000293Iterator.getOBI_0000293());
		} catch (Exception e) {
