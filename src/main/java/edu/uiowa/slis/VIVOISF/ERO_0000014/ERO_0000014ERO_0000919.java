...
public class ERO_0000014ERO_0000919 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000014ERO_0000919 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000014ERO_0000919.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000014ERO_0000919Iterator.getERO_0000919());
		} catch (Exception e) {
