...
public class ERO_0000014RO_0000057 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000014RO_0000057 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000014RO_0000057.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000014RO_0000057Iterator.getRO_0000057());
		} catch (Exception e) {
