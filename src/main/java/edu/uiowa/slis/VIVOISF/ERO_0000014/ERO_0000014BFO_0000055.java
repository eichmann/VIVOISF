...
public class ERO_0000014BFO_0000055 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000014BFO_0000055 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000014BFO_0000055.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000014BFO_0000055Iterator.getBFO_0000055());
		} catch (Exception e) {
