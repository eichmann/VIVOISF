...
public class ERO_0000014OBI_0000299 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000014OBI_0000299 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000014OBI_0000299.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000014OBI_0000299Iterator.getOBI_0000299());
		} catch (Exception e) {
