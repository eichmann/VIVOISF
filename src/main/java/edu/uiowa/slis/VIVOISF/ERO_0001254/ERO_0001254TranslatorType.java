...
public class ERO_0001254TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001254TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001254TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001254TranslatorIterator.getType());
		} catch (Exception e) {
