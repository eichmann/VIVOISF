...
public class RelationshipCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCodeISO3Iterator.class);
