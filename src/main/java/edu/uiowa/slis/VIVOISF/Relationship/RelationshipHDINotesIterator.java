...
public class RelationshipHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipHDINotesIterator.class);
