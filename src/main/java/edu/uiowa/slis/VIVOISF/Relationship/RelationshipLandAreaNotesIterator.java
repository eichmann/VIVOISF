...
public class RelationshipLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipLandAreaNotesIterator.class);
