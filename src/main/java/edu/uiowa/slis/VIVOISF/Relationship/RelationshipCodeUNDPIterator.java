...
public class RelationshipCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCodeUNDPIterator.class);
