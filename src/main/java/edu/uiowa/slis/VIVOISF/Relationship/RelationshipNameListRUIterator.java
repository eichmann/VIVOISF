...
public class RelationshipNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameListRUIterator.class);
