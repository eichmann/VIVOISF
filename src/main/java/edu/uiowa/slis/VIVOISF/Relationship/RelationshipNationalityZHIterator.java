...
public class RelationshipNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNationalityZHIterator.class);
