...
public class RelationshipHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipHasMaxLatitudeIterator.class);
