...
public class RelationshipCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCodeDBPediaIDIterator.class);
