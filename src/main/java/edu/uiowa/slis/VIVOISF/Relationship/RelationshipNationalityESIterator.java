...
public class RelationshipNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNationalityESIterator.class);
