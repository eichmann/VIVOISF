...
public class RelationshipCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCodeFAOTERMIterator.class);
