...
public class RelationshipGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipGDPUnitIterator.class);
