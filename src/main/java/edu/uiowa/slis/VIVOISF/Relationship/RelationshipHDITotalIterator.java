...
public class RelationshipHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipHDITotalIterator.class);
