...
public class RelationshipHasURLType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipHasURLType currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipHasURLType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theRelationshipHasURLIterator.getType());
		} catch (Exception e) {
