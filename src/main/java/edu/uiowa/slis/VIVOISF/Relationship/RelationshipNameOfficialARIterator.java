...
public class RelationshipNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameOfficialARIterator.class);
