...
public class Relationship extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Relationship currentInstance = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			RelationshipIterator theRelationshipIterator = (RelationshipIterator) findAncestorWithClass(this, RelationshipIterator.class);

			if (theRelationshipIterator != null) {
				subjectURI = theRelationshipIterator.getSubjectURI();
				label = theRelationshipIterator.getLabel();
			}
			...
			if (theRelationshipIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in Relationship doStartTag", e);
			throw new JspTagException("Exception raised in Relationship doStartTag");
		} finally {
			freeConnection();
		}
