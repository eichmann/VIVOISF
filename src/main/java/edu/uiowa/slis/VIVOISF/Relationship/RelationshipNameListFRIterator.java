...
public class RelationshipNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameListFRIterator.class);
