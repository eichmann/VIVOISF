...
public class RelationshipFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipFreetextKeywordIterator.class);
