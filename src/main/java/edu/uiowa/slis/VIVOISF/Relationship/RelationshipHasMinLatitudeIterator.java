...
public class RelationshipHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipHasMinLatitudeIterator.class);
