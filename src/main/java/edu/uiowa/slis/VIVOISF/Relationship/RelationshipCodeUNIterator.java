...
public class RelationshipCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCodeUNIterator.class);
