...
public class RelationshipGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipGDPNotesIterator.class);
