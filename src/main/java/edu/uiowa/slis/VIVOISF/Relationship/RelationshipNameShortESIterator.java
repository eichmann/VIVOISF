...
public class RelationshipNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameShortESIterator.class);
