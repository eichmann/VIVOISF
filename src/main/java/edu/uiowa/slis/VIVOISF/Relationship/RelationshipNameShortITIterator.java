...
public class RelationshipNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameShortITIterator.class);
