...
public class RelationshipLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipLandAreaTotalIterator.class);
