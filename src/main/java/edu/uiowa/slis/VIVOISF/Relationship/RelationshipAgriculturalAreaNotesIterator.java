...
public class RelationshipAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipAgriculturalAreaNotesIterator.class);
