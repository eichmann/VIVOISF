...
public class RelationshipNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameCurrencyENIterator.class);
