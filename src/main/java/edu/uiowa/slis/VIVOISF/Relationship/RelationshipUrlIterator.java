...
public class RelationshipUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipUrlIterator.class);
