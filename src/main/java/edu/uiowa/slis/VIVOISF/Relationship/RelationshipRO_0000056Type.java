...
public class RelationshipRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theRelationshipRO_0000056Iterator.getType());
		} catch (Exception e) {
