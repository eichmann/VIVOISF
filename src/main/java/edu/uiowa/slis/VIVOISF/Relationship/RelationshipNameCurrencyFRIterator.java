...
public class RelationshipNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameCurrencyFRIterator.class);
