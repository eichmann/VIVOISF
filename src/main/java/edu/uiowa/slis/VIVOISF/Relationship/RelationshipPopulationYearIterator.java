...
public class RelationshipPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipPopulationYearIterator.class);
