...
public class RelationshipNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameOfficialZHIterator.class);
