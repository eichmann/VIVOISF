...
public class RelationshipRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in RelationshipRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RelationshipRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in RelationshipRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RelationshipRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in RelationshipRelates doEndTag", e);
			throw new JspTagException("Exception raised in RelationshipRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to RelationshipRelatesIterator");
