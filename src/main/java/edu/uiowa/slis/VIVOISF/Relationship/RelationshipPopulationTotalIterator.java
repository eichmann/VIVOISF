...
public class RelationshipPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipPopulationTotalIterator.class);
