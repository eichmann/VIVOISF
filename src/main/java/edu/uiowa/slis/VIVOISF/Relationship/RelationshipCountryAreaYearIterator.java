...
public class RelationshipCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCountryAreaYearIterator.class);
