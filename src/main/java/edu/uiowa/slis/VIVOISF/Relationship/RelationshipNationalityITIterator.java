...
public class RelationshipNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNationalityITIterator.class);
