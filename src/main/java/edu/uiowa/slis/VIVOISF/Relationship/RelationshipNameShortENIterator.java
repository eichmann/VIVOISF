...
public class RelationshipNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameShortENIterator.class);
