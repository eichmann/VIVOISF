...
public class RelationshipNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameCurrencyZHIterator.class);
