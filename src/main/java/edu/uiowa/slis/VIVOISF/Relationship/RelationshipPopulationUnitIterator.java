...
public class RelationshipPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipPopulationUnitIterator.class);
