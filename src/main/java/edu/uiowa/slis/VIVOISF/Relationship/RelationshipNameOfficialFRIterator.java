...
public class RelationshipNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameOfficialFRIterator.class);
