...
public class RelationshipAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipAgriculturalAreaTotalIterator.class);
