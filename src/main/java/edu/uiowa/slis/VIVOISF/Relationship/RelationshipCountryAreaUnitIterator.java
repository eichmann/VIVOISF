...
public class RelationshipCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCountryAreaUnitIterator.class);
