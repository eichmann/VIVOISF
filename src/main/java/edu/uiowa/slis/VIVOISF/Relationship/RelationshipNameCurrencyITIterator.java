...
public class RelationshipNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameCurrencyITIterator.class);
