...
public class RelationshipCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCodeFAOSTATIterator.class);
