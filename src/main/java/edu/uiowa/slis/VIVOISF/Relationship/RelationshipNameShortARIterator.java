...
public class RelationshipNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameShortARIterator.class);
