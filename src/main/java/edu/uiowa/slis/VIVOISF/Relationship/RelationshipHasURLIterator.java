...
public class RelationshipHasURLIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipHasURLIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipHasURLIterator.class);
...
//					continue;
			...
			log.error("Exception raised in RelationshipHasURLIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RelationshipHasURLIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in RelationshipHasURLIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RelationshipHasURLIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in RelationshipHasURL doEndTag", e);
			throw new JspTagException("Exception raised in RelationshipHasURL doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to RelationshipHasURLIterator");
