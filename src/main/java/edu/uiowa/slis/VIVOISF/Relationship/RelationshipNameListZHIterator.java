...
public class RelationshipNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameListZHIterator.class);
