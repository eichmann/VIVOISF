...
public class RelationshipNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameOfficialITIterator.class);
