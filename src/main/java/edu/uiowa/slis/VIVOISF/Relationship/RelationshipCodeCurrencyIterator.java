...
public class RelationshipCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCodeCurrencyIterator.class);
