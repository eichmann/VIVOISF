...
public class RelationshipNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameOfficialENIterator.class);
