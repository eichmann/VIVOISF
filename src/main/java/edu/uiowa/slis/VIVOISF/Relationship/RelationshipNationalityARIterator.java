...
public class RelationshipNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNationalityARIterator.class);
