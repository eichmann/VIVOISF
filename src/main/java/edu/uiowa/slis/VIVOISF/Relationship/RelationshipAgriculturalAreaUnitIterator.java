...
public class RelationshipAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipAgriculturalAreaUnitIterator.class);
