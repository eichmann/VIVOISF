...
public class RelationshipNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameListITIterator.class);
