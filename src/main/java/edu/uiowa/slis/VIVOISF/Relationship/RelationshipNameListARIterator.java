...
public class RelationshipNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameListARIterator.class);
