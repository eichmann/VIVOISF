...
public class RelationshipIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Relationship> . "+
