...
public class RelationshipNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameCurrencyESIterator.class);
