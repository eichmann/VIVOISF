...
public class RelationshipNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNationalityRUIterator.class);
