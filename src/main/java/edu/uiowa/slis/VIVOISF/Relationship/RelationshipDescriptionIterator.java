...
public class RelationshipDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipDescriptionIterator.class);
