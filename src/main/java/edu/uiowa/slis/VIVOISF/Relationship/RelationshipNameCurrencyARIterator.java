...
public class RelationshipNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameCurrencyARIterator.class);
