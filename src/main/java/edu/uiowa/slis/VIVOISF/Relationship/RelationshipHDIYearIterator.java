...
public class RelationshipHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipHDIYearIterator.class);
