...
public class RelationshipHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipHasMaxLongitudeIterator.class);
