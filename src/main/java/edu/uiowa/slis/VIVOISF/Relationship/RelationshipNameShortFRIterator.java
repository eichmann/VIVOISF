...
public class RelationshipNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameShortFRIterator.class);
