...
public class RelationshipCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCodeAGROVOCIterator.class);
