...
public class RelationshipGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipGDPYearIterator.class);
