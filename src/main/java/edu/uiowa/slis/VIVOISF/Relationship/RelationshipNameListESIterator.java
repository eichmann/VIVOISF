...
public class RelationshipNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameListESIterator.class);
