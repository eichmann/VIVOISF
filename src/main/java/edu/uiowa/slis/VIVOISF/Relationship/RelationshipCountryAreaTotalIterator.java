...
public class RelationshipCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCountryAreaTotalIterator.class);
