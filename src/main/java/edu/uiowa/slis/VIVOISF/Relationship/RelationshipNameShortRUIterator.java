...
public class RelationshipNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipNameShortRUIterator.class);
