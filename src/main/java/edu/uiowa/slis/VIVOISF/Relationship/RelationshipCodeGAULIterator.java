...
public class RelationshipCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipCodeGAULIterator.class);
