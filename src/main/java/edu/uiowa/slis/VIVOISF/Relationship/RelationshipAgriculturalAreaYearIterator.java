...
public class RelationshipAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelationshipAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelationshipAgriculturalAreaYearIterator.class);
