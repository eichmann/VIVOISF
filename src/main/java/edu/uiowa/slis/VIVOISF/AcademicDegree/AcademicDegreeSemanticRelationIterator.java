...
public class AcademicDegreeSemanticRelationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicDegreeSemanticRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicDegreeSemanticRelationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AcademicDegreeSemanticRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AcademicDegreeSemanticRelationIterator doStartTag");
		}
