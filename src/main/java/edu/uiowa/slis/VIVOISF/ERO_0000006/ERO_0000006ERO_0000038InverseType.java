...
public class ERO_0000006ERO_0000038InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000006ERO_0000038InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000006ERO_0000038InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000006ERO_0000038InverseIterator.getType());
		} catch (Exception e) {
