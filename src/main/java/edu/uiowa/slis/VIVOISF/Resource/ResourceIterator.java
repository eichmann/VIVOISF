...
public class ResourceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResourceIterator currentInstance = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.w3.org/2000/01/rdf-schema#Resource> . "+
