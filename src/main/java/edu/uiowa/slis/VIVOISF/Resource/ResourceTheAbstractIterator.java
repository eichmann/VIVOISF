...
public class ResourceTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResourceTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResourceTheAbstractIterator.class);
