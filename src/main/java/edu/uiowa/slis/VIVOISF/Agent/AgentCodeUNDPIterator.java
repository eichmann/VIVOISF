...
public class AgentCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCodeUNDPIterator.class);
