...
public class AgentNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNationalityENIterator.class);
