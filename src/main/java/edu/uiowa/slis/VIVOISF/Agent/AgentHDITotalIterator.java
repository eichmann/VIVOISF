...
public class AgentHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentHDITotalIterator.class);
