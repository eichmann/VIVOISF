...
public class AgentNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameShortITIterator.class);
