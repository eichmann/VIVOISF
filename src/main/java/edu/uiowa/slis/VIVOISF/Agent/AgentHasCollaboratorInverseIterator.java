...
public class AgentHasCollaboratorInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentHasCollaboratorInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentHasCollaboratorInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AgentHasCollaboratorInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentHasCollaboratorInverseIterator doStartTag");
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AgentHasCollaboratorIterator");
