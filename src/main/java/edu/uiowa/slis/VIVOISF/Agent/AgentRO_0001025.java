...
public class AgentRO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentRO_0001025 currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentRO_0001025.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAgentRO_0001025Iterator.getRO_0001025());
		} catch (Exception e) {
