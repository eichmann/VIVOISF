...
public class AgentNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameCurrencyESIterator.class);
