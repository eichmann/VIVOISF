...
public class AgentGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentGDPNotesIterator.class);
