...
public class AgentNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameCurrencyARIterator.class);
