...
public class AgentAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentAgriculturalAreaUnitIterator.class);
