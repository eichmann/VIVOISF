...
public class AgentRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentRankIterator.class);
