...
public class AgentNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameCurrencyFRIterator.class);
