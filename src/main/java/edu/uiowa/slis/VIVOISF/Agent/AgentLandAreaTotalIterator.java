...
public class AgentLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentLandAreaTotalIterator.class);
