...
public class AgentNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameOfficialESIterator.class);
