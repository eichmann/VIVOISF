...
public class AgentDirectorInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentDirectorInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentDirectorInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAgentDirectorInverseIterator.getDirectorInverse());
		} catch (Exception e) {
