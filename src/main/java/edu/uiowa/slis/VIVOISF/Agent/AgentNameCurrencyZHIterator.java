...
public class AgentNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameCurrencyZHIterator.class);
