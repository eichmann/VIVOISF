...
public class AgentNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameListZHIterator.class);
