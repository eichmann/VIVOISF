...
public class AgentNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameListFRIterator.class);
