...
public class AgentCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCodeGAULIterator.class);
