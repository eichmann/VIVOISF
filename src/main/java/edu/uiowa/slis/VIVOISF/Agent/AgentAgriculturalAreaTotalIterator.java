...
public class AgentAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentAgriculturalAreaTotalIterator.class);
