...
public class AgentDateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentDateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentDateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAgentDateTimeIntervalIterator.getType());
		} catch (Exception e) {
