...
public class AgentNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameListENIterator.class);
