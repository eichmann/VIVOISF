...
public class AgentNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNationalityZHIterator.class);
