...
public class AgentRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAgentRO_0000056Iterator.getType());
		} catch (Exception e) {
