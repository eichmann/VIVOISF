...
public class AgentPublicationVenueForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentPublicationVenueForType currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentPublicationVenueForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAgentPublicationVenueForIterator.getType());
		} catch (Exception e) {
