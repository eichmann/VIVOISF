...
public class AgentLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentLandAreaUnitIterator.class);
