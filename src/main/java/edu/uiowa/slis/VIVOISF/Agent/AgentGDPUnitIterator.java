...
public class AgentGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentGDPUnitIterator.class);
