...
public class AgentNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameListITIterator.class);
