...
public class AgentPublisherIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentPublisherIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentPublisherIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AgentPublisherIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentPublisherIterator doStartTag");
		}
