...
public class AgentNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameShortENIterator.class);
