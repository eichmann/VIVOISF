...
public class AgentNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameShortRUIterator.class);
