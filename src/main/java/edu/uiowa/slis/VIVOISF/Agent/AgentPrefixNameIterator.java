...
public class AgentPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentPrefixNameIterator.class);
