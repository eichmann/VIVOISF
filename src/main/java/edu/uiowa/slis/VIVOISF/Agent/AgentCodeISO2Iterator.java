...
public class AgentCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCodeISO2Iterator.class);
