...
public class AgentUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentUrlIterator.class);
