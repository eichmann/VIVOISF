...
public class AgentNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameOfficialFRIterator.class);
