...
public class AgentNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNationalityRUIterator.class);
