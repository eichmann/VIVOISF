...
public class AgentCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCountryAreaUnitIterator.class);
