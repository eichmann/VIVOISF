...
public class AgentNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameOfficialZHIterator.class);
