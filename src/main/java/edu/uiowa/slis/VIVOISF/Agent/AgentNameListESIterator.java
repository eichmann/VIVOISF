...
public class AgentNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameListESIterator.class);
