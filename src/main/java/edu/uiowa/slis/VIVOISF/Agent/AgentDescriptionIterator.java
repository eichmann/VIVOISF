...
public class AgentDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentDescriptionIterator.class);
