...
public class AgentNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameCurrencyITIterator.class);
