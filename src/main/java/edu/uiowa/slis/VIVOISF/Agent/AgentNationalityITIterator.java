...
public class AgentNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNationalityITIterator.class);
