...
public class AgentPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentPopulationYearIterator.class);
