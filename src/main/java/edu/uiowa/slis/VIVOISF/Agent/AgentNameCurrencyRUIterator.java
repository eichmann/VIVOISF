...
public class AgentNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameCurrencyRUIterator.class);
