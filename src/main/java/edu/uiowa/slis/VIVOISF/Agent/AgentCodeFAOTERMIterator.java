...
public class AgentCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCodeFAOTERMIterator.class);
