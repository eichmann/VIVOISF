...
public class AgentCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCountryAreaTotalIterator.class);
