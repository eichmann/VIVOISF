...
public class AgentPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentPopulationTotalIterator.class);
