...
public class AgentCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCodeDBPediaIDIterator.class);
