...
public class AgentHasCollaboratorInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentHasCollaboratorInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentHasCollaboratorInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAgentHasCollaboratorInverseIterator.getType());
		} catch (Exception e) {
