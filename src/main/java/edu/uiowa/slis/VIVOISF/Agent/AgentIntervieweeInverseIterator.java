...
public class AgentIntervieweeInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentIntervieweeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentIntervieweeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AgentIntervieweeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentIntervieweeInverseIterator doStartTag");
		}
