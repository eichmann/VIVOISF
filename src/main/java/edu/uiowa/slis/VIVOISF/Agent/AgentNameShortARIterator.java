...
public class AgentNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameShortARIterator.class);
