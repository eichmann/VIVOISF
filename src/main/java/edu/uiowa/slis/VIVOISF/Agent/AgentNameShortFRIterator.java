...
public class AgentNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameShortFRIterator.class);
