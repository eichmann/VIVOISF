...
public class AgentRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentRelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentRelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AgentRelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AgentRelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AgentRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AgentRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in AgentRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AgentRelatedByIterator");
