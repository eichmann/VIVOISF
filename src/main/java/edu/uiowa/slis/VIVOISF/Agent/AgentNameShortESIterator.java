...
public class AgentNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameShortESIterator.class);
