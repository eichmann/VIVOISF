...
public class AgentLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentLandAreaNotesIterator.class);
