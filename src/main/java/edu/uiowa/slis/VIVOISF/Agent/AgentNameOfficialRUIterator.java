...
public class AgentNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameOfficialRUIterator.class);
