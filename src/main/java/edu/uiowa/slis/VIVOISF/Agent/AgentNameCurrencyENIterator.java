...
public class AgentNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameCurrencyENIterator.class);
