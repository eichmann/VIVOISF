...
public class AgentCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCodeAGROVOCIterator.class);
