...
public class AgentNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameOfficialITIterator.class);
