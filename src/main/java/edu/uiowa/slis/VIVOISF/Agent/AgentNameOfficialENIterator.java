...
public class AgentNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameOfficialENIterator.class);
