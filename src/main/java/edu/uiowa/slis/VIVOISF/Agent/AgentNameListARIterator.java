...
public class AgentNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameListARIterator.class);
