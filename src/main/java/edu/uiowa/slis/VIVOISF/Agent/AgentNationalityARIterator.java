...
public class AgentNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNationalityARIterator.class);
