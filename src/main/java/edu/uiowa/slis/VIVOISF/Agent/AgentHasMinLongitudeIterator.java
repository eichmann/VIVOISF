...
public class AgentHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentHasMinLongitudeIterator.class);
