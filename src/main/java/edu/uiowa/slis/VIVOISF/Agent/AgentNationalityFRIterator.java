...
public class AgentNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNationalityFRIterator.class);
