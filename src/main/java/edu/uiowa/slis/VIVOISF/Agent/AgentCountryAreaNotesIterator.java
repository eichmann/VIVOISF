...
public class AgentCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCountryAreaNotesIterator.class);
