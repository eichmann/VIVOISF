...
public class AgentNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameOfficialARIterator.class);
