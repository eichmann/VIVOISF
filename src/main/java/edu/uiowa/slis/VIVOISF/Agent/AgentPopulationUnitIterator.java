...
public class AgentPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentPopulationUnitIterator.class);
