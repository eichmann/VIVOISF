...
public class AgentCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCodeUNIterator.class);
