...
public class AgentCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentCountryAreaYearIterator.class);
