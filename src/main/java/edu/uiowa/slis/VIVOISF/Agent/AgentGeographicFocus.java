...
public class AgentGeographicFocus extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentGeographicFocus currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentGeographicFocus.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAgentGeographicFocusIterator.getGeographicFocus());
		} catch (Exception e) {
