...
public class AgentAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentAgriculturalAreaYearIterator.class);
