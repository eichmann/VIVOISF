...
public class AgentLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentLandAreaYearIterator.class);
