...
public class AgentHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentHDIYearIterator.class);
