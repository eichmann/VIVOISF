...
public class AgentSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentSuffixNameIterator.class);
