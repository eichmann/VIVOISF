...
public class AgentNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentNameShortZHIterator.class);
