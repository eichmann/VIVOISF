...
public class AgentHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentHasMinLatitudeIterator.class);
