...
public class AgentHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AgentHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AgentHDINotesIterator.class);
