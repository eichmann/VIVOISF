...
public class LibraryOBI_0000304Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibraryOBI_0000304Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(LibraryOBI_0000304Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibraryOBI_0000304InverseIterator.getOBI_0000304Inverse());
		} catch (Exception e) {
