...
public class LibraryDirectorInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibraryDirectorInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(LibraryDirectorInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibraryDirectorInverseIterator.getDirectorInverse());
		} catch (Exception e) {
