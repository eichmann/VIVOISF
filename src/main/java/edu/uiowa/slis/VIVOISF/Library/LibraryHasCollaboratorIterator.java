...
public class LibraryHasCollaboratorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibraryHasCollaboratorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibraryHasCollaboratorIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LibraryHasCollaboratorIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LibraryHasCollaboratorIterator doStartTag");
		}
