...
public class LibraryRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibraryRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LibraryRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibraryRO_0000053Iterator.getType());
		} catch (Exception e) {
