...
public class LibraryAssigneeForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibraryAssigneeForType currentInstance = null;
	private static final Log log = LogFactory.getLog(LibraryAssigneeForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibraryAssigneeForIterator.getType());
		} catch (Exception e) {
