...
public class LibraryHasSuccessorOrganizationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibraryHasSuccessorOrganizationType currentInstance = null;
	private static final Log log = LogFactory.getLog(LibraryHasSuccessorOrganizationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibraryHasSuccessorOrganizationIterator.getType());
		} catch (Exception e) {
