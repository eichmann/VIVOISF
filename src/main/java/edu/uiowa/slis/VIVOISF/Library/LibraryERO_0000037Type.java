...
public class LibraryERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibraryERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LibraryERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibraryERO_0000037Iterator.getType());
		} catch (Exception e) {
