...
public class ARG_2000011OBI_0000417Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000011OBI_0000417Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000011OBI_0000417Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000011OBI_0000417Iterator.getType());
		} catch (Exception e) {
