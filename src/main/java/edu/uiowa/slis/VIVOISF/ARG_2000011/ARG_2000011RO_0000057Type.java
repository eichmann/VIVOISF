...
public class ARG_2000011RO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000011RO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000011RO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000011RO_0000057Iterator.getType());
		} catch (Exception e) {
