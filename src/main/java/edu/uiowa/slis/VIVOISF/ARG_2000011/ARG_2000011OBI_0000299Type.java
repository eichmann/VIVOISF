...
public class ARG_2000011OBI_0000299Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000011OBI_0000299Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000011OBI_0000299Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000011OBI_0000299Iterator.getType());
		} catch (Exception e) {
