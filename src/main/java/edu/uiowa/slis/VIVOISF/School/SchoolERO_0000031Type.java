...
public class SchoolERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SchoolERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SchoolERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSchoolERO_0000031Iterator.getType());
		} catch (Exception e) {
