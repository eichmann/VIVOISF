...
public class SchoolInterviewerInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SchoolInterviewerInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SchoolInterviewerInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SchoolInterviewerInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SchoolInterviewerInverseIterator doStartTag");
		}
