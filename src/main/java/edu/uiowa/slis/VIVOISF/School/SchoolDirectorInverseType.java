...
public class SchoolDirectorInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SchoolDirectorInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(SchoolDirectorInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSchoolDirectorInverseIterator.getType());
		} catch (Exception e) {
