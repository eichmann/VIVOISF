...
public class SchoolIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SchoolIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SchoolIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#School> . "+
