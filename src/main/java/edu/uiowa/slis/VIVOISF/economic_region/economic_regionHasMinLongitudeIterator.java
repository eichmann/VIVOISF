...
public class economic_regionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHasMinLongitudeIterator.class);
