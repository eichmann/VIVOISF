...
public class economic_regionCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCodeUNIterator.class);
