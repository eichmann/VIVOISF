...
public class economic_regionCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCodeGAULIterator.class);
