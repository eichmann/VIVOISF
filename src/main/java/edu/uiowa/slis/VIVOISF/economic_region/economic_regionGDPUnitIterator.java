...
public class economic_regionGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionGDPUnitIterator.class);
