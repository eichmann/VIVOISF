...
public class economic_regionPublicationVenueFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionPublicationVenueFor currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionPublicationVenueFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theeconomic_regionPublicationVenueForIterator.getPublicationVenueFor());
		} catch (Exception e) {
