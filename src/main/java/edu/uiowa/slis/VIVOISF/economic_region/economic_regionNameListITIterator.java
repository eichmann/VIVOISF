...
public class economic_regionNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameListITIterator.class);
