...
public class economic_regionNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameListESIterator.class);
