...
public class economic_regionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCodeDBPediaIDIterator.class);
