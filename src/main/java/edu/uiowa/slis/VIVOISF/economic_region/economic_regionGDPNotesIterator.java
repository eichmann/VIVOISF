...
public class economic_regionGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionGDPNotesIterator.class);
