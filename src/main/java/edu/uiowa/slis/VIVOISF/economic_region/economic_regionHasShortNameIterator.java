...
public class economic_regionHasShortNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHasShortNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHasShortNameIterator.class);
