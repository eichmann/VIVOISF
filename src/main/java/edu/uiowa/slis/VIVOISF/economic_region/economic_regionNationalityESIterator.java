...
public class economic_regionNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNationalityESIterator.class);
