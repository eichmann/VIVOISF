...
public class economic_regionValidSinceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionValidSinceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionValidSinceIterator.class);
