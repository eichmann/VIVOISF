...
public class economic_regionPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionPopulationUnitIterator.class);
