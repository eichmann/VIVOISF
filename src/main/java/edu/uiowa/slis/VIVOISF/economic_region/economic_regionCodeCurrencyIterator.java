...
public class economic_regionCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCodeCurrencyIterator.class);
