...
public class economic_regionHasListNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHasListNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHasListNameIterator.class);
