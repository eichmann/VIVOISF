...
public class economic_regionPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionPopulationYearIterator.class);
