...
public class economic_regionCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCodeISO3Iterator.class);
