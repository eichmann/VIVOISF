...
public class economic_regionHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHDITotalIterator.class);
