...
public class economic_regionHasCodeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHasCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHasCodeIterator.class);
