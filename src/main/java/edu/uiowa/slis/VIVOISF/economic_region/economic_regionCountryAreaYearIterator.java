...
public class economic_regionCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCountryAreaYearIterator.class);
