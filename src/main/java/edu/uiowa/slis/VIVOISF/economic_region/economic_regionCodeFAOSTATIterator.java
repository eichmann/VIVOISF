...
public class economic_regionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCodeFAOSTATIterator.class);
