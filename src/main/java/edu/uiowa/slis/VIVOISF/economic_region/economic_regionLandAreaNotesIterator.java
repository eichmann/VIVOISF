...
public class economic_regionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionLandAreaNotesIterator.class);
