...
public class economic_regionNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameCurrencyITIterator.class);
