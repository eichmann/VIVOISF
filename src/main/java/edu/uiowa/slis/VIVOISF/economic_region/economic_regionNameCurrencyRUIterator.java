...
public class economic_regionNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameCurrencyRUIterator.class);
