...
public class economic_regionRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theeconomic_regionRO_0002234Iterator.getType());
		} catch (Exception e) {
