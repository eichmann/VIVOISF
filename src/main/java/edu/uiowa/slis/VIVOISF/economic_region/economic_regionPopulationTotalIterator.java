...
public class economic_regionPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionPopulationTotalIterator.class);
