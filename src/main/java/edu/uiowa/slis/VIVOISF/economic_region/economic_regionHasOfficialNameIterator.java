...
public class economic_regionHasOfficialNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHasOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHasOfficialNameIterator.class);
