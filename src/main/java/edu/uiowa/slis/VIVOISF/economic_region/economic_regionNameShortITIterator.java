...
public class economic_regionNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameShortITIterator.class);
