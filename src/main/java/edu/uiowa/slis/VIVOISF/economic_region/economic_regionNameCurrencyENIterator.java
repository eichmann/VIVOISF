...
public class economic_regionNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameCurrencyENIterator.class);
