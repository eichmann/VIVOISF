...
public class economic_regionNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameShortRUIterator.class);
