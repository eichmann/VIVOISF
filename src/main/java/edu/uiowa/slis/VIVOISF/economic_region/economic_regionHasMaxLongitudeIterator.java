...
public class economic_regionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHasMaxLongitudeIterator.class);
