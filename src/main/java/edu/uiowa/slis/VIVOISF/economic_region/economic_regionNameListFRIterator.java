...
public class economic_regionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameListFRIterator.class);
