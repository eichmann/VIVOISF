...
public class economic_regionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHDINotesIterator.class);
