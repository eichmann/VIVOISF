...
public class economic_regionNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameListRUIterator.class);
