...
public class economic_regionTelephoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionTelephoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionTelephoneIterator.class);
