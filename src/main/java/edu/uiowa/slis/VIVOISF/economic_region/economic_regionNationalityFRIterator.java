...
public class economic_regionNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNationalityFRIterator.class);
