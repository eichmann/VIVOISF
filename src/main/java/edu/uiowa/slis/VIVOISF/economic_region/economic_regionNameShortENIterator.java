...
public class economic_regionNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameShortENIterator.class);
