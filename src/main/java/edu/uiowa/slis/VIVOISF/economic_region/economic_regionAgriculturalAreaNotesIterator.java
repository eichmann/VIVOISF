...
public class economic_regionAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionAgriculturalAreaNotesIterator.class);
