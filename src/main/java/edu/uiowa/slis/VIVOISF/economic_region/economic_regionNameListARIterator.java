...
public class economic_regionNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameListARIterator.class);
