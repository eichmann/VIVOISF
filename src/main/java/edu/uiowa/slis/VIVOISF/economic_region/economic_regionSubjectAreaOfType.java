...
public class economic_regionSubjectAreaOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionSubjectAreaOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionSubjectAreaOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theeconomic_regionSubjectAreaOfIterator.getType());
		} catch (Exception e) {
