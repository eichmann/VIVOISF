...
public class economic_regionNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameCurrencyARIterator.class);
