...
public class economic_regionNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNationalityENIterator.class);
