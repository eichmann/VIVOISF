...
public class economic_regionLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionLandAreaUnitIterator.class);
