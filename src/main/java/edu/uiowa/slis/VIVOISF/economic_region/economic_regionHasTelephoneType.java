...
public class economic_regionHasTelephoneType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHasTelephoneType currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHasTelephoneType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theeconomic_regionHasTelephoneIterator.getType());
		} catch (Exception e) {
