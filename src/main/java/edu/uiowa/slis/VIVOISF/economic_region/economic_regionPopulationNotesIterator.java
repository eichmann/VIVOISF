...
public class economic_regionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionPopulationNotesIterator.class);
