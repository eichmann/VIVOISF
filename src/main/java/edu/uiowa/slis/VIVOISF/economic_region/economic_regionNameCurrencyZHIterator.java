...
public class economic_regionNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameCurrencyZHIterator.class);
