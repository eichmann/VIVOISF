...
public class economic_regionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHasMinLatitudeIterator.class);
