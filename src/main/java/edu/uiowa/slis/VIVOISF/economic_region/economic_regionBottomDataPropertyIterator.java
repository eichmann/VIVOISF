...
public class economic_regionBottomDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionBottomDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionBottomDataPropertyIterator.class);
