...
public class economic_regionGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionGDPYearIterator.class);
