...
public class economic_regionNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNationalityRUIterator.class);
