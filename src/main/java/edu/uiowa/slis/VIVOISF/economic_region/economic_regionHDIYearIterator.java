...
public class economic_regionHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHDIYearIterator.class);
