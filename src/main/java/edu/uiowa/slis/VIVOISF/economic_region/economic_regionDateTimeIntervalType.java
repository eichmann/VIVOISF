...
public class economic_regionDateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionDateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionDateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theeconomic_regionDateTimeIntervalIterator.getType());
		} catch (Exception e) {
