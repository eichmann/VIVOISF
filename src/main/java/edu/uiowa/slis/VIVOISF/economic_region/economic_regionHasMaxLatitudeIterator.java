...
public class economic_regionHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionHasMaxLatitudeIterator.class);
