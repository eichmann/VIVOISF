...
public class economic_regionNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameShortFRIterator.class);
