...
public class economic_regionCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCodeFAOTERMIterator.class);
