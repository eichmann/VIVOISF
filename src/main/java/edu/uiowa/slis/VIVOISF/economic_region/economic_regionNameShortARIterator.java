...
public class economic_regionNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameShortARIterator.class);
