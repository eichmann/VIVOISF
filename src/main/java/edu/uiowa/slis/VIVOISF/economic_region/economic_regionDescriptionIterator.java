...
public class economic_regionDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionDescriptionIterator.class);
