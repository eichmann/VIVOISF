...
public class economic_regionBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theeconomic_regionBFO_0000051Iterator.getType());
		} catch (Exception e) {
