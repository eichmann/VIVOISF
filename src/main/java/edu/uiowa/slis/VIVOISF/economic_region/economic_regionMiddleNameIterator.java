...
public class economic_regionMiddleNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionMiddleNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionMiddleNameIterator.class);
