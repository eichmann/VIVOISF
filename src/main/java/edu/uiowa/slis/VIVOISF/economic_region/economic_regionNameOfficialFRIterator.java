...
public class economic_regionNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameOfficialFRIterator.class);
