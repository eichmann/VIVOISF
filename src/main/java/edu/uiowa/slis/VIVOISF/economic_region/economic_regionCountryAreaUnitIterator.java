...
public class economic_regionCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCountryAreaUnitIterator.class);
