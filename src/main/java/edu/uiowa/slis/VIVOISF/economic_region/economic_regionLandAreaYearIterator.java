...
public class economic_regionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionLandAreaYearIterator.class);
