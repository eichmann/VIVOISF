...
public class economic_regionNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNameOfficialARIterator.class);
