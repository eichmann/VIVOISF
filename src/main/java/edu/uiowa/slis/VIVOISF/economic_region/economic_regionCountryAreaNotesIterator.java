...
public class economic_regionCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCountryAreaNotesIterator.class);
