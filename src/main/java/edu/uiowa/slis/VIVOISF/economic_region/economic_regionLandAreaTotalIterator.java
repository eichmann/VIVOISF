...
public class economic_regionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionLandAreaTotalIterator.class);
