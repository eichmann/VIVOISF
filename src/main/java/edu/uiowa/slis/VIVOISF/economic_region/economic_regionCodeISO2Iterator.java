...
public class economic_regionCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionCodeISO2Iterator.class);
