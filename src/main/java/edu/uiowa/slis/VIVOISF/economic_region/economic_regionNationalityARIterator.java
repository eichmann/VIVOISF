...
public class economic_regionNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static economic_regionNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(economic_regionNationalityARIterator.class);
