...
public class ERO_0001245RO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001245RO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001245RO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001245RO_0000057Iterator.getType());
		} catch (Exception e) {
