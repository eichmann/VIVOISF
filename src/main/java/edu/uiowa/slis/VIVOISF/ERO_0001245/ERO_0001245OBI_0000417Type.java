...
public class ERO_0001245OBI_0000417Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001245OBI_0000417Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001245OBI_0000417Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001245OBI_0000417Iterator.getType());
		} catch (Exception e) {
