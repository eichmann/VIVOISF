...
public class FacilityRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacilityRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FacilityRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacilityRO_0000056Iterator.getType());
		} catch (Exception e) {
