...
public class StudentOrganizationAffiliatedOrganizationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationAffiliatedOrganizationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationAffiliatedOrganizationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in StudentOrganizationAffiliatedOrganizationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StudentOrganizationAffiliatedOrganizationIterator doStartTag");
		}
