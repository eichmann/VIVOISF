...
public class StudentOrganizationERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentOrganizationERO_0000037Iterator.getType());
		} catch (Exception e) {
