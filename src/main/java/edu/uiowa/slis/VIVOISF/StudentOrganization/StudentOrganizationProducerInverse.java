...
public class StudentOrganizationProducerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationProducerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationProducerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentOrganizationProducerInverseIterator.getProducerInverse());
		} catch (Exception e) {
