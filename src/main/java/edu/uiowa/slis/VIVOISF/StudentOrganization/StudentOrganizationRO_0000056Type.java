...
public class StudentOrganizationRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentOrganizationRO_0000056Iterator.getType());
		} catch (Exception e) {
