...
public class StudentOrganizationHasCollaborator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationHasCollaborator currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationHasCollaborator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentOrganizationHasCollaboratorIterator.getHasCollaborator());
		} catch (Exception e) {
