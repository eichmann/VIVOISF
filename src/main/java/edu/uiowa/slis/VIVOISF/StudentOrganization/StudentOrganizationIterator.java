...
public class StudentOrganizationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationIterator.class);
