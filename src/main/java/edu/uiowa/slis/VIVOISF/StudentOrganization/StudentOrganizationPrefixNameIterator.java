...
public class StudentOrganizationPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationPrefixNameIterator.class);
