...
public class StudentOrganizationAssigneeFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationAssigneeFor currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationAssigneeFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentOrganizationAssigneeForIterator.getAssigneeFor());
		} catch (Exception e) {
