...
public class StudentOrganizationOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentOrganizationOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
