...
public class StudentOrganizationSponsorsType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationSponsorsType currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationSponsorsType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentOrganizationSponsorsIterator.getType());
		} catch (Exception e) {
