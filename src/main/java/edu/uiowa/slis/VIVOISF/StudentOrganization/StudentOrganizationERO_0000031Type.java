...
public class StudentOrganizationERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentOrganizationERO_0000031Iterator.getType());
		} catch (Exception e) {
