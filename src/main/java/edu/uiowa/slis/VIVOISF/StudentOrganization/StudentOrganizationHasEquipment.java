...
public class StudentOrganizationHasEquipment extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentOrganizationHasEquipment currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentOrganizationHasEquipment.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentOrganizationHasEquipmentIterator.getHasEquipment());
		} catch (Exception e) {
