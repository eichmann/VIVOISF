...
public class IAO_0000032IAO_0000221Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000032IAO_0000221Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000032IAO_0000221Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000032IAO_0000221Iterator.getType());
		} catch (Exception e) {
