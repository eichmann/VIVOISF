...
public class IAO_0000032Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000032Features currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000032Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000032FeaturesIterator.getFeatures());
		} catch (Exception e) {
