...
public class IAO_0000032Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000032Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000032Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000032TranslatorIterator.getTranslator());
		} catch (Exception e) {
