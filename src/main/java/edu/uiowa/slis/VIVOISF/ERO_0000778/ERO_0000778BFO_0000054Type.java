...
public class ERO_0000778BFO_0000054Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000778BFO_0000054Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000778BFO_0000054Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000778BFO_0000054Iterator.getType());
		} catch (Exception e) {
