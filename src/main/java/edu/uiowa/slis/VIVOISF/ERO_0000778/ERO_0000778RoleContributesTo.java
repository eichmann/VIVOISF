...
public class ERO_0000778RoleContributesTo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000778RoleContributesTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000778RoleContributesTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000778RoleContributesToIterator.getRoleContributesTo());
		} catch (Exception e) {
