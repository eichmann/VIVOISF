...
public class ClinicalRoleBFO_0000054 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalRoleBFO_0000054 currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalRoleBFO_0000054.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalRoleBFO_0000054Iterator.getBFO_0000054());
		} catch (Exception e) {
