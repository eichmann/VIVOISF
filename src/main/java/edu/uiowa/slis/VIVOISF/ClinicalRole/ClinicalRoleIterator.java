...
public class ClinicalRoleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalRoleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalRoleIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#ClinicalRole> . "+
			...
			log.error("Exception raised in ClinicalRoleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ClinicalRoleIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in ClinicalRoleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ClinicalRoleIterator doAfterBody");
		}
