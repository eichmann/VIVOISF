...
public class EditedBookIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookIdentifierIterator.class);
