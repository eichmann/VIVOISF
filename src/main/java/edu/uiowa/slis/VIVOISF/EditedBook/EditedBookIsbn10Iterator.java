...
public class EditedBookIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookIsbn10Iterator.class);
