...
public class EditedBookUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookUpcIterator.class);
