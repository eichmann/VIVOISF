...
public class EditedBookPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookPageEndIterator.class);
