...
public class EditedBookContributorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookContributorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookContributorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditedBookContributorListIterator.getType());
		} catch (Exception e) {
