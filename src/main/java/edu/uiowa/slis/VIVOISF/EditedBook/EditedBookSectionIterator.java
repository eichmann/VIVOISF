...
public class EditedBookSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookSectionIterator.class);
