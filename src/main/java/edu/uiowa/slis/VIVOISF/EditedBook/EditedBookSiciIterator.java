...
public class EditedBookSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookSiciIterator.class);
