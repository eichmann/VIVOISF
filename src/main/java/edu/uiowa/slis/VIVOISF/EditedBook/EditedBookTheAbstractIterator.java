...
public class EditedBookTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookTheAbstractIterator.class);
