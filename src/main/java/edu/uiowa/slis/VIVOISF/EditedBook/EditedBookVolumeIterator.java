...
public class EditedBookVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookVolumeIterator.class);
