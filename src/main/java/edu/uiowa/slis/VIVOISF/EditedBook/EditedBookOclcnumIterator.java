...
public class EditedBookOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookOclcnumIterator.class);
