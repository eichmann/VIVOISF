...
public class EditedBookAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookAsinIterator.class);
