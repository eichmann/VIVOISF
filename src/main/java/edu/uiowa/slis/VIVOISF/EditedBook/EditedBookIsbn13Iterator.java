...
public class EditedBookIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookIsbn13Iterator.class);
