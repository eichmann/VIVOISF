...
public class EditedBookUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookUriIterator.class);
