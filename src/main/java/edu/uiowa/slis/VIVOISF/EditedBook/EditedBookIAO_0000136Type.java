...
public class EditedBookIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditedBookIAO_0000136Iterator.getType());
		} catch (Exception e) {
