...
public class EditedBookARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookARG_0000001Iterator.class);
