...
public class EditedBookCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookCodenIterator.class);
