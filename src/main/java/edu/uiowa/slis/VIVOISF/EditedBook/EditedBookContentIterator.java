...
public class EditedBookContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookContentIterator.class);
