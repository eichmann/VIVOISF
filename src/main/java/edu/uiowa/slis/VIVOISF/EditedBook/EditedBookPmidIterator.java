...
public class EditedBookPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookPmidIterator.class);
