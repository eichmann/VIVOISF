...
public class EditedBookNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookNumberIterator.class);
