...
public class EditedBookNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookNumPagesIterator.class);
