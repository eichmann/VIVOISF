...
public class EditedBookDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookDoiIterator.class);
