...
public class EditedBookGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookGtin14Iterator.class);
