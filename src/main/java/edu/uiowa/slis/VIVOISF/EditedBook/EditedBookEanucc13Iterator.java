...
public class EditedBookEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookEanucc13Iterator.class);
