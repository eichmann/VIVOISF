...
public class EditedBookShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookShortDescriptionIterator.class);
