...
public class EditedBookHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookHandleIterator.class);
