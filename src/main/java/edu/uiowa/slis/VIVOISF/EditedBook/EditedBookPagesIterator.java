...
public class EditedBookPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookPagesIterator.class);
