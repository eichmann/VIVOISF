...
public class EditedBookPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditedBookPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditedBookPageStartIterator.class);
