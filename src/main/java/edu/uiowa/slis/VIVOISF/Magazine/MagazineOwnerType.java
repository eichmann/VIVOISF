...
public class MagazineOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMagazineOwnerIterator.getType());
		} catch (Exception e) {
