...
public class MagazineGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineGtin14Iterator.class);
