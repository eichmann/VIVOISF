...
public class MagazineIssnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineIssnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineIssnIterator.class);
