...
public class MagazineDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineDoiIterator.class);
