...
public class MagazineEissnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineEissnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineEissnIterator.class);
