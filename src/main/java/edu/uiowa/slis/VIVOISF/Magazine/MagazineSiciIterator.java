...
public class MagazineSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineSiciIterator.class);
