...
public class MagazineEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineEanucc13Iterator.class);
