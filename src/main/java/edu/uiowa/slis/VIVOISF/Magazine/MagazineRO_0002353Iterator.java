...
public class MagazineRO_0002353Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(MagazineRO_0002353Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MagazineRO_0002353Iterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MagazineRO_0002353Iterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MagazineRO_0002353 doEndTag", e);
			throw new JspTagException("Exception raised in MagazineRO_0002353 doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
