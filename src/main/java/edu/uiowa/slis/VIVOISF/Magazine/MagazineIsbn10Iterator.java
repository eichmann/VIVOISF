...
public class MagazineIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineIsbn10Iterator.class);
