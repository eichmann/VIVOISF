...
public class MagazineUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineUriIterator.class);
