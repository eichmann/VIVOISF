...
public class MagazineIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMagazineIAO_0000136Iterator.getType());
		} catch (Exception e) {
