...
public class MagazineUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineUpcIterator.class);
