...
public class MagazineHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineHandleIterator.class);
