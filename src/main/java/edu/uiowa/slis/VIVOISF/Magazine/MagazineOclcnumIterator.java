...
public class MagazineOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineOclcnumIterator.class);
