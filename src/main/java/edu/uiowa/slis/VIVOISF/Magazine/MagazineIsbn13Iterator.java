...
public class MagazineIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineIsbn13Iterator.class);
