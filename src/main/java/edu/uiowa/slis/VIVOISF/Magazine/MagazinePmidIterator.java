...
public class MagazinePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazinePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazinePmidIterator.class);
