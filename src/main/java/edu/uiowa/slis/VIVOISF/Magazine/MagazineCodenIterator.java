...
public class MagazineCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineCodenIterator.class);
