...
public class MagazineIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MagazineIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MagazineIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/Magazine> . "+
