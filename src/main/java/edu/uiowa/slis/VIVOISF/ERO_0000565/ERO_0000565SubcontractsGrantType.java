...
public class ERO_0000565SubcontractsGrantType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565SubcontractsGrantType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565SubcontractsGrantType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565SubcontractsGrantIterator.getType());
		} catch (Exception e) {
