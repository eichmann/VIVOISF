...
public class ERO_0000565AffiliatedOrganizationInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565AffiliatedOrganizationInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565AffiliatedOrganizationInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565AffiliatedOrganizationInverseIterator.getAffiliatedOrganizationInverse());
		} catch (Exception e) {
