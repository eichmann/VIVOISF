...
public class ERO_0000565PrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565PrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565PrefixNameIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			ERO_0000565 ancestorInstance = (ERO_0000565) findAncestorWithClass(this, ERO_0000565.class);
