...
public class ERO_0000565OBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565OBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565OBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565OBI_0000304InverseIterator.getType());
		} catch (Exception e) {
