...
public class ERO_0000565InterviewerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565InterviewerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565InterviewerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565InterviewerInverseIterator.getType());
		} catch (Exception e) {
