...
public class ERO_0000565SuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565SuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565SuffixNameIterator.class);
