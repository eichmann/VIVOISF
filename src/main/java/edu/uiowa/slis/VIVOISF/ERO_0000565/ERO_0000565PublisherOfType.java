...
public class ERO_0000565PublisherOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565PublisherOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565PublisherOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565PublisherOfIterator.getType());
		} catch (Exception e) {
