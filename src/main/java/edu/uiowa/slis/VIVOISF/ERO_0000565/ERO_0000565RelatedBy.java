...
public class ERO_0000565RelatedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565RelatedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565RelatedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565RelatedByIterator.getRelatedBy());
		} catch (Exception e) {
