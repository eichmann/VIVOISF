...
public class ERO_0000565Interviewee extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565Interviewee currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565Interviewee.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565IntervieweeIterator.getInterviewee());
		} catch (Exception e) {
