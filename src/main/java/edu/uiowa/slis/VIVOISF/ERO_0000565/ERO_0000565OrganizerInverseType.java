...
public class ERO_0000565OrganizerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565OrganizerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565OrganizerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565OrganizerInverseIterator.getType());
		} catch (Exception e) {
