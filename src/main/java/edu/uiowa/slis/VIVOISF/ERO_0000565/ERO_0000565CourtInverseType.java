...
public class ERO_0000565CourtInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565CourtInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565CourtInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565CourtInverseIterator.getType());
		} catch (Exception e) {
