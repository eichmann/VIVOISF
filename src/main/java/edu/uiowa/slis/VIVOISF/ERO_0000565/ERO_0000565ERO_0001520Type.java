...
public class ERO_0000565ERO_0001520Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565ERO_0001520Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565ERO_0001520Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565ERO_0001520Iterator.getType());
		} catch (Exception e) {
