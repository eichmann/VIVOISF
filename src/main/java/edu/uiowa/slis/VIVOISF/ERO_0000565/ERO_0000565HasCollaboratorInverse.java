...
public class ERO_0000565HasCollaboratorInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565HasCollaboratorInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565HasCollaboratorInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565HasCollaboratorInverseIterator.getHasCollaboratorInverse());
		} catch (Exception e) {
