...
public class ERO_0000565HasCollaborator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565HasCollaborator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565HasCollaborator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565HasCollaboratorIterator.getHasCollaborator());
		} catch (Exception e) {
