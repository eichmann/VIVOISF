...
public class ERO_0000565ERO_0000037 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565ERO_0000037 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565ERO_0000037.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565ERO_0000037Iterator.getERO_0000037());
		} catch (Exception e) {
