...
public class ERO_0000565OwnerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565OwnerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565OwnerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565OwnerInverseIterator.getType());
		} catch (Exception e) {
