...
public class ERO_0000565RecipientInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565RecipientInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565RecipientInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565RecipientInverseIterator.getType());
		} catch (Exception e) {
