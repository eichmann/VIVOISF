...
public class ERO_0000565GoverningAuthorityForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565GoverningAuthorityForType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565GoverningAuthorityForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565GoverningAuthorityForIterator.getType());
		} catch (Exception e) {
