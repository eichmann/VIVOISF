...
public class ERO_0000565ERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565ERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565ERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565ERO_0000031Iterator.getType());
		} catch (Exception e) {
