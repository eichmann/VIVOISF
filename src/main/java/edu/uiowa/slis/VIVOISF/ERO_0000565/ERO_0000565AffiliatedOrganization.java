...
public class ERO_0000565AffiliatedOrganization extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565AffiliatedOrganization currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565AffiliatedOrganization.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565AffiliatedOrganizationIterator.getAffiliatedOrganization());
		} catch (Exception e) {
