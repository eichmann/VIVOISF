...
public class ERO_0000565HasEquipmentType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565HasEquipmentType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565HasEquipmentType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565HasEquipmentIterator.getType());
		} catch (Exception e) {
