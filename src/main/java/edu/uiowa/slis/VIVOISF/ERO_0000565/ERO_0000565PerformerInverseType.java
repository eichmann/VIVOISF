...
public class ERO_0000565PerformerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565PerformerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565PerformerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565PerformerInverseIterator.getType());
		} catch (Exception e) {
