...
public class ERO_0000565EditorInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565EditorInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565EditorInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565EditorInverseIterator.getEditorInverse());
		} catch (Exception e) {
