...
public class ERO_0000565Interviewer extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000565Interviewer currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000565Interviewer.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000565InterviewerIterator.getInterviewer());
		} catch (Exception e) {
