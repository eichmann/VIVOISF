...
public class CaseStudyPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyPagesIterator.class);
