...
public class CaseStudyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#CaseStudy> . "+
