...
public class CaseStudyShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyShortTitleIterator.class);
