...
public class CaseStudyContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyContentIterator.class);
