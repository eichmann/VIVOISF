...
public class CaseStudyTranslator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyTranslator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyTranslator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCaseStudyTranslatorIterator.getTranslator());
		} catch (Exception e) {
