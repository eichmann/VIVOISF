...
public class CaseStudyIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyIsbn13Iterator.class);
