...
public class CaseStudyUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyUpcIterator.class);
