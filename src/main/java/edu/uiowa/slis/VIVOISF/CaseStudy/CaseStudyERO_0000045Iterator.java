...
public class CaseStudyERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyERO_0000045Iterator.class);
