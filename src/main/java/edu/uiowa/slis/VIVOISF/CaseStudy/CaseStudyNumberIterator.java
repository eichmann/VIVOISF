...
public class CaseStudyNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyNumberIterator.class);
