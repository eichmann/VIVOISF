...
public class CaseStudyCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyCodenIterator.class);
