...
public class CaseStudySectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudySectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudySectionIterator.class);
