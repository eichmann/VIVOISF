...
public class CaseStudyEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyEanucc13Iterator.class);
