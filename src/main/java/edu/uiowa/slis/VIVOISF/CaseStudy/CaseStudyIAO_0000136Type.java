...
public class CaseStudyIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCaseStudyIAO_0000136Iterator.getType());
		} catch (Exception e) {
