...
public class CaseStudyTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyTheAbstractIterator.class);
