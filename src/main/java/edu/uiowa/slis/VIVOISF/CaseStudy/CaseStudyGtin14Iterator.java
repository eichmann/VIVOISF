...
public class CaseStudyGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyGtin14Iterator.class);
