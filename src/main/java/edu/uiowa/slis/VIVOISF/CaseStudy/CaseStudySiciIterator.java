...
public class CaseStudySiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudySiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudySiciIterator.class);
