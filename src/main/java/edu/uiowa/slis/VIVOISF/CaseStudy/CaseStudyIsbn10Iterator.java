...
public class CaseStudyIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyIsbn10Iterator.class);
