...
public class CaseStudyVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyVolumeIterator.class);
