...
public class CaseStudyDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyDoiIterator.class);
