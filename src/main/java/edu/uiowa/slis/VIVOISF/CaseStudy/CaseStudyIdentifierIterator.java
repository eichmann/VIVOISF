...
public class CaseStudyIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyIdentifierIterator.class);
