...
public class CaseStudyPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyPmidIterator.class);
