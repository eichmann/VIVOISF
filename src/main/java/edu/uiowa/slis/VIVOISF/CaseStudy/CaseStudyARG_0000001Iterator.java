...
public class CaseStudyARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyARG_0000001Iterator.class);
