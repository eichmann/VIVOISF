...
public class CaseStudyOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyOclcnumIterator.class);
