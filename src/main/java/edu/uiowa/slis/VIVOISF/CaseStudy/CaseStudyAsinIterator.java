...
public class CaseStudyAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyAsinIterator.class);
