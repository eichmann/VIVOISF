...
public class CaseStudyShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyShortDescriptionIterator.class);
