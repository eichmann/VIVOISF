...
public class CaseStudyUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyUriIterator.class);
