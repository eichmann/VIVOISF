...
public class CaseStudyNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyNumPagesIterator.class);
