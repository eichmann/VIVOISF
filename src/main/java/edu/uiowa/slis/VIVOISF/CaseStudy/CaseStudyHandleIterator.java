...
public class CaseStudyHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CaseStudyHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CaseStudyHandleIterator.class);
