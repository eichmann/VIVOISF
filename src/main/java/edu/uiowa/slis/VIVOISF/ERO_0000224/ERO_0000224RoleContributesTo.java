...
public class ERO_0000224RoleContributesTo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000224RoleContributesTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000224RoleContributesTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000224RoleContributesToIterator.getRoleContributesTo());
		} catch (Exception e) {
