...
public class CompanyNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameOfficialARIterator.class);
