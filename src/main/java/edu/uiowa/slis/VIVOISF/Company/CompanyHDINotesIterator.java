...
public class CompanyHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHDINotesIterator.class);
