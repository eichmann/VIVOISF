...
public class CompanyGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyGDPTotalInCurrentPricesIterator.class);
