...
public class CompanyNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNationalityESIterator.class);
