...
public class CompanyHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHasMinLongitudeIterator.class);
