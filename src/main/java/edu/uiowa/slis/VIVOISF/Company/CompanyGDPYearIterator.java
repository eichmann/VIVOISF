...
public class CompanyGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyGDPYearIterator.class);
