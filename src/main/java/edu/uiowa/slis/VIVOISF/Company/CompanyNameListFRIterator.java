...
public class CompanyNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameListFRIterator.class);
