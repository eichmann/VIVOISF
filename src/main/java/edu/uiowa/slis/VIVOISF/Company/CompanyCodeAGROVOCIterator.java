...
public class CompanyCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCodeAGROVOCIterator.class);
