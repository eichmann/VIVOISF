...
public class CompanyNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameCurrencyESIterator.class);
