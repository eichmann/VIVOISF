...
public class CompanyCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCountryAreaUnitIterator.class);
