...
public class CompanyHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHDIYearIterator.class);
