...
public class CompanyNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameOfficialZHIterator.class);
