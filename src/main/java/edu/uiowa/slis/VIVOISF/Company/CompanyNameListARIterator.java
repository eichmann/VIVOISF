...
public class CompanyNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameListARIterator.class);
