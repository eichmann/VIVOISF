...
public class CompanyCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCodeISO3Iterator.class);
