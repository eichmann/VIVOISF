...
public class CompanyNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameShortZHIterator.class);
