...
public class CompanyERO_0001520Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyERO_0001520Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyERO_0001520Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyERO_0001520Iterator.getType());
		} catch (Exception e) {
