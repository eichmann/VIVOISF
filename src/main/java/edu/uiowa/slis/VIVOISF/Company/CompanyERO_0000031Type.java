...
public class CompanyERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyERO_0000031Iterator.getType());
		} catch (Exception e) {
