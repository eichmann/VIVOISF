...
public class CompanyRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyRankIterator.class);
