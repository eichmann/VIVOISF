...
public class CompanyIntervieweeInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyIntervieweeInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyIntervieweeInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyIntervieweeInverseIterator.getType());
		} catch (Exception e) {
