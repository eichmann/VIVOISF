...
public class CompanyCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCountryAreaYearIterator.class);
