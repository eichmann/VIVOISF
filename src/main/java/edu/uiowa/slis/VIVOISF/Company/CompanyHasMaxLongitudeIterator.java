...
public class CompanyHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHasMaxLongitudeIterator.class);
