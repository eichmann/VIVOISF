...
public class CompanyNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameShortARIterator.class);
