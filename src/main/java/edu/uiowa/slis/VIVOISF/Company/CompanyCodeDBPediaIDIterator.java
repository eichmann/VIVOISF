...
public class CompanyCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCodeDBPediaIDIterator.class);
