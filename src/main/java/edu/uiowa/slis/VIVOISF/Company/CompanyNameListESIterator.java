...
public class CompanyNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameListESIterator.class);
