...
public class CompanyLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyLandAreaTotalIterator.class);
