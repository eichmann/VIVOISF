...
public class CompanyNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameOfficialITIterator.class);
