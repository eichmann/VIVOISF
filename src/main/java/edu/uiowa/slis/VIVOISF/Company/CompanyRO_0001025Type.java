...
public class CompanyRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyRO_0001025Iterator.getType());
		} catch (Exception e) {
