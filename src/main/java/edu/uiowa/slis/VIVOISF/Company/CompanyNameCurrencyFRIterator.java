...
public class CompanyNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameCurrencyFRIterator.class);
