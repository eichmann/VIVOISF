...
public class CompanyHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHasMinLatitudeIterator.class);
