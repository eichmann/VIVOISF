...
public class CompanyLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyLandAreaUnitIterator.class);
