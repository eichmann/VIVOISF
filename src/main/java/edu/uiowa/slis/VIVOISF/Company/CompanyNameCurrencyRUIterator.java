...
public class CompanyNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameCurrencyRUIterator.class);
