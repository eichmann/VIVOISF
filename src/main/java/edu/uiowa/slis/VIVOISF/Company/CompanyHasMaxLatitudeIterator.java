...
public class CompanyHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHasMaxLatitudeIterator.class);
