...
public class CompanyNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameShortESIterator.class);
