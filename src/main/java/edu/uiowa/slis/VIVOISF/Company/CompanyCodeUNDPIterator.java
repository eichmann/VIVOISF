...
public class CompanyCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCodeUNDPIterator.class);
