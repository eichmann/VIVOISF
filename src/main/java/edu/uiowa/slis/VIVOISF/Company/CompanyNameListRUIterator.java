...
public class CompanyNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameListRUIterator.class);
