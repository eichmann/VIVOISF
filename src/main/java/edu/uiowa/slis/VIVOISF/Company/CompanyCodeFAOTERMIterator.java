...
public class CompanyCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCodeFAOTERMIterator.class);
