...
public class CompanyCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCodeFAOSTATIterator.class);
