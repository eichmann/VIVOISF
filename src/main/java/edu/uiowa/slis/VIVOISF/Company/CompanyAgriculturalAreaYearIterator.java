...
public class CompanyAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyAgriculturalAreaYearIterator.class);
