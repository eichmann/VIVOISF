...
public class CompanyHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHDITotalIterator.class);
