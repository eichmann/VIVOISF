...
public class CompanyPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyPopulationYearIterator.class);
