...
public class CompanyNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameCurrencyITIterator.class);
