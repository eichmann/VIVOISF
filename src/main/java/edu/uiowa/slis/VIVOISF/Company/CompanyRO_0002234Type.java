...
public class CompanyRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyRO_0002234Iterator.getType());
		} catch (Exception e) {
