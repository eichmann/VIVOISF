...
public class CompanyCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCountryAreaTotalIterator.class);
