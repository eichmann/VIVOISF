...
public class CompanyNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameShortRUIterator.class);
