...
public class CompanyAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyAgriculturalAreaUnitIterator.class);
