...
public class CompanyHasSubjectArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHasSubjectArea currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHasSubjectArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyHasSubjectAreaIterator.getHasSubjectArea());
		} catch (Exception e) {
