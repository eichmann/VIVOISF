...
public class CompanyHasPredecessorOrganization extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHasPredecessorOrganization currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHasPredecessorOrganization.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyHasPredecessorOrganizationIterator.getHasPredecessorOrganization());
		} catch (Exception e) {
