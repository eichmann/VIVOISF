...
public class CompanyOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
