...
public class CompanyNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameOfficialFRIterator.class);
