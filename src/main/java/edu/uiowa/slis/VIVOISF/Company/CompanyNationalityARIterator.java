...
public class CompanyNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNationalityARIterator.class);
