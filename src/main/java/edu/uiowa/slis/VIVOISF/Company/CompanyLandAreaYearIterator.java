...
public class CompanyLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyLandAreaYearIterator.class);
