...
public class CompanyPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyPopulationTotalIterator.class);
