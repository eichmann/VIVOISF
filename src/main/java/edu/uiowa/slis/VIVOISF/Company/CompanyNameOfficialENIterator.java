...
public class CompanyNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameOfficialENIterator.class);
