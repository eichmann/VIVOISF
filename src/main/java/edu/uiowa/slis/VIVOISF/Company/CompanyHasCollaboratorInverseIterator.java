...
public class CompanyHasCollaboratorInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHasCollaboratorInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHasCollaboratorInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CompanyHasCollaboratorInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CompanyHasCollaboratorInverseIterator doStartTag");
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CompanyHasCollaboratorIterator");
