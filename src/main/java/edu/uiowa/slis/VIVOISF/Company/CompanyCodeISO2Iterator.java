...
public class CompanyCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCodeISO2Iterator.class);
