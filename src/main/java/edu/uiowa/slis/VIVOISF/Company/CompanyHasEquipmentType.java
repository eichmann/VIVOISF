...
public class CompanyHasEquipmentType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyHasEquipmentType currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyHasEquipmentType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyHasEquipmentIterator.getType());
		} catch (Exception e) {
