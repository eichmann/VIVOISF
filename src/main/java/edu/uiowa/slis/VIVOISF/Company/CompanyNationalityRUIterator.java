...
public class CompanyNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNationalityRUIterator.class);
