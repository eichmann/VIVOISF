...
public class CompanyNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameShortENIterator.class);
