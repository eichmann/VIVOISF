...
public class CompanyNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNationalityFRIterator.class);
