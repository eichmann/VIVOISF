...
public class CompanyNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameCurrencyENIterator.class);
