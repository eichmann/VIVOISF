...
public class CompanyNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNationalityITIterator.class);
