...
public class CompanyNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameListENIterator.class);
