...
public class CompanyNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameListITIterator.class);
