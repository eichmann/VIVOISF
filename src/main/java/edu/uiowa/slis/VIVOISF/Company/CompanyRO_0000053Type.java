...
public class CompanyRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyRO_0000053Iterator.getType());
		} catch (Exception e) {
