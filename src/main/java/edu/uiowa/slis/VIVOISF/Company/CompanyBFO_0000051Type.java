...
public class CompanyBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyBFO_0000051Iterator.getType());
		} catch (Exception e) {
