...
public class CompanyNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameShortITIterator.class);
