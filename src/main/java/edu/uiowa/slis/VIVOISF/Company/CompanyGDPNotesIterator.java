...
public class CompanyGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyGDPNotesIterator.class);
