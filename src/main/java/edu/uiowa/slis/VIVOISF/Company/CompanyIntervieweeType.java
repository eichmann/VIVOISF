...
public class CompanyIntervieweeType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyIntervieweeType currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyIntervieweeType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyIntervieweeIterator.getType());
		} catch (Exception e) {
