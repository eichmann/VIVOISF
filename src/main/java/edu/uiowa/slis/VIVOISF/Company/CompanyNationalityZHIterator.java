...
public class CompanyNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNationalityZHIterator.class);
