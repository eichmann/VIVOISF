...
public class CompanyAffiliatedOrganizationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyAffiliatedOrganizationType currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyAffiliatedOrganizationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompanyAffiliatedOrganizationIterator.getType());
		} catch (Exception e) {
