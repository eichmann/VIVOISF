...
public class CompanyNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameOfficialESIterator.class);
