...
public class CompanyPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyPrefixNameIterator.class);
