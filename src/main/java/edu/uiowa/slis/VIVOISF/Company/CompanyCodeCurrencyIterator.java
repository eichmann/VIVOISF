...
public class CompanyCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCodeCurrencyIterator.class);
