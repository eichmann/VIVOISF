...
public class CompanyNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameCurrencyARIterator.class);
