...
public class CompanyGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyGDPUnitIterator.class);
