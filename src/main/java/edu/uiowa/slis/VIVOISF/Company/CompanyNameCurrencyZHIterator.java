...
public class CompanyNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameCurrencyZHIterator.class);
