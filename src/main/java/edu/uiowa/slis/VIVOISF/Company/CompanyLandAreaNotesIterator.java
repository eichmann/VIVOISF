...
public class CompanyLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyLandAreaNotesIterator.class);
