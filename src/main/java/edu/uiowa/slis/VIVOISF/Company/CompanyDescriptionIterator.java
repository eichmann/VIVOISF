...
public class CompanyDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyDescriptionIterator.class);
