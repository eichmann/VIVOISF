...
public class CompanyNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNationalityENIterator.class);
