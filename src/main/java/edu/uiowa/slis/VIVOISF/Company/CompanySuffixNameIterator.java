...
public class CompanySuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanySuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanySuffixNameIterator.class);
