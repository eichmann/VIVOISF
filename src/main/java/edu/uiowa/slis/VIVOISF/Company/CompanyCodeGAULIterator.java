...
public class CompanyCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCodeGAULIterator.class);
