...
public class CompanyCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyCountryAreaNotesIterator.class);
