...
public class CompanyUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyUrlIterator.class);
