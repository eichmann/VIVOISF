...
public class CompanyNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompanyNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyNameShortFRIterator.class);
