...
public class ExhibitRO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExhibitRO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ExhibitRO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExhibitRO_0000057Iterator.getType());
		} catch (Exception e) {
