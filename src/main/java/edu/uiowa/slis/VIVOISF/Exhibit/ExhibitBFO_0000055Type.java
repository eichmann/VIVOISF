...
public class ExhibitBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExhibitBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ExhibitBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExhibitBFO_0000055Iterator.getType());
		} catch (Exception e) {
