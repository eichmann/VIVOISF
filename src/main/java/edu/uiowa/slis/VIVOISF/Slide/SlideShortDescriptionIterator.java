...
public class SlideShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideShortDescriptionIterator.class);
