...
public class SlideIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideIdentifierIterator.class);
