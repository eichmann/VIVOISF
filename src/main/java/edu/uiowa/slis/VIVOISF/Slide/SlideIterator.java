...
public class SlideIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/Slide> . "+
