...
public class SlideNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideNumPagesIterator.class);
