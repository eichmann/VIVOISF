...
public class SlideCites extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideCites currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideCites.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideCitesIterator.getCites());
		} catch (Exception e) {
