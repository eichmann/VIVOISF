...
public class SlidePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlidePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlidePageEndIterator.class);
