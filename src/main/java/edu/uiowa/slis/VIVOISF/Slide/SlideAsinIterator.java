...
public class SlideAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideAsinIterator.class);
