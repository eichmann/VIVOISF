...
public class SlideEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideEanucc13Iterator.class);
