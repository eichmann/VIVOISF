...
public class SlidePresentedAt extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlidePresentedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(SlidePresentedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlidePresentedAtIterator.getPresentedAt());
		} catch (Exception e) {
