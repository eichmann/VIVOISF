...
public class SlideTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideTheAbstractIterator.class);
