...
public class SlidePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlidePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlidePmidIterator.class);
