...
public class SlideGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideGtin14Iterator.class);
