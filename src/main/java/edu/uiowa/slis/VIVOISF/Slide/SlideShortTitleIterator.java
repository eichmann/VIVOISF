...
public class SlideShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideShortTitleIterator.class);
