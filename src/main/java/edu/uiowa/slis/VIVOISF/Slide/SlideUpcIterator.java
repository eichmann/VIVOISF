...
public class SlideUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideUpcIterator.class);
