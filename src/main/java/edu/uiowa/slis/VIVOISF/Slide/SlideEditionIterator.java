...
public class SlideEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideEditionIterator.class);
