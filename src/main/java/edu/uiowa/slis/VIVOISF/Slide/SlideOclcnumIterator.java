...
public class SlideOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideOclcnumIterator.class);
