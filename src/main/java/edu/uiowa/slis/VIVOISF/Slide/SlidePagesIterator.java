...
public class SlidePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlidePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlidePagesIterator.class);
