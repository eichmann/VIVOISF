...
public class SlideIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideIsbn10Iterator.class);
