...
public class SlideLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideLocatorIterator.class);
