...
public class SlideIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideIsbn13Iterator.class);
