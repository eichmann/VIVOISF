...
public class SlideVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideVolumeIterator.class);
