...
public class SlideNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideNumberIterator.class);
