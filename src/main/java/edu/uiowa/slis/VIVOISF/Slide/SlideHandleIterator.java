...
public class SlideHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideHandleIterator.class);
