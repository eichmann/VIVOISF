...
public class SlideSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideSectionIterator.class);
