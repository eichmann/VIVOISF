...
public class SlideARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideARG_0000001Iterator.class);
