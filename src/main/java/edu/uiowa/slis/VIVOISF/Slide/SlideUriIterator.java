...
public class SlideUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideUriIterator.class);
