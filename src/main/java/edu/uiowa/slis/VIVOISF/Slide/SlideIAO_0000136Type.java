...
public class SlideIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideIAO_0000136Iterator.getType());
		} catch (Exception e) {
