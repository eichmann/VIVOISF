...
public class SlideERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideERO_0000045Iterator.class);
