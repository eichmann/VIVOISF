...
public class SlidePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlidePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlidePageStartIterator.class);
