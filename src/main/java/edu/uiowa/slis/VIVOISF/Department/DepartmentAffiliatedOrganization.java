...
public class DepartmentAffiliatedOrganization extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DepartmentAffiliatedOrganization currentInstance = null;
	private static final Log log = LogFactory.getLog(DepartmentAffiliatedOrganization.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDepartmentAffiliatedOrganizationIterator.getAffiliatedOrganization());
		} catch (Exception e) {
