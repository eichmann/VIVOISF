...
public class DepartmentOBI_0000304Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DepartmentOBI_0000304Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(DepartmentOBI_0000304Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDepartmentOBI_0000304InverseIterator.getOBI_0000304Inverse());
		} catch (Exception e) {
