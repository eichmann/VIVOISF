...
public class DepartmentHasCollaboratorInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DepartmentHasCollaboratorInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(DepartmentHasCollaboratorInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDepartmentHasCollaboratorInverseIterator.getType());
		} catch (Exception e) {
