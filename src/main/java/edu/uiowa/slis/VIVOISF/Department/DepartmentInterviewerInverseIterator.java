...
public class DepartmentInterviewerInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DepartmentInterviewerInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DepartmentInterviewerInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DepartmentInterviewerInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DepartmentInterviewerInverseIterator doStartTag");
		}
