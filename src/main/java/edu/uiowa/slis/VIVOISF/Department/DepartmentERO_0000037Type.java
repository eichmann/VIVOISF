...
public class DepartmentERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DepartmentERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DepartmentERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDepartmentERO_0000037Iterator.getType());
		} catch (Exception e) {
