...
public class FacultyPositionNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameListITIterator.class);
