...
public class FacultyPositionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCodeFAOSTATIterator.class);
