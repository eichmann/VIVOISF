...
public class FacultyPositionNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameShortITIterator.class);
