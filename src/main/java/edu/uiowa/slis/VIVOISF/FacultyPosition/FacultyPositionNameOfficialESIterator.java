...
public class FacultyPositionNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameOfficialESIterator.class);
