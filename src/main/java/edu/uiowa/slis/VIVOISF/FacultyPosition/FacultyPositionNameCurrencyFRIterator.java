...
public class FacultyPositionNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameCurrencyFRIterator.class);
