...
public class FacultyPositionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionHasMinLongitudeIterator.class);
