...
public class FacultyPositionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionLandAreaYearIterator.class);
