...
public class FacultyPositionHasSubjectArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionHasSubjectArea currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionHasSubjectArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacultyPositionHasSubjectAreaIterator.getHasSubjectArea());
		} catch (Exception e) {
