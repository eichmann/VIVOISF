...
public class FacultyPositionCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCountryAreaNotesIterator.class);
