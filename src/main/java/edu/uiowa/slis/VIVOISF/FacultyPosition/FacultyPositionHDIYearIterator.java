...
public class FacultyPositionHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionHDIYearIterator.class);
