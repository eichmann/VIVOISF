...
public class FacultyPositionNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameShortRUIterator.class);
