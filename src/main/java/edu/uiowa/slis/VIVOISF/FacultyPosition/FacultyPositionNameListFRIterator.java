...
public class FacultyPositionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameListFRIterator.class);
