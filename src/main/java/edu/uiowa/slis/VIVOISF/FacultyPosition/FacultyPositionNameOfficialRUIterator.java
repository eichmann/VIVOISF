...
public class FacultyPositionNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameOfficialRUIterator.class);
