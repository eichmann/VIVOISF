...
public class FacultyPositionCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCountryAreaYearIterator.class);
