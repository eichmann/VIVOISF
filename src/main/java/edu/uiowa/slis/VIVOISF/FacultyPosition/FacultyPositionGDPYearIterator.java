...
public class FacultyPositionGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionGDPYearIterator.class);
