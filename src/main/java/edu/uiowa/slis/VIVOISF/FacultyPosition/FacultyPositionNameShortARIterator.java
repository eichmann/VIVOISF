...
public class FacultyPositionNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameShortARIterator.class);
