...
public class FacultyPositionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionLandAreaNotesIterator.class);
