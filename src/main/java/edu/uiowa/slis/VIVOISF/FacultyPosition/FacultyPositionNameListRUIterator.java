...
public class FacultyPositionNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameListRUIterator.class);
