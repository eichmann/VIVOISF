...
public class FacultyPositionNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNationalityITIterator.class);
