...
public class FacultyPositionRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionRankIterator.class);
