...
public class FacultyPositionCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCodeCurrencyIterator.class);
