...
public class FacultyPositionNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameOfficialZHIterator.class);
