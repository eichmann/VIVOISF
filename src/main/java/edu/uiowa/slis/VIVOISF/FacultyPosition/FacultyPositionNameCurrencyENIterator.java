...
public class FacultyPositionNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameCurrencyENIterator.class);
