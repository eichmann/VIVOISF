...
public class FacultyPositionLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionLandAreaUnitIterator.class);
