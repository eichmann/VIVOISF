...
public class FacultyPositionNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNationalityRUIterator.class);
