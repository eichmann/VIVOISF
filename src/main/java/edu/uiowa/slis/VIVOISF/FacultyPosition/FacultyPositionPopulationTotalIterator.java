...
public class FacultyPositionPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionPopulationTotalIterator.class);
