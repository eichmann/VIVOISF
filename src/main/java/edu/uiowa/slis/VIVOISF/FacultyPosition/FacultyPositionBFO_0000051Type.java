...
public class FacultyPositionBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacultyPositionBFO_0000051Iterator.getType());
		} catch (Exception e) {
