...
public class FacultyPositionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionPopulationNotesIterator.class);
