...
public class FacultyPositionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCodeAGROVOCIterator.class);
