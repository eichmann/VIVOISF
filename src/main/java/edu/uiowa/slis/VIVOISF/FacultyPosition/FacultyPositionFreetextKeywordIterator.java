...
public class FacultyPositionFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionFreetextKeywordIterator.class);
