...
public class FacultyPositionUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionUrlIterator.class);
