...
public class FacultyPositionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionHDINotesIterator.class);
