...
public class FacultyPositionGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionGDPUnitIterator.class);
