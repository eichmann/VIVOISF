...
public class FacultyPositionCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCodeUNDPIterator.class);
