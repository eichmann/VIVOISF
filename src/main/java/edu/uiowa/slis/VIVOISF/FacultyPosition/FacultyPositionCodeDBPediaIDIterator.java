...
public class FacultyPositionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCodeDBPediaIDIterator.class);
