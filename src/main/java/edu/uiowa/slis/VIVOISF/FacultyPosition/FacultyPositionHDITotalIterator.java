...
public class FacultyPositionHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionHDITotalIterator.class);
