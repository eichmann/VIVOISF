...
public class FacultyPositionNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameOfficialENIterator.class);
