...
public class FacultyPositionNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameCurrencyESIterator.class);
