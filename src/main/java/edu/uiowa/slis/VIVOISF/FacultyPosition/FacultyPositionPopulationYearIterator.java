...
public class FacultyPositionPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionPopulationYearIterator.class);
