...
public class FacultyPositionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#FacultyPosition> . "+
