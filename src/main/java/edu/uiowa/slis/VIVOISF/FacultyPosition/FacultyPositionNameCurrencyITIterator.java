...
public class FacultyPositionNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameCurrencyITIterator.class);
