...
public class FacultyPositionDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionDescriptionIterator.class);
