...
public class FacultyPositionNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNationalityFRIterator.class);
