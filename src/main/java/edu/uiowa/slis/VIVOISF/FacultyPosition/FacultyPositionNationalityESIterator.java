...
public class FacultyPositionNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNationalityESIterator.class);
