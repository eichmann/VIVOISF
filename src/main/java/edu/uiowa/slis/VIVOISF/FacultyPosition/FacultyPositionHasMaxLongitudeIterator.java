...
public class FacultyPositionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionHasMaxLongitudeIterator.class);
