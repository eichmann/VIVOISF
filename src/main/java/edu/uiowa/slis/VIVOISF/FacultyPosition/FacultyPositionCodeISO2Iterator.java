...
public class FacultyPositionCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCodeISO2Iterator.class);
