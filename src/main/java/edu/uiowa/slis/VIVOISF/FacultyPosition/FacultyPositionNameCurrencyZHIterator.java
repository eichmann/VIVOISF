...
public class FacultyPositionNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameCurrencyZHIterator.class);
