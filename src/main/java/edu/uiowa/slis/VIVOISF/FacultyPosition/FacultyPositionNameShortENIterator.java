...
public class FacultyPositionNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameShortENIterator.class);
