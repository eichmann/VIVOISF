...
public class FacultyPositionCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCodeUNIterator.class);
