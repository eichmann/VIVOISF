...
public class FacultyPositionNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameShortFRIterator.class);
