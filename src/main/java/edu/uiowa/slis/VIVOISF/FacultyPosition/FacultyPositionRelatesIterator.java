...
public class FacultyPositionRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in FacultyPositionRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FacultyPositionRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in FacultyPositionRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FacultyPositionRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FacultyPositionRelates doEndTag", e);
			throw new JspTagException("Exception raised in FacultyPositionRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to FacultyPositionRelatesIterator");
