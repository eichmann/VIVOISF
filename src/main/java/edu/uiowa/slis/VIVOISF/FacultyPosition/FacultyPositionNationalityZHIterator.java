...
public class FacultyPositionNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNationalityZHIterator.class);
