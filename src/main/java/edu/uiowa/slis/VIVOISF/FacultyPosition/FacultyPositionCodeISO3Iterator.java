...
public class FacultyPositionCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCodeISO3Iterator.class);
