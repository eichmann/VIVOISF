...
public class FacultyPositionNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameOfficialITIterator.class);
