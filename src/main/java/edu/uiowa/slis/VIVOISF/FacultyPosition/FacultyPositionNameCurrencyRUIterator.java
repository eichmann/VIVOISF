...
public class FacultyPositionNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameCurrencyRUIterator.class);
