...
public class FacultyPositionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionHasMinLatitudeIterator.class);
