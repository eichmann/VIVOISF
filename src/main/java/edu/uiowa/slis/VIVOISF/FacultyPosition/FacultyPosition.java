...
public class FacultyPosition extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPosition currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPosition.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			FacultyPositionIterator theFacultyPositionIterator = (FacultyPositionIterator) findAncestorWithClass(this, FacultyPositionIterator.class);

			if (theFacultyPositionIterator != null) {
				subjectURI = theFacultyPositionIterator.getSubjectURI();
				label = theFacultyPositionIterator.getLabel();
			}
			...
			if (theFacultyPositionIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in FacultyPosition doStartTag", e);
			throw new JspTagException("Exception raised in FacultyPosition doStartTag");
		} finally {
			freeConnection();
		}
