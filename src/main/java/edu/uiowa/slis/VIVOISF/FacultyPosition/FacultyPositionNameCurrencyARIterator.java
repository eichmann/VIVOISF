...
public class FacultyPositionNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionNameCurrencyARIterator.class);
