...
public class FacultyPositionCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCodeGAULIterator.class);
