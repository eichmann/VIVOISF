...
public class FacultyPositionCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionCountryAreaTotalIterator.class);
