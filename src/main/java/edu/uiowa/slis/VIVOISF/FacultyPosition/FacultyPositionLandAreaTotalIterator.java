...
public class FacultyPositionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyPositionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyPositionLandAreaTotalIterator.class);
