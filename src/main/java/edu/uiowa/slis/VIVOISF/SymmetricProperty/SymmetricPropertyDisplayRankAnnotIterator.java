...
public class SymmetricPropertyDisplayRankAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SymmetricPropertyDisplayRankAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SymmetricPropertyDisplayRankAnnotIterator.class);
