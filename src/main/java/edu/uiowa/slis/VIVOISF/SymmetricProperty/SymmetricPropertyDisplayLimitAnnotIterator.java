...
public class SymmetricPropertyDisplayLimitAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SymmetricPropertyDisplayLimitAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SymmetricPropertyDisplayLimitAnnotIterator.class);
