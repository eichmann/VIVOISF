...
public class IAO_0000005TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000005TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000005TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000005TranslatorIterator.getType());
		} catch (Exception e) {
