...
public class IAO_0000005OBI_0000833Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000005OBI_0000833Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000005OBI_0000833Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000005OBI_0000833Iterator.getType());
		} catch (Exception e) {
