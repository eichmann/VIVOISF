...
public class IAO_0000033FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000033FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000033FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000033FeaturesIterator.getType());
		} catch (Exception e) {
