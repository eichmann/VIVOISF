...
public class ERO_0000394Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000394Features currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000394Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000394FeaturesIterator.getFeatures());
		} catch (Exception e) {
