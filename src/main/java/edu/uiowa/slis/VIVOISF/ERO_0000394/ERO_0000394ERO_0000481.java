...
public class ERO_0000394ERO_0000481 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000394ERO_0000481 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000394ERO_0000481.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000394ERO_0000481Iterator.getERO_0000481());
		} catch (Exception e) {
