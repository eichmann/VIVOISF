...
public class TeacherRoleRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TeacherRoleRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(TeacherRoleRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTeacherRoleRO_0000052Iterator.getType());
		} catch (Exception e) {
