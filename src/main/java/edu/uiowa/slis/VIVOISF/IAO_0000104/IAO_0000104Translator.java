...
public class IAO_0000104Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000104Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000104Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000104TranslatorIterator.getTranslator());
		} catch (Exception e) {
