...
public class BibliographicInformationSourceSWO_0000741Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BibliographicInformationSourceSWO_0000741Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BibliographicInformationSourceSWO_0000741Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBibliographicInformationSourceSWO_0000741Iterator.getType());
		} catch (Exception e) {
