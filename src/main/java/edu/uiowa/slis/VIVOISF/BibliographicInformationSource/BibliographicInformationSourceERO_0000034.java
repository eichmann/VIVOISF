...
public class BibliographicInformationSourceERO_0000034 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BibliographicInformationSourceERO_0000034 currentInstance = null;
	private static final Log log = LogFactory.getLog(BibliographicInformationSourceERO_0000034.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBibliographicInformationSourceERO_0000034Iterator.getERO_0000034());
		} catch (Exception e) {
