...
public class BibliographicInformationSourceRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BibliographicInformationSourceRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BibliographicInformationSourceRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBibliographicInformationSourceRO_0000056Iterator.getType());
		} catch (Exception e) {
