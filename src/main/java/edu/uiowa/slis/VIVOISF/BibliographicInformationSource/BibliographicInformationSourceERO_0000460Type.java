...
public class BibliographicInformationSourceERO_0000460Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BibliographicInformationSourceERO_0000460Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BibliographicInformationSourceERO_0000460Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBibliographicInformationSourceERO_0000460Iterator.getType());
		} catch (Exception e) {
