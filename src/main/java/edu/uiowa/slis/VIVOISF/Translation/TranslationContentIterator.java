...
public class TranslationContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationContentIterator.class);
