...
public class TranslationLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationLccnIterator.class);
