...
public class TranslationPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationPageEndIterator.class);
