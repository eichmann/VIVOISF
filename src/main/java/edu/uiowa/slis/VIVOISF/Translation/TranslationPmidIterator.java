...
public class TranslationPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationPmidIterator.class);
