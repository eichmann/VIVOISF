...
public class TranslationSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationSectionIterator.class);
