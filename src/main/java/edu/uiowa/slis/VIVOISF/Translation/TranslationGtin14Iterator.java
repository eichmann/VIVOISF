...
public class TranslationGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationGtin14Iterator.class);
