...
public class TranslationReproducedInType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationReproducedInType currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationReproducedInType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTranslationReproducedInIterator.getType());
		} catch (Exception e) {
