...
public class TranslationCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationCodenIterator.class);
