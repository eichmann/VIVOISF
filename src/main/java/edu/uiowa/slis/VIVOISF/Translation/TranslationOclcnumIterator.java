...
public class TranslationOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationOclcnumIterator.class);
