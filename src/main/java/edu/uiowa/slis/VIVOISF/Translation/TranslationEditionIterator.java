...
public class TranslationEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationEditionIterator.class);
