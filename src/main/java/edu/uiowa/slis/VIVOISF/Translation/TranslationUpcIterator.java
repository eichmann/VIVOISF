...
public class TranslationUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationUpcIterator.class);
