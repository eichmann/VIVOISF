...
public class TranslationIAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationIAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationIAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTranslationIAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
