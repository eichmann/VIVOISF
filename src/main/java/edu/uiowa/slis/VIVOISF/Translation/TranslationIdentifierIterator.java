...
public class TranslationIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationIdentifierIterator.class);
