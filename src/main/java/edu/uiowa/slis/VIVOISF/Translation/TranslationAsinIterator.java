...
public class TranslationAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationAsinIterator.class);
