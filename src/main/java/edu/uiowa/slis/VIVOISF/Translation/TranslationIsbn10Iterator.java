...
public class TranslationIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationIsbn10Iterator.class);
