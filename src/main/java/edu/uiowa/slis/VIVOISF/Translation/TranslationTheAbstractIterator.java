...
public class TranslationTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationTheAbstractIterator.class);
