...
public class TranslationNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationNumPagesIterator.class);
