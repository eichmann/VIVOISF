...
public class TranslationARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationARG_0000001Iterator.class);
