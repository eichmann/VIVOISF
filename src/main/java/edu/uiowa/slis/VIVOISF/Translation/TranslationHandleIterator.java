...
public class TranslationHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationHandleIterator.class);
