...
public class TranslationDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationDoiIterator.class);
