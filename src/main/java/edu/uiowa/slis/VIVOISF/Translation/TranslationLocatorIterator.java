...
public class TranslationLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationLocatorIterator.class);
