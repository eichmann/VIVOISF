...
public class TranslationTranscriptOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationTranscriptOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationTranscriptOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTranslationTranscriptOfIterator.getType());
		} catch (Exception e) {
