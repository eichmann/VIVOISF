...
public class TranslationShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationShortDescriptionIterator.class);
