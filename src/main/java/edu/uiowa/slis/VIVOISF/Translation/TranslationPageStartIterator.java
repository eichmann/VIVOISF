...
public class TranslationPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationPageStartIterator.class);
