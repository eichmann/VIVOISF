...
public class TranslationUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationUriIterator.class);
