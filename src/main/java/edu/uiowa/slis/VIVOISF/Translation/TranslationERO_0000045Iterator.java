...
public class TranslationERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationERO_0000045Iterator.class);
