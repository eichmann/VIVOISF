...
public class TranslationPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationPagesIterator.class);
