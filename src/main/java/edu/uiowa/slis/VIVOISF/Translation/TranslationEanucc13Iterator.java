...
public class TranslationEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TranslationEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TranslationEanucc13Iterator.class);
