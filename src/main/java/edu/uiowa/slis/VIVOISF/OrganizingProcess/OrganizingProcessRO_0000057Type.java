...
public class OrganizingProcessRO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizingProcessRO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizingProcessRO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizingProcessRO_0000057Iterator.getType());
		} catch (Exception e) {
