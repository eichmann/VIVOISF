...
public class OrganizingProcessBFO_0000055 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizingProcessBFO_0000055 currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizingProcessBFO_0000055.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizingProcessBFO_0000055Iterator.getBFO_0000055());
		} catch (Exception e) {
