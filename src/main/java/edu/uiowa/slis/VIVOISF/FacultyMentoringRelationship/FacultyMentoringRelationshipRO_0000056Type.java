...
public class FacultyMentoringRelationshipRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyMentoringRelationshipRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyMentoringRelationshipRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacultyMentoringRelationshipRO_0000056Iterator.getType());
		} catch (Exception e) {
