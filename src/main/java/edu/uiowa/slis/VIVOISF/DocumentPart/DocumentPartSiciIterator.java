...
public class DocumentPartSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartSiciIterator.class);
