...
public class DocumentPartNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameListRUIterator.class);
