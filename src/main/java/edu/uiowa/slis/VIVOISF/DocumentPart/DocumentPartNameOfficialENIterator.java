...
public class DocumentPartNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameOfficialENIterator.class);
