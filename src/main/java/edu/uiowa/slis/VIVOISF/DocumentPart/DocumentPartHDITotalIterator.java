...
public class DocumentPartHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHDITotalIterator.class);
