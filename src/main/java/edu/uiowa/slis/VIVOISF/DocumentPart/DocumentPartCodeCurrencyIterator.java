...
public class DocumentPartCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCodeCurrencyIterator.class);
