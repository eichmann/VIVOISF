...
public class DocumentPartNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameCurrencyITIterator.class);
