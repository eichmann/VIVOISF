...
public class DocumentPartShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartShortTitleIterator.class);
