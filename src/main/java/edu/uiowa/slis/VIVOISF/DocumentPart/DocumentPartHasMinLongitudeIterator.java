...
public class DocumentPartHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHasMinLongitudeIterator.class);
