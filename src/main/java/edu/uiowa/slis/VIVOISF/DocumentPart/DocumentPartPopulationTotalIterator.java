...
public class DocumentPartPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartPopulationTotalIterator.class);
