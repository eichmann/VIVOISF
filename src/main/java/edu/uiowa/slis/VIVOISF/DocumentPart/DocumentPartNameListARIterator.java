...
public class DocumentPartNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameListARIterator.class);
