...
public class DocumentPartLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartLandAreaTotalIterator.class);
