...
public class DocumentPartUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartUpcIterator.class);
