...
public class DocumentPartContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartContentIterator.class);
