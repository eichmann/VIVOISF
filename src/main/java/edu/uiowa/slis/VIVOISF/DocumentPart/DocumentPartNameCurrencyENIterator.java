...
public class DocumentPartNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameCurrencyENIterator.class);
