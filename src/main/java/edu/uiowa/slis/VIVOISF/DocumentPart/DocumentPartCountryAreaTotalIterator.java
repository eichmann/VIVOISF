...
public class DocumentPartCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCountryAreaTotalIterator.class);
