...
public class DocumentPartAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartAgriculturalAreaUnitIterator.class);
