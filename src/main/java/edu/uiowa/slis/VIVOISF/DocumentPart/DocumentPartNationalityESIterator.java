...
public class DocumentPartNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNationalityESIterator.class);
