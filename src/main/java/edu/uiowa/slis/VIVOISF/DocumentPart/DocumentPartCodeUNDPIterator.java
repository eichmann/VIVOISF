...
public class DocumentPartCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCodeUNDPIterator.class);
