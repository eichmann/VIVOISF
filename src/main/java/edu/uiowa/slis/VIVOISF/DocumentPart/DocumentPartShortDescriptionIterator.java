...
public class DocumentPartShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartShortDescriptionIterator.class);
