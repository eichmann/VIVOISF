...
public class DocumentPartTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartTheAbstractIterator.class);
