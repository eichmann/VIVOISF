...
public class DocumentPartNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameShortFRIterator.class);
