...
public class DocumentPartPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartPagesIterator.class);
