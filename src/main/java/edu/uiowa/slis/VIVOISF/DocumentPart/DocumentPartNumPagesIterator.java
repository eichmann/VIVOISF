...
public class DocumentPartNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNumPagesIterator.class);
