...
public class DocumentPartNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameShortZHIterator.class);
