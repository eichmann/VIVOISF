...
public class DocumentPartGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartGDPYearIterator.class);
