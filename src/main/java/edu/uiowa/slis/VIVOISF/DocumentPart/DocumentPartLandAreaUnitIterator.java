...
public class DocumentPartLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartLandAreaUnitIterator.class);
