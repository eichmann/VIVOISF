...
public class DocumentPartDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartDoiIterator.class);
