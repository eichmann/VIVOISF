...
public class DocumentPartNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameCurrencyZHIterator.class);
