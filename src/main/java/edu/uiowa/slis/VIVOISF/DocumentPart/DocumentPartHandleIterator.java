...
public class DocumentPartHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHandleIterator.class);
