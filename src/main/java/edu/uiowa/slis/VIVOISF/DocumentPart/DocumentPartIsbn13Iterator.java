...
public class DocumentPartIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartIsbn13Iterator.class);
