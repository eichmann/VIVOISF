...
public class DocumentPartGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartGDPNotesIterator.class);
