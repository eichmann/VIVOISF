...
public class DocumentPartLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartLandAreaYearIterator.class);
