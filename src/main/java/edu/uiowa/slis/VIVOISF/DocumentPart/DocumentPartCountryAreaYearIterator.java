...
public class DocumentPartCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCountryAreaYearIterator.class);
