...
public class DocumentPartDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartDescriptionIterator.class);
