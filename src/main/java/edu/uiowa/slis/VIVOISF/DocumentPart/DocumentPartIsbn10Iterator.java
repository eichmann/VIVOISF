...
public class DocumentPartIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartIsbn10Iterator.class);
