...
public class DocumentPartNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNationalityENIterator.class);
