...
public class DocumentPartCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCodeGAULIterator.class);
