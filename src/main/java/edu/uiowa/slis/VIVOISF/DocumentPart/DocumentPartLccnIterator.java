...
public class DocumentPartLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartLccnIterator.class);
