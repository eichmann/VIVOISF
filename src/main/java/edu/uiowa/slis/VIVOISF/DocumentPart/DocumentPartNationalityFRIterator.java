...
public class DocumentPartNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNationalityFRIterator.class);
