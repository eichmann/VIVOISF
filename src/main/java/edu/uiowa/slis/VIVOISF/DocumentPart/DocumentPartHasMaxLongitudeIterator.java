...
public class DocumentPartHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHasMaxLongitudeIterator.class);
