...
public class DocumentPartNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameListZHIterator.class);
