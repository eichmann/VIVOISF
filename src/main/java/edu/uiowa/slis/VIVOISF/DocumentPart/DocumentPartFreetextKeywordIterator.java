...
public class DocumentPartFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartFreetextKeywordIterator.class);
