...
public class DocumentPartNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNationalityZHIterator.class);
