...
public class DocumentPartHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHasMinLatitudeIterator.class);
