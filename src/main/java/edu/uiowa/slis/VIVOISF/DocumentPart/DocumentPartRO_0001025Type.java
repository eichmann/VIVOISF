...
public class DocumentPartRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentPartRO_0001025Iterator.getType());
		} catch (Exception e) {
