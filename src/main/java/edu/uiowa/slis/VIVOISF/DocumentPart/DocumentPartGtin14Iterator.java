...
public class DocumentPartGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartGtin14Iterator.class);
