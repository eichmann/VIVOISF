...
public class DocumentPartNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameOfficialFRIterator.class);
