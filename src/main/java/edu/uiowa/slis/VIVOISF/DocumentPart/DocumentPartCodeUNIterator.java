...
public class DocumentPartCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCodeUNIterator.class);
