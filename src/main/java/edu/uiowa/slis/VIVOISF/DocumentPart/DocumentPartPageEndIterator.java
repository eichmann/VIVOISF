...
public class DocumentPartPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartPageEndIterator.class);
