...
public class DocumentPartPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartPopulationNotesIterator.class);
