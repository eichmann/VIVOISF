...
public class DocumentPartARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartARG_0000001Iterator.class);
