...
public class DocumentPartLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartLocatorIterator.class);
