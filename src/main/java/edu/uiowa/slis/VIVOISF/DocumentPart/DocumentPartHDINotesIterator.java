...
public class DocumentPartHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHDINotesIterator.class);
