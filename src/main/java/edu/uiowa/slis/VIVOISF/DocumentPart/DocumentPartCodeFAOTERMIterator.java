...
public class DocumentPartCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCodeFAOTERMIterator.class);
