...
public class DocumentPartNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNationalityARIterator.class);
