...
public class DocumentPartUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartUrlIterator.class);
