...
public class DocumentPartNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameListESIterator.class);
