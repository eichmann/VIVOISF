...
public class DocumentPartAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartAgriculturalAreaTotalIterator.class);
