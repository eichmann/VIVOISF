...
public class DocumentPartNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameListFRIterator.class);
