...
public class DocumentPartPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartPopulationYearIterator.class);
