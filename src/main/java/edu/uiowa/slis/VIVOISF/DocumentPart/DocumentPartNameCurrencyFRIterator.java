...
public class DocumentPartNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameCurrencyFRIterator.class);
