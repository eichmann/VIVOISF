...
public class DocumentPartHasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentPartHasNameIterator.getType());
		} catch (Exception e) {
