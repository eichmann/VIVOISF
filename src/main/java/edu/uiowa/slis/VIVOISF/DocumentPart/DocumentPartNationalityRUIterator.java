...
public class DocumentPartNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNationalityRUIterator.class);
