...
public class DocumentPartNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameListENIterator.class);
