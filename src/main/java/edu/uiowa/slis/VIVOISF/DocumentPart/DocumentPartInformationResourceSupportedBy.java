...
public class DocumentPartInformationResourceSupportedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartInformationResourceSupportedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartInformationResourceSupportedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentPartInformationResourceSupportedByIterator.getInformationResourceSupportedBy());
		} catch (Exception e) {
