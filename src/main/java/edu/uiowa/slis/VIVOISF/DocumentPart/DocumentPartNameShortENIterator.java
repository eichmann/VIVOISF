...
public class DocumentPartNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameShortENIterator.class);
