...
public class DocumentPartNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameShortARIterator.class);
