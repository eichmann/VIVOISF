...
public class DocumentPartHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHDIYearIterator.class);
