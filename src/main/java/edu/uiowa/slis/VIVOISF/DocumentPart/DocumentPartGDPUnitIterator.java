...
public class DocumentPartGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartGDPUnitIterator.class);
