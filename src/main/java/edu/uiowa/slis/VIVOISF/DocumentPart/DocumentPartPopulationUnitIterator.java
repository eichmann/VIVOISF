...
public class DocumentPartPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartPopulationUnitIterator.class);
