...
public class DocumentPartNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameOfficialZHIterator.class);
