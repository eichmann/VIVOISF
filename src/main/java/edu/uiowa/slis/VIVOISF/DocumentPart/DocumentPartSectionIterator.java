...
public class DocumentPartSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartSectionIterator.class);
