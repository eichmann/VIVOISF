...
public class DocumentPartBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentPartBFO_0000051Iterator.getType());
		} catch (Exception e) {
