...
public class DocumentPartCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCodeFAOSTATIterator.class);
