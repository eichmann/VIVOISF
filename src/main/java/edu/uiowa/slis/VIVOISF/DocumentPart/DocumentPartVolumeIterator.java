...
public class DocumentPartVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartVolumeIterator.class);
