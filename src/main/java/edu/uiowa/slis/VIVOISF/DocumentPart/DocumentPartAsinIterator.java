...
public class DocumentPartAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartAsinIterator.class);
