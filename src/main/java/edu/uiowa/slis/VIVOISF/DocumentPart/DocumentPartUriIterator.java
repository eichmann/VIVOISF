...
public class DocumentPartUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartUriIterator.class);
