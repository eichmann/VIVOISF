...
public class DocumentPartCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCodeAGROVOCIterator.class);
