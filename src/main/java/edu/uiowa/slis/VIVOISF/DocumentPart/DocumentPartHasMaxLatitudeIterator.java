...
public class DocumentPartHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHasMaxLatitudeIterator.class);
