...
public class DocumentPartCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCodeDBPediaIDIterator.class);
