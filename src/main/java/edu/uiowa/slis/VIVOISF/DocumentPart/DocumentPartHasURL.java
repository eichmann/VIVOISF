...
public class DocumentPartHasURL extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHasURL currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHasURL.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentPartHasURLIterator.getHasURL());
		} catch (Exception e) {
