...
public class DocumentPartReproducedIn extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartReproducedIn currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartReproducedIn.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentPartReproducedInIterator.getReproducedIn());
		} catch (Exception e) {
