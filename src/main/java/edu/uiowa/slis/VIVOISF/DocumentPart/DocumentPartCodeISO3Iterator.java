...
public class DocumentPartCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCodeISO3Iterator.class);
