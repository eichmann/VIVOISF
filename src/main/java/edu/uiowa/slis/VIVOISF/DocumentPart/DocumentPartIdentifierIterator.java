...
public class DocumentPartIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartIdentifierIterator.class);
