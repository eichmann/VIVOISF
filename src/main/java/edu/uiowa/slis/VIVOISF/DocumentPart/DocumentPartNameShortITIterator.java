...
public class DocumentPartNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameShortITIterator.class);
