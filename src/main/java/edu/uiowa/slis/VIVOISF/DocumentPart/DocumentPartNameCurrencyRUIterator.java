...
public class DocumentPartNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameCurrencyRUIterator.class);
