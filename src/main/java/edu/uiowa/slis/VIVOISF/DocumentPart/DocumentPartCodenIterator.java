...
public class DocumentPartCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCodenIterator.class);
