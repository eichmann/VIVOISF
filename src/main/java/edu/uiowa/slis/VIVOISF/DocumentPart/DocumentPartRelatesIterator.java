...
public class DocumentPartRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DocumentPartRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DocumentPartRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DocumentPartRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DocumentPartRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DocumentPartRelates doEndTag", e);
			throw new JspTagException("Exception raised in DocumentPartRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DocumentPartRelatesIterator");
