...
public class DocumentPartNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameShortRUIterator.class);
