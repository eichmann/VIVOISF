...
public class DocumentPartNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameOfficialARIterator.class);
