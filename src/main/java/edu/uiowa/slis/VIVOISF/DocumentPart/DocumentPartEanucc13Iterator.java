...
public class DocumentPartEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartEanucc13Iterator.class);
