...
public class DocumentPartNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameShortESIterator.class);
