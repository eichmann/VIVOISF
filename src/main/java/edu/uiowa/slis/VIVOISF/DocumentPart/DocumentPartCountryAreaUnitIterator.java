...
public class DocumentPartCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCountryAreaUnitIterator.class);
