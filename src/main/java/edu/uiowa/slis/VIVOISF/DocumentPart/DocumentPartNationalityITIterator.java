...
public class DocumentPartNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNationalityITIterator.class);
