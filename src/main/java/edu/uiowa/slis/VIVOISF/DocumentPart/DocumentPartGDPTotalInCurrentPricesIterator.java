...
public class DocumentPartGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartGDPTotalInCurrentPricesIterator.class);
