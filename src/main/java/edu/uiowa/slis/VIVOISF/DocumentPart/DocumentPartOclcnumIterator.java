...
public class DocumentPartOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartOclcnumIterator.class);
