...
public class DocumentPartEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartEditionIterator.class);
