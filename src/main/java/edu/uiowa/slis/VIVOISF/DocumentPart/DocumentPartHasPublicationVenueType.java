...
public class DocumentPartHasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartHasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartHasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentPartHasPublicationVenueIterator.getType());
		} catch (Exception e) {
