...
public class DocumentPartAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartAgriculturalAreaYearIterator.class);
