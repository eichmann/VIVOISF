...
public class DocumentPartNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNameListITIterator.class);
