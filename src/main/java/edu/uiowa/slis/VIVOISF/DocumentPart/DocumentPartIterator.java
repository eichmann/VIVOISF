...
public class DocumentPartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://purl.org/ontology/bibo/DocumentPart> . "+
