...
public class DocumentPartCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartCountryAreaNotesIterator.class);
