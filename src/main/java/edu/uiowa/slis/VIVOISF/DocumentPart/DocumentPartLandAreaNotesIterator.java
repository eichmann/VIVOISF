...
public class DocumentPartLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartLandAreaNotesIterator.class);
