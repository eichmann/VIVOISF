...
public class DocumentPartARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentPartARG_2000028Iterator.getType());
		} catch (Exception e) {
