...
public class DocumentPartRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentPartRO_0002234Iterator.getType());
		} catch (Exception e) {
