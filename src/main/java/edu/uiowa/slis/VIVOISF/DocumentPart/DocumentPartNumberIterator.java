...
public class DocumentPartNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPartNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPartNumberIterator.class);
