...
public class geographical_regionOrcidIdInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionOrcidIdInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionOrcidIdInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegeographical_regionOrcidIdInverseIterator.getOrcidIdInverse());
		} catch (Exception e) {
