...
public class geographical_regionGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionGDPYearIterator.class);
