...
public class geographical_regionTopObjectPropertyType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionTopObjectPropertyType currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionTopObjectPropertyType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegeographical_regionTopObjectPropertyIterator.getType());
		} catch (Exception e) {
