...
public class geographical_regionFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionFreetextKeywordIterator.class);
