...
public class geographical_regionCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionCodeGAULIterator.class);
