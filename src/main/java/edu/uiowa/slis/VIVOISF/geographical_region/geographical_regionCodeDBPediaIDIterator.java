...
public class geographical_regionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionCodeDBPediaIDIterator.class);
