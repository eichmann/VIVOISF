...
public class geographical_regionMiddleNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionMiddleNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionMiddleNameIterator.class);
