...
public class geographical_regionTelephoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionTelephoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionTelephoneIterator.class);
