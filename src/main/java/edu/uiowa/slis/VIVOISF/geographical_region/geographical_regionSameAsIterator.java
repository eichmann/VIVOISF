...
public class geographical_regionSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionSameAsIterator.class);
