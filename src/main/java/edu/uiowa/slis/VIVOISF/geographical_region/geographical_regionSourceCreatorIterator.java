...
public class geographical_regionSourceCreatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionSourceCreatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionSourceCreatorIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				sourceCreator = sol.get("?s").toString();
