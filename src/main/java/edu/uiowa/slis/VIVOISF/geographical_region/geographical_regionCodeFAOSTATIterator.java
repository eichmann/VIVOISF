...
public class geographical_regionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionCodeFAOSTATIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#codeFAOSTAT> ?s } ");
			if(rs.hasNext()) {
