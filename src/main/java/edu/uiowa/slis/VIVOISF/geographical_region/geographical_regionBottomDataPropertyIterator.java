...
public class geographical_regionBottomDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionBottomDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionBottomDataPropertyIterator.class);
