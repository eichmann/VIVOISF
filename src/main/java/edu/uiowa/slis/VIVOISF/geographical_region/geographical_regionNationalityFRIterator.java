...
public class geographical_regionNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionNationalityFRIterator.class);
