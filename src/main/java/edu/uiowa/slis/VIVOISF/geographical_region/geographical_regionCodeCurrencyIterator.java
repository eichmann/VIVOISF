...
public class geographical_regionCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionCodeCurrencyIterator.class);
