...
public class geographical_regionCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionCodeUNDPIterator.class);
