...
public class geographical_regionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionLandAreaYearIterator.class);
