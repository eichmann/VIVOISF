...
public class geographical_regionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionPopulationNotesIterator.class);
