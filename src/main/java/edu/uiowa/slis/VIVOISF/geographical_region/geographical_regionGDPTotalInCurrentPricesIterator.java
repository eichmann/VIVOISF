...
public class geographical_regionGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionGDPTotalInCurrentPricesIterator.class);
