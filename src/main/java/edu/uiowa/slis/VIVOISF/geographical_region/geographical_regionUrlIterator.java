...
public class geographical_regionUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionUrlIterator.class);
