...
public class geographical_regionSubjectAreaOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionSubjectAreaOf currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionSubjectAreaOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegeographical_regionSubjectAreaOfIterator.getSubjectAreaOf());
		} catch (Exception e) {
