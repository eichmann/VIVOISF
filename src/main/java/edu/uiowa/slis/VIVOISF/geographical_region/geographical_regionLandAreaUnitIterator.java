...
public class geographical_regionLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionLandAreaUnitIterator.class);
