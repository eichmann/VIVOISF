...
public class geographical_regionSourceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionSourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionSourceIterator.class);
