...
public class geographical_regionNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionNameOfficialFRIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#nameOfficialFR> ?s } ");
			if(rs.hasNext()) {
