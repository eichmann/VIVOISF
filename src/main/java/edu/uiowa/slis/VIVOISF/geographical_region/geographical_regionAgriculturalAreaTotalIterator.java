...
public class geographical_regionAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionAgriculturalAreaTotalIterator.class);
