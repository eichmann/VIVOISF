...
public class geographical_regionHasEmailType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHasEmailType currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHasEmailType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegeographical_regionHasEmailIterator.getType());
		} catch (Exception e) {
