...
public class geographical_regionCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionCountryAreaUnitIterator.class);
