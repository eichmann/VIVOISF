...
public class geographical_regionRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegeographical_regionRO_0000053Iterator.getType());
		} catch (Exception e) {
