...
public class geographical_regionValidUntilIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionValidUntilIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionValidUntilIterator.class);
