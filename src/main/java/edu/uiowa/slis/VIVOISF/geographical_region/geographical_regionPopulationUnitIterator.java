...
public class geographical_regionPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionPopulationUnitIterator.class);
