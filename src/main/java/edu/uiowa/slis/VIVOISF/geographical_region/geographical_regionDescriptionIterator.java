...
public class geographical_regionDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionDescriptionIterator.class);
