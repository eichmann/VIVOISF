...
public class geographical_regionCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionCountryAreaTotalIterator.class);
