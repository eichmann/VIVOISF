...
public class geographical_regionHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHasMaxLatitudeIterator.class);
