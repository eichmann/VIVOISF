...
public class geographical_regionNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionNationalityENIterator.class);
