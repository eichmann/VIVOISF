...
public class geographical_regionARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegeographical_regionARG_2000028Iterator.getType());
		} catch (Exception e) {
