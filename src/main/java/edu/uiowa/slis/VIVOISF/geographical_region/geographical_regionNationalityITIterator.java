...
public class geographical_regionNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionNationalityITIterator.class);
