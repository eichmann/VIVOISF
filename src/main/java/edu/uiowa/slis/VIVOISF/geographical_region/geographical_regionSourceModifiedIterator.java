...
public class geographical_regionSourceModifiedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionSourceModifiedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionSourceModifiedIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				sourceModified = sol.get("?s").toString();
