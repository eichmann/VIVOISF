...
public class geographical_regionDateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionDateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionDateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegeographical_regionDateTimeIntervalIterator.getType());
		} catch (Exception e) {
