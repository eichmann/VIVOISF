...
public class geographical_regionPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionPopulationTotalIterator.class);
