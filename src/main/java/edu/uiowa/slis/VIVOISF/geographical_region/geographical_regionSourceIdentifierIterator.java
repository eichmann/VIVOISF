...
public class geographical_regionSourceIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionSourceIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionSourceIdentifierIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				sourceIdentifier = sol.get("?s").toString();
