...
public class geographical_regionHasCodeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHasCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHasCodeIterator.class);
