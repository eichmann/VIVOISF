...
public class geographical_regionGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionGDPNotesIterator.class);
