...
public class geographical_regionGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionGDPUnitIterator.class);
