...
public class geographical_regionHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHDIYearIterator.class);
