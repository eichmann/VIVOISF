...
public class geographical_regionCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionCountryAreaYearIterator.class);
