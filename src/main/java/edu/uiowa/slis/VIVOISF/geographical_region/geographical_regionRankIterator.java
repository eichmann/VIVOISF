...
public class geographical_regionRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionRankIterator.class);
