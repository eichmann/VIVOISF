...
public class geographical_regionNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionNameShortITIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#nameShortIT> ?s } ");
			if(rs.hasNext()) {
