...
public class geographical_regionCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionCodeISO2Iterator.class);
