...
public class geographical_regionNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionNationalityRUIterator.class);
