...
public class geographical_regionNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionNationalityESIterator.class);
