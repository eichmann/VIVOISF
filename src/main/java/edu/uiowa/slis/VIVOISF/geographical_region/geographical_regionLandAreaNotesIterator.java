...
public class geographical_regionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionLandAreaNotesIterator.class);
