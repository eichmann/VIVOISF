...
public class geographical_regionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHDINotesIterator.class);
