...
public class geographical_regionHasOfficialNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHasOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHasOfficialNameIterator.class);
