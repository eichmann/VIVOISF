...
public class geographical_regionValidSinceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionValidSinceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionValidSinceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#validSince> ?s } ");
			if(rs.hasNext()) {
