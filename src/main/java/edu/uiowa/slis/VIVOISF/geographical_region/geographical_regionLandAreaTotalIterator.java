...
public class geographical_regionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionLandAreaTotalIterator.class);
