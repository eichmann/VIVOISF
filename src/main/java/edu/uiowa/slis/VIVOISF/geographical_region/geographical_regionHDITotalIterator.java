...
public class geographical_regionHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHDITotalIterator.class);
