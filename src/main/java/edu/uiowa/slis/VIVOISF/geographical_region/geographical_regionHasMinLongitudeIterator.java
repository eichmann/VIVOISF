...
public class geographical_regionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHasMinLongitudeIterator.class);
