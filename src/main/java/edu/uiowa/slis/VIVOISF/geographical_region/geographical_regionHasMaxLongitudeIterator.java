...
public class geographical_regionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHasMaxLongitudeIterator.class);
