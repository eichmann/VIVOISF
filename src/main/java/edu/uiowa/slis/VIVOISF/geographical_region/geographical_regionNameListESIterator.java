...
public class geographical_regionNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionNameListESIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#nameListES> ?s } ");
			if(rs.hasNext()) {
