...
public class geographical_regionPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionPopulationYearIterator.class);
