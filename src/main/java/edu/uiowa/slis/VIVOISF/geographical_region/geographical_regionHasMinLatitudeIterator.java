...
public class geographical_regionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHasMinLatitudeIterator.class);
