...
public class geographical_regionCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionCodeFAOTERMIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#codeFAOTERM> ?s } ");
			if(rs.hasNext()) {
