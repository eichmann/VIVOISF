...
public class geographical_regionValidInInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionValidInInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionValidInInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegeographical_regionValidInInverseIterator.getType());
		} catch (Exception e) {
