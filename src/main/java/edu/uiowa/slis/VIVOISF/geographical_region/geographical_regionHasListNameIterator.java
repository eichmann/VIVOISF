...
public class geographical_regionHasListNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static geographical_regionHasListNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(geographical_regionHasListNameIterator.class);
