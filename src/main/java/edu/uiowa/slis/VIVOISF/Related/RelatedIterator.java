...
public class RelatedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RelatedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RelatedIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://www.w3.org/2006/vcard/ns#Related> . "+
