...
public class ListContributorListInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ListContributorListInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ListContributorListInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theListContributorListInverseIterator.getContributorListInverse());
		} catch (Exception e) {
