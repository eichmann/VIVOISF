...
public class Phase_2BFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Phase_2BFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(Phase_2BFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePhase_2BFO_0000055Iterator.getType());
		} catch (Exception e) {
