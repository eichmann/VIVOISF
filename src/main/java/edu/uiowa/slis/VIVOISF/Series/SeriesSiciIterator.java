...
public class SeriesSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesSiciIterator.class);
