...
public class SeriesIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesIsbn10Iterator.class);
