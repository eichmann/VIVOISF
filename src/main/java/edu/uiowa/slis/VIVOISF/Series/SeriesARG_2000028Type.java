...
public class SeriesARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeriesARG_2000028Iterator.getType());
		} catch (Exception e) {
