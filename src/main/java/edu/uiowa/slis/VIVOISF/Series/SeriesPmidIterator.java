...
public class SeriesPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesPmidIterator.class);
