...
public class SeriesUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesUriIterator.class);
