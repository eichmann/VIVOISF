...
public class SeriesIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeriesIAO_0000136Iterator.getType());
		} catch (Exception e) {
