...
public class SeriesHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesHandleIterator.class);
