...
public class SeriesRO_0002353 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesRO_0002353 currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesRO_0002353.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeriesRO_0002353Iterator.getRO_0002353());
		} catch (Exception e) {
