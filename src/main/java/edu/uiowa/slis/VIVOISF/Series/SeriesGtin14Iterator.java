...
public class SeriesGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesGtin14Iterator.class);
