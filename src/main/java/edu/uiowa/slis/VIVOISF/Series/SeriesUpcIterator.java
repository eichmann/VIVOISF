...
public class SeriesUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesUpcIterator.class);
