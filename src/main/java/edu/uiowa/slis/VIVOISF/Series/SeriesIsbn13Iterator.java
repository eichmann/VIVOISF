...
public class SeriesIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesIsbn13Iterator.class);
