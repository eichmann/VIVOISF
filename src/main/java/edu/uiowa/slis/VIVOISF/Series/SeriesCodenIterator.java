...
public class SeriesCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesCodenIterator.class);
