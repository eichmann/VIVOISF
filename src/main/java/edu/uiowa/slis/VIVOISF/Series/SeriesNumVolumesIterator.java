...
public class SeriesNumVolumesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesNumVolumesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesNumVolumesIterator.class);
