...
public class SeriesDistributorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesDistributorType currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesDistributorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeriesDistributorIterator.getType());
		} catch (Exception e) {
