...
public class SeriesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/Series> . "+
