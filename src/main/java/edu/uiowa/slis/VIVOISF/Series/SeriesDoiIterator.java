...
public class SeriesDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesDoiIterator.class);
