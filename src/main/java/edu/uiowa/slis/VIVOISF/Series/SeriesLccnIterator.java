...
public class SeriesLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesLccnIterator.class);
