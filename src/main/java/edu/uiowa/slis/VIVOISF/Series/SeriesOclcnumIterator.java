...
public class SeriesOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeriesOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeriesOclcnumIterator.class);
