...
public class ProjectRO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProjectRO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ProjectRO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProjectRO_0000057Iterator.getType());
		} catch (Exception e) {
