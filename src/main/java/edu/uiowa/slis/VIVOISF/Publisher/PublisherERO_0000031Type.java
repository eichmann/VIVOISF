...
public class PublisherERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherERO_0000031Iterator.getType());
		} catch (Exception e) {
