...
public class PublisherPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherPopulationYearIterator.class);
