...
public class PublisherCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCodeISO3Iterator.class);
