...
public class PublisherNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameCurrencyRUIterator.class);
