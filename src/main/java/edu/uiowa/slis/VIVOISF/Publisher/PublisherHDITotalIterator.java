...
public class PublisherHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherHDITotalIterator.class);
