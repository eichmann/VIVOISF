...
public class PublisherNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameShortITIterator.class);
