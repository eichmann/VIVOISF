...
public class PublisherNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameOfficialARIterator.class);
