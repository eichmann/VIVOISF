...
public class PublisherNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameListRUIterator.class);
