...
public class PublisherHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherHasMaxLongitudeIterator.class);
