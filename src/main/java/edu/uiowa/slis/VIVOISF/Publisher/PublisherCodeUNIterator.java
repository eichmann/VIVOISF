...
public class PublisherCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCodeUNIterator.class);
