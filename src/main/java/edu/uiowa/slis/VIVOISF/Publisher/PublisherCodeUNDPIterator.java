...
public class PublisherCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCodeUNDPIterator.class);
