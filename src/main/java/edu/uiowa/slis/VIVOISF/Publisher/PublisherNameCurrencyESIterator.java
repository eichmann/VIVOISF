...
public class PublisherNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameCurrencyESIterator.class);
