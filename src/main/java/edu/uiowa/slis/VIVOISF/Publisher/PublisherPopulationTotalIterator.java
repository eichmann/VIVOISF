...
public class PublisherPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherPopulationTotalIterator.class);
