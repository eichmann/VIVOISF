...
public class PublisherRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherRO_0000056Iterator.getType());
		} catch (Exception e) {
