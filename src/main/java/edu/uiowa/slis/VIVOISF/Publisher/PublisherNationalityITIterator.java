...
public class PublisherNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNationalityITIterator.class);
