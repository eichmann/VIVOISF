...
public class PublisherNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameShortFRIterator.class);
