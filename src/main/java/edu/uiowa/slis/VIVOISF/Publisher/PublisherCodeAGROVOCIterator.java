...
public class PublisherCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCodeAGROVOCIterator.class);
