...
public class PublisherNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNationalityFRIterator.class);
