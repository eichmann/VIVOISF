...
public class PublisherNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameOfficialRUIterator.class);
