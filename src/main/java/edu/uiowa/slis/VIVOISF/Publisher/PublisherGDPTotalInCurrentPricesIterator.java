...
public class PublisherGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherGDPTotalInCurrentPricesIterator.class);
