...
public class PublisherCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCodeCurrencyIterator.class);
