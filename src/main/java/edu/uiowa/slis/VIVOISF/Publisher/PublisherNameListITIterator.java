...
public class PublisherNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameListITIterator.class);
