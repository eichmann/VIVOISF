...
public class PublisherIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherIterator currentInstance = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Publisher> . "+
