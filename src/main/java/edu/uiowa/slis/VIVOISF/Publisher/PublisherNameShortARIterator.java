...
public class PublisherNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameShortARIterator.class);
