...
public class PublisherPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherPopulationUnitIterator.class);
