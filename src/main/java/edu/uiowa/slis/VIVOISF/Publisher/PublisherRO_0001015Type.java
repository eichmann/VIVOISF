...
public class PublisherRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherRO_0001015Iterator.getType());
		} catch (Exception e) {
