...
public class PublisherHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherHasMinLongitudeIterator.class);
