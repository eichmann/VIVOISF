...
public class PublisherOwnerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherOwnerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherOwnerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherOwnerInverseIterator.getOwnerInverse());
		} catch (Exception e) {
