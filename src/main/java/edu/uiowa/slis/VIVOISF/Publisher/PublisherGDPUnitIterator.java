...
public class PublisherGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherGDPUnitIterator.class);
