...
public class PublisherLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherLandAreaYearIterator.class);
