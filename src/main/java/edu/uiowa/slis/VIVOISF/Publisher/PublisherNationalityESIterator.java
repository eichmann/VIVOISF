...
public class PublisherNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNationalityESIterator.class);
