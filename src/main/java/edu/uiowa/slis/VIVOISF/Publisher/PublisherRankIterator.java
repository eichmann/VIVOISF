...
public class PublisherRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherRankIterator.class);
