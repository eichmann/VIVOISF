...
public class PublisherERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherERO_0000037Iterator.getType());
		} catch (Exception e) {
