...
public class PublisherGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherGDPYearIterator.class);
