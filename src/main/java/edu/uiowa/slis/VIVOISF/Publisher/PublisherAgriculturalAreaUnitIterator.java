...
public class PublisherAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherAgriculturalAreaUnitIterator.class);
