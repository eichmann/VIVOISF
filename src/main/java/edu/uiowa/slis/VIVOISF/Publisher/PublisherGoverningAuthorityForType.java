...
public class PublisherGoverningAuthorityForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherGoverningAuthorityForType currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherGoverningAuthorityForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherGoverningAuthorityForIterator.getType());
		} catch (Exception e) {
