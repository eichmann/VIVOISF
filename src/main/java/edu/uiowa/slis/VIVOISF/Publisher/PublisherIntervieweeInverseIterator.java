...
public class PublisherIntervieweeInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherIntervieweeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherIntervieweeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PublisherIntervieweeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PublisherIntervieweeInverseIterator doStartTag");
		}
