...
public class PublisherCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCountryAreaTotalIterator.class);
