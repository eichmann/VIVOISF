...
public class PublisherHasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherHasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherHasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherHasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
