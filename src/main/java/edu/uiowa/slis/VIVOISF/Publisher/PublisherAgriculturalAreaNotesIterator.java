...
public class PublisherAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherAgriculturalAreaNotesIterator.class);
