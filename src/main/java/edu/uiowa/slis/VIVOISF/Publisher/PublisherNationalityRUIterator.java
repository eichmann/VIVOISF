...
public class PublisherNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNationalityRUIterator.class);
