...
public class PublisherPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherPopulationNotesIterator.class);
