...
public class PublisherNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameCurrencyARIterator.class);
