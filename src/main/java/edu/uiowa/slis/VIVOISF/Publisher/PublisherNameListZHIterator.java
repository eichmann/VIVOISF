...
public class PublisherNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameListZHIterator.class);
