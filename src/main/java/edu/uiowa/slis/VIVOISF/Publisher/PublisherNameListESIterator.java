...
public class PublisherNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameListESIterator.class);
