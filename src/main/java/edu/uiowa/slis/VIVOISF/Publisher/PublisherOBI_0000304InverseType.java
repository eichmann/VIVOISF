...
public class PublisherOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
