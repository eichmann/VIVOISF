...
public class PublisherNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNationalityARIterator.class);
