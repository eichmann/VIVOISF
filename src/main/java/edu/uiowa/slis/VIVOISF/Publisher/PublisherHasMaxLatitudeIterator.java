...
public class PublisherHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherHasMaxLatitudeIterator.class);
