...
public class PublisherNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameListARIterator.class);
