...
public class PublisherCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCodeFAOSTATIterator.class);
