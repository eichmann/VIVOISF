...
public class PublisherNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameShortRUIterator.class);
