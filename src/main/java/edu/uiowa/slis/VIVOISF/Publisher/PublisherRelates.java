...
public class PublisherRelates extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherRelates currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherRelates.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherRelatesIterator.getRelates());
		} catch (Exception e) {
