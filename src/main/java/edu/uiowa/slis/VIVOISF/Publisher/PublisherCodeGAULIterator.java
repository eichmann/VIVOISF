...
public class PublisherCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCodeGAULIterator.class);
