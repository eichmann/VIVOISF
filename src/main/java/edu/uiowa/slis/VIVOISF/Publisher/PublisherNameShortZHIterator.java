...
public class PublisherNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameShortZHIterator.class);
