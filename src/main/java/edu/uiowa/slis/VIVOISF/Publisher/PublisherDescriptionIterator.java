...
public class PublisherDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherDescriptionIterator.class);
