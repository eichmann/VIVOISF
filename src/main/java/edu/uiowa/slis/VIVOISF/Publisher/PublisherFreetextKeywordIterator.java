...
public class PublisherFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherFreetextKeywordIterator.class);
