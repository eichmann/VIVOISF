...
public class PublisherNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameOfficialZHIterator.class);
