...
public class PublisherTranslatorOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherTranslatorOf currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherTranslatorOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherTranslatorOfIterator.getTranslatorOf());
		} catch (Exception e) {
