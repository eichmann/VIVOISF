...
public class PublisherGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherGDPNotesIterator.class);
