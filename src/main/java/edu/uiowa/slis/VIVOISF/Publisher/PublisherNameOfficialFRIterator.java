...
public class PublisherNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameOfficialFRIterator.class);
