...
public class PublisherNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameOfficialITIterator.class);
