...
public class PublisherNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNationalityENIterator.class);
