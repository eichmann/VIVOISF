...
public class PublisherCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCountryAreaUnitIterator.class);
