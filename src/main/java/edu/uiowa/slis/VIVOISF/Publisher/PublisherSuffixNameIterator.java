...
public class PublisherSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherSuffixNameIterator.class);
