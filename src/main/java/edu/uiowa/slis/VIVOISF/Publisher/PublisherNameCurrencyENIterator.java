...
public class PublisherNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameCurrencyENIterator.class);
