...
public class PublisherERO_0001520 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherERO_0001520 currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherERO_0001520.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherERO_0001520Iterator.getERO_0001520());
		} catch (Exception e) {
