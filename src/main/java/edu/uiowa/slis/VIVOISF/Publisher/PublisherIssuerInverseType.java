...
public class PublisherIssuerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherIssuerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherIssuerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherIssuerInverseIterator.getType());
		} catch (Exception e) {
