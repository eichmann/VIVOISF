...
public class PublisherCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCountryAreaYearIterator.class);
