...
public class PublisherNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameCurrencyITIterator.class);
