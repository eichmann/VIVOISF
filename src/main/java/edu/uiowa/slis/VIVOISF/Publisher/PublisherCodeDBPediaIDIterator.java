...
public class PublisherCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCodeDBPediaIDIterator.class);
