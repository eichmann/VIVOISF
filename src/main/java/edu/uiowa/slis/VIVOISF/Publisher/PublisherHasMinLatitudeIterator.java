...
public class PublisherHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherHasMinLatitudeIterator.class);
