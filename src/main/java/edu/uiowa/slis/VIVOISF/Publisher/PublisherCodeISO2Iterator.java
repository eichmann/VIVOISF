...
public class PublisherCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCodeISO2Iterator.class);
