...
public class PublisherNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNationalityZHIterator.class);
