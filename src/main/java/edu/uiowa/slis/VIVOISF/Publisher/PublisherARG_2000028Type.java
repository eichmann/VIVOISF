...
public class PublisherARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherARG_2000028Iterator.getType());
		} catch (Exception e) {
