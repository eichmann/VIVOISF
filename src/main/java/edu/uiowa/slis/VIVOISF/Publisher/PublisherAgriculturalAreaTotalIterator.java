...
public class PublisherAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherAgriculturalAreaTotalIterator.class);
