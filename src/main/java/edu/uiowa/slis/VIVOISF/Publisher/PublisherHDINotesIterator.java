...
public class PublisherHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherHDINotesIterator.class);
