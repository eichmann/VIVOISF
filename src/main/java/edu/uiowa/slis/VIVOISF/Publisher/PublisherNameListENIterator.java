...
public class PublisherNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameListENIterator.class);
