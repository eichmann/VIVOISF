...
public class PublisherNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameShortENIterator.class);
