...
public class PublisherNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameListFRIterator.class);
