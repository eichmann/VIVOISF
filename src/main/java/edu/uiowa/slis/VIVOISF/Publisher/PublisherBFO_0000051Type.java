...
public class PublisherBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePublisherBFO_0000051Iterator.getType());
		} catch (Exception e) {
