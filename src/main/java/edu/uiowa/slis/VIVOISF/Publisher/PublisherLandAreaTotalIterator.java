...
public class PublisherLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherLandAreaTotalIterator.class);
