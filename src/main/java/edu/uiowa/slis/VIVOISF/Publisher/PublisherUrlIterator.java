...
public class PublisherUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherUrlIterator.class);
