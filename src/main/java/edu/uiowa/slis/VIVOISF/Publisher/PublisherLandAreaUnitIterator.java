...
public class PublisherLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherLandAreaUnitIterator.class);
