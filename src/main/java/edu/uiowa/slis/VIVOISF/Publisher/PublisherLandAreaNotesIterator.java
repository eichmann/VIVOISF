...
public class PublisherLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherLandAreaNotesIterator.class);
