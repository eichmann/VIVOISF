...
public class PublisherNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherNameShortESIterator.class);
