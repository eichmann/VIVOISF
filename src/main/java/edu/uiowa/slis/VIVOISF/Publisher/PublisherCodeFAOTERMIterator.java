...
public class PublisherCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PublisherCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PublisherCodeFAOTERMIterator.class);
