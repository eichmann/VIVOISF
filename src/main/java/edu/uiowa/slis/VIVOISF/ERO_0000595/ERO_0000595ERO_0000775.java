...
public class ERO_0000595ERO_0000775 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000595ERO_0000775 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000595ERO_0000775.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000595ERO_0000775Iterator.getERO_0000775());
		} catch (Exception e) {
