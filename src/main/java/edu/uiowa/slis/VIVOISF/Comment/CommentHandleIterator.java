...
public class CommentHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentHandleIterator.class);
