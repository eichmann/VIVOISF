...
public class CommentTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentTheAbstractIterator.class);
