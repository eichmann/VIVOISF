...
public class CommentNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentNumberIterator.class);
