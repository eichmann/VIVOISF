...
public class CommentIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCommentIAO_0000136Iterator.getType());
		} catch (Exception e) {
