...
public class CommentShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentShortTitleIterator.class);
