...
public class CommentSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentSiciIterator.class);
