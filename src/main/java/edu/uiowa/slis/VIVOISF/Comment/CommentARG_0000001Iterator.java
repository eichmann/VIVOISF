...
public class CommentARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentARG_0000001Iterator.class);
