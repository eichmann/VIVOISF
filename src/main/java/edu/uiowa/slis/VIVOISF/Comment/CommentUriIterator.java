...
public class CommentUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentUriIterator.class);
