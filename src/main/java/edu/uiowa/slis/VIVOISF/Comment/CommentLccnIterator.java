...
public class CommentLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentLccnIterator.class);
