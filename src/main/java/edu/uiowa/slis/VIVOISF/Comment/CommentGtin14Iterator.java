...
public class CommentGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentGtin14Iterator.class);
