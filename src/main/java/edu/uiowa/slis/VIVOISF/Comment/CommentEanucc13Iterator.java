...
public class CommentEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentEanucc13Iterator.class);
