...
public class CommentReproduces extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentReproduces currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentReproduces.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCommentReproducesIterator.getReproduces());
		} catch (Exception e) {
