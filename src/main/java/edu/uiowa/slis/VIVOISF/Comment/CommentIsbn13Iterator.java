...
public class CommentIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentIsbn13Iterator.class);
