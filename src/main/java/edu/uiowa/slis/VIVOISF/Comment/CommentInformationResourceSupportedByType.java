...
public class CommentInformationResourceSupportedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentInformationResourceSupportedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentInformationResourceSupportedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCommentInformationResourceSupportedByIterator.getType());
		} catch (Exception e) {
