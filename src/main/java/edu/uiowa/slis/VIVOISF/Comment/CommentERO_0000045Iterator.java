...
public class CommentERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentERO_0000045Iterator.class);
