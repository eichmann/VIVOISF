...
public class CommentAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentAsinIterator.class);
