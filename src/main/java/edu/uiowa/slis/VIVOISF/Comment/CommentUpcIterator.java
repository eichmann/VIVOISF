...
public class CommentUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentUpcIterator.class);
