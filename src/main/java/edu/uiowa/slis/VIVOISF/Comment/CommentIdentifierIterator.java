...
public class CommentIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentIdentifierIterator.class);
