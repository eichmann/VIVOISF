...
public class CommentDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentDoiIterator.class);
