...
public class CommentLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentLocatorIterator.class);
