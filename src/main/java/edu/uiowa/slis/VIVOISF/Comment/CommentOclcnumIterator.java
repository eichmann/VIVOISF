...
public class CommentOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentOclcnumIterator.class);
