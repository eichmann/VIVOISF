...
public class CommentIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentIsbn10Iterator.class);
