...
public class CommentCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentCodenIterator.class);
