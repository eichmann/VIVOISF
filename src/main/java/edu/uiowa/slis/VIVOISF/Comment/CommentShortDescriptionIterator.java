...
public class CommentShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentShortDescriptionIterator.class);
