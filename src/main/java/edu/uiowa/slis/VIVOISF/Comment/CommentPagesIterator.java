...
public class CommentPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentPagesIterator.class);
