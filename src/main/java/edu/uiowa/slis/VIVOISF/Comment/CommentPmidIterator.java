...
public class CommentPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentPmidIterator.class);
