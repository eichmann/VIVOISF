...
public class CommentPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommentPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommentPageStartIterator.class);
