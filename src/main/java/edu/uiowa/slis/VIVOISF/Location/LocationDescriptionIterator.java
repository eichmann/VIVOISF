...
public class LocationDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationDescriptionIterator.class);
