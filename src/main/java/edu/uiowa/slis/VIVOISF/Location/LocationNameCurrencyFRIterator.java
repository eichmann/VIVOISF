...
public class LocationNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameCurrencyFRIterator.class);
