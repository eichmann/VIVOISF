...
public class LocationCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCountryAreaUnitIterator.class);
