...
public class LocationDateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationDateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationDateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationDateTimeIntervalIterator.getType());
		} catch (Exception e) {
