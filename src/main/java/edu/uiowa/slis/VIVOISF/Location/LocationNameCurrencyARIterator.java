...
public class LocationNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameCurrencyARIterator.class);
