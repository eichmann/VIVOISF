...
public class LocationAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationAgriculturalAreaUnitIterator.class);
