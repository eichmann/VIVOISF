...
public class LocationNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameCurrencyRUIterator.class);
