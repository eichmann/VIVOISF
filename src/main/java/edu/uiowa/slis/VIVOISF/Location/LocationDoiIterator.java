...
public class LocationDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationDoiIterator.class);
