...
public class LocationNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameListENIterator.class);
