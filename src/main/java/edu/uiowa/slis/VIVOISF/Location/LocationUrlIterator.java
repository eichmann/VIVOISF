...
public class LocationUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationUrlIterator.class);
