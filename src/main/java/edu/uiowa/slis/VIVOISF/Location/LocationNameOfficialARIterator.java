...
public class LocationNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameOfficialARIterator.class);
