...
public class LocationNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameOfficialENIterator.class);
