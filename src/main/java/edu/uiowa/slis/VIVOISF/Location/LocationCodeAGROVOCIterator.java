...
public class LocationCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCodeAGROVOCIterator.class);
