...
public class LocationRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationRO_0002234Iterator.getType());
		} catch (Exception e) {
