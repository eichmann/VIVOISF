...
public class LocationAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationAgriculturalAreaNotesIterator.class);
