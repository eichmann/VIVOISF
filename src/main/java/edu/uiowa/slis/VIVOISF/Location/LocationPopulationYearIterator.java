...
public class LocationPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationPopulationYearIterator.class);
