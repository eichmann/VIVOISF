...
public class LocationNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameShortARIterator.class);
