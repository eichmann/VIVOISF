...
public class LocationNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameShortZHIterator.class);
