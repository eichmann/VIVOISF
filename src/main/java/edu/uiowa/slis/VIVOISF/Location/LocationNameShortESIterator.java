...
public class LocationNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameShortESIterator.class);
