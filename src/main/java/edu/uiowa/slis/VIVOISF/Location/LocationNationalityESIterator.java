...
public class LocationNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNationalityESIterator.class);
