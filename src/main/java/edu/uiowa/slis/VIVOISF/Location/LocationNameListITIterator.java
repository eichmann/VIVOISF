...
public class LocationNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameListITIterator.class);
