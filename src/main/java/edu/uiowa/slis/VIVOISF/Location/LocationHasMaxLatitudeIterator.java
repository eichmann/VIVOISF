...
public class LocationHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationHasMaxLatitudeIterator.class);
