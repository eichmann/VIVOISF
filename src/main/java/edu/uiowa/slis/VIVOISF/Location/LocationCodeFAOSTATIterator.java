...
public class LocationCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCodeFAOSTATIterator.class);
