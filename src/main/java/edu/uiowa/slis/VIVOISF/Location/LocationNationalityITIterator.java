...
public class LocationNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNationalityITIterator.class);
