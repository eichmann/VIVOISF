...
public class LocationPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationPopulationTotalIterator.class);
