...
public class LocationHasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationHasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationHasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationHasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
