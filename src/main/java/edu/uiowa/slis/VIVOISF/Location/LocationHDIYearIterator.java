...
public class LocationHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationHDIYearIterator.class);
