...
public class LocationGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationGDPUnitIterator.class);
