...
public class LocationNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameShortITIterator.class);
