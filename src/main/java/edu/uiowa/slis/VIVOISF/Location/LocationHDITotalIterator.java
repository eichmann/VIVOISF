...
public class LocationHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationHDITotalIterator.class);
