...
public class LocationNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameListRUIterator.class);
