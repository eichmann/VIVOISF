...
public class LocationCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCodeFAOTERMIterator.class);
