...
public class LocationRelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationRelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationRelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationRelatedByIterator.getType());
		} catch (Exception e) {
