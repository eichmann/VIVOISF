...
public class LocationHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationHasMaxLongitudeIterator.class);
