...
public class LocationNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameOfficialESIterator.class);
