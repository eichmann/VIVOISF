...
public class LocationPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationPopulationNotesIterator.class);
