...
public class LocationGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationGDPTotalInCurrentPricesIterator.class);
