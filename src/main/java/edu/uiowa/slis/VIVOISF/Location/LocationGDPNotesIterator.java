...
public class LocationGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationGDPNotesIterator.class);
