...
public class LocationNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNationalityRUIterator.class);
