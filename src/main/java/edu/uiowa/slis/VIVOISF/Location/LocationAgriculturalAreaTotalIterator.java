...
public class LocationAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationAgriculturalAreaTotalIterator.class);
