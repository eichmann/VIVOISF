...
public class LocationLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationLandAreaUnitIterator.class);
