...
public class LocationNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNationalityZHIterator.class);
