...
public class LocationNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameListESIterator.class);
