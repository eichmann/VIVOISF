...
public class LocationCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCodeUNDPIterator.class);
