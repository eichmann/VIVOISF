...
public class LocationNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameOfficialFRIterator.class);
