...
public class LocationHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationHasMinLongitudeIterator.class);
