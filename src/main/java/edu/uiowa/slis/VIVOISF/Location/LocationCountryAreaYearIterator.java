...
public class LocationCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCountryAreaYearIterator.class);
