...
public class LocationRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationRO_0001025Iterator.getType());
		} catch (Exception e) {
