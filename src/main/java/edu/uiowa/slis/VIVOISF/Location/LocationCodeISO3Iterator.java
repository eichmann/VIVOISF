...
public class LocationCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCodeISO3Iterator.class);
