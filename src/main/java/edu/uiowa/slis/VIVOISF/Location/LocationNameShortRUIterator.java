...
public class LocationNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameShortRUIterator.class);
