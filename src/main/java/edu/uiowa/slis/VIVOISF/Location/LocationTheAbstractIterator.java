...
public class LocationTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationTheAbstractIterator.class);
