...
public class LocationPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationPopulationUnitIterator.class);
