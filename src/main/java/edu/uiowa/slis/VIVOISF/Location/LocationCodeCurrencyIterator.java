...
public class LocationCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCodeCurrencyIterator.class);
