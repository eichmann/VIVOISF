...
public class LocationCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCountryAreaNotesIterator.class);
