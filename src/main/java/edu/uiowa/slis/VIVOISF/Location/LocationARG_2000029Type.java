...
public class LocationARG_2000029Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationARG_2000029Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationARG_2000029Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationARG_2000029Iterator.getType());
		} catch (Exception e) {
