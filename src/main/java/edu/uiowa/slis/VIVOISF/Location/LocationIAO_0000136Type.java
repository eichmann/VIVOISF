...
public class LocationIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationIAO_0000136Iterator.getType());
		} catch (Exception e) {
