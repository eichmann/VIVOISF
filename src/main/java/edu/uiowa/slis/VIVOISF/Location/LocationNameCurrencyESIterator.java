...
public class LocationNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameCurrencyESIterator.class);
