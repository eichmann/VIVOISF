...
public class LocationNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameListARIterator.class);
