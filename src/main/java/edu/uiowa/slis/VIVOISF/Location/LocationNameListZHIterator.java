...
public class LocationNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameListZHIterator.class);
