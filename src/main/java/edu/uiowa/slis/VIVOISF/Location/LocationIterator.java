...
public class LocationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationIterator currentInstance = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Location> . "+
