...
public class LocationNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameOfficialITIterator.class);
