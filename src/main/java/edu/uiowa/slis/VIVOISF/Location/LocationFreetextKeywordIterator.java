...
public class LocationFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationFreetextKeywordIterator.class);
