...
public class LocationCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCodeDBPediaIDIterator.class);
