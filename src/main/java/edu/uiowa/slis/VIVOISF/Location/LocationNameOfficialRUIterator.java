...
public class LocationNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationNameOfficialRUIterator.class);
