...
public class LocationLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationLandAreaTotalIterator.class);
