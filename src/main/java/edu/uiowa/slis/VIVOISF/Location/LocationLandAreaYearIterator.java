...
public class LocationLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationLandAreaYearIterator.class);
