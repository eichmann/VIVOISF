...
public class LocationCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCountryAreaTotalIterator.class);
