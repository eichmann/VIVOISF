...
public class LocationCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationCodeGAULIterator.class);
