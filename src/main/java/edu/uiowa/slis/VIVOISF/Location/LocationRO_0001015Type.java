...
public class LocationRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLocationRO_0001015Iterator.getType());
		} catch (Exception e) {
