...
public class LocationHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LocationHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LocationHasMinLatitudeIterator.class);
