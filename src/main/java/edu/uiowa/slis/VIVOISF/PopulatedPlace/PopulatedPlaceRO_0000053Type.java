...
public class PopulatedPlaceRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PopulatedPlaceRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PopulatedPlaceRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePopulatedPlaceRO_0000053Iterator.getType());
		} catch (Exception e) {
