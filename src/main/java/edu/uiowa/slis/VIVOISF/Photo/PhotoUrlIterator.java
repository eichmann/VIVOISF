...
public class PhotoUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PhotoUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PhotoUrlIterator.class);
