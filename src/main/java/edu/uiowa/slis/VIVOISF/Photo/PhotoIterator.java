...
public class PhotoIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PhotoIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PhotoIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://www.w3.org/2006/vcard/ns#Photo> . "+
