...
public class LaboratoryOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LaboratoryOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(LaboratoryOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLaboratoryOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
