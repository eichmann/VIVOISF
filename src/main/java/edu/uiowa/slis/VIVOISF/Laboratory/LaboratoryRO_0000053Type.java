...
public class LaboratoryRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LaboratoryRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LaboratoryRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLaboratoryRO_0000053Iterator.getType());
		} catch (Exception e) {
