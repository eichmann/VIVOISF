...
public class LaboratoryIntervieweeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LaboratoryIntervieweeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LaboratoryIntervieweeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LaboratoryIntervieweeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LaboratoryIntervieweeIterator doStartTag");
		}
