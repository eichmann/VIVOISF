...
public class LaboratoryInterviewerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LaboratoryInterviewerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(LaboratoryInterviewerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLaboratoryInterviewerInverseIterator.getInterviewerInverse());
		} catch (Exception e) {
