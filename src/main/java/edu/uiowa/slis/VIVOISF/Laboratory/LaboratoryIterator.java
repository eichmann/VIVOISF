...
public class LaboratoryIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LaboratoryIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LaboratoryIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(Prefix_1_4+
					" SELECT ?s ?l where { "+
						"?s rdfs:label ?l . "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Laboratory> . "+
					"} ORDER BY ?l");
			if(rs.hasNext()) {
