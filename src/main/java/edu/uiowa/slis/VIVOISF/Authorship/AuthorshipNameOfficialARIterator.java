...
public class AuthorshipNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameOfficialARIterator.class);
