...
public class AuthorshipCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCodeUNDPIterator.class);
