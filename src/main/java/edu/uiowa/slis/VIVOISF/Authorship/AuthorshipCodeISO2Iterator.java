...
public class AuthorshipCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCodeISO2Iterator.class);
