...
public class AuthorshipNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameShortARIterator.class);
