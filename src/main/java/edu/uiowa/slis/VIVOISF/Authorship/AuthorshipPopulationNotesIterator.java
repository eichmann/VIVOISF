...
public class AuthorshipPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipPopulationNotesIterator.class);
