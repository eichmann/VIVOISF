...
public class AuthorshipNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNationalityARIterator.class);
