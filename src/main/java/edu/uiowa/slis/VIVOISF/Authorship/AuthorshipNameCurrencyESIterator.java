...
public class AuthorshipNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameCurrencyESIterator.class);
