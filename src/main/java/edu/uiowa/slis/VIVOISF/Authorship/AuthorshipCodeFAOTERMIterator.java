...
public class AuthorshipCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCodeFAOTERMIterator.class);
