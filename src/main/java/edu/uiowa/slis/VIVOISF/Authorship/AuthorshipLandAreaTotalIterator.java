...
public class AuthorshipLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipLandAreaTotalIterator.class);
