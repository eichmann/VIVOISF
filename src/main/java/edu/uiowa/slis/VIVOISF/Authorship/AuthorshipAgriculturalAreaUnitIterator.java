...
public class AuthorshipAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipAgriculturalAreaUnitIterator.class);
