...
public class AuthorshipCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCodeGAULIterator.class);
