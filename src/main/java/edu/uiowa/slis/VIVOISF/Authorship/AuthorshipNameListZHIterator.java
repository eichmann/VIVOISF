...
public class AuthorshipNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameListZHIterator.class);
