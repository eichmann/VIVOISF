...
public class AuthorshipNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNationalityFRIterator.class);
