...
public class AuthorshipCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCountryAreaUnitIterator.class);
