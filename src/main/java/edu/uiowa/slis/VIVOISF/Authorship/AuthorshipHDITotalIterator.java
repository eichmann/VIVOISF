...
public class AuthorshipHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipHDITotalIterator.class);
