...
public class AuthorshipNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNationalityESIterator.class);
