...
public class AuthorshipNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameShortRUIterator.class);
