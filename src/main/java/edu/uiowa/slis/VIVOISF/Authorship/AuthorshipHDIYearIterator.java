...
public class AuthorshipHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipHDIYearIterator.class);
