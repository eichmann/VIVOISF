...
public class AuthorshipFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipFreetextKeywordIterator.class);
