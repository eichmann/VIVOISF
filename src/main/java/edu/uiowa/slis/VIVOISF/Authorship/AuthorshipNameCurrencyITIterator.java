...
public class AuthorshipNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameCurrencyITIterator.class);
