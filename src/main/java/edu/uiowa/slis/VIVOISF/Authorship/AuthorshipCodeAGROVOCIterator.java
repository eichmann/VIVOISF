...
public class AuthorshipCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCodeAGROVOCIterator.class);
