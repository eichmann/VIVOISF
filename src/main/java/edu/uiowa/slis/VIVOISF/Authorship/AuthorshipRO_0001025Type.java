...
public class AuthorshipRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAuthorshipRO_0001025Iterator.getType());
		} catch (Exception e) {
