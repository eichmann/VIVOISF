...
public class AuthorshipPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipPopulationTotalIterator.class);
