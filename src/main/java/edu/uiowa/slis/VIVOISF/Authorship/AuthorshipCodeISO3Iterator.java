...
public class AuthorshipCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCodeISO3Iterator.class);
