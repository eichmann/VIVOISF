...
public class AuthorshipNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameCurrencyENIterator.class);
