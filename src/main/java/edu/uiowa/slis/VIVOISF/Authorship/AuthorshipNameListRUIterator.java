...
public class AuthorshipNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameListRUIterator.class);
