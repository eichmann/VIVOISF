...
public class AuthorshipGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipGDPTotalInCurrentPricesIterator.class);
