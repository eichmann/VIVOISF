...
public class AuthorshipHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipHasMinLatitudeIterator.class);
