...
public class AuthorshipRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAuthorshipRO_0001015Iterator.getType());
		} catch (Exception e) {
