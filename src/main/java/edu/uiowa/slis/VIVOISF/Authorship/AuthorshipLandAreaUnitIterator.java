...
public class AuthorshipLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipLandAreaUnitIterator.class);
