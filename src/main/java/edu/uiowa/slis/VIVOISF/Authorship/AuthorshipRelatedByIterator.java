...
public class AuthorshipRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipRelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipRelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AuthorshipRelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AuthorshipRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AuthorshipRelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AuthorshipRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AuthorshipRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in AuthorshipRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AuthorshipRelatedByIterator");
