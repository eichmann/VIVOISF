...
public class AuthorshipNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameCurrencyARIterator.class);
