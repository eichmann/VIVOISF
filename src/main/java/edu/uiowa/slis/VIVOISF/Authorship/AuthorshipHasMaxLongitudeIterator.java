...
public class AuthorshipHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipHasMaxLongitudeIterator.class);
