...
public class AuthorshipNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameListARIterator.class);
