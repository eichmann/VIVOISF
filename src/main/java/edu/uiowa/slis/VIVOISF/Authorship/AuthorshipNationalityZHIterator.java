...
public class AuthorshipNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNationalityZHIterator.class);
