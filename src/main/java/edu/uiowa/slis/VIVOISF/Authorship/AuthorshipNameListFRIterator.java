...
public class AuthorshipNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameListFRIterator.class);
