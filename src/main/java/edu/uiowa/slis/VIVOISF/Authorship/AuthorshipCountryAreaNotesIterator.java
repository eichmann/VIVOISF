...
public class AuthorshipCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCountryAreaNotesIterator.class);
