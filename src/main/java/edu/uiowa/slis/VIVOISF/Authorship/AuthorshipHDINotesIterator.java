...
public class AuthorshipHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipHDINotesIterator.class);
