...
public class AuthorshipNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameOfficialENIterator.class);
