...
public class AuthorshipCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCodeUNIterator.class);
