...
public class AuthorshipNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameOfficialITIterator.class);
