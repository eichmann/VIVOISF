...
public class AuthorshipNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameListENIterator.class);
