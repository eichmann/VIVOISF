...
public class AuthorshipGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipGDPUnitIterator.class);
