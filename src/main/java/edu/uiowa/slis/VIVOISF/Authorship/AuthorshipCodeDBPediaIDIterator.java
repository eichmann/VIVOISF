...
public class AuthorshipCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCodeDBPediaIDIterator.class);
