...
public class AuthorshipRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipRankIterator.class);
