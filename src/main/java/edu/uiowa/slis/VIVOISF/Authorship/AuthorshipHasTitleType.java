...
public class AuthorshipHasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipHasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipHasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAuthorshipHasTitleIterator.getType());
		} catch (Exception e) {
