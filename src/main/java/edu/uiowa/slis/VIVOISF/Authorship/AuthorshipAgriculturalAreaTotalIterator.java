...
public class AuthorshipAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipAgriculturalAreaTotalIterator.class);
