...
public class AuthorshipNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameCurrencyRUIterator.class);
