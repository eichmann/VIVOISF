...
public class AuthorshipNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameOfficialRUIterator.class);
