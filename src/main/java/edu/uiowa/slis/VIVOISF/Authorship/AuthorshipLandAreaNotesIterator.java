...
public class AuthorshipLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipLandAreaNotesIterator.class);
