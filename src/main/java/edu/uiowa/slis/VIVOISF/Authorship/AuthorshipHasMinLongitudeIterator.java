...
public class AuthorshipHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipHasMinLongitudeIterator.class);
