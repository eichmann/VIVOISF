...
public class AuthorshipNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNationalityRUIterator.class);
