...
public class AuthorshipRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAuthorshipRO_0002353Iterator.getType());
		} catch (Exception e) {
