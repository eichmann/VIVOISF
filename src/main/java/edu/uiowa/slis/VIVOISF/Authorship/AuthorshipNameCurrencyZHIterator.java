...
public class AuthorshipNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameCurrencyZHIterator.class);
