...
public class AuthorshipNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNationalityENIterator.class);
