...
public class AuthorshipLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipLandAreaYearIterator.class);
