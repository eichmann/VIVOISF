...
public class AuthorshipNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameShortESIterator.class);
