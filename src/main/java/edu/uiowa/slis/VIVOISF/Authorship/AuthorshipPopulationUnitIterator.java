...
public class AuthorshipPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipPopulationUnitIterator.class);
