...
public class AuthorshipNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameShortFRIterator.class);
