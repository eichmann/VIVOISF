...
public class AuthorshipDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipDescriptionIterator.class);
