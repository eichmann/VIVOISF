...
public class AuthorshipGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipGDPYearIterator.class);
