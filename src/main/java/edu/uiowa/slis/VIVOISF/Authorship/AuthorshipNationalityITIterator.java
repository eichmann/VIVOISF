...
public class AuthorshipNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNationalityITIterator.class);
