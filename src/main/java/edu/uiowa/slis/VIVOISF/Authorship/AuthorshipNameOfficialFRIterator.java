...
public class AuthorshipNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameOfficialFRIterator.class);
