...
public class AuthorshipCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCodeCurrencyIterator.class);
