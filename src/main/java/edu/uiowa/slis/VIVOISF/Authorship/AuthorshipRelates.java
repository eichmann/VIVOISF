...
public class AuthorshipRelates extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipRelates currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipRelates.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAuthorshipRelatesIterator.getRelates());
		} catch (Exception e) {
