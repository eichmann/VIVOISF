...
public class AuthorshipNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameShortZHIterator.class);
