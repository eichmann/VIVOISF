...
public class AuthorshipGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipGDPNotesIterator.class);
