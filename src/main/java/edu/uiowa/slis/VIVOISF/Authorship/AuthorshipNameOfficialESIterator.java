...
public class AuthorshipNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameOfficialESIterator.class);
