...
public class AuthorshipNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameListITIterator.class);
