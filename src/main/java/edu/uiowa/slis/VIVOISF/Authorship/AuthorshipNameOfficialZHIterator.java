...
public class AuthorshipNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameOfficialZHIterator.class);
