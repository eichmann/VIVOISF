...
public class AuthorshipNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameShortITIterator.class);
