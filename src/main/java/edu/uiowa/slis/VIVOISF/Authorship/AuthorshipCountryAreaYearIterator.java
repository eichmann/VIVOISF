...
public class AuthorshipCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipCountryAreaYearIterator.class);
