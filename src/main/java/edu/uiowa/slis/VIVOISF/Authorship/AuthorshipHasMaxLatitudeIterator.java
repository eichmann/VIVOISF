...
public class AuthorshipHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipHasMaxLatitudeIterator.class);
