...
public class AuthorshipNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipNameCurrencyFRIterator.class);
