...
public class AuthorshipPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AuthorshipPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AuthorshipPopulationYearIterator.class);
