...
public class EditorshipNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameOfficialZHIterator.class);
