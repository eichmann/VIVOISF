...
public class EditorshipNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNationalityARIterator.class);
