...
public class EditorshipAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipAgriculturalAreaTotalIterator.class);
