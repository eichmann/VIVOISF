...
public class EditorshipNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameShortZHIterator.class);
