...
public class EditorshipNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameOfficialESIterator.class);
