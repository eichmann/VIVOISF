...
public class EditorshipNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameCurrencyITIterator.class);
