...
public class EditorshipAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipAgriculturalAreaUnitIterator.class);
