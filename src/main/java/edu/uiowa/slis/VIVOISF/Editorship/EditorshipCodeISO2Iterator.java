...
public class EditorshipCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCodeISO2Iterator.class);
