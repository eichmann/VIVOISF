...
public class EditorshipNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNationalityESIterator.class);
