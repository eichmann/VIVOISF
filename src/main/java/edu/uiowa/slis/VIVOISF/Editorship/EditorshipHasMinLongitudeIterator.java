...
public class EditorshipHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipHasMinLongitudeIterator.class);
