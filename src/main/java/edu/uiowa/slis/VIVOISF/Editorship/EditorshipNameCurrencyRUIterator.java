...
public class EditorshipNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameCurrencyRUIterator.class);
