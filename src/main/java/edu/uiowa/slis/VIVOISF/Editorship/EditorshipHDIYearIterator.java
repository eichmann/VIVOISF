...
public class EditorshipHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipHDIYearIterator.class);
