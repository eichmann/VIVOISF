...
public class EditorshipCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCountryAreaNotesIterator.class);
