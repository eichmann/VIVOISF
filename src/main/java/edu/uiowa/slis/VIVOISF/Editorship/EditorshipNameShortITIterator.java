...
public class EditorshipNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameShortITIterator.class);
