...
public class EditorshipRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipRankIterator.class);
