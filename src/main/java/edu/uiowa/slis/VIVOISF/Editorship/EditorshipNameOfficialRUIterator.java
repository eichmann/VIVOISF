...
public class EditorshipNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameOfficialRUIterator.class);
