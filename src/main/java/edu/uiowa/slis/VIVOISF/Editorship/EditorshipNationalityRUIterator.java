...
public class EditorshipNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNationalityRUIterator.class);
