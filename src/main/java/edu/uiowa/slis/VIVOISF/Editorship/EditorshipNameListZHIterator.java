...
public class EditorshipNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameListZHIterator.class);
