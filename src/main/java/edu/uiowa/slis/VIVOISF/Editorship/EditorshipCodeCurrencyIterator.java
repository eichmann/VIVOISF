...
public class EditorshipCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCodeCurrencyIterator.class);
