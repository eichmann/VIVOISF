...
public class EditorshipCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCodeUNIterator.class);
