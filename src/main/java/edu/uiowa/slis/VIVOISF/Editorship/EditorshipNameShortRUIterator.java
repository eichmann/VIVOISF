...
public class EditorshipNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameShortRUIterator.class);
