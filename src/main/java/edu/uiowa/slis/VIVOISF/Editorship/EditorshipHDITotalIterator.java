...
public class EditorshipHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipHDITotalIterator.class);
