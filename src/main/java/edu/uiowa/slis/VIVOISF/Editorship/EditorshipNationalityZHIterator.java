...
public class EditorshipNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNationalityZHIterator.class);
