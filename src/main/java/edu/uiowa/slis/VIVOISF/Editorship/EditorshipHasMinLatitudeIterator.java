...
public class EditorshipHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipHasMinLatitudeIterator.class);
