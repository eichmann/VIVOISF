...
public class EditorshipNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNationalityFRIterator.class);
