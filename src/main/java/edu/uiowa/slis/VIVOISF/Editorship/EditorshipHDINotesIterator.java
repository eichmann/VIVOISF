...
public class EditorshipHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipHDINotesIterator.class);
