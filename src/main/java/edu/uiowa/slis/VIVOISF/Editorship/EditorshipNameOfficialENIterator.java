...
public class EditorshipNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameOfficialENIterator.class);
