...
public class EditorshipNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameOfficialITIterator.class);
