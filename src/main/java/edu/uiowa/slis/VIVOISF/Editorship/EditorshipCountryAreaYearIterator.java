...
public class EditorshipCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCountryAreaYearIterator.class);
