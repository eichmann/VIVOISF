...
public class EditorshipCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCountryAreaUnitIterator.class);
