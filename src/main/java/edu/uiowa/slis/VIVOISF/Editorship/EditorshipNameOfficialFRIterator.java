...
public class EditorshipNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameOfficialFRIterator.class);
