...
public class EditorshipAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipAgriculturalAreaYearIterator.class);
