...
public class EditorshipNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameShortENIterator.class);
