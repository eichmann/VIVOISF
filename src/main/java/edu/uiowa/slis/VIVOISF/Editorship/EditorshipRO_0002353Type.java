...
public class EditorshipRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditorshipRO_0002353Iterator.getType());
		} catch (Exception e) {
