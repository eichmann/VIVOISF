...
public class EditorshipDateTimeValueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipDateTimeValueType currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipDateTimeValueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditorshipDateTimeValueIterator.getType());
		} catch (Exception e) {
