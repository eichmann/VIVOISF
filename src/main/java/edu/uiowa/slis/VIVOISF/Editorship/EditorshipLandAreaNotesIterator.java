...
public class EditorshipLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipLandAreaNotesIterator.class);
