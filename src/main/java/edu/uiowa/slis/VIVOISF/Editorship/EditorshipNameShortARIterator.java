...
public class EditorshipNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameShortARIterator.class);
