...
public class EditorshipPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipPopulationUnitIterator.class);
