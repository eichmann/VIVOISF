...
public class EditorshipNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameCurrencyFRIterator.class);
