...
public class EditorshipARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditorshipARG_2000028Iterator.getType());
		} catch (Exception e) {
