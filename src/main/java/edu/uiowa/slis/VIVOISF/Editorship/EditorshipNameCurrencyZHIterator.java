...
public class EditorshipNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameCurrencyZHIterator.class);
