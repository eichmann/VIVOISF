...
public class EditorshipGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipGDPNotesIterator.class);
