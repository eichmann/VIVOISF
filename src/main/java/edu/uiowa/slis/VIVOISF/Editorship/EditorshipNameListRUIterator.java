...
public class EditorshipNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameListRUIterator.class);
