...
public class EditorshipNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameListFRIterator.class);
