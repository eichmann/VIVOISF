...
public class EditorshipCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCodeAGROVOCIterator.class);
