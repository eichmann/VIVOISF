...
public class EditorshipNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameShortESIterator.class);
