...
public class EditorshipNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNationalityENIterator.class);
