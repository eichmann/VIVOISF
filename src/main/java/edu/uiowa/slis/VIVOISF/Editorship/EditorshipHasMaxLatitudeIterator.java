...
public class EditorshipHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipHasMaxLatitudeIterator.class);
