...
public class EditorshipCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCodeFAOSTATIterator.class);
