...
public class EditorshipCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCodeISO3Iterator.class);
