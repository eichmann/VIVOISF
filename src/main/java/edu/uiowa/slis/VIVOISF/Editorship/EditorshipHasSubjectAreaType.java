...
public class EditorshipHasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipHasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipHasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditorshipHasSubjectAreaIterator.getType());
		} catch (Exception e) {
