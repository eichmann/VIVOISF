...
public class EditorshipPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipPopulationNotesIterator.class);
