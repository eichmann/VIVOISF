...
public class EditorshipRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in EditorshipRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EditorshipRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in EditorshipRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EditorshipRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EditorshipRelates doEndTag", e);
			throw new JspTagException("Exception raised in EditorshipRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to EditorshipRelatesIterator");
