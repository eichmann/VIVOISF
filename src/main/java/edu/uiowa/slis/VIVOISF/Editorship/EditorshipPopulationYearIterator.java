...
public class EditorshipPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipPopulationYearIterator.class);
