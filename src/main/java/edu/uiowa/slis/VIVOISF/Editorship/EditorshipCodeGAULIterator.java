...
public class EditorshipCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCodeGAULIterator.class);
