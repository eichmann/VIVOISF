...
public class EditorshipPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipPopulationTotalIterator.class);
