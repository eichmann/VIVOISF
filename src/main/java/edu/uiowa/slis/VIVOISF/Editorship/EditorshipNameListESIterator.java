...
public class EditorshipNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameListESIterator.class);
