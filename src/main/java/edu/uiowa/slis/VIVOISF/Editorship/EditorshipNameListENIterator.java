...
public class EditorshipNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameListENIterator.class);
