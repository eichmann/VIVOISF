...
public class EditorshipLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipLandAreaYearIterator.class);
