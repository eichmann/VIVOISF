...
public class EditorshipUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipUrlIterator.class);
