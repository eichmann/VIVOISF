...
public class EditorshipNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameCurrencyARIterator.class);
