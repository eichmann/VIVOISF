...
public class EditorshipRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditorshipRO_0001025Iterator.getType());
		} catch (Exception e) {
