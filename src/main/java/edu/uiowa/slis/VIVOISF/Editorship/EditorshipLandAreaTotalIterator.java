...
public class EditorshipLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipLandAreaTotalIterator.class);
