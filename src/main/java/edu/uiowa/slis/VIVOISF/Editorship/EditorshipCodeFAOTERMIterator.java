...
public class EditorshipCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipCodeFAOTERMIterator.class);
