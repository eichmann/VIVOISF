...
public class EditorshipNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameCurrencyESIterator.class);
