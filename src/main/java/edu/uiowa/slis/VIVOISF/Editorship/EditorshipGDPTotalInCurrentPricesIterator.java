...
public class EditorshipGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipGDPTotalInCurrentPricesIterator.class);
