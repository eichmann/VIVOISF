...
public class EditorshipNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameOfficialARIterator.class);
