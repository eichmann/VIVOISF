...
public class EditorshipHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipHasMaxLongitudeIterator.class);
