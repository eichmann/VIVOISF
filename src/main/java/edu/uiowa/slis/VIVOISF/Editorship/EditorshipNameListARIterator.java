...
public class EditorshipNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameListARIterator.class);
