...
public class EditorshipNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNationalityITIterator.class);
