...
public class EditorshipNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipNameListITIterator.class);
