...
public class EditorshipGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipGDPUnitIterator.class);
