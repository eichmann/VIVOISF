...
public class EditorshipLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipLandAreaUnitIterator.class);
