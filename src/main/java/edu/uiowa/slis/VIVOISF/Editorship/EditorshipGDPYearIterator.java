...
public class EditorshipGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorshipGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorshipGDPYearIterator.class);
