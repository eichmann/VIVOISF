...
public class GeographicRegionCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCountryAreaYearIterator.class);
