...
public class GeographicRegionNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameListENIterator.class);
