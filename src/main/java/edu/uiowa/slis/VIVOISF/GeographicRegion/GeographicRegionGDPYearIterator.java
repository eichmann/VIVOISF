...
public class GeographicRegionGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionGDPYearIterator.class);
