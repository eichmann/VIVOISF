...
public class GeographicRegionCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCodeUNIterator.class);
