...
public class GeographicRegionRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeographicRegionRO_0001015Iterator.getType());
		} catch (Exception e) {
