...
public class GeographicRegionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameListFRIterator.class);
