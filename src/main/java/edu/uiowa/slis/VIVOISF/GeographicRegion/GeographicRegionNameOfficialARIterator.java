...
public class GeographicRegionNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameOfficialARIterator.class);
