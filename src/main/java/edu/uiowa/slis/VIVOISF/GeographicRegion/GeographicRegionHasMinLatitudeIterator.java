...
public class GeographicRegionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionHasMinLatitudeIterator.class);
