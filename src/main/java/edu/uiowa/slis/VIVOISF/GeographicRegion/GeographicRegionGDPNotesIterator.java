...
public class GeographicRegionGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionGDPNotesIterator.class);
