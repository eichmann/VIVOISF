...
public class GeographicRegionNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameShortFRIterator.class);
