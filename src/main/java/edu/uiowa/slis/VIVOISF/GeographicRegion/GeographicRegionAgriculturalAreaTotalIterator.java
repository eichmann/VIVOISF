...
public class GeographicRegionAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionAgriculturalAreaTotalIterator.class);
