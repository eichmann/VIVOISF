...
public class GeographicRegionCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCodeUNDPIterator.class);
