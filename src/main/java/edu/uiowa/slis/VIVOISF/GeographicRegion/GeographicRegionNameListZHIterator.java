...
public class GeographicRegionNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameListZHIterator.class);
