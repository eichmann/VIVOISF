...
public class GeographicRegionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionHasMaxLongitudeIterator.class);
