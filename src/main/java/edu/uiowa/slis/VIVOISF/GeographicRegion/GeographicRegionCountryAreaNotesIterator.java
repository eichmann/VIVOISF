...
public class GeographicRegionCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCountryAreaNotesIterator.class);
