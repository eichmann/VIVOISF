...
public class GeographicRegionNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameOfficialESIterator.class);
