...
public class GeographicRegionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionLandAreaNotesIterator.class);
