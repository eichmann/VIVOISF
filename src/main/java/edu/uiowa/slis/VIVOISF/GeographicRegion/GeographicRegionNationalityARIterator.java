...
public class GeographicRegionNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNationalityARIterator.class);
