...
public class GeographicRegionHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionHasMaxLatitudeIterator.class);
