...
public class GeographicRegionCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCodeGAULIterator.class);
