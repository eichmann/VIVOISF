...
public class GeographicRegionNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameShortITIterator.class);
