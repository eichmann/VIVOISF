...
public class GeographicRegionNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNationalityFRIterator.class);
