...
public class GeographicRegionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionHDINotesIterator.class);
