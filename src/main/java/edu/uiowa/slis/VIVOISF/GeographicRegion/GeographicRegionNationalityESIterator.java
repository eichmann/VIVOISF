...
public class GeographicRegionNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNationalityESIterator.class);
