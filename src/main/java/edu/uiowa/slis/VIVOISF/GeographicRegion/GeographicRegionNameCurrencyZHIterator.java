...
public class GeographicRegionNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameCurrencyZHIterator.class);
