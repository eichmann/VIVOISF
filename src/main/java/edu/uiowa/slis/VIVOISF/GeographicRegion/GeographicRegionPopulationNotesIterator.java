...
public class GeographicRegionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionPopulationNotesIterator.class);
