...
public class GeographicRegionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionLandAreaYearIterator.class);
