...
public class GeographicRegionNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameOfficialZHIterator.class);
