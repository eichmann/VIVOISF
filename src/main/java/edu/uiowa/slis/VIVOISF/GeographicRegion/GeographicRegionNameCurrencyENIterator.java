...
public class GeographicRegionNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameCurrencyENIterator.class);
