...
public class GeographicRegionPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionPopulationYearIterator.class);
