...
public class GeographicRegionNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNationalityZHIterator.class);
