...
public class GeographicRegionNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNationalityENIterator.class);
