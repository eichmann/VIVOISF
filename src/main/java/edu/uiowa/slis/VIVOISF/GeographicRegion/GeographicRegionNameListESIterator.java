...
public class GeographicRegionNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameListESIterator.class);
