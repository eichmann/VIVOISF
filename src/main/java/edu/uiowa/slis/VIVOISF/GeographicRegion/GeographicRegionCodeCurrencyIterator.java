...
public class GeographicRegionCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCodeCurrencyIterator.class);
