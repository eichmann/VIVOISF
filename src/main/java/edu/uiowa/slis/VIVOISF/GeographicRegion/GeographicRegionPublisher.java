...
public class GeographicRegionPublisher extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionPublisher currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionPublisher.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeographicRegionPublisherIterator.getPublisher());
		} catch (Exception e) {
