...
public class GeographicRegionCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCodeFAOTERMIterator.class);
