...
public class GeographicRegionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#GeographicRegion> . "+
