...
public class GeographicRegionNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameCurrencyESIterator.class);
