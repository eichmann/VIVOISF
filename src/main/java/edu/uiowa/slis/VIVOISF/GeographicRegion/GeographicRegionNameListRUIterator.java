...
public class GeographicRegionNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameListRUIterator.class);
