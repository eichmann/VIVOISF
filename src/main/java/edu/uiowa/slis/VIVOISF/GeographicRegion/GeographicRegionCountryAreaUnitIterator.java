...
public class GeographicRegionCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCountryAreaUnitIterator.class);
