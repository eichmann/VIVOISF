...
public class GeographicRegionNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameListITIterator.class);
