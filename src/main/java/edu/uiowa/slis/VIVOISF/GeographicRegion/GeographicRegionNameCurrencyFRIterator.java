...
public class GeographicRegionNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameCurrencyFRIterator.class);
