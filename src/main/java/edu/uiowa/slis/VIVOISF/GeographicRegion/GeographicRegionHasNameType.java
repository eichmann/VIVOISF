...
public class GeographicRegionHasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionHasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionHasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeographicRegionHasNameIterator.getType());
		} catch (Exception e) {
