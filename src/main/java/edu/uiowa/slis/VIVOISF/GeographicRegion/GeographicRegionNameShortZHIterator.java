...
public class GeographicRegionNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameShortZHIterator.class);
