...
public class GeographicRegionCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCodeISO3Iterator.class);
