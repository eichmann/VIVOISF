...
public class GeographicRegionGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionGDPUnitIterator.class);
