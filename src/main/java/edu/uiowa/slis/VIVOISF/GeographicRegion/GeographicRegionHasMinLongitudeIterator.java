...
public class GeographicRegionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionHasMinLongitudeIterator.class);
