...
public class GeographicRegionLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionLandAreaUnitIterator.class);
