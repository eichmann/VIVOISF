...
public class GeographicRegionHasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionHasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionHasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeographicRegionHasSubjectAreaIterator.getType());
		} catch (Exception e) {
