...
public class GeographicRegionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCodeAGROVOCIterator.class);
