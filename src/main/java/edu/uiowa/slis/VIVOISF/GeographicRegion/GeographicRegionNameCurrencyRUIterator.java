...
public class GeographicRegionNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameCurrencyRUIterator.class);
