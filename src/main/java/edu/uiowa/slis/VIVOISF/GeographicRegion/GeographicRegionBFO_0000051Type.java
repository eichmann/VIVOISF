...
public class GeographicRegionBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeographicRegionBFO_0000051Iterator.getType());
		} catch (Exception e) {
