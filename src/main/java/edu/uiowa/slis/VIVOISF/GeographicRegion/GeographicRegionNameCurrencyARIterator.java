...
public class GeographicRegionNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameCurrencyARIterator.class);
