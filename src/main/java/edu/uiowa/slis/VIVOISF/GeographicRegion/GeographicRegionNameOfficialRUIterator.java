...
public class GeographicRegionNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameOfficialRUIterator.class);
