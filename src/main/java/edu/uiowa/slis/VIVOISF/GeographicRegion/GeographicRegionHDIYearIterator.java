...
public class GeographicRegionHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionHDIYearIterator.class);
