...
public class GeographicRegionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCodeFAOSTATIterator.class);
