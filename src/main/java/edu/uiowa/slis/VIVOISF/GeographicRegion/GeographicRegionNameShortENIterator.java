...
public class GeographicRegionNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionNameShortENIterator.class);
