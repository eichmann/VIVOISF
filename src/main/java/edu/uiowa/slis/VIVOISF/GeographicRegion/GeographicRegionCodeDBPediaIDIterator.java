...
public class GeographicRegionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionCodeDBPediaIDIterator.class);
