...
public class GeographicRegionRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicRegionRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicRegionRankIterator.class);
