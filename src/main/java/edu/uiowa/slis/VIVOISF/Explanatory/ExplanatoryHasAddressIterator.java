...
public class ExplanatoryHasAddressIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExplanatoryHasAddressIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ExplanatoryHasAddressIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ExplanatoryHasAddressIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ExplanatoryHasAddressIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ExplanatoryHasAddressIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ExplanatoryHasAddressIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ExplanatoryHasAddress doEndTag", e);
			throw new JspTagException("Exception raised in ExplanatoryHasAddress doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ExplanatoryHasAddressIterator");
