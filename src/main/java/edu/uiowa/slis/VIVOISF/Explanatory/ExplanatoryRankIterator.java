...
public class ExplanatoryRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExplanatoryRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ExplanatoryRankIterator.class);
