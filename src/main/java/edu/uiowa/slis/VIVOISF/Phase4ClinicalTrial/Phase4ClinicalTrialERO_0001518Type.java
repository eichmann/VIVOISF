...
public class Phase4ClinicalTrialERO_0001518Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Phase4ClinicalTrialERO_0001518Type currentInstance = null;
	private static final Log log = LogFactory.getLog(Phase4ClinicalTrialERO_0001518Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePhase4ClinicalTrialERO_0001518Iterator.getType());
		} catch (Exception e) {
