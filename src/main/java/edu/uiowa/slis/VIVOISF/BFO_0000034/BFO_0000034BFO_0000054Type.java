...
public class BFO_0000034BFO_0000054Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000034BFO_0000054Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000034BFO_0000054Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000034BFO_0000054Iterator.getType());
		} catch (Exception e) {
