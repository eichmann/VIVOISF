...
public class BFO_0000034RO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000034RO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000034RO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000034RO_0000052Iterator.getType());
		} catch (Exception e) {
