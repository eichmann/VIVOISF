...
public class DatasetNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameOfficialENIterator.class);
