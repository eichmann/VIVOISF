...
public class DatasetNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameOfficialRUIterator.class);
