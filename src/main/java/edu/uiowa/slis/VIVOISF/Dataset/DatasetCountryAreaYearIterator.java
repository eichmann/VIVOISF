...
public class DatasetCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCountryAreaYearIterator.class);
