...
public class DatasetUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetUpcIterator.class);
