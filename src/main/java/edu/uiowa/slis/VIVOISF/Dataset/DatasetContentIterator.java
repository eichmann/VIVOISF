...
public class DatasetContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetContentIterator.class);
