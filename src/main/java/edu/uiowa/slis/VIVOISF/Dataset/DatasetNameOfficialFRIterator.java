...
public class DatasetNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameOfficialFRIterator.class);
