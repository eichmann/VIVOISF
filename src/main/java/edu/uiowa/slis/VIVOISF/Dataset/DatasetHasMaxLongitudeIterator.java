...
public class DatasetHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasMaxLongitudeIterator.class);
