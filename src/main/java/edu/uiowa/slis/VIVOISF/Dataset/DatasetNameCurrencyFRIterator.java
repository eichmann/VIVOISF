...
public class DatasetNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameCurrencyFRIterator.class);
