...
public class DatasetNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNationalityZHIterator.class);
