...
public class DatasetCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCodeAGROVOCIterator.class);
