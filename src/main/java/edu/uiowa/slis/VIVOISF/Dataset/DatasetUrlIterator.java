...
public class DatasetUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetUrlIterator.class);
