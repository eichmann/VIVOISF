...
public class DatasetCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCountryAreaNotesIterator.class);
