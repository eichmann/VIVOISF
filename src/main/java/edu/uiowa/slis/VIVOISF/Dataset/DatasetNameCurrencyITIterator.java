...
public class DatasetNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameCurrencyITIterator.class);
