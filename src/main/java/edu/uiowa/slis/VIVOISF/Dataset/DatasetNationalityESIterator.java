...
public class DatasetNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNationalityESIterator.class);
