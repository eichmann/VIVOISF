...
public class DatasetPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetPopulationTotalIterator.class);
