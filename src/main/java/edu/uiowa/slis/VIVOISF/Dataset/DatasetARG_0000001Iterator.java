...
public class DatasetARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetARG_0000001Iterator.class);
