...
public class DatasetGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetGDPYearIterator.class);
