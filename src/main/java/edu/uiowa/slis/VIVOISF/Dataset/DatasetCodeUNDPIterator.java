...
public class DatasetCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCodeUNDPIterator.class);
