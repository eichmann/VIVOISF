...
public class DatasetNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameShortZHIterator.class);
