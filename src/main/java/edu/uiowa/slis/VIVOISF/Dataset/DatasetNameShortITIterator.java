...
public class DatasetNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameShortITIterator.class);
