...
public class DatasetDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetDoiIterator.class);
