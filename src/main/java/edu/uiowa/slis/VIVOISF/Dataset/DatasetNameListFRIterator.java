...
public class DatasetNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameListFRIterator.class);
