...
public class DatasetCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCodeISO2Iterator.class);
