...
public class DatasetCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCountryAreaUnitIterator.class);
