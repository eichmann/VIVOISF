...
public class DatasetNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNationalityFRIterator.class);
