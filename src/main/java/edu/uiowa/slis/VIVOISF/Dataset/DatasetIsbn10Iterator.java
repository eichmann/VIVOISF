...
public class DatasetIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetIsbn10Iterator.class);
