...
public class DatasetPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetPmidIterator.class);
