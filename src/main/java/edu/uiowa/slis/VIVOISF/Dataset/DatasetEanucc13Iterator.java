...
public class DatasetEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetEanucc13Iterator.class);
