...
public class DatasetNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameOfficialESIterator.class);
