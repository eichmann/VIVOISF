...
public class DatasetGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetGDPNotesIterator.class);
