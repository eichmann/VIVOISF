...
public class DatasetNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNumPagesIterator.class);
