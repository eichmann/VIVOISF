...
public class DatasetTranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetTranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetTranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetTranslatorIterator.getType());
		} catch (Exception e) {
