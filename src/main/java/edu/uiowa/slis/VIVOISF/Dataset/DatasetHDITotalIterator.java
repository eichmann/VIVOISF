...
public class DatasetHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHDITotalIterator.class);
