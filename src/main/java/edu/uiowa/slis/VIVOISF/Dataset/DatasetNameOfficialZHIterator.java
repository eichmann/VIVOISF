...
public class DatasetNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameOfficialZHIterator.class);
