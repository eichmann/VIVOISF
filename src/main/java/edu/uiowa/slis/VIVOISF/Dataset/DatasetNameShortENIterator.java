...
public class DatasetNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameShortENIterator.class);
