...
public class DatasetLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetLccnIterator.class);
