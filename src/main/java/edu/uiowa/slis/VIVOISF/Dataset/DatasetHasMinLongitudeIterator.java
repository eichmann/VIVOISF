...
public class DatasetHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasMinLongitudeIterator.class);
