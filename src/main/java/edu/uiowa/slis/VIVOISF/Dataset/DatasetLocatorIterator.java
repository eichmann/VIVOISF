...
public class DatasetLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetLocatorIterator.class);
