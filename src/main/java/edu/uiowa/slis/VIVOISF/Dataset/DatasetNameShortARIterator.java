...
public class DatasetNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameShortARIterator.class);
