...
public class DatasetCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCountryAreaTotalIterator.class);
