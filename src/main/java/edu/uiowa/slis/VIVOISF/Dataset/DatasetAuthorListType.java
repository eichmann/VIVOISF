...
public class DatasetAuthorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetAuthorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetAuthorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetAuthorListIterator.getType());
		} catch (Exception e) {
