...
public class DatasetHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHDIYearIterator.class);
