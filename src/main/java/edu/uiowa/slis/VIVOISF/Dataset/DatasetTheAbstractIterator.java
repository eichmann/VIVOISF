...
public class DatasetTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetTheAbstractIterator.class);
