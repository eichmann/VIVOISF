...
public class DatasetNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameListESIterator.class);
