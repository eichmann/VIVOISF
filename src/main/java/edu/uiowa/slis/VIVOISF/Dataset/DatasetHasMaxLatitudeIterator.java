...
public class DatasetHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasMaxLatitudeIterator.class);
