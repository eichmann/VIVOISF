...
public class DatasetNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameListARIterator.class);
