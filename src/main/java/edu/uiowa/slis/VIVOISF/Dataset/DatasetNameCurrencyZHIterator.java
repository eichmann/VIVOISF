...
public class DatasetNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameCurrencyZHIterator.class);
