...
public class DatasetCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCodenIterator.class);
