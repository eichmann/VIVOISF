...
public class DatasetIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetIdentifierIterator.class);
