...
public class DatasetAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetAgriculturalAreaUnitIterator.class);
