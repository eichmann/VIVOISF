...
public class DatasetCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCodeDBPediaIDIterator.class);
