...
public class DatasetEditorList extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetEditorList currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetEditorList.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetEditorListIterator.getEditorList());
		} catch (Exception e) {
