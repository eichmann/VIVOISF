...
public class DatasetCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCodeGAULIterator.class);
