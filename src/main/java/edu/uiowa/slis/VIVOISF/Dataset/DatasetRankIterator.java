...
public class DatasetRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetRankIterator.class);
