...
public class DatasetRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DatasetRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DatasetRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DatasetRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DatasetRelates doEndTag", e);
			throw new JspTagException("Exception raised in DatasetRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DatasetRelatesIterator");
