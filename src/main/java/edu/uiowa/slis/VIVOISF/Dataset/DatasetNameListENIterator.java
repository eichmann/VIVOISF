...
public class DatasetNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameListENIterator.class);
