...
public class DatasetPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetPageEndIterator.class);
