...
public class DatasetNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNationalityENIterator.class);
