...
public class DatasetCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCodeCurrencyIterator.class);
