...
public class DatasetERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetERO_0000045Iterator.class);
