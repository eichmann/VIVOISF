...
public class DatasetNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameListRUIterator.class);
