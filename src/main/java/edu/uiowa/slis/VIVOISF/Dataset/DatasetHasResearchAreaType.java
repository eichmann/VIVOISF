...
public class DatasetHasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetHasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetHasResearchAreaIterator.getType());
		} catch (Exception e) {
