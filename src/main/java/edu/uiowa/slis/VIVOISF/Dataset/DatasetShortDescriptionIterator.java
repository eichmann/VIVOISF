...
public class DatasetShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetShortDescriptionIterator.class);
