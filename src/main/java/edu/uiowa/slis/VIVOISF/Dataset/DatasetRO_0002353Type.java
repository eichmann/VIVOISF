...
public class DatasetRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetRO_0002353Iterator.getType());
		} catch (Exception e) {
