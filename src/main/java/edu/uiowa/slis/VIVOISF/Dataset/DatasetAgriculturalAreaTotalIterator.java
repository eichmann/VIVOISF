...
public class DatasetAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetAgriculturalAreaTotalIterator.class);
