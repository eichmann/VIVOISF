...
public class DatasetNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameOfficialITIterator.class);
