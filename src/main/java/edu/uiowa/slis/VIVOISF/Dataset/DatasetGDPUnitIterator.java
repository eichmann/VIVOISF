...
public class DatasetGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetGDPUnitIterator.class);
