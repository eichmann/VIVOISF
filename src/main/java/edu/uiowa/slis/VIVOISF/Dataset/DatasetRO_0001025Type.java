...
public class DatasetRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetRO_0001025Iterator.getType());
		} catch (Exception e) {
