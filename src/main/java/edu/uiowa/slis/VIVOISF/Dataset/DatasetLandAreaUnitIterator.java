...
public class DatasetLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetLandAreaUnitIterator.class);
