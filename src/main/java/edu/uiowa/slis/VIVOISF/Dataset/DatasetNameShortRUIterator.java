...
public class DatasetNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameShortRUIterator.class);
