...
public class DatasetUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetUriIterator.class);
