...
public class DatasetNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameListZHIterator.class);
