...
public class DatasetNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNumberIterator.class);
