...
public class DatasetNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameCurrencyENIterator.class);
