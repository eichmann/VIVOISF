...
public class DatasetNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameShortESIterator.class);
