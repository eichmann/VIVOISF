...
public class DatasetSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetSectionIterator.class);
