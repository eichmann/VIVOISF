...
public class DatasetGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetGtin14Iterator.class);
