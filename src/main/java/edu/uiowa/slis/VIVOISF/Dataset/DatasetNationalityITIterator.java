...
public class DatasetNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNationalityITIterator.class);
