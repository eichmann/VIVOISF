...
public class DatasetFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetFreetextKeywordIterator.class);
