...
public class DatasetPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetPopulationYearIterator.class);
