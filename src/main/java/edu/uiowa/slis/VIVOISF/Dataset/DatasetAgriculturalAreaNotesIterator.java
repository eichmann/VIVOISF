...
public class DatasetAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetAgriculturalAreaNotesIterator.class);
