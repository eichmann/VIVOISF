...
public class DatasetEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetEditionIterator.class);
