...
public class DatasetDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetDescriptionIterator.class);
