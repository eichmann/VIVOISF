...
public class DatasetCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCodeISO3Iterator.class);
