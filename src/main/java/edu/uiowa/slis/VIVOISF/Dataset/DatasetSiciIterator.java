...
public class DatasetSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetSiciIterator.class);
