...
public class DatasetHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHandleIterator.class);
