...
public class DatasetNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameShortFRIterator.class);
