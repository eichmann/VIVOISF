...
public class DatasetPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetPageStartIterator.class);
