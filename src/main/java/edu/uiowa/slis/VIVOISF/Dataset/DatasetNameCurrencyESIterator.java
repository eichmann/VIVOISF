...
public class DatasetNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameCurrencyESIterator.class);
