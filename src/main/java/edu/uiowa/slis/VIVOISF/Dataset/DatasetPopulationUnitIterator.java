...
public class DatasetPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetPopulationUnitIterator.class);
