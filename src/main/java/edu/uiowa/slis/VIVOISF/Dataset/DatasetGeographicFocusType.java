...
public class DatasetGeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetGeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetGeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetGeographicFocusIterator.getType());
		} catch (Exception e) {
