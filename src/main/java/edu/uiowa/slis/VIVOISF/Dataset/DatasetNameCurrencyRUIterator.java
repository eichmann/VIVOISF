...
public class DatasetNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameCurrencyRUIterator.class);
