...
public class DatasetCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCodeUNIterator.class);
