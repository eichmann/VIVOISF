...
public class DatasetPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetPopulationNotesIterator.class);
