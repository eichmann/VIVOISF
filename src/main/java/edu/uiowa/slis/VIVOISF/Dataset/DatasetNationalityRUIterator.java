...
public class DatasetNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNationalityRUIterator.class);
