...
public class DatasetHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHasMinLatitudeIterator.class);
