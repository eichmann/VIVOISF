...
public class DatasetReproducesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetReproducesType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetReproducesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatasetReproducesIterator.getType());
		} catch (Exception e) {
