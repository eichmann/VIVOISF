...
public class DatasetNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameOfficialARIterator.class);
