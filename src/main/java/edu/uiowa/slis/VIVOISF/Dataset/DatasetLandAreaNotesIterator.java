...
public class DatasetLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetLandAreaNotesIterator.class);
