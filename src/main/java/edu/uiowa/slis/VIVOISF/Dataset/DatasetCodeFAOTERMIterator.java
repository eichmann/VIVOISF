...
public class DatasetCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetCodeFAOTERMIterator.class);
