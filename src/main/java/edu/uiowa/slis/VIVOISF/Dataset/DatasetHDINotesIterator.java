...
public class DatasetHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetHDINotesIterator.class);
