...
public class DatasetLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetLandAreaTotalIterator.class);
