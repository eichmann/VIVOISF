...
public class DatasetNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNationalityARIterator.class);
