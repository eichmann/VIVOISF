...
public class DatasetNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatasetNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatasetNameCurrencyARIterator.class);
