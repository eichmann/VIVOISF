...
public class AssociationERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationERO_0000037Iterator.getType());
		} catch (Exception e) {
