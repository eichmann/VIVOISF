...
public class AssociationSponsors extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationSponsors currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationSponsors.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationSponsorsIterator.getSponsors());
		} catch (Exception e) {
