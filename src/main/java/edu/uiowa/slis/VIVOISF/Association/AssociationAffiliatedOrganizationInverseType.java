...
public class AssociationAffiliatedOrganizationInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationAffiliatedOrganizationInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationAffiliatedOrganizationInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationAffiliatedOrganizationInverseIterator.getType());
		} catch (Exception e) {
