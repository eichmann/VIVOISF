...
public class AssociationIntervieweeInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationIntervieweeInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationIntervieweeInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationIntervieweeInverseIterator.getType());
		} catch (Exception e) {
