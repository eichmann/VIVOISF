...
public class AssociationInterviewer extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationInterviewer currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationInterviewer.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationInterviewerIterator.getInterviewer());
		} catch (Exception e) {
