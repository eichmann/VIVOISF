...
public class AssociationHasEquipment extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationHasEquipment currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationHasEquipment.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationHasEquipmentIterator.getHasEquipment());
		} catch (Exception e) {
