...
public class AssociationInterviewerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationInterviewerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationInterviewerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationInterviewerInverseIterator.getInterviewerInverse());
		} catch (Exception e) {
