...
public class AssociationRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationRO_0000056Iterator.getType());
		} catch (Exception e) {
