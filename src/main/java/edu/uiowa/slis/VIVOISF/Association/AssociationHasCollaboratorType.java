...
public class AssociationHasCollaboratorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationHasCollaboratorType currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationHasCollaboratorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationHasCollaboratorIterator.getType());
		} catch (Exception e) {
