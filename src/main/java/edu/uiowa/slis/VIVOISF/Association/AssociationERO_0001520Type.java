...
public class AssociationERO_0001520Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationERO_0001520Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationERO_0001520Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationERO_0001520Iterator.getType());
		} catch (Exception e) {
