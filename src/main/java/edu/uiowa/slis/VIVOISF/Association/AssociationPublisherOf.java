...
public class AssociationPublisherOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AssociationPublisherOf currentInstance = null;
	private static final Log log = LogFactory.getLog(AssociationPublisherOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAssociationPublisherOfIterator.getPublisherOf());
		} catch (Exception e) {
