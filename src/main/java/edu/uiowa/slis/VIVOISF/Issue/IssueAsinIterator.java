...
public class IssueAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueAsinIterator.class);
