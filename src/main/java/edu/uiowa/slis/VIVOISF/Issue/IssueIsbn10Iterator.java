...
public class IssueIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueIsbn10Iterator.class);
