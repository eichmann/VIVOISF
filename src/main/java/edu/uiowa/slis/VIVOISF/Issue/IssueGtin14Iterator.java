...
public class IssueGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueGtin14Iterator.class);
