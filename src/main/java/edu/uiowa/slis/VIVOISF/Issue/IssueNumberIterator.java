...
public class IssueNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueNumberIterator.class);
