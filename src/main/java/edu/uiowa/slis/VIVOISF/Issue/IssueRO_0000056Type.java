...
public class IssueRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIssueRO_0000056Iterator.getType());
		} catch (Exception e) {
