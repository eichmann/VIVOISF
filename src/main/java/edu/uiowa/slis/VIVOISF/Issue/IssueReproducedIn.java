...
public class IssueReproducedIn extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueReproducedIn currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueReproducedIn.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIssueReproducedInIterator.getReproducedIn());
		} catch (Exception e) {
