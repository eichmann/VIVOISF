...
public class IssueLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueLocatorIterator.class);
