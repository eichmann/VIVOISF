...
public class IssueNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueNumPagesIterator.class);
