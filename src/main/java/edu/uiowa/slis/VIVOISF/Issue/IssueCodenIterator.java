...
public class IssueCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueCodenIterator.class);
