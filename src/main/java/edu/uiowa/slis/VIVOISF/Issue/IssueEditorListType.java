...
public class IssueEditorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueEditorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueEditorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIssueEditorListIterator.getType());
		} catch (Exception e) {
