...
public class IssueIssueIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueIssueIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueIssueIterator.class);
