...
public class IssueReproduces extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueReproduces currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueReproduces.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIssueReproducesIterator.getReproduces());
		} catch (Exception e) {
