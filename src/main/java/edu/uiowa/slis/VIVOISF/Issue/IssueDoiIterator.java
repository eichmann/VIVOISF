...
public class IssueDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueDoiIterator.class);
