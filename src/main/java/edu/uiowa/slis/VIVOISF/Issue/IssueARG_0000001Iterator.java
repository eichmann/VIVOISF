...
public class IssueARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueARG_0000001Iterator.class);
