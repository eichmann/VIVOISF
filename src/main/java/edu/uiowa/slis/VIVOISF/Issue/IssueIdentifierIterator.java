...
public class IssueIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueIdentifierIterator.class);
