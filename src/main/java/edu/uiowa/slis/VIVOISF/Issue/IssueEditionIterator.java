...
public class IssueEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueEditionIterator.class);
