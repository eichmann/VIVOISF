...
public class IssueShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueShortDescriptionIterator.class);
