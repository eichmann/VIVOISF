...
public class IssuePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssuePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssuePagesIterator.class);
