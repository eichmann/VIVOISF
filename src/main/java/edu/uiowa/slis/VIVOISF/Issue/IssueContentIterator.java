...
public class IssueContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueContentIterator.class);
