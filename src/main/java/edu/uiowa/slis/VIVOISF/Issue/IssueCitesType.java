...
public class IssueCitesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueCitesType currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueCitesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIssueCitesIterator.getType());
		} catch (Exception e) {
