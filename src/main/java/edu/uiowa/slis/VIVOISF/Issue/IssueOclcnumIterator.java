...
public class IssueOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueOclcnumIterator.class);
