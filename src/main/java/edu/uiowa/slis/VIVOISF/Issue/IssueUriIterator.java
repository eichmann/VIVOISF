...
public class IssueUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueUriIterator.class);
