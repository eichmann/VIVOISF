...
public class IssueTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueTheAbstractIterator.class);
