...
public class IssueHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueHandleIterator.class);
