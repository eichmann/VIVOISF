...
public class IssueSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueSiciIterator.class);
