...
public class IssueIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueIsbn13Iterator.class);
