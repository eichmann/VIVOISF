...
public class IssueLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssueLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IssueLccnIterator.class);
