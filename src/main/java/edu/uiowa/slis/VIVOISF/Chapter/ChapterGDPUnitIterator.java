...
public class ChapterGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterGDPUnitIterator.class);
