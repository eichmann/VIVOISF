...
public class ChapterCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCodeUNDPIterator.class);
