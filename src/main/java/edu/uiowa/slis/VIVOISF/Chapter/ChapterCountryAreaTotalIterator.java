...
public class ChapterCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCountryAreaTotalIterator.class);
