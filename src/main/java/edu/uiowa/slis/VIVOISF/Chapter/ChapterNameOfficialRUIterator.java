...
public class ChapterNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameOfficialRUIterator.class);
