...
public class ChapterChapterIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterChapterIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterChapterIterator.class);
