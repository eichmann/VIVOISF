...
public class ChapterIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterIsbn10Iterator.class);
