...
public class ChapterPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterPagesIterator.class);
