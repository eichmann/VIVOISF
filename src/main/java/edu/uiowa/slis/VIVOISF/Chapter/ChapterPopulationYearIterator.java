...
public class ChapterPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterPopulationYearIterator.class);
