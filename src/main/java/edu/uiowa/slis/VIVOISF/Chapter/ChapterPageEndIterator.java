...
public class ChapterPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterPageEndIterator.class);
