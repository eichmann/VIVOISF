...
public class ChapterRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ChapterRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ChapterRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ChapterRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ChapterRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ChapterRelates doEndTag", e);
			throw new JspTagException("Exception raised in ChapterRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ChapterRelatesIterator");
