...
public class ChapterNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNationalityENIterator.class);
