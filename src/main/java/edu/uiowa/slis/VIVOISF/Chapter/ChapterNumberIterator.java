...
public class ChapterNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNumberIterator.class);
