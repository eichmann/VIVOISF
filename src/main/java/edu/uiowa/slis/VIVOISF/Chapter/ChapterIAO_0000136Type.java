...
public class ChapterIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theChapterIAO_0000136Iterator.getType());
		} catch (Exception e) {
