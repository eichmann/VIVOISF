...
public class ChapterGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterGDPYearIterator.class);
