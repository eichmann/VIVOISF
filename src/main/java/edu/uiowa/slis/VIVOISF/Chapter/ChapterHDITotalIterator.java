...
public class ChapterHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHDITotalIterator.class);
