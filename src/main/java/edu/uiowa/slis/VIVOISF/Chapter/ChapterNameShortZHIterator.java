...
public class ChapterNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameShortZHIterator.class);
