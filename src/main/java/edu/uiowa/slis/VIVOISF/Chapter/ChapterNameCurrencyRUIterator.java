...
public class ChapterNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameCurrencyRUIterator.class);
