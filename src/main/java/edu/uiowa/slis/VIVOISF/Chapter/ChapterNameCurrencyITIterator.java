...
public class ChapterNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameCurrencyITIterator.class);
