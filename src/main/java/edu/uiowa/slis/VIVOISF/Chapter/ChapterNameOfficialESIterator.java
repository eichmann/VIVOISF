...
public class ChapterNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameOfficialESIterator.class);
