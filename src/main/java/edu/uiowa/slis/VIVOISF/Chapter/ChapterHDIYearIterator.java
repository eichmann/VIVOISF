...
public class ChapterHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHDIYearIterator.class);
