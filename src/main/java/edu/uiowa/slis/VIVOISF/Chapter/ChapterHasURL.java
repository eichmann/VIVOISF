...
public class ChapterHasURL extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHasURL currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHasURL.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theChapterHasURLIterator.getHasURL());
		} catch (Exception e) {
