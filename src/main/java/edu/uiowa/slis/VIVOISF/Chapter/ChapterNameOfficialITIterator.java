...
public class ChapterNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameOfficialITIterator.class);
