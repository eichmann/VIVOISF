...
public class ChapterNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNationalityZHIterator.class);
