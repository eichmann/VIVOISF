...
public class ChapterNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameShortARIterator.class);
