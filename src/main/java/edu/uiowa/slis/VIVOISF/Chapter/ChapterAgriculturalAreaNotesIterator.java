...
public class ChapterAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterAgriculturalAreaNotesIterator.class);
