...
public class ChapterIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/Chapter> . "+
