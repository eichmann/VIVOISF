...
public class ChapterEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterEanucc13Iterator.class);
