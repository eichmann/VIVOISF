...
public class ChapterCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCodeCurrencyIterator.class);
