...
public class ChapterNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameCurrencyENIterator.class);
