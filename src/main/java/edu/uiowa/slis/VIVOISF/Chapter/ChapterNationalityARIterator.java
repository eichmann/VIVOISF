...
public class ChapterNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNationalityARIterator.class);
