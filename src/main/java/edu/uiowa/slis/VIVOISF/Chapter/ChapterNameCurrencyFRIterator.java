...
public class ChapterNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameCurrencyFRIterator.class);
