...
public class ChapterCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCodeISO3Iterator.class);
