...
public class ChapterRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterRankIterator.class);
