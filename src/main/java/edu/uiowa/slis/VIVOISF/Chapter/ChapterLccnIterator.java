...
public class ChapterLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterLccnIterator.class);
