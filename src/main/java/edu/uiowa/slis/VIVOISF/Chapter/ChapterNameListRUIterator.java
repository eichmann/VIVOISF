...
public class ChapterNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameListRUIterator.class);
