...
public class ChapterCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCodeFAOTERMIterator.class);
