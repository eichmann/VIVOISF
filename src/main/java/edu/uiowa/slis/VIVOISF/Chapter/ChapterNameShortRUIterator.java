...
public class ChapterNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameShortRUIterator.class);
