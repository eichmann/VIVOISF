...
public class ChapterHasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theChapterHasPublicationVenueIterator.getType());
		} catch (Exception e) {
