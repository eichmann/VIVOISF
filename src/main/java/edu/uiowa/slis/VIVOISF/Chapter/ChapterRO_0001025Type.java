...
public class ChapterRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theChapterRO_0001025Iterator.getType());
		} catch (Exception e) {
