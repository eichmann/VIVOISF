...
public class ChapterNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameOfficialZHIterator.class);
