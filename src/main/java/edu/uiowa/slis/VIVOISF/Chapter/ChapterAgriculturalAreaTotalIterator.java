...
public class ChapterAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterAgriculturalAreaTotalIterator.class);
