...
public class ChapterHasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theChapterHasResearchAreaIterator.getType());
		} catch (Exception e) {
