...
public class ChapterRO_0002353 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterRO_0002353 currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterRO_0002353.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theChapterRO_0002353Iterator.getRO_0002353());
		} catch (Exception e) {
