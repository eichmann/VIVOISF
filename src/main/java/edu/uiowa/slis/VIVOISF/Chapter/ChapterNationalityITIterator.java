...
public class ChapterNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNationalityITIterator.class);
