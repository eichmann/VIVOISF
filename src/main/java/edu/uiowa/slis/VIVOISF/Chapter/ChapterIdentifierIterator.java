...
public class ChapterIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterIdentifierIterator.class);
