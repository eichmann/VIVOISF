...
public class ChapterLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterLandAreaNotesIterator.class);
