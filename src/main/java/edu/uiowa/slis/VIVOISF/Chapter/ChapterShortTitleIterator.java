...
public class ChapterShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterShortTitleIterator.class);
