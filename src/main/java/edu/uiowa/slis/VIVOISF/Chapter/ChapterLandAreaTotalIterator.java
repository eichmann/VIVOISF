...
public class ChapterLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterLandAreaTotalIterator.class);
