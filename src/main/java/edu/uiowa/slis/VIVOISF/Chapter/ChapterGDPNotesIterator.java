...
public class ChapterGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterGDPNotesIterator.class);
