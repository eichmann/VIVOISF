...
public class ChapterPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterPopulationTotalIterator.class);
