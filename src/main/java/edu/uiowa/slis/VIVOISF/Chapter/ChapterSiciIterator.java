...
public class ChapterSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterSiciIterator.class);
