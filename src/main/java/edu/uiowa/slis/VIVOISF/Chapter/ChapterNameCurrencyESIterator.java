...
public class ChapterNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameCurrencyESIterator.class);
