...
public class ChapterTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterTheAbstractIterator.class);
