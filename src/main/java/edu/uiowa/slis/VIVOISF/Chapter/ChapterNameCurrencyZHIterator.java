...
public class ChapterNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameCurrencyZHIterator.class);
