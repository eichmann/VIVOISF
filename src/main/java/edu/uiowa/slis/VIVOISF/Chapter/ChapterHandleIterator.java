...
public class ChapterHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHandleIterator.class);
