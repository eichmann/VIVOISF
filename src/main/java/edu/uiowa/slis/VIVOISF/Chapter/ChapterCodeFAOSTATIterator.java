...
public class ChapterCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCodeFAOSTATIterator.class);
