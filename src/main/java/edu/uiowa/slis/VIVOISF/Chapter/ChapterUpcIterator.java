...
public class ChapterUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterUpcIterator.class);
