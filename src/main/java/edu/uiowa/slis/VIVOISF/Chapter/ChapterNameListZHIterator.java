...
public class ChapterNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameListZHIterator.class);
