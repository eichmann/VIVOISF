...
public class ChapterCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCodeUNIterator.class);
