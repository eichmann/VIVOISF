...
public class ChapterFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterFreetextKeywordIterator.class);
