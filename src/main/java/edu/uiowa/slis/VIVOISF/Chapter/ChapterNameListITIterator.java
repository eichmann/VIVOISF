...
public class ChapterNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameListITIterator.class);
