...
public class ChapterLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterLocatorIterator.class);
