...
public class ChapterCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCountryAreaYearIterator.class);
