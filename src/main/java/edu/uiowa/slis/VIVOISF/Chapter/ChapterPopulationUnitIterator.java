...
public class ChapterPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterPopulationUnitIterator.class);
