...
public class ChapterSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterSectionIterator.class);
