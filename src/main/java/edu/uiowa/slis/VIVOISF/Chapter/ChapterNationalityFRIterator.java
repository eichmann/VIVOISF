...
public class ChapterNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNationalityFRIterator.class);
