...
public class ChapterUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterUrlIterator.class);
