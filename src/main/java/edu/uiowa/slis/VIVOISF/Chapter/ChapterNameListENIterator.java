...
public class ChapterNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameListENIterator.class);
