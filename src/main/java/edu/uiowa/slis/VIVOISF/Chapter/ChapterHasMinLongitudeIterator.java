...
public class ChapterHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHasMinLongitudeIterator.class);
