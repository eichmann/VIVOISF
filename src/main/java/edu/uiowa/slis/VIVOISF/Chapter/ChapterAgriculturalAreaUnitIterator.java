...
public class ChapterAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterAgriculturalAreaUnitIterator.class);
