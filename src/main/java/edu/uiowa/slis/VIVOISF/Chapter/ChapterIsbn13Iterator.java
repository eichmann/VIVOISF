...
public class ChapterIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterIsbn13Iterator.class);
