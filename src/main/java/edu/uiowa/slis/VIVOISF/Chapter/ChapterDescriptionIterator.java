...
public class ChapterDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterDescriptionIterator.class);
