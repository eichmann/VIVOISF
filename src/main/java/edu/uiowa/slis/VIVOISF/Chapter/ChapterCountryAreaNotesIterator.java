...
public class ChapterCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCountryAreaNotesIterator.class);
