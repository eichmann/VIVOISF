...
public class ChapterNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameOfficialARIterator.class);
