...
public class ChapterUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterUriIterator.class);
