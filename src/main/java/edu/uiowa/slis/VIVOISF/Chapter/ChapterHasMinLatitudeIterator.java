...
public class ChapterHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHasMinLatitudeIterator.class);
