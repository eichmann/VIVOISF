...
public class ChapterContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterContentIterator.class);
