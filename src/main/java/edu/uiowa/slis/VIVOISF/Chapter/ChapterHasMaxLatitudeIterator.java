...
public class ChapterHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHasMaxLatitudeIterator.class);
