...
public class ChapterNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNationalityRUIterator.class);
