...
public class ChapterHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHasMaxLongitudeIterator.class);
