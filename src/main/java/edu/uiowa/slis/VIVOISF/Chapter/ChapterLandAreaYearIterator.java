...
public class ChapterLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterLandAreaYearIterator.class);
