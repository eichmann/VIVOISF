...
public class ChapterNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNumPagesIterator.class);
