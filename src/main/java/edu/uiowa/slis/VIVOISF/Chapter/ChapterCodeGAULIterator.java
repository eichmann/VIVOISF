...
public class ChapterCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCodeGAULIterator.class);
