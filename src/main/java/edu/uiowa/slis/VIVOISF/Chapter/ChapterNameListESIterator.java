...
public class ChapterNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameListESIterator.class);
