...
public class ChapterNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameOfficialFRIterator.class);
