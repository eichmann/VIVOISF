...
public class ChapterNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameShortENIterator.class);
