...
public class ChapterCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCodenIterator.class);
