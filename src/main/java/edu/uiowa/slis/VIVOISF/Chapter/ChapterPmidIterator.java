...
public class ChapterPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterPmidIterator.class);
