...
public class ChapterCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCountryAreaUnitIterator.class);
