...
public class ChapterERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterERO_0000045Iterator.class);
