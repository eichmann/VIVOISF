...
public class ChapterARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterARG_0000001Iterator.class);
