...
public class ChapterPublisherIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterPublisherIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterPublisherIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ChapterPublisherIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ChapterPublisherIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ChapterPublisherIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ChapterPublisherIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ChapterPublisher doEndTag", e);
			throw new JspTagException("Exception raised in ChapterPublisher doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ChapterPublisherIterator");
