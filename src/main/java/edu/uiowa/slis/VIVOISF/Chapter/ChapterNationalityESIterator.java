...
public class ChapterNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNationalityESIterator.class);
