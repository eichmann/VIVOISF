...
public class ChapterNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameShortITIterator.class);
