...
public class ChapterNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameOfficialENIterator.class);
