...
public class ChapterLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterLandAreaUnitIterator.class);
