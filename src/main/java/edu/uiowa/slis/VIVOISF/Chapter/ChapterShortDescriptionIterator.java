...
public class ChapterShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterShortDescriptionIterator.class);
