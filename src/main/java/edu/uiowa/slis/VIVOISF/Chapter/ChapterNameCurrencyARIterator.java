...
public class ChapterNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameCurrencyARIterator.class);
