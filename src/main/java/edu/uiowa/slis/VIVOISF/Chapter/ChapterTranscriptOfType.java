...
public class ChapterTranscriptOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterTranscriptOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterTranscriptOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theChapterTranscriptOfIterator.getType());
		} catch (Exception e) {
