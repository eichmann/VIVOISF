...
public class ChapterDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterDoiIterator.class);
