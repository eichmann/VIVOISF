...
public class ChapterHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterHDINotesIterator.class);
