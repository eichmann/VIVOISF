...
public class ChapterNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterNameListARIterator.class);
