...
public class ChapterCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterCodeAGROVOCIterator.class);
