...
public class ChapterEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ChapterEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ChapterEditionIterator.class);
