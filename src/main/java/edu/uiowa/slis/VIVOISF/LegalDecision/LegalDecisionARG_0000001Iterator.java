...
public class LegalDecisionARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionARG_0000001Iterator.class);
