...
public class LegalDecisionAffirmedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionAffirmedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionAffirmedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDecisionAffirmedByIterator.getType());
		} catch (Exception e) {
