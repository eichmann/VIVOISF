...
public class LegalDecisionIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionIsbn10Iterator.class);
