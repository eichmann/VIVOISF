...
public class LegalDecisionOwner extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionOwner currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionOwner.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDecisionOwnerIterator.getOwner());
		} catch (Exception e) {
