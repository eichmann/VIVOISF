...
public class LegalDecisionArguedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionArguedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionArguedIterator.class);
