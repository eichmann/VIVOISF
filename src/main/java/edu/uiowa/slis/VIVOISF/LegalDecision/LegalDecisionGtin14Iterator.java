...
public class LegalDecisionGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionGtin14Iterator.class);
