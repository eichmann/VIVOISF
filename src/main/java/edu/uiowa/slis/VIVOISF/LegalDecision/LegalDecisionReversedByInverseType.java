...
public class LegalDecisionReversedByInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionReversedByInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionReversedByInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDecisionReversedByInverseIterator.getType());
		} catch (Exception e) {
