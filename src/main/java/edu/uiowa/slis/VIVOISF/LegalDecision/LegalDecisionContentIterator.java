...
public class LegalDecisionContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionContentIterator.class);
