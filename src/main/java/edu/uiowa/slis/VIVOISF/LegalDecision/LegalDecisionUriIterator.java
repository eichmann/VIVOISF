...
public class LegalDecisionUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionUriIterator.class);
