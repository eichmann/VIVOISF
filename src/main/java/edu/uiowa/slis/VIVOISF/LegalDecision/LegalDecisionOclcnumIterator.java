...
public class LegalDecisionOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionOclcnumIterator.class);
