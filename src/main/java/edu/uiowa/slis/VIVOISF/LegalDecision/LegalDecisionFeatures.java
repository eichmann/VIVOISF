...
public class LegalDecisionFeatures extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionFeatures currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionFeatures.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDecisionFeaturesIterator.getFeatures());
		} catch (Exception e) {
