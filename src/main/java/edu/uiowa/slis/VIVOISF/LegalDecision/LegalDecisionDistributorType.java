...
public class LegalDecisionDistributorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionDistributorType currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionDistributorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDecisionDistributorIterator.getType());
		} catch (Exception e) {
