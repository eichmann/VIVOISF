...
public class LegalDecisionTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionTheAbstractIterator.class);
