...
public class LegalDecisionShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionShortTitleIterator.class);
