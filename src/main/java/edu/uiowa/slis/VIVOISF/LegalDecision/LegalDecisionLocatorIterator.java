...
public class LegalDecisionLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionLocatorIterator.class);
