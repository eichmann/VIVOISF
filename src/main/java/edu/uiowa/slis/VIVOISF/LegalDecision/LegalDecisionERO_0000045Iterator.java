...
public class LegalDecisionERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionERO_0000045Iterator.class);
