...
public class LegalDecisionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/LegalDecision> . "+
