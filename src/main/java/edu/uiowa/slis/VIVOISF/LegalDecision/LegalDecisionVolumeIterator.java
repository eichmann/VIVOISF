...
public class LegalDecisionVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionVolumeIterator.class);
