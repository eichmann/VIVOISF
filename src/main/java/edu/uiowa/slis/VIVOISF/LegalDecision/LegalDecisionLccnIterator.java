...
public class LegalDecisionLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionLccnIterator.class);
