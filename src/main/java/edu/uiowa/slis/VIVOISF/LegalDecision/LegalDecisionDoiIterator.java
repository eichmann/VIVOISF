...
public class LegalDecisionDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionDoiIterator.class);
