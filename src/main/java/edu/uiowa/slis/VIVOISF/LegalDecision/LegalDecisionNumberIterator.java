...
public class LegalDecisionNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionNumberIterator.class);
