...
public class LegalDecisionDocumentationForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionDocumentationForType currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionDocumentationForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDecisionDocumentationForIterator.getType());
		} catch (Exception e) {
