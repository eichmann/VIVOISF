...
public class LegalDecisionNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionNumPagesIterator.class);
