...
public class LegalDecisionIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionIdentifierIterator.class);
