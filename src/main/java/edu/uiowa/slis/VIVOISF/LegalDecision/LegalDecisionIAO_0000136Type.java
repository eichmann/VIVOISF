...
public class LegalDecisionIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDecisionIAO_0000136Iterator.getType());
		} catch (Exception e) {
