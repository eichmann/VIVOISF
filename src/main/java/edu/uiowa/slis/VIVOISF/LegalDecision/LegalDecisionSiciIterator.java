...
public class LegalDecisionSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionSiciIterator.class);
