...
public class LegalDecisionSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionSectionIterator.class);
