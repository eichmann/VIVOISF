...
public class LegalDecisionEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionEditionIterator.class);
