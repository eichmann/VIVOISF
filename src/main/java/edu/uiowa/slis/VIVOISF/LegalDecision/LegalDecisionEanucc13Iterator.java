...
public class LegalDecisionEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionEanucc13Iterator.class);
