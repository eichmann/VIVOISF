...
public class LegalDecisionRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDecisionRO_0000056Iterator.getType());
		} catch (Exception e) {
