...
public class LegalDecisionAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionAsinIterator.class);
