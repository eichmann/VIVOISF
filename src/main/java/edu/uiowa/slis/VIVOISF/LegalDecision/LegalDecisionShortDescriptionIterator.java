...
public class LegalDecisionShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionShortDescriptionIterator.class);
