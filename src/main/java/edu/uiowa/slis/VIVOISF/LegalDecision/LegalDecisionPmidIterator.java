...
public class LegalDecisionPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionPmidIterator.class);
