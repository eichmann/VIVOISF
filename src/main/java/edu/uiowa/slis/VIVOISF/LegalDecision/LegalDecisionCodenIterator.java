...
public class LegalDecisionCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionCodenIterator.class);
