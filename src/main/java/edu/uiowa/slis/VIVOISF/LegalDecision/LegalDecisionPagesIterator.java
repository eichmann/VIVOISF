...
public class LegalDecisionPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionPagesIterator.class);
