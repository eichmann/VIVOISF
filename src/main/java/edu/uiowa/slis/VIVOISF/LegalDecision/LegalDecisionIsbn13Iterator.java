...
public class LegalDecisionIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDecisionIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDecisionIsbn13Iterator.class);
