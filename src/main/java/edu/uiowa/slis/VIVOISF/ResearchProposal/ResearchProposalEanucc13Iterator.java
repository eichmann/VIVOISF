...
public class ResearchProposalEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalEanucc13Iterator.class);
