...
public class ResearchProposalNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalNumPagesIterator.class);
