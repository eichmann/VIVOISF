...
public class ResearchProposalIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchProposalIAO_0000136Iterator.getType());
		} catch (Exception e) {
