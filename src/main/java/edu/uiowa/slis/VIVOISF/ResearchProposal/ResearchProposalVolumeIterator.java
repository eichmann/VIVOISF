...
public class ResearchProposalVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalVolumeIterator.class);
