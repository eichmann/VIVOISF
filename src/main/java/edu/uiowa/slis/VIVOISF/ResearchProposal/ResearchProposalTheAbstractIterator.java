...
public class ResearchProposalTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalTheAbstractIterator.class);
