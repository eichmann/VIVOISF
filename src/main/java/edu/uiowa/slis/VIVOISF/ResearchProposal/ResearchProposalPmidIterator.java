...
public class ResearchProposalPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalPmidIterator.class);
