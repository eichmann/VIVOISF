...
public class ResearchProposalHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalHandleIterator.class);
