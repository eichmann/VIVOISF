...
public class ResearchProposalPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalPagesIterator.class);
