...
public class ResearchProposalLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalLocatorIterator.class);
