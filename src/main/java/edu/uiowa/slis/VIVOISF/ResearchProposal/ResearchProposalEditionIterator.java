...
public class ResearchProposalEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalEditionIterator.class);
