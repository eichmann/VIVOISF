...
public class ResearchProposalShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalShortDescriptionIterator.class);
