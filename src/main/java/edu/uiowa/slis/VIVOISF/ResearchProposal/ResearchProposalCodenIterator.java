...
public class ResearchProposalCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalCodenIterator.class);
