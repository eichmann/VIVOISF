...
public class ResearchProposalUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalUpcIterator.class);
