...
public class ResearchProposalContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalContentIterator.class);
