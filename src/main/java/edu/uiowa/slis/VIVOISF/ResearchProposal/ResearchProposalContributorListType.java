...
public class ResearchProposalContributorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalContributorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalContributorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchProposalContributorListIterator.getType());
		} catch (Exception e) {
