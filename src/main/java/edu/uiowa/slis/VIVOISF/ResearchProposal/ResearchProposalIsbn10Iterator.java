...
public class ResearchProposalIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalIsbn10Iterator.class);
