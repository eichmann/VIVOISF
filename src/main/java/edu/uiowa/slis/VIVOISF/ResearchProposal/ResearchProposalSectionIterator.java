...
public class ResearchProposalSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalSectionIterator.class);
