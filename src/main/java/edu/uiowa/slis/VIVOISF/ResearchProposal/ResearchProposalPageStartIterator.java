...
public class ResearchProposalPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalPageStartIterator.class);
