...
public class ResearchProposalNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalNumberIterator.class);
