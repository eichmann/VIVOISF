...
public class ResearchProposalUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalUriIterator.class);
