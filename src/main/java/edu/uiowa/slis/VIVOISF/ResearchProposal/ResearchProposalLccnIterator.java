...
public class ResearchProposalLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalLccnIterator.class);
