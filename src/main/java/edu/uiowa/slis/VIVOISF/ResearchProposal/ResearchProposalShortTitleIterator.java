...
public class ResearchProposalShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalShortTitleIterator.class);
