...
public class ResearchProposalAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalAsinIterator.class);
