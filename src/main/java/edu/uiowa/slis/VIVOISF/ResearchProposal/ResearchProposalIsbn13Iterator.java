...
public class ResearchProposalIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalIsbn13Iterator.class);
