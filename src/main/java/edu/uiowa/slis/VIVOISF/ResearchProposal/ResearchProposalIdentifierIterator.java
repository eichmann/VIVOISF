...
public class ResearchProposalIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalIdentifierIterator.class);
