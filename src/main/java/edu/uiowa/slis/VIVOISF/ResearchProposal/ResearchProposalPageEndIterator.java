...
public class ResearchProposalPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalPageEndIterator.class);
