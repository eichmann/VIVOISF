...
public class ResearchProposalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#ResearchProposal> . "+
