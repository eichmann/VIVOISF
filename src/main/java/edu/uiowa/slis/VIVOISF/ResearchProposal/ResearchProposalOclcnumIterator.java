...
public class ResearchProposalOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchProposalOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchProposalOclcnumIterator.class);
