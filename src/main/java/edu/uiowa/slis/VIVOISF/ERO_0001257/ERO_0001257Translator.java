...
public class ERO_0001257Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001257Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001257Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001257TranslatorIterator.getTranslator());
		} catch (Exception e) {
