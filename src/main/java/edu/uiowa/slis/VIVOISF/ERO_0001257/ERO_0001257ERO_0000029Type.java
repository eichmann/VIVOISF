...
public class ERO_0001257ERO_0000029Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001257ERO_0000029Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001257ERO_0000029Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001257ERO_0000029Iterator.getType());
		} catch (Exception e) {
