...
public class ERO_0001257FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001257FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001257FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001257FeaturesIterator.getType());
		} catch (Exception e) {
