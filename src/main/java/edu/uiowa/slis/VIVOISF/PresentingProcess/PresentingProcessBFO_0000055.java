...
public class PresentingProcessBFO_0000055 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PresentingProcessBFO_0000055 currentInstance = null;
	private static final Log log = LogFactory.getLog(PresentingProcessBFO_0000055.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePresentingProcessBFO_0000055Iterator.getBFO_0000055());
		} catch (Exception e) {
