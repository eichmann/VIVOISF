...
public class ReferenceSourceShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceShortDescriptionIterator.class);
