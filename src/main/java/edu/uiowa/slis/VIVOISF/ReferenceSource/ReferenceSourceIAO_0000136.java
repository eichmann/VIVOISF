...
public class ReferenceSourceIAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceIAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceIAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReferenceSourceIAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
