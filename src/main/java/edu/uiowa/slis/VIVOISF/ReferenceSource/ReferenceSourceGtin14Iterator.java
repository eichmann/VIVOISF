...
public class ReferenceSourceGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceGtin14Iterator.class);
