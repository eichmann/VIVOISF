...
public class ReferenceSourceIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceIsbn10Iterator.class);
