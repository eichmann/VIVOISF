...
public class ReferenceSourceSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceSectionIterator.class);
