...
public class ReferenceSourceEditorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceEditorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceEditorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReferenceSourceEditorListIterator.getType());
		} catch (Exception e) {
