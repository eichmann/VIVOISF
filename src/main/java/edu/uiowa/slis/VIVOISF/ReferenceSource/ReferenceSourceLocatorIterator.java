...
public class ReferenceSourceLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceLocatorIterator.class);
