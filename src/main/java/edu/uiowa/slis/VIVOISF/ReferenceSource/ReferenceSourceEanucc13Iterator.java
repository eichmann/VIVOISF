...
public class ReferenceSourceEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceEanucc13Iterator.class);
