...
public class ReferenceSourceUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceUriIterator.class);
