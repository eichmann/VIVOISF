...
public class ReferenceSourceRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReferenceSourceRO_0000056Iterator.getType());
		} catch (Exception e) {
