...
public class ReferenceSourceAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceAsinIterator.class);
