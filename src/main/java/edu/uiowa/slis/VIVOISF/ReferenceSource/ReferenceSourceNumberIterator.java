...
public class ReferenceSourceNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceNumberIterator.class);
