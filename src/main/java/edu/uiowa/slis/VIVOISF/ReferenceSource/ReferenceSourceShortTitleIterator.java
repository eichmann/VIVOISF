...
public class ReferenceSourceShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceShortTitleIterator.class);
