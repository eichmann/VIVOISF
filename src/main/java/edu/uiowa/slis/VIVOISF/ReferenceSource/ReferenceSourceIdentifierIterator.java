...
public class ReferenceSourceIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceIdentifierIterator.class);
