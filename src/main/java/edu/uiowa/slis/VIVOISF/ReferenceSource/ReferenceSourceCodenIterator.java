...
public class ReferenceSourceCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceCodenIterator.class);
