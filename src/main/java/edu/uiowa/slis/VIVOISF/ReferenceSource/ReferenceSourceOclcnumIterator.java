...
public class ReferenceSourceOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceOclcnumIterator.class);
