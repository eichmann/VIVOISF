...
public class ReferenceSourcePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourcePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourcePagesIterator.class);
