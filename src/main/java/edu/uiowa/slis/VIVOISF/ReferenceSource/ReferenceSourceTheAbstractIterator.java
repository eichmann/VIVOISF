...
public class ReferenceSourceTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceTheAbstractIterator.class);
