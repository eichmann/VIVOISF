...
public class ReferenceSourceSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceSiciIterator.class);
