...
public class ReferenceSourcePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourcePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourcePageStartIterator.class);
