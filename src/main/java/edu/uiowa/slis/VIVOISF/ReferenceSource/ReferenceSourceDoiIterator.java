...
public class ReferenceSourceDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceDoiIterator.class);
