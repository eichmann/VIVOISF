...
public class ReferenceSourceContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceContentIterator.class);
