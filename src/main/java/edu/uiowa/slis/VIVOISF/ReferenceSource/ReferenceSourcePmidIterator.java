...
public class ReferenceSourcePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourcePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourcePmidIterator.class);
