...
public class ReferenceSourceEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceEditionIterator.class);
