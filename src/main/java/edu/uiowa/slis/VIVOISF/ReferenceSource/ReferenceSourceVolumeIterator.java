...
public class ReferenceSourceVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceVolumeIterator.class);
