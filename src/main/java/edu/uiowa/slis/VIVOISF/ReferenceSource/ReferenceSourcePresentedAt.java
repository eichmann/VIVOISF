...
public class ReferenceSourcePresentedAt extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourcePresentedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourcePresentedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReferenceSourcePresentedAtIterator.getPresentedAt());
		} catch (Exception e) {
