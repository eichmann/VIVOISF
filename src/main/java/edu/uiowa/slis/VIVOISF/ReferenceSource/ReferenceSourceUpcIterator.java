...
public class ReferenceSourceUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceUpcIterator.class);
