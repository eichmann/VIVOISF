...
public class ReferenceSourcePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourcePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourcePageEndIterator.class);
