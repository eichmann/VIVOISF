...
public class ReferenceSourceLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReferenceSourceLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReferenceSourceLccnIterator.class);
