...
public class ERO_0001258Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001258Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001258Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001258TranslatorIterator.getTranslator());
		} catch (Exception e) {
