...
public class ERO_0001258ERO_0000482Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001258ERO_0000482Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001258ERO_0000482Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001258ERO_0000482Iterator.getType());
		} catch (Exception e) {
