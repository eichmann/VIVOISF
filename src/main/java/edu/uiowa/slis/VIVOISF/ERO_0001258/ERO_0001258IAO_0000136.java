...
public class ERO_0001258IAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001258IAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001258IAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001258IAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
