...
public class ERO_0001258Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001258Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001258Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.obolibrary.org/obo/ERO_0001258> . "+
