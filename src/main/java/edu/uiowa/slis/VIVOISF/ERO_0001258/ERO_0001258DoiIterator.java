...
public class ERO_0001258DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001258DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001258DoiIterator.class);
