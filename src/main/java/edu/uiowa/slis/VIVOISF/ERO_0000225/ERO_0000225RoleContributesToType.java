...
public class ERO_0000225RoleContributesToType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000225RoleContributesToType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000225RoleContributesToType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000225RoleContributesToIterator.getType());
		} catch (Exception e) {
