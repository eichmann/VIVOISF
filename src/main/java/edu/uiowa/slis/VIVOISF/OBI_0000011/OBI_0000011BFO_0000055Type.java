...
public class OBI_0000011BFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000011BFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000011BFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000011BFO_0000055Iterator.getType());
		} catch (Exception e) {
