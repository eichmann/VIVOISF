...
public class OBI_0000011RO_0000057 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000011RO_0000057 currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000011RO_0000057.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000011RO_0000057Iterator.getRO_0000057());
		} catch (Exception e) {
