...
public class OBI_0000011OBI_0000417 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000011OBI_0000417 currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000011OBI_0000417.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000011OBI_0000417Iterator.getOBI_0000417());
		} catch (Exception e) {
