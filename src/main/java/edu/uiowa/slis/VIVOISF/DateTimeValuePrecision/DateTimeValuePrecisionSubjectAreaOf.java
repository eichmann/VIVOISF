...
public class DateTimeValuePrecisionSubjectAreaOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeValuePrecisionSubjectAreaOf currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeValuePrecisionSubjectAreaOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeValuePrecisionSubjectAreaOfIterator.getSubjectAreaOf());
		} catch (Exception e) {
