...
public class FacultyAdministrativePositionRO_0000052 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionRO_0000052 currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionRO_0000052.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacultyAdministrativePositionRO_0000052Iterator.getRO_0000052());
		} catch (Exception e) {
