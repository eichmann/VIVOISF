...
public class FacultyAdministrativePositionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionHasMinLatitudeIterator.class);
