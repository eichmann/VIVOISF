...
public class FacultyAdministrativePositionHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionHDITotalIterator.class);
