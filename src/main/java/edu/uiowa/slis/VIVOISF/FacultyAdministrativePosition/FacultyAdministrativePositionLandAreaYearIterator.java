...
public class FacultyAdministrativePositionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionLandAreaYearIterator.class);
