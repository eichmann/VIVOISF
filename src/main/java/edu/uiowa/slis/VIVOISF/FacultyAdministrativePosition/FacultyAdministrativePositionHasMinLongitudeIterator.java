...
public class FacultyAdministrativePositionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionHasMinLongitudeIterator.class);
