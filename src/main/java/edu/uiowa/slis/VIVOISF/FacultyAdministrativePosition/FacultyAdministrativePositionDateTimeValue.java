...
public class FacultyAdministrativePositionDateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionDateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionDateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacultyAdministrativePositionDateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
