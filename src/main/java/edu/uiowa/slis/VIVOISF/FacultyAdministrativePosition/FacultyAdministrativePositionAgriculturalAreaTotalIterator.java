...
public class FacultyAdministrativePositionAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionAgriculturalAreaTotalIterator.class);
