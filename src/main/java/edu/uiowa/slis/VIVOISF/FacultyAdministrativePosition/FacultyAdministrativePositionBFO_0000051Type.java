...
public class FacultyAdministrativePositionBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacultyAdministrativePositionBFO_0000051Iterator.getType());
		} catch (Exception e) {
