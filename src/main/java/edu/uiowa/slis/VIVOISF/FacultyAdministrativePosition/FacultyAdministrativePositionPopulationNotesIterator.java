...
public class FacultyAdministrativePositionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionPopulationNotesIterator.class);
