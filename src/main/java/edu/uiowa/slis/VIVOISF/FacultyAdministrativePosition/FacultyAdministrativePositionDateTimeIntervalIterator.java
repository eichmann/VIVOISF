...
public class FacultyAdministrativePositionDateTimeIntervalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionDateTimeIntervalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionDateTimeIntervalIterator.class);
...
//					continue;
			...
			log.error("Exception raised in FacultyAdministrativePositionDateTimeIntervalIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FacultyAdministrativePositionDateTimeIntervalIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in FacultyAdministrativePositionDateTimeIntervalIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FacultyAdministrativePositionDateTimeIntervalIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FacultyAdministrativePositionDateTimeInterval doEndTag", e);
			throw new JspTagException("Exception raised in FacultyAdministrativePositionDateTimeInterval doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to FacultyAdministrativePositionDateTimeIntervalIterator");
