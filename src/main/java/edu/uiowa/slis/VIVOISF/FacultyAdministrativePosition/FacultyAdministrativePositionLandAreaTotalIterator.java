...
public class FacultyAdministrativePositionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionLandAreaTotalIterator.class);
