...
public class FacultyAdministrativePositionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionLandAreaNotesIterator.class);
