...
public class FacultyAdministrativePositionRO_0001015 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionRO_0001015 currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionRO_0001015.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacultyAdministrativePositionRO_0001015Iterator.getRO_0001015());
		} catch (Exception e) {
