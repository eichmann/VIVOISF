...
public class FacultyAdministrativePositionCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyAdministrativePositionCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyAdministrativePositionCountryAreaTotalIterator.class);
