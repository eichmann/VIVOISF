...
public class PrivateCompanyEditorInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyEditorInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyEditorInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyEditorInverseIterator.getEditorInverse());
		} catch (Exception e) {
