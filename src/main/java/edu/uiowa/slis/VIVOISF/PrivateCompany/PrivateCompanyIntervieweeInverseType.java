...
public class PrivateCompanyIntervieweeInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyIntervieweeInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyIntervieweeInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyIntervieweeInverseIterator.getType());
		} catch (Exception e) {
