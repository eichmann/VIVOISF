...
public class PrivateCompanyRO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyRO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyRO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyRO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
