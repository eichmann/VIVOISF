...
public class PrivateCompanyInterviewerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyInterviewerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyInterviewerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyInterviewerInverseIterator.getInterviewerInverse());
		} catch (Exception e) {
