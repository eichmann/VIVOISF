...
public class PrivateCompanyOrganizerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyOrganizerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyOrganizerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyOrganizerInverseIterator.getOrganizerInverse());
		} catch (Exception e) {
