...
public class PrivateCompanyOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
