...
public class PrivateCompanyERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyERO_0000037Iterator.getType());
		} catch (Exception e) {
