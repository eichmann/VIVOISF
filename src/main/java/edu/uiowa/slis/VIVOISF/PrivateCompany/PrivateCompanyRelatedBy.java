...
public class PrivateCompanyRelatedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyRelatedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyRelatedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyRelatedByIterator.getRelatedBy());
		} catch (Exception e) {
