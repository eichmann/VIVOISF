...
public class PrivateCompanyHasCollaboratorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyHasCollaboratorType currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyHasCollaboratorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyHasCollaboratorIterator.getType());
		} catch (Exception e) {
