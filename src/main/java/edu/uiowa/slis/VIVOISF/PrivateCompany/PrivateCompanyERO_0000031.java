...
public class PrivateCompanyERO_0000031 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyERO_0000031 currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyERO_0000031.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyERO_0000031Iterator.getERO_0000031());
		} catch (Exception e) {
