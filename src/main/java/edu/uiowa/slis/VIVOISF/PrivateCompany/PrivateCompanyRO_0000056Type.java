...
public class PrivateCompanyRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrivateCompanyRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PrivateCompanyRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrivateCompanyRO_0000056Iterator.getType());
		} catch (Exception e) {
