...
public class KindAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindAgriculturalAreaNotesIterator.class);
