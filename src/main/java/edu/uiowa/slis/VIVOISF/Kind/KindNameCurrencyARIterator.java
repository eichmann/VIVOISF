...
public class KindNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameCurrencyARIterator.class);
