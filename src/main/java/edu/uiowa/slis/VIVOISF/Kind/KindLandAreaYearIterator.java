...
public class KindLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindLandAreaYearIterator.class);
