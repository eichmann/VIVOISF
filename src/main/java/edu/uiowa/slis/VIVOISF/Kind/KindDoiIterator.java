...
public class KindDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindDoiIterator.class);
