...
public class KindNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameListITIterator.class);
