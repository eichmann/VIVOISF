...
public class KindCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCodeDBPediaIDIterator.class);
