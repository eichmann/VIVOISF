...
public class KindNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNationalityITIterator.class);
