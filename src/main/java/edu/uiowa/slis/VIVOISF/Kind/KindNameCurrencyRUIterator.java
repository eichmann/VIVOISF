...
public class KindNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameCurrencyRUIterator.class);
