...
public class KindNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNationalityARIterator.class);
