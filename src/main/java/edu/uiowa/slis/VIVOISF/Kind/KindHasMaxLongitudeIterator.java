...
public class KindHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHasMaxLongitudeIterator.class);
