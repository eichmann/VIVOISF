...
public class KindAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindAgriculturalAreaYearIterator.class);
