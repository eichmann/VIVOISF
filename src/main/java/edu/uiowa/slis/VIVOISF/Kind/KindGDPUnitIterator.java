...
public class KindGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindGDPUnitIterator.class);
