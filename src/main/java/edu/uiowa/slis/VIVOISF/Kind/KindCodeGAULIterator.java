...
public class KindCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCodeGAULIterator.class);
