...
public class KindNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameOfficialFRIterator.class);
