...
public class KindNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameShortFRIterator.class);
