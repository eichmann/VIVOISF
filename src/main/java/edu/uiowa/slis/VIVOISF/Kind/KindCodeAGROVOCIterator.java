...
public class KindCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCodeAGROVOCIterator.class);
