...
public class KindHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHasMaxLatitudeIterator.class);
