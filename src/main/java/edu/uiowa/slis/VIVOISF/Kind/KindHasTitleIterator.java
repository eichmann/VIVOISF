...
public class KindHasTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHasTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHasTitleIterator.class);
...
//					continue;
			...
			log.error("Exception raised in KindHasTitleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KindHasTitleIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in KindHasTitleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KindHasTitleIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in KindHasTitle doEndTag", e);
			throw new JspTagException("Exception raised in KindHasTitle doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to KindHasTitleIterator");
