...
public class KindGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindGDPNotesIterator.class);
