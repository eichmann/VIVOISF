...
public class KindGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindGDPYearIterator.class);
