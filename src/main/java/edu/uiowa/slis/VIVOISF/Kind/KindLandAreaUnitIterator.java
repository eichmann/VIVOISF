...
public class KindLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindLandAreaUnitIterator.class);
