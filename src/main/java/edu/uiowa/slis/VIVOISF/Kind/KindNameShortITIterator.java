...
public class KindNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameShortITIterator.class);
