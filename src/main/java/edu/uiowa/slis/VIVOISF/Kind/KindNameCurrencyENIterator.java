...
public class KindNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameCurrencyENIterator.class);
