...
public class KindCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCodeISO3Iterator.class);
