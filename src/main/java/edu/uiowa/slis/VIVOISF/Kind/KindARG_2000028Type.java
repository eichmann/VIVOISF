...
public class KindARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(KindARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theKindARG_2000028Iterator.getType());
		} catch (Exception e) {
