...
public class KindNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameListARIterator.class);
