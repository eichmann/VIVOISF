...
public class KindHasAddressType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHasAddressType currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHasAddressType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theKindHasAddressIterator.getType());
		} catch (Exception e) {
