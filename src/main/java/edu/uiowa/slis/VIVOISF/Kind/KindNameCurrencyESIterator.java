...
public class KindNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameCurrencyESIterator.class);
