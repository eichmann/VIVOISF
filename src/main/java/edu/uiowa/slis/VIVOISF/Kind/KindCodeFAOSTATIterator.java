...
public class KindCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCodeFAOSTATIterator.class);
