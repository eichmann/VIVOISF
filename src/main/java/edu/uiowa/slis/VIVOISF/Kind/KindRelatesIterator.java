...
public class KindRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in KindRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KindRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in KindRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KindRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in KindRelates doEndTag", e);
			throw new JspTagException("Exception raised in KindRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to KindRelatesIterator");
