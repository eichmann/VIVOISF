...
public class KindNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameCurrencyITIterator.class);
