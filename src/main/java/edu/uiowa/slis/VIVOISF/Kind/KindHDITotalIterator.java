...
public class KindHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHDITotalIterator.class);
