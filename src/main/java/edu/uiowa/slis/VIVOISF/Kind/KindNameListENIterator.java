...
public class KindNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameListENIterator.class);
