...
public class KindNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNationalityRUIterator.class);
