...
public class KindCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCodeUNIterator.class);
