...
public class KindNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameShortENIterator.class);
