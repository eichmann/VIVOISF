...
public class KindCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCodeUNDPIterator.class);
