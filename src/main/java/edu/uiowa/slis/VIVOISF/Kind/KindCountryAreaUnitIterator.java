...
public class KindCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCountryAreaUnitIterator.class);
