...
public class KindNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameOfficialITIterator.class);
