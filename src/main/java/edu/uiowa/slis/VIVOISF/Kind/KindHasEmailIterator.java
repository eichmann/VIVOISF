...
public class KindHasEmailIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHasEmailIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHasEmailIterator.class);
...
//					continue;
			...
			log.error("Exception raised in KindHasEmailIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KindHasEmailIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in KindHasEmailIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KindHasEmailIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in KindHasEmail doEndTag", e);
			throw new JspTagException("Exception raised in KindHasEmail doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to KindHasEmailIterator");
