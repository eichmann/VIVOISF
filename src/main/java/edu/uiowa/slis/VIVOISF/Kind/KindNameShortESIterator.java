...
public class KindNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameShortESIterator.class);
