...
public class KindFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindFreetextKeywordIterator.class);
