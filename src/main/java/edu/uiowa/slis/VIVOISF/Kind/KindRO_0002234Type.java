...
public class KindRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(KindRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theKindRO_0002234Iterator.getType());
		} catch (Exception e) {
