...
public class KindCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCodeISO2Iterator.class);
