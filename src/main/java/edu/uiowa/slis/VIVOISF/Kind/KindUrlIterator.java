...
public class KindUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindUrlIterator.class);
