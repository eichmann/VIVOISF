...
public class KindNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNationalityENIterator.class);
