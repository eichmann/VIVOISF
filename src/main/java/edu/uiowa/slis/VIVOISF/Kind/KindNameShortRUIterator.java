...
public class KindNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameShortRUIterator.class);
