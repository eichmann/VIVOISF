...
public class KindNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameShortARIterator.class);
