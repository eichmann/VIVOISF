...
public class KindAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindAgriculturalAreaTotalIterator.class);
