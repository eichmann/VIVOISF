...
public class KindAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindAgriculturalAreaUnitIterator.class);
