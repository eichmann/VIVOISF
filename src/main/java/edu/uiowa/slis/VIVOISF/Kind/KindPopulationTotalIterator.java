...
public class KindPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindPopulationTotalIterator.class);
