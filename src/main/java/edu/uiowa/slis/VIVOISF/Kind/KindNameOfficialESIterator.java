...
public class KindNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameOfficialESIterator.class);
