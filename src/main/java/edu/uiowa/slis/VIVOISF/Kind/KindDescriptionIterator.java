...
public class KindDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindDescriptionIterator.class);
