...
public class KindCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCountryAreaTotalIterator.class);
