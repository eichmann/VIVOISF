...
public class KindHasGeoIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHasGeoIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHasGeoIterator.class);
...
//					continue;
			...
			log.error("Exception raised in KindHasGeoIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KindHasGeoIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in KindHasGeoIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KindHasGeoIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in KindHasGeo doEndTag", e);
			throw new JspTagException("Exception raised in KindHasGeo doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to KindHasGeoIterator");
