...
public class KindHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHDINotesIterator.class);
