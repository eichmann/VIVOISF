...
public class KindNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNationalityZHIterator.class);
