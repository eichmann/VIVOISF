...
public class KindARG_2000029Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindARG_2000029Type currentInstance = null;
	private static final Log log = LogFactory.getLog(KindARG_2000029Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theKindARG_2000029Iterator.getType());
		} catch (Exception e) {
