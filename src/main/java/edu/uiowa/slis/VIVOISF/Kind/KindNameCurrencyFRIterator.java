...
public class KindNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameCurrencyFRIterator.class);
