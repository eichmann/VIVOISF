...
public class KindHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHDIYearIterator.class);
