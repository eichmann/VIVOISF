...
public class KindNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameOfficialZHIterator.class);
