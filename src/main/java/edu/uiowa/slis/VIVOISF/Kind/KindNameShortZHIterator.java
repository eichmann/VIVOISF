...
public class KindNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameShortZHIterator.class);
