...
public class KindCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCodeFAOTERMIterator.class);
