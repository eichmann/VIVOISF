...
public class KindNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNationalityESIterator.class);
