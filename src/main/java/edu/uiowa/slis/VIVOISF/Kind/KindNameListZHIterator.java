...
public class KindNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameListZHIterator.class);
