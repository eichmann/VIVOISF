...
public class KindNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameListESIterator.class);
