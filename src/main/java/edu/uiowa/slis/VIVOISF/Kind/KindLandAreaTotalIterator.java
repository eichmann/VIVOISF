...
public class KindLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindLandAreaTotalIterator.class);
