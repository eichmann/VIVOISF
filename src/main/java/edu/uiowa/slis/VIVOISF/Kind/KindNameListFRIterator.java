...
public class KindNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameListFRIterator.class);
