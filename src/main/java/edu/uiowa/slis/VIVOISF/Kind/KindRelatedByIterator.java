...
public class KindRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindRelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindRelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in KindRelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KindRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in KindRelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in KindRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in KindRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in KindRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to KindRelatedByIterator");
