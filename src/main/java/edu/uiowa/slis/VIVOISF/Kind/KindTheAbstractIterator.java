...
public class KindTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindTheAbstractIterator.class);
