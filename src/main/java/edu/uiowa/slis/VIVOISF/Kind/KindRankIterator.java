...
public class KindRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindRankIterator.class);
