...
public class KindNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameCurrencyZHIterator.class);
