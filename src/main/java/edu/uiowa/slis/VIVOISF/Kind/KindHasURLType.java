...
public class KindHasURLType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHasURLType currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHasURLType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theKindHasURLIterator.getType());
		} catch (Exception e) {
