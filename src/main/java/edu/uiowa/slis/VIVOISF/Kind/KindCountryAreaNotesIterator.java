...
public class KindCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindCountryAreaNotesIterator.class);
