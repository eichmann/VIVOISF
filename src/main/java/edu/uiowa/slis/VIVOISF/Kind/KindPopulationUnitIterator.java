...
public class KindPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindPopulationUnitIterator.class);
