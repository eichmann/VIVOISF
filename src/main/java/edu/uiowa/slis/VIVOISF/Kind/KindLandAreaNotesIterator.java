...
public class KindLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindLandAreaNotesIterator.class);
