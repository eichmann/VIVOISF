...
public class KindHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindHasMinLongitudeIterator.class);
