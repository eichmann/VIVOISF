...
public class KindNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static KindNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(KindNameOfficialARIterator.class);
