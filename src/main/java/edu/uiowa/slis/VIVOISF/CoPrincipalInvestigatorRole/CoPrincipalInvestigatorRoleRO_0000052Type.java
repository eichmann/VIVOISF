...
public class CoPrincipalInvestigatorRoleRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoPrincipalInvestigatorRoleRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CoPrincipalInvestigatorRoleRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCoPrincipalInvestigatorRoleRO_0000052Iterator.getType());
		} catch (Exception e) {
