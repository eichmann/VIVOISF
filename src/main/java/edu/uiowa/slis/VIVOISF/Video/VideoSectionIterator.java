...
public class VideoSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoSectionIterator.class);
