...
public class VideoIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoIsbn13Iterator.class);
