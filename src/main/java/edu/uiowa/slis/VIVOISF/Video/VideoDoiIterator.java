...
public class VideoDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoDoiIterator.class);
