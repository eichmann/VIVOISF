...
public class VideoLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoLccnIterator.class);
