...
public class VideoEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoEditionIterator.class);
