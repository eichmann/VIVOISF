...
public class VideoEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoEanucc13Iterator.class);
