...
public class VideoShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoShortTitleIterator.class);
