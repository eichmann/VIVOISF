...
public class VideoContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoContentIterator.class);
