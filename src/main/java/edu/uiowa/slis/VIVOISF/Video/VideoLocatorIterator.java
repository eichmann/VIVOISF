...
public class VideoLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoLocatorIterator.class);
