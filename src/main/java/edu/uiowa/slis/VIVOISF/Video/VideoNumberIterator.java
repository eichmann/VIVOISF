...
public class VideoNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoNumberIterator.class);
