...
public class VideoTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoTheAbstractIterator.class);
