...
public class VideoAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoAsinIterator.class);
