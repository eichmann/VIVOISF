...
public class VideoUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoUpcIterator.class);
