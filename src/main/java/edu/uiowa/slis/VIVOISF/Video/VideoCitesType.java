...
public class VideoCitesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoCitesType currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoCitesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theVideoCitesIterator.getType());
		} catch (Exception e) {
