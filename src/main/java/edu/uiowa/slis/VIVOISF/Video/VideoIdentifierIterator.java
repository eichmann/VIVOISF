...
public class VideoIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoIdentifierIterator.class);
