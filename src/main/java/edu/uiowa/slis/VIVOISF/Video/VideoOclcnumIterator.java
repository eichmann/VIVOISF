...
public class VideoOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoOclcnumIterator.class);
