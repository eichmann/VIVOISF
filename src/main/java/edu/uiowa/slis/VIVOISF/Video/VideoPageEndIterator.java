...
public class VideoPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoPageEndIterator.class);
