...
public class VideoShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoShortDescriptionIterator.class);
