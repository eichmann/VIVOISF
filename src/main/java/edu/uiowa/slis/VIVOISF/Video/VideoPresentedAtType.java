...
public class VideoPresentedAtType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoPresentedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoPresentedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theVideoPresentedAtIterator.getType());
		} catch (Exception e) {
