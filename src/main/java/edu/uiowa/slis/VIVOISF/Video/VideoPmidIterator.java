...
public class VideoPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoPmidIterator.class);
