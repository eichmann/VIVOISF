...
public class VideoPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoPageStartIterator.class);
