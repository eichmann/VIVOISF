...
public class Video extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (theVideoIterator != null) {
				subjectURI = theVideoIterator.getSubjectURI();
				label = theVideoIterator.getLabel();
			}

			if (theVideoIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in Video doStartTag", e);
			throw new JspTagException("Exception raised in Video doStartTag");
		} finally {
			freeConnection();
		}
