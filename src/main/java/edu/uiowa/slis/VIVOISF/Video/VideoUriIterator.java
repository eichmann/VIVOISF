...
public class VideoUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoUriIterator.class);
