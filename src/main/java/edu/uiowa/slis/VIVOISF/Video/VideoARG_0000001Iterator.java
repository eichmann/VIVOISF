...
public class VideoARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoARG_0000001Iterator.class);
