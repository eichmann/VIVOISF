...
public class VideoIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoIterator.class);
