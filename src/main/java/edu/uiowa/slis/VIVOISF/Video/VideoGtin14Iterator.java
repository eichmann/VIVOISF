...
public class VideoGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoGtin14Iterator.class);
