...
public class VideoPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoPagesIterator.class);
