...
public class VideoVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static VideoVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(VideoVolumeIterator.class);
