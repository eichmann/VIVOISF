...
public class ERO_0001259TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001259TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001259TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001259TranslatorIterator.getType());
		} catch (Exception e) {
