...
public class ERO_0001259FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001259FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001259FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001259FeaturesIterator.getType());
		} catch (Exception e) {
