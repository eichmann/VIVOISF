...
public class ERO_0000784RoleContributesTo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000784RoleContributesTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000784RoleContributesTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000784RoleContributesToIterator.getRoleContributesTo());
		} catch (Exception e) {
