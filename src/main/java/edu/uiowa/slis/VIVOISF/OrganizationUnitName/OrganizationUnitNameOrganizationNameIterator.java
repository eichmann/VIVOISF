...
public class OrganizationUnitNameOrganizationNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationUnitNameOrganizationNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationUnitNameOrganizationNameIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.w3.org/2006/vcard/ns#organizationName> ?s } ");
			if(rs.hasNext()) {
