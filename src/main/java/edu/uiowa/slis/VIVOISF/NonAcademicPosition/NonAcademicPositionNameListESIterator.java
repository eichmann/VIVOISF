...
public class NonAcademicPositionNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameListESIterator.class);
