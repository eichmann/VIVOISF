...
public class NonAcademicPositionNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameListZHIterator.class);
