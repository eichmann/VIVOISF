...
public class NonAcademicPositionNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameListITIterator.class);
