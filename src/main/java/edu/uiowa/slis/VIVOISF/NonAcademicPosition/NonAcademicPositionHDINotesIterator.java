...
public class NonAcademicPositionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionHDINotesIterator.class);
