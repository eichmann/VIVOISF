...
public class NonAcademicPositionAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionAgriculturalAreaTotalIterator.class);
