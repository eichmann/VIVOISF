...
public class NonAcademicPositionRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionRankIterator.class);
