...
public class NonAcademicPositionNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNationalityFRIterator.class);
