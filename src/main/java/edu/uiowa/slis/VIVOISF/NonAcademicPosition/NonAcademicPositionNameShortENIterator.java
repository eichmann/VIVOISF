...
public class NonAcademicPositionNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameShortENIterator.class);
