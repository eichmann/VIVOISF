...
public class NonAcademicPositionRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicPositionRO_0001015Iterator.getType());
		} catch (Exception e) {
