...
public class NonAcademicPositionHasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionHasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionHasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicPositionHasPublicationVenueIterator.getType());
		} catch (Exception e) {
