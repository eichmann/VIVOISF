...
public class NonAcademicPositionRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicPositionRO_0002353Iterator.getType());
		} catch (Exception e) {
