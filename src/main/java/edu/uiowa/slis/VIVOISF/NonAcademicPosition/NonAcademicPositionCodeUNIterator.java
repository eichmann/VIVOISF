...
public class NonAcademicPositionCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionCodeUNIterator.class);
