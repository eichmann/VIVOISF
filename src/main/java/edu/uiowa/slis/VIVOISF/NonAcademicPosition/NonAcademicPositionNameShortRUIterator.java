...
public class NonAcademicPositionNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameShortRUIterator.class);
