...
public class NonAcademicPositionCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionCountryAreaYearIterator.class);
