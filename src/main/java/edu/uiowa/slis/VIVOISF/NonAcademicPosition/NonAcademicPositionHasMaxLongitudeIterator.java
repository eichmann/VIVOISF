...
public class NonAcademicPositionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionHasMaxLongitudeIterator.class);
