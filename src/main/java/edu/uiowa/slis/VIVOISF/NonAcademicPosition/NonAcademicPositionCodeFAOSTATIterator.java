...
public class NonAcademicPositionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionCodeFAOSTATIterator.class);
