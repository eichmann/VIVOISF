...
public class NonAcademicPositionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#NonAcademicPosition> . "+
