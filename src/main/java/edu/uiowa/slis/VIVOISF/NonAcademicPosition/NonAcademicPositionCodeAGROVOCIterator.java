...
public class NonAcademicPositionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionCodeAGROVOCIterator.class);
