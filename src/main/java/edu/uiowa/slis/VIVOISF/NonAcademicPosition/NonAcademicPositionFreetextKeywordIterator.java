...
public class NonAcademicPositionFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionFreetextKeywordIterator.class);
