...
public class NonAcademicPositionBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicPositionBFO_0000051Iterator.getType());
		} catch (Exception e) {
