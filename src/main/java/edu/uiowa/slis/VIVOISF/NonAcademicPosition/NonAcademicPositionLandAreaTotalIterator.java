...
public class NonAcademicPositionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionLandAreaTotalIterator.class);
