...
public class NonAcademicPositionHasName extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionHasName currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionHasName.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicPositionHasNameIterator.getHasName());
		} catch (Exception e) {
