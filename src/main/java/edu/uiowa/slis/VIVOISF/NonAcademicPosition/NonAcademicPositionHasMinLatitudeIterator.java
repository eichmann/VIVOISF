...
public class NonAcademicPositionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionHasMinLatitudeIterator.class);
