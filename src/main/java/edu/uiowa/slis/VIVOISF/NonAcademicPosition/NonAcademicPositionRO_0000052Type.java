...
public class NonAcademicPositionRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicPositionRO_0000052Iterator.getType());
		} catch (Exception e) {
