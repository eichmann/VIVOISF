...
public class NonAcademicPositionCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionCodeUNDPIterator.class);
