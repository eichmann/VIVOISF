...
public class NonAcademicPositionNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameShortZHIterator.class);
