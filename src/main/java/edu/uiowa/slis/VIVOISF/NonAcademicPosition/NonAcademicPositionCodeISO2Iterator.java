...
public class NonAcademicPositionCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionCodeISO2Iterator.class);
