...
public class NonAcademicPositionNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameShortFRIterator.class);
