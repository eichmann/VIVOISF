...
public class NonAcademicPositionNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameListARIterator.class);
