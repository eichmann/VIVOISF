...
public class NonAcademicPositionNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNationalityRUIterator.class);
