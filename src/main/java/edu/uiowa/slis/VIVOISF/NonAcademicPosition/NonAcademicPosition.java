...
public class NonAcademicPosition extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPosition currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPosition.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			NonAcademicPositionIterator theNonAcademicPositionIterator = (NonAcademicPositionIterator) findAncestorWithClass(this, NonAcademicPositionIterator.class);

			if (theNonAcademicPositionIterator != null) {
				subjectURI = theNonAcademicPositionIterator.getSubjectURI();
				label = theNonAcademicPositionIterator.getLabel();
			}
			...
			if (theNonAcademicPositionIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in NonAcademicPosition doStartTag", e);
			throw new JspTagException("Exception raised in NonAcademicPosition doStartTag");
		} finally {
			freeConnection();
		}
