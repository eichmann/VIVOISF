...
public class NonAcademicPositionCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionCodeFAOTERMIterator.class);
