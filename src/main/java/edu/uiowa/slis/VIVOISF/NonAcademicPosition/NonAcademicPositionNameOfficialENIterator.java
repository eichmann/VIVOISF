...
public class NonAcademicPositionNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameOfficialENIterator.class);
