...
public class NonAcademicPositionCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionCodeCurrencyIterator.class);
