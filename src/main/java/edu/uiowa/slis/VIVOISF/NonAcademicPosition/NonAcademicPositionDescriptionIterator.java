...
public class NonAcademicPositionDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionDescriptionIterator.class);
