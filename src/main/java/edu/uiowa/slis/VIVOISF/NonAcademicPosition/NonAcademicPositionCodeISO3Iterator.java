...
public class NonAcademicPositionCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionCodeISO3Iterator.class);
