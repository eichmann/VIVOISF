...
public class NonAcademicPositionGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionGDPNotesIterator.class);
