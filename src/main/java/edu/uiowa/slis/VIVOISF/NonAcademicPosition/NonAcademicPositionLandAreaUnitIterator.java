...
public class NonAcademicPositionLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionLandAreaUnitIterator.class);
