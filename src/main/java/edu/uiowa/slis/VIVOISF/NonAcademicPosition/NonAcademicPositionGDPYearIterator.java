...
public class NonAcademicPositionGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionGDPYearIterator.class);
