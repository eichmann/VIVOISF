...
public class NonAcademicPositionRelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionRelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionRelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicPositionRelatesIterator.getType());
		} catch (Exception e) {
