...
public class NonAcademicPositionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionLandAreaYearIterator.class);
