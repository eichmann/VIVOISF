...
public class NonAcademicPositionHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionHDIYearIterator.class);
