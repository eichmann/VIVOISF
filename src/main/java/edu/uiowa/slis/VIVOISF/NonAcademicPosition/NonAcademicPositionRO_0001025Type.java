...
public class NonAcademicPositionRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicPositionRO_0001025Iterator.getType());
		} catch (Exception e) {
