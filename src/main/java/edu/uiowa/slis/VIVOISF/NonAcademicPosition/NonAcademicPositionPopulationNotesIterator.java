...
public class NonAcademicPositionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionPopulationNotesIterator.class);
