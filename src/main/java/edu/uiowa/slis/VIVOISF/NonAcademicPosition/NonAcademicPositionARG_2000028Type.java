...
public class NonAcademicPositionARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicPositionARG_2000028Iterator.getType());
		} catch (Exception e) {
