...
public class NonAcademicPositionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameListFRIterator.class);
