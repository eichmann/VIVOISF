...
public class NonAcademicPositionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionCodeDBPediaIDIterator.class);
