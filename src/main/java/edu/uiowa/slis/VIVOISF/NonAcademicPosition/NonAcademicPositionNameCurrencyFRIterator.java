...
public class NonAcademicPositionNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameCurrencyFRIterator.class);
