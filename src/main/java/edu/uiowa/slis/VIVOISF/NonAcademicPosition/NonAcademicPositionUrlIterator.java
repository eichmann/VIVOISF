...
public class NonAcademicPositionUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionUrlIterator.class);
