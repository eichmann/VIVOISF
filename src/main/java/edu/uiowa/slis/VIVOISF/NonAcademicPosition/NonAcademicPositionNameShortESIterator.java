...
public class NonAcademicPositionNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNameShortESIterator.class);
