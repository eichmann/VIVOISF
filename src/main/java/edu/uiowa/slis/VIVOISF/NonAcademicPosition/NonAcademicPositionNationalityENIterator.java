...
public class NonAcademicPositionNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionNationalityENIterator.class);
