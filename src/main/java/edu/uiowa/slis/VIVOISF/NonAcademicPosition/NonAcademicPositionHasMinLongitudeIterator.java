...
public class NonAcademicPositionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionHasMinLongitudeIterator.class);
