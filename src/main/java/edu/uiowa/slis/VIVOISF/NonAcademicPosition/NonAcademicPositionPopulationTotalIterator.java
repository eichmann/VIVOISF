...
public class NonAcademicPositionPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicPositionPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicPositionPopulationTotalIterator.class);
