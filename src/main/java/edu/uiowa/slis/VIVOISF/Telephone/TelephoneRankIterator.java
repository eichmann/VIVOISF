...
public class TelephoneRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TelephoneRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TelephoneRankIterator.class);
