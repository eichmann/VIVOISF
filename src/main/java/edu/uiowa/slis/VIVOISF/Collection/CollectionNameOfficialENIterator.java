...
public class CollectionNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameOfficialENIterator.class);
