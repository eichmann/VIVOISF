...
public class CollectionNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameListENIterator.class);
