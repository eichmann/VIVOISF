...
public class CollectionNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameShortITIterator.class);
