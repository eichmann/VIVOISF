...
public class CollectionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionLandAreaYearIterator.class);
