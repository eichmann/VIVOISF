...
public class CollectionCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCodeGAULIterator.class);
