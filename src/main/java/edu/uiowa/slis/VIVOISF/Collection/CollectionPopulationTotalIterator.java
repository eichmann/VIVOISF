...
public class CollectionPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionPopulationTotalIterator.class);
