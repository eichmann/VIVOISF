...
public class CollectionDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionDescriptionIterator.class);
