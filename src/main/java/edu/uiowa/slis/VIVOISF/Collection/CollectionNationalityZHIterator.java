...
public class CollectionNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNationalityZHIterator.class);
