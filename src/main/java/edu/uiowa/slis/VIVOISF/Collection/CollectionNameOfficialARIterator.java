...
public class CollectionNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameOfficialARIterator.class);
