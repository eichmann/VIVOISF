...
public class CollectionTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionTheAbstractIterator.class);
