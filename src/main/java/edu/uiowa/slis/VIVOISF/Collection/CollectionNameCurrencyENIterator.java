...
public class CollectionNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameCurrencyENIterator.class);
