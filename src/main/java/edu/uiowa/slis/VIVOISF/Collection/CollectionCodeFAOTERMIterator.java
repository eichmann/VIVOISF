...
public class CollectionCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCodeFAOTERMIterator.class);
