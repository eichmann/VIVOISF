...
public class CollectionNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameCurrencyITIterator.class);
