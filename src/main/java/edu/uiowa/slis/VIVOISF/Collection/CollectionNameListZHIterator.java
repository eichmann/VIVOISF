...
public class CollectionNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameListZHIterator.class);
