...
public class CollectionIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionIsbn13Iterator.class);
