...
public class CollectionUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionUriIterator.class);
