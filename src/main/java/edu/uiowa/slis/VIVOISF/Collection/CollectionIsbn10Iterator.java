...
public class CollectionIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionIsbn10Iterator.class);
