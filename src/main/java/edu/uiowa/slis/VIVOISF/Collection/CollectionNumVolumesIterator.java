...
public class CollectionNumVolumesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNumVolumesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNumVolumesIterator.class);
