...
public class CollectionHasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionHasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionHasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
