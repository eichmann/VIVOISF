...
public class CollectionHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasMaxLatitudeIterator.class);
