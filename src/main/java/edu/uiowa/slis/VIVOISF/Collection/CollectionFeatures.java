...
public class CollectionFeatures extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionFeatures currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionFeatures.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionFeaturesIterator.getFeatures());
		} catch (Exception e) {
