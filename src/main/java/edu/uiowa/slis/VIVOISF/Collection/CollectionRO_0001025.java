...
public class CollectionRO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionRO_0001025 currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionRO_0001025.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionRO_0001025Iterator.getRO_0001025());
		} catch (Exception e) {
