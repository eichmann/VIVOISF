...
public class CollectionRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionRankIterator.class);
