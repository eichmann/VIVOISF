...
public class CollectionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionPopulationNotesIterator.class);
