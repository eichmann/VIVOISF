...
public class CollectionNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNationalityFRIterator.class);
