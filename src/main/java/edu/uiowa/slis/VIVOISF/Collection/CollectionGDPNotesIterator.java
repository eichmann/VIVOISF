...
public class CollectionGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionGDPNotesIterator.class);
