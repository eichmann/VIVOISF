...
public class CollectionRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionRO_0002353Iterator.getType());
		} catch (Exception e) {
