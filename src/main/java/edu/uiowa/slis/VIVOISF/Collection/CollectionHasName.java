...
public class CollectionHasName extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionHasName currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasName.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionHasNameIterator.getHasName());
		} catch (Exception e) {
