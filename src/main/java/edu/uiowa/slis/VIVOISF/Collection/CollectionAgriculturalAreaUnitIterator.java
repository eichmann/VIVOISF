...
public class CollectionAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionAgriculturalAreaUnitIterator.class);
