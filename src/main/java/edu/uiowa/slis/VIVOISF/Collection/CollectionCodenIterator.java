...
public class CollectionCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCodenIterator.class);
