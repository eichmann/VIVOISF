...
public class CollectionCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCountryAreaYearIterator.class);
