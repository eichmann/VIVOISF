...
public class CollectionGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionGtin14Iterator.class);
