...
public class CollectionPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionPmidIterator.class);
