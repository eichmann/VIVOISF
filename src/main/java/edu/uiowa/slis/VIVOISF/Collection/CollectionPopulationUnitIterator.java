...
public class CollectionPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionPopulationUnitIterator.class);
