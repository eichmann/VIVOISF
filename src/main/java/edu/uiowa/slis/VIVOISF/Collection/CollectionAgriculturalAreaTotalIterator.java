...
public class CollectionAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionAgriculturalAreaTotalIterator.class);
