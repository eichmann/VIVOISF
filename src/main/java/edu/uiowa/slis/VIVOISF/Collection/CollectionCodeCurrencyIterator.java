...
public class CollectionCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCodeCurrencyIterator.class);
