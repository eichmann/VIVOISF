...
public class CollectionNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNationalityARIterator.class);
