...
public class CollectionNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameCurrencyZHIterator.class);
