...
public class CollectionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameListFRIterator.class);
