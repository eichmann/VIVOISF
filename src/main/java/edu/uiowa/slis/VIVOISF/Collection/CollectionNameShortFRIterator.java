...
public class CollectionNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameShortFRIterator.class);
