...
public class CollectionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasMaxLongitudeIterator.class);
