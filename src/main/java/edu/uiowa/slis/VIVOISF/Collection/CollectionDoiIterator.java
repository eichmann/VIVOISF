...
public class CollectionDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionDoiIterator.class);
