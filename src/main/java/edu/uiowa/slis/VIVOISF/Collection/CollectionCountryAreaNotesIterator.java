...
public class CollectionCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCountryAreaNotesIterator.class);
