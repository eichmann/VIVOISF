...
public class CollectionNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameOfficialESIterator.class);
