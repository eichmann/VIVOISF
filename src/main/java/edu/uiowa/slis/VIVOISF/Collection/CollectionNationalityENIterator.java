...
public class CollectionNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNationalityENIterator.class);
