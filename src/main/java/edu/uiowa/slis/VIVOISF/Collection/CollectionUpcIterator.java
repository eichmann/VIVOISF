...
public class CollectionUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionUpcIterator.class);
