...
public class CollectionEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionEanucc13Iterator.class);
