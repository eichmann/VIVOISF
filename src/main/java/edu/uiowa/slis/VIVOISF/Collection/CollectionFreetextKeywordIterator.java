...
public class CollectionFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionFreetextKeywordIterator.class);
