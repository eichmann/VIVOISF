...
public class CollectionMemberInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionMemberInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionMemberInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CollectionMemberInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectionMemberInverseIterator doStartTag");
		}
