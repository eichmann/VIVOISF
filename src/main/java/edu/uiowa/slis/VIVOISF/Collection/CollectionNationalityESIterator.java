...
public class CollectionNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNationalityESIterator.class);
