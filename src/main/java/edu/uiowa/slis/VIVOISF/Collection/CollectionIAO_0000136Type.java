...
public class CollectionIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionIAO_0000136Iterator.getType());
		} catch (Exception e) {
