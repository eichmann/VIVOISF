...
public class CollectionSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionSiciIterator.class);
