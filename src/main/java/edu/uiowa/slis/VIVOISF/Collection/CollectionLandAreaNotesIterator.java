...
public class CollectionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionLandAreaNotesIterator.class);
