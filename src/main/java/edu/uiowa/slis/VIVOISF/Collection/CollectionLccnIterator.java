...
public class CollectionLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionLccnIterator.class);
