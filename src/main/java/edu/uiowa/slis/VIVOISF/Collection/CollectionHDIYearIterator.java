...
public class CollectionHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHDIYearIterator.class);
