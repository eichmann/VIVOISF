...
public class CollectionGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionGDPYearIterator.class);
