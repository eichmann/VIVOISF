...
public class CollectionNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameOfficialITIterator.class);
