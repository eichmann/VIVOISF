...
public class CollectionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHDINotesIterator.class);
