...
public class CollectionAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionAsinIterator.class);
