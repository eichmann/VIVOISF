...
public class CollectionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCodeFAOSTATIterator.class);
