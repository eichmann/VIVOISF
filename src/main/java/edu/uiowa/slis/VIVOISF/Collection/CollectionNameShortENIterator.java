...
public class CollectionNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameShortENIterator.class);
