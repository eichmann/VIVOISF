...
public class CollectionLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionLandAreaUnitIterator.class);
