...
public class CollectionNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameOfficialZHIterator.class);
