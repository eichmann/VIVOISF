...
public class CollectionNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameListRUIterator.class);
