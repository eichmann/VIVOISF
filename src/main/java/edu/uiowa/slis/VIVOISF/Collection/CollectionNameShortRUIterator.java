...
public class CollectionNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameShortRUIterator.class);
