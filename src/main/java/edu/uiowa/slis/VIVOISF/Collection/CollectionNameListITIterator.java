...
public class CollectionNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameListITIterator.class);
