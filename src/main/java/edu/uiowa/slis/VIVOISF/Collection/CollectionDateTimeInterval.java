...
public class CollectionDateTimeInterval extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionDateTimeInterval currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionDateTimeInterval.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionDateTimeIntervalIterator.getDateTimeInterval());
		} catch (Exception e) {
