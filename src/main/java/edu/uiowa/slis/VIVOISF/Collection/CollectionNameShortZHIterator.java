...
public class CollectionNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameShortZHIterator.class);
