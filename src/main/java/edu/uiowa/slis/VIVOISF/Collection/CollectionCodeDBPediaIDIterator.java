...
public class CollectionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCodeDBPediaIDIterator.class);
