...
public class CollectionTranslator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionTranslator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionTranslator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionTranslatorIterator.getTranslator());
		} catch (Exception e) {
