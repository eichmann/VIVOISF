...
public class CollectionNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameShortESIterator.class);
