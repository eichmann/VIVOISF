...
public class CollectionNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameShortARIterator.class);
