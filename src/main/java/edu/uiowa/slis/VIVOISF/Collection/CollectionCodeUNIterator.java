...
public class CollectionCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCodeUNIterator.class);
