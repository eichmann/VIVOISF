...
public class CollectionHasEmailType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionHasEmailType currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasEmailType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionHasEmailIterator.getType());
		} catch (Exception e) {
