...
public class CollectionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCodeAGROVOCIterator.class);
