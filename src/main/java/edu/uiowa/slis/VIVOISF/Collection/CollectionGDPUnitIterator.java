...
public class CollectionGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionGDPUnitIterator.class);
