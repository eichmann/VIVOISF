...
public class CollectionNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameListESIterator.class);
