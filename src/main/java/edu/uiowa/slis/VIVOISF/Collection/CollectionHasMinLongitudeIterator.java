...
public class CollectionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasMinLongitudeIterator.class);
