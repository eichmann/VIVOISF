...
public class CollectionNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNationalityRUIterator.class);
