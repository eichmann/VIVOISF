...
public class CollectionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionLandAreaTotalIterator.class);
