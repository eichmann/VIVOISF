...
public class CollectionCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCountryAreaTotalIterator.class);
