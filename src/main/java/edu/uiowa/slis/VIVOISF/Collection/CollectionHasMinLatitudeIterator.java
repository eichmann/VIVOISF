...
public class CollectionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHasMinLatitudeIterator.class);
