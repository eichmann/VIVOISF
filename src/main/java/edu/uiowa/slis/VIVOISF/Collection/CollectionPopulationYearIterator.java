...
public class CollectionPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionPopulationYearIterator.class);
