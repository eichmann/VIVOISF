...
public class CollectionCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCodeISO3Iterator.class);
