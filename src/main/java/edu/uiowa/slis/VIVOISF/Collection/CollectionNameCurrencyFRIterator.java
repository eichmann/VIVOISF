...
public class CollectionNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameCurrencyFRIterator.class);
