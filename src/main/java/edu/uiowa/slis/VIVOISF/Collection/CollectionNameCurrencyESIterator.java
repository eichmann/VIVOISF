...
public class CollectionNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionNameCurrencyESIterator.class);
