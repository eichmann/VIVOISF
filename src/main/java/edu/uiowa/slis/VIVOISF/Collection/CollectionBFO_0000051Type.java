...
public class CollectionBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectionBFO_0000051Iterator.getType());
		} catch (Exception e) {
