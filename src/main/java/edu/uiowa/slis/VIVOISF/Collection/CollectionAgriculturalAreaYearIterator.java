...
public class CollectionAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionAgriculturalAreaYearIterator.class);
