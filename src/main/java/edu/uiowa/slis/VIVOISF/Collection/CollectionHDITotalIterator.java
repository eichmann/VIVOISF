...
public class CollectionHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionHDITotalIterator.class);
