...
public class CollectionCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectionCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectionCountryAreaUnitIterator.class);
