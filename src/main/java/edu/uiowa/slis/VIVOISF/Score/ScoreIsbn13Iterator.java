...
public class ScoreIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreIsbn13Iterator.class);
