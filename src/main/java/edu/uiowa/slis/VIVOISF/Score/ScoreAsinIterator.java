...
public class ScoreAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreAsinIterator.class);
