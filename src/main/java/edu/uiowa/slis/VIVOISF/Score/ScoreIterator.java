...
public class ScoreIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Score> . "+
