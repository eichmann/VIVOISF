...
public class ScoreARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreARG_0000001Iterator.class);
