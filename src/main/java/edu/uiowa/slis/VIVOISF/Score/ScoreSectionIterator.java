...
public class ScoreSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreSectionIterator.class);
