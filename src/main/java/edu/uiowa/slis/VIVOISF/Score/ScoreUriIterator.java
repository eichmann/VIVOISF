...
public class ScoreUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreUriIterator.class);
