...
public class ScoreERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreERO_0000045Iterator.class);
