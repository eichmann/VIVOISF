...
public class ScoreTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreTheAbstractIterator.class);
