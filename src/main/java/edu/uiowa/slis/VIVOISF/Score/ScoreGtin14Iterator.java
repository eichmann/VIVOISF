...
public class ScoreGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreGtin14Iterator.class);
