...
public class ScoreIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theScoreIAO_0000136Iterator.getType());
		} catch (Exception e) {
