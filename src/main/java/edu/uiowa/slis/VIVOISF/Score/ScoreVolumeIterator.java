...
public class ScoreVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreVolumeIterator.class);
