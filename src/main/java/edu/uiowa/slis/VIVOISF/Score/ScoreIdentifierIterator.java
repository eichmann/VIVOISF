...
public class ScoreIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreIdentifierIterator.class);
