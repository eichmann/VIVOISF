...
public class ScoreSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreSiciIterator.class);
