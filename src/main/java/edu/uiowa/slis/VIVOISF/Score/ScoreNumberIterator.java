...
public class ScoreNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreNumberIterator.class);
