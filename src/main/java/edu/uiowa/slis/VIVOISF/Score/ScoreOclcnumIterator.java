...
public class ScoreOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreOclcnumIterator.class);
