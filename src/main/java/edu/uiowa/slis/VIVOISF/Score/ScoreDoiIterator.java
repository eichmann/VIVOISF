...
public class ScoreDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreDoiIterator.class);
