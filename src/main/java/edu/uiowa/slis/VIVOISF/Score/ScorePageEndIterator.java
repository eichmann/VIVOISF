...
public class ScorePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScorePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScorePageEndIterator.class);
