...
public class ScorePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScorePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScorePagesIterator.class);
