...
public class ScorePresentedAt extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScorePresentedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(ScorePresentedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theScorePresentedAtIterator.getPresentedAt());
		} catch (Exception e) {
