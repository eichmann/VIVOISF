...
public class ScoreEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreEanucc13Iterator.class);
