...
public class ScorePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScorePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScorePageStartIterator.class);
