...
public class ScoreCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreCodenIterator.class);
