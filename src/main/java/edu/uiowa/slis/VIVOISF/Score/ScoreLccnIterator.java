...
public class ScoreLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreLccnIterator.class);
