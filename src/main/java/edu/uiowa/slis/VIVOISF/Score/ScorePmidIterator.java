...
public class ScorePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScorePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScorePmidIterator.class);
