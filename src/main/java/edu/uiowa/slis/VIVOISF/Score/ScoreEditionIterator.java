...
public class ScoreEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreEditionIterator.class);
