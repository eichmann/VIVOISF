...
public class ScoreShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreShortDescriptionIterator.class);
