...
public class ScoreUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreUpcIterator.class);
