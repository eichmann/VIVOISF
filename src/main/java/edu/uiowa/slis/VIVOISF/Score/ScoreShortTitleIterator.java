...
public class ScoreShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreShortTitleIterator.class);
