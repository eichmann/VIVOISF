...
public class ScoreHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreHandleIterator.class);
