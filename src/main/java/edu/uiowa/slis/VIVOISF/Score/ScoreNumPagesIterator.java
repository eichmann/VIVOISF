...
public class ScoreNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScoreNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScoreNumPagesIterator.class);
