...
public class OBI_0000017RO_0000052 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000017RO_0000052 currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000017RO_0000052.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000017RO_0000052Iterator.getRO_0000052());
		} catch (Exception e) {
