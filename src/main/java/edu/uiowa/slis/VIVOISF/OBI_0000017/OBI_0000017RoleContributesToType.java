...
public class OBI_0000017RoleContributesToType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000017RoleContributesToType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000017RoleContributesToType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000017RoleContributesToIterator.getType());
		} catch (Exception e) {
