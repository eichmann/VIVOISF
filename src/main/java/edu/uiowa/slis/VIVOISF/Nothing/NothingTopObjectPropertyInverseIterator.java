...
public class NothingTopObjectPropertyInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NothingTopObjectPropertyInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NothingTopObjectPropertyInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NothingTopObjectPropertyInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NothingTopObjectPropertyInverseIterator doStartTag");
		}
