...
public class non_self_governingCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingCodeUNIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#codeUN> ?s } ");
			if(rs.hasNext()) {
