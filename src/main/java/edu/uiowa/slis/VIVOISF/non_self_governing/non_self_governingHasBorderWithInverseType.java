...
public class non_self_governingHasBorderWithInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasBorderWithInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasBorderWithInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingHasBorderWithInverseIterator.getType());
		} catch (Exception e) {
