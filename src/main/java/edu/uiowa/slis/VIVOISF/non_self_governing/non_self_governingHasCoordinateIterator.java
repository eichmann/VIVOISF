...
public class non_self_governingHasCoordinateIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasCoordinateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasCoordinateIterator.class);
