...
public class non_self_governingHasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingHasSubjectAreaIterator.getType());
		} catch (Exception e) {
