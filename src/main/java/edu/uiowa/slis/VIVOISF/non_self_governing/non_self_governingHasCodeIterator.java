...
public class non_self_governingHasCodeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasCodeIterator.class);
