...
public class non_self_governingRO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingRO_0001025 currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingRO_0001025.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingRO_0001025Iterator.getRO_0001025());
		} catch (Exception e) {
