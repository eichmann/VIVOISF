...
public class non_self_governingPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingPopulationYearIterator.class);
