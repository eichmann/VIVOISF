...
public class non_self_governingNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingNameShortENIterator.class);
