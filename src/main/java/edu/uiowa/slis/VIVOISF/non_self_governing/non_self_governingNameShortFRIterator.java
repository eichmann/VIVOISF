...
public class non_self_governingNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingNameShortFRIterator.class);
