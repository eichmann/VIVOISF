...
public class non_self_governingHasBorderWithInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasBorderWithInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasBorderWithInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in non_self_governingHasBorderWithInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in non_self_governingHasBorderWithInverseIterator doStartTag");
		}
