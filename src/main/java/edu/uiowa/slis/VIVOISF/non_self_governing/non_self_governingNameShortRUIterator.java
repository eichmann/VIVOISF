...
public class non_self_governingNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingNameShortRUIterator.class);
