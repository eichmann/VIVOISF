...
public class non_self_governingTopObjectPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingTopObjectPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingTopObjectPropertyIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in non_self_governingTopObjectPropertyIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in non_self_governingTopObjectPropertyIterator doStartTag");
		}
