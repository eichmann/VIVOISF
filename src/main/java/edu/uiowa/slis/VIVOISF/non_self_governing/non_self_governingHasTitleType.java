...
public class non_self_governingHasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingHasTitleIterator.getType());
		} catch (Exception e) {
