...
public class non_self_governingCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingCodeFAOSTATIterator.class);
