...
public class non_self_governingHasPublicationVenue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasPublicationVenue currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasPublicationVenue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingHasPublicationVenueIterator.getHasPublicationVenue());
		} catch (Exception e) {
