...
public class non_self_governingNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingNameListESIterator.class);
