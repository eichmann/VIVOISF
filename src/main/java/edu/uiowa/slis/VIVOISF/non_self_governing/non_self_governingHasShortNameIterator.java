...
public class non_self_governingHasShortNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasShortNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasShortNameIterator.class);
