...
public class non_self_governingNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingNationalityITIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#nationalityIT> ?s } ");
			if(rs.hasNext()) {
