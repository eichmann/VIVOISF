...
public class non_self_governingSourceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingSourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingSourceIterator.class);
