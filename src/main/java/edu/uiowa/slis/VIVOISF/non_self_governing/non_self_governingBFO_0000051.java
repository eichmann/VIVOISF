...
public class non_self_governingBFO_0000051 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingBFO_0000051 currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingBFO_0000051.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingBFO_0000051Iterator.getBFO_0000051());
		} catch (Exception e) {
