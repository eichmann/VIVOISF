...
public class non_self_governingHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasMinLongitudeIterator.class);
