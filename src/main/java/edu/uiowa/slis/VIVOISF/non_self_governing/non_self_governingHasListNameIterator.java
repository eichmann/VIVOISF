...
public class non_self_governingHasListNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasListNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasListNameIterator.class);
