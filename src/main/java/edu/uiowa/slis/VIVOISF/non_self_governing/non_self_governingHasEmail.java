...
public class non_self_governingHasEmail extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasEmail currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasEmail.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingHasEmailIterator.getHasEmail());
		} catch (Exception e) {
