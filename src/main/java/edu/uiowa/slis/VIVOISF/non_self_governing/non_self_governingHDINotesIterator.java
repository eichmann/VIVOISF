...
public class non_self_governingHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHDINotesIterator.class);
