...
public class non_self_governingDateTimeInterval extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingDateTimeInterval currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingDateTimeInterval.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingDateTimeIntervalIterator.getDateTimeInterval());
		} catch (Exception e) {
