...
public class non_self_governingLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingLandAreaYearIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#landAreaYear> ?s } ");
			if(rs.hasNext()) {
