...
public class non_self_governingValidInInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingValidInInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingValidInInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingValidInInverseIterator.getValidInInverse());
		} catch (Exception e) {
