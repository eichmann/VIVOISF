...
public class non_self_governingUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingUrlIterator.class);
