...
public class non_self_governingTopDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingTopDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingTopDataPropertyIterator.class);
