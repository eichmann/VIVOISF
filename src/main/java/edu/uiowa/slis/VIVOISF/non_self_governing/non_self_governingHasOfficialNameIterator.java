...
public class non_self_governingHasOfficialNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasOfficialNameIterator.class);
