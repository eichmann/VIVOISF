...
public class non_self_governingHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHDIYearIterator.class);
