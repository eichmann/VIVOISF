...
public class non_self_governingMiddleNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingMiddleNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingMiddleNameIterator.class);
