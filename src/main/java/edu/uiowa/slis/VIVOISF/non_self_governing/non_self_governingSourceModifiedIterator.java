...
public class non_self_governingSourceModifiedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingSourceModifiedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingSourceModifiedIterator.class);
