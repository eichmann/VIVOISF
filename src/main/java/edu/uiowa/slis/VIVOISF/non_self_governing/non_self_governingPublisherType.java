...
public class non_self_governingPublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingPublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingPublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingPublisherIterator.getType());
		} catch (Exception e) {
