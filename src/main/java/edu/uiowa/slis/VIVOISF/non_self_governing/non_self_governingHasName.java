...
public class non_self_governingHasName extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasName currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasName.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingHasNameIterator.getHasName());
		} catch (Exception e) {
