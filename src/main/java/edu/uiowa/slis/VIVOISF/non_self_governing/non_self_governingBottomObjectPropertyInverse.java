...
public class non_self_governingBottomObjectPropertyInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingBottomObjectPropertyInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingBottomObjectPropertyInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingBottomObjectPropertyInverseIterator.getBottomObjectPropertyInverse());
		} catch (Exception e) {
