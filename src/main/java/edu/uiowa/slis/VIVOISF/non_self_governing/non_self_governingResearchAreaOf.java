...
public class non_self_governingResearchAreaOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingResearchAreaOf currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingResearchAreaOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingResearchAreaOfIterator.getResearchAreaOf());
		} catch (Exception e) {
