...
public class non_self_governingOrcidIdInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingOrcidIdInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingOrcidIdInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingOrcidIdInverseIterator.getOrcidIdInverse());
		} catch (Exception e) {
