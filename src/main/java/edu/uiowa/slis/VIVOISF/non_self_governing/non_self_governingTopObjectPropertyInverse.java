...
public class non_self_governingTopObjectPropertyInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingTopObjectPropertyInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingTopObjectPropertyInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingTopObjectPropertyInverseIterator.getTopObjectPropertyInverse());
		} catch (Exception e) {
