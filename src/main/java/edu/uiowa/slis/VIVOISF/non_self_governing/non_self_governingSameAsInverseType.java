...
public class non_self_governingSameAsInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingSameAsInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingSameAsInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingSameAsInverseIterator.getType());
		} catch (Exception e) {
