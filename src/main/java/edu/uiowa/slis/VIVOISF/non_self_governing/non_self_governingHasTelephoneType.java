...
public class non_self_governingHasTelephoneType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasTelephoneType currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasTelephoneType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingHasTelephoneIterator.getType());
		} catch (Exception e) {
