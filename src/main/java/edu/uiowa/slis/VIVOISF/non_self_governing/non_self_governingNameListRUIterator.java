...
public class non_self_governingNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingNameListRUIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#nameListRU> ?s } ");
			if(rs.hasNext()) {
