...
public class non_self_governingHasCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasCurrencyIterator.class);
