...
public class non_self_governingSubjectAreaOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingSubjectAreaOf currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingSubjectAreaOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingSubjectAreaOfIterator.getSubjectAreaOf());
		} catch (Exception e) {
