...
public class non_self_governingSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingSameAsIterator.class);
