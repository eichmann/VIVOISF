...
public class non_self_governingHasURL extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasURL currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasURL.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingHasURLIterator.getHasURL());
		} catch (Exception e) {
