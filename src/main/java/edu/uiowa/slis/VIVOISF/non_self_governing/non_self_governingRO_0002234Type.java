...
public class non_self_governingRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingRO_0002234Iterator.getType());
		} catch (Exception e) {
