...
public class non_self_governingHasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingHasResearchAreaIterator.getType());
		} catch (Exception e) {
