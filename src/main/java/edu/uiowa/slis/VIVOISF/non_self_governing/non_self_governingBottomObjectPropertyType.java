...
public class non_self_governingBottomObjectPropertyType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingBottomObjectPropertyType currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingBottomObjectPropertyType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingBottomObjectPropertyIterator.getType());
		} catch (Exception e) {
