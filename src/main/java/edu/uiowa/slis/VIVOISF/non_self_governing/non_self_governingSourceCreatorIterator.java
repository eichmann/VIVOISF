...
public class non_self_governingSourceCreatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingSourceCreatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingSourceCreatorIterator.class);
