...
public class non_self_governingRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingRankIterator.class);
