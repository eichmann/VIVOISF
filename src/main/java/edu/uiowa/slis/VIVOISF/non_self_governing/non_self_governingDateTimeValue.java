...
public class non_self_governingDateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingDateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingDateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingDateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
