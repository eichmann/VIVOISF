...
public class non_self_governingPublicationVenueForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingPublicationVenueForType currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingPublicationVenueForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingPublicationVenueForIterator.getType());
		} catch (Exception e) {
