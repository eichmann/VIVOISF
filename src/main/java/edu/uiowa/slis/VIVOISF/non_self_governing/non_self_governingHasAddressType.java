...
public class non_self_governingHasAddressType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHasAddressType currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHasAddressType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thenon_self_governingHasAddressIterator.getType());
		} catch (Exception e) {
