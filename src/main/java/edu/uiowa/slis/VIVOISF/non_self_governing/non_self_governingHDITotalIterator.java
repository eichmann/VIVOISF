...
public class non_self_governingHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static non_self_governingHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(non_self_governingHDITotalIterator.class);
