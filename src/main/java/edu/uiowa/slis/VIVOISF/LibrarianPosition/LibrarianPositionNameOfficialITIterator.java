...
public class LibrarianPositionNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameOfficialITIterator.class);
