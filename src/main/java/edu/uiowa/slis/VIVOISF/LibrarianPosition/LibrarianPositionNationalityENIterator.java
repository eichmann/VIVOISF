...
public class LibrarianPositionNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNationalityENIterator.class);
