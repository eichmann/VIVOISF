...
public class LibrarianPositionPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionPopulationUnitIterator.class);
