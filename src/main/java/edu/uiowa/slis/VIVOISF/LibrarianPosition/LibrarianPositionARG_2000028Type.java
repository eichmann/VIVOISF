...
public class LibrarianPositionARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianPositionARG_2000028Iterator.getType());
		} catch (Exception e) {
