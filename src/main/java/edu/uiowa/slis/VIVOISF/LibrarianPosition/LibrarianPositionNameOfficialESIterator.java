...
public class LibrarianPositionNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameOfficialESIterator.class);
