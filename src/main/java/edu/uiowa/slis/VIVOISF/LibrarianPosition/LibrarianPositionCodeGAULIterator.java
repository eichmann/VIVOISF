...
public class LibrarianPositionCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCodeGAULIterator.class);
