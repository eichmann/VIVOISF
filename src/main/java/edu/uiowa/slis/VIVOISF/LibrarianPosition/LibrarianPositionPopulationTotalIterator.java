...
public class LibrarianPositionPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionPopulationTotalIterator.class);
