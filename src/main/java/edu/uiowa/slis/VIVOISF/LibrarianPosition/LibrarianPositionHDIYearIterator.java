...
public class LibrarianPositionHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionHDIYearIterator.class);
