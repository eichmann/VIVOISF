...
public class LibrarianPositionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionLandAreaTotalIterator.class);
