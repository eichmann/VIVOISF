...
public class LibrarianPositionCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCountryAreaYearIterator.class);
