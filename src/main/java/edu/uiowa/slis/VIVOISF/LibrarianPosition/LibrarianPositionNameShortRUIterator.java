...
public class LibrarianPositionNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameShortRUIterator.class);
