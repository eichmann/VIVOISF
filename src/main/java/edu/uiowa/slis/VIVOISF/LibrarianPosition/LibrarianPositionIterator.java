...
public class LibrarianPositionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#LibrarianPosition> . "+
