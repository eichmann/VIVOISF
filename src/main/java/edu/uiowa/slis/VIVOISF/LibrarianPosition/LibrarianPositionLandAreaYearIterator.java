...
public class LibrarianPositionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionLandAreaYearIterator.class);
