...
public class LibrarianPositionGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionGDPUnitIterator.class);
