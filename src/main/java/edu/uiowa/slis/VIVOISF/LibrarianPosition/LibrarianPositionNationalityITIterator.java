...
public class LibrarianPositionNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNationalityITIterator.class);
