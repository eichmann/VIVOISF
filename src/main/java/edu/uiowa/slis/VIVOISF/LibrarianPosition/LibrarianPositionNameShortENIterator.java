...
public class LibrarianPositionNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameShortENIterator.class);
