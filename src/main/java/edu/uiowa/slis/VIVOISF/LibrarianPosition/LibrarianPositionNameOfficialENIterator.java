...
public class LibrarianPositionNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameOfficialENIterator.class);
