...
public class LibrarianPositionCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCodeUNIterator.class);
