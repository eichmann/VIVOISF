...
public class LibrarianPositionPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionPopulationYearIterator.class);
