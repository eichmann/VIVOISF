...
public class LibrarianPositionHasURL extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionHasURL currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionHasURL.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianPositionHasURLIterator.getHasURL());
		} catch (Exception e) {
