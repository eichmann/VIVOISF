...
public class LibrarianPositionLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionLandAreaUnitIterator.class);
