...
public class LibrarianPositionNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameListARIterator.class);
