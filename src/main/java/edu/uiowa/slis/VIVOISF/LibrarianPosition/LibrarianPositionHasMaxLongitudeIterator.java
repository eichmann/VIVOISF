...
public class LibrarianPositionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionHasMaxLongitudeIterator.class);
