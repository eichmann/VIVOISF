...
public class LibrarianPositionCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCodeISO3Iterator.class);
