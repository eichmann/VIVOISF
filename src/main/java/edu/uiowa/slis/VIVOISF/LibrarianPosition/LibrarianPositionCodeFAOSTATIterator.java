...
public class LibrarianPositionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCodeFAOSTATIterator.class);
