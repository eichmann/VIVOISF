...
public class LibrarianPositionNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameCurrencyESIterator.class);
