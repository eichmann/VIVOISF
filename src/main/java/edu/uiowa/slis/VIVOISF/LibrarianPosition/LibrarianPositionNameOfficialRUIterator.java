...
public class LibrarianPositionNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameOfficialRUIterator.class);
