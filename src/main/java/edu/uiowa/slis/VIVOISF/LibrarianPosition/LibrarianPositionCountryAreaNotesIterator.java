...
public class LibrarianPositionCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCountryAreaNotesIterator.class);
