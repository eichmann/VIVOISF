...
public class LibrarianPositionNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameShortARIterator.class);
