...
public class LibrarianPositionNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameOfficialFRIterator.class);
