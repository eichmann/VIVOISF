...
public class LibrarianPositionNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameShortITIterator.class);
