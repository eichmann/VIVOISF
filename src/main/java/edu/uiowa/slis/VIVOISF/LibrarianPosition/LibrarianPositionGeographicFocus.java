...
public class LibrarianPositionGeographicFocus extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionGeographicFocus currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionGeographicFocus.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianPositionGeographicFocusIterator.getGeographicFocus());
		} catch (Exception e) {
