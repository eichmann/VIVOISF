...
public class LibrarianPositionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCodeAGROVOCIterator.class);
