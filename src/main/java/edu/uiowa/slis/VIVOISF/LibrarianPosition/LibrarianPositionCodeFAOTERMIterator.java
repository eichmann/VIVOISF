...
public class LibrarianPositionCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCodeFAOTERMIterator.class);
