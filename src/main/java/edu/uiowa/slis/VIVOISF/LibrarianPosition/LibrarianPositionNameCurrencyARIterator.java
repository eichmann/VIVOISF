...
public class LibrarianPositionNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameCurrencyARIterator.class);
