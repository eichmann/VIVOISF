...
public class LibrarianPositionNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameListESIterator.class);
