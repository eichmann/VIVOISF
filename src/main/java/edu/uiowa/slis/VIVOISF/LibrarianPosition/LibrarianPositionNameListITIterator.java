...
public class LibrarianPositionNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameListITIterator.class);
