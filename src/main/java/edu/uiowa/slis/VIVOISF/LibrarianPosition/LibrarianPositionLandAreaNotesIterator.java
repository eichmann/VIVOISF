...
public class LibrarianPositionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionLandAreaNotesIterator.class);
