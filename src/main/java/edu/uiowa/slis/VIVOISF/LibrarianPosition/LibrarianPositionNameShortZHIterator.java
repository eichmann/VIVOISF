...
public class LibrarianPositionNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameShortZHIterator.class);
