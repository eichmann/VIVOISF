...
public class LibrarianPositionNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNationalityESIterator.class);
