...
public class LibrarianPositionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCodeDBPediaIDIterator.class);
