...
public class LibrarianPositionNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameCurrencyZHIterator.class);
