...
public class LibrarianPositionRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionRankIterator.class);
