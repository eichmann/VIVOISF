...
public class LibrarianPositionBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianPositionBFO_0000050Iterator.getType());
		} catch (Exception e) {
