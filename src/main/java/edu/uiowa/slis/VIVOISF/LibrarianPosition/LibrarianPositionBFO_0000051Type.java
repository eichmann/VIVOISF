...
public class LibrarianPositionBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianPositionBFO_0000051Iterator.getType());
		} catch (Exception e) {
