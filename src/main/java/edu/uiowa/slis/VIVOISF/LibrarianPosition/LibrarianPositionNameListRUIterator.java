...
public class LibrarianPositionNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameListRUIterator.class);
