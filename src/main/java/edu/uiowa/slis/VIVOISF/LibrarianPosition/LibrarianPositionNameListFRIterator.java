...
public class LibrarianPositionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameListFRIterator.class);
