...
public class LibrarianPositionNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameOfficialARIterator.class);
