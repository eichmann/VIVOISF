...
public class LibrarianPositionRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianPositionRO_0001015Iterator.getType());
		} catch (Exception e) {
