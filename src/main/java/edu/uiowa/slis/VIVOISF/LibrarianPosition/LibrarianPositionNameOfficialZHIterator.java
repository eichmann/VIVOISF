...
public class LibrarianPositionNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameOfficialZHIterator.class);
