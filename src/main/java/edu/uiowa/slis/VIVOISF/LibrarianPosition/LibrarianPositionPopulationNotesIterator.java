...
public class LibrarianPositionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionPopulationNotesIterator.class);
