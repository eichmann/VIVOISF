...
public class LibrarianPositionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionHasMinLatitudeIterator.class);
