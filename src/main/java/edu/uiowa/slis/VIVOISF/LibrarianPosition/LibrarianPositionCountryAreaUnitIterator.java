...
public class LibrarianPositionCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCountryAreaUnitIterator.class);
