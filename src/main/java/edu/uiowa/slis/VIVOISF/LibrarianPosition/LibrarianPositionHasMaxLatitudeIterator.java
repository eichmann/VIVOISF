...
public class LibrarianPositionHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionHasMaxLatitudeIterator.class);
