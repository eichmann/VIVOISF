...
public class LibrarianPositionNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNationalityRUIterator.class);
