...
public class LibrarianPositionCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCodeISO2Iterator.class);
