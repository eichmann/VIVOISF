...
public class LibrarianPositionCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionCodeUNDPIterator.class);
