...
public class LibrarianPositionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionHDINotesIterator.class);
