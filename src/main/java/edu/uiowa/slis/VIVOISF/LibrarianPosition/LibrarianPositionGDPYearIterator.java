...
public class LibrarianPositionGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionGDPYearIterator.class);
