...
public class LibrarianPositionNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameListZHIterator.class);
