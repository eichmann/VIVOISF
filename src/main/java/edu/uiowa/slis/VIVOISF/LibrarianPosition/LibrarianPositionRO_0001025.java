...
public class LibrarianPositionRO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionRO_0001025 currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionRO_0001025.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianPositionRO_0001025Iterator.getRO_0001025());
		} catch (Exception e) {
