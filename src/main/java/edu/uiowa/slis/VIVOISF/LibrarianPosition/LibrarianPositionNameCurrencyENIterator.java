...
public class LibrarianPositionNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameCurrencyENIterator.class);
