...
public class LibrarianPositionUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionUrlIterator.class);
