...
public class LibrarianPositionGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionGDPTotalInCurrentPricesIterator.class);
