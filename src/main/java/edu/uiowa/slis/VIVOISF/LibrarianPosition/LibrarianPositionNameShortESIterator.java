...
public class LibrarianPositionNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNameShortESIterator.class);
