...
public class LibrarianPositionHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionHDITotalIterator.class);
