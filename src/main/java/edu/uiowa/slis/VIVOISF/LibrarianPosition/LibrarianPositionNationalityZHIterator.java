...
public class LibrarianPositionNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionNationalityZHIterator.class);
