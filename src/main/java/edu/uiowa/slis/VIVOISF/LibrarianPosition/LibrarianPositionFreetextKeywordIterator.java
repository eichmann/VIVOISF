...
public class LibrarianPositionFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionFreetextKeywordIterator.class);
