...
public class LibrarianPositionHrJobTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPositionHrJobTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPositionHrJobTitleIterator.class);
