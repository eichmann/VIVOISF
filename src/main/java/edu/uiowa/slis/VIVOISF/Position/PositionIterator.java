...
public class PositionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Position> . "+
