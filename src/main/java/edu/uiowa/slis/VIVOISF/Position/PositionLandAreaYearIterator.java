...
public class PositionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionLandAreaYearIterator.class);
