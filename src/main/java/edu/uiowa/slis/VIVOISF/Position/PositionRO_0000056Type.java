...
public class PositionRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePositionRO_0000056Iterator.getType());
		} catch (Exception e) {
