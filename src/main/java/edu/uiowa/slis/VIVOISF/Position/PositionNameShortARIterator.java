...
public class PositionNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameShortARIterator.class);
