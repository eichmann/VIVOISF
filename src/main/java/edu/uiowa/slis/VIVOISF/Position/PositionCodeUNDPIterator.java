...
public class PositionCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCodeUNDPIterator.class);
