...
public class PositionNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNationalityFRIterator.class);
