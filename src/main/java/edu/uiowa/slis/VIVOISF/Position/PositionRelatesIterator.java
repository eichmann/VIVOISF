...
public class PositionRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in PositionRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PositionRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in PositionRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PositionRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PositionRelates doEndTag", e);
			throw new JspTagException("Exception raised in PositionRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to PositionRelatesIterator");
