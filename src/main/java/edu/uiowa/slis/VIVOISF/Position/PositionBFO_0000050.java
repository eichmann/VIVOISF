...
public class PositionBFO_0000050 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionBFO_0000050 currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionBFO_0000050.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePositionBFO_0000050Iterator.getBFO_0000050());
		} catch (Exception e) {
