...
public class PositionCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCountryAreaYearIterator.class);
