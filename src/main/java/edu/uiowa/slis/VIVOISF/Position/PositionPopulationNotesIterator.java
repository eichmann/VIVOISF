...
public class PositionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionPopulationNotesIterator.class);
