...
public class PositionNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameOfficialFRIterator.class);
