...
public class PositionCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCodeGAULIterator.class);
