...
public class PositionPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionPopulationYearIterator.class);
