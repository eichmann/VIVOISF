...
public class PositionNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameShortZHIterator.class);
