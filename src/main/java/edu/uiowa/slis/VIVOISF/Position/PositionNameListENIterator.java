...
public class PositionNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameListENIterator.class);
