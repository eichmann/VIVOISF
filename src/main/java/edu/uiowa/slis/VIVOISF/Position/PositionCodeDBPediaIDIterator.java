...
public class PositionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCodeDBPediaIDIterator.class);
