...
public class PositionPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionPopulationTotalIterator.class);
