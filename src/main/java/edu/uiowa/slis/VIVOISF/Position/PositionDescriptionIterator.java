...
public class PositionDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionDescriptionIterator.class);
