...
public class PositionNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameListRUIterator.class);
