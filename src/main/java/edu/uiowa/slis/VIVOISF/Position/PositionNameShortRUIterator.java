...
public class PositionNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameShortRUIterator.class);
