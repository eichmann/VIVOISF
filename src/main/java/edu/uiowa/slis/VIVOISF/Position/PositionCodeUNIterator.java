...
public class PositionCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCodeUNIterator.class);
