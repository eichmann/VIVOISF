...
public class PositionAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionAgriculturalAreaUnitIterator.class);
