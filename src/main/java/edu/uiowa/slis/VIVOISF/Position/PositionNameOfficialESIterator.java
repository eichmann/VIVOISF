...
public class PositionNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameOfficialESIterator.class);
