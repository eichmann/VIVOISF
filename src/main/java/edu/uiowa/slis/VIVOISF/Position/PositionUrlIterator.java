...
public class PositionUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionUrlIterator.class);
