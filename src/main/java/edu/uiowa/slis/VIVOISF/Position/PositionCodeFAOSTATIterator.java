...
public class PositionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCodeFAOSTATIterator.class);
