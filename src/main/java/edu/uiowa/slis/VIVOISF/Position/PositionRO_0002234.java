...
public class PositionRO_0002234 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionRO_0002234 currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionRO_0002234.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePositionRO_0002234Iterator.getRO_0002234());
		} catch (Exception e) {
