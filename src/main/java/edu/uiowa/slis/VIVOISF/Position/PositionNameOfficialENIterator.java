...
public class PositionNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameOfficialENIterator.class);
