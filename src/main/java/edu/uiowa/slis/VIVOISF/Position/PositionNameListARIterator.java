...
public class PositionNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameListARIterator.class);
