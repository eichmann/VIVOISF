...
public class PositionNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameShortESIterator.class);
