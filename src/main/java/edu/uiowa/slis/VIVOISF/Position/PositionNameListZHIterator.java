...
public class PositionNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameListZHIterator.class);
