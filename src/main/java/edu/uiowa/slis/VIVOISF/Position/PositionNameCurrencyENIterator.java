...
public class PositionNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameCurrencyENIterator.class);
