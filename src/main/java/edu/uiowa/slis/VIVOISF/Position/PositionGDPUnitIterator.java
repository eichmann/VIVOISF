...
public class PositionGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionGDPUnitIterator.class);
