...
public class PositionNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNationalityENIterator.class);
