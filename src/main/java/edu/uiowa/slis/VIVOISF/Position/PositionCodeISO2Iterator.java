...
public class PositionCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCodeISO2Iterator.class);
