...
public class PositionCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCodeISO3Iterator.class);
