...
public class PositionRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionRankIterator.class);
