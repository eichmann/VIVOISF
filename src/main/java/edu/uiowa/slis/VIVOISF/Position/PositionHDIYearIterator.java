...
public class PositionHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionHDIYearIterator.class);
