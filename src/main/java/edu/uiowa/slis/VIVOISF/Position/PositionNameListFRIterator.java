...
public class PositionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameListFRIterator.class);
