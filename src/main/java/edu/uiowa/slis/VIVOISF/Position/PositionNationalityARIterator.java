...
public class PositionNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNationalityARIterator.class);
