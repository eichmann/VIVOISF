...
public class PositionRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePositionRO_0001015Iterator.getType());
		} catch (Exception e) {
