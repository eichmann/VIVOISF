...
public class PositionCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCodeFAOTERMIterator.class);
