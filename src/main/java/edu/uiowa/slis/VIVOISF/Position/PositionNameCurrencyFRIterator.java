...
public class PositionNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameCurrencyFRIterator.class);
