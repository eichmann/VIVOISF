...
public class PositionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionHDINotesIterator.class);
