...
public class PositionNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNationalityZHIterator.class);
