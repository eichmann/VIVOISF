...
public class PositionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionLandAreaTotalIterator.class);
