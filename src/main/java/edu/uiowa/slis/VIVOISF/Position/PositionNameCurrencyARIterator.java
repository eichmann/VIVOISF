...
public class PositionNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameCurrencyARIterator.class);
