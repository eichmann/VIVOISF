...
public class PositionNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameListITIterator.class);
