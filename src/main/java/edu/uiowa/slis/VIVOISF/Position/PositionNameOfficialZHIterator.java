...
public class PositionNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameOfficialZHIterator.class);
