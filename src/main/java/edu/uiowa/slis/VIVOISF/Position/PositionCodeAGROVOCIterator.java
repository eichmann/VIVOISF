...
public class PositionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCodeAGROVOCIterator.class);
