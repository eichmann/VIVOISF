...
public class PositionNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameCurrencyRUIterator.class);
