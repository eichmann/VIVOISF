...
public class PositionNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameCurrencyESIterator.class);
