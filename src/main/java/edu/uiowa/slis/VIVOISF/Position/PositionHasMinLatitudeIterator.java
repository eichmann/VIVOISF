...
public class PositionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionHasMinLatitudeIterator.class);
