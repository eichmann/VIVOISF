...
public class PositionNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameShortITIterator.class);
