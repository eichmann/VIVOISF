...
public class PositionNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameCurrencyITIterator.class);
