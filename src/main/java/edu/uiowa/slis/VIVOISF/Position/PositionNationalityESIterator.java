...
public class PositionNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNationalityESIterator.class);
