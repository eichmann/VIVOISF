...
public class PositionHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionHasMaxLatitudeIterator.class);
