...
public class PositionGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionGDPYearIterator.class);
