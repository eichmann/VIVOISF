...
public class PositionNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNationalityRUIterator.class);
