...
public class PositionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionHasMaxLongitudeIterator.class);
