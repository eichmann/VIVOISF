...
public class PositionPublisher extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionPublisher currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionPublisher.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePositionPublisherIterator.getPublisher());
		} catch (Exception e) {
