...
public class PositionCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionCodeCurrencyIterator.class);
