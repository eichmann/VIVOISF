...
public class PositionPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionPopulationUnitIterator.class);
