...
public class PositionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionHasMinLongitudeIterator.class);
