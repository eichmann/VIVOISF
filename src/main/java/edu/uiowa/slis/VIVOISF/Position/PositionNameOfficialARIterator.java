...
public class PositionNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameOfficialARIterator.class);
