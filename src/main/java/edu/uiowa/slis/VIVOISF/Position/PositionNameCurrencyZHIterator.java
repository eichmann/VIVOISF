...
public class PositionNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameCurrencyZHIterator.class);
