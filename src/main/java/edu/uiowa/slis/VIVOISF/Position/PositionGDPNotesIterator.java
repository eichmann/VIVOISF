...
public class PositionGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionGDPNotesIterator.class);
