...
public class PositionNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNameListESIterator.class);
