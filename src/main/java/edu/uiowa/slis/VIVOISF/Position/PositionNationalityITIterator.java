...
public class PositionNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionNationalityITIterator.class);
