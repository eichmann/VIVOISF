...
public class PositionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PositionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PositionLandAreaNotesIterator.class);
