...
public class IAO_0000003NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameListZHIterator.class);
