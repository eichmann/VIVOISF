...
public class IAO_0000003UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003UrlIterator.class);
