...
public class IAO_0000003HDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003HDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003HDINotesIterator.class);
