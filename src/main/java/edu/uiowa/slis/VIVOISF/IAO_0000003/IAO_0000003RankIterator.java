...
public class IAO_0000003RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003RankIterator.class);
