...
public class IAO_0000003HasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003HasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003HasMinLongitudeIterator.class);
