...
public class IAO_0000003LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003LandAreaYearIterator.class);
