...
public class IAO_0000003RO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003RO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003RO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003RO_0001015Iterator.getType());
		} catch (Exception e) {
