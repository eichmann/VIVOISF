...
public class IAO_0000003Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003TranslatorIterator.getTranslator());
		} catch (Exception e) {
