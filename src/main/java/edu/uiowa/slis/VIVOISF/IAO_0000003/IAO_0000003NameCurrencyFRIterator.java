...
public class IAO_0000003NameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameCurrencyFRIterator.class);
