...
public class IAO_0000003NationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NationalityESIterator.class);
