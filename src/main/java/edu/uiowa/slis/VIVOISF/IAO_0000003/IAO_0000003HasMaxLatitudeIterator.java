...
public class IAO_0000003HasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003HasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003HasMaxLatitudeIterator.class);
