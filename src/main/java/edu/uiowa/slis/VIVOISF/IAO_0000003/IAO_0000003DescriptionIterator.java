...
public class IAO_0000003DescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003DescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003DescriptionIterator.class);
