...
public class IAO_0000003HDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003HDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003HDIYearIterator.class);
