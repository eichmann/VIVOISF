...
public class IAO_0000003PublicationVenueFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003PublicationVenueFor currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003PublicationVenueFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003PublicationVenueForIterator.getPublicationVenueFor());
		} catch (Exception e) {
