...
public class IAO_0000003NameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameListFRIterator.class);
