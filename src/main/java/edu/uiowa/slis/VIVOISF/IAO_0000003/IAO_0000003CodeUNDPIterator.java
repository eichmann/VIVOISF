...
public class IAO_0000003CodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003CodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003CodeUNDPIterator.class);
