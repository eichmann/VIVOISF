...
public class IAO_0000003CodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003CodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003CodeGAULIterator.class);
