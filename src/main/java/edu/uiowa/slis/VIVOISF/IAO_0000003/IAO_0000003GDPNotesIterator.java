...
public class IAO_0000003GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003GDPNotesIterator.class);
