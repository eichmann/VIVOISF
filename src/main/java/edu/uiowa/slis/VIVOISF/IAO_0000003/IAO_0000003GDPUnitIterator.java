...
public class IAO_0000003GDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003GDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003GDPUnitIterator.class);
