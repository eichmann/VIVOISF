...
public class IAO_0000003GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003GDPYearIterator.class);
