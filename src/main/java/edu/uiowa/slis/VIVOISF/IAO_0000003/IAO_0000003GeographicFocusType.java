...
public class IAO_0000003GeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003GeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003GeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003GeographicFocusIterator.getType());
		} catch (Exception e) {
