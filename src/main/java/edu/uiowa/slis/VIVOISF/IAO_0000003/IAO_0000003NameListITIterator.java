...
public class IAO_0000003NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameListITIterator.class);
