...
public class IAO_0000003NationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NationalityZHIterator.class);
