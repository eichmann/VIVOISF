...
public class IAO_0000003LandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003LandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003LandAreaNotesIterator.class);
