...
public class IAO_0000003NameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameCurrencyESIterator.class);
