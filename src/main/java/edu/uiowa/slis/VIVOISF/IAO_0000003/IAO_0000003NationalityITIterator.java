...
public class IAO_0000003NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NationalityITIterator.class);
