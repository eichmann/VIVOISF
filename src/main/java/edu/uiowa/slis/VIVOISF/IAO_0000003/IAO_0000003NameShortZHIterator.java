...
public class IAO_0000003NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameShortZHIterator.class);
