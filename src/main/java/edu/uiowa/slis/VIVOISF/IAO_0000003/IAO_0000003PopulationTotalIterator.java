...
public class IAO_0000003PopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003PopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003PopulationTotalIterator.class);
