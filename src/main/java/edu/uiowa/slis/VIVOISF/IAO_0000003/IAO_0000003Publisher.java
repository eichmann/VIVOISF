...
public class IAO_0000003Publisher extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003Publisher currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003Publisher.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003PublisherIterator.getPublisher());
		} catch (Exception e) {
