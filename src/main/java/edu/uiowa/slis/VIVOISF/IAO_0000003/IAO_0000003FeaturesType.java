...
public class IAO_0000003FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003FeaturesIterator.getType());
		} catch (Exception e) {
