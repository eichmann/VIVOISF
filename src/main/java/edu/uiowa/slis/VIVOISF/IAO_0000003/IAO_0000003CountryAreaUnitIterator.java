...
public class IAO_0000003CountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003CountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003CountryAreaUnitIterator.class);
