...
public class IAO_0000003NameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameShortARIterator.class);
