...
public class IAO_0000003NameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameOfficialZHIterator.class);
