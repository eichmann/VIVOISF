...
public class IAO_0000003NationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NationalityENIterator.class);
