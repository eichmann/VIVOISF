...
public class IAO_0000003 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003 currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			IAO_0000003Iterator theIAO_0000003Iterator = (IAO_0000003Iterator) findAncestorWithClass(this, IAO_0000003Iterator.class);

			if (theIAO_0000003Iterator != null) {
				subjectURI = theIAO_0000003Iterator.getSubjectURI();
				label = theIAO_0000003Iterator.getLabel();
			}

			if (theIAO_0000003Iterator == null && subjectURI == null) {
			...
			log.error("Exception raised in IAO_0000003 doStartTag", e);
			throw new JspTagException("Exception raised in IAO_0000003 doStartTag");
		} finally {
			freeConnection();
		}
