...
public class IAO_0000003HasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003HasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003HasMaxLongitudeIterator.class);
