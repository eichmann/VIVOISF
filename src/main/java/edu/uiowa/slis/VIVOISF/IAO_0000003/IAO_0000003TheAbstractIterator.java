...
public class IAO_0000003TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003TheAbstractIterator.class);
