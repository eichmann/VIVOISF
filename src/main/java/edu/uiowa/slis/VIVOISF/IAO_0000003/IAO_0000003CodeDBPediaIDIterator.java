...
public class IAO_0000003CodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003CodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003CodeDBPediaIDIterator.class);
