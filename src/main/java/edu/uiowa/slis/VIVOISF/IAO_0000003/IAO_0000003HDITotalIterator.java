...
public class IAO_0000003HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003HDITotalIterator.class);
