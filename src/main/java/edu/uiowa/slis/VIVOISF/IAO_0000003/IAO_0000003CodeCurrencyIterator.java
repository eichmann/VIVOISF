...
public class IAO_0000003CodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003CodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003CodeCurrencyIterator.class);
