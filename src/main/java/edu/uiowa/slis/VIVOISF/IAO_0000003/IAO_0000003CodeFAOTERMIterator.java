...
public class IAO_0000003CodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003CodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003CodeFAOTERMIterator.class);
