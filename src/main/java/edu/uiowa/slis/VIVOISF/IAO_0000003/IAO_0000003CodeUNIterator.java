...
public class IAO_0000003CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003CodeUNIterator.class);
