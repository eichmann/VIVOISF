...
public class IAO_0000003NameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameCurrencyENIterator.class);
