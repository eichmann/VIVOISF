...
public class IAO_0000003CodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003CodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003CodeAGROVOCIterator.class);
