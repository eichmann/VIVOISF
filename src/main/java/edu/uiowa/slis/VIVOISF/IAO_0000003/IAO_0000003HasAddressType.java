...
public class IAO_0000003HasAddressType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003HasAddressType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003HasAddressType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003HasAddressIterator.getType());
		} catch (Exception e) {
