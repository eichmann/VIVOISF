...
public class IAO_0000003CountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003CountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003CountryAreaYearIterator.class);
