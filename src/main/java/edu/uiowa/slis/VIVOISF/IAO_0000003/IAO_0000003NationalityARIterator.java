...
public class IAO_0000003NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NationalityARIterator.class);
