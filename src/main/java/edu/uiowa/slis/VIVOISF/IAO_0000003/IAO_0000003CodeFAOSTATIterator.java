...
public class IAO_0000003CodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003CodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003CodeFAOSTATIterator.class);
