...
public class IAO_0000003DateTimeValueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003DateTimeValueType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003DateTimeValueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003DateTimeValueIterator.getType());
		} catch (Exception e) {
