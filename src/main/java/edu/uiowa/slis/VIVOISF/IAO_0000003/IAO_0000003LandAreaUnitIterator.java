...
public class IAO_0000003LandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003LandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003LandAreaUnitIterator.class);
