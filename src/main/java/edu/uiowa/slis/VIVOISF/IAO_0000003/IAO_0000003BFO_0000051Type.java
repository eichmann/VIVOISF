...
public class IAO_0000003BFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003BFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003BFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003BFO_0000051Iterator.getType());
		} catch (Exception e) {
