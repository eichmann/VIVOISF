...
public class IAO_0000003NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameCurrencyARIterator.class);
