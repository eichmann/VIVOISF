...
public class IAO_0000003NameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameOfficialRUIterator.class);
