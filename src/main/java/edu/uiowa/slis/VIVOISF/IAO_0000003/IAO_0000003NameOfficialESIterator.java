...
public class IAO_0000003NameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameOfficialESIterator.class);
