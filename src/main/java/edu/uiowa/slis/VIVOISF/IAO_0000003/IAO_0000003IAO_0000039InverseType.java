...
public class IAO_0000003IAO_0000039InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003IAO_0000039InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003IAO_0000039InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003IAO_0000039InverseIterator.getType());
		} catch (Exception e) {
