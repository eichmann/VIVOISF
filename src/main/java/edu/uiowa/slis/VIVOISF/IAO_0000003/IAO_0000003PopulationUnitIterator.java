...
public class IAO_0000003PopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003PopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003PopulationUnitIterator.class);
