...
public class IAO_0000003PopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003PopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003PopulationYearIterator.class);
