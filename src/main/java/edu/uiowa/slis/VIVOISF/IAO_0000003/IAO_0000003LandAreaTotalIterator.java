...
public class IAO_0000003LandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003LandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003LandAreaTotalIterator.class);
