...
public class IAO_0000003NameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NameCurrencyITIterator.class);
