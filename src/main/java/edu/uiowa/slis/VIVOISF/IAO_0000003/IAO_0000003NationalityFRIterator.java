...
public class IAO_0000003NationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003NationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003NationalityFRIterator.class);
