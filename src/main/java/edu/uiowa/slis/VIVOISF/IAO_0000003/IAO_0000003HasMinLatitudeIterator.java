...
public class IAO_0000003HasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003HasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003HasMinLatitudeIterator.class);
