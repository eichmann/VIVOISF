...
public class IAO_0000003HasPublicationVenue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003HasPublicationVenue currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003HasPublicationVenue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003HasPublicationVenueIterator.getHasPublicationVenue());
		} catch (Exception e) {
