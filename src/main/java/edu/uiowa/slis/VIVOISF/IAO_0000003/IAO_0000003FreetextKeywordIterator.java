...
public class IAO_0000003FreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003FreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003FreetextKeywordIterator.class);
