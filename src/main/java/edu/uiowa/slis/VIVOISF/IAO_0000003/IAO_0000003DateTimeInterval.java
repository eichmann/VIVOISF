...
public class IAO_0000003DateTimeInterval extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000003DateTimeInterval currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000003DateTimeInterval.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000003DateTimeIntervalIterator.getDateTimeInterval());
		} catch (Exception e) {
