...
public class AcademicArticleIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleIsbn13Iterator.class);
