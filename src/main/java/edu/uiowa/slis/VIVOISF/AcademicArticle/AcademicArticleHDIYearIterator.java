...
public class AcademicArticleHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleHDIYearIterator.class);
