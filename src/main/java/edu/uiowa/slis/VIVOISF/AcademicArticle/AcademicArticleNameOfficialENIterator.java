...
public class AcademicArticleNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameOfficialENIterator.class);
