...
public class AcademicArticleContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleContentIterator.class);
