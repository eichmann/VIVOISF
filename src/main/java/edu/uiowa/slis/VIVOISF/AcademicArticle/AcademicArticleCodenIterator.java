...
public class AcademicArticleCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCodenIterator.class);
