...
public class AcademicArticleCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCodeCurrencyIterator.class);
