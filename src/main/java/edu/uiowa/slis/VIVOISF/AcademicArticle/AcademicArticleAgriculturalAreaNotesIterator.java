...
public class AcademicArticleAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleAgriculturalAreaNotesIterator.class);
