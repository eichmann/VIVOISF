...
public class AcademicArticleRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleRankIterator.class);
