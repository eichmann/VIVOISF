...
public class AcademicArticleIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleIdentifierIterator.class);
