...
public class AcademicArticleCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCountryAreaYearIterator.class);
