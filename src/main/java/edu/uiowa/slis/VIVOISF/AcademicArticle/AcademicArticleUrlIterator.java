...
public class AcademicArticleUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleUrlIterator.class);
