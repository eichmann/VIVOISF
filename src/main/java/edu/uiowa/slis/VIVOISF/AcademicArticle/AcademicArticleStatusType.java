...
public class AcademicArticleStatusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleStatusType currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleStatusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicArticleStatusIterator.getType());
		} catch (Exception e) {
