...
public class AcademicArticleLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleLandAreaYearIterator.class);
