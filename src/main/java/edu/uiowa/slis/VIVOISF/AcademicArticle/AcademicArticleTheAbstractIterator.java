...
public class AcademicArticleTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleTheAbstractIterator.class);
