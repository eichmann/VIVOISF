...
public class AcademicArticleHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleHasMaxLongitudeIterator.class);
