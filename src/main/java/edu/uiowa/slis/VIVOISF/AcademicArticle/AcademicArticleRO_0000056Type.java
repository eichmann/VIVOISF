...
public class AcademicArticleRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicArticleRO_0000056Iterator.getType());
		} catch (Exception e) {
