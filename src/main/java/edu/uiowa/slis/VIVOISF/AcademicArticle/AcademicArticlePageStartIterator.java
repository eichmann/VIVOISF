...
public class AcademicArticlePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticlePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticlePageStartIterator.class);
