...
public class AcademicArticleAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleAsinIterator.class);
