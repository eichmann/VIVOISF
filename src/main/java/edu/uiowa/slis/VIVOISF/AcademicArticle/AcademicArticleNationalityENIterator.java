...
public class AcademicArticleNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNationalityENIterator.class);
