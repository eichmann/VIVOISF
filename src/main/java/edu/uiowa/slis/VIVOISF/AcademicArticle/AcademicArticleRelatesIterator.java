...
public class AcademicArticleRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in AcademicArticleRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AcademicArticleRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in AcademicArticleRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AcademicArticleRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in AcademicArticleRelates doEndTag", e);
			throw new JspTagException("Exception raised in AcademicArticleRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to AcademicArticleRelatesIterator");
