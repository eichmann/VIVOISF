...
public class AcademicArticleLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleLandAreaTotalIterator.class);
