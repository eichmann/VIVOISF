...
public class AcademicArticleGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleGDPNotesIterator.class);
