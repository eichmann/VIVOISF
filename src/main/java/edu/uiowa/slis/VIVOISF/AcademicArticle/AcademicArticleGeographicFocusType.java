...
public class AcademicArticleGeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleGeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleGeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicArticleGeographicFocusIterator.getType());
		} catch (Exception e) {
