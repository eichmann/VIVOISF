...
public class AcademicArticleNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNationalityARIterator.class);
