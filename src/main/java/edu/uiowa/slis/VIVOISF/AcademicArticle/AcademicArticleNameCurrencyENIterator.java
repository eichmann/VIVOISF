...
public class AcademicArticleNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameCurrencyENIterator.class);
