...
public class AcademicArticleIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleIsbn10Iterator.class);
