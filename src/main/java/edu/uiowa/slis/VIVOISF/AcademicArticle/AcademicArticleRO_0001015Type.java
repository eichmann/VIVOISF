...
public class AcademicArticleRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicArticleRO_0001015Iterator.getType());
		} catch (Exception e) {
