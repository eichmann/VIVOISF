...
public class AcademicArticlePopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticlePopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticlePopulationTotalIterator.class);
