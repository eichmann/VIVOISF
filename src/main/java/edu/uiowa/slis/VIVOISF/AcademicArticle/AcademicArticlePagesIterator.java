...
public class AcademicArticlePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticlePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticlePagesIterator.class);
