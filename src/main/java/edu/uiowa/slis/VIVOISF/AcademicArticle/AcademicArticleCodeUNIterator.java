...
public class AcademicArticleCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCodeUNIterator.class);
