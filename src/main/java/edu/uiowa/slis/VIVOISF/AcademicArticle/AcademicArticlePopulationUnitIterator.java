...
public class AcademicArticlePopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticlePopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticlePopulationUnitIterator.class);
