...
public class AcademicArticleRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicArticleRO_0002234Iterator.getType());
		} catch (Exception e) {
