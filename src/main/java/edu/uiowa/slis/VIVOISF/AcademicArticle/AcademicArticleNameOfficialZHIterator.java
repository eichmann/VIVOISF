...
public class AcademicArticleNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameOfficialZHIterator.class);
