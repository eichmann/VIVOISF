...
public class AcademicArticleDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleDescriptionIterator.class);
