...
public class AcademicArticleLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleLandAreaNotesIterator.class);
