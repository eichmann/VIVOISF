...
public class AcademicArticleBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicArticleBFO_0000051Iterator.getType());
		} catch (Exception e) {
