...
public class AcademicArticleNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNumPagesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://purl.org/ontology/bibo/numPages> ?s } ");
			if(rs.hasNext()) {
