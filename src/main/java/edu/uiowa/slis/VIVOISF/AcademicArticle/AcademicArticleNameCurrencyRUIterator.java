...
public class AcademicArticleNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameCurrencyRUIterator.class);
