...
public class AcademicArticle extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticle currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticle.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			AcademicArticleIterator theAcademicArticleIterator = (AcademicArticleIterator) findAncestorWithClass(this, AcademicArticleIterator.class);

			if (theAcademicArticleIterator != null) {
				subjectURI = theAcademicArticleIterator.getSubjectURI();
				label = theAcademicArticleIterator.getLabel();
			}
			...
			if (theAcademicArticleIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in AcademicArticle doStartTag", e);
			throw new JspTagException("Exception raised in AcademicArticle doStartTag");
		} finally {
			freeConnection();
		}
