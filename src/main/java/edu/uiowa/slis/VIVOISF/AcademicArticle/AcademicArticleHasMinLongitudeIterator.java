...
public class AcademicArticleHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleHasMinLongitudeIterator.class);
