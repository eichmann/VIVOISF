...
public class AcademicArticleNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNationalityZHIterator.class);
