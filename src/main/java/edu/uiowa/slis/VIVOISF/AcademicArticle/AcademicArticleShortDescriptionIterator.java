...
public class AcademicArticleShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleShortDescriptionIterator.class);
