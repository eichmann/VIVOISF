...
public class AcademicArticleARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleARG_0000001Iterator.class);
