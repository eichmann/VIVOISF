...
public class AcademicArticleGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleGDPTotalInCurrentPricesIterator.class);
