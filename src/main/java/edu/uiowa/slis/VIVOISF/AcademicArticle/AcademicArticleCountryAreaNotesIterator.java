...
public class AcademicArticleCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCountryAreaNotesIterator.class);
