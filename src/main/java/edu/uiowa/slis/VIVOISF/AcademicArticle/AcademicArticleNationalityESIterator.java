...
public class AcademicArticleNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNationalityESIterator.class);
