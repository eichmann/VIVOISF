...
public class AcademicArticleNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNationalityRUIterator.class);
