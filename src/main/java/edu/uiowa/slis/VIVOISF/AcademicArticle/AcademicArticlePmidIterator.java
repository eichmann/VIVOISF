...
public class AcademicArticlePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticlePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticlePmidIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				pmid = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setPmid(String thePmid) {
		pmid = thePmid;
	}
