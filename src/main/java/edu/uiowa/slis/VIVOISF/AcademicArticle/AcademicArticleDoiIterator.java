...
public class AcademicArticleDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleDoiIterator.class);
