...
public class AcademicArticleCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCodeFAOSTATIterator.class);
