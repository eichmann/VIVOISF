...
public class AcademicArticleNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameShortZHIterator.class);
