...
public class AcademicArticleHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleHDINotesIterator.class);
