...
public class AcademicArticleNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameCurrencyZHIterator.class);
