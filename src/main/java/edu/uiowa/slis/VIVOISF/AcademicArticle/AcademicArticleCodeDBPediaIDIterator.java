...
public class AcademicArticleCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCodeDBPediaIDIterator.class);
