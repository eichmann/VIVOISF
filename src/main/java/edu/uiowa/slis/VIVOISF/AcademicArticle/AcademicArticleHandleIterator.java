...
public class AcademicArticleHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleHandleIterator.class);
