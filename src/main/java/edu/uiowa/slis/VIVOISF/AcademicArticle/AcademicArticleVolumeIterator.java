...
public class AcademicArticleVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleVolumeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				volume = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
