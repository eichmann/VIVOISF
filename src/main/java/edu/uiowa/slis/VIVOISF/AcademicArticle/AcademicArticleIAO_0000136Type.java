...
public class AcademicArticleIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicArticleIAO_0000136Iterator.getType());
		} catch (Exception e) {
