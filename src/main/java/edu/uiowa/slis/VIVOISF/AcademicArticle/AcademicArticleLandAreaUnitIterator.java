...
public class AcademicArticleLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleLandAreaUnitIterator.class);
