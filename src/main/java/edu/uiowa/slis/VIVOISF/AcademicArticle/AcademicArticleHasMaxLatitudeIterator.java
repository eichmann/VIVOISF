...
public class AcademicArticleHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleHasMaxLatitudeIterator.class);
