...
public class AcademicArticleNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameListITIterator.class);
