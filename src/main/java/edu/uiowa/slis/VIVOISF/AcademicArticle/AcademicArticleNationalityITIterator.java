...
public class AcademicArticleNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNationalityITIterator.class);
