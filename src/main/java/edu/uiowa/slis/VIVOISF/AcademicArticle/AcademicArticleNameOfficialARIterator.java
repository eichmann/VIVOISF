...
public class AcademicArticleNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameOfficialARIterator.class);
