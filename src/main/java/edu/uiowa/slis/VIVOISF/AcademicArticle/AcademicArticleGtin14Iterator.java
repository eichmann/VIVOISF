...
public class AcademicArticleGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleGtin14Iterator.class);
