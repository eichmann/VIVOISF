...
public class AcademicArticleNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameShortENIterator.class);
