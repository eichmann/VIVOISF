...
public class AcademicArticleEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleEditionIterator.class);
