...
public class AcademicArticleCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCountryAreaUnitIterator.class);
