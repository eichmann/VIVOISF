...
public class AcademicArticleHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleHasMinLatitudeIterator.class);
