...
public class AcademicArticleNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameOfficialFRIterator.class);
