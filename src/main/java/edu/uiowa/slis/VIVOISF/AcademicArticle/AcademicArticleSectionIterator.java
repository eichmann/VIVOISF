...
public class AcademicArticleSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleSectionIterator.class);
