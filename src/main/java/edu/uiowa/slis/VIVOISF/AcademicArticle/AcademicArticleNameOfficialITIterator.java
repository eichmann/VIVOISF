...
public class AcademicArticleNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameOfficialITIterator.class);
