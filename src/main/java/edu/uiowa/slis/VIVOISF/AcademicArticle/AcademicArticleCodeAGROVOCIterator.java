...
public class AcademicArticleCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCodeAGROVOCIterator.class);
