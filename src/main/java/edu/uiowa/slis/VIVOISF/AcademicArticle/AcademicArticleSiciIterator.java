...
public class AcademicArticleSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleSiciIterator.class);
