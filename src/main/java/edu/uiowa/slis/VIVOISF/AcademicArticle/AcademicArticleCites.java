...
public class AcademicArticleCites extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCites currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCites.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicArticleCitesIterator.getCites());
		} catch (Exception e) {
