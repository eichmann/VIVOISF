...
public class AcademicArticleNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNationalityFRIterator.class);
