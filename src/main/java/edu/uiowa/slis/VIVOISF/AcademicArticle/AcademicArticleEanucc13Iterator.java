...
public class AcademicArticleEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleEanucc13Iterator.class);
