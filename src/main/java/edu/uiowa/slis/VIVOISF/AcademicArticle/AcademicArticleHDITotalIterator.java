...
public class AcademicArticleHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleHDITotalIterator.class);
