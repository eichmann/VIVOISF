...
public class AcademicArticleNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameListRUIterator.class);
