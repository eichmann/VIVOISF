...
public class AcademicArticleCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCodeISO3Iterator.class);
