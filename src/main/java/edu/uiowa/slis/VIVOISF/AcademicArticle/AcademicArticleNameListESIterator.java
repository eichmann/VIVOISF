...
public class AcademicArticleNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameListESIterator.class);
