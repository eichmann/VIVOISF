...
public class AcademicArticleCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCodeISO2Iterator.class);
