...
public class AcademicArticleNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameCurrencyARIterator.class);
