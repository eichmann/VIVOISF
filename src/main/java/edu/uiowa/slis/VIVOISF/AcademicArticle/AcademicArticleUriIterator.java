...
public class AcademicArticleUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleUriIterator.class);
