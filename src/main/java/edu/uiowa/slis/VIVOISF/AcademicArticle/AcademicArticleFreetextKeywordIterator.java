...
public class AcademicArticleFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleFreetextKeywordIterator.class);
