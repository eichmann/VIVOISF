...
public class AcademicArticleUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleUpcIterator.class);
