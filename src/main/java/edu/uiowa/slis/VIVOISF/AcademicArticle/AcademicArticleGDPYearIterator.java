...
public class AcademicArticleGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleGDPYearIterator.class);
