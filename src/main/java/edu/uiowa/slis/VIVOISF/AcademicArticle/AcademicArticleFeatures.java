...
public class AcademicArticleFeatures extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleFeatures currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleFeatures.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicArticleFeaturesIterator.getFeatures());
		} catch (Exception e) {
