...
public class AcademicArticleGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleGDPUnitIterator.class);
