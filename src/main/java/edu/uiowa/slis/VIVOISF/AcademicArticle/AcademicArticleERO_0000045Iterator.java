...
public class AcademicArticleERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleERO_0000045Iterator.class);
