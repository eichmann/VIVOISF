...
public class AcademicArticleCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCountryAreaTotalIterator.class);
