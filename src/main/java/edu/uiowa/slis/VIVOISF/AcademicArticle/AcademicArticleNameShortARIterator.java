...
public class AcademicArticleNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameShortARIterator.class);
