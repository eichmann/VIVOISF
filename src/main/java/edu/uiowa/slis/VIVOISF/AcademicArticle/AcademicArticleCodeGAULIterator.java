...
public class AcademicArticleCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCodeGAULIterator.class);
