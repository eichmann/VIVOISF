...
public class AcademicArticleNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameCurrencyFRIterator.class);
