...
public class AcademicArticleCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleCodeUNDPIterator.class);
