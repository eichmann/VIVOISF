...
public class AcademicArticleAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleAgriculturalAreaTotalIterator.class);
