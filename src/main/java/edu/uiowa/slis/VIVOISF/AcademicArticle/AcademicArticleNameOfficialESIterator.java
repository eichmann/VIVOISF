...
public class AcademicArticleNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleNameOfficialESIterator.class);
