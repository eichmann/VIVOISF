...
public class AcademicArticleLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicArticleLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicArticleLocatorIterator.class);
