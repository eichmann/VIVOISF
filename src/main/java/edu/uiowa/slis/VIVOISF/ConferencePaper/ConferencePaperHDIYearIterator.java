...
public class ConferencePaperHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperHDIYearIterator.class);
