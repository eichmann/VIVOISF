...
public class ConferencePaperShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperShortTitleIterator.class);
