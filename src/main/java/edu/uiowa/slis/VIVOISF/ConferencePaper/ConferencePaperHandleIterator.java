...
public class ConferencePaperHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperHandleIterator.class);
