...
public class ConferencePaperPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperPopulationUnitIterator.class);
