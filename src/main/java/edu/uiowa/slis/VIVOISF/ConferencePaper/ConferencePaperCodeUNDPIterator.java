...
public class ConferencePaperCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCodeUNDPIterator.class);
