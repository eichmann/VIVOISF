...
public class ConferencePaperNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameListZHIterator.class);
