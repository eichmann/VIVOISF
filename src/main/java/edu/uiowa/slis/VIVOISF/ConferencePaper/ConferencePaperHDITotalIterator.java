...
public class ConferencePaperHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperHDITotalIterator.class);
