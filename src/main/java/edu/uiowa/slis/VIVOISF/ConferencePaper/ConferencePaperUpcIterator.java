...
public class ConferencePaperUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperUpcIterator.class);
