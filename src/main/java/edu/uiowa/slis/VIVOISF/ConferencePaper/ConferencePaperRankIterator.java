...
public class ConferencePaperRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperRankIterator.class);
