...
public class ConferencePaperDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperDescriptionIterator.class);
