...
public class ConferencePaperGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperGtin14Iterator.class);
