...
public class ConferencePaperPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperPageStartIterator.class);
