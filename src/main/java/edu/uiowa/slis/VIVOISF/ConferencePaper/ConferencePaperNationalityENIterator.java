...
public class ConferencePaperNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNationalityENIterator.class);
