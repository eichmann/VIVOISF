...
public class ConferencePaperGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperGDPYearIterator.class);
