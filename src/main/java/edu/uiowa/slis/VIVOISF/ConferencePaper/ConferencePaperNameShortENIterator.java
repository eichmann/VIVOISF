...
public class ConferencePaperNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameShortENIterator.class);
