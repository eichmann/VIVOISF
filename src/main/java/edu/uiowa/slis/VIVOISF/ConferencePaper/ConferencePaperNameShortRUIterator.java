...
public class ConferencePaperNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameShortRUIterator.class);
