...
public class ConferencePaperOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperOclcnumIterator.class);
