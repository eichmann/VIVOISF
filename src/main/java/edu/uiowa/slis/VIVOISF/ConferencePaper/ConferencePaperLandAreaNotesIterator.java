...
public class ConferencePaperLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperLandAreaNotesIterator.class);
