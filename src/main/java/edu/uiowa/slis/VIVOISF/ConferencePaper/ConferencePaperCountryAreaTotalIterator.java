...
public class ConferencePaperCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCountryAreaTotalIterator.class);
