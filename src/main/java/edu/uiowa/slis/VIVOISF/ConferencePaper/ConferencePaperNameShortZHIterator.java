...
public class ConferencePaperNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameShortZHIterator.class);
