...
public class ConferencePaperContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperContentIterator.class);
