...
public class ConferencePaperNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNationalityZHIterator.class);
