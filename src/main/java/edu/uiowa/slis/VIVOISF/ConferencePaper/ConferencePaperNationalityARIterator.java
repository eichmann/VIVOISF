...
public class ConferencePaperNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNationalityARIterator.class);
