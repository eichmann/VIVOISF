...
public class ConferencePaperNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameListITIterator.class);
