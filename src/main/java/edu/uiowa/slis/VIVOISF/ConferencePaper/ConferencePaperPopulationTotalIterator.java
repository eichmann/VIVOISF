...
public class ConferencePaperPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperPopulationTotalIterator.class);
