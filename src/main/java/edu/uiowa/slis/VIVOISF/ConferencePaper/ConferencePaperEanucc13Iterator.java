...
public class ConferencePaperEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperEanucc13Iterator.class);
