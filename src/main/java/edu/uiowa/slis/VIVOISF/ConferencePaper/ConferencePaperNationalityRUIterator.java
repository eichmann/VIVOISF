...
public class ConferencePaperNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNationalityRUIterator.class);
