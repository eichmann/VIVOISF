...
public class ConferencePaperShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperShortDescriptionIterator.class);
