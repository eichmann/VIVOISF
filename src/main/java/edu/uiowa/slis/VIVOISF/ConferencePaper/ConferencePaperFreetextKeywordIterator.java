...
public class ConferencePaperFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperFreetextKeywordIterator.class);
