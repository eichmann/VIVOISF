...
public class ConferencePaperNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNumberIterator.class);
