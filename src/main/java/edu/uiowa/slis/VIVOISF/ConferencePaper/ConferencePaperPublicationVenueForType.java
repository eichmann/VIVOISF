...
public class ConferencePaperPublicationVenueForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperPublicationVenueForType currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperPublicationVenueForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePaperPublicationVenueForIterator.getType());
		} catch (Exception e) {
