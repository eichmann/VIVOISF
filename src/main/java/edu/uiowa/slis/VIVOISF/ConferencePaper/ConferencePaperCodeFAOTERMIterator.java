...
public class ConferencePaperCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCodeFAOTERMIterator.class);
