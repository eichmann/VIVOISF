...
public class ConferencePaperPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperPopulationYearIterator.class);
