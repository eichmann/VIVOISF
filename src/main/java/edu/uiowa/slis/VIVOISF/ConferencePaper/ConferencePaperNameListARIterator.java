...
public class ConferencePaperNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameListARIterator.class);
