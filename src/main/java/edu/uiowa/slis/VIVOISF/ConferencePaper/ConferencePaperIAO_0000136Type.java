...
public class ConferencePaperIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePaperIAO_0000136Iterator.getType());
		} catch (Exception e) {
