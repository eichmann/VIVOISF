...
public class ConferencePaperAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperAsinIterator.class);
