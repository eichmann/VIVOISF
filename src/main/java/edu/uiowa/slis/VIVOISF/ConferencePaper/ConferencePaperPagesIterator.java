...
public class ConferencePaperPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperPagesIterator.class);
