...
public class ConferencePaperRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ConferencePaperRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConferencePaperRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ConferencePaperRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConferencePaperRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ConferencePaperRelates doEndTag", e);
			throw new JspTagException("Exception raised in ConferencePaperRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ConferencePaperRelatesIterator");
