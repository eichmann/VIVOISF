...
public class ConferencePaperLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperLandAreaTotalIterator.class);
