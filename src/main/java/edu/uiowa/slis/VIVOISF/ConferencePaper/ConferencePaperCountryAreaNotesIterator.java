...
public class ConferencePaperCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCountryAreaNotesIterator.class);
