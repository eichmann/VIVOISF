...
public class ConferencePaperNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameCurrencyZHIterator.class);
