...
public class ConferencePaperCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCodeGAULIterator.class);
