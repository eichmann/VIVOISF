...
public class ConferencePaperNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameCurrencyARIterator.class);
