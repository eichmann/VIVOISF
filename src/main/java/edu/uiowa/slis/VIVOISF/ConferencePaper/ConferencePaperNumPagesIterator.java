...
public class ConferencePaperNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNumPagesIterator.class);
