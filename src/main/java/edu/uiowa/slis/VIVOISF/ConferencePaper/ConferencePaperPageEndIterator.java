...
public class ConferencePaperPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperPageEndIterator.class);
