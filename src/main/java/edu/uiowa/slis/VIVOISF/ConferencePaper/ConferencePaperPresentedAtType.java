...
public class ConferencePaperPresentedAtType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperPresentedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperPresentedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePaperPresentedAtIterator.getType());
		} catch (Exception e) {
