...
public class ConferencePaperNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameListRUIterator.class);
