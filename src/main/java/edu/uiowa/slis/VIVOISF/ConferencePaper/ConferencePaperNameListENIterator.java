...
public class ConferencePaperNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameListENIterator.class);
