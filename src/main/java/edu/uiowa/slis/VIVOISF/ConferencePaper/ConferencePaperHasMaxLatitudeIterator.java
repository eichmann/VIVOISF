...
public class ConferencePaperHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperHasMaxLatitudeIterator.class);
