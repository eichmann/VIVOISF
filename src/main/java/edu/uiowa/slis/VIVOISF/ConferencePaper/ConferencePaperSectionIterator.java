...
public class ConferencePaperSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperSectionIterator.class);
