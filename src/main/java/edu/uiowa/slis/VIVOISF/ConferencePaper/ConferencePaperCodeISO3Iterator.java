...
public class ConferencePaperCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCodeISO3Iterator.class);
