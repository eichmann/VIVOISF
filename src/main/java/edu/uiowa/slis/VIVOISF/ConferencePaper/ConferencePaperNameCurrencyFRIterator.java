...
public class ConferencePaperNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameCurrencyFRIterator.class);
