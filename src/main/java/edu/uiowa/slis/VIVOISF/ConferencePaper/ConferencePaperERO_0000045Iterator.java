...
public class ConferencePaperERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperERO_0000045Iterator.class);
