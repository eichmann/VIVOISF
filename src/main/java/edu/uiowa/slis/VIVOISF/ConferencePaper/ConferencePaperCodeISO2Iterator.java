...
public class ConferencePaperCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCodeISO2Iterator.class);
