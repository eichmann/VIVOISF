...
public class ConferencePaperCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCountryAreaUnitIterator.class);
