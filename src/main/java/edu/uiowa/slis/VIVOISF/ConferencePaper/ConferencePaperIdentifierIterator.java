...
public class ConferencePaperIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperIdentifierIterator.class);
