...
public class ConferencePaperNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameOfficialRUIterator.class);
