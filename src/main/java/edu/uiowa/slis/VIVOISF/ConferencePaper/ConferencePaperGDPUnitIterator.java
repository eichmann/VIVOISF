...
public class ConferencePaperGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperGDPUnitIterator.class);
