...
public class ConferencePaperCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCodeAGROVOCIterator.class);
