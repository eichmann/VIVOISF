...
public class ConferencePaperCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCodeUNIterator.class);
