...
public class ConferencePaperNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameOfficialARIterator.class);
