...
public class ConferencePaperARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperARG_0000001Iterator.class);
