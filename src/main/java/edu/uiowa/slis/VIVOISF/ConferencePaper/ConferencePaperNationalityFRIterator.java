...
public class ConferencePaperNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNationalityFRIterator.class);
