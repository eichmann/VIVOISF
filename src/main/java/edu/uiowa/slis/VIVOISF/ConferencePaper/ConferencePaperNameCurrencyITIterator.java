...
public class ConferencePaperNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameCurrencyITIterator.class);
