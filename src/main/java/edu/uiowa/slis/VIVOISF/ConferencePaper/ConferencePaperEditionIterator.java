...
public class ConferencePaperEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperEditionIterator.class);
