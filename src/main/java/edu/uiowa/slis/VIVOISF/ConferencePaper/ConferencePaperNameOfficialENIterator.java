...
public class ConferencePaperNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameOfficialENIterator.class);
