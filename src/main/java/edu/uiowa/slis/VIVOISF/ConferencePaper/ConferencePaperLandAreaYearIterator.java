...
public class ConferencePaperLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperLandAreaYearIterator.class);
