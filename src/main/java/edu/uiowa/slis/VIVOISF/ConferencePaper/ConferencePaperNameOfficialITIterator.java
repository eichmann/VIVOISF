...
public class ConferencePaperNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameOfficialITIterator.class);
