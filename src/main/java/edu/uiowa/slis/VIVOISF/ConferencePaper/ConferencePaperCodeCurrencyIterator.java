...
public class ConferencePaperCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCodeCurrencyIterator.class);
