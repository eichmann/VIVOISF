...
public class ConferencePaperLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperLocatorIterator.class);
