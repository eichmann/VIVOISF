...
public class ConferencePaperNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameShortITIterator.class);
