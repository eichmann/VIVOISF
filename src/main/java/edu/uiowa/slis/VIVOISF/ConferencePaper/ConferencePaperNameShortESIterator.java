...
public class ConferencePaperNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameShortESIterator.class);
