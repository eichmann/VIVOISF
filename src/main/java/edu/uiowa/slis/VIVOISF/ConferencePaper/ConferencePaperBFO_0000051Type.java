...
public class ConferencePaperBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePaperBFO_0000051Iterator.getType());
		} catch (Exception e) {
