...
public class ConferencePaperPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperPopulationNotesIterator.class);
