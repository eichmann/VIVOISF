...
public class ConferencePaperTranslationOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperTranslationOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperTranslationOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePaperTranslationOfIterator.getType());
		} catch (Exception e) {
