...
public class ConferencePaperNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameListFRIterator.class);
