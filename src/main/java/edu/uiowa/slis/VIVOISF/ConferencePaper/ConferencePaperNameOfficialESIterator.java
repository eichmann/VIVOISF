...
public class ConferencePaperNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameOfficialESIterator.class);
