...
public class ConferencePaperUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperUriIterator.class);
