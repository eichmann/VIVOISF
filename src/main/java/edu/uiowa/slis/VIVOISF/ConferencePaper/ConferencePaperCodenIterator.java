...
public class ConferencePaperCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCodenIterator.class);
