...
public class ConferencePaperLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperLandAreaUnitIterator.class);
