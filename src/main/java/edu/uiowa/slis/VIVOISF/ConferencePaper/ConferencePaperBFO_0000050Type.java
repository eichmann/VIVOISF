...
public class ConferencePaperBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePaperBFO_0000050Iterator.getType());
		} catch (Exception e) {
