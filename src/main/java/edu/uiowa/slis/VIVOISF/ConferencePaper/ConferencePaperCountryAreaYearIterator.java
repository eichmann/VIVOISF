...
public class ConferencePaperCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCountryAreaYearIterator.class);
