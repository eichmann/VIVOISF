...
public class ConferencePaperLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperLccnIterator.class);
