...
public class ConferencePaperNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameCurrencyESIterator.class);
