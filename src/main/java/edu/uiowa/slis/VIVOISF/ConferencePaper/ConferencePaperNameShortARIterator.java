...
public class ConferencePaperNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperNameShortARIterator.class);
