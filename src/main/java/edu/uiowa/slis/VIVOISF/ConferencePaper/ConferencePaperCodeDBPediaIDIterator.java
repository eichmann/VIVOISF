...
public class ConferencePaperCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperCodeDBPediaIDIterator.class);
