...
public class ConferencePaperHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperHDINotesIterator.class);
