...
public class ConferencePaperSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperSiciIterator.class);
