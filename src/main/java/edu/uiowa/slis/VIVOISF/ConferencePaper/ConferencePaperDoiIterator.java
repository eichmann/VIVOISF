...
public class ConferencePaperDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperDoiIterator.class);
