...
public class ConferencePaperHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperHasMaxLongitudeIterator.class);
