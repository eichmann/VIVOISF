...
public class ConferencePaperHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePaperHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePaperHasMinLongitudeIterator.class);
