...
public class ERO_0000391Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000391Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000391Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000391TranslatorIterator.getTranslator());
		} catch (Exception e) {
