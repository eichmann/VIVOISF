...
public class ERO_0000391FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000391FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000391FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000391FeaturesIterator.getType());
		} catch (Exception e) {
