...
public class IAO_0000027Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000027Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000027Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000027TranslatorIterator.getTranslator());
		} catch (Exception e) {
