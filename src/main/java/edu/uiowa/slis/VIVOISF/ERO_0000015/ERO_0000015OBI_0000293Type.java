...
public class ERO_0000015OBI_0000293Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000015OBI_0000293Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000015OBI_0000293Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000015OBI_0000293Iterator.getType());
		} catch (Exception e) {
