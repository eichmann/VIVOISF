...
public class ERO_0000015OBI_0000417 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000015OBI_0000417 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000015OBI_0000417.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000015OBI_0000417Iterator.getOBI_0000417());
		} catch (Exception e) {
