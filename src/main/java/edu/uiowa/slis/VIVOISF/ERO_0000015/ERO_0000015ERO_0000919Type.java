...
public class ERO_0000015ERO_0000919Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000015ERO_0000919Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000015ERO_0000919Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000015ERO_0000919Iterator.getType());
		} catch (Exception e) {
