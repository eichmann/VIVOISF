...
public class ERO_0000015ERO_0001521Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000015ERO_0001521Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000015ERO_0001521Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000015ERO_0001521Iterator.getType());
		} catch (Exception e) {
