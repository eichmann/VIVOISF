...
public class ContractRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ContractRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ContractRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theContractRO_0000052Iterator.getType());
		} catch (Exception e) {
