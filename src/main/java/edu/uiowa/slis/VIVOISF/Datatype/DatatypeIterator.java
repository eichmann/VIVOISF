...
public class DatatypeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatatypeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.w3.org/2000/01/rdf-schema#Datatype> . "+
