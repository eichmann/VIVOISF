...
public class JournalAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalAgriculturalAreaTotalIterator.class);
