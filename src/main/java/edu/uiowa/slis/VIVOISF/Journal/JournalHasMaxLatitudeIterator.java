...
public class JournalHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalHasMaxLatitudeIterator.class);
