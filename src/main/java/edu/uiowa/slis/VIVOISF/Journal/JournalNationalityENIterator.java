...
public class JournalNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNationalityENIterator.class);
