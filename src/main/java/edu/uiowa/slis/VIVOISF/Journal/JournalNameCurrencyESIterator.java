...
public class JournalNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameCurrencyESIterator.class);
