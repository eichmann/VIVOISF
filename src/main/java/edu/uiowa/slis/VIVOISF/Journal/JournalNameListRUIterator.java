...
public class JournalNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameListRUIterator.class);
