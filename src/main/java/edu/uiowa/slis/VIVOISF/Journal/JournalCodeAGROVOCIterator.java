...
public class JournalCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCodeAGROVOCIterator.class);
