...
public class JournalCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCodenIterator.class);
