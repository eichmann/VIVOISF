...
public class JournalNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameShortFRIterator.class);
