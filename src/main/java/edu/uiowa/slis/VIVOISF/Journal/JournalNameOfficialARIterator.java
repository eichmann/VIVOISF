...
public class JournalNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameOfficialARIterator.class);
