...
public class JournalNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameListESIterator.class);
