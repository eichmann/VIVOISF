...
public class JournalNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameShortESIterator.class);
