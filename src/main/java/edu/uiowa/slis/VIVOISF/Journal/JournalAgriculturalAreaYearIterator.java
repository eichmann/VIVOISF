...
public class JournalAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalAgriculturalAreaYearIterator.class);
