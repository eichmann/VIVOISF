...
public class JournalCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCodeDBPediaIDIterator.class);
