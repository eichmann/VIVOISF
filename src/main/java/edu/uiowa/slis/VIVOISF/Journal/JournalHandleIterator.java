...
public class JournalHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalHandleIterator.class);
