...
public class JournalDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalDoiIterator.class);
