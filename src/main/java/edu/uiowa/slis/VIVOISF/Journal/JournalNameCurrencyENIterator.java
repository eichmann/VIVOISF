...
public class JournalNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameCurrencyENIterator.class);
