...
public class JournalNumVolumesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNumVolumesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNumVolumesIterator.class);
