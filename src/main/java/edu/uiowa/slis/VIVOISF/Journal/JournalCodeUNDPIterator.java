...
public class JournalCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCodeUNDPIterator.class);
