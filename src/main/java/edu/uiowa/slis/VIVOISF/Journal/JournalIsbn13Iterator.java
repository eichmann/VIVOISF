...
public class JournalIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalIsbn13Iterator.class);
