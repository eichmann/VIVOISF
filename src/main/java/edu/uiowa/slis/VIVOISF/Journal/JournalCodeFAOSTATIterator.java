...
public class JournalCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCodeFAOSTATIterator.class);
