...
public class JournalLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalLandAreaUnitIterator.class);
