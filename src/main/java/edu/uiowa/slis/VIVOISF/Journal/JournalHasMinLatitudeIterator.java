...
public class JournalHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalHasMinLatitudeIterator.class);
