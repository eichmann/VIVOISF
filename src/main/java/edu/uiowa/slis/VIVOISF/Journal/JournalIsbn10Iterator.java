...
public class JournalIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalIsbn10Iterator.class);
