...
public class JournalNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNationalityRUIterator.class);
