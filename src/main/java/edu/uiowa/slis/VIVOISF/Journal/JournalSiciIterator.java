...
public class JournalSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalSiciIterator.class);
