...
public class JournalLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalLccnIterator.class);
