...
public class JournalNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameShortENIterator.class);
