...
public class JournalNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNationalityITIterator.class);
