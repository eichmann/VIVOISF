...
public class JournalLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalLandAreaNotesIterator.class);
