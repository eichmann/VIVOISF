...
public class JournalHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalHDINotesIterator.class);
