...
public class JournalNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNationalityFRIterator.class);
