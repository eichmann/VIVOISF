...
public class JournalNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameCurrencyFRIterator.class);
