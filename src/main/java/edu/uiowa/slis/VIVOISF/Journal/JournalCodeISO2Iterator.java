...
public class JournalCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCodeISO2Iterator.class);
