...
public class JournalHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalHDITotalIterator.class);
