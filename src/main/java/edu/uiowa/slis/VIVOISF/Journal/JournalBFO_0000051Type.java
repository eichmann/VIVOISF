...
public class JournalBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalBFO_0000051Iterator.getType());
		} catch (Exception e) {
