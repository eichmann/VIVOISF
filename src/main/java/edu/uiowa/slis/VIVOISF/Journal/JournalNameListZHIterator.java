...
public class JournalNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameListZHIterator.class);
