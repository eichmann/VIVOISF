...
public class JournalCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCodeUNIterator.class);
