...
public class JournalNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameOfficialESIterator.class);
