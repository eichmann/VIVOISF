...
public class JournalCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCodeCurrencyIterator.class);
