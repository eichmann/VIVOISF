...
public class JournalARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalARG_2000028Iterator.getType());
		} catch (Exception e) {
