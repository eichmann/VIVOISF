...
public class JournalCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCountryAreaYearIterator.class);
