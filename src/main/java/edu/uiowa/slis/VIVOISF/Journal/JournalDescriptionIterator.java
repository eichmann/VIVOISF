...
public class JournalDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalDescriptionIterator.class);
