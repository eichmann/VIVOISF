...
public class JournalNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameOfficialENIterator.class);
