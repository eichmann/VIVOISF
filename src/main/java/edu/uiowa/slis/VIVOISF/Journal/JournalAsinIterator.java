...
public class JournalAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalAsinIterator.class);
