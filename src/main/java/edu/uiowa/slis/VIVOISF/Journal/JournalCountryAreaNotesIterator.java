...
public class JournalCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCountryAreaNotesIterator.class);
