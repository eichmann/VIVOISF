...
public class JournalHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalHDIYearIterator.class);
