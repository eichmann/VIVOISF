...
public class JournalCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCodeFAOTERMIterator.class);
