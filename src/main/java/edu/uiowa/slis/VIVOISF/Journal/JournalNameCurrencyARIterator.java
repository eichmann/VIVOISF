...
public class JournalNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameCurrencyARIterator.class);
