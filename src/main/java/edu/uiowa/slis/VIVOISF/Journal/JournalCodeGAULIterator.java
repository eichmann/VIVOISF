...
public class JournalCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCodeGAULIterator.class);
