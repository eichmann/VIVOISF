...
public class JournalHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalHasMaxLongitudeIterator.class);
