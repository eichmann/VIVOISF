...
public class JournalGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalGtin14Iterator.class);
