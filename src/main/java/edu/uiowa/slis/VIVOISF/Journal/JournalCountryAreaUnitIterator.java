...
public class JournalCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCountryAreaUnitIterator.class);
