...
public class JournalPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalPopulationYearIterator.class);
