...
public class JournalGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalGDPNotesIterator.class);
