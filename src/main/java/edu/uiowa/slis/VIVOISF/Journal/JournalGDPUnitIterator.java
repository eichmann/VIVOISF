...
public class JournalGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalGDPUnitIterator.class);
