...
public class JournalIssnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalIssnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalIssnIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://purl.org/ontology/bibo/issn> ?s } ");
			if(rs.hasNext()) {
