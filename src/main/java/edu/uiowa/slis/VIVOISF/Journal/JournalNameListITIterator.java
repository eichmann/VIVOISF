...
public class JournalNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameListITIterator.class);
