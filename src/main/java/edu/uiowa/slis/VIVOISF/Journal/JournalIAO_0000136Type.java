...
public class JournalIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalIAO_0000136Iterator.getType());
		} catch (Exception e) {
