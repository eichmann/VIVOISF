...
public class JournalAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalAgriculturalAreaUnitIterator.class);
