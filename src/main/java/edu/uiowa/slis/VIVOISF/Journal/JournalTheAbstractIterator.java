...
public class JournalTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalTheAbstractIterator.class);
