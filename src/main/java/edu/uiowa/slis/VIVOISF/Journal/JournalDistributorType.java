...
public class JournalDistributorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalDistributorType currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalDistributorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalDistributorIterator.getType());
		} catch (Exception e) {
