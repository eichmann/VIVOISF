...
public class JournalFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalFreetextKeywordIterator.class);
