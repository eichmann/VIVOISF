...
public class JournalNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameListARIterator.class);
