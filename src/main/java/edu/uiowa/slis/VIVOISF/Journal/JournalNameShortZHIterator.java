...
public class JournalNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameShortZHIterator.class);
