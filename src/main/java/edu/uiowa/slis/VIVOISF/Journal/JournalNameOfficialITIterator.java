...
public class JournalNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameOfficialITIterator.class);
