...
public class JournalPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalPopulationNotesIterator.class);
