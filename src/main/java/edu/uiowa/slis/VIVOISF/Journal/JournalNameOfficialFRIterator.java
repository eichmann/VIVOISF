...
public class JournalNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameOfficialFRIterator.class);
