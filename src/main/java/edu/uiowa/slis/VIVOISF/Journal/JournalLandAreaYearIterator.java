...
public class JournalLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalLandAreaYearIterator.class);
