...
public class JournalNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameCurrencyITIterator.class);
