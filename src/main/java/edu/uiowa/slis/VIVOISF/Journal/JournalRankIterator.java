...
public class JournalRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalRankIterator.class);
