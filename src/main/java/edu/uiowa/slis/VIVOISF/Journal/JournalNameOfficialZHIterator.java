...
public class JournalNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameOfficialZHIterator.class);
