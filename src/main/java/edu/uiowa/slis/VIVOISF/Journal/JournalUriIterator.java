...
public class JournalUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalUriIterator.class);
