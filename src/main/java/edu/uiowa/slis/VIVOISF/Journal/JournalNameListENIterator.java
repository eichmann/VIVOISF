...
public class JournalNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameListENIterator.class);
