...
public class JournalHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalHasMinLongitudeIterator.class);
