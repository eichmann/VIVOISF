...
public class JournalRelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalRelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalRelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalRelatedByIterator.getType());
		} catch (Exception e) {
