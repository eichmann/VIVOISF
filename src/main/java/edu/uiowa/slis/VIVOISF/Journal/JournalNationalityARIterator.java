...
public class JournalNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNationalityARIterator.class);
