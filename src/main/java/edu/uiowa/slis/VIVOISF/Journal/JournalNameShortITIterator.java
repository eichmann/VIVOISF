...
public class JournalNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameShortITIterator.class);
