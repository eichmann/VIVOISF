...
public class JournalRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theJournalRO_0001025Iterator.getType());
		} catch (Exception e) {
