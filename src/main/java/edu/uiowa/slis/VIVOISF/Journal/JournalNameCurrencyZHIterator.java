...
public class JournalNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameCurrencyZHIterator.class);
