...
public class JournalIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalIdentifierIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://purl.org/ontology/bibo/identifier> ?s } ");
			if(rs.hasNext()) {
