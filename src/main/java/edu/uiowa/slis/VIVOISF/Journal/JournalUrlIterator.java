...
public class JournalUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalUrlIterator.class);
