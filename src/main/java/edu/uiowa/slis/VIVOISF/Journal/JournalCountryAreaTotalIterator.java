...
public class JournalCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalCountryAreaTotalIterator.class);
