...
public class JournalNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameListFRIterator.class);
