...
public class JournalUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalUpcIterator.class);
