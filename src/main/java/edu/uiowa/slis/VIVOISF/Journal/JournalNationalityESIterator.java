...
public class JournalNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNationalityESIterator.class);
