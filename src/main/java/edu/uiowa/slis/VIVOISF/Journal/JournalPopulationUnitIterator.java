...
public class JournalPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalPopulationUnitIterator.class);
