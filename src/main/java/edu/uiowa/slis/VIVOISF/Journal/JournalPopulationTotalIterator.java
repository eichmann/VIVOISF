...
public class JournalPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalPopulationTotalIterator.class);
