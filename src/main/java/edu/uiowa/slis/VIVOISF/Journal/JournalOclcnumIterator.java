...
public class JournalOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalOclcnumIterator.class);
