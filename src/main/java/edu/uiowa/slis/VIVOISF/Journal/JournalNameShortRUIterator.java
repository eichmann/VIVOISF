...
public class JournalNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameShortRUIterator.class);
