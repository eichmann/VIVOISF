...
public class JournalNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNameCurrencyRUIterator.class);
