...
public class JournalLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalLandAreaTotalIterator.class);
