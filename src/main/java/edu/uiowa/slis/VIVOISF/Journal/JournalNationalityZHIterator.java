...
public class JournalNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalNationalityZHIterator.class);
