...
public class JournalPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static JournalPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(JournalPmidIterator.class);
