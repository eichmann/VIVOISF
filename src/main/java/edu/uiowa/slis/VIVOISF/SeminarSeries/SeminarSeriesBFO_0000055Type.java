...
public class SeminarSeriesBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeminarSeriesBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SeminarSeriesBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeminarSeriesBFO_0000055Iterator.getType());
		} catch (Exception e) {
