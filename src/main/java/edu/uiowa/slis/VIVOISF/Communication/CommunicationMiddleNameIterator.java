...
public class CommunicationMiddleNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommunicationMiddleNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommunicationMiddleNameIterator.class);
