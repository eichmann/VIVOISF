...
public class CommunicationRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommunicationRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommunicationRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CommunicationRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CommunicationRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CommunicationRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CommunicationRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CommunicationRelates doEndTag", e);
			throw new JspTagException("Exception raised in CommunicationRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CommunicationRelatesIterator");
