...
public class CommunicationRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommunicationRelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommunicationRelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CommunicationRelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CommunicationRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CommunicationRelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CommunicationRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CommunicationRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in CommunicationRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CommunicationRelatedByIterator");
