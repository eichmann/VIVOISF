...
public class CommunicationHasEmailIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommunicationHasEmailIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommunicationHasEmailIterator.class);
...
//					continue;
			...
			log.error("Exception raised in CommunicationHasEmailIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CommunicationHasEmailIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in CommunicationHasEmailIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CommunicationHasEmailIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CommunicationHasEmail doEndTag", e);
			throw new JspTagException("Exception raised in CommunicationHasEmail doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to CommunicationHasEmailIterator");
