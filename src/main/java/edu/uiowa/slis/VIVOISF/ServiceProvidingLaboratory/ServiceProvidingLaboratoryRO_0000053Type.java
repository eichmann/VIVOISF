...
public class ServiceProvidingLaboratoryRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ServiceProvidingLaboratoryRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ServiceProvidingLaboratoryRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theServiceProvidingLaboratoryRO_0000053Iterator.getType());
		} catch (Exception e) {
