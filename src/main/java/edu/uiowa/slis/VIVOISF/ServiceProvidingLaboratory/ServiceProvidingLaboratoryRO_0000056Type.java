...
public class ServiceProvidingLaboratoryRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ServiceProvidingLaboratoryRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ServiceProvidingLaboratoryRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theServiceProvidingLaboratoryRO_0000056Iterator.getType());
		} catch (Exception e) {
