...
public class ServiceProvidingLaboratoryPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ServiceProvidingLaboratoryPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ServiceProvidingLaboratoryPrefixNameIterator.class);
