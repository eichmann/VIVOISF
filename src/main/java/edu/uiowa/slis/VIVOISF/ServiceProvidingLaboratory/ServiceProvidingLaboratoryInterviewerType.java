...
public class ServiceProvidingLaboratoryInterviewerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ServiceProvidingLaboratoryInterviewerType currentInstance = null;
	private static final Log log = LogFactory.getLog(ServiceProvidingLaboratoryInterviewerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theServiceProvidingLaboratoryInterviewerIterator.getType());
		} catch (Exception e) {
