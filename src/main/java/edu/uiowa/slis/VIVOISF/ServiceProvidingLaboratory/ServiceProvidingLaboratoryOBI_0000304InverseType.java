...
public class ServiceProvidingLaboratoryOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ServiceProvidingLaboratoryOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ServiceProvidingLaboratoryOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theServiceProvidingLaboratoryOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
