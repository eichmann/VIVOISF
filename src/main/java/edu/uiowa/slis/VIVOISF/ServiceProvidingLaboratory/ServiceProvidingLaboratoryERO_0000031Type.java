...
public class ServiceProvidingLaboratoryERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ServiceProvidingLaboratoryERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ServiceProvidingLaboratoryERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theServiceProvidingLaboratoryERO_0000031Iterator.getType());
		} catch (Exception e) {
