...
public class BlogOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogOclcnumIterator.class);
