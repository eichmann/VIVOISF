...
public class BlogUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogUriIterator.class);
