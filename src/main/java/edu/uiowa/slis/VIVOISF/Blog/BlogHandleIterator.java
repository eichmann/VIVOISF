...
public class BlogHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogHandleIterator.class);
