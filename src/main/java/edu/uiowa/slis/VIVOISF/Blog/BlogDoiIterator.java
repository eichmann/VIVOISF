...
public class BlogDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogDoiIterator.class);
