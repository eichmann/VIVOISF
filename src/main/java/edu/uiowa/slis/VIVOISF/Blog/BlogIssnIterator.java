...
public class BlogIssnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogIssnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogIssnIterator.class);
