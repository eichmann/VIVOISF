...
public class BlogRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogRO_0000056Iterator.getType());
		} catch (Exception e) {
