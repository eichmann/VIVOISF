...
public class BlogSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogSiciIterator.class);
