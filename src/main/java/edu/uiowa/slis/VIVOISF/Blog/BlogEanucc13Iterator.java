...
public class BlogEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogEanucc13Iterator.class);
