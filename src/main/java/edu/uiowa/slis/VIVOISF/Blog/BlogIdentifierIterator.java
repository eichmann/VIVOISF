...
public class BlogIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogIdentifierIterator.class);
