...
public class BlogIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Blog> . "+
