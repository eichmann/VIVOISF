...
public class BlogOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogOwnerIterator.getType());
		} catch (Exception e) {
