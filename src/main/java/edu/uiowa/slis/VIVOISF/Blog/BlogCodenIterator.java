...
public class BlogCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogCodenIterator.class);
