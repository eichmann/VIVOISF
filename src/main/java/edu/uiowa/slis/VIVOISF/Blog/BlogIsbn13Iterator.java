...
public class BlogIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogIsbn13Iterator.class);
