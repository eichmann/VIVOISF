...
public class BlogDistributorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogDistributorType currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogDistributorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogDistributorIterator.getType());
		} catch (Exception e) {
