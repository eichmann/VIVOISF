...
public class BlogTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogTheAbstractIterator.class);
