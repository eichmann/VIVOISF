...
public class BlogRO_0002353 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogRO_0002353 currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogRO_0002353.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogRO_0002353Iterator.getRO_0002353());
		} catch (Exception e) {
