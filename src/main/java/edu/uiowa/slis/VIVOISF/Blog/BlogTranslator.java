...
public class BlogTranslator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogTranslator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogTranslator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogTranslatorIterator.getTranslator());
		} catch (Exception e) {
