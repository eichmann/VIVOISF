...
public class BlogPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogPmidIterator.class);
