...
public class BlogGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogGtin14Iterator.class);
