...
public class BlogAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogAsinIterator.class);
