...
public class BlogIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BlogIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BlogIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBlogIAO_0000136Iterator.getType());
		} catch (Exception e) {
