...
public class Geographical_regionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Geographical_regionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Geographical_regionCodeAGROVOCIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				codeAGROVOC = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setCodeAGROVOC(String theCodeAGROVOC) {
		codeAGROVOC = theCodeAGROVOC;
	}
