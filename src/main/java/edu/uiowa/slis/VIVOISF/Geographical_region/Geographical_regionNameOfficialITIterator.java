...
public class Geographical_regionNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Geographical_regionNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Geographical_regionNameOfficialITIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nameOfficialIT = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNameOfficialIT(String theNameOfficialIT) {
		nameOfficialIT = theNameOfficialIT;
	}
