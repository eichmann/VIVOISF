...
public class Geographical_regionNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Geographical_regionNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Geographical_regionNameListENIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nameListEN = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNameListEN(String theNameListEN) {
		nameListEN = theNameListEN;
	}
