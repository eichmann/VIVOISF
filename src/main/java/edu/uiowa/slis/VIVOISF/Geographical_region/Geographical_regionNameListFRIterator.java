...
public class Geographical_regionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Geographical_regionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Geographical_regionNameListFRIterator.class);
