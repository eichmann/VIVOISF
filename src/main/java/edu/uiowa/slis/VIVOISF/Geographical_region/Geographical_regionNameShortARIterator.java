...
public class Geographical_regionNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Geographical_regionNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Geographical_regionNameShortARIterator.class);
