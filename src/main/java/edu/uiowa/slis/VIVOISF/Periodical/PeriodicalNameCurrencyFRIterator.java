...
public class PeriodicalNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameCurrencyFRIterator.class);
