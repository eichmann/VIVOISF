...
public class PeriodicalDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalDescriptionIterator.class);
