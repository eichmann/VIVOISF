...
public class PeriodicalDateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalDateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalDateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalDateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
