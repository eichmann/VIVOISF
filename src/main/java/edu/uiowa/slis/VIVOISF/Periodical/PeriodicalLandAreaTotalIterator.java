...
public class PeriodicalLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalLandAreaTotalIterator.class);
