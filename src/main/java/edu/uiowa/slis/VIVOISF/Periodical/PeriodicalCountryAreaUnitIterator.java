...
public class PeriodicalCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCountryAreaUnitIterator.class);
