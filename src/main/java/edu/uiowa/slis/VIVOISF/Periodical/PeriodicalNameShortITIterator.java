...
public class PeriodicalNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameShortITIterator.class);
