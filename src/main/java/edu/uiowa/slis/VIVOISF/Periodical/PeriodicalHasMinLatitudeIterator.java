...
public class PeriodicalHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasMinLatitudeIterator.class);
