...
public class PeriodicalNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameShortRUIterator.class);
