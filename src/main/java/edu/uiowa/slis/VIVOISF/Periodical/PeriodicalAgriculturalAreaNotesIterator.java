...
public class PeriodicalAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalAgriculturalAreaNotesIterator.class);
