...
public class PeriodicalUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalUpcIterator.class);
