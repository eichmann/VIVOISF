...
public class PeriodicalEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalEanucc13Iterator.class);
