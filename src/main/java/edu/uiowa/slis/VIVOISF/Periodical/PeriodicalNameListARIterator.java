...
public class PeriodicalNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameListARIterator.class);
