...
public class PeriodicalGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalGtin14Iterator.class);
