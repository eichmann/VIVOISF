...
public class PeriodicalEissnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalEissnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalEissnIterator.class);
