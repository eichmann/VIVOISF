...
public class PeriodicalCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodeGAULIterator.class);
