...
public class PeriodicalNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameListRUIterator.class);
