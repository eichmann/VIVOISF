...
public class PeriodicalLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalLandAreaNotesIterator.class);
