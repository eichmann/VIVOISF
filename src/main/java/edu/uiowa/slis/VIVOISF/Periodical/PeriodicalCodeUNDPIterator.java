...
public class PeriodicalCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodeUNDPIterator.class);
