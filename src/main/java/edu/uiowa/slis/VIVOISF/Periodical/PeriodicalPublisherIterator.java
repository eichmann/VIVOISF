...
public class PeriodicalPublisherIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalPublisherIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPublisherIterator.class);
...
//					continue;
			...
			log.error("Exception raised in PeriodicalPublisherIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PeriodicalPublisherIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in PeriodicalPublisherIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PeriodicalPublisherIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PeriodicalPublisher doEndTag", e);
			throw new JspTagException("Exception raised in PeriodicalPublisher doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to PeriodicalPublisherIterator");
