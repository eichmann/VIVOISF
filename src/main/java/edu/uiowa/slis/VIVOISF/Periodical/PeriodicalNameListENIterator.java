...
public class PeriodicalNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameListENIterator.class);
