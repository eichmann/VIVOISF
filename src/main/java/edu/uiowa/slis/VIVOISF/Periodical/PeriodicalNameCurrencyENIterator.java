...
public class PeriodicalNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameCurrencyENIterator.class);
