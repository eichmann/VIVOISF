...
public class PeriodicalCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodeUNIterator.class);
