...
public class PeriodicalCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodenIterator.class);
