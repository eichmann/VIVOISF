...
public class PeriodicalNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameShortARIterator.class);
