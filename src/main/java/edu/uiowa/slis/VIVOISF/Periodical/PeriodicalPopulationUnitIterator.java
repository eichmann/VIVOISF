...
public class PeriodicalPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPopulationUnitIterator.class);
