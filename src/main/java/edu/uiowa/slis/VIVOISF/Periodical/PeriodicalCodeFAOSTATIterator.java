...
public class PeriodicalCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodeFAOSTATIterator.class);
