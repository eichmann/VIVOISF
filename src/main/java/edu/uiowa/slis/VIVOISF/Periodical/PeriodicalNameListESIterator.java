...
public class PeriodicalNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameListESIterator.class);
