...
public class PeriodicalNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameOfficialESIterator.class);
