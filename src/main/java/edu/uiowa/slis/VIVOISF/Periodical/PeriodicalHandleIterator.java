...
public class PeriodicalHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHandleIterator.class);
