...
public class PeriodicalNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameOfficialFRIterator.class);
