...
public class PeriodicalLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalLandAreaUnitIterator.class);
