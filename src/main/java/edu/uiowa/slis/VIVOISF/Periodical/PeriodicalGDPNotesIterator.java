...
public class PeriodicalGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalGDPNotesIterator.class);
