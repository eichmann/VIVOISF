...
public class PeriodicalBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalBFO_0000050Iterator.getType());
		} catch (Exception e) {
