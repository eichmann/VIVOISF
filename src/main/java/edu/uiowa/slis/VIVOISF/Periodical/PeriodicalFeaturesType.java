...
public class PeriodicalFeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalFeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalFeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalFeaturesIterator.getType());
		} catch (Exception e) {
