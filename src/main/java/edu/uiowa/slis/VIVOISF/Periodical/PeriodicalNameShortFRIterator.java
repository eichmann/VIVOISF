...
public class PeriodicalNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameShortFRIterator.class);
