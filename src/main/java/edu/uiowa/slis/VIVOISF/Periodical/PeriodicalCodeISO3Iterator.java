...
public class PeriodicalCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodeISO3Iterator.class);
