...
public class PeriodicalNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameOfficialARIterator.class);
