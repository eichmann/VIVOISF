...
public class PeriodicalNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameCurrencyZHIterator.class);
