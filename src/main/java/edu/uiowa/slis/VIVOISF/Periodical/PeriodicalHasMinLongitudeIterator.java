...
public class PeriodicalHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasMinLongitudeIterator.class);
