...
public class PeriodicalNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameCurrencyARIterator.class);
