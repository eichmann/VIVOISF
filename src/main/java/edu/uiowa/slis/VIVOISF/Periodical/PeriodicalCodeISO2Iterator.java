...
public class PeriodicalCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodeISO2Iterator.class);
