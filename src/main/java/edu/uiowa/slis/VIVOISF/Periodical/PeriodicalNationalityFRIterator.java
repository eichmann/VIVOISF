...
public class PeriodicalNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNationalityFRIterator.class);
