...
public class PeriodicalIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalIsbn10Iterator.class);
