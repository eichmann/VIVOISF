...
public class PeriodicalAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalAsinIterator.class);
