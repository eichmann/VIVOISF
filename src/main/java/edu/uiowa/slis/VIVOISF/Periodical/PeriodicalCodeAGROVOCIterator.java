...
public class PeriodicalCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodeAGROVOCIterator.class);
