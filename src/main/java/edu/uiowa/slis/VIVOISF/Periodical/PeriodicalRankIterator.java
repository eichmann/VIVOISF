...
public class PeriodicalRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalRankIterator.class);
