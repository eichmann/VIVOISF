...
public class PeriodicalGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalGDPYearIterator.class);
