...
public class PeriodicalNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameOfficialRUIterator.class);
