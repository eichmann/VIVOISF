...
public class PeriodicalCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodeCurrencyIterator.class);
