...
public class PeriodicalUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalUriIterator.class);
