...
public class PeriodicalNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameOfficialITIterator.class);
