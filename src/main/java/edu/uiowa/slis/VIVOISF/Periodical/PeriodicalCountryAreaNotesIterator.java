...
public class PeriodicalCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCountryAreaNotesIterator.class);
