...
public class PeriodicalNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameListITIterator.class);
