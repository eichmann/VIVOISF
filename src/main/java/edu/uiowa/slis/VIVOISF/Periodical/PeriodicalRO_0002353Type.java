...
public class PeriodicalRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalRO_0002353Iterator.getType());
		} catch (Exception e) {
