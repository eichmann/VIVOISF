...
public class PeriodicalLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalLccnIterator.class);
