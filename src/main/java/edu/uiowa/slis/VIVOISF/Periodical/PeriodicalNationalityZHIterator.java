...
public class PeriodicalNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNationalityZHIterator.class);
