...
public class PeriodicalPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPopulationYearIterator.class);
