...
public class PeriodicalNumVolumesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNumVolumesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNumVolumesIterator.class);
