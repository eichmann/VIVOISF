...
public class PeriodicalIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalIsbn13Iterator.class);
