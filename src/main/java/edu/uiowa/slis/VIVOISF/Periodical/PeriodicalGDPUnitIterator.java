...
public class PeriodicalGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalGDPUnitIterator.class);
