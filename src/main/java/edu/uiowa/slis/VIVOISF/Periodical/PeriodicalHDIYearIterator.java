...
public class PeriodicalHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHDIYearIterator.class);
