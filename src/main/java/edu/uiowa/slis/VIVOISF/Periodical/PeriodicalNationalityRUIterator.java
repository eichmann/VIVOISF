...
public class PeriodicalNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNationalityRUIterator.class);
