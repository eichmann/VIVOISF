...
public class PeriodicalNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameCurrencyITIterator.class);
