...
public class PeriodicalHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasMaxLongitudeIterator.class);
