...
public class PeriodicalCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodeFAOTERMIterator.class);
