...
public class PeriodicalFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalFreetextKeywordIterator.class);
