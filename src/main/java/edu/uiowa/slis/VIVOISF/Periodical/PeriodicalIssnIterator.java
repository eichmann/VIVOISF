...
public class PeriodicalIssnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalIssnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalIssnIterator.class);
