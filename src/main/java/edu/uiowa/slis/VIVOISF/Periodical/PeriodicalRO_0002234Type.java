...
public class PeriodicalRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalRO_0002234Iterator.getType());
		} catch (Exception e) {
