...
public class PeriodicalRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalRO_0001025Iterator.getType());
		} catch (Exception e) {
