...
public class PeriodicalAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalAgriculturalAreaYearIterator.class);
