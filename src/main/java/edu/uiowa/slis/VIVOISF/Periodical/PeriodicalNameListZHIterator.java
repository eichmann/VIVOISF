...
public class PeriodicalNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameListZHIterator.class);
