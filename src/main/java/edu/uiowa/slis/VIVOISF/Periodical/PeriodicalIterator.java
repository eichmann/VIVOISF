...
public class PeriodicalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/Periodical> . "+
