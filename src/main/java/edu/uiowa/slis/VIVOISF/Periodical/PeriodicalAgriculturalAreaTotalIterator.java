...
public class PeriodicalAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalAgriculturalAreaTotalIterator.class);
