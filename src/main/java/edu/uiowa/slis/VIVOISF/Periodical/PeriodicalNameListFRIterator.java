...
public class PeriodicalNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameListFRIterator.class);
