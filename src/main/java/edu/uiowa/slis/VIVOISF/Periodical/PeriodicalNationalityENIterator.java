...
public class PeriodicalNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNationalityENIterator.class);
