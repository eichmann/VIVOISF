...
public class PeriodicalHasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalHasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalHasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
