...
public class PeriodicalNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameCurrencyRUIterator.class);
