...
public class PeriodicalHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHDINotesIterator.class);
