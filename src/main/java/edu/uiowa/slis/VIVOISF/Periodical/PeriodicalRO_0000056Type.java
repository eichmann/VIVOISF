...
public class PeriodicalRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalRO_0000056Iterator.getType());
		} catch (Exception e) {
