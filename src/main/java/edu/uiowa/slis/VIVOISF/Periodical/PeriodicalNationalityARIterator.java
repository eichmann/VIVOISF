...
public class PeriodicalNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNationalityARIterator.class);
