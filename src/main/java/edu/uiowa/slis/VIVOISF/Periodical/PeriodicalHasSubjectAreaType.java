...
public class PeriodicalHasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalHasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalHasSubjectAreaIterator.getType());
		} catch (Exception e) {
