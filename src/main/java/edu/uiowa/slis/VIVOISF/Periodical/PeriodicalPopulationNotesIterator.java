...
public class PeriodicalPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPopulationNotesIterator.class);
