...
public class PeriodicalPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalPmidIterator.class);
