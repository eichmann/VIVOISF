...
public class PeriodicalBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePeriodicalBFO_0000051Iterator.getType());
		} catch (Exception e) {
