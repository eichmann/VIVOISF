...
public class PeriodicalUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalUrlIterator.class);
