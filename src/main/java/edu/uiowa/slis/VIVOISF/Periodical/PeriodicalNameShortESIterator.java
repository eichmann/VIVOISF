...
public class PeriodicalNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameShortESIterator.class);
