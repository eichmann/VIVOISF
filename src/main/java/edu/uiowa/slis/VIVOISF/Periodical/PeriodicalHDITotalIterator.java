...
public class PeriodicalHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalHDITotalIterator.class);
