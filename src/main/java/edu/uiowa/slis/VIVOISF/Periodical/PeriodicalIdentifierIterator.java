...
public class PeriodicalIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalIdentifierIterator.class);
