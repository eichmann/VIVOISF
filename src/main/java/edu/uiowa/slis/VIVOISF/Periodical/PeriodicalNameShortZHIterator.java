...
public class PeriodicalNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameShortZHIterator.class);
