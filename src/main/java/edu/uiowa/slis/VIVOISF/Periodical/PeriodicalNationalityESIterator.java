...
public class PeriodicalNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNationalityESIterator.class);
