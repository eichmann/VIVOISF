...
public class PeriodicalCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCountryAreaYearIterator.class);
