...
public class PeriodicalAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalAgriculturalAreaUnitIterator.class);
