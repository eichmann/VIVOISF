...
public class PeriodicalNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNationalityITIterator.class);
