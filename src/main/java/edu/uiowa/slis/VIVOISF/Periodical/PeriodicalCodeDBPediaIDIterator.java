...
public class PeriodicalCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalCodeDBPediaIDIterator.class);
