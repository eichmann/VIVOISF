...
public class PeriodicalNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PeriodicalNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PeriodicalNameCurrencyESIterator.class);
