...
public class ConsortiumRO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumRO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumRO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConsortiumRO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
