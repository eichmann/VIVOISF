...
public class ConsortiumRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConsortiumRO_0000056Iterator.getType());
		} catch (Exception e) {
