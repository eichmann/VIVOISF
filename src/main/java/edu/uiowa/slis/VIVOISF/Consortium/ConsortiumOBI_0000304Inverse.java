...
public class ConsortiumOBI_0000304Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumOBI_0000304Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumOBI_0000304Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConsortiumOBI_0000304InverseIterator.getOBI_0000304Inverse());
		} catch (Exception e) {
