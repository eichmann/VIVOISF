...
public class ConsortiumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Consortium> . "+
