...
public class ConsortiumIntervieweeInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumIntervieweeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumIntervieweeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ConsortiumIntervieweeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConsortiumIntervieweeInverseIterator doStartTag");
		}
