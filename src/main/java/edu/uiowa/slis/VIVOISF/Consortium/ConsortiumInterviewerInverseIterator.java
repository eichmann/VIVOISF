...
public class ConsortiumInterviewerInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumInterviewerInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumInterviewerInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ConsortiumInterviewerInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConsortiumInterviewerInverseIterator doStartTag");
		}
