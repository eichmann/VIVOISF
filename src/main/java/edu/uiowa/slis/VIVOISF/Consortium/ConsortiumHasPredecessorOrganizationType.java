...
public class ConsortiumHasPredecessorOrganizationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumHasPredecessorOrganizationType currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumHasPredecessorOrganizationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConsortiumHasPredecessorOrganizationIterator.getType());
		} catch (Exception e) {
