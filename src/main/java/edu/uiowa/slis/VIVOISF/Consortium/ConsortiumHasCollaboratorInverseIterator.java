...
public class ConsortiumHasCollaboratorInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumHasCollaboratorInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumHasCollaboratorInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ConsortiumHasCollaboratorInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConsortiumHasCollaboratorInverseIterator doStartTag");
		}
