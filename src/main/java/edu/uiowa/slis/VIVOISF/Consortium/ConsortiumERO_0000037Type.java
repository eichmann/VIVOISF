...
public class ConsortiumERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConsortiumERO_0000037Iterator.getType());
		} catch (Exception e) {
