...
public class ConsortiumERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConsortiumERO_0000031Iterator.getType());
		} catch (Exception e) {
