...
public class ConsortiumRelatedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConsortiumRelatedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(ConsortiumRelatedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConsortiumRelatedByIterator.getRelatedBy());
		} catch (Exception e) {
