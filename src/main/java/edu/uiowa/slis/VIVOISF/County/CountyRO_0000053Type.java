...
public class CountyRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountyRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CountyRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCountyRO_0000053Iterator.getType());
		} catch (Exception e) {
