...
public class CountyRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountyRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CountyRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCountyRO_0000056Iterator.getType());
		} catch (Exception e) {
