...
public class ERO_0000007ERO_0000543Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000007ERO_0000543Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000007ERO_0000543Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000007ERO_0000543InverseIterator.getERO_0000543Inverse());
		} catch (Exception e) {
