...
public class ERO_0000007Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000007Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000007Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.obolibrary.org/obo/ERO_0000007> . "+
			...
			log.error("Exception raised in ERO_0000007Iterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ERO_0000007Iterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in ERO_0000007Iterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ERO_0000007Iterator doAfterBody");
		}
