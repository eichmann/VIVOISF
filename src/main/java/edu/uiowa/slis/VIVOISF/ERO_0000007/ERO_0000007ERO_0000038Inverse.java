...
public class ERO_0000007ERO_0000038Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000007ERO_0000038Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000007ERO_0000038Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000007ERO_0000038InverseIterator.getERO_0000038Inverse());
		} catch (Exception e) {
