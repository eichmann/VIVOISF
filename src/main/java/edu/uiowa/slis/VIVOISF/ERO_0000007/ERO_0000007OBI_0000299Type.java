...
public class ERO_0000007OBI_0000299Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000007OBI_0000299Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000007OBI_0000299Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000007OBI_0000299Iterator.getType());
		} catch (Exception e) {
