...
public class ERO_0000007ERO_0000398 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000007ERO_0000398 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000007ERO_0000398.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000007ERO_0000398Iterator.getERO_0000398());
		} catch (Exception e) {
