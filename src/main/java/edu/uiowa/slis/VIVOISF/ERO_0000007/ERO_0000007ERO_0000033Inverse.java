...
public class ERO_0000007ERO_0000033Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000007ERO_0000033Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000007ERO_0000033Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000007ERO_0000033InverseIterator.getERO_0000033Inverse());
		} catch (Exception e) {
