...
public class PrimaryPositionNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameShortESIterator.class);
