...
public class PrimaryPositionPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionPopulationYearIterator.class);
