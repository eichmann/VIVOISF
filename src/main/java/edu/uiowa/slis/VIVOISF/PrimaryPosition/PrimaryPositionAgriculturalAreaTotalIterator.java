...
public class PrimaryPositionAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionAgriculturalAreaTotalIterator.class);
