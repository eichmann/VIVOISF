...
public class PrimaryPositionCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCountryAreaYearIterator.class);
