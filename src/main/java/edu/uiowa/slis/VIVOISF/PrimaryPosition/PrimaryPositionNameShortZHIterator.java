...
public class PrimaryPositionNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameShortZHIterator.class);
