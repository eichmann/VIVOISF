...
public class PrimaryPositionCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCountryAreaUnitIterator.class);
