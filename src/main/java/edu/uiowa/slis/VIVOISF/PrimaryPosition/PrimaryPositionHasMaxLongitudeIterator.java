...
public class PrimaryPositionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionHasMaxLongitudeIterator.class);
