...
public class PrimaryPositionGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionGDPTotalInCurrentPricesIterator.class);
