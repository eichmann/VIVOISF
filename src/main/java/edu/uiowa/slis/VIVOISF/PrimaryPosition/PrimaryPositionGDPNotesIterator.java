...
public class PrimaryPositionGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionGDPNotesIterator.class);
