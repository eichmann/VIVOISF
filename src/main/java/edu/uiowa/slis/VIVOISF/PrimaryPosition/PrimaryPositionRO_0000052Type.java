...
public class PrimaryPositionRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrimaryPositionRO_0000052Iterator.getType());
		} catch (Exception e) {
