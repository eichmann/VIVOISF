...
public class PrimaryPositionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameListFRIterator.class);
