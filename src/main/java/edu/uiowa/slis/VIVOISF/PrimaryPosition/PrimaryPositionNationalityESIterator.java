...
public class PrimaryPositionNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNationalityESIterator.class);
