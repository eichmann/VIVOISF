...
public class PrimaryPositionHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionHDITotalIterator.class);
