...
public class PrimaryPositionRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionRankIterator.class);
