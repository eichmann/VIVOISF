...
public class PrimaryPositionNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameListZHIterator.class);
