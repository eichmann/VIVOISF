...
public class PrimaryPositionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionLandAreaNotesIterator.class);
