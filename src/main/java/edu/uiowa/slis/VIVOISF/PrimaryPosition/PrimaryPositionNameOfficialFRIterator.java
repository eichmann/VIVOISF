...
public class PrimaryPositionNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameOfficialFRIterator.class);
