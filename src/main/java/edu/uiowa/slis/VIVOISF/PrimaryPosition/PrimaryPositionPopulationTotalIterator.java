...
public class PrimaryPositionPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionPopulationTotalIterator.class);
