...
public class PrimaryPositionNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameCurrencyRUIterator.class);
