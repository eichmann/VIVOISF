...
public class PrimaryPositionNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNationalityITIterator.class);
