...
public class PrimaryPositionNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameListARIterator.class);
