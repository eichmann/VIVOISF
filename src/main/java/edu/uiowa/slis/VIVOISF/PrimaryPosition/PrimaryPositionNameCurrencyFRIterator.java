...
public class PrimaryPositionNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameCurrencyFRIterator.class);
