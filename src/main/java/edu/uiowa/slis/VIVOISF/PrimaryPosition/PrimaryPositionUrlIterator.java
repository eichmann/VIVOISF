...
public class PrimaryPositionUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionUrlIterator.class);
