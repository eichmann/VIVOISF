...
public class PrimaryPositionLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionLandAreaUnitIterator.class);
