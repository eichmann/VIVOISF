...
public class PrimaryPositionGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionGDPYearIterator.class);
