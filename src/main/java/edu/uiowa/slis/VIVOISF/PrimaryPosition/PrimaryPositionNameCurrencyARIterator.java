...
public class PrimaryPositionNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameCurrencyARIterator.class);
