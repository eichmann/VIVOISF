...
public class PrimaryPositionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionLandAreaTotalIterator.class);
