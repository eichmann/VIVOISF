...
public class PrimaryPositionHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionHasMaxLatitudeIterator.class);
