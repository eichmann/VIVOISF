...
public class PrimaryPositionARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrimaryPositionARG_2000028Iterator.getType());
		} catch (Exception e) {
