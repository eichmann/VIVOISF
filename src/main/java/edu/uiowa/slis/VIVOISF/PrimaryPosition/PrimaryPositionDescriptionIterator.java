...
public class PrimaryPositionDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionDescriptionIterator.class);
