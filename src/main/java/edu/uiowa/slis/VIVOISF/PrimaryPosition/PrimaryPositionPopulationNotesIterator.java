...
public class PrimaryPositionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionPopulationNotesIterator.class);
