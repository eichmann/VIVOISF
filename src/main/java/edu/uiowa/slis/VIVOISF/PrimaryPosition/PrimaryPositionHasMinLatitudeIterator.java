...
public class PrimaryPositionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionHasMinLatitudeIterator.class);
