...
public class PrimaryPositionRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in PrimaryPositionRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PrimaryPositionRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in PrimaryPositionRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PrimaryPositionRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PrimaryPositionRelates doEndTag", e);
			throw new JspTagException("Exception raised in PrimaryPositionRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to PrimaryPositionRelatesIterator");
