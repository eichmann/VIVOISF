...
public class PrimaryPositionNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameOfficialENIterator.class);
