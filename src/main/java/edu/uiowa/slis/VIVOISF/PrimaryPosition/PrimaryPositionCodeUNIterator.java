...
public class PrimaryPositionCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCodeUNIterator.class);
