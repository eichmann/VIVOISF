...
public class PrimaryPositionNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNationalityARIterator.class);
