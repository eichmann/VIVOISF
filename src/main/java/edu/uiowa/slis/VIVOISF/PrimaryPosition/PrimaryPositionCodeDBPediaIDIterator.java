...
public class PrimaryPositionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCodeDBPediaIDIterator.class);
