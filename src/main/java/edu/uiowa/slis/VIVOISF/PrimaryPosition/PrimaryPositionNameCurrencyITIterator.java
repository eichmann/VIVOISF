...
public class PrimaryPositionNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameCurrencyITIterator.class);
