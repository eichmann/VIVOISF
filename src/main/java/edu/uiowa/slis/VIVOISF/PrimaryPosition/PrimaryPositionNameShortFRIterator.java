...
public class PrimaryPositionNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameShortFRIterator.class);
