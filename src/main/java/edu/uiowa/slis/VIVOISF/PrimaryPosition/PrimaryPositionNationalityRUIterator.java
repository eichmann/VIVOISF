...
public class PrimaryPositionNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNationalityRUIterator.class);
