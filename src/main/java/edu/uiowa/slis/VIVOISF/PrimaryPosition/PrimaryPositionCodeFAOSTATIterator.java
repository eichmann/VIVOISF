...
public class PrimaryPositionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCodeFAOSTATIterator.class);
