...
public class PrimaryPositionNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameOfficialRUIterator.class);
