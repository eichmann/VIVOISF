...
public class PrimaryPositionCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCountryAreaNotesIterator.class);
