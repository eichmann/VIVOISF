...
public class PrimaryPositionNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameCurrencyESIterator.class);
