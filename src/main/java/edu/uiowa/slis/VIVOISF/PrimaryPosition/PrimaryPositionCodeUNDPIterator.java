...
public class PrimaryPositionCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCodeUNDPIterator.class);
