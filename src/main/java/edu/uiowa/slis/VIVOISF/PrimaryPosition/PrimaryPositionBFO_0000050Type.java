...
public class PrimaryPositionBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrimaryPositionBFO_0000050Iterator.getType());
		} catch (Exception e) {
