...
public class PrimaryPositionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionLandAreaYearIterator.class);
