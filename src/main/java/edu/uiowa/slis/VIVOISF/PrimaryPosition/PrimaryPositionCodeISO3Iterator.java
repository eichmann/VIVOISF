...
public class PrimaryPositionCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCodeISO3Iterator.class);
