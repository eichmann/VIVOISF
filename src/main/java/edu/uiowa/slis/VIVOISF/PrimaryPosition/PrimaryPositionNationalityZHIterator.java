...
public class PrimaryPositionNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNationalityZHIterator.class);
