...
public class PrimaryPositionNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameListESIterator.class);
