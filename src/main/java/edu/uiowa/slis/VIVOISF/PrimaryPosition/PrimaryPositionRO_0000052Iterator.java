...
public class PrimaryPositionRO_0000052Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(PrimaryPositionRO_0000052Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PrimaryPositionRO_0000052Iterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PrimaryPositionRO_0000052Iterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PrimaryPositionRO_0000052 doEndTag", e);
			throw new JspTagException("Exception raised in PrimaryPositionRO_0000052 doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
