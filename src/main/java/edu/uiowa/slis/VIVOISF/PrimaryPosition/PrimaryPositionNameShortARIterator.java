...
public class PrimaryPositionNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameShortARIterator.class);
