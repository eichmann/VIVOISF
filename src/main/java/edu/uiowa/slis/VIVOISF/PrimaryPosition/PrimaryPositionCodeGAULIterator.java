...
public class PrimaryPositionCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCodeGAULIterator.class);
