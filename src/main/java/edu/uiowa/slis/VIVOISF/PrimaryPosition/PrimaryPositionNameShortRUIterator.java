...
public class PrimaryPositionNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameShortRUIterator.class);
