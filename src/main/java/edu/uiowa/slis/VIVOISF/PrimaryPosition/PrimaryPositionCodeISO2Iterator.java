...
public class PrimaryPositionCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCodeISO2Iterator.class);
