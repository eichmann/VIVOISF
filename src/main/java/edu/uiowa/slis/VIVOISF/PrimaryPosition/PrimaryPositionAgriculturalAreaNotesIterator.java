...
public class PrimaryPositionAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionAgriculturalAreaNotesIterator.class);
