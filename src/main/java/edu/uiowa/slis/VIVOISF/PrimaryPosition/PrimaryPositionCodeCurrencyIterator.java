...
public class PrimaryPositionCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCodeCurrencyIterator.class);
