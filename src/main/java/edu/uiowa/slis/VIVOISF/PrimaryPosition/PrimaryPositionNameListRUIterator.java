...
public class PrimaryPositionNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameListRUIterator.class);
