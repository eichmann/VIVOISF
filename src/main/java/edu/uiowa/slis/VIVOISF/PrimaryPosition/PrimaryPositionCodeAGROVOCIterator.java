...
public class PrimaryPositionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCodeAGROVOCIterator.class);
