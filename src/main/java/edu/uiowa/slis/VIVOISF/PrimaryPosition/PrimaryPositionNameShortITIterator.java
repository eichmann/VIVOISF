...
public class PrimaryPositionNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameShortITIterator.class);
