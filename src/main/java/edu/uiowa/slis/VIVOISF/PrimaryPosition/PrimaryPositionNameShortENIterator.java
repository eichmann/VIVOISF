...
public class PrimaryPositionNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameShortENIterator.class);
