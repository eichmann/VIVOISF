...
public class PrimaryPositionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionHDINotesIterator.class);
