...
public class PrimaryPositionNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameOfficialARIterator.class);
