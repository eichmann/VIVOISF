...
public class PrimaryPositionGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionGDPUnitIterator.class);
