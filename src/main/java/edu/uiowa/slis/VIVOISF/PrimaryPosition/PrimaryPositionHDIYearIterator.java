...
public class PrimaryPositionHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionHDIYearIterator.class);
