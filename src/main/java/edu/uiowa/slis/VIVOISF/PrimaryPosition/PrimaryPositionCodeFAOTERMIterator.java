...
public class PrimaryPositionCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionCodeFAOTERMIterator.class);
