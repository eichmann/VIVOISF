...
public class PrimaryPositionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionHasMinLongitudeIterator.class);
