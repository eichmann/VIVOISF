...
public class PrimaryPositionNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrimaryPositionNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrimaryPositionNameOfficialZHIterator.class);
