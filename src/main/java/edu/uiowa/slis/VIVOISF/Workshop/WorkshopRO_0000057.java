...
public class WorkshopRO_0000057 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkshopRO_0000057 currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkshopRO_0000057.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWorkshopRO_0000057Iterator.getRO_0000057());
		} catch (Exception e) {
