...
public class WorkshopBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkshopBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkshopBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWorkshopBFO_0000055Iterator.getType());
		} catch (Exception e) {
