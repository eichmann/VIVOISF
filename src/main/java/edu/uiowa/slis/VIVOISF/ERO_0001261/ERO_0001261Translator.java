...
public class ERO_0001261Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001261Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001261Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001261TranslatorIterator.getTranslator());
		} catch (Exception e) {
