...
public class ERO_0001261TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001261TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001261TheAbstractIterator.class);
