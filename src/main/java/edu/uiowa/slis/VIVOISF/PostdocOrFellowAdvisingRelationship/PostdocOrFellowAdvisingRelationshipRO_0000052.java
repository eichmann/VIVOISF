...
public class PostdocOrFellowAdvisingRelationshipRO_0000052 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocOrFellowAdvisingRelationshipRO_0000052 currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocOrFellowAdvisingRelationshipRO_0000052.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocOrFellowAdvisingRelationshipRO_0000052Iterator.getRO_0000052());
		} catch (Exception e) {
