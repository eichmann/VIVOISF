...
public class PostdocOrFellowAdvisingRelationshipDegreeCandidacyType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocOrFellowAdvisingRelationshipDegreeCandidacyType currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocOrFellowAdvisingRelationshipDegreeCandidacyType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocOrFellowAdvisingRelationshipDegreeCandidacyIterator.getType());
		} catch (Exception e) {
