...
public class WebpagePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpagePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpagePagesIterator.class);
