...
public class WebpageIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageIsbn10Iterator.class);
