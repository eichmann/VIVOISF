...
public class WebpageLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageLocatorIterator.class);
