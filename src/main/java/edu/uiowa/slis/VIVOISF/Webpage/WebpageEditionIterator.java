...
public class WebpageEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageEditionIterator.class);
