...
public class WebpageContributorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageContributorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageContributorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWebpageContributorListIterator.getType());
		} catch (Exception e) {
