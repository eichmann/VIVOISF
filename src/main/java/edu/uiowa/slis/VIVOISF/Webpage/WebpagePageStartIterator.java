...
public class WebpagePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpagePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpagePageStartIterator.class);
