...
public class WebpagePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpagePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpagePageEndIterator.class);
