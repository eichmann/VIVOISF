...
public class WebpageFeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageFeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageFeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWebpageFeaturesIterator.getType());
		} catch (Exception e) {
