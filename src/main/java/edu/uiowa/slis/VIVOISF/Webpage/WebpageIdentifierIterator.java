...
public class WebpageIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageIdentifierIterator.class);
