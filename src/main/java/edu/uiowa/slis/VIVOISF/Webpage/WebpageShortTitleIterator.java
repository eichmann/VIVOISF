...
public class WebpageShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageShortTitleIterator.class);
