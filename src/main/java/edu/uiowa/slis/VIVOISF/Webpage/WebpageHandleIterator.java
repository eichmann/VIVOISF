...
public class WebpageHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageHandleIterator.class);
