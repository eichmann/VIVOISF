...
public class WebpageCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageCodenIterator.class);
