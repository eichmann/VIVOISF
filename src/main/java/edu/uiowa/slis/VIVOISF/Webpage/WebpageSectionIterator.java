...
public class WebpageSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageSectionIterator.class);
