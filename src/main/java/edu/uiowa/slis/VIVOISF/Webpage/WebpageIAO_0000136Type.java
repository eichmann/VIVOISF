...
public class WebpageIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWebpageIAO_0000136Iterator.getType());
		} catch (Exception e) {
