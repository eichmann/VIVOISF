...
public class WebpageVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageVolumeIterator.class);
