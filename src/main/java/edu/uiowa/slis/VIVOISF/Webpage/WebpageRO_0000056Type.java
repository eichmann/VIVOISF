...
public class WebpageRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWebpageRO_0000056Iterator.getType());
		} catch (Exception e) {
