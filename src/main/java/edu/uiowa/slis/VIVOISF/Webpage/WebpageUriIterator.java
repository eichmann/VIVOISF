...
public class WebpageUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageUriIterator.class);
