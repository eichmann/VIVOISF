...
public class WebpageUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageUpcIterator.class);
