...
public class WebpageARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageARG_0000001Iterator.class);
