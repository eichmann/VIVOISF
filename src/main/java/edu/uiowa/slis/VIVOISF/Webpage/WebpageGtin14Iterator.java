...
public class WebpageGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageGtin14Iterator.class);
