...
public class WebpageShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageShortDescriptionIterator.class);
