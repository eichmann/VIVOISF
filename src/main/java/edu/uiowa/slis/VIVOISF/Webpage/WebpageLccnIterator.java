...
public class WebpageLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageLccnIterator.class);
