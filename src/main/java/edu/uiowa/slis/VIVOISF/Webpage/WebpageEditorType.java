...
public class WebpageEditorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageEditorType currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageEditorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWebpageEditorIterator.getType());
		} catch (Exception e) {
