...
public class WebpageContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageContentIterator.class);
