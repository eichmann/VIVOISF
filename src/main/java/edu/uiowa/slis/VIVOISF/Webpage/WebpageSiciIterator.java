...
public class WebpageSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageSiciIterator.class);
