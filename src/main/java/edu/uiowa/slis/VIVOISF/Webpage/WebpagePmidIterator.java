...
public class WebpagePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpagePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpagePmidIterator.class);
