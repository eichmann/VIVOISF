...
public class WebpageOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageOclcnumIterator.class);
