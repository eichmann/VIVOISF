...
public class WebpageAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageAsinIterator.class);
