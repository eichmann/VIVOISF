...
public class WebpageDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageDoiIterator.class);
