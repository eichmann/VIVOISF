...
public class WebpageTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageTheAbstractIterator.class);
