...
public class WebpageIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageIsbn13Iterator.class);
