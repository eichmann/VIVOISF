...
public class WebpageAuthorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebpageAuthorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(WebpageAuthorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWebpageAuthorListIterator.getType());
		} catch (Exception e) {
