...
public class StatuteAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteAsinIterator.class);
