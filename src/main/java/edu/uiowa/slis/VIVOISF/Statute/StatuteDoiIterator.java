...
public class StatuteDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteDoiIterator.class);
