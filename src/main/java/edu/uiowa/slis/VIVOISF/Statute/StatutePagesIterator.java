...
public class StatutePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatutePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatutePagesIterator.class);
