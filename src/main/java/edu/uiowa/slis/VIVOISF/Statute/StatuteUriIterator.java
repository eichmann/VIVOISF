...
public class StatuteUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteUriIterator.class);
