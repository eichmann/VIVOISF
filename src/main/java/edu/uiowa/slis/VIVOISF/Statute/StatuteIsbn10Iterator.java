...
public class StatuteIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteIsbn10Iterator.class);
