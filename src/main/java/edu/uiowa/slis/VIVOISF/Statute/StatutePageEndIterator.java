...
public class StatutePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatutePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatutePageEndIterator.class);
