...
public class StatuteSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteSectionIterator.class);
