...
public class StatuteNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteNumPagesIterator.class);
