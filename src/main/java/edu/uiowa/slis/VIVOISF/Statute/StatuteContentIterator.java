...
public class StatuteContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteContentIterator.class);
