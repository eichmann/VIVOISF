...
public class StatuteCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteCodenIterator.class);
