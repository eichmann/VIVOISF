...
public class StatuteERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteERO_0000045Iterator.class);
