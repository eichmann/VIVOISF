...
public class StatutePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatutePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatutePmidIterator.class);
