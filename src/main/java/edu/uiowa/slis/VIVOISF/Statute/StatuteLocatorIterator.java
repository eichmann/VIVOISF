...
public class StatuteLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteLocatorIterator.class);
