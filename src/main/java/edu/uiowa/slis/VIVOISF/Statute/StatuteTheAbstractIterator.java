...
public class StatuteTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteTheAbstractIterator.class);
