...
public class StatutePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatutePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatutePageStartIterator.class);
