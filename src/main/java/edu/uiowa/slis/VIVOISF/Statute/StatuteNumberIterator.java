...
public class StatuteNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteNumberIterator.class);
