...
public class StatuteARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteARG_0000001Iterator.class);
