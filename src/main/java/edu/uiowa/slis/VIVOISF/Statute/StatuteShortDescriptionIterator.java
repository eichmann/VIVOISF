...
public class StatuteShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteShortDescriptionIterator.class);
