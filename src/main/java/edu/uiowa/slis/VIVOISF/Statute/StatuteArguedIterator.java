...
public class StatuteArguedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteArguedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteArguedIterator.class);
