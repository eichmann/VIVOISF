...
public class StatuteIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStatuteIAO_0000136Iterator.getType());
		} catch (Exception e) {
