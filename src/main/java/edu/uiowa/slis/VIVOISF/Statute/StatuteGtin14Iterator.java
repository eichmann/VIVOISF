...
public class StatuteGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteGtin14Iterator.class);
