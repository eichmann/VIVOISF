...
public class StatuteEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteEditionIterator.class);
