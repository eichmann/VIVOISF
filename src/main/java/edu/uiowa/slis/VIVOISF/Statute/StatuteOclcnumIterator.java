...
public class StatuteOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteOclcnumIterator.class);
