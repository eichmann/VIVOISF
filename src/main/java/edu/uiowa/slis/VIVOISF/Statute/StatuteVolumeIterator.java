...
public class StatuteVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteVolumeIterator.class);
