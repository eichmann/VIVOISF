...
public class StatuteSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteSiciIterator.class);
