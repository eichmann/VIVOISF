...
public class StatuteLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteLccnIterator.class);
