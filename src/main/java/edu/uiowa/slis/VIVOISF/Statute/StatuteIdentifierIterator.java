...
public class StatuteIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteIdentifierIterator.class);
