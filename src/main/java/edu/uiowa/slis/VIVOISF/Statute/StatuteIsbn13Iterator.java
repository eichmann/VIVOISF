...
public class StatuteIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteIsbn13Iterator.class);
