...
public class StatuteEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteEanucc13Iterator.class);
