...
public class StatuteShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StatuteShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StatuteShortTitleIterator.class);
