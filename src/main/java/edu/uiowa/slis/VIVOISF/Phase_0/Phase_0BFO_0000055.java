...
public class Phase_0BFO_0000055 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Phase_0BFO_0000055 currentInstance = null;
	private static final Log log = LogFactory.getLog(Phase_0BFO_0000055.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePhase_0BFO_0000055Iterator.getBFO_0000055());
		} catch (Exception e) {
