...
public class Phase_0ERO_0001518Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Phase_0ERO_0001518Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(Phase_0ERO_0001518Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePhase_0ERO_0001518InverseIterator.getERO_0001518Inverse());
		} catch (Exception e) {
