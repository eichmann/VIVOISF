...
public class SpeechIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Speech> . "+
