...
public class SpeechLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechLccnIterator.class);
