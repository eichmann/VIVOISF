...
public class SpeechTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechTheAbstractIterator.class);
