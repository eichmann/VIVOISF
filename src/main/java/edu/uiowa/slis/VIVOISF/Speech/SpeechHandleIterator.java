...
public class SpeechHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechHandleIterator.class);
