...
public class SpeechSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechSiciIterator.class);
