...
public class SpeechUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechUpcIterator.class);
