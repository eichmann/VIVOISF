...
public class SpeechPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechPageStartIterator.class);
