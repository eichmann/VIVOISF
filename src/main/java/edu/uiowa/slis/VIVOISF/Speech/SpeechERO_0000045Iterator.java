...
public class SpeechERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechERO_0000045Iterator.class);
