...
public class SpeechNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechNumPagesIterator.class);
