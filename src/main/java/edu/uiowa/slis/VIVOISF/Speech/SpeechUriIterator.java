...
public class SpeechUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechUriIterator.class);
