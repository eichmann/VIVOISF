...
public class SpeechPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechPagesIterator.class);
