...
public class SpeechCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechCodenIterator.class);
