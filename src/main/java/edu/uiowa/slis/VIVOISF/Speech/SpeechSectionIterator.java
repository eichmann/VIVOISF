...
public class SpeechSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechSectionIterator.class);
