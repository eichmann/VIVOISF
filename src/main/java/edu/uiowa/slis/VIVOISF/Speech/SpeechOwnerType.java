...
public class SpeechOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSpeechOwnerIterator.getType());
		} catch (Exception e) {
