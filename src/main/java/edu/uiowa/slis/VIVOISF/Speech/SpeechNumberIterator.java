...
public class SpeechNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechNumberIterator.class);
