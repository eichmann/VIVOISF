...
public class SpeechEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechEditionIterator.class);
