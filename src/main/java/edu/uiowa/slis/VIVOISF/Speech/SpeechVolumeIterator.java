...
public class SpeechVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechVolumeIterator.class);
