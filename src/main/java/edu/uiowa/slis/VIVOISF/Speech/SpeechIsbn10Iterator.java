...
public class SpeechIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechIsbn10Iterator.class);
