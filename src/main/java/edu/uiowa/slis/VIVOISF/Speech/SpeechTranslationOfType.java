...
public class SpeechTranslationOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechTranslationOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechTranslationOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSpeechTranslationOfIterator.getType());
		} catch (Exception e) {
