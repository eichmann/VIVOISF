...
public class SpeechARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechARG_0000001Iterator.class);
