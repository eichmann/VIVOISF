...
public class SpeechIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechIdentifierIterator.class);
