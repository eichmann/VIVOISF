...
public class SpeechGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechGtin14Iterator.class);
