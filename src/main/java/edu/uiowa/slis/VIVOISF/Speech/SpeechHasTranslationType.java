...
public class SpeechHasTranslationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechHasTranslationType currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechHasTranslationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSpeechHasTranslationIterator.getType());
		} catch (Exception e) {
