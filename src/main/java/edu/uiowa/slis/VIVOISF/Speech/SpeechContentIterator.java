...
public class SpeechContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechContentIterator.class);
