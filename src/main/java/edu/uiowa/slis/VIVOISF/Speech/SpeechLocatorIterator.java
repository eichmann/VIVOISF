...
public class SpeechLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechLocatorIterator.class);
