...
public class SpeechPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SpeechPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SpeechPageEndIterator.class);
