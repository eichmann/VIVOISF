...
public class special_groupNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameCurrencyFRIterator.class);
