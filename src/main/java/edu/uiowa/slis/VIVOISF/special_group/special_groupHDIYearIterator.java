...
public class special_groupHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHDIYearIterator.class);
