...
public class special_groupHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHasMaxLatitudeIterator.class);
