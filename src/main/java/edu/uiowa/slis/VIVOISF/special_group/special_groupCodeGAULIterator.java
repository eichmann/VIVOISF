...
public class special_groupCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCodeGAULIterator.class);
