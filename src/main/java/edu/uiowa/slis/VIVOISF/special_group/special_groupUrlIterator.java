...
public class special_groupUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupUrlIterator.class);
