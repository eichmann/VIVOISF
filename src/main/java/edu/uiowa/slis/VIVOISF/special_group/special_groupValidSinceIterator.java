...
public class special_groupValidSinceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupValidSinceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupValidSinceIterator.class);
