...
public class special_groupNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNationalityENIterator.class);
