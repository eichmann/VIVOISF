...
public class special_groupHasEmailType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHasEmailType currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHasEmailType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thespecial_groupHasEmailIterator.getType());
		} catch (Exception e) {
