...
public class special_groupNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameCurrencyARIterator.class);
