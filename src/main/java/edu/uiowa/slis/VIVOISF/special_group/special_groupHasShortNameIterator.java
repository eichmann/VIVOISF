...
public class special_groupHasShortNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHasShortNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHasShortNameIterator.class);
