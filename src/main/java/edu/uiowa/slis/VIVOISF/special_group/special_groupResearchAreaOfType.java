...
public class special_groupResearchAreaOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupResearchAreaOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupResearchAreaOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thespecial_groupResearchAreaOfIterator.getType());
		} catch (Exception e) {
