...
public class special_groupAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupAgriculturalAreaUnitIterator.class);
