...
public class special_groupGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupGDPTotalInCurrentPricesIterator.class);
