...
public class special_groupCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCountryAreaYearIterator.class);
