...
public class special_groupHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHasMinLongitudeIterator.class);
