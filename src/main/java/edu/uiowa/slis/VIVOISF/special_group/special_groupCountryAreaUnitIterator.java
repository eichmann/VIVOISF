...
public class special_groupCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCountryAreaUnitIterator.class);
