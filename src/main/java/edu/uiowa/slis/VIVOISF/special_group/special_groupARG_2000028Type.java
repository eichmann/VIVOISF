...
public class special_groupARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thespecial_groupARG_2000028Iterator.getType());
		} catch (Exception e) {
