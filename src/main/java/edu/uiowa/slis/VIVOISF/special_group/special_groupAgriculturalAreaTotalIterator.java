...
public class special_groupAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupAgriculturalAreaTotalIterator.class);
