...
public class special_groupAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupAgriculturalAreaNotesIterator.class);
