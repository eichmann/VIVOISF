...
public class special_groupNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameListZHIterator.class);
