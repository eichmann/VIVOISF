...
public class special_groupSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupSameAsIterator.class);
