...
public class special_groupHasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thespecial_groupHasTitleIterator.getType());
		} catch (Exception e) {
