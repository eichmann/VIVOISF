...
public class special_groupPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupPopulationYearIterator.class);
