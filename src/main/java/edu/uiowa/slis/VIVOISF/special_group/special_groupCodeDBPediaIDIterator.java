...
public class special_groupCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCodeDBPediaIDIterator.class);
