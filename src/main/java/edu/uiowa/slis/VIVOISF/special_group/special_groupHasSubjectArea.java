...
public class special_groupHasSubjectArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHasSubjectArea currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHasSubjectArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thespecial_groupHasSubjectAreaIterator.getHasSubjectArea());
		} catch (Exception e) {
