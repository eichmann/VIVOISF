...
public class special_groupNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameCurrencyESIterator.class);
