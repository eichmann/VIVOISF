...
public class special_groupNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameListFRIterator.class);
