...
public class special_groupRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupRankIterator.class);
