...
public class special_groupCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCodeUNDPIterator.class);
