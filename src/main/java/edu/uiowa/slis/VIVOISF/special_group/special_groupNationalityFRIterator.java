...
public class special_groupNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNationalityFRIterator.class);
