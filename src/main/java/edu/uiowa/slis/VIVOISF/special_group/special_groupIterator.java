...
public class special_groupIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://aims.fao.org/aos/geopolitical.owl#special_group> . "+
