...
public class special_groupLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupLandAreaUnitIterator.class);
