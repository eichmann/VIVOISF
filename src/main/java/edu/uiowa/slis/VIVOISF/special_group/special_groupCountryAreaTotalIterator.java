...
public class special_groupCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCountryAreaTotalIterator.class);
