...
public class special_groupNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameOfficialARIterator.class);
