...
public class special_groupRelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupRelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupRelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thespecial_groupRelatesIterator.getType());
		} catch (Exception e) {
