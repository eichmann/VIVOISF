...
public class special_groupHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHasMaxLongitudeIterator.class);
