...
public class special_groupNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameShortFRIterator.class);
