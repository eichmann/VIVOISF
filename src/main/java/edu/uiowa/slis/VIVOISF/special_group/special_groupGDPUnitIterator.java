...
public class special_groupGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupGDPUnitIterator.class);
