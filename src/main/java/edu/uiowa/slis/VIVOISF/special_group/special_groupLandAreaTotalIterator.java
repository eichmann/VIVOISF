...
public class special_groupLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupLandAreaTotalIterator.class);
