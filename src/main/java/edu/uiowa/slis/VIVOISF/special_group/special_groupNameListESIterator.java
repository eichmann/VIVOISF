...
public class special_groupNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameListESIterator.class);
