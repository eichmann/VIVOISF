...
public class special_groupNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNationalityRUIterator.class);
