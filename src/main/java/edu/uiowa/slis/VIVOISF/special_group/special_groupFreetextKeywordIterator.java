...
public class special_groupFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupFreetextKeywordIterator.class);
