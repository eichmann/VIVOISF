...
public class special_groupNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameOfficialFRIterator.class);
