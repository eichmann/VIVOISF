...
public class special_groupHasOfficialNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHasOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHasOfficialNameIterator.class);
