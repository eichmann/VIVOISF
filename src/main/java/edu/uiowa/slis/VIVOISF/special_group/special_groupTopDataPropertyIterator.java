...
public class special_groupTopDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupTopDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupTopDataPropertyIterator.class);
