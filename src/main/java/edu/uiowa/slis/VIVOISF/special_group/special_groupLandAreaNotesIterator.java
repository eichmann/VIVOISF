...
public class special_groupLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupLandAreaNotesIterator.class);
