...
public class special_groupCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCountryAreaNotesIterator.class);
