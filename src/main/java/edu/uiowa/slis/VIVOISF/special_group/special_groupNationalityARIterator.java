...
public class special_groupNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNationalityARIterator.class);
