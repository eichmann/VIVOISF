...
public class special_groupHasCodeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHasCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHasCodeIterator.class);
