...
public class special_groupNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameListRUIterator.class);
