...
public class special_groupPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupPopulationTotalIterator.class);
