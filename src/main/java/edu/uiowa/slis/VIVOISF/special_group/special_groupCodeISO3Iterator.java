...
public class special_groupCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCodeISO3Iterator.class);
