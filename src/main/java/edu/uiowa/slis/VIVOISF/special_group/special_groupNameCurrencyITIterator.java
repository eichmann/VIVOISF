...
public class special_groupNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameCurrencyITIterator.class);
