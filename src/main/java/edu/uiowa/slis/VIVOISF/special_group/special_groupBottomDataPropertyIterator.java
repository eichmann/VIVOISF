...
public class special_groupBottomDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupBottomDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupBottomDataPropertyIterator.class);
