...
public class special_groupNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNameOfficialESIterator.class);
