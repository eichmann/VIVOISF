...
public class special_groupBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thespecial_groupBFO_0000050Iterator.getType());
		} catch (Exception e) {
