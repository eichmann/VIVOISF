...
public class special_groupGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupGDPNotesIterator.class);
