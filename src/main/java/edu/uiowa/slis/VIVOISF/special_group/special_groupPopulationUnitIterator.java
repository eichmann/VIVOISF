...
public class special_groupPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupPopulationUnitIterator.class);
