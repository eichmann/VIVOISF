...
public class special_groupPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupPopulationNotesIterator.class);
