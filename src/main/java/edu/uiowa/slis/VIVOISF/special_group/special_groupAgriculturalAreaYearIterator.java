...
public class special_groupAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupAgriculturalAreaYearIterator.class);
