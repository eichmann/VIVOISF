...
public class special_groupHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHDITotalIterator.class);
