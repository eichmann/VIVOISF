...
public class special_groupRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thespecial_groupRO_0001025Iterator.getType());
		} catch (Exception e) {
