...
public class special_groupSourceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupSourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupSourceIterator.class);
