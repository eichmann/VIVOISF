...
public class special_groupNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupNationalityITIterator.class);
