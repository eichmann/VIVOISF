...
public class special_groupCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCodeCurrencyIterator.class);
