...
public class special_groupDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupDescriptionIterator.class);
