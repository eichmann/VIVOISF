...
public class special_groupCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCodeUNIterator.class);
