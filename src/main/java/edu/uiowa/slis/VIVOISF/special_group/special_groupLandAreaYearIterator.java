...
public class special_groupLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupLandAreaYearIterator.class);
