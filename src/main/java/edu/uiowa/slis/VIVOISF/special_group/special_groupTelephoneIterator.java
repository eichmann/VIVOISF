...
public class special_groupTelephoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupTelephoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupTelephoneIterator.class);
