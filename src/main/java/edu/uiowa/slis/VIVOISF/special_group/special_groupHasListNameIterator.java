...
public class special_groupHasListNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHasListNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHasListNameIterator.class);
