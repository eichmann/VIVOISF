...
public class special_groupCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCodeFAOSTATIterator.class);
