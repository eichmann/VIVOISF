...
public class special_groupCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupCodeISO2Iterator.class);
