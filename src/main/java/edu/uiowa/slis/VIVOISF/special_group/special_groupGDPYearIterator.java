...
public class special_groupGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupGDPYearIterator.class);
