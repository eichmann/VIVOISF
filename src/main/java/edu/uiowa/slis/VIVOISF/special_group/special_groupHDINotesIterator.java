...
public class special_groupHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static special_groupHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(special_groupHDINotesIterator.class);
