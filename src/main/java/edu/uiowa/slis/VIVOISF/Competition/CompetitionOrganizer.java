...
public class CompetitionOrganizer extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CompetitionOrganizer currentInstance = null;
	private static final Log log = LogFactory.getLog(CompetitionOrganizer.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCompetitionOrganizerIterator.getOrganizer());
		} catch (Exception e) {
