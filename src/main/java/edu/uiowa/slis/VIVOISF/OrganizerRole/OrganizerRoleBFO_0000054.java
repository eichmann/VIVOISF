...
public class OrganizerRoleBFO_0000054 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizerRoleBFO_0000054 currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizerRoleBFO_0000054.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizerRoleBFO_0000054Iterator.getBFO_0000054());
		} catch (Exception e) {
