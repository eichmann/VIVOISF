...
public class OrganizerRoleRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizerRoleRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizerRoleRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizerRoleRO_0000056Iterator.getType());
		} catch (Exception e) {
