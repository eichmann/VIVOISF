...
public class BFO_0000031HasNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HasNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HasNameIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000031HasNameIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000031HasNameIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000031HasNameIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000031HasNameIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000031HasName doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000031HasName doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000031HasNameIterator");
