...
public class BFO_0000031NationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NationalityRUIterator.class);
