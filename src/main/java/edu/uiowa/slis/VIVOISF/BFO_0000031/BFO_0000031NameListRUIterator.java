...
public class BFO_0000031NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NameListRUIterator.class);
