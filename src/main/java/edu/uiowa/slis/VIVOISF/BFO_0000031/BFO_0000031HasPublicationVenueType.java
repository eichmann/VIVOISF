...
public class BFO_0000031HasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031HasPublicationVenueIterator.getType());
		} catch (Exception e) {
