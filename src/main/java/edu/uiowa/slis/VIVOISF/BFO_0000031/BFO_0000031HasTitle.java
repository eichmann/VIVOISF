...
public class BFO_0000031HasTitle extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HasTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HasTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031HasTitleIterator.getHasTitle());
		} catch (Exception e) {
