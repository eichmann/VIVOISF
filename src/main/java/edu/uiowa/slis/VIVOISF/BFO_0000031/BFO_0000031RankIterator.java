...
public class BFO_0000031RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031RankIterator.class);
