...
public class BFO_0000031HasSubjectAreaIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HasSubjectAreaIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HasSubjectAreaIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000031HasSubjectAreaIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000031HasSubjectAreaIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000031HasSubjectAreaIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000031HasSubjectAreaIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000031HasSubjectArea doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000031HasSubjectArea doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000031HasSubjectAreaIterator");
