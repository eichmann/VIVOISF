...
public class BFO_0000031NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NameListITIterator.class);
