...
public class BFO_0000031RelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031RelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031RelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031RelatedByIterator.getType());
		} catch (Exception e) {
