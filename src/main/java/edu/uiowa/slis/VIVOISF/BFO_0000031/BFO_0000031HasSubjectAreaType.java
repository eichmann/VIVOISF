...
public class BFO_0000031HasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031HasSubjectAreaIterator.getType());
		} catch (Exception e) {
