...
public class BFO_0000031NumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NumPagesIterator.class);
