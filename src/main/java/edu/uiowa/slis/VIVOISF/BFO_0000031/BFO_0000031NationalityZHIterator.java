...
public class BFO_0000031NationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NationalityZHIterator.class);
