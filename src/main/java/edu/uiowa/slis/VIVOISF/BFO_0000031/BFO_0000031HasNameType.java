...
public class BFO_0000031HasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031HasNameIterator.getType());
		} catch (Exception e) {
