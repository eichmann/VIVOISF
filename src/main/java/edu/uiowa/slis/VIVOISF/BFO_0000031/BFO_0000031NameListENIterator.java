...
public class BFO_0000031NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NameListENIterator.class);
