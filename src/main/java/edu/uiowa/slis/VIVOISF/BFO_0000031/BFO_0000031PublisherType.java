...
public class BFO_0000031PublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031PublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031PublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031PublisherIterator.getType());
		} catch (Exception e) {
