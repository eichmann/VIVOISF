...
public class BFO_0000031IdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031IdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031IdentifierIterator.class);
