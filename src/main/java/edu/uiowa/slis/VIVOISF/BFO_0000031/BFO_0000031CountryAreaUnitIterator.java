...
public class BFO_0000031CountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031CountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031CountryAreaUnitIterator.class);
