...
public class BFO_0000031AgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031AgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031AgriculturalAreaUnitIterator.class);
