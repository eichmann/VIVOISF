...
public class BFO_0000031CountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031CountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031CountryAreaYearIterator.class);
