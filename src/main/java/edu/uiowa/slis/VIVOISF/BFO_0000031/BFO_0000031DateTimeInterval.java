...
public class BFO_0000031DateTimeInterval extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031DateTimeInterval currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031DateTimeInterval.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031DateTimeIntervalIterator.getDateTimeInterval());
		} catch (Exception e) {
