...
public class BFO_0000031CodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031CodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031CodeFAOTERMIterator.class);
