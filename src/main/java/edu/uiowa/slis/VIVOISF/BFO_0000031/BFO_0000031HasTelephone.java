...
public class BFO_0000031HasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031HasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
