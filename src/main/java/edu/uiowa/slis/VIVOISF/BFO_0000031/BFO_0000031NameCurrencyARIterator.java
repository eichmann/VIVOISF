...
public class BFO_0000031NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NameCurrencyARIterator.class);
