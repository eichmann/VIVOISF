...
public class BFO_0000031CodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031CodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031CodeUNDPIterator.class);
