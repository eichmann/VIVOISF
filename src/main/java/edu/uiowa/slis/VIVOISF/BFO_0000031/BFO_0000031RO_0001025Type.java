...
public class BFO_0000031RO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031RO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031RO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031RO_0001025Iterator.getType());
		} catch (Exception e) {
