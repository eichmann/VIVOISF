...
public class BFO_0000031NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NameListZHIterator.class);
