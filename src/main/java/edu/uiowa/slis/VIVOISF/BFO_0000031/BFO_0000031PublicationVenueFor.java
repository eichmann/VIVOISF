...
public class BFO_0000031PublicationVenueFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031PublicationVenueFor currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031PublicationVenueFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031PublicationVenueForIterator.getPublicationVenueFor());
		} catch (Exception e) {
