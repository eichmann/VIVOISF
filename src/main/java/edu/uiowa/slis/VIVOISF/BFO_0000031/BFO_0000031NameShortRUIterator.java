...
public class BFO_0000031NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NameShortRUIterator.class);
