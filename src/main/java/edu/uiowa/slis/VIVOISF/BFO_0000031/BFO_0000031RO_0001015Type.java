...
public class BFO_0000031RO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031RO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031RO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031RO_0001015Iterator.getType());
		} catch (Exception e) {
