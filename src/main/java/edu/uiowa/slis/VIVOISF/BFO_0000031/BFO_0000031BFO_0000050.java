...
public class BFO_0000031BFO_0000050 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031BFO_0000050 currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031BFO_0000050.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031BFO_0000050Iterator.getBFO_0000050());
		} catch (Exception e) {
