...
public class BFO_0000031NameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NameOfficialRUIterator.class);
