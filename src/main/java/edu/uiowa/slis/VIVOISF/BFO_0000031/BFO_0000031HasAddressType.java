...
public class BFO_0000031HasAddressType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HasAddressType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HasAddressType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031HasAddressIterator.getType());
		} catch (Exception e) {
