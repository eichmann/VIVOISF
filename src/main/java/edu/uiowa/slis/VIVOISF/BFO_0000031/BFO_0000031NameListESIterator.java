...
public class BFO_0000031NameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NameListESIterator.class);
