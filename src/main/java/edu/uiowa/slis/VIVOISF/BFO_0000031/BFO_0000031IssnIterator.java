...
public class BFO_0000031IssnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031IssnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031IssnIterator.class);
