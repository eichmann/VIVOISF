...
public class BFO_0000031NameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NameCurrencyZHIterator.class);
