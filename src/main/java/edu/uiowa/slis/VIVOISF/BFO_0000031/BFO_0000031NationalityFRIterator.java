...
public class BFO_0000031NationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NationalityFRIterator.class);
