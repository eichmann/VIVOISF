...
public class BFO_0000031NameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NameShortITIterator.class);
