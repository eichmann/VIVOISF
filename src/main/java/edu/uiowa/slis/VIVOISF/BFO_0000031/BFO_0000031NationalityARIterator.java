...
public class BFO_0000031NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031NationalityARIterator.class);
