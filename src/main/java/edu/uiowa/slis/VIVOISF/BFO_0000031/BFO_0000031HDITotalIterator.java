...
public class BFO_0000031HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HDITotalIterator.class);
