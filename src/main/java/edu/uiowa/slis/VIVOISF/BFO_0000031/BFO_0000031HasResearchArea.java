...
public class BFO_0000031HasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031HasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
