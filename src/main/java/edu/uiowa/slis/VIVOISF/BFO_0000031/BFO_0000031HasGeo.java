...
public class BFO_0000031HasGeo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031HasGeo currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031HasGeo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031HasGeoIterator.getHasGeo());
		} catch (Exception e) {
