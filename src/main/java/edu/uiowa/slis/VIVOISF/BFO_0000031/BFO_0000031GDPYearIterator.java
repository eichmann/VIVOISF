...
public class BFO_0000031GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031GDPYearIterator.class);
