...
public class BFO_0000031DateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031DateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031DateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000031DateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
