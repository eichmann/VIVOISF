...
public class BFO_0000031EissnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000031EissnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000031EissnIterator.class);
