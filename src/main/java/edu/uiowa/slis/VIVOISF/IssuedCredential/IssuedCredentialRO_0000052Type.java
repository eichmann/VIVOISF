...
public class IssuedCredentialRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssuedCredentialRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IssuedCredentialRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIssuedCredentialRO_0000052Iterator.getType());
		} catch (Exception e) {
