...
public class IssuedCredentialRO_0000056 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IssuedCredentialRO_0000056 currentInstance = null;
	private static final Log log = LogFactory.getLog(IssuedCredentialRO_0000056.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIssuedCredentialRO_0000056Iterator.getRO_0000056());
		} catch (Exception e) {
