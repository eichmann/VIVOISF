...
public class PostdocPositionCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCodeISO2Iterator.class);
