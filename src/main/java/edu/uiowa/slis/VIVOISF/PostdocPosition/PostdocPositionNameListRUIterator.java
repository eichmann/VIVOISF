...
public class PostdocPositionNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameListRUIterator.class);
