...
public class PostdocPositionRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionRankIterator.class);
