...
public class PostdocPositionNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameCurrencyENIterator.class);
