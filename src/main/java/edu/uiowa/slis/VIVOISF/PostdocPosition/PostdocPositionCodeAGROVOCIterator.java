...
public class PostdocPositionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCodeAGROVOCIterator.class);
