...
public class PostdocPositionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCodeFAOSTATIterator.class);
