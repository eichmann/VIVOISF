...
public class PostdocPositionCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCodeISO3Iterator.class);
