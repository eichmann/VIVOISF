...
public class PostdocPositionNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameListARIterator.class);
