...
public class PostdocPositionRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocPositionRO_0000056Iterator.getType());
		} catch (Exception e) {
