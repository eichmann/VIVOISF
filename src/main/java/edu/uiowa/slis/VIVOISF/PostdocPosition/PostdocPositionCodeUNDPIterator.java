...
public class PostdocPositionCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCodeUNDPIterator.class);
