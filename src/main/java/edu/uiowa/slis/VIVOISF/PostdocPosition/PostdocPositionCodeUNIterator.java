...
public class PostdocPositionCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCodeUNIterator.class);
