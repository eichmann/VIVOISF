...
public class PostdocPositionNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameOfficialITIterator.class);
