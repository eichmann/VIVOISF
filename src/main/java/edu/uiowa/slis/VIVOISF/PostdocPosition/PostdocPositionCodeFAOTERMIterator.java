...
public class PostdocPositionCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCodeFAOTERMIterator.class);
