...
public class PostdocPositionGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionGDPUnitIterator.class);
