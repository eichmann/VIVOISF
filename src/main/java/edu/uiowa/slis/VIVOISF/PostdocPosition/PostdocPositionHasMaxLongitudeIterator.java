...
public class PostdocPositionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionHasMaxLongitudeIterator.class);
