...
public class PostdocPositionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionLandAreaNotesIterator.class);
