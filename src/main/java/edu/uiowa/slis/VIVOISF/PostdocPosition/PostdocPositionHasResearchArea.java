...
public class PostdocPositionHasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionHasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionHasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocPositionHasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
