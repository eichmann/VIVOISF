...
public class PostdocPositionNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameCurrencyRUIterator.class);
