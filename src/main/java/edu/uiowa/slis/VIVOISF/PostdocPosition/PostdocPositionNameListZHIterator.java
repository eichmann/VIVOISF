...
public class PostdocPositionNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameListZHIterator.class);
