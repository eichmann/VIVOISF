...
public class PostdocPositionHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionHasMaxLatitudeIterator.class);
