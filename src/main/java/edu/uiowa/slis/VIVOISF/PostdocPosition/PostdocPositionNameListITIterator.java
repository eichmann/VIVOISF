...
public class PostdocPositionNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameListITIterator.class);
