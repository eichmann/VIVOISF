...
public class PostdocPositionRelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionRelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionRelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocPositionRelatesIterator.getType());
		} catch (Exception e) {
