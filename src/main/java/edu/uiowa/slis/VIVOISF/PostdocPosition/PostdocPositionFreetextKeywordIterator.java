...
public class PostdocPositionFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionFreetextKeywordIterator.class);
