...
public class PostdocPositionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionLandAreaYearIterator.class);
