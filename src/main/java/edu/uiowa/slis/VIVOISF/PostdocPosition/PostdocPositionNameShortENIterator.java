...
public class PostdocPositionNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameShortENIterator.class);
