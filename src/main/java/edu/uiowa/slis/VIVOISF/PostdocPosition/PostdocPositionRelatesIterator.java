...
public class PostdocPositionRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in PostdocPositionRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PostdocPositionRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in PostdocPositionRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PostdocPositionRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PostdocPositionRelates doEndTag", e);
			throw new JspTagException("Exception raised in PostdocPositionRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to PostdocPositionRelatesIterator");
