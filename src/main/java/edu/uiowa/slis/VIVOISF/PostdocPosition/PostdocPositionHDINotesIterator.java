...
public class PostdocPositionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionHDINotesIterator.class);
