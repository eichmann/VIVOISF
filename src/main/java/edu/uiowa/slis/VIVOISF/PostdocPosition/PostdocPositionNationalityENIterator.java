...
public class PostdocPositionNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNationalityENIterator.class);
