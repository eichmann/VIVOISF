...
public class PostdocPositionNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameOfficialESIterator.class);
