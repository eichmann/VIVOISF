...
public class PostdocPositionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionHasMinLongitudeIterator.class);
