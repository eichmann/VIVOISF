...
public class PostdocPositionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCodeDBPediaIDIterator.class);
