...
public class PostdocPositionHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionHDITotalIterator.class);
