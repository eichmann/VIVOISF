...
public class PostdocPositionDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionDescriptionIterator.class);
