...
public class PostdocPositionNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameShortRUIterator.class);
