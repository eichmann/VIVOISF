...
public class PostdocPositionAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionAgriculturalAreaYearIterator.class);
