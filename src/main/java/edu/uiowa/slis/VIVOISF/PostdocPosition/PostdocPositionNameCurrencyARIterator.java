...
public class PostdocPositionNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameCurrencyARIterator.class);
