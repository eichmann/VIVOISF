...
public class PostdocPositionGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionGDPYearIterator.class);
