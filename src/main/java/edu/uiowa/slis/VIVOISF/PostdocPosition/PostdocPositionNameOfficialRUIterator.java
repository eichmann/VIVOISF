...
public class PostdocPositionNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameOfficialRUIterator.class);
