...
public class PostdocPositionCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCodeGAULIterator.class);
