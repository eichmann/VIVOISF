...
public class PostdocPositionNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNationalityFRIterator.class);
