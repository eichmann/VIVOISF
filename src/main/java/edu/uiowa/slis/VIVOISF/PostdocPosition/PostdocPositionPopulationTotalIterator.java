...
public class PostdocPositionPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionPopulationTotalIterator.class);
