...
public class PostdocPositionLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionLandAreaUnitIterator.class);
