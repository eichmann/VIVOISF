...
public class PostdocPositionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameListFRIterator.class);
