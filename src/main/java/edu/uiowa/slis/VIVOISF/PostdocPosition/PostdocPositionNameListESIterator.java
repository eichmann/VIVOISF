...
public class PostdocPositionNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameListESIterator.class);
