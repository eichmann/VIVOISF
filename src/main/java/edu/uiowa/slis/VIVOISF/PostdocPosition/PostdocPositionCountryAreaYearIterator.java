...
public class PostdocPositionCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCountryAreaYearIterator.class);
