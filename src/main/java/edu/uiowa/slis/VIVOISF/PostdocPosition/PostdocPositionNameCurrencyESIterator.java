...
public class PostdocPositionNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameCurrencyESIterator.class);
