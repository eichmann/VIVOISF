...
public class PostdocPositionNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameShortESIterator.class);
