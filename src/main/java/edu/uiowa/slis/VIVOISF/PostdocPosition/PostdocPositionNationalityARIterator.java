...
public class PostdocPositionNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNationalityARIterator.class);
