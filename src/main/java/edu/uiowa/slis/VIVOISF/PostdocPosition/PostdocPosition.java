...
public class PostdocPosition extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPosition currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPosition.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			PostdocPositionIterator thePostdocPositionIterator = (PostdocPositionIterator) findAncestorWithClass(this, PostdocPositionIterator.class);

			if (thePostdocPositionIterator != null) {
				subjectURI = thePostdocPositionIterator.getSubjectURI();
				label = thePostdocPositionIterator.getLabel();
			}
			...
			if (thePostdocPositionIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in PostdocPosition doStartTag", e);
			throw new JspTagException("Exception raised in PostdocPosition doStartTag");
		} finally {
			freeConnection();
		}
