...
public class PostdocPositionNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameOfficialENIterator.class);
