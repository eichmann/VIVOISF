...
public class PostdocPositionNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNationalityITIterator.class);
