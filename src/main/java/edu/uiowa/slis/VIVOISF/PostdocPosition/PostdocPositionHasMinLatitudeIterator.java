...
public class PostdocPositionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionHasMinLatitudeIterator.class);
