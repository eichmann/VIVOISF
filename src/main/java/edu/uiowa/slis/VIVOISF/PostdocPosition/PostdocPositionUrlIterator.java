...
public class PostdocPositionUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionUrlIterator.class);
