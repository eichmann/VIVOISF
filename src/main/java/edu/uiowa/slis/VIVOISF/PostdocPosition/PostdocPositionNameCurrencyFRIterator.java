...
public class PostdocPositionNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameCurrencyFRIterator.class);
