...
public class PostdocPositionNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameShortARIterator.class);
