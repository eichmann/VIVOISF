...
public class PostdocPositionCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCodeCurrencyIterator.class);
