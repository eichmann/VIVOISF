...
public class PostdocPositionCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionCountryAreaUnitIterator.class);
