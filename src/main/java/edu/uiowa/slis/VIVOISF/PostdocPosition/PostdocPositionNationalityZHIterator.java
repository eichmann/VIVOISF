...
public class PostdocPositionNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNationalityZHIterator.class);
