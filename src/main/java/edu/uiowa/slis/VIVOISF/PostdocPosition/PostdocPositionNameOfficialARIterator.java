...
public class PostdocPositionNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameOfficialARIterator.class);
