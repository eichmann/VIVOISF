...
public class PostdocPositionPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionPopulationUnitIterator.class);
