...
public class PostdocPositionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionLandAreaTotalIterator.class);
