...
public class PostdocPositionNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameCurrencyITIterator.class);
