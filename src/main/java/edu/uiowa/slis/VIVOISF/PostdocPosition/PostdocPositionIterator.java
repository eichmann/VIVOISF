...
public class PostdocPositionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://vivoweb.org/ontology/core#PostdocPosition> . "+
