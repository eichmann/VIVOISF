...
public class PostdocPositionNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionNameShortITIterator.class);
