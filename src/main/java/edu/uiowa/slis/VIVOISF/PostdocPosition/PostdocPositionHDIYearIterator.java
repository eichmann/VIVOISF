...
public class PostdocPositionHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionHDIYearIterator.class);
