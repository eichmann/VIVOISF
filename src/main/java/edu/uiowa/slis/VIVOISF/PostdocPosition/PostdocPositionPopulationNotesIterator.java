...
public class PostdocPositionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPositionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPositionPopulationNotesIterator.class);
