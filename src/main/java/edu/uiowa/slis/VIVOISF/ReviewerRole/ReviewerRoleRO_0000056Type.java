...
public class ReviewerRoleRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewerRoleRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewerRoleRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReviewerRoleRO_0000056Iterator.getType());
		} catch (Exception e) {
