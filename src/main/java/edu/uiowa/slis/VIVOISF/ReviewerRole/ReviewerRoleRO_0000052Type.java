...
public class ReviewerRoleRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewerRoleRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewerRoleRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReviewerRoleRO_0000052Iterator.getType());
		} catch (Exception e) {
