...
public class F1000LinkUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static F1000LinkUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(F1000LinkUrlIterator.class);
