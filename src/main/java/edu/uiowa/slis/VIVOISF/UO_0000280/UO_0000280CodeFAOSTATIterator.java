...
public class UO_0000280CodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CodeFAOSTATIterator.class);
