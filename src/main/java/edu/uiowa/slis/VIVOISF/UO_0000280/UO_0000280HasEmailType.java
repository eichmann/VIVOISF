...
public class UO_0000280HasEmailType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HasEmailType currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HasEmailType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280HasEmailIterator.getType());
		} catch (Exception e) {
