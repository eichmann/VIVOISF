...
public class UO_0000280TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280TheAbstractIterator.class);
