...
public class UO_0000280LandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280LandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280LandAreaTotalIterator.class);
