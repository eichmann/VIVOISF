...
public class UO_0000280AgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280AgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280AgriculturalAreaUnitIterator.class);
