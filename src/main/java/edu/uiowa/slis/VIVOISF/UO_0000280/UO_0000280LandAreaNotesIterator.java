...
public class UO_0000280LandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280LandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280LandAreaNotesIterator.class);
