...
public class UO_0000280NameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameCurrencyENIterator.class);
