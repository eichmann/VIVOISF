...
public class UO_0000280NationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NationalityESIterator.class);
