...
public class UO_0000280NameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameShortFRIterator.class);
