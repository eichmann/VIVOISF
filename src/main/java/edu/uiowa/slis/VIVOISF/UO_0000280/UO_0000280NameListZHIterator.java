...
public class UO_0000280NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameListZHIterator.class);
