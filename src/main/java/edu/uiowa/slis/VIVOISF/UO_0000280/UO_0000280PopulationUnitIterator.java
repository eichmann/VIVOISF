...
public class UO_0000280PopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280PopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280PopulationUnitIterator.class);
