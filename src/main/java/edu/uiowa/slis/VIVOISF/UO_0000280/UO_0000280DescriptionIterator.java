...
public class UO_0000280DescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280DescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280DescriptionIterator.class);
