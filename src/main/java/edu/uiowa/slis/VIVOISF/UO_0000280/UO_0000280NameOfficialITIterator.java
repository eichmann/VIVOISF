...
public class UO_0000280NameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameOfficialITIterator.class);
