...
public class UO_0000280NameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameCurrencyITIterator.class);
