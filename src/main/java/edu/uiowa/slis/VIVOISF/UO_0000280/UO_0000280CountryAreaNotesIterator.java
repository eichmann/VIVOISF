...
public class UO_0000280CountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CountryAreaNotesIterator.class);
