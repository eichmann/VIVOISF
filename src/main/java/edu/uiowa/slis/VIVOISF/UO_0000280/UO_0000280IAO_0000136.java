...
public class UO_0000280IAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280IAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280IAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280IAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
