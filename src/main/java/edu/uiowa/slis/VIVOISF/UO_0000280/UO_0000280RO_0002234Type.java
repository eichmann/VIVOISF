...
public class UO_0000280RO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280RO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280RO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280RO_0002234Iterator.getType());
		} catch (Exception e) {
