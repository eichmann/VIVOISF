...
public class UO_0000280LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280LandAreaYearIterator.class);
