...
public class UO_0000280NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameListENIterator.class);
