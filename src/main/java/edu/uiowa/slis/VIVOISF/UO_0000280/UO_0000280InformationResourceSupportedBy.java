...
public class UO_0000280InformationResourceSupportedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280InformationResourceSupportedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280InformationResourceSupportedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280InformationResourceSupportedByIterator.getInformationResourceSupportedBy());
		} catch (Exception e) {
