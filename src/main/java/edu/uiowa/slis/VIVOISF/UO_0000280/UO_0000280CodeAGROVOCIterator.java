...
public class UO_0000280CodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CodeAGROVOCIterator.class);
