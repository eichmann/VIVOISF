...
public class UO_0000280UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280UrlIterator.class);
