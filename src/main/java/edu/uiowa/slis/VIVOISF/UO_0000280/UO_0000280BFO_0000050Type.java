...
public class UO_0000280BFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280BFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280BFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280BFO_0000050Iterator.getType());
		} catch (Exception e) {
