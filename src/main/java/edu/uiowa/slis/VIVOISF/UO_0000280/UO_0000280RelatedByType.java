...
public class UO_0000280RelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280RelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280RelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280RelatedByIterator.getType());
		} catch (Exception e) {
