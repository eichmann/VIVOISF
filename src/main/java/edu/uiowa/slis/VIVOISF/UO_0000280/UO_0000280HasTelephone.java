...
public class UO_0000280HasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280HasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
