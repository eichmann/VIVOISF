...
public class UO_0000280NameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameCurrencyESIterator.class);
