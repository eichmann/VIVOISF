...
public class UO_0000280IAO_0000039Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280IAO_0000039Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280IAO_0000039Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280IAO_0000039InverseIterator.getIAO_0000039Inverse());
		} catch (Exception e) {
