...
public class UO_0000280HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HDITotalIterator.class);
