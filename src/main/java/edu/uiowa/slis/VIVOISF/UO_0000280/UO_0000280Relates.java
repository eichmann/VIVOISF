...
public class UO_0000280Relates extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280Relates currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280Relates.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280RelatesIterator.getRelates());
		} catch (Exception e) {
