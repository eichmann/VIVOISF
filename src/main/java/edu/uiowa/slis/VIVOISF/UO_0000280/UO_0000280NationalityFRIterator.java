...
public class UO_0000280NationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NationalityFRIterator.class);
