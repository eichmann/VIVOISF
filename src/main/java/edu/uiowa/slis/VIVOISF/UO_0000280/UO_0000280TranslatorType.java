...
public class UO_0000280TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280TranslatorIterator.getType());
		} catch (Exception e) {
