...
public class UO_0000280NameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameListESIterator.class);
