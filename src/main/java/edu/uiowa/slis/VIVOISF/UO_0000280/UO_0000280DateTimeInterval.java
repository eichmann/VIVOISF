...
public class UO_0000280DateTimeInterval extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280DateTimeInterval currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280DateTimeInterval.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280DateTimeIntervalIterator.getDateTimeInterval());
		} catch (Exception e) {
