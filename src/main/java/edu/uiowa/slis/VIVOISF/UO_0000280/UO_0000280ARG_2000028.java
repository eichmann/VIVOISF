...
public class UO_0000280ARG_2000028 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280ARG_2000028 currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280ARG_2000028.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280ARG_2000028Iterator.getARG_2000028());
		} catch (Exception e) {
