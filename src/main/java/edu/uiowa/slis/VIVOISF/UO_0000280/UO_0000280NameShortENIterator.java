...
public class UO_0000280NameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameShortENIterator.class);
