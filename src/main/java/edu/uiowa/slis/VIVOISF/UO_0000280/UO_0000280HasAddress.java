...
public class UO_0000280HasAddress extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HasAddress currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HasAddress.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280HasAddressIterator.getHasAddress());
		} catch (Exception e) {
