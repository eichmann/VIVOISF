...
public class UO_0000280NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameListITIterator.class);
