...
public class UO_0000280GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280GDPYearIterator.class);
