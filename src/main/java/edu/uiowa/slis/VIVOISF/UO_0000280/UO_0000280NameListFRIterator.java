...
public class UO_0000280NameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameListFRIterator.class);
