...
public class UO_0000280PopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280PopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280PopulationTotalIterator.class);
