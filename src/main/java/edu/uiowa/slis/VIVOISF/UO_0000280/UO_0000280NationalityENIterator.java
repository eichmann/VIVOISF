...
public class UO_0000280NationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NationalityENIterator.class);
