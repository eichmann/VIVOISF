...
public class UO_0000280CountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CountryAreaTotalIterator.class);
