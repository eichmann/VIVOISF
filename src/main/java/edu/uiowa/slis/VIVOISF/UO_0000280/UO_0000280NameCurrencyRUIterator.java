...
public class UO_0000280NameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameCurrencyRUIterator.class);
