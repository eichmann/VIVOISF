...
public class UO_0000280HasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HasMaxLongitudeIterator.class);
