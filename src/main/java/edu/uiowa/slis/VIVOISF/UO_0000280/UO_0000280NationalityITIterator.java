...
public class UO_0000280NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NationalityITIterator.class);
