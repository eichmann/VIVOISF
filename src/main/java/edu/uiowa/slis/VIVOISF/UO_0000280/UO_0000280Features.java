...
public class UO_0000280Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280Features currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280FeaturesIterator.getFeatures());
		} catch (Exception e) {
