...
public class UO_0000280NameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameShortITIterator.class);
