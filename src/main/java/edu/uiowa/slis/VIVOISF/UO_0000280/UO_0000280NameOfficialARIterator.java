...
public class UO_0000280NameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameOfficialARIterator.class);
