...
public class UO_0000280RO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280RO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280RO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280RO_0001015Iterator.getType());
		} catch (Exception e) {
