...
public class UO_0000280CodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CodeCurrencyIterator.class);
