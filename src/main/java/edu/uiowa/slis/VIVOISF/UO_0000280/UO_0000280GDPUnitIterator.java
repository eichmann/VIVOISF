...
public class UO_0000280GDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280GDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280GDPUnitIterator.class);
