...
public class UO_0000280HasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280HasResearchAreaIterator.getType());
		} catch (Exception e) {
