...
public class UO_0000280CodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CodeDBPediaIDIterator.class);
