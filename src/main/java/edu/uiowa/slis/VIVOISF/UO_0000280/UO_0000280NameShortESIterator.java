...
public class UO_0000280NameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameShortESIterator.class);
