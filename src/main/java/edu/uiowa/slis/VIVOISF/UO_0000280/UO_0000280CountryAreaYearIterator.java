...
public class UO_0000280CountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CountryAreaYearIterator.class);
