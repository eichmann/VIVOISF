...
public class UO_0000280NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameCurrencyARIterator.class);
