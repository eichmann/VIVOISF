...
public class UO_0000280NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NationalityARIterator.class);
