...
public class UO_0000280PopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280PopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280PopulationYearIterator.class);
