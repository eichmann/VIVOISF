...
public class UO_0000280CodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CodeGAULIterator.class);
