...
public class UO_0000280CountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CountryAreaUnitIterator.class);
