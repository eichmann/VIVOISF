...
public class UO_0000280HasName extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HasName currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HasName.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280HasNameIterator.getHasName());
		} catch (Exception e) {
