...
public class UO_0000280CodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CodeFAOTERMIterator.class);
