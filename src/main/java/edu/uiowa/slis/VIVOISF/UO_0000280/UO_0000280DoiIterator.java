...
public class UO_0000280DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280DoiIterator.class);
