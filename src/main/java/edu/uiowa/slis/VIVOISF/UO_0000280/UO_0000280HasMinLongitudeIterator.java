...
public class UO_0000280HasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HasMinLongitudeIterator.class);
