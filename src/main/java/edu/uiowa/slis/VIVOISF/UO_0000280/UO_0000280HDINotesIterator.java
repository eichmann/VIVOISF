...
public class UO_0000280HDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HDINotesIterator.class);
