...
public class UO_0000280RO_0002353 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280RO_0002353 currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280RO_0002353.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280RO_0002353Iterator.getRO_0002353());
		} catch (Exception e) {
