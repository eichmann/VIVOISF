...
public class UO_0000280NameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameListARIterator.class);
