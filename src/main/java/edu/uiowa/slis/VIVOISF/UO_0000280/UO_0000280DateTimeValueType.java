...
public class UO_0000280DateTimeValueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280DateTimeValueType currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280DateTimeValueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280DateTimeValueIterator.getType());
		} catch (Exception e) {
