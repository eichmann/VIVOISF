...
public class UO_0000280HasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HasMinLatitudeIterator.class);
