...
public class UO_0000280LandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280LandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280LandAreaUnitIterator.class);
