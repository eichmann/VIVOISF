...
public class UO_0000280HasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HasMaxLatitudeIterator.class);
