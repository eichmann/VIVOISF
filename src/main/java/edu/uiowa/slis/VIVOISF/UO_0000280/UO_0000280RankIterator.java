...
public class UO_0000280RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280RankIterator.class);
