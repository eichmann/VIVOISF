...
public class UO_0000280NationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NationalityRUIterator.class);
