...
public class UO_0000280CodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CodeISO3Iterator.class);
