...
public class UO_0000280NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameListRUIterator.class);
