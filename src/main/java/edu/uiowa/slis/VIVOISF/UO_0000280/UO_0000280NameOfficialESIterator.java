...
public class UO_0000280NameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameOfficialESIterator.class);
