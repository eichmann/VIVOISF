...
public class UO_0000280NameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameOfficialFRIterator.class);
