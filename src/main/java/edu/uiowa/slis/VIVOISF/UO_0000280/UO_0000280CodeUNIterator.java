...
public class UO_0000280CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CodeUNIterator.class);
