...
public class UO_0000280PopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280PopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280PopulationNotesIterator.class);
