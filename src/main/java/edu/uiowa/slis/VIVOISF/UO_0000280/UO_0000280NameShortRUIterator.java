...
public class UO_0000280NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameShortRUIterator.class);
