...
public class UO_0000280NameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameShortARIterator.class);
