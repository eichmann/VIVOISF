...
public class UO_0000280NameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameCurrencyZHIterator.class);
