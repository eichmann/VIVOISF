...
public class UO_0000280CodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280CodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280CodeUNDPIterator.class);
