...
public class UO_0000280NameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameOfficialENIterator.class);
