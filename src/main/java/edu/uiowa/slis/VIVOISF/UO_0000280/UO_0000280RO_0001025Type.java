...
public class UO_0000280RO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280RO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280RO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUO_0000280RO_0001025Iterator.getType());
		} catch (Exception e) {
