...
public class UO_0000280HDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280HDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280HDIYearIterator.class);
