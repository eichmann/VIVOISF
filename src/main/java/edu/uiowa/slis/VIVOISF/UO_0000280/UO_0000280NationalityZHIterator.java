...
public class UO_0000280NationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NationalityZHIterator.class);
