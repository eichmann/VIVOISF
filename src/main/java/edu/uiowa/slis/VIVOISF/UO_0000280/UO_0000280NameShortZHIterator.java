...
public class UO_0000280NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UO_0000280NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UO_0000280NameShortZHIterator.class);
