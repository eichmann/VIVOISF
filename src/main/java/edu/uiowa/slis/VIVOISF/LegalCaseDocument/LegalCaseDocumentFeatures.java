...
public class LegalCaseDocumentFeatures extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentFeatures currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentFeatures.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalCaseDocumentFeaturesIterator.getFeatures());
		} catch (Exception e) {
