...
public class LegalCaseDocumentEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentEditionIterator.class);
