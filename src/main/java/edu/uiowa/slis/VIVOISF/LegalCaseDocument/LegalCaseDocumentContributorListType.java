...
public class LegalCaseDocumentContributorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentContributorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentContributorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalCaseDocumentContributorListIterator.getType());
		} catch (Exception e) {
