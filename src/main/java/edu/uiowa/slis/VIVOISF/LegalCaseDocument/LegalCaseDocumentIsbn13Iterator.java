...
public class LegalCaseDocumentIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentIsbn13Iterator.class);
