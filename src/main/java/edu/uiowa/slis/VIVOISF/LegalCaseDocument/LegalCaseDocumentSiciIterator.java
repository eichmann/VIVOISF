...
public class LegalCaseDocumentSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentSiciIterator.class);
