...
public class LegalCaseDocumentOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentOclcnumIterator.class);
