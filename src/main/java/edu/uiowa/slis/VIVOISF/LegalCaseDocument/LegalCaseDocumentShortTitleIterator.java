...
public class LegalCaseDocumentShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentShortTitleIterator.class);
