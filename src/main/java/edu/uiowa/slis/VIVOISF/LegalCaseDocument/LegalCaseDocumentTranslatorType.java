...
public class LegalCaseDocumentTranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentTranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentTranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalCaseDocumentTranslatorIterator.getType());
		} catch (Exception e) {
