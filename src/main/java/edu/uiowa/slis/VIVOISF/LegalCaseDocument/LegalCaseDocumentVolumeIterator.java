...
public class LegalCaseDocumentVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentVolumeIterator.class);
