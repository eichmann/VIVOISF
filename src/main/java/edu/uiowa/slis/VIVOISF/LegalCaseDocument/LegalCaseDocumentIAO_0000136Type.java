...
public class LegalCaseDocumentIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalCaseDocumentIAO_0000136Iterator.getType());
		} catch (Exception e) {
