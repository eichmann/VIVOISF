...
public class LegalCaseDocumentPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentPagesIterator.class);
