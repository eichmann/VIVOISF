...
public class LegalCaseDocumentERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentERO_0000045Iterator.class);
