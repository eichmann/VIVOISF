...
public class LegalCaseDocumentLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentLccnIterator.class);
