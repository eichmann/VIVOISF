...
public class LegalCaseDocumentNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentNumberIterator.class);
