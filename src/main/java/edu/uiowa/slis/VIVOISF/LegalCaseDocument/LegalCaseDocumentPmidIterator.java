...
public class LegalCaseDocumentPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentPmidIterator.class);
