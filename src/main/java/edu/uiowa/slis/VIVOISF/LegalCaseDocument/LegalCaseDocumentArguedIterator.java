...
public class LegalCaseDocumentArguedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentArguedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentArguedIterator.class);
