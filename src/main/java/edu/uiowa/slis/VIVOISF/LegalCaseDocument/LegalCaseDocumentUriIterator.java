...
public class LegalCaseDocumentUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentUriIterator.class);
