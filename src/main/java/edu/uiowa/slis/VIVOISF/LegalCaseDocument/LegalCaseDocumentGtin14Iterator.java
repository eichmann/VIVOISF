...
public class LegalCaseDocumentGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentGtin14Iterator.class);
