...
public class LegalCaseDocumentPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentPageEndIterator.class);
