...
public class LegalCaseDocumentShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentShortDescriptionIterator.class);
