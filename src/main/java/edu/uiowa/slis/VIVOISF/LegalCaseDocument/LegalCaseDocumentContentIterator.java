...
public class LegalCaseDocumentContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentContentIterator.class);
