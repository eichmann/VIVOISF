...
public class LegalCaseDocumentSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentSectionIterator.class);
