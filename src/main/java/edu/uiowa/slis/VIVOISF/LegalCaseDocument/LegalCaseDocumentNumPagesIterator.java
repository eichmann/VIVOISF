...
public class LegalCaseDocumentNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentNumPagesIterator.class);
