...
public class LegalCaseDocumentPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentPageStartIterator.class);
