...
public class LegalCaseDocumentIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentIdentifierIterator.class);
