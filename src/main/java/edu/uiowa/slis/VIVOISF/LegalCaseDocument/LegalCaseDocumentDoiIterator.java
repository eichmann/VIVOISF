...
public class LegalCaseDocumentDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentDoiIterator.class);
