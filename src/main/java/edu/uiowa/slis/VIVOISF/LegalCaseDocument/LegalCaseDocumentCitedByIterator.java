...
public class LegalCaseDocumentCitedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(LegalCaseDocumentCitedByIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LegalCaseDocumentCitedByIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LegalCaseDocumentCitedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LegalCaseDocumentCitedBy doEndTag", e);
			throw new JspTagException("Exception raised in LegalCaseDocumentCitedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
