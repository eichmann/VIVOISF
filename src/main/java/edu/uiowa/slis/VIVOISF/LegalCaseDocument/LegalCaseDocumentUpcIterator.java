...
public class LegalCaseDocumentUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentUpcIterator.class);
