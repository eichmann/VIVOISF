...
public class LegalCaseDocumentIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentIsbn10Iterator.class);
