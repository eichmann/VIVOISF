...
public class LegalCaseDocumentAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentAsinIterator.class);
