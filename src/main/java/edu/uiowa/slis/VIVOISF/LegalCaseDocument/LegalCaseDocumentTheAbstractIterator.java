...
public class LegalCaseDocumentTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentTheAbstractIterator.class);
