...
public class LegalCaseDocumentRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalCaseDocumentRO_0000056Iterator.getType());
		} catch (Exception e) {
