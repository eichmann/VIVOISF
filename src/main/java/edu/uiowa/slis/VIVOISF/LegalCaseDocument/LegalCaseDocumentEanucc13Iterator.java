...
public class LegalCaseDocumentEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalCaseDocumentEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalCaseDocumentEanucc13Iterator.class);
