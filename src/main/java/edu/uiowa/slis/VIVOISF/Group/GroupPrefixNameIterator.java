...
public class GroupPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupPrefixNameIterator.class);
