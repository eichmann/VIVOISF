...
public class GroupHasCollaboratorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupHasCollaboratorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupHasCollaboratorIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in GroupHasCollaboratorIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in GroupHasCollaboratorIterator doStartTag");
		}
