...
public class GroupIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGroupIAO_0000136Iterator.getType());
		} catch (Exception e) {
