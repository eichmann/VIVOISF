...
public class GroupCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupCodeUNIterator.class);
