...
public class GroupNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupNameListZHIterator.class);
