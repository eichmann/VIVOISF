...
public class GroupNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupNameShortRUIterator.class);
