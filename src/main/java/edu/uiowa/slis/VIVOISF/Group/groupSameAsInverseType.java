...
public class groupSameAsInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupSameAsInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(groupSameAsInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegroupSameAsInverseIterator.getType());
		} catch (Exception e) {
