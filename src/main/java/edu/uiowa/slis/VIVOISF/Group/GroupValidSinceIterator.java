...
public class GroupValidSinceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupValidSinceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupValidSinceIterator.class);
