...
public class GroupCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupCodeAGROVOCIterator.class);
