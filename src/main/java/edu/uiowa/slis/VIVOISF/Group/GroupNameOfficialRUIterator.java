...
public class GroupNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupNameOfficialRUIterator.class);
