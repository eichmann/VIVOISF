...
public class GroupCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupCodeFAOTERMIterator.class);
