...
public class groupHasCodeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHasCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHasCodeIterator.class);
