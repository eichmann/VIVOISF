...
public class GroupDirectorInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupDirectorInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupDirectorInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGroupDirectorInverseIterator.getDirectorInverse());
		} catch (Exception e) {
