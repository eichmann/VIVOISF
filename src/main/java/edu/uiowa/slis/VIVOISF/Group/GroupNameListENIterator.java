...
public class GroupNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupNameListENIterator.class);
