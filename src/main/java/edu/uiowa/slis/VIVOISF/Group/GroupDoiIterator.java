...
public class GroupDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupDoiIterator.class);
