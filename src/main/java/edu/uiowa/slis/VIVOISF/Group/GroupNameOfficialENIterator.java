...
public class GroupNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupNameOfficialENIterator.class);
