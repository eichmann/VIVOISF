...
public class GroupNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupNameOfficialESIterator.class);
