...
public class groupHasShortNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHasShortNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHasShortNameIterator.class);
