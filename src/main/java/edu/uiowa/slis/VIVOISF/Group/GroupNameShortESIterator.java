...
public class GroupNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupNameShortESIterator.class);
