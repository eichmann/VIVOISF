...
public class groupOrcidIdInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupOrcidIdInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(groupOrcidIdInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegroupOrcidIdInverseIterator.getOrcidIdInverse());
		} catch (Exception e) {
