...
public class GroupNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupNameShortZHIterator.class);
