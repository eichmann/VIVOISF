...
public class groupHasOfficialNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHasOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHasOfficialNameIterator.class);
