...
public class GroupSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupSuffixNameIterator.class);
