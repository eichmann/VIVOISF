...
public class GroupNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupNameListARIterator.class);
