...
public class groupSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupSameAsIterator.class);
