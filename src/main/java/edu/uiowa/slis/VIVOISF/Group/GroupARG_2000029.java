...
public class GroupARG_2000029 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GroupARG_2000029 currentInstance = null;
	private static final Log log = LogFactory.getLog(GroupARG_2000029.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGroupARG_2000029Iterator.getARG_2000029());
		} catch (Exception e) {
