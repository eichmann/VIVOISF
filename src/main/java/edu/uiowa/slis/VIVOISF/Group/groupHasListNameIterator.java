...
public class groupHasListNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHasListNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHasListNameIterator.class);
