...
public class ManualEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualEanucc13Iterator.class);
