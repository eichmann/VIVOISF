...
public class ManualIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualIsbn10Iterator.class);
