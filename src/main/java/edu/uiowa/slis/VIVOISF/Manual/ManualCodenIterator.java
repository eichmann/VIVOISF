...
public class ManualCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualCodenIterator.class);
