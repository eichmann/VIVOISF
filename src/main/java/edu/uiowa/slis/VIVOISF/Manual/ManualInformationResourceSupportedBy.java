...
public class ManualInformationResourceSupportedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualInformationResourceSupportedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualInformationResourceSupportedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theManualInformationResourceSupportedByIterator.getInformationResourceSupportedBy());
		} catch (Exception e) {
