...
public class ManualPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualPageStartIterator.class);
