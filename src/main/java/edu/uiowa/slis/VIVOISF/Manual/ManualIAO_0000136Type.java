...
public class ManualIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theManualIAO_0000136Iterator.getType());
		} catch (Exception e) {
