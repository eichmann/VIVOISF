...
public class ManualPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualPageEndIterator.class);
