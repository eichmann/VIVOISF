...
public class ManualTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualTheAbstractIterator.class);
