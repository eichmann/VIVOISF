...
public class ManualARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualARG_0000001Iterator.class);
