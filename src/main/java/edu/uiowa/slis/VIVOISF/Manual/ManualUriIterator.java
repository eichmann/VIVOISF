...
public class ManualUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualUriIterator.class);
