...
public class ManualShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualShortTitleIterator.class);
