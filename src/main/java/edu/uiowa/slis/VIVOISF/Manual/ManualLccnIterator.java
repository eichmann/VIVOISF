...
public class ManualLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualLccnIterator.class);
