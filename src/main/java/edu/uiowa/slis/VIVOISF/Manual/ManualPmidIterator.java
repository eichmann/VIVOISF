...
public class ManualPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualPmidIterator.class);
