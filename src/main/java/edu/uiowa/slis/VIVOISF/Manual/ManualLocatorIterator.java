...
public class ManualLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualLocatorIterator.class);
