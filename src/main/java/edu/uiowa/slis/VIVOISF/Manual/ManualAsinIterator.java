...
public class ManualAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualAsinIterator.class);
