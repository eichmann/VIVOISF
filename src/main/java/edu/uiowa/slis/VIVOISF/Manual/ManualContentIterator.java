...
public class ManualContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualContentIterator.class);
