...
public class ManualGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualGtin14Iterator.class);
