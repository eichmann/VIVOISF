...
public class ManualOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualOclcnumIterator.class);
