...
public class ManualDistributor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualDistributor currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualDistributor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theManualDistributorIterator.getDistributor());
		} catch (Exception e) {
