...
public class ManualRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theManualRO_0000056Iterator.getType());
		} catch (Exception e) {
