...
public class ManualIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualIdentifierIterator.class);
