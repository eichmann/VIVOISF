...
public class ManualNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualNumPagesIterator.class);
