...
public class ManualHasTranslationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualHasTranslationType currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualHasTranslationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theManualHasTranslationIterator.getType());
		} catch (Exception e) {
