...
public class ManualDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualDoiIterator.class);
