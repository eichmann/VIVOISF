...
public class ManualPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualPagesIterator.class);
