...
public class ManualHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualHandleIterator.class);
