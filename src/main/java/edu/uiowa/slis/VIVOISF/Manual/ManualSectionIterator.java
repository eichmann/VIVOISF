...
public class ManualSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualSectionIterator.class);
