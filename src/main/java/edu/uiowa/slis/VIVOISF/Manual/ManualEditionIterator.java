...
public class ManualEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualEditionIterator.class);
