...
public class ManualShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualShortDescriptionIterator.class);
