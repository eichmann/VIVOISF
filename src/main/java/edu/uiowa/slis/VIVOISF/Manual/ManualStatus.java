...
public class ManualStatus extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualStatus currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualStatus.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theManualStatusIterator.getStatus());
		} catch (Exception e) {
