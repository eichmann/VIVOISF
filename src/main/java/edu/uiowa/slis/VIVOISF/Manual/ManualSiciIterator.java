...
public class ManualSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManualSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManualSiciIterator.class);
