...
public class StudentARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentARG_2000028Iterator.getType());
		} catch (Exception e) {
