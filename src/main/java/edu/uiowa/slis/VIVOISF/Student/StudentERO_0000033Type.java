...
public class StudentERO_0000033Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentERO_0000033Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentERO_0000033Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentERO_0000033Iterator.getType());
		} catch (Exception e) {
