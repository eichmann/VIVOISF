...
public class StudentResearcherIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentResearcherIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentResearcherIdIterator.class);
