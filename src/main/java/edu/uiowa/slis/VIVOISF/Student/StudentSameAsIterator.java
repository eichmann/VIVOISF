...
public class StudentSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentSameAsIterator.class);
