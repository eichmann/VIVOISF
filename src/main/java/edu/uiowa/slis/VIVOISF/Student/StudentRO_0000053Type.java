...
public class StudentRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentRO_0000053Iterator.getType());
		} catch (Exception e) {
