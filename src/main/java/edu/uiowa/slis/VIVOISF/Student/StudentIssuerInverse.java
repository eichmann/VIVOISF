...
public class StudentIssuerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentIssuerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentIssuerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentIssuerInverseIterator.getIssuerInverse());
		} catch (Exception e) {
