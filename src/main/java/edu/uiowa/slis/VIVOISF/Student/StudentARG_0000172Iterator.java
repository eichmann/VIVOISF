...
public class StudentARG_0000172Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentARG_0000172Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentARG_0000172Iterator.class);
