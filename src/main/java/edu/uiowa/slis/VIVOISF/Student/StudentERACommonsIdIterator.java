...
public class StudentERACommonsIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentERACommonsIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentERACommonsIdIterator.class);
