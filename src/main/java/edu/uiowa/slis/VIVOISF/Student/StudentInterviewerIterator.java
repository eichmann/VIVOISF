...
public class StudentInterviewerIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentInterviewerIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentInterviewerIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in StudentInterviewerIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in StudentInterviewerIterator doStartTag");
		}
