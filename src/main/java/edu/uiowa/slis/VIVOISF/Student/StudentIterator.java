...
public class StudentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Student> . "+
