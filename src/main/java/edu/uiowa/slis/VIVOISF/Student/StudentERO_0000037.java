...
public class StudentERO_0000037 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentERO_0000037 currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentERO_0000037.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentERO_0000037Iterator.getERO_0000037());
		} catch (Exception e) {
