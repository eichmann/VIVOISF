...
public class StudentERO_0000397 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StudentERO_0000397 currentInstance = null;
	private static final Log log = LogFactory.getLog(StudentERO_0000397.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStudentERO_0000397Iterator.getERO_0000397());
		} catch (Exception e) {
