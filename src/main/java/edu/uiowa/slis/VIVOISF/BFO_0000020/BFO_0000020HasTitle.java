...
public class BFO_0000020HasTitle extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020HasTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020HasTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000020HasTitleIterator.getHasTitle());
		} catch (Exception e) {
