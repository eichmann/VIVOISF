...
public class BFO_0000020HasTelephoneType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020HasTelephoneType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020HasTelephoneType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000020HasTelephoneIterator.getType());
		} catch (Exception e) {
