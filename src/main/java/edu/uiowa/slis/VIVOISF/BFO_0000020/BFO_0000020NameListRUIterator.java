...
public class BFO_0000020NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameListRUIterator.class);
