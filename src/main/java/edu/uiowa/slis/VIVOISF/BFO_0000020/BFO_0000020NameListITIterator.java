...
public class BFO_0000020NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameListITIterator.class);
