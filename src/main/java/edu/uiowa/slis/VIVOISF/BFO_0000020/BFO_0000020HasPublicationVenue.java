...
public class BFO_0000020HasPublicationVenue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020HasPublicationVenue currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020HasPublicationVenue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000020HasPublicationVenueIterator.getHasPublicationVenue());
		} catch (Exception e) {
