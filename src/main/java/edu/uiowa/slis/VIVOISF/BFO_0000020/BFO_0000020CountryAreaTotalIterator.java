...
public class BFO_0000020CountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020CountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020CountryAreaTotalIterator.class);
