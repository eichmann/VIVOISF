...
public class BFO_0000020NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameListZHIterator.class);
