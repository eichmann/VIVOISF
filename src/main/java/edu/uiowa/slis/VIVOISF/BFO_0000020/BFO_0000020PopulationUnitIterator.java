...
public class BFO_0000020PopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020PopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020PopulationUnitIterator.class);
