...
public class BFO_0000020HasEmailType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020HasEmailType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020HasEmailType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000020HasEmailIterator.getType());
		} catch (Exception e) {
