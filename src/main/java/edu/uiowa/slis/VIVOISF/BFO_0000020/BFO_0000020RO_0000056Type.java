...
public class BFO_0000020RO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020RO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020RO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000020RO_0000056Iterator.getType());
		} catch (Exception e) {
