...
public class BFO_0000020NameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameCurrencyITIterator.class);
