...
public class BFO_0000020HasAddressType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020HasAddressType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020HasAddressType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000020HasAddressIterator.getType());
		} catch (Exception e) {
