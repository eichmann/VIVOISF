...
public class BFO_0000020HasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020HasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020HasMaxLongitudeIterator.class);
