...
public class BFO_0000020PopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020PopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020PopulationNotesIterator.class);
