...
public class BFO_0000020NameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameShortENIterator.class);
