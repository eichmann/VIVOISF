...
public class BFO_0000020NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameShortZHIterator.class);
