...
public class BFO_0000020NameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameOfficialENIterator.class);
