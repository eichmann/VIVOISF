...
public class BFO_0000020NameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameOfficialRUIterator.class);
