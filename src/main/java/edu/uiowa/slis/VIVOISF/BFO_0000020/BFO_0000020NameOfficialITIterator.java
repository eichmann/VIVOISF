...
public class BFO_0000020NameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameOfficialITIterator.class);
