...
public class BFO_0000020DateTimeIntervalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020DateTimeIntervalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020DateTimeIntervalIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000020DateTimeIntervalIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000020DateTimeIntervalIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000020DateTimeIntervalIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000020DateTimeIntervalIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000020DateTimeInterval doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000020DateTimeInterval doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000020DateTimeIntervalIterator");
