...
public class BFO_0000020RelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020RelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020RelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000020RelatesIterator.getType());
		} catch (Exception e) {
