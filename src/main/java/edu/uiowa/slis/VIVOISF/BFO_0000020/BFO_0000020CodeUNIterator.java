...
public class BFO_0000020CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020CodeUNIterator.class);
