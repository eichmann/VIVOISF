...
public class BFO_0000020NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameCurrencyARIterator.class);
