...
public class BFO_0000020DateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020DateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020DateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000020DateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
