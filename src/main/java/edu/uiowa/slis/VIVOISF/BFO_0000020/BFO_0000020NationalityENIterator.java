...
public class BFO_0000020NationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NationalityENIterator.class);
