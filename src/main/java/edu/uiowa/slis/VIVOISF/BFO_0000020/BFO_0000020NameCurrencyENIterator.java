...
public class BFO_0000020NameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameCurrencyENIterator.class);
