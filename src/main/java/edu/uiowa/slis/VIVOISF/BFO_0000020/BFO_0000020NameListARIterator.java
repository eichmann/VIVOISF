...
public class BFO_0000020NameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameListARIterator.class);
