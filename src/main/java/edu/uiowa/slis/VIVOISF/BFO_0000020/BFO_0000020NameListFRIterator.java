...
public class BFO_0000020NameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameListFRIterator.class);
