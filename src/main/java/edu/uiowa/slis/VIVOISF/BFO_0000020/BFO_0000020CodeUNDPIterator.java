...
public class BFO_0000020CodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020CodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020CodeUNDPIterator.class);
