...
public class BFO_0000020HasURLIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020HasURLIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020HasURLIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000020HasURLIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000020HasURLIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000020HasURLIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000020HasURLIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000020HasURL doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000020HasURL doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000020HasURLIterator");
