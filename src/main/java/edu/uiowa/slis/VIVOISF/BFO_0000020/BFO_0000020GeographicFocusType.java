...
public class BFO_0000020GeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020GeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020GeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000020GeographicFocusIterator.getType());
		} catch (Exception e) {
