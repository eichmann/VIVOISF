...
public class BFO_0000020PublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020PublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020PublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000020PublisherIterator.getType());
		} catch (Exception e) {
