...
public class BFO_0000020FreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020FreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020FreetextKeywordIterator.class);
