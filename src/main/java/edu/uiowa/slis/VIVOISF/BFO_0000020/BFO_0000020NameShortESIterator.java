...
public class BFO_0000020NameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NameShortESIterator.class);
