...
public class BFO_0000020GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020GDPNotesIterator.class);
