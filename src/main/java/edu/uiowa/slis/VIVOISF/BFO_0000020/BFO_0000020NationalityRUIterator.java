...
public class BFO_0000020NationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000020NationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000020NationalityRUIterator.class);
