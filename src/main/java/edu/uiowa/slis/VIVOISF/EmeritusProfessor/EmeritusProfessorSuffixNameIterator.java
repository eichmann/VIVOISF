...
public class EmeritusProfessorSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorSuffixNameIterator.class);
