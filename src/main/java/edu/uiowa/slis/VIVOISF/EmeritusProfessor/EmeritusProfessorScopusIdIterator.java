...
public class EmeritusProfessorScopusIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorScopusIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorScopusIdIterator.class);
