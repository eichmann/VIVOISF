...
public class EmeritusProfessorERACommonsIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorERACommonsIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorERACommonsIdIterator.class);
