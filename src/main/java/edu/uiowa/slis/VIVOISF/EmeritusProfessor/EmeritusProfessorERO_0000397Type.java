...
public class EmeritusProfessorERO_0000397Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorERO_0000397Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorERO_0000397Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusProfessorERO_0000397Iterator.getType());
		} catch (Exception e) {
