...
public class EmeritusProfessorResearcherIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorResearcherIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorResearcherIdIterator.class);
