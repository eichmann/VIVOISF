...
public class EmeritusProfessorARG_0000172Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorARG_0000172Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorARG_0000172Iterator.class);
