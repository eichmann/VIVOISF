...
public class EmeritusProfessorERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusProfessorERO_0000037Iterator.getType());
		} catch (Exception e) {
