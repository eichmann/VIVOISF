...
public class EmeritusProfessorPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorPrefixNameIterator.class);
