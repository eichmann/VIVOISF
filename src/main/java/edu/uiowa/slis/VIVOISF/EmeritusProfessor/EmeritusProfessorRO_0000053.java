...
public class EmeritusProfessorRO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorRO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorRO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusProfessorRO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
