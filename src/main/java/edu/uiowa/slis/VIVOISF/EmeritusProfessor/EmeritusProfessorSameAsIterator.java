...
public class EmeritusProfessorSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorSameAsIterator.class);
