...
public class EmeritusProfessorERO_0000033Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorERO_0000033Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorERO_0000033Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusProfessorERO_0000033Iterator.getType());
		} catch (Exception e) {
