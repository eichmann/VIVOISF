...
public class EmeritusProfessorFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusProfessorFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusProfessorFreetextKeywordIterator.class);
