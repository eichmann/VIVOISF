...
public class ARG_2000022RO_0000052 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000022RO_0000052 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000022RO_0000052.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000022RO_0000052Iterator.getRO_0000052());
		} catch (Exception e) {
