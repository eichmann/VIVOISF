...
public class CenterRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CenterRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CenterRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCenterRO_0000053Iterator.getType());
		} catch (Exception e) {
