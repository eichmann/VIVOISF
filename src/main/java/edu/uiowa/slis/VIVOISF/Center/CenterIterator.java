...
public class CenterIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CenterIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CenterIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Center> . "+
