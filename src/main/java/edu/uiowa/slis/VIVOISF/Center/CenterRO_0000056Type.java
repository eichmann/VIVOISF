...
public class CenterRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CenterRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CenterRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCenterRO_0000056Iterator.getType());
		} catch (Exception e) {
