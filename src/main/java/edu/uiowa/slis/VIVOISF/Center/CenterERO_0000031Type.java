...
public class CenterERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CenterERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CenterERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCenterERO_0000031Iterator.getType());
		} catch (Exception e) {
