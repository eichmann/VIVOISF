...
public class CenterSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CenterSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CenterSuffixNameIterator.class);
