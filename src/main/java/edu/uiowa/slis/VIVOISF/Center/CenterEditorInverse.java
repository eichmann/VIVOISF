...
public class CenterEditorInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CenterEditorInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(CenterEditorInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCenterEditorInverseIterator.getEditorInverse());
		} catch (Exception e) {
