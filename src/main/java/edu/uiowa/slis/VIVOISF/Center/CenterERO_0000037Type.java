...
public class CenterERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CenterERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CenterERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCenterERO_0000037Iterator.getType());
		} catch (Exception e) {
