...
public class CenterOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CenterOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(CenterOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCenterOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
