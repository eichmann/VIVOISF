...
public class CenterRelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CenterRelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(CenterRelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCenterRelatedByIterator.getType());
		} catch (Exception e) {
