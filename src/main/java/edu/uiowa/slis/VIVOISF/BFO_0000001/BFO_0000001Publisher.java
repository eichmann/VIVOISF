...
public class BFO_0000001Publisher extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001Publisher currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001Publisher.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001PublisherIterator.getPublisher());
		} catch (Exception e) {
