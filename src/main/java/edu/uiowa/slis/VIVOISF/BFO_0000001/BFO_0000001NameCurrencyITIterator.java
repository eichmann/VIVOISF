...
public class BFO_0000001NameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NameCurrencyITIterator.class);
