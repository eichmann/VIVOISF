...
public class BFO_0000001CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001CodeUNIterator.class);
