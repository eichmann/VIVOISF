...
public class BFO_0000001HasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001HasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001HasMinLatitudeIterator.class);
