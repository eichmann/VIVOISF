...
public class BFO_0000001HasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001HasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001HasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001HasPublicationVenueIterator.getType());
		} catch (Exception e) {
