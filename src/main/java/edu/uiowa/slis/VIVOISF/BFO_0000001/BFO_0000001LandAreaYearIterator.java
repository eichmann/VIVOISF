...
public class BFO_0000001LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001LandAreaYearIterator.class);
