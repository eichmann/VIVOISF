...
public class BFO_0000001HDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001HDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001HDINotesIterator.class);
