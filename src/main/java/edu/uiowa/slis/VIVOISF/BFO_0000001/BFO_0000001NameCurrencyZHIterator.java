...
public class BFO_0000001NameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NameCurrencyZHIterator.class);
