...
public class BFO_0000001DateTimeValueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001DateTimeValueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001DateTimeValueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001DateTimeValueIterator.getType());
		} catch (Exception e) {
