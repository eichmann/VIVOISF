...
public class BFO_0000001GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001GDPYearIterator.class);
