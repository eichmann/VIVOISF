...
public class BFO_0000001PublisherIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001PublisherIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001PublisherIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000001PublisherIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000001PublisherIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000001PublisherIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000001PublisherIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000001Publisher doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000001Publisher doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000001PublisherIterator");
