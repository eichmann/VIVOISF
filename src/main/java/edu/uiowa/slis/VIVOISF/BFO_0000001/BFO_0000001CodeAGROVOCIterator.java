...
public class BFO_0000001CodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001CodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001CodeAGROVOCIterator.class);
