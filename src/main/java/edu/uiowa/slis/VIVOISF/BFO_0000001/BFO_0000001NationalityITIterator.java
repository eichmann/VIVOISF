...
public class BFO_0000001NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NationalityITIterator.class);
