...
public class BFO_0000001CodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001CodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001CodeDBPediaIDIterator.class);
