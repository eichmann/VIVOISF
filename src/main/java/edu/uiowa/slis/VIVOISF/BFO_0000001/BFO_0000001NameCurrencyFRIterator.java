...
public class BFO_0000001NameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NameCurrencyFRIterator.class);
