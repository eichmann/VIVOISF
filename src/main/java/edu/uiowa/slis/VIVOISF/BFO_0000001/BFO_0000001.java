...
public class BFO_0000001 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001 currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			BFO_0000001Iterator theBFO_0000001Iterator = (BFO_0000001Iterator) findAncestorWithClass(this, BFO_0000001Iterator.class);

			if (theBFO_0000001Iterator != null) {
				subjectURI = theBFO_0000001Iterator.getSubjectURI();
				label = theBFO_0000001Iterator.getLabel();
			}
			...
			if (theBFO_0000001Iterator == null && subjectURI == null) {
			...
			log.error("Exception raised in BFO_0000001 doStartTag", e);
			throw new JspTagException("Exception raised in BFO_0000001 doStartTag");
		} finally {
			freeConnection();
		}
