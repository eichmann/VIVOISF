...
public class BFO_0000001DescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001DescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001DescriptionIterator.class);
