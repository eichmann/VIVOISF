...
public class BFO_0000001IssnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001IssnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001IssnIterator.class);
