...
public class BFO_0000001NameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NameOfficialARIterator.class);
