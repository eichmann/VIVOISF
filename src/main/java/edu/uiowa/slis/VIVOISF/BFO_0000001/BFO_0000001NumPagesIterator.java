...
public class BFO_0000001NumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NumPagesIterator.class);
