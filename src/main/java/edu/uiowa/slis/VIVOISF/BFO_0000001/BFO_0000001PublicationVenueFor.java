...
public class BFO_0000001PublicationVenueFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001PublicationVenueFor currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001PublicationVenueFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001PublicationVenueForIterator.getPublicationVenueFor());
		} catch (Exception e) {
