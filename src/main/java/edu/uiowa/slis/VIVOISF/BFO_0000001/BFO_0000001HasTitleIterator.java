...
public class BFO_0000001HasTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001HasTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001HasTitleIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000001HasTitleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000001HasTitleIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000001HasTitleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000001HasTitleIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000001HasTitle doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000001HasTitle doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000001HasTitleIterator");
