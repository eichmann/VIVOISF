...
public class BFO_0000001NationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NationalityZHIterator.class);
