...
public class BFO_0000001PopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001PopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001PopulationNotesIterator.class);
