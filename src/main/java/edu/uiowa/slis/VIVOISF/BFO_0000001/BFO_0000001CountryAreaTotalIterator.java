...
public class BFO_0000001CountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001CountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001CountryAreaTotalIterator.class);
