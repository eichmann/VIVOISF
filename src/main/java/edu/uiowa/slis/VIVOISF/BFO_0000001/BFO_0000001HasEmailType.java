...
public class BFO_0000001HasEmailType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001HasEmailType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001HasEmailType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001HasEmailIterator.getType());
		} catch (Exception e) {
