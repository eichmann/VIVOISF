...
public class BFO_0000001LandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001LandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001LandAreaNotesIterator.class);
