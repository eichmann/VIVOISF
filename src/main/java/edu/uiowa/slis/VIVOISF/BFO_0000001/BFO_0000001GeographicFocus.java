...
public class BFO_0000001GeographicFocus extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001GeographicFocus currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001GeographicFocus.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001GeographicFocusIterator.getGeographicFocus());
		} catch (Exception e) {
