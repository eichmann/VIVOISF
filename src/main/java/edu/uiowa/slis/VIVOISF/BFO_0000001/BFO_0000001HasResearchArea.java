...
public class BFO_0000001HasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001HasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001HasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001HasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
