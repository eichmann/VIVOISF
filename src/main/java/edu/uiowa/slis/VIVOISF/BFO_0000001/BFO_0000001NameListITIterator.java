...
public class BFO_0000001NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NameListITIterator.class);
