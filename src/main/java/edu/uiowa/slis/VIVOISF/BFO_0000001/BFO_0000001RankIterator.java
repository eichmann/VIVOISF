...
public class BFO_0000001RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001RankIterator.class);
