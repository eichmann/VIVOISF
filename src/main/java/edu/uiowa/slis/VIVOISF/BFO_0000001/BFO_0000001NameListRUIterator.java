...
public class BFO_0000001NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NameListRUIterator.class);
