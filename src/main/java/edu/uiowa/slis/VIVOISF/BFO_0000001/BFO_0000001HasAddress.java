...
public class BFO_0000001HasAddress extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001HasAddress currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001HasAddress.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001HasAddressIterator.getHasAddress());
		} catch (Exception e) {
