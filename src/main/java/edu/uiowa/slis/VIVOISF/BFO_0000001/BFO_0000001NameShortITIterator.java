...
public class BFO_0000001NameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NameShortITIterator.class);
