...
public class BFO_0000001HasTitle extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001HasTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001HasTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001HasTitleIterator.getHasTitle());
		} catch (Exception e) {
