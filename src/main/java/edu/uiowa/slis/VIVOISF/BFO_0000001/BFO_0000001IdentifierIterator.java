...
public class BFO_0000001IdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001IdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001IdentifierIterator.class);
