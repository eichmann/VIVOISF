...
public class BFO_0000001NationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NationalityFRIterator.class);
