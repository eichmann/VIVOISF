...
public class BFO_0000001HasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001HasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001HasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001HasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
