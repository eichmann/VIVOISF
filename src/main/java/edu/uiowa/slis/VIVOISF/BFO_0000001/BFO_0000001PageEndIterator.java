...
public class BFO_0000001PageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001PageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001PageEndIterator.class);
