...
public class BFO_0000001CodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001CodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001CodeFAOTERMIterator.class);
