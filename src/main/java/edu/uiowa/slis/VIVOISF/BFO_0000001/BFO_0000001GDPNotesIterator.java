...
public class BFO_0000001GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001GDPNotesIterator.class);
