...
public class BFO_0000001HasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001HasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001HasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000001HasNameIterator.getType());
		} catch (Exception e) {
