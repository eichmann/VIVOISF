...
public class BFO_0000001NameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000001NameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000001NameCurrencyESIterator.class);
