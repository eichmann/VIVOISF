...
public class BriefCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefCodenIterator.class);
