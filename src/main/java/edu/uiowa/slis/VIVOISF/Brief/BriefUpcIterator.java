...
public class BriefUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefUpcIterator.class);
