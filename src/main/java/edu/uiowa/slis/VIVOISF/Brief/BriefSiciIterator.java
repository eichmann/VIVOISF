...
public class BriefSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefSiciIterator.class);
