...
public class BriefERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefERO_0000045Iterator.class);
