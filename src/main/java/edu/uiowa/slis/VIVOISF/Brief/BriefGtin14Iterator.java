...
public class BriefGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefGtin14Iterator.class);
