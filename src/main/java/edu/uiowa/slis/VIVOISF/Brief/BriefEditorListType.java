...
public class BriefEditorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefEditorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefEditorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBriefEditorListIterator.getType());
		} catch (Exception e) {
