...
public class BriefRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBriefRO_0000056Iterator.getType());
		} catch (Exception e) {
