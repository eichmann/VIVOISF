...
public class BriefEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefEditionIterator.class);
