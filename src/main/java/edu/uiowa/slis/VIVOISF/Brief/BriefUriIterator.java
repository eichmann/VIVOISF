...
public class BriefUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefUriIterator.class);
