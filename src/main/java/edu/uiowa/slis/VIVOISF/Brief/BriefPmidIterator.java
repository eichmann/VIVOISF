...
public class BriefPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefPmidIterator.class);
