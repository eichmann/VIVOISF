...
public class BriefPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefPagesIterator.class);
