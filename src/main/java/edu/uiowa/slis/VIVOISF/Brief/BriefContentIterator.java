...
public class BriefContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefContentIterator.class);
