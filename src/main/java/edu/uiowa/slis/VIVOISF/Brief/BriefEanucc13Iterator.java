...
public class BriefEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefEanucc13Iterator.class);
