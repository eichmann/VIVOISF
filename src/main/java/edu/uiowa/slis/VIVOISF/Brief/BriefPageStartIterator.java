...
public class BriefPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefPageStartIterator.class);
