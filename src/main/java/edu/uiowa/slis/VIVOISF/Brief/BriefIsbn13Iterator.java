...
public class BriefIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefIsbn13Iterator.class);
