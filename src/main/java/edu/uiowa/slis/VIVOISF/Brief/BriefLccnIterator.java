...
public class BriefLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefLccnIterator.class);
