...
public class BriefHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefHandleIterator.class);
