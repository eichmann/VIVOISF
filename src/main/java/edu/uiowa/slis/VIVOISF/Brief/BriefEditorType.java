...
public class BriefEditorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefEditorType currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefEditorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBriefEditorIterator.getType());
		} catch (Exception e) {
