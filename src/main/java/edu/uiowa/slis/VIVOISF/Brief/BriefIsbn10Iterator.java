...
public class BriefIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefIsbn10Iterator.class);
