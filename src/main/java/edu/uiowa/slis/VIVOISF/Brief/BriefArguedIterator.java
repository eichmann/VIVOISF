...
public class BriefArguedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefArguedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefArguedIterator.class);
