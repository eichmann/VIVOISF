...
public class BriefSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefSectionIterator.class);
