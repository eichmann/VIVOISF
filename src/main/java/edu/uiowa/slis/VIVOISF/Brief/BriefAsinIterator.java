...
public class BriefAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefAsinIterator.class);
