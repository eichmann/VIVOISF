...
public class BriefLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefLocatorIterator.class);
