...
public class BriefNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefNumberIterator.class);
