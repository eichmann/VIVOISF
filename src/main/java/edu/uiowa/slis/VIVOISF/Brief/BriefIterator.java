...
public class BriefIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/Brief> . "+
