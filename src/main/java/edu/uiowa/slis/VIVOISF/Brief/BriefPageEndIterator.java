...
public class BriefPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefPageEndIterator.class);
