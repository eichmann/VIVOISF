...
public class BriefVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefVolumeIterator.class);
