...
public class BriefShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefShortDescriptionIterator.class);
