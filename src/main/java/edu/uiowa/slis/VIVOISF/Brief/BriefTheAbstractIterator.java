...
public class BriefTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefTheAbstractIterator.class);
