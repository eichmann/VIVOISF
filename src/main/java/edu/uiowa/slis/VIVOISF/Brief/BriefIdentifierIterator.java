...
public class BriefIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefIdentifierIterator.class);
