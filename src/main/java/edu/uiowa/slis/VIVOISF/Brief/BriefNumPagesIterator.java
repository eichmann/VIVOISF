...
public class BriefNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefNumPagesIterator.class);
