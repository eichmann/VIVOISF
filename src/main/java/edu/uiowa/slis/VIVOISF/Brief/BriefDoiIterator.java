...
public class BriefDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BriefDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BriefDoiIterator.class);
