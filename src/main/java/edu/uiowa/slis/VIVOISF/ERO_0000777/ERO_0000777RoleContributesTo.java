...
public class ERO_0000777RoleContributesTo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000777RoleContributesTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000777RoleContributesTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000777RoleContributesToIterator.getRoleContributesTo());
		} catch (Exception e) {
