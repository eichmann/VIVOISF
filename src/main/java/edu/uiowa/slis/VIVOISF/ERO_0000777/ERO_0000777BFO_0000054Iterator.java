...
public class ERO_0000777BFO_0000054Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(ERO_0000777BFO_0000054Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ERO_0000777BFO_0000054Iterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ERO_0000777BFO_0000054Iterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ERO_0000777BFO_0000054 doEndTag", e);
			throw new JspTagException("Exception raised in ERO_0000777BFO_0000054 doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
