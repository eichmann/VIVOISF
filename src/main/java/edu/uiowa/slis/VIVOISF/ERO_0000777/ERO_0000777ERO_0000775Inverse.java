...
public class ERO_0000777ERO_0000775Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000777ERO_0000775Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000777ERO_0000775Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000777ERO_0000775InverseIterator.getERO_0000775Inverse());
		} catch (Exception e) {
