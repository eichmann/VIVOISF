...
public class BFO_0000023PublicationVenueFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023PublicationVenueFor currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023PublicationVenueFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023PublicationVenueForIterator.getPublicationVenueFor());
		} catch (Exception e) {
