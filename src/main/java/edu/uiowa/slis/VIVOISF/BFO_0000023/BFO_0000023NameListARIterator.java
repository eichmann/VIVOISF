...
public class BFO_0000023NameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NameListARIterator.class);
