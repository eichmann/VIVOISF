...
public class BFO_0000023NationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NationalityRUIterator.class);
