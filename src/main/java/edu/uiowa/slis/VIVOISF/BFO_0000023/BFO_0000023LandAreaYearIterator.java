...
public class BFO_0000023LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023LandAreaYearIterator.class);
