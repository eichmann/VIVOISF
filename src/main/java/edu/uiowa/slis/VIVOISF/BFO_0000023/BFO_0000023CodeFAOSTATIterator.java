...
public class BFO_0000023CodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023CodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023CodeFAOSTATIterator.class);
