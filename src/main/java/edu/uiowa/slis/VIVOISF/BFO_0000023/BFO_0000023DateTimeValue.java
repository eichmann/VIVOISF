...
public class BFO_0000023DateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023DateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023DateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023DateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
