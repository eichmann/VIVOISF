...
public class BFO_0000023BFO_0000054 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023BFO_0000054 currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023BFO_0000054.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023BFO_0000054Iterator.getBFO_0000054());
		} catch (Exception e) {
