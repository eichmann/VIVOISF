...
public class BFO_0000023NameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NameCurrencyFRIterator.class);
