...
public class BFO_0000023GeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023GeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023GeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023GeographicFocusIterator.getType());
		} catch (Exception e) {
