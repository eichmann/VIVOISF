...
public class BFO_0000023HasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023HasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023HasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023HasPublicationVenueIterator.getType());
		} catch (Exception e) {
