...
public class BFO_0000023DescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023DescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023DescriptionIterator.class);
