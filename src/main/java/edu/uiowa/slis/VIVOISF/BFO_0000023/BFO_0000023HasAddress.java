...
public class BFO_0000023HasAddress extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023HasAddress currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023HasAddress.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023HasAddressIterator.getHasAddress());
		} catch (Exception e) {
