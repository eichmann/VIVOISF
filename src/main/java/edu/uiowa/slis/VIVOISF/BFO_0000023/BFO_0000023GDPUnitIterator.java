...
public class BFO_0000023GDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023GDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023GDPUnitIterator.class);
