...
public class BFO_0000023HasName extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023HasName currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023HasName.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023HasNameIterator.getHasName());
		} catch (Exception e) {
