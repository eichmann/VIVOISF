...
public class BFO_0000023PublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023PublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023PublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023PublisherIterator.getType());
		} catch (Exception e) {
