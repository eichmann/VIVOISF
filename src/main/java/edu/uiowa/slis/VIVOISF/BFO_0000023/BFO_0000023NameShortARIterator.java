...
public class BFO_0000023NameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NameShortARIterator.class);
