...
public class BFO_0000023NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NameCurrencyARIterator.class);
