...
public class BFO_0000023UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023UrlIterator.class);
