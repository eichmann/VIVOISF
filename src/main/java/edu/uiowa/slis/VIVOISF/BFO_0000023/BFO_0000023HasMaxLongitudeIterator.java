...
public class BFO_0000023HasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023HasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023HasMaxLongitudeIterator.class);
