...
public class BFO_0000023CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023CodeUNIterator.class);
