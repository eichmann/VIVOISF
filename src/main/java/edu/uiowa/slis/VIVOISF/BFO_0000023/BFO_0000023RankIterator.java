...
public class BFO_0000023RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023RankIterator.class);
