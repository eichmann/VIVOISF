...
public class BFO_0000023NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NameListZHIterator.class);
