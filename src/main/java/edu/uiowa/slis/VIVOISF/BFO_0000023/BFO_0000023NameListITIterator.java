...
public class BFO_0000023NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NameListITIterator.class);
