...
public class BFO_0000023HasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023HasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023HasMinLongitudeIterator.class);
