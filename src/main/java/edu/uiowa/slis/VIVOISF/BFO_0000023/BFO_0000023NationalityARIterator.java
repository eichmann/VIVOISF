...
public class BFO_0000023NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NationalityARIterator.class);
