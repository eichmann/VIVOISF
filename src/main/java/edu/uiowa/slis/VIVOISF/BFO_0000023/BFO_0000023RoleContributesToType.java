...
public class BFO_0000023RoleContributesToType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023RoleContributesToType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023RoleContributesToType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023RoleContributesToIterator.getType());
		} catch (Exception e) {
