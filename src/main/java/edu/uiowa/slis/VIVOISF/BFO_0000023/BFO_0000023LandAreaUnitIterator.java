...
public class BFO_0000023LandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023LandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023LandAreaUnitIterator.class);
