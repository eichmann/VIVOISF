...
public class BFO_0000023NationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NationalityESIterator.class);
