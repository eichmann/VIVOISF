...
public class BFO_0000023NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NationalityITIterator.class);
