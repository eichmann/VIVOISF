...
public class BFO_0000023PopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023PopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023PopulationUnitIterator.class);
