...
public class BFO_0000023RelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023RelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023RelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023RelatedByIterator.getType());
		} catch (Exception e) {
