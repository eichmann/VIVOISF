...
public class BFO_0000023NationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NationalityENIterator.class);
