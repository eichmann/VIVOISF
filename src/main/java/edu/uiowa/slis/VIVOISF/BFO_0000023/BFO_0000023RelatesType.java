...
public class BFO_0000023RelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023RelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023RelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000023RelatesIterator.getType());
		} catch (Exception e) {
