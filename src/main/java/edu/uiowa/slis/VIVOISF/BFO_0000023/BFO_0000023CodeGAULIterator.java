...
public class BFO_0000023CodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023CodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023CodeGAULIterator.class);
