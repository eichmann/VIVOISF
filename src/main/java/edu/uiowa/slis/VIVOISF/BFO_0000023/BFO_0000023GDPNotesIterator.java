...
public class BFO_0000023GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023GDPNotesIterator.class);
