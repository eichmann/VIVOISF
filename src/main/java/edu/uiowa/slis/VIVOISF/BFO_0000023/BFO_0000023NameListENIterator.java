...
public class BFO_0000023NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NameListENIterator.class);
