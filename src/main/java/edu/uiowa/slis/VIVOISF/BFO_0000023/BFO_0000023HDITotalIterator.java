...
public class BFO_0000023HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023HDITotalIterator.class);
