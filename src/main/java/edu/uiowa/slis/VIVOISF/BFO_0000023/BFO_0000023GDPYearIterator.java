...
public class BFO_0000023GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023GDPYearIterator.class);
