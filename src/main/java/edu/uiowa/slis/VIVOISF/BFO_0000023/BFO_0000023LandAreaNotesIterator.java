...
public class BFO_0000023LandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023LandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023LandAreaNotesIterator.class);
