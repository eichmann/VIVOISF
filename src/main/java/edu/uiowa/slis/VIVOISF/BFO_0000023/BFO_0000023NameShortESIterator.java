...
public class BFO_0000023NameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NameShortESIterator.class);
