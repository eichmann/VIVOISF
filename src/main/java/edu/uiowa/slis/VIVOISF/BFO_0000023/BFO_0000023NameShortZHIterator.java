...
public class BFO_0000023NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000023NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000023NameShortZHIterator.class);
