...
public class MedicalResidencyRO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MedicalResidencyRO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(MedicalResidencyRO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMedicalResidencyRO_0000057Iterator.getType());
		} catch (Exception e) {
