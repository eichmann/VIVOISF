...
public class MedicalResidencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MedicalResidencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MedicalResidencyIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#MedicalResidency> . "+
