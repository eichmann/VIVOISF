...
public class MedicalResidencyBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MedicalResidencyBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(MedicalResidencyBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMedicalResidencyBFO_0000055Iterator.getType());
		} catch (Exception e) {
