...
public class BFO_0000006NameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameListESIterator.class);
