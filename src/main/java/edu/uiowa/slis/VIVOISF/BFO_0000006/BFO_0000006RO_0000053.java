...
public class BFO_0000006RO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006RO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006RO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000006RO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
