...
public class BFO_0000006HDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006HDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006HDINotesIterator.class);
