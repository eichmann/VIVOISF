...
public class BFO_0000006GeographicFocus extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006GeographicFocus currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006GeographicFocus.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000006GeographicFocusIterator.getGeographicFocus());
		} catch (Exception e) {
