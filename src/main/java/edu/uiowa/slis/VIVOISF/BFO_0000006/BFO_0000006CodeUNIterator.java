...
public class BFO_0000006CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006CodeUNIterator.class);
