...
public class BFO_0000006NationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NationalityENIterator.class);
