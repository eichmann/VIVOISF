...
public class BFO_0000006FreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006FreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006FreetextKeywordIterator.class);
