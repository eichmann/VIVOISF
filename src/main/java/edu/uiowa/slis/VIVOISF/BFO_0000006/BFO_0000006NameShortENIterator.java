...
public class BFO_0000006NameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameShortENIterator.class);
