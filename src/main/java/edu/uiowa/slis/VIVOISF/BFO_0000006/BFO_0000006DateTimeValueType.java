...
public class BFO_0000006DateTimeValueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006DateTimeValueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006DateTimeValueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000006DateTimeValueIterator.getType());
		} catch (Exception e) {
