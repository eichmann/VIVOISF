...
public class BFO_0000006BFO_0000051 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006BFO_0000051 currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006BFO_0000051.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000006BFO_0000051Iterator.getBFO_0000051());
		} catch (Exception e) {
