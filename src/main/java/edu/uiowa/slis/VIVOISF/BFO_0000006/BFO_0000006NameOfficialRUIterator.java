...
public class BFO_0000006NameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameOfficialRUIterator.class);
