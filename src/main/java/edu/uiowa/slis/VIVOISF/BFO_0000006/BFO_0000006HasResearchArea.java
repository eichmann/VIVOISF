...
public class BFO_0000006HasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006HasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006HasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000006HasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
