...
public class BFO_0000006CodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006CodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006CodeGAULIterator.class);
