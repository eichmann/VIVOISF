...
public class BFO_0000006NameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameShortITIterator.class);
