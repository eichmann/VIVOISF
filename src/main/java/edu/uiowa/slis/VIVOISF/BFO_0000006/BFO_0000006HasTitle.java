...
public class BFO_0000006HasTitle extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006HasTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006HasTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000006HasTitleIterator.getHasTitle());
		} catch (Exception e) {
