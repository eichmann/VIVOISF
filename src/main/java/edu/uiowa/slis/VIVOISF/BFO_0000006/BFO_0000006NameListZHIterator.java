...
public class BFO_0000006NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameListZHIterator.class);
