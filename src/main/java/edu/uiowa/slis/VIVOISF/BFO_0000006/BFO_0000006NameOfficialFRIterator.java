...
public class BFO_0000006NameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameOfficialFRIterator.class);
