...
public class BFO_0000006CodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006CodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006CodeFAOSTATIterator.class);
