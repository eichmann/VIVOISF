...
public class BFO_0000006NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameShortRUIterator.class);
