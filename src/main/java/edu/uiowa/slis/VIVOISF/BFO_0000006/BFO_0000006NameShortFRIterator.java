...
public class BFO_0000006NameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameShortFRIterator.class);
