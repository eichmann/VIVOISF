...
public class BFO_0000006NationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NationalityESIterator.class);
