...
public class BFO_0000006Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(Prefix_1_4+
					" SELECT ?s ?l where { "+
						"?s rdfs:label ?l . "+
						"?s rdf:type <http://purl.obolibrary.org/obo/BFO_0000006> . "+
					"} ORDER BY ?l");
			if(rs.hasNext()) {
