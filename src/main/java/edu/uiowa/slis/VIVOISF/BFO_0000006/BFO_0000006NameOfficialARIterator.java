...
public class BFO_0000006NameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameOfficialARIterator.class);
