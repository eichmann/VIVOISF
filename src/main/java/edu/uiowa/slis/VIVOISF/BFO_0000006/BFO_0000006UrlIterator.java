...
public class BFO_0000006UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006UrlIterator.class);
