...
public class BFO_0000006NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NationalityITIterator.class);
