...
public class BFO_0000006HasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006HasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006HasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000006HasPublicationVenueIterator.getType());
		} catch (Exception e) {
