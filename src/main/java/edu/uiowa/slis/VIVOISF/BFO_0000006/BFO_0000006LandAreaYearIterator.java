...
public class BFO_0000006LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006LandAreaYearIterator.class);
