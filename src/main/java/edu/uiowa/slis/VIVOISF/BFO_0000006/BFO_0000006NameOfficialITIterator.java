...
public class BFO_0000006NameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameOfficialITIterator.class);
