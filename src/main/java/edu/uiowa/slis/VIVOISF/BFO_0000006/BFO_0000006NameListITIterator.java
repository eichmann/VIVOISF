...
public class BFO_0000006NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameListITIterator.class);
