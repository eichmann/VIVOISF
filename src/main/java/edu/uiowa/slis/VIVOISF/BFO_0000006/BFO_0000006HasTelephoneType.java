...
public class BFO_0000006HasTelephoneType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006HasTelephoneType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006HasTelephoneType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000006HasTelephoneIterator.getType());
		} catch (Exception e) {
