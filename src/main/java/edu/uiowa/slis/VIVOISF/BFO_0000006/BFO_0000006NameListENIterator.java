...
public class BFO_0000006NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameListENIterator.class);
