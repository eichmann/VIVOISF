...
public class BFO_0000006RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006RankIterator.class);
