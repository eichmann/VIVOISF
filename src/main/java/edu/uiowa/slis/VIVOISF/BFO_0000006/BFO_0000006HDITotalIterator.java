...
public class BFO_0000006HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006HDITotalIterator.class);
