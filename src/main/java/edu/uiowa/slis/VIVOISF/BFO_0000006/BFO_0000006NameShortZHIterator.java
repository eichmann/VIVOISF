...
public class BFO_0000006NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameShortZHIterator.class);
