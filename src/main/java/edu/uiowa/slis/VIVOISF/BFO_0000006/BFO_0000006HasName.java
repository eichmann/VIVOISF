...
public class BFO_0000006HasName extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006HasName currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006HasName.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000006HasNameIterator.getHasName());
		} catch (Exception e) {
