...
public class BFO_0000006NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000006NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000006NameListRUIterator.class);
