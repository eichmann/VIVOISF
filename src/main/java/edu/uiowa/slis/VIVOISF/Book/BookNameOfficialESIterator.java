...
public class BookNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameOfficialESIterator.class);
