...
public class BookNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameCurrencyZHIterator.class);
