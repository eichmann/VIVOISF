...
public class BookRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BookRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookRO_0001015Iterator.getType());
		} catch (Exception e) {
