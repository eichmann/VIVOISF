...
public class BookAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookAgriculturalAreaTotalIterator.class);
