...
public class BookRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BookRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BookRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BookRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BookRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BookRelates doEndTag", e);
			throw new JspTagException("Exception raised in BookRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BookRelatesIterator");
