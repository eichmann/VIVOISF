...
public class BookNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameCurrencyRUIterator.class);
