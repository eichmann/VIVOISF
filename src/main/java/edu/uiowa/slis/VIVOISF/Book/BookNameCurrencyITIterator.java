...
public class BookNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameCurrencyITIterator.class);
