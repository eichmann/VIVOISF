...
public class BookPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookPageEndIterator.class);
