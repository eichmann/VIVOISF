...
public class BookERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookERO_0000045Iterator.class);
