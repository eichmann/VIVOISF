...
public class BookAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookAgriculturalAreaUnitIterator.class);
