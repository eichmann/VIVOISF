...
public class BookPresentedAtType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookPresentedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(BookPresentedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookPresentedAtIterator.getType());
		} catch (Exception e) {
