...
public class BookCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCountryAreaTotalIterator.class);
