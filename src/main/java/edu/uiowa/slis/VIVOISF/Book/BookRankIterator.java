...
public class BookRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookRankIterator.class);
