...
public class BookUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookUpcIterator.class);
