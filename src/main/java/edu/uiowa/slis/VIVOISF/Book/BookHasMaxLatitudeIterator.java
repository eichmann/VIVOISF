...
public class BookHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookHasMaxLatitudeIterator.class);
