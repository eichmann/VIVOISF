...
public class BookDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookDescriptionIterator.class);
