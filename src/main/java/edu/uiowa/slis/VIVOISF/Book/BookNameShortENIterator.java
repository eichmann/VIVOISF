...
public class BookNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameShortENIterator.class);
