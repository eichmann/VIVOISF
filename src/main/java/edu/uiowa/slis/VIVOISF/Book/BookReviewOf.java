...
public class BookReviewOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookReviewOf currentInstance = null;
	private static final Log log = LogFactory.getLog(BookReviewOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookReviewOfIterator.getReviewOf());
		} catch (Exception e) {
