...
public class BookPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookPopulationUnitIterator.class);
