...
public class BookNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameCurrencyFRIterator.class);
