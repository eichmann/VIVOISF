...
public class BookShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookShortDescriptionIterator.class);
