...
public class BookCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCountryAreaUnitIterator.class);
