...
public class BookNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameShortITIterator.class);
