...
public class BookHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookHDITotalIterator.class);
