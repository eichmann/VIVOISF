...
public class BookCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCodeISO3Iterator.class);
