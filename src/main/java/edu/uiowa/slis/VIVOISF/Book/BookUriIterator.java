...
public class BookUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookUriIterator.class);
