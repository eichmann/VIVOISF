...
public class BookHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookHasMaxLongitudeIterator.class);
