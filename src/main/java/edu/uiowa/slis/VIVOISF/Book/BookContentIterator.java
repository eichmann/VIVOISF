...
public class BookContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookContentIterator.class);
