...
public class BookNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameShortZHIterator.class);
