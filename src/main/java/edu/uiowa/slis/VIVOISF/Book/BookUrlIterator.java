...
public class BookUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookUrlIterator.class);
