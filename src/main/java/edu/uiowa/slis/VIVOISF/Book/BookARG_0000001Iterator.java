...
public class BookARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookARG_0000001Iterator.class);
