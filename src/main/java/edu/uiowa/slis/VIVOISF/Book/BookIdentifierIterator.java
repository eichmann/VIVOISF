...
public class BookIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookIdentifierIterator.class);
