...
public class BookPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookPageStartIterator.class);
