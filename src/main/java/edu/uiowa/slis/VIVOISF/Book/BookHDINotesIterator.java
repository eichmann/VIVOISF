...
public class BookHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookHDINotesIterator.class);
