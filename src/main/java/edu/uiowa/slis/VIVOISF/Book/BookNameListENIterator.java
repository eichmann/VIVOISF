...
public class BookNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameListENIterator.class);
