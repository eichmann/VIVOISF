...
public class BookNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNationalityZHIterator.class);
