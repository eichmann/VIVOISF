...
public class BookCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCodeCurrencyIterator.class);
