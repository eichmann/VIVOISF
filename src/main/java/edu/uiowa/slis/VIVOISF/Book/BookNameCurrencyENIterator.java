...
public class BookNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameCurrencyENIterator.class);
