...
public class BookLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookLandAreaYearIterator.class);
