...
public class BookGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookGDPUnitIterator.class);
