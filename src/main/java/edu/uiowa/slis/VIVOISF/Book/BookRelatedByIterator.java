...
public class BookRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookRelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookRelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BookRelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BookRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BookRelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BookRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BookRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in BookRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BookRelatedByIterator");
