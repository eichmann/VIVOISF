...
public class BookLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookLccnIterator.class);
