...
public class BookGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookGtin14Iterator.class);
