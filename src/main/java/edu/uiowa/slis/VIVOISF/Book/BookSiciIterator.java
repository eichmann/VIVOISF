...
public class BookSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSiciIterator.class);
