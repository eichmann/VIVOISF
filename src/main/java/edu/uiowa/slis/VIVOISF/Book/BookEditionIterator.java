...
public class BookEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookEditionIterator.class);
