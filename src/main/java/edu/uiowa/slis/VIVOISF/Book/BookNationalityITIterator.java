...
public class BookNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNationalityITIterator.class);
