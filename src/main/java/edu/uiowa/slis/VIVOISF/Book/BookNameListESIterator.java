...
public class BookNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameListESIterator.class);
