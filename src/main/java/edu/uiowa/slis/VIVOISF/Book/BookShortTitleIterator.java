...
public class BookShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookShortTitleIterator.class);
