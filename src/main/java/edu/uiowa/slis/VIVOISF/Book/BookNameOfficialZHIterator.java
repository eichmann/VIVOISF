...
public class BookNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameOfficialZHIterator.class);
