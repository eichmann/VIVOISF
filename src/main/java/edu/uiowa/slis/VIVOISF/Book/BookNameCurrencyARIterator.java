...
public class BookNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameCurrencyARIterator.class);
