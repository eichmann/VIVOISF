...
public class BookNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameOfficialITIterator.class);
