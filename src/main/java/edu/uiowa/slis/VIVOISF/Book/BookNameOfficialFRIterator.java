...
public class BookNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameOfficialFRIterator.class);
