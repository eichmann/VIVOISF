...
public class BookNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNationalityFRIterator.class);
