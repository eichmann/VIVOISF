...
public class BookGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookGDPYearIterator.class);
