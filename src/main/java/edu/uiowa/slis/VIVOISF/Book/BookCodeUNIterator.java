...
public class BookCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCodeUNIterator.class);
