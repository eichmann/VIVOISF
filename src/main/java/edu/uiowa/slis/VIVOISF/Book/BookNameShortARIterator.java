...
public class BookNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameShortARIterator.class);
