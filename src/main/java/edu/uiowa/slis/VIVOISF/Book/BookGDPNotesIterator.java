...
public class BookGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookGDPNotesIterator.class);
