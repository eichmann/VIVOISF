...
public class BookNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameListARIterator.class);
