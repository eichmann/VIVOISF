...
public class BookTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookTheAbstractIterator.class);
