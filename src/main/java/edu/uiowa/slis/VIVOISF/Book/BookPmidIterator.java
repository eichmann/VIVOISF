...
public class BookPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookPmidIterator.class);
