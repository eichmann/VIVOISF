...
public class BookHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookHandleIterator.class);
