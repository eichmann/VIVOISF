...
public class BookHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookHasMinLatitudeIterator.class);
