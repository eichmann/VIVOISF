...
public class BookNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameListRUIterator.class);
