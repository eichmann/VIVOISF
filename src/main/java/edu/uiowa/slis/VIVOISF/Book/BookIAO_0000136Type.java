...
public class BookIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BookIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookIAO_0000136Iterator.getType());
		} catch (Exception e) {
