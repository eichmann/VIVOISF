...
public class BookNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNationalityARIterator.class);
