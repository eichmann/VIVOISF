...
public class BookDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookDoiIterator.class);
