...
public class BookFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookFreetextKeywordIterator.class);
