...
public class BookEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookEanucc13Iterator.class);
