...
public class BookNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameOfficialENIterator.class);
