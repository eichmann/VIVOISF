...
public class BookCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCodeAGROVOCIterator.class);
