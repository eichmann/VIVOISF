...
public class BookCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCodeGAULIterator.class);
