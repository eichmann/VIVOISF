...
public class BookIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookIterator.class);
