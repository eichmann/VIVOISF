...
public class BookNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameOfficialRUIterator.class);
