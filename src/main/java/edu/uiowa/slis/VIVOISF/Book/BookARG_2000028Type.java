...
public class BookARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BookARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookARG_2000028Iterator.getType());
		} catch (Exception e) {
