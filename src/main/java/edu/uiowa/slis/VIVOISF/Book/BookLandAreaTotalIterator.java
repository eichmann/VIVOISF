...
public class BookLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookLandAreaTotalIterator.class);
