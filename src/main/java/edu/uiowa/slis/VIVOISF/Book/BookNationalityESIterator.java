...
public class BookNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNationalityESIterator.class);
