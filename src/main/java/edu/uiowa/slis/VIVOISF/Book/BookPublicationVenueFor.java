...
public class BookPublicationVenueFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookPublicationVenueFor currentInstance = null;
	private static final Log log = LogFactory.getLog(BookPublicationVenueFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookPublicationVenueForIterator.getPublicationVenueFor());
		} catch (Exception e) {
