...
public class BookLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookLandAreaNotesIterator.class);
