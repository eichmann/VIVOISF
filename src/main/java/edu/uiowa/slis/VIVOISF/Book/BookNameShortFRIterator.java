...
public class BookNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameShortFRIterator.class);
