...
public class BookLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookLocatorIterator.class);
