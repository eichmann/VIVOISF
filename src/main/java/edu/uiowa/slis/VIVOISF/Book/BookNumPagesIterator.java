...
public class BookNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNumPagesIterator.class);
