...
public class BookNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameListZHIterator.class);
