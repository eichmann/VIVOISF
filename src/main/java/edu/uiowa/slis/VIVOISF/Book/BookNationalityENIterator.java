...
public class BookNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNationalityENIterator.class);
