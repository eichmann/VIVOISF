...
public class BookHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookHasMinLongitudeIterator.class);
