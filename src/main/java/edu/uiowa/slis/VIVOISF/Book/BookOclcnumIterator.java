...
public class BookOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookOclcnumIterator.class);
