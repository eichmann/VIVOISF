...
public class BookNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameCurrencyESIterator.class);
