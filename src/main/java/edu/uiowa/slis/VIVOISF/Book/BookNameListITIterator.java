...
public class BookNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameListITIterator.class);
