...
public class BookAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookAgriculturalAreaYearIterator.class);
