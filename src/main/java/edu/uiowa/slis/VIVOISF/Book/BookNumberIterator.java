...
public class BookNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNumberIterator.class);
