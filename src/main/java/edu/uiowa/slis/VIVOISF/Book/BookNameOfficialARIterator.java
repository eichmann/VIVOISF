...
public class BookNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameOfficialARIterator.class);
