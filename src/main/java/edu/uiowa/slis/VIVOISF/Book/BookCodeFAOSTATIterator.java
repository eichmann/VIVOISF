...
public class BookCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCodeFAOSTATIterator.class);
