...
public class BookPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookPopulationYearIterator.class);
