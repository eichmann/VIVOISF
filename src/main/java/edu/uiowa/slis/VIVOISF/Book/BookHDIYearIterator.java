...
public class BookHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookHDIYearIterator.class);
