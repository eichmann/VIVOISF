...
public class BookCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCodeUNDPIterator.class);
