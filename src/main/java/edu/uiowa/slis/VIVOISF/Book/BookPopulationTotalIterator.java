...
public class BookPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookPopulationTotalIterator.class);
