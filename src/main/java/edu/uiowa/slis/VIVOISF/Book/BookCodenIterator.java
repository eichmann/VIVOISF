...
public class BookCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCodenIterator.class);
