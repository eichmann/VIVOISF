...
public class BookNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameShortRUIterator.class);
