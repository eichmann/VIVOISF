...
public class BookLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookLandAreaUnitIterator.class);
