...
public class BookNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookNameListFRIterator.class);
