...
public class BookCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCodeDBPediaIDIterator.class);
