...
public class BookCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookCountryAreaYearIterator.class);
