...
public class BookPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookPopulationNotesIterator.class);
