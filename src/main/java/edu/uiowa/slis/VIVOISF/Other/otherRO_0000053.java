...
public class otherRO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherRO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(otherRO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theotherRO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
