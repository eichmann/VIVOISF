...
public class otherHasCodeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherHasCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherHasCodeIterator.class);
