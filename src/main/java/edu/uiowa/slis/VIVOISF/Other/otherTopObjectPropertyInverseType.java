...
public class otherTopObjectPropertyInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherTopObjectPropertyInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(otherTopObjectPropertyInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theotherTopObjectPropertyInverseIterator.getType());
		} catch (Exception e) {
