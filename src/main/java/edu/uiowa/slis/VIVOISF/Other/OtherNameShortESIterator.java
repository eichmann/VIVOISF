...
public class OtherNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OtherNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OtherNameShortESIterator.class);
