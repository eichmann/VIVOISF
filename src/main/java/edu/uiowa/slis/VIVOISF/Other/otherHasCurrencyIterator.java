...
public class otherHasCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherHasCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherHasCurrencyIterator.class);
