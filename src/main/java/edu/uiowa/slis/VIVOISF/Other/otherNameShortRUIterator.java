...
public class otherNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherNameShortRUIterator.class);
