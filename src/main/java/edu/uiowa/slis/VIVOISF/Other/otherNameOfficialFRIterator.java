...
public class otherNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherNameOfficialFRIterator.class);
