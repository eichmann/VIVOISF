...
public class otherValidUntilIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherValidUntilIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherValidUntilIterator.class);
