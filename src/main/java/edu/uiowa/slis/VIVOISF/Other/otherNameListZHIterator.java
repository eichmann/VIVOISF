...
public class otherNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherNameListZHIterator.class);
