...
public class OtherCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OtherCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OtherCodeISO3Iterator.class);
