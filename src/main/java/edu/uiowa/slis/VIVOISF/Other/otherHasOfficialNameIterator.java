...
public class otherHasOfficialNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherHasOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherHasOfficialNameIterator.class);
