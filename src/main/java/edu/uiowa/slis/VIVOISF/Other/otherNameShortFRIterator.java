...
public class otherNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherNameShortFRIterator.class);
