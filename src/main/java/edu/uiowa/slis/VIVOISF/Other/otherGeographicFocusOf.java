...
public class otherGeographicFocusOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		try {
			otherGeographicFocusOfIterator theother = (otherGeographicFocusOfIterator)findAncestorWithClass(this, otherGeographicFocusOfIterator.class);
			pageContext.getOut().print(theother.getGeographicFocusOf());
		} catch (Exception e) {
