...
public class otherNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherNameListESIterator.class);
