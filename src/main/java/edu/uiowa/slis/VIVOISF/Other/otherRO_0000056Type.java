...
public class otherRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(otherRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theotherRO_0000056Iterator.getType());
		} catch (Exception e) {
