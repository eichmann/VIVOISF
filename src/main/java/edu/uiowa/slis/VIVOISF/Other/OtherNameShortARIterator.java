...
public class OtherNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OtherNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OtherNameShortARIterator.class);
