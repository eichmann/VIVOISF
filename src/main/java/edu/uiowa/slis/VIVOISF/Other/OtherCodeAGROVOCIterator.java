...
public class OtherCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OtherCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OtherCodeAGROVOCIterator.class);
