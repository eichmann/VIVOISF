...
public class otherBottomDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherBottomDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherBottomDataPropertyIterator.class);
