...
public class otherNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherNameListARIterator.class);
