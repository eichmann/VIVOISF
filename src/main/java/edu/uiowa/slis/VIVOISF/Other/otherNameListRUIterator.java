...
public class otherNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherNameListRUIterator.class);
