...
public class otherHasShortNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherHasShortNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherHasShortNameIterator.class);
