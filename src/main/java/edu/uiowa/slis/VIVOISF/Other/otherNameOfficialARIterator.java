...
public class otherNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static otherNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(otherNameOfficialARIterator.class);
