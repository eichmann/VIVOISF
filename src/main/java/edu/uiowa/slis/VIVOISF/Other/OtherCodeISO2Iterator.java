...
public class OtherCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OtherCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OtherCodeISO2Iterator.class);
