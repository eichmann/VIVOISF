...
public class OtherNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OtherNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OtherNameShortZHIterator.class);
