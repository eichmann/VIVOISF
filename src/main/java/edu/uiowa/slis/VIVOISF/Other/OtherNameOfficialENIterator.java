...
public class OtherNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OtherNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OtherNameOfficialENIterator.class);
