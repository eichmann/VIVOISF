...
public class CodeIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeIsbn10Iterator.class);
