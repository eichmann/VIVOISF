...
public class CodeGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeGtin14Iterator.class);
