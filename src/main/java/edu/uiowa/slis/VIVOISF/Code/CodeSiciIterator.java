...
public class CodeSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeSiciIterator.class);
