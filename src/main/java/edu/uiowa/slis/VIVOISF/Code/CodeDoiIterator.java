...
public class CodeDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeDoiIterator.class);
