...
public class CodeCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeCodenIterator.class);
