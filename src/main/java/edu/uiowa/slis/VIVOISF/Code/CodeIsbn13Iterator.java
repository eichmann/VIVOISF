...
public class CodeIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeIsbn13Iterator.class);
