...
public class CodeEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeEanucc13Iterator.class);
