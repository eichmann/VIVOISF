...
public class CodePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodePmidIterator.class);
