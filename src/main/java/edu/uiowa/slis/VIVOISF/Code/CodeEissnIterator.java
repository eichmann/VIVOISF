...
public class CodeEissnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeEissnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeEissnIterator.class);
