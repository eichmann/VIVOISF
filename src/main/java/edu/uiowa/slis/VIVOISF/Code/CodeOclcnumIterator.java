...
public class CodeOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeOclcnumIterator.class);
