...
public class CodeTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeTheAbstractIterator.class);
