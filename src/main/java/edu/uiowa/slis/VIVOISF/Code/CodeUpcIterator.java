...
public class CodeUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeUpcIterator.class);
