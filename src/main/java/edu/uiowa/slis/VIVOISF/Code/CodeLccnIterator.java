...
public class CodeLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeLccnIterator.class);
