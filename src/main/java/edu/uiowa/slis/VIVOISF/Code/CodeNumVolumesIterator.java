...
public class CodeNumVolumesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeNumVolumesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeNumVolumesIterator.class);
