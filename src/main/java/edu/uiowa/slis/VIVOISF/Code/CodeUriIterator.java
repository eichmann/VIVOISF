...
public class CodeUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeUriIterator.class);
