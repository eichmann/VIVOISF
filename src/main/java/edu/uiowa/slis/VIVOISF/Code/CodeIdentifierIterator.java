...
public class CodeIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CodeIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CodeIdentifierIterator.class);
