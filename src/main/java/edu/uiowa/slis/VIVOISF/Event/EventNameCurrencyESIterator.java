...
public class EventNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameCurrencyESIterator.class);
