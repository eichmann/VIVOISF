...
public class EventNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameOfficialITIterator.class);
