...
public class EventHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHDITotalIterator.class);
