...
public class EventGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventGDPNotesIterator.class);
