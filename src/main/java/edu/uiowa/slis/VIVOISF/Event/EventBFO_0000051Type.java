...
public class EventBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EventBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEventBFO_0000051Iterator.getType());
		} catch (Exception e) {
