...
public class EventDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventDescriptionIterator.class);
