...
public class EventNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNationalityZHIterator.class);
