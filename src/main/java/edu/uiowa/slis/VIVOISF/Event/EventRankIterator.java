...
public class EventRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventRankIterator.class);
