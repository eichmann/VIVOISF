...
public class EventGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventGDPYearIterator.class);
