...
public class EventCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCountryAreaUnitIterator.class);
