...
public class EventCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCodeISO3Iterator.class);
