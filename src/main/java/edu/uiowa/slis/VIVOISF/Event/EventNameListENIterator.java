...
public class EventNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameListENIterator.class);
