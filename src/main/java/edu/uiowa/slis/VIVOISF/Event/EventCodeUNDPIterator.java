...
public class EventCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCodeUNDPIterator.class);
