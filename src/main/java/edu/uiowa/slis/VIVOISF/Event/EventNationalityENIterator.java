...
public class EventNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNationalityENIterator.class);
