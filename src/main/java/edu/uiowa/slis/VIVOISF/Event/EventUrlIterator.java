...
public class EventUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventUrlIterator.class);
