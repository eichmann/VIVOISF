...
public class EventAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventAgriculturalAreaNotesIterator.class);
