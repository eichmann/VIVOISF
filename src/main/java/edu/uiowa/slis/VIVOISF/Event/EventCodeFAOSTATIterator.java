...
public class EventCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCodeFAOSTATIterator.class);
