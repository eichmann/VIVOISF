...
public class EventNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameCurrencyARIterator.class);
