...
public class EventHasTelephoneType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventHasTelephoneType currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHasTelephoneType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEventHasTelephoneIterator.getType());
		} catch (Exception e) {
