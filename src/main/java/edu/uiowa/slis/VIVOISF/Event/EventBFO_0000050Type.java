...
public class EventBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EventBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEventBFO_0000050Iterator.getType());
		} catch (Exception e) {
