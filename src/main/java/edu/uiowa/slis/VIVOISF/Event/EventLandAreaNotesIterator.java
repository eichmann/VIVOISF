...
public class EventLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventLandAreaNotesIterator.class);
