...
public class EventNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNationalityESIterator.class);
