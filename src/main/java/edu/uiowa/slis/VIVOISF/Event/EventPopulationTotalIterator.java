...
public class EventPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventPopulationTotalIterator.class);
