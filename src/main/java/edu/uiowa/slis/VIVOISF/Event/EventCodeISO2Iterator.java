...
public class EventCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCodeISO2Iterator.class);
