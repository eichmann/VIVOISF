...
public class EventNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameListARIterator.class);
