...
public class EventNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNationalityARIterator.class);
