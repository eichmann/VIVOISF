...
public class EventNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameCurrencyFRIterator.class);
