...
public class EventCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCountryAreaYearIterator.class);
