...
public class EventNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameOfficialESIterator.class);
