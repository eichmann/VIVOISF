...
public class EventNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameListRUIterator.class);
