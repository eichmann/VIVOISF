...
public class EventIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventIterator.class);
