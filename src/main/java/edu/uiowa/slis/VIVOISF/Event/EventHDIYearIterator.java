...
public class EventHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHDIYearIterator.class);
