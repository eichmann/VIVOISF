...
public class EventNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameShortESIterator.class);
