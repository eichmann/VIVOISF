...
public class EventCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCountryAreaTotalIterator.class);
