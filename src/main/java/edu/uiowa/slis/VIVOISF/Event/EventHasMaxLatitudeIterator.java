...
public class EventHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHasMaxLatitudeIterator.class);
