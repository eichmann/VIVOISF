...
public class EventCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCountryAreaNotesIterator.class);
