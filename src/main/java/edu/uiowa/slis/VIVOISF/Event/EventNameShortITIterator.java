...
public class EventNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameShortITIterator.class);
