...
public class EventHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHDINotesIterator.class);
