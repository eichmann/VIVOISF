...
public class EventNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameOfficialENIterator.class);
