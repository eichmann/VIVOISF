...
public class EventNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNationalityITIterator.class);
