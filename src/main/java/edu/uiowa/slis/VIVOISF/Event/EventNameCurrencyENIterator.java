...
public class EventNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameCurrencyENIterator.class);
