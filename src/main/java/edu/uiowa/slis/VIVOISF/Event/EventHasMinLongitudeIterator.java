...
public class EventHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHasMinLongitudeIterator.class);
