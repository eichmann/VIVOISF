...
public class EventHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHasMaxLongitudeIterator.class);
