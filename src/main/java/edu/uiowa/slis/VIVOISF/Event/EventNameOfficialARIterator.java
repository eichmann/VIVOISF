...
public class EventNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameOfficialARIterator.class);
