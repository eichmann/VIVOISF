...
public class EventCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCodeAGROVOCIterator.class);
