...
public class EventCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCodeDBPediaIDIterator.class);
