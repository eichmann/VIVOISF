...
public class EventNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameOfficialFRIterator.class);
