...
public class EventBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EventBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEventBFO_0000055Iterator.getType());
		} catch (Exception e) {
