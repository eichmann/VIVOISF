...
public class EventCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCodeFAOTERMIterator.class);
