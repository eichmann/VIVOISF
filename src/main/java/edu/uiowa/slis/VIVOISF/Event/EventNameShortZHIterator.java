...
public class EventNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameShortZHIterator.class);
