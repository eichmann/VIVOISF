...
public class EventNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameListESIterator.class);
