...
public class EventHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHasMinLatitudeIterator.class);
