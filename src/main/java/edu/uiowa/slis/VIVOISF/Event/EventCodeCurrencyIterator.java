...
public class EventCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCodeCurrencyIterator.class);
