...
public class EventNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameOfficialZHIterator.class);
