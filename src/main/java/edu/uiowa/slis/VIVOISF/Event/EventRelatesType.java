...
public class EventRelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventRelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(EventRelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEventRelatesIterator.getType());
		} catch (Exception e) {
