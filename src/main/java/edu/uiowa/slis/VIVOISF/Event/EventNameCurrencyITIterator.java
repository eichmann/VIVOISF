...
public class EventNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameCurrencyITIterator.class);
