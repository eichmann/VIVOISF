...
public class EventNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNationalityFRIterator.class);
