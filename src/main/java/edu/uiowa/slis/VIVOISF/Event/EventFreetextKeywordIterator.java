...
public class EventFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventFreetextKeywordIterator.class);
