...
public class EventNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameListITIterator.class);
