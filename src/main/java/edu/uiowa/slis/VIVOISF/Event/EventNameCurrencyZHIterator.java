...
public class EventNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameCurrencyZHIterator.class);
