...
public class EventRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EventRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEventRO_0001015Iterator.getType());
		} catch (Exception e) {
