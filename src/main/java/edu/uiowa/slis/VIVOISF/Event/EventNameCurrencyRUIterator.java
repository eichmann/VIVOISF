...
public class EventNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameCurrencyRUIterator.class);
