...
public class EventNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameListFRIterator.class);
