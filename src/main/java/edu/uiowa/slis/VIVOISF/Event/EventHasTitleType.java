...
public class EventHasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventHasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(EventHasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEventHasTitleIterator.getType());
		} catch (Exception e) {
