...
public class EventNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameListZHIterator.class);
