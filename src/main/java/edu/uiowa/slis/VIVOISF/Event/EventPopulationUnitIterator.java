...
public class EventPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventPopulationUnitIterator.class);
