...
public class EventLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventLandAreaTotalIterator.class);
