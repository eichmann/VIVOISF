...
public class EventLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventLandAreaYearIterator.class);
