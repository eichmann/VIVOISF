...
public class EventNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameOfficialRUIterator.class);
