...
public class EventNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameShortFRIterator.class);
