...
public class EventPublicationVenueFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventPublicationVenueFor currentInstance = null;
	private static final Log log = LogFactory.getLog(EventPublicationVenueFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEventPublicationVenueForIterator.getPublicationVenueFor());
		} catch (Exception e) {
