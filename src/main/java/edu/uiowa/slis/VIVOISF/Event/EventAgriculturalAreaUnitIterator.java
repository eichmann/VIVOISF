...
public class EventAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventAgriculturalAreaUnitIterator.class);
