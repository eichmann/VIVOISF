...
public class EventNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventNameShortENIterator.class);
