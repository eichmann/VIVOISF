...
public class EventCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventCodeGAULIterator.class);
