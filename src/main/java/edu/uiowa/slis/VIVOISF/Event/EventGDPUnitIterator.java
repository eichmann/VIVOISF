...
public class EventGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EventGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EventGDPUnitIterator.class);
