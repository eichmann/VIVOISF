...
public class ERO_0000789RoleContributesTo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000789RoleContributesTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000789RoleContributesTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000789RoleContributesToIterator.getRoleContributesTo());
		} catch (Exception e) {
