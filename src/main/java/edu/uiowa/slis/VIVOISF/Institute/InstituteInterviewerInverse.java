...
public class InstituteInterviewerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteInterviewerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteInterviewerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInstituteInterviewerInverseIterator.getInterviewerInverse());
		} catch (Exception e) {
