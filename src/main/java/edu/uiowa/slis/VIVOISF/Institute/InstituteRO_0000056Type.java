...
public class InstituteRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInstituteRO_0000056Iterator.getType());
		} catch (Exception e) {
