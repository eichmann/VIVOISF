...
public class InstituteERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInstituteERO_0000037Iterator.getType());
		} catch (Exception e) {
