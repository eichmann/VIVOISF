...
public class InstituteSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteSuffixNameIterator.class);
