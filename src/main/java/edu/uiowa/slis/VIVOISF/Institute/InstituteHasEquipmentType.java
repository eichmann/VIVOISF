...
public class InstituteHasEquipmentType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteHasEquipmentType currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteHasEquipmentType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInstituteHasEquipmentIterator.getType());
		} catch (Exception e) {
