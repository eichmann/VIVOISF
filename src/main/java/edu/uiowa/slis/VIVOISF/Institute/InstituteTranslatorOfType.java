...
public class InstituteTranslatorOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteTranslatorOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteTranslatorOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInstituteTranslatorOfIterator.getType());
		} catch (Exception e) {
