...
public class InstituteERO_0001520Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteERO_0001520Type currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteERO_0001520Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInstituteERO_0001520Iterator.getType());
		} catch (Exception e) {
