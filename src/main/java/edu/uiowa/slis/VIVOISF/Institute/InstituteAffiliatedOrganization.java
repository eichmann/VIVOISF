...
public class InstituteAffiliatedOrganization extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteAffiliatedOrganization currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteAffiliatedOrganization.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInstituteAffiliatedOrganizationIterator.getAffiliatedOrganization());
		} catch (Exception e) {
