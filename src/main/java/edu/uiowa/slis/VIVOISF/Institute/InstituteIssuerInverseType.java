...
public class InstituteIssuerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteIssuerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteIssuerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInstituteIssuerInverseIterator.getType());
		} catch (Exception e) {
