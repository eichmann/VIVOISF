...
public class InstituteOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInstituteOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
