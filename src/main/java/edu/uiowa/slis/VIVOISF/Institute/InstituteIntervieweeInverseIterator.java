...
public class InstituteIntervieweeInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteIntervieweeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteIntervieweeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in InstituteIntervieweeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in InstituteIntervieweeInverseIterator doStartTag");
		}
