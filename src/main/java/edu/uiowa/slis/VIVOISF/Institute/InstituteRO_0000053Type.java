...
public class InstituteRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstituteRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(InstituteRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInstituteRO_0000053Iterator.getType());
		} catch (Exception e) {
