...
public class ManuscriptPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptPageStartIterator.class);
