...
public class ManuscriptOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptOclcnumIterator.class);
