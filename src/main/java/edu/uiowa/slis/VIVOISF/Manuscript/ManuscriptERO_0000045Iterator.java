...
public class ManuscriptERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptERO_0000045Iterator.class);
