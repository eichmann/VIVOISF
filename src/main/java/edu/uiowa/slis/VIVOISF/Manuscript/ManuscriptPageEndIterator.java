...
public class ManuscriptPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptPageEndIterator.class);
