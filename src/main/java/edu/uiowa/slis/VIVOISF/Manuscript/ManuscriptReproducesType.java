...
public class ManuscriptReproducesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptReproducesType currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptReproducesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theManuscriptReproducesIterator.getType());
		} catch (Exception e) {
