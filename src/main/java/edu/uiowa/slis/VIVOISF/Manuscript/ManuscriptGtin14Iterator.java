...
public class ManuscriptGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptGtin14Iterator.class);
