...
public class ManuscriptUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptUriIterator.class);
