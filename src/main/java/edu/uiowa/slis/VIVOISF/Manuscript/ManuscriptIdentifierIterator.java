...
public class ManuscriptIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptIdentifierIterator.class);
