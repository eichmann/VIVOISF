...
public class ManuscriptIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/Manuscript> . "+
