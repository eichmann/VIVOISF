...
public class ManuscriptDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptDoiIterator.class);
