...
public class ManuscriptRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theManuscriptRO_0000056Iterator.getType());
		} catch (Exception e) {
