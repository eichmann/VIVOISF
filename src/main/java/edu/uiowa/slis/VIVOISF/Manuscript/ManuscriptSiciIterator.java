...
public class ManuscriptSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptSiciIterator.class);
