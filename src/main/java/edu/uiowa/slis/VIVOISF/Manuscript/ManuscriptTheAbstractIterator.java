...
public class ManuscriptTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptTheAbstractIterator.class);
