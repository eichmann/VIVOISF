...
public class ManuscriptLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptLocatorIterator.class);
