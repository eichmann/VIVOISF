...
public class ManuscriptSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptSectionIterator.class);
