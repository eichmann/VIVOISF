...
public class ManuscriptUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptUpcIterator.class);
