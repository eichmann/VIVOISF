...
public class ManuscriptLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptLccnIterator.class);
