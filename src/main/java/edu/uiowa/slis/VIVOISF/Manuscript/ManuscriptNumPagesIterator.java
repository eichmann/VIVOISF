...
public class ManuscriptNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptNumPagesIterator.class);
