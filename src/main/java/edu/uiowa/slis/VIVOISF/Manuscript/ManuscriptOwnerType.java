...
public class ManuscriptOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theManuscriptOwnerIterator.getType());
		} catch (Exception e) {
