...
public class ManuscriptEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptEditionIterator.class);
