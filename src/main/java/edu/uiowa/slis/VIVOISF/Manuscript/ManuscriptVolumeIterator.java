...
public class ManuscriptVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptVolumeIterator.class);
