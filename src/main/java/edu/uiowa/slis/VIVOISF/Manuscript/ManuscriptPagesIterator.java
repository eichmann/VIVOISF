...
public class ManuscriptPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptPagesIterator.class);
