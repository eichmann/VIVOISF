...
public class ManuscriptPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptPmidIterator.class);
