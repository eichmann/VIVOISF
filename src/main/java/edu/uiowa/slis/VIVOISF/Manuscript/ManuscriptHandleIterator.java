...
public class ManuscriptHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptHandleIterator.class);
