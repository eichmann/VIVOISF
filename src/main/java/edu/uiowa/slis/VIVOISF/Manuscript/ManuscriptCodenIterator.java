...
public class ManuscriptCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptCodenIterator.class);
