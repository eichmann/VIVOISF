...
public class ManuscriptShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptShortDescriptionIterator.class);
