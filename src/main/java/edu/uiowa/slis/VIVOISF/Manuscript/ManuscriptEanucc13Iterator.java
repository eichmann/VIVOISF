...
public class ManuscriptEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ManuscriptEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ManuscriptEanucc13Iterator.class);
