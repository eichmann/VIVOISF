...
public class ERO_0000785RoleContributesTo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000785RoleContributesTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000785RoleContributesTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000785RoleContributesToIterator.getRoleContributesTo());
		} catch (Exception e) {
