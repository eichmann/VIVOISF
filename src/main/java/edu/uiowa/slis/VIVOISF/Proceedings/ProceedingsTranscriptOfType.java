...
public class ProceedingsTranscriptOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsTranscriptOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsTranscriptOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProceedingsTranscriptOfIterator.getType());
		} catch (Exception e) {
