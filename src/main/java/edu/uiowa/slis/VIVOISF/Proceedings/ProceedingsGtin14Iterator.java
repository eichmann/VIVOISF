...
public class ProceedingsGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsGtin14Iterator.class);
