...
public class ProceedingsEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsEditionIterator.class);
