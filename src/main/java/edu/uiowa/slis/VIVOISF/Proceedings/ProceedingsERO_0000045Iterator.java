...
public class ProceedingsERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsERO_0000045Iterator.class);
