...
public class ProceedingsDocumentationFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsDocumentationFor currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsDocumentationFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProceedingsDocumentationForIterator.getDocumentationFor());
		} catch (Exception e) {
