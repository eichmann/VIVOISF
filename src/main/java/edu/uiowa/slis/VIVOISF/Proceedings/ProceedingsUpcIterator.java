...
public class ProceedingsUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsUpcIterator.class);
