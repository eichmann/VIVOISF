...
public class ProceedingsShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsShortDescriptionIterator.class);
