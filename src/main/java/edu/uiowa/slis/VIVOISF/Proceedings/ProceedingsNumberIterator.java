...
public class ProceedingsNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsNumberIterator.class);
