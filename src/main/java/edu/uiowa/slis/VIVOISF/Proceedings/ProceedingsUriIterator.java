...
public class ProceedingsUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsUriIterator.class);
