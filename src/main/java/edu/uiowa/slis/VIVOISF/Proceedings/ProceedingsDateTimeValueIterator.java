...
public class ProceedingsDateTimeValueIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(ProceedingsDateTimeValueIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ProceedingsDateTimeValueIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ProceedingsDateTimeValueIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ProceedingsDateTimeValue doEndTag", e);
			throw new JspTagException("Exception raised in ProceedingsDateTimeValue doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
