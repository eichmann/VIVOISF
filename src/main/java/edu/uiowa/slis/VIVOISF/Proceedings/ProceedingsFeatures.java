...
public class ProceedingsFeatures extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsFeatures currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsFeatures.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProceedingsFeaturesIterator.getFeatures());
		} catch (Exception e) {
