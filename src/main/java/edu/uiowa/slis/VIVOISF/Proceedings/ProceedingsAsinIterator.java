...
public class ProceedingsAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsAsinIterator.class);
