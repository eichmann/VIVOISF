...
public class ProceedingsPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsPagesIterator.class);
