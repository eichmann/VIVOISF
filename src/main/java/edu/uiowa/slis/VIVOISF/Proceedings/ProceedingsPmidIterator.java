...
public class ProceedingsPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsPmidIterator.class);
