...
public class ProceedingsVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsVolumeIterator.class);
