...
public class ProceedingsNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsNumPagesIterator.class);
