...
public class ProceedingsCitedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsCitedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsCitedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProceedingsCitedByIterator.getCitedBy());
		} catch (Exception e) {
