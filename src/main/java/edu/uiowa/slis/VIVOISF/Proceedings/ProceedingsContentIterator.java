...
public class ProceedingsContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsContentIterator.class);
