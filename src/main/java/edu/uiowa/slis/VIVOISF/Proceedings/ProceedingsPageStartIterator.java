...
public class ProceedingsPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsPageStartIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://purl.org/ontology/bibo/pageStart> ?s } ");
			if(rs.hasNext()) {
