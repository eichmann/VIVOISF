...
public class ProceedingsPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsPageEndIterator.class);
