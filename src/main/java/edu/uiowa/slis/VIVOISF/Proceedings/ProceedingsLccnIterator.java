...
public class ProceedingsLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsLccnIterator.class);
