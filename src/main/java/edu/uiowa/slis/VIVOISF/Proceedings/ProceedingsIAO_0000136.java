...
public class ProceedingsIAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsIAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsIAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProceedingsIAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
