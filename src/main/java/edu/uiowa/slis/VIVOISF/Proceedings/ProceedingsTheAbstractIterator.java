...
public class ProceedingsTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsTheAbstractIterator.class);
