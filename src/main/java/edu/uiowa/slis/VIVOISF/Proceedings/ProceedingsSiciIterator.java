...
public class ProceedingsSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsSiciIterator.class);
