...
public class ProceedingsHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsHandleIterator.class);
