...
public class ProceedingsRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProceedingsRO_0000056Iterator.getType());
		} catch (Exception e) {
