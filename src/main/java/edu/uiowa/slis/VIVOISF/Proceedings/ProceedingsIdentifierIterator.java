...
public class ProceedingsIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsIdentifierIterator.class);
