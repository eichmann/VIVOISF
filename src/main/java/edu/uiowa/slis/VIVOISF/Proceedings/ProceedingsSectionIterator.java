...
public class ProceedingsSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsSectionIterator.class);
