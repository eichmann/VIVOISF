...
public class ProceedingsCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsCodenIterator.class);
