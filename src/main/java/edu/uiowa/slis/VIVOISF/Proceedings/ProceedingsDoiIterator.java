...
public class ProceedingsDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsDoiIterator.class);
