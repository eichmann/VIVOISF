...
public class ProceedingsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/Proceedings> . "+
