...
public class ProceedingsLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsLocatorIterator.class);
