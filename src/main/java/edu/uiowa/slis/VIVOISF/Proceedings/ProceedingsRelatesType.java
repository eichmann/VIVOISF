...
public class ProceedingsRelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsRelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsRelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProceedingsRelatesIterator.getType());
		} catch (Exception e) {
