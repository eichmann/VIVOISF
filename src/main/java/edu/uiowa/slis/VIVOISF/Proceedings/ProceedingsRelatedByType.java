...
public class ProceedingsRelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProceedingsRelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(ProceedingsRelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProceedingsRelatedByIterator.getType());
		} catch (Exception e) {
