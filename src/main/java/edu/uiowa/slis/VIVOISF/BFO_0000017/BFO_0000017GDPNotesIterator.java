...
public class BFO_0000017GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017GDPNotesIterator.class);
