...
public class BFO_0000017HasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017HasTitleIterator.getType());
		} catch (Exception e) {
