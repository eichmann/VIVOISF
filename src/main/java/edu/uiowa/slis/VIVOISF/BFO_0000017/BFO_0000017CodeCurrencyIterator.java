...
public class BFO_0000017CodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017CodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017CodeCurrencyIterator.class);
