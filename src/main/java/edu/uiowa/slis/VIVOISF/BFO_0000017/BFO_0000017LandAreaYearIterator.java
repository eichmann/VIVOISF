...
public class BFO_0000017LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017LandAreaYearIterator.class);
