...
public class BFO_0000017RelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017RelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017RelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000017RelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000017RelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000017RelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000017RelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000017Relates doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000017Relates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000017RelatesIterator");
