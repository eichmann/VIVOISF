...
public class BFO_0000017HasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HasMaxLongitudeIterator.class);
