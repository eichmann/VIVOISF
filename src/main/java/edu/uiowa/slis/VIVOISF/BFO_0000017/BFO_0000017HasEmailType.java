...
public class BFO_0000017HasEmailType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HasEmailType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HasEmailType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017HasEmailIterator.getType());
		} catch (Exception e) {
