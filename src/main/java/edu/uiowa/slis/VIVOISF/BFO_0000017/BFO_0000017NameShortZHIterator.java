...
public class BFO_0000017NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017NameShortZHIterator.class);
