...
public class BFO_0000017NationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017NationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017NationalityRUIterator.class);
