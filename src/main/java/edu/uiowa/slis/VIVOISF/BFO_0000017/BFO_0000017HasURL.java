...
public class BFO_0000017HasURL extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HasURL currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HasURL.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017HasURLIterator.getHasURL());
		} catch (Exception e) {
