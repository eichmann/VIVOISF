...
public class BFO_0000017HDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HDINotesIterator.class);
