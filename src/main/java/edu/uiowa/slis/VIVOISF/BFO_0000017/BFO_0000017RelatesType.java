...
public class BFO_0000017RelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017RelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017RelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017RelatesIterator.getType());
		} catch (Exception e) {
