...
public class BFO_0000017DescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017DescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017DescriptionIterator.class);
