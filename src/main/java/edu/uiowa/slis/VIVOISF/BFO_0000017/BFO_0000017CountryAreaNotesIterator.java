...
public class BFO_0000017CountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017CountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017CountryAreaNotesIterator.class);
