...
public class BFO_0000017PopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017PopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017PopulationYearIterator.class);
