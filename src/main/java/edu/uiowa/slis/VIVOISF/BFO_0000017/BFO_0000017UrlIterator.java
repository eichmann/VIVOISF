...
public class BFO_0000017UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017UrlIterator.class);
