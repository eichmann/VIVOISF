...
public class BFO_0000017NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017NameShortRUIterator.class);
