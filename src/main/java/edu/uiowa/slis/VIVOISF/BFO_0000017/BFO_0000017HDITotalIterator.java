...
public class BFO_0000017HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HDITotalIterator.class);
