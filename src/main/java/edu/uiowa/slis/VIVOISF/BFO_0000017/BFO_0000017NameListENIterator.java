...
public class BFO_0000017NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017NameListENIterator.class);
