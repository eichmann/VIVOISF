...
public class BFO_0000017HasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HasMinLatitudeIterator.class);
