...
public class BFO_0000017DateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017DateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017DateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017DateTimeIntervalIterator.getType());
		} catch (Exception e) {
