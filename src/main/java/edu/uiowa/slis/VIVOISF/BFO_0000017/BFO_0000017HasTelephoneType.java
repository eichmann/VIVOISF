...
public class BFO_0000017HasTelephoneType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HasTelephoneType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HasTelephoneType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017HasTelephoneIterator.getType());
		} catch (Exception e) {
