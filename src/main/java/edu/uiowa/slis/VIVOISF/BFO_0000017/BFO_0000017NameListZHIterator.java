...
public class BFO_0000017NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017NameListZHIterator.class);
