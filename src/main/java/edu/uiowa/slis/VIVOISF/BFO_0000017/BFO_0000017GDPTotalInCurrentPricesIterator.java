...
public class BFO_0000017GDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017GDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017GDPTotalInCurrentPricesIterator.class);
