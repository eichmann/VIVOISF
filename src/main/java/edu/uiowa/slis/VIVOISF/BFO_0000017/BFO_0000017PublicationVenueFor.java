...
public class BFO_0000017PublicationVenueFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017PublicationVenueFor currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017PublicationVenueFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017PublicationVenueForIterator.getPublicationVenueFor());
		} catch (Exception e) {
