...
public class BFO_0000017HasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017HasNameIterator.getType());
		} catch (Exception e) {
