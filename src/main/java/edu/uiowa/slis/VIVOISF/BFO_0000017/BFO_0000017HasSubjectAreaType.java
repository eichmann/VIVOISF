...
public class BFO_0000017HasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017HasSubjectAreaIterator.getType());
		} catch (Exception e) {
