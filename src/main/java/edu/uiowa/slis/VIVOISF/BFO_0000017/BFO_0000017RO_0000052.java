...
public class BFO_0000017RO_0000052 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017RO_0000052 currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017RO_0000052.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017RO_0000052Iterator.getRO_0000052());
		} catch (Exception e) {
