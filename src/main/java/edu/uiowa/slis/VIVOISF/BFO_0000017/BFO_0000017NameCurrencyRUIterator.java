...
public class BFO_0000017NameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017NameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017NameCurrencyRUIterator.class);
