...
public class BFO_0000017GDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017GDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017GDPUnitIterator.class);
