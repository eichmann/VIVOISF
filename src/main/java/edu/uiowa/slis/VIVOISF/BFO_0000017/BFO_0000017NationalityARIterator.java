...
public class BFO_0000017NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017NationalityARIterator.class);
