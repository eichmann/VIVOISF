...
public class BFO_0000017NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017NameListRUIterator.class);
