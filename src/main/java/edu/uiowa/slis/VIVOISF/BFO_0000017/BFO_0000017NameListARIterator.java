...
public class BFO_0000017NameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017NameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017NameListARIterator.class);
