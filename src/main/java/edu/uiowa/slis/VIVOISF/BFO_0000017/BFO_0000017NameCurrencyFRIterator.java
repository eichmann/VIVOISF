...
public class BFO_0000017NameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017NameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017NameCurrencyFRIterator.class);
