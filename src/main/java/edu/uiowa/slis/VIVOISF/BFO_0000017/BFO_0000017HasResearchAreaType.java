...
public class BFO_0000017HasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000017HasResearchAreaIterator.getType());
		} catch (Exception e) {
