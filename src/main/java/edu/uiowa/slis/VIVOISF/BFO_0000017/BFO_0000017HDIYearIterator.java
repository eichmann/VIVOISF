...
public class BFO_0000017HDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000017HDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000017HDIYearIterator.class);
