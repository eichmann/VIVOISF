...
public class SeqIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeqIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SeqIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://www.w3.org/1999/02/22-rdf-syntax-ns#Seq> . "+
