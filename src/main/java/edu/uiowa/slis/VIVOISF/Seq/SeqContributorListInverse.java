...
public class SeqContributorListInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SeqContributorListInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(SeqContributorListInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSeqContributorListInverseIterator.getContributorListInverse());
		} catch (Exception e) {
