...
public class PersonalCommunicationDocumentDocumentationFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentDocumentationFor currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentDocumentationFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonalCommunicationDocumentDocumentationForIterator.getDocumentationFor());
		} catch (Exception e) {
