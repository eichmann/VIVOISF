...
public class PersonalCommunicationDocumentHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentHandleIterator.class);
