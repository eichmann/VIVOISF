...
public class PersonalCommunicationDocumentNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentNumberIterator.class);
