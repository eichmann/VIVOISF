...
public class PersonalCommunicationDocument extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocument currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocument.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			PersonalCommunicationDocumentIterator thePersonalCommunicationDocumentIterator = (PersonalCommunicationDocumentIterator) findAncestorWithClass(this, PersonalCommunicationDocumentIterator.class);
			...
			log.error("Exception raised in PersonalCommunicationDocument doStartTag", e);
			throw new JspTagException("Exception raised in PersonalCommunicationDocument doStartTag");
		} finally {
			freeConnection();
		}
