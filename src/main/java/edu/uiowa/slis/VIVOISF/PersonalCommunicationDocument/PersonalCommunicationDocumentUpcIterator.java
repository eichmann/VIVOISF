...
public class PersonalCommunicationDocumentUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentUpcIterator.class);
