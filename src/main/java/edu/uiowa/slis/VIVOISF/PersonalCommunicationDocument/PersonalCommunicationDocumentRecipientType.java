...
public class PersonalCommunicationDocumentRecipientType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentRecipientType currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentRecipientType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonalCommunicationDocumentRecipientIterator.getType());
		} catch (Exception e) {
