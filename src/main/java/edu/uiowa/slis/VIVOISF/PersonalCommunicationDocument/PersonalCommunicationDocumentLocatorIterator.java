...
public class PersonalCommunicationDocumentLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentLocatorIterator.class);
