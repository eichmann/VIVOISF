...
public class PersonalCommunicationDocumentPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentPageStartIterator.class);
