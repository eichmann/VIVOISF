...
public class PersonalCommunicationDocumentShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentShortDescriptionIterator.class);
