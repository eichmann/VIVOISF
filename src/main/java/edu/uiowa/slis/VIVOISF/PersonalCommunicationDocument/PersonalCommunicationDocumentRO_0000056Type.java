...
public class PersonalCommunicationDocumentRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonalCommunicationDocumentRO_0000056Iterator.getType());
		} catch (Exception e) {
