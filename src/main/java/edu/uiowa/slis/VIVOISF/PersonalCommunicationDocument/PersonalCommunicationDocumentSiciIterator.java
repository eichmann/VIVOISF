...
public class PersonalCommunicationDocumentSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentSiciIterator.class);
