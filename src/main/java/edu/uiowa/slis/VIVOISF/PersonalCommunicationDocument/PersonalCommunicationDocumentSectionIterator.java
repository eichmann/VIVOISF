...
public class PersonalCommunicationDocumentSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentSectionIterator.class);
