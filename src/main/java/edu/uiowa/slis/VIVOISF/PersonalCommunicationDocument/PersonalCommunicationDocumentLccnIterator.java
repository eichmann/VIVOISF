...
public class PersonalCommunicationDocumentLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentLccnIterator.class);
