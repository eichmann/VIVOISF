...
public class PersonalCommunicationDocumentAuthorList extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentAuthorList currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentAuthorList.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonalCommunicationDocumentAuthorListIterator.getAuthorList());
		} catch (Exception e) {
