...
public class PersonalCommunicationDocumentCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentCodenIterator.class);
