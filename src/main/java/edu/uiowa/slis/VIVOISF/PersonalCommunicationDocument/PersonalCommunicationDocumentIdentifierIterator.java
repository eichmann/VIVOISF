...
public class PersonalCommunicationDocumentIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentIdentifierIterator.class);
