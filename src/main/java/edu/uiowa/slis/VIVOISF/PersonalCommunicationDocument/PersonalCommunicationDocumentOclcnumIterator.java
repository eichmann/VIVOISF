...
public class PersonalCommunicationDocumentOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonalCommunicationDocumentOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonalCommunicationDocumentOclcnumIterator.class);
