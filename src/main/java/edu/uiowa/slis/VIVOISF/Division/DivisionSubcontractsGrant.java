...
public class DivisionSubcontractsGrant extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DivisionSubcontractsGrant currentInstance = null;
	private static final Log log = LogFactory.getLog(DivisionSubcontractsGrant.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDivisionSubcontractsGrantIterator.getSubcontractsGrant());
		} catch (Exception e) {
