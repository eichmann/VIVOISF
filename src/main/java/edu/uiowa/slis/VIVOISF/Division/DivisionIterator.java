...
public class DivisionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DivisionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DivisionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Division> . "+
