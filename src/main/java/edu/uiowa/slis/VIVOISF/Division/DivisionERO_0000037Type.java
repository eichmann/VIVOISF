...
public class DivisionERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DivisionERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DivisionERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDivisionERO_0000037Iterator.getType());
		} catch (Exception e) {
