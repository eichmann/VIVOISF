...
public class DivisionERO_0001520Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DivisionERO_0001520Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DivisionERO_0001520Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDivisionERO_0001520Iterator.getType());
		} catch (Exception e) {
