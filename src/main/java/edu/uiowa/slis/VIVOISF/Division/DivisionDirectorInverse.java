...
public class DivisionDirectorInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DivisionDirectorInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(DivisionDirectorInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDivisionDirectorInverseIterator.getDirectorInverse());
		} catch (Exception e) {
