...
public class DivisionHasEquipmentType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DivisionHasEquipmentType currentInstance = null;
	private static final Log log = LogFactory.getLog(DivisionHasEquipmentType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDivisionHasEquipmentIterator.getType());
		} catch (Exception e) {
