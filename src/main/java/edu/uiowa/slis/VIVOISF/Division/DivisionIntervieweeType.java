...
public class DivisionIntervieweeType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DivisionIntervieweeType currentInstance = null;
	private static final Log log = LogFactory.getLog(DivisionIntervieweeType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDivisionIntervieweeIterator.getType());
		} catch (Exception e) {
