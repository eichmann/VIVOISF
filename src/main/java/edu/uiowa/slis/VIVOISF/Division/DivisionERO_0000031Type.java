...
public class DivisionERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DivisionERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DivisionERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDivisionERO_0000031Iterator.getType());
		} catch (Exception e) {
