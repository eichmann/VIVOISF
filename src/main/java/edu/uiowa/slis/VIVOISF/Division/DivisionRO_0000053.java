...
public class DivisionRO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DivisionRO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(DivisionRO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDivisionRO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
