...
public class DivisionHasCollaboratorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DivisionHasCollaboratorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DivisionHasCollaboratorIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DivisionHasCollaboratorIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DivisionHasCollaboratorIterator doStartTag");
		}
