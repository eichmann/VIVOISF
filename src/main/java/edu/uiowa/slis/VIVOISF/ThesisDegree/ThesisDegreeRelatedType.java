...
public class ThesisDegreeRelatedType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisDegreeRelatedType currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisDegreeRelatedType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThesisDegreeRelatedIterator.getType());
		} catch (Exception e) {
