...
public class ThesisDegreeMemberInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisDegreeMemberInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisDegreeMemberInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThesisDegreeMemberInverseIterator.getMemberInverse());
		} catch (Exception e) {
