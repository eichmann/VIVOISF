...
public class ThesisDegreeSemanticRelationInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisDegreeSemanticRelationInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisDegreeSemanticRelationInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThesisDegreeSemanticRelationInverseIterator.getType());
		} catch (Exception e) {
