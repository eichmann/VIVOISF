...
public class ThesisDegreeTopConceptOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThesisDegreeTopConceptOf currentInstance = null;
	private static final Log log = LogFactory.getLog(ThesisDegreeTopConceptOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThesisDegreeTopConceptOfIterator.getTopConceptOf());
		} catch (Exception e) {
