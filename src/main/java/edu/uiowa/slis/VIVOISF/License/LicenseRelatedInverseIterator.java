...
public class LicenseRelatedInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LicenseRelatedInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LicenseRelatedInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in LicenseRelatedInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in LicenseRelatedInverseIterator doStartTag");
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to LicenseRelatedIterator");
