...
public class WorkingPaperLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperLocatorIterator.class);
