...
public class WorkingPaperIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperIsbn10Iterator.class);
