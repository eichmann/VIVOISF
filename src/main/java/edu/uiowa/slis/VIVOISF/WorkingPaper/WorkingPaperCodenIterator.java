...
public class WorkingPaperCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperCodenIterator.class);
