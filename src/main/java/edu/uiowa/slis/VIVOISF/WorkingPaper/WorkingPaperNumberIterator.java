...
public class WorkingPaperNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperNumberIterator.class);
