...
public class WorkingPaperShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperShortDescriptionIterator.class);
