...
public class WorkingPaperSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperSiciIterator.class);
