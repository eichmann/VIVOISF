...
public class WorkingPaperPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperPageEndIterator.class);
