...
public class WorkingPaperNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperNumPagesIterator.class);
