...
public class WorkingPaperContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperContentIterator.class);
