...
public class WorkingPaperUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperUriIterator.class);
