...
public class WorkingPaperVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperVolumeIterator.class);
