...
public class WorkingPaperTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperTheAbstractIterator.class);
