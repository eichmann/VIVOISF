...
public class WorkingPaperShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperShortTitleIterator.class);
