...
public class WorkingPaperSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperSectionIterator.class);
