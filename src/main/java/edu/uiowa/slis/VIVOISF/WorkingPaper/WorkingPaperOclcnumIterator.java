...
public class WorkingPaperOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperOclcnumIterator.class);
