...
public class WorkingPaperDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperDoiIterator.class);
