...
public class WorkingPaperLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperLccnIterator.class);
