...
public class WorkingPaperPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperPmidIterator.class);
