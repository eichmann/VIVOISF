...
public class WorkingPaperDocumentationForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperDocumentationForType currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperDocumentationForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWorkingPaperDocumentationForIterator.getType());
		} catch (Exception e) {
