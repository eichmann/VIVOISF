...
public class WorkingPaperPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperPagesIterator.class);
