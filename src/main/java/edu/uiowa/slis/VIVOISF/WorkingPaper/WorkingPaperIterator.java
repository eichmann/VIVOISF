...
public class WorkingPaperIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#WorkingPaper> . "+
