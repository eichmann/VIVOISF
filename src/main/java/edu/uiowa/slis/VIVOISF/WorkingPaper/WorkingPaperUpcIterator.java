...
public class WorkingPaperUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperUpcIterator.class);
