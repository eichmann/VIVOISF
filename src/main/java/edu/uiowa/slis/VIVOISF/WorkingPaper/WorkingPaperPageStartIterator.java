...
public class WorkingPaperPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperPageStartIterator.class);
