...
public class WorkingPaperARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperARG_0000001Iterator.class);
