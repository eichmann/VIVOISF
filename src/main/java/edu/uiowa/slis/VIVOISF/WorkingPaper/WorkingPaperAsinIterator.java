...
public class WorkingPaperAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkingPaperAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkingPaperAsinIterator.class);
