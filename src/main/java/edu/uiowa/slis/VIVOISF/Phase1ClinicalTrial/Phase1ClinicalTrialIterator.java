...
public class Phase1ClinicalTrialIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Phase1ClinicalTrialIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Phase1ClinicalTrialIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/scientific-research#Phase1ClinicalTrial> . "+
			...
			log.error("Exception raised in Phase1ClinicalTrialIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in Phase1ClinicalTrialIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in Phase1ClinicalTrialIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in Phase1ClinicalTrialIterator doAfterBody");
		}
