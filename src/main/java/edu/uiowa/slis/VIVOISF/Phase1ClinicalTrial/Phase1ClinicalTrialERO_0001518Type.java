...
public class Phase1ClinicalTrialERO_0001518Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Phase1ClinicalTrialERO_0001518Type currentInstance = null;
	private static final Log log = LogFactory.getLog(Phase1ClinicalTrialERO_0001518Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePhase1ClinicalTrialERO_0001518Iterator.getType());
		} catch (Exception e) {
