...
public class LanguageRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LanguageRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LanguageRankIterator.class);
