...
public class LanguageIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LanguageIterator currentInstance = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(Prefix_1_4+
					" SELECT ?s ?l where { "+
						"?s rdfs:label ?l . "+
						"?s rdf:type <http://www.w3.org/2006/vcard/ns#Language> . "+
					"} ORDER BY ?l");
			if(rs.hasNext()) {
