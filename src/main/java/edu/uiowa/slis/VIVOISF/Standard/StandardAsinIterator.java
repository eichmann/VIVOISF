...
public class StandardAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardAsinIterator.class);
