...
public class StandardHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardHandleIterator.class);
