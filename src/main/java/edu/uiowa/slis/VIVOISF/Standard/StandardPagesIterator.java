...
public class StandardPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardPagesIterator.class);
