...
public class StandardPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardPageEndIterator.class);
