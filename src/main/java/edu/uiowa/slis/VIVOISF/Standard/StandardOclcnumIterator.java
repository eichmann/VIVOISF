...
public class StandardOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardOclcnumIterator.class);
