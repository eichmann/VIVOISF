...
public class StandardUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardUriIterator.class);
