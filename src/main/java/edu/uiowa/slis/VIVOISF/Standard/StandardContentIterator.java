...
public class StandardContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardContentIterator.class);
