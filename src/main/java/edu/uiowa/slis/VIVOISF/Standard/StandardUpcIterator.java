...
public class StandardUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardUpcIterator.class);
