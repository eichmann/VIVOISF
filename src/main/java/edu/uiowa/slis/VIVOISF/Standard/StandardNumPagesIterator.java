...
public class StandardNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardNumPagesIterator.class);
