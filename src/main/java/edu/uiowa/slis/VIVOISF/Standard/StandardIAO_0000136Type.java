...
public class StandardIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStandardIAO_0000136Iterator.getType());
		} catch (Exception e) {
