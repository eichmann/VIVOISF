...
public class StandardVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardVolumeIterator.class);
