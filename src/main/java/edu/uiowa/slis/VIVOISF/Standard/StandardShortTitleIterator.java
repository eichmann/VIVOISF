...
public class StandardShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardShortTitleIterator.class);
