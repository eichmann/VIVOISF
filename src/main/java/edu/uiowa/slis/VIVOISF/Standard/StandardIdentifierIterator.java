...
public class StandardIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardIdentifierIterator.class);
