...
public class StandardShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardShortDescriptionIterator.class);
