...
public class StandardProducer extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardProducer currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardProducer.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theStandardProducerIterator.getProducer());
		} catch (Exception e) {
