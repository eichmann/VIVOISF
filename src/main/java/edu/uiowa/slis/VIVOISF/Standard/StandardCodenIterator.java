...
public class StandardCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardCodenIterator.class);
