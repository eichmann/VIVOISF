...
public class StandardPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardPageStartIterator.class);
