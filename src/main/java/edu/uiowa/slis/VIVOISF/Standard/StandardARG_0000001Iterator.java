...
public class StandardARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardARG_0000001Iterator.class);
