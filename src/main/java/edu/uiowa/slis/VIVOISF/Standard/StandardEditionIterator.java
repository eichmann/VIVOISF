...
public class StandardEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardEditionIterator.class);
