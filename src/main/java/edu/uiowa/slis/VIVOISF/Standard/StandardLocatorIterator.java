...
public class StandardLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardLocatorIterator.class);
