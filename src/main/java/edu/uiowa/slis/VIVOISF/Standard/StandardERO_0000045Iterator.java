...
public class StandardERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardERO_0000045Iterator.class);
