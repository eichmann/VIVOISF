...
public class StandardSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardSectionIterator.class);
