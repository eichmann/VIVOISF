...
public class StandardTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardTheAbstractIterator.class);
