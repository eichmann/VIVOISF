...
public class StandardGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardGtin14Iterator.class);
