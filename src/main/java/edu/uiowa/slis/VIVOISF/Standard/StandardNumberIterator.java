...
public class StandardNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardNumberIterator.class);
