...
public class StandardPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardPmidIterator.class);
