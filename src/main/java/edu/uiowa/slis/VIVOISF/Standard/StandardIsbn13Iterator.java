...
public class StandardIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardIsbn13Iterator.class);
