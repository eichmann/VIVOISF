...
public class StandardDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardDoiIterator.class);
