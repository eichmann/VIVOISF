...
public class StandardSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardSiciIterator.class);
