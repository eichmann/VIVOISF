...
public class StandardLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static StandardLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(StandardLccnIterator.class);
