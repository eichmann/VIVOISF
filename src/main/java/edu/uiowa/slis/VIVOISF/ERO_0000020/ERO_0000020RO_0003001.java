...
public class ERO_0000020RO_0003001 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000020RO_0003001 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000020RO_0003001.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000020RO_0003001Iterator.getRO_0003001());
		} catch (Exception e) {
