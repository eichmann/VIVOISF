...
public class ERO_0000020ERO_0000918Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000020ERO_0000918Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000020ERO_0000918Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000020ERO_0000918Iterator.getType());
		} catch (Exception e) {
