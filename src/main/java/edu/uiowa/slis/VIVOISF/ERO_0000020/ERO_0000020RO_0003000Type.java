...
public class ERO_0000020RO_0003000Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000020RO_0003000Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000020RO_0003000Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000020RO_0003000Iterator.getType());
		} catch (Exception e) {
