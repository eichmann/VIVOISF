...
public class AwardedDegreeRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AwardedDegreeRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AwardedDegreeRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAwardedDegreeRO_0000052Iterator.getType());
		} catch (Exception e) {
