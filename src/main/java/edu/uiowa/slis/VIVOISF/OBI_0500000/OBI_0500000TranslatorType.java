...
public class OBI_0500000TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0500000TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0500000TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0500000TranslatorIterator.getType());
		} catch (Exception e) {
