...
public class OBI_0500000DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0500000DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0500000DoiIterator.class);
