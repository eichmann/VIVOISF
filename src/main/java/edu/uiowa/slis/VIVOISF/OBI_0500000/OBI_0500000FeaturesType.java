...
public class OBI_0500000FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0500000FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0500000FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0500000FeaturesIterator.getType());
		} catch (Exception e) {
