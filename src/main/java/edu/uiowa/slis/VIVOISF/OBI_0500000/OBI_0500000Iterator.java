...
public class OBI_0500000Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0500000Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0500000Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.obolibrary.org/obo/OBI_0500000> . "+
