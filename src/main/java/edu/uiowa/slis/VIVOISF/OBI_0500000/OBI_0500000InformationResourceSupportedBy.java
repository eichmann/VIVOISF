...
public class OBI_0500000InformationResourceSupportedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0500000InformationResourceSupportedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0500000InformationResourceSupportedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0500000InformationResourceSupportedByIterator.getInformationResourceSupportedBy());
		} catch (Exception e) {
