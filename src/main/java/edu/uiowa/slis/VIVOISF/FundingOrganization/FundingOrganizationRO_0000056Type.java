...
public class FundingOrganizationRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FundingOrganizationRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FundingOrganizationRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFundingOrganizationRO_0000056Iterator.getType());
		} catch (Exception e) {
