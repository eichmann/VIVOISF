...
public class FundingOrganizationSponsors extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FundingOrganizationSponsors currentInstance = null;
	private static final Log log = LogFactory.getLog(FundingOrganizationSponsors.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFundingOrganizationSponsorsIterator.getSponsors());
		} catch (Exception e) {
