...
public class FundingOrganizationERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FundingOrganizationERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FundingOrganizationERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFundingOrganizationERO_0000031Iterator.getType());
		} catch (Exception e) {
