...
public class FundingOrganizationIntervieweeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FundingOrganizationIntervieweeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FundingOrganizationIntervieweeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FundingOrganizationIntervieweeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FundingOrganizationIntervieweeIterator doStartTag");
		}
