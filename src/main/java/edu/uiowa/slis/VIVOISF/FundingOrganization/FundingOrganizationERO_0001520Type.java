...
public class FundingOrganizationERO_0001520Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FundingOrganizationERO_0001520Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FundingOrganizationERO_0001520Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFundingOrganizationERO_0001520Iterator.getType());
		} catch (Exception e) {
