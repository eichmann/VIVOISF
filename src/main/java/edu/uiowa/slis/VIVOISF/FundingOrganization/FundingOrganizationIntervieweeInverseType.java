...
public class FundingOrganizationIntervieweeInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FundingOrganizationIntervieweeInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(FundingOrganizationIntervieweeInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFundingOrganizationIntervieweeInverseIterator.getType());
		} catch (Exception e) {
