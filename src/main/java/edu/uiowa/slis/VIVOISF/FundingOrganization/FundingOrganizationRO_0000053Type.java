...
public class FundingOrganizationRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FundingOrganizationRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FundingOrganizationRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFundingOrganizationRO_0000053Iterator.getType());
		} catch (Exception e) {
