...
public class FundingOrganizationHasPredecessorOrganization extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FundingOrganizationHasPredecessorOrganization currentInstance = null;
	private static final Log log = LogFactory.getLog(FundingOrganizationHasPredecessorOrganization.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFundingOrganizationHasPredecessorOrganizationIterator.getHasPredecessorOrganization());
		} catch (Exception e) {
