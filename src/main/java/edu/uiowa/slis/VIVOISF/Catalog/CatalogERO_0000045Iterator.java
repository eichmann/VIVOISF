...
public class CatalogERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogERO_0000045Iterator.class);
