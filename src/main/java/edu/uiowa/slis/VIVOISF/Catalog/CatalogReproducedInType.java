...
public class CatalogReproducedInType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogReproducedInType currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogReproducedInType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCatalogReproducedInIterator.getType());
		} catch (Exception e) {
