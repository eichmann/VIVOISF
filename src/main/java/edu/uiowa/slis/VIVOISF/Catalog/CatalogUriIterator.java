...
public class CatalogUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogUriIterator.class);
