...
public class CatalogUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogUpcIterator.class);
