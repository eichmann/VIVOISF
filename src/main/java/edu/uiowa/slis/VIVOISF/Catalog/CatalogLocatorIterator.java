...
public class CatalogLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogLocatorIterator.class);
