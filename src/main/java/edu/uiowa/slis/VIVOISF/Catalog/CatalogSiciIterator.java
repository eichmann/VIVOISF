...
public class CatalogSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogSiciIterator.class);
