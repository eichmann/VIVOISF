...
public class CatalogHasTranslation extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogHasTranslation currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogHasTranslation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCatalogHasTranslationIterator.getHasTranslation());
		} catch (Exception e) {
