...
public class CatalogTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogTheAbstractIterator.class);
