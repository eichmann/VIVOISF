...
public class CatalogPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogPmidIterator.class);
