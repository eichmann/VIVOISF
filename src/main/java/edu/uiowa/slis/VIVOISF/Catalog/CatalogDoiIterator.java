...
public class CatalogDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogDoiIterator.class);
