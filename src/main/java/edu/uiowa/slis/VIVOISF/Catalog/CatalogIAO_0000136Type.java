...
public class CatalogIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCatalogIAO_0000136Iterator.getType());
		} catch (Exception e) {
