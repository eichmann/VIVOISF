...
public class CatalogShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogShortDescriptionIterator.class);
