...
public class CatalogEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogEanucc13Iterator.class);
