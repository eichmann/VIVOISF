...
public class CatalogPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogPageEndIterator.class);
