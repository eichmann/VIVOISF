...
public class CatalogSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogSectionIterator.class);
