...
public class CatalogEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogEditionIterator.class);
