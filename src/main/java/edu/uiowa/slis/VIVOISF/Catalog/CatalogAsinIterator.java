...
public class CatalogAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogAsinIterator.class);
