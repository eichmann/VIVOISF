...
public class CatalogIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Catalog> . "+
