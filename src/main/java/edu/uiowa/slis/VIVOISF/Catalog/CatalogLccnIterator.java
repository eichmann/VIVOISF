...
public class CatalogLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogLccnIterator.class);
