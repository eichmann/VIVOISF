...
public class CatalogIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogIdentifierIterator.class);
