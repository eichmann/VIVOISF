...
public class CatalogARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogARG_0000001Iterator.class);
