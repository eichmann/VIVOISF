...
public class CatalogContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogContentIterator.class);
