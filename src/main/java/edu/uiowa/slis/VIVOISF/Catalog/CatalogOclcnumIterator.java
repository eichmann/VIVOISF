...
public class CatalogOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogOclcnumIterator.class);
