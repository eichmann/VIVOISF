...
public class CatalogNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogNumberIterator.class);
