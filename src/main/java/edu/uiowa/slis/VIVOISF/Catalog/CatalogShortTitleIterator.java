...
public class CatalogShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogShortTitleIterator.class);
