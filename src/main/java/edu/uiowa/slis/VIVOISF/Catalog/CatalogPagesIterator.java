...
public class CatalogPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogPagesIterator.class);
