...
public class CatalogCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogCodenIterator.class);
