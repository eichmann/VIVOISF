...
public class CatalogIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogIsbn10Iterator.class);
