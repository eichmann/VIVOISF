...
public class CatalogHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CatalogHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CatalogHandleIterator.class);
