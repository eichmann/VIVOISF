...
public class ERO_0000393Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000393Features currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000393Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000393FeaturesIterator.getFeatures());
		} catch (Exception e) {
