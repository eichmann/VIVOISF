...
public class ERO_0000393TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000393TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000393TheAbstractIterator.class);
