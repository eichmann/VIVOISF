...
public class ERO_0000393DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000393DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000393DoiIterator.class);
