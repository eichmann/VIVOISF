...
public class ERO_0000393TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000393TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000393TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000393TranslatorIterator.getType());
		} catch (Exception e) {
