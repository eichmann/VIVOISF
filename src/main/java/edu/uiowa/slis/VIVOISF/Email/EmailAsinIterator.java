...
public class EmailAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailAsinIterator.class);
