...
public class EmailHasURLType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailHasURLType currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailHasURLType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmailHasURLIterator.getType());
		} catch (Exception e) {
