...
public class EmailIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailIsbn13Iterator.class);
