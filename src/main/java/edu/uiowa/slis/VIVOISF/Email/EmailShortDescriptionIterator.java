...
public class EmailShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailShortDescriptionIterator.class);
