...
public class EmailHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailHandleIterator.class);
