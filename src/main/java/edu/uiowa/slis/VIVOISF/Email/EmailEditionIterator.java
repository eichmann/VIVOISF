...
public class EmailEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailEditionIterator.class);
