...
public class EmailNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailNumberIterator.class);
