...
public class EmailCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailCodenIterator.class);
