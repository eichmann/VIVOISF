...
public class EmailPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailPageStartIterator.class);
