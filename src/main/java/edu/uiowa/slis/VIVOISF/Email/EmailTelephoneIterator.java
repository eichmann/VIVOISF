...
public class EmailTelephoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailTelephoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailTelephoneIterator.class);
