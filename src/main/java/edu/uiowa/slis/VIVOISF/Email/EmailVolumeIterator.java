...
public class EmailVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailVolumeIterator.class);
