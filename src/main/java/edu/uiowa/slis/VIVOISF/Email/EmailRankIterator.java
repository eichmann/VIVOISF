...
public class EmailRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailRankIterator.class);
