...
public class EmailReproducedIn extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailReproducedIn currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailReproducedIn.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmailReproducedInIterator.getReproducedIn());
		} catch (Exception e) {
