...
public class EmailIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailIsbn10Iterator.class);
