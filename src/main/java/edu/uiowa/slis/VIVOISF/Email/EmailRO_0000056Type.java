...
public class EmailRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmailRO_0000056Iterator.getType());
		} catch (Exception e) {
