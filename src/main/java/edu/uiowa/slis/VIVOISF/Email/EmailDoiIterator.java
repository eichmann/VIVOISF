...
public class EmailDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailDoiIterator.class);
