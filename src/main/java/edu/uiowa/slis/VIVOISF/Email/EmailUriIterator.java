...
public class EmailUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailUriIterator.class);
