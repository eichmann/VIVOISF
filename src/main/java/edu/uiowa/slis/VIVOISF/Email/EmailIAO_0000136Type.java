...
public class EmailIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmailIAO_0000136Iterator.getType());
		} catch (Exception e) {
