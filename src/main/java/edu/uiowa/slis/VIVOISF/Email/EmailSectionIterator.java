...
public class EmailSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailSectionIterator.class);
