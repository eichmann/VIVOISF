...
public class EmailUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailUrlIterator.class);
