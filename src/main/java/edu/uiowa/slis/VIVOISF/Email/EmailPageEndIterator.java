...
public class EmailPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailPageEndIterator.class);
