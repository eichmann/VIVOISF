...
public class EmailContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailContentIterator.class);
