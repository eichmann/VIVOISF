...
public class EmailPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailPagesIterator.class);
