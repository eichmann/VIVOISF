...
public class EmailLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailLccnIterator.class);
