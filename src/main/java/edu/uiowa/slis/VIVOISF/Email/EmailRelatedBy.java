...
public class EmailRelatedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailRelatedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailRelatedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmailRelatedByIterator.getRelatedBy());
		} catch (Exception e) {
