...
public class EmailSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailSiciIterator.class);
