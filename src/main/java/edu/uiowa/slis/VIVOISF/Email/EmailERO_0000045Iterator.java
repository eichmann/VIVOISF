...
public class EmailERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailERO_0000045Iterator.class);
