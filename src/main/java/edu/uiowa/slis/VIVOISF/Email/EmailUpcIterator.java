...
public class EmailUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailUpcIterator.class);
