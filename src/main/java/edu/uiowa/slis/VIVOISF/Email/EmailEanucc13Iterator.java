...
public class EmailEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailEanucc13Iterator.class);
