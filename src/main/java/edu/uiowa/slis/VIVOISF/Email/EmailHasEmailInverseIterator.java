	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				hasEmailInverse = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
	...
	public void setHasEmailInverse(String theHasEmailInverse) {
		hasEmailInverse = theHasEmailInverse;
	}
