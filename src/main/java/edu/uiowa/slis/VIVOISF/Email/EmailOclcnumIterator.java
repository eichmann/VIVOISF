...
public class EmailOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailOclcnumIterator.class);
