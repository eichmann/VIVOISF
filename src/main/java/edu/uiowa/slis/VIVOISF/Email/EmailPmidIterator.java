...
public class EmailPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailPmidIterator.class);
