...
public class EmailIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailIdentifierIterator.class);
