...
public class EmailShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailShortTitleIterator.class);
