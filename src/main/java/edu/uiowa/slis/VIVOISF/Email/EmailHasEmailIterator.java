...
public class EmailHasEmailIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailHasEmailIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailHasEmailIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EmailHasEmailIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EmailHasEmailIterator doStartTag");
		}
