...
public class EmailARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailARG_0000001Iterator.class);
