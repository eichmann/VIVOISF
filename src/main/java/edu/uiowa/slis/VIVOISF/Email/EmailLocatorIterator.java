...
public class EmailLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailLocatorIterator.class);
