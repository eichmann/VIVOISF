...
public class EmailMiddleNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailMiddleNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailMiddleNameIterator.class);
