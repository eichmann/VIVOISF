...
public class EmailGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmailGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmailGtin14Iterator.class);
