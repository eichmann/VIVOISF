...
public class LegislationUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationUpcIterator.class);
