...
public class LegislationNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationNumberIterator.class);
