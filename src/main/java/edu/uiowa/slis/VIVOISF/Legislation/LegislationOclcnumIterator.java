...
public class LegislationOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationOclcnumIterator.class);
