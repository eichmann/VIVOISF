...
public class LegislationShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationShortDescriptionIterator.class);
