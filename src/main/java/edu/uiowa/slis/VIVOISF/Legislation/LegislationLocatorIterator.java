...
public class LegislationLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationLocatorIterator.class);
