...
public class LegislationARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationARG_0000001Iterator.class);
