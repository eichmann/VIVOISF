...
public class LegislationNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationNumPagesIterator.class);
