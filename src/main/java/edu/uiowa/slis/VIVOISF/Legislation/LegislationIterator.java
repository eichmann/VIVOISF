...
public class LegislationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/Legislation> . "+
