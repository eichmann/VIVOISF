...
public class LegislationTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationTheAbstractIterator.class);
