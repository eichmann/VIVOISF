...
public class LegislationHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationHandleIterator.class);
