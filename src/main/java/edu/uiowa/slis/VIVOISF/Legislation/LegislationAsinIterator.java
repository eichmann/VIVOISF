...
public class LegislationAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationAsinIterator.class);
