...
public class LegislationERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationERO_0000045Iterator.class);
