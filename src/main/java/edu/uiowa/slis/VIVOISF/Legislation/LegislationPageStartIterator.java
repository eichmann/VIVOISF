...
public class LegislationPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationPageStartIterator.class);
