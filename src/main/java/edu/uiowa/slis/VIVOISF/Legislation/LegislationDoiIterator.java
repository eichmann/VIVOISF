...
public class LegislationDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationDoiIterator.class);
