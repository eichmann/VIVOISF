...
public class LegislationSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationSiciIterator.class);
