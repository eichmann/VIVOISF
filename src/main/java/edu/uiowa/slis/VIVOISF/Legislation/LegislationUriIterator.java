...
public class LegislationUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationUriIterator.class);
