...
public class LegislationVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationVolumeIterator.class);
