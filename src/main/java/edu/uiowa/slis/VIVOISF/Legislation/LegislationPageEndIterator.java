...
public class LegislationPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationPageEndIterator.class);
