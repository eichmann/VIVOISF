...
public class LegislationLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationLccnIterator.class);
