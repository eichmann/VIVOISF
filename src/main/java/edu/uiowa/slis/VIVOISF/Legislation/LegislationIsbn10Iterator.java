...
public class LegislationIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationIsbn10Iterator.class);
