...
public class LegislationPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationPmidIterator.class);
