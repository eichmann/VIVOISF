...
public class LegislationContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationContentIterator.class);
