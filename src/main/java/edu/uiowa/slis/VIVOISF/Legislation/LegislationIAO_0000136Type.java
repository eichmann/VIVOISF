...
public class LegislationIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegislationIAO_0000136Iterator.getType());
		} catch (Exception e) {
