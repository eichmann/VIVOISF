...
public class LegislationIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationIdentifierIterator.class);
