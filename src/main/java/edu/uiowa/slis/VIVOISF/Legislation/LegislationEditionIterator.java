...
public class LegislationEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationEditionIterator.class);
