...
public class LegislationCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationCodenIterator.class);
