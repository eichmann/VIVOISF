...
public class LegislationSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegislationSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegislationSectionIterator.class);
