...
public class AdvisingRelationshipIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AdvisingRelationshipIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AdvisingRelationshipIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#AdvisingRelationship> . "+
			...
			log.error("Exception raised in AdvisingRelationshipIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AdvisingRelationshipIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in AdvisingRelationshipIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AdvisingRelationshipIterator doAfterBody");
		}
