...
public class PerformanceBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PerformanceBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PerformanceBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePerformanceBFO_0000055Iterator.getType());
		} catch (Exception e) {
