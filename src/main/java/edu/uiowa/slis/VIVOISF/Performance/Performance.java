...
public class Performance extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Performance currentInstance = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			PerformanceIterator thePerformanceIterator = (PerformanceIterator) findAncestorWithClass(this, PerformanceIterator.class);
			...
			log.error("Exception raised in Performance doStartTag", e);
			throw new JspTagException("Exception raised in Performance doStartTag");
		} finally {
			freeConnection();
		}
