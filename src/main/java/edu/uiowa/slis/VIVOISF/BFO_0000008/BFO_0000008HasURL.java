...
public class BFO_0000008HasURL extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008HasURL currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008HasURL.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008HasURLIterator.getHasURL());
		} catch (Exception e) {
