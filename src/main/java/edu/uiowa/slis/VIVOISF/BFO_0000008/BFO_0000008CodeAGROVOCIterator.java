...
public class BFO_0000008CodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008CodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008CodeAGROVOCIterator.class);
