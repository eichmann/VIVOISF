...
public class BFO_0000008RelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008RelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008RelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008RelatedByIterator.getType());
		} catch (Exception e) {
