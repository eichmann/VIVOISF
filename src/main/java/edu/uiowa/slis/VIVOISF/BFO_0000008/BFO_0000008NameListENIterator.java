...
public class BFO_0000008NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameListENIterator.class);
