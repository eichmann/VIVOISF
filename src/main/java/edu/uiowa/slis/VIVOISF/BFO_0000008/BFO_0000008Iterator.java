...
public class BFO_0000008Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://purl.obolibrary.org/obo/BFO_0000008> . "+
