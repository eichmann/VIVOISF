...
public class BFO_0000008CodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008CodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008CodeISO3Iterator.class);
