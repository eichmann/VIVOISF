...
public class BFO_0000008HasTelephoneType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008HasTelephoneType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008HasTelephoneType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008HasTelephoneIterator.getType());
		} catch (Exception e) {
