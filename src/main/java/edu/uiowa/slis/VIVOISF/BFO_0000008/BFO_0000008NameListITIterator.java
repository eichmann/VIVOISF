...
public class BFO_0000008NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameListITIterator.class);
