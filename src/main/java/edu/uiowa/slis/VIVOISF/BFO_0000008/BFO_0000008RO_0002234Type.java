...
public class BFO_0000008RO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008RO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008RO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008RO_0002234Iterator.getType());
		} catch (Exception e) {
