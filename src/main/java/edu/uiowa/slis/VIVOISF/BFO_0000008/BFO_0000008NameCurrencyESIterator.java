...
public class BFO_0000008NameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameCurrencyESIterator.class);
