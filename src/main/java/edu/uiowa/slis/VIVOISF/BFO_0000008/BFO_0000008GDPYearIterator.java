...
public class BFO_0000008GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008GDPYearIterator.class);
