...
public class BFO_0000008HasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008HasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008HasMaxLatitudeIterator.class);
