...
public class BFO_0000008RO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008RO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008RO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008RO_0002353Iterator.getType());
		} catch (Exception e) {
