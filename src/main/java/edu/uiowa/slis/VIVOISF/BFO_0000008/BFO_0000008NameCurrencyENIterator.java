...
public class BFO_0000008NameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameCurrencyENIterator.class);
