...
public class BFO_0000008NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameShortRUIterator.class);
