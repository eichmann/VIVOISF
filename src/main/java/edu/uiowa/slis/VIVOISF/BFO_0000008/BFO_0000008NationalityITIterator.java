...
public class BFO_0000008NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NationalityITIterator.class);
