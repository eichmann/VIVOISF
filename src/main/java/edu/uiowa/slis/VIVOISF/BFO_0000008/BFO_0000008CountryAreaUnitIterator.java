...
public class BFO_0000008CountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008CountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008CountryAreaUnitIterator.class);
