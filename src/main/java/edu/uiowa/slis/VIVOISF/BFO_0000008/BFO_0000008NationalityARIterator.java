...
public class BFO_0000008NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NationalityARIterator.class);
