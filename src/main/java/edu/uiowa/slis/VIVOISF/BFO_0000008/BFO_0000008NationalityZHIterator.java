...
public class BFO_0000008NationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NationalityZHIterator.class);
