...
public class BFO_0000008NameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameShortENIterator.class);
