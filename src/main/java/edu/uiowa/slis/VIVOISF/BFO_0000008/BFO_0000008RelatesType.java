...
public class BFO_0000008RelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008RelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008RelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008RelatesIterator.getType());
		} catch (Exception e) {
