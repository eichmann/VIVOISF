...
public class BFO_0000008NameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameListARIterator.class);
