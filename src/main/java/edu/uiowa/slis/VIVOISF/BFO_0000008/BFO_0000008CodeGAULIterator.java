...
public class BFO_0000008CodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008CodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008CodeGAULIterator.class);
