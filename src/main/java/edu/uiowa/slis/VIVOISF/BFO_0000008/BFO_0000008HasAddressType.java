...
public class BFO_0000008HasAddressType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008HasAddressType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008HasAddressType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008HasAddressIterator.getType());
		} catch (Exception e) {
