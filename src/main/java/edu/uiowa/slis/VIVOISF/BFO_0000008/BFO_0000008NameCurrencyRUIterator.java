...
public class BFO_0000008NameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameCurrencyRUIterator.class);
