...
public class BFO_0000008HasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008HasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008HasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008HasSubjectAreaIterator.getType());
		} catch (Exception e) {
