...
public class BFO_0000008HasTitle extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008HasTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008HasTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008HasTitleIterator.getHasTitle());
		} catch (Exception e) {
