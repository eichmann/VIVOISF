...
public class BFO_0000008UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008UrlIterator.class);
