...
public class BFO_0000008NameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameOfficialRUIterator.class);
