...
public class BFO_0000008NationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NationalityFRIterator.class);
