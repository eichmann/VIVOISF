...
public class BFO_0000008PublicationVenueForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008PublicationVenueForType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008PublicationVenueForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008PublicationVenueForIterator.getType());
		} catch (Exception e) {
