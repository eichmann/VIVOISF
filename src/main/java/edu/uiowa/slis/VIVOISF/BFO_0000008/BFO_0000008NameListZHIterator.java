...
public class BFO_0000008NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameListZHIterator.class);
