...
public class BFO_0000008CodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008CodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008CodeUNDPIterator.class);
