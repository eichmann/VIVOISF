...
public class BFO_0000008NameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameListFRIterator.class);
