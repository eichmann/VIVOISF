...
public class BFO_0000008GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008GDPNotesIterator.class);
