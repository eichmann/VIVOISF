...
public class BFO_0000008HasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008HasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008HasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008HasNameIterator.getType());
		} catch (Exception e) {
