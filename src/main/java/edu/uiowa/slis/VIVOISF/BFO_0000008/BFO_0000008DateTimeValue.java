...
public class BFO_0000008DateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008DateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008DateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008DateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
