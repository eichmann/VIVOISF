...
public class BFO_0000008HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008HDITotalIterator.class);
