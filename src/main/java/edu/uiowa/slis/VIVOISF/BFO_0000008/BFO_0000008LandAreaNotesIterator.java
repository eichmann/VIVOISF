...
public class BFO_0000008LandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008LandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008LandAreaNotesIterator.class);
