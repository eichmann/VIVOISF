...
public class BFO_0000008NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameListRUIterator.class);
