...
public class BFO_0000008PopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008PopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008PopulationUnitIterator.class);
