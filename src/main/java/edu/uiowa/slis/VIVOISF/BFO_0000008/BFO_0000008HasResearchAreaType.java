...
public class BFO_0000008HasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008HasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008HasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008HasResearchAreaIterator.getType());
		} catch (Exception e) {
