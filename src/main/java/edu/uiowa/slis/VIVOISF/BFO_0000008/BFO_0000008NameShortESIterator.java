...
public class BFO_0000008NameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameShortESIterator.class);
