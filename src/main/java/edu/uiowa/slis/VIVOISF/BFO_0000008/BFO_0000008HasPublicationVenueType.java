...
public class BFO_0000008HasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008HasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008HasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008HasPublicationVenueIterator.getType());
		} catch (Exception e) {
