...
public class BFO_0000008Publisher extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008Publisher currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008Publisher.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000008PublisherIterator.getPublisher());
		} catch (Exception e) {
