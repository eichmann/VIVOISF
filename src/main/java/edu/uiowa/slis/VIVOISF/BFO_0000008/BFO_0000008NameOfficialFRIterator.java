...
public class BFO_0000008NameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NameOfficialFRIterator.class);
