...
public class BFO_0000008CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008CodeUNIterator.class);
