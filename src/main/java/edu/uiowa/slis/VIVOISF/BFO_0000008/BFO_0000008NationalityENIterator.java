...
public class BFO_0000008NationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000008NationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000008NationalityENIterator.class);
