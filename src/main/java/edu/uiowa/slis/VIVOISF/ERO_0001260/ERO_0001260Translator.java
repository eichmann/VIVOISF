...
public class ERO_0001260Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001260Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001260Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001260TranslatorIterator.getTranslator());
		} catch (Exception e) {
