...
public class ERO_0001260ERO_0000390 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001260ERO_0000390 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001260ERO_0000390.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001260ERO_0000390Iterator.getERO_0000390());
		} catch (Exception e) {
