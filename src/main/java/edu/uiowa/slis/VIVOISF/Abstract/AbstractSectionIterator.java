...
public class AbstractSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractSectionIterator.class);
