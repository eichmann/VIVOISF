...
public class AbstractIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractIsbn10Iterator.class);
