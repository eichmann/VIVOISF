...
public class AbstractUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractUriIterator.class);
