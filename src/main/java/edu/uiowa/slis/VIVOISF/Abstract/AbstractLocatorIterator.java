...
public class AbstractLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractLocatorIterator.class);
