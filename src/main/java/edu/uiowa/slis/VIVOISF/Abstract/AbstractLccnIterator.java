...
public class AbstractLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractLccnIterator.class);
