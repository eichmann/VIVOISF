...
public class AbstractTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractTheAbstractIterator.class);
