...
public class AbstractOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractOclcnumIterator.class);
