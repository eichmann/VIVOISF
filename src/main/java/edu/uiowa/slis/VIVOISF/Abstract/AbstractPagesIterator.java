...
public class AbstractPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractPagesIterator.class);
