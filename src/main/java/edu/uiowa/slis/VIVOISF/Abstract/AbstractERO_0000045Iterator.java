...
public class AbstractERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractERO_0000045Iterator.class);
