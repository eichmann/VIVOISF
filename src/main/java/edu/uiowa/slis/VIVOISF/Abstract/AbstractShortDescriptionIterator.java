...
public class AbstractShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractShortDescriptionIterator.class);
