...
public class AbstractContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractContentIterator.class);
