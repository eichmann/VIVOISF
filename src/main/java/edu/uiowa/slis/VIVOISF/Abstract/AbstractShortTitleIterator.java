...
public class AbstractShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractShortTitleIterator.class);
