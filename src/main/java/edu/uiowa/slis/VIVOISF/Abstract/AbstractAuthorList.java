...
public class AbstractAuthorList extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractAuthorList currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractAuthorList.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAbstractAuthorListIterator.getAuthorList());
		} catch (Exception e) {
