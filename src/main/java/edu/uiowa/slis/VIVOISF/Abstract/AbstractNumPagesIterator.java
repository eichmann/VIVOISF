...
public class AbstractNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractNumPagesIterator.class);
