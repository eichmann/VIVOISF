...
public class AbstractARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractARG_0000001Iterator.class);
