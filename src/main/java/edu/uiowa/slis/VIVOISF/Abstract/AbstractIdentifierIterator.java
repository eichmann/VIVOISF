...
public class AbstractIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractIdentifierIterator.class);
