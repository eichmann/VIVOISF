...
public class AbstractUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractUpcIterator.class);
