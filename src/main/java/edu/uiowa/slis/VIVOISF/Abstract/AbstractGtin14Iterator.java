...
public class AbstractGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractGtin14Iterator.class);
