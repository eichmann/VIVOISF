...
public class AbstractAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractAsinIterator.class);
