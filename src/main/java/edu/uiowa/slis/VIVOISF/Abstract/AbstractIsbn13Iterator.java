...
public class AbstractIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractIsbn13Iterator.class);
