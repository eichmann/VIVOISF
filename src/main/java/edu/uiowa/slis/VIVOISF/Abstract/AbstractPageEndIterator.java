...
public class AbstractPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractPageEndIterator.class);
