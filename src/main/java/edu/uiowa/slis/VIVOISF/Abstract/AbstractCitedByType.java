...
public class AbstractCitedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractCitedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractCitedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAbstractCitedByIterator.getType());
		} catch (Exception e) {
