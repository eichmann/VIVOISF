...
public class AbstractEditorList extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractEditorList currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractEditorList.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAbstractEditorListIterator.getEditorList());
		} catch (Exception e) {
