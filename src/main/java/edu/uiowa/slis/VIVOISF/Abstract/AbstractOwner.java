...
public class AbstractOwner extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractOwner currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractOwner.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAbstractOwnerIterator.getOwner());
		} catch (Exception e) {
