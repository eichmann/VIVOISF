...
public class AbstractVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractVolumeIterator.class);
