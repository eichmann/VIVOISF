...
public class AbstractEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractEanucc13Iterator.class);
