...
public class AbstractHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractHandleIterator.class);
