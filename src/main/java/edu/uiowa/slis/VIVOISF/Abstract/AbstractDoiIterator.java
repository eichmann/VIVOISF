...
public class AbstractDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractDoiIterator.class);
