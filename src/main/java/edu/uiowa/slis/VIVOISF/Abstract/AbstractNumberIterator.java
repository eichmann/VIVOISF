...
public class AbstractNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractNumberIterator.class);
