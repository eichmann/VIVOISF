...
public class AbstractEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractEditionIterator.class);
