...
public class AbstractSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractSiciIterator.class);
