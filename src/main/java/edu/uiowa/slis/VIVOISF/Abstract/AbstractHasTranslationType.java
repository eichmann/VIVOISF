...
public class AbstractHasTranslationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractHasTranslationType currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractHasTranslationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAbstractHasTranslationIterator.getType());
		} catch (Exception e) {
