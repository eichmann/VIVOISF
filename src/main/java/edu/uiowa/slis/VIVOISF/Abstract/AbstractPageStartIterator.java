...
public class AbstractPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractPageStartIterator.class);
