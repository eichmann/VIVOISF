...
public class AbstractCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AbstractCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AbstractCodenIterator.class);
