...
public class ERO_0001716ERO_0000034Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001716ERO_0000034Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001716ERO_0000034Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001716ERO_0000034Iterator.getType());
		} catch (Exception e) {
