...
public class ERO_0001716TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001716TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001716TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001716TranslatorIterator.getType());
		} catch (Exception e) {
