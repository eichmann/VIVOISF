...
public class ERO_0001716FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001716FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001716FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001716FeaturesIterator.getType());
		} catch (Exception e) {
