...
public class ResearchOrganizationRelatedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationRelatedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationRelatedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationRelatedByIterator.getRelatedBy());
		} catch (Exception e) {
