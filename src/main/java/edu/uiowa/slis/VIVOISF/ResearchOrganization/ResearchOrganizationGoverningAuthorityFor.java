...
public class ResearchOrganizationGoverningAuthorityFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationGoverningAuthorityFor currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationGoverningAuthorityFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationGoverningAuthorityForIterator.getGoverningAuthorityFor());
		} catch (Exception e) {
