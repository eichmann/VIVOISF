...
public class ResearchOrganizationPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationPrefixNameIterator.class);
