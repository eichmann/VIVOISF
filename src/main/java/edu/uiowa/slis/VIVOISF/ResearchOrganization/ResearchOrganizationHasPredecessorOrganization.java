...
public class ResearchOrganizationHasPredecessorOrganization extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationHasPredecessorOrganization currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationHasPredecessorOrganization.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationHasPredecessorOrganizationIterator.getHasPredecessorOrganization());
		} catch (Exception e) {
