...
public class ResearchOrganizationPublisherOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationPublisherOf currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationPublisherOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationPublisherOfIterator.getPublisherOf());
		} catch (Exception e) {
