...
public class ResearchOrganizationIntervieweeInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationIntervieweeInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationIntervieweeInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationIntervieweeInverseIterator.getIntervieweeInverse());
		} catch (Exception e) {
