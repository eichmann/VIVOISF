...
public class ResearchOrganizationRO_0000056 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationRO_0000056 currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationRO_0000056.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationRO_0000056Iterator.getRO_0000056());
		} catch (Exception e) {
