...
public class ResearchOrganizationRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationRO_0000053Iterator.getType());
		} catch (Exception e) {
