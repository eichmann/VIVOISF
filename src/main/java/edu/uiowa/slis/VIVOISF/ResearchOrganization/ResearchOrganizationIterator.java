...
public class ResearchOrganizationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#ResearchOrganization> . "+
