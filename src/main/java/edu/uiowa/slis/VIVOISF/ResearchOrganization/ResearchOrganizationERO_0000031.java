...
public class ResearchOrganizationERO_0000031 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationERO_0000031 currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationERO_0000031.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationERO_0000031Iterator.getERO_0000031());
		} catch (Exception e) {
