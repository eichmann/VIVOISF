...
public class ResearchOrganizationIssuerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationIssuerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationIssuerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationIssuerInverseIterator.getIssuerInverse());
		} catch (Exception e) {
