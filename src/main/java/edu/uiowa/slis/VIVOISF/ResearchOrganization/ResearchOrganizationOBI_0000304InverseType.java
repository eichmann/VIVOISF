...
public class ResearchOrganizationOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
