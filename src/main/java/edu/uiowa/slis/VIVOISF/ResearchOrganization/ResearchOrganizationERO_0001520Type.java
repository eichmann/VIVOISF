...
public class ResearchOrganizationERO_0001520Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationERO_0001520Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationERO_0001520Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationERO_0001520Iterator.getType());
		} catch (Exception e) {
