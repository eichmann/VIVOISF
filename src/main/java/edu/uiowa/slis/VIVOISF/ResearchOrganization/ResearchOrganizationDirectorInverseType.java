...
public class ResearchOrganizationDirectorInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ResearchOrganizationDirectorInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ResearchOrganizationDirectorInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theResearchOrganizationDirectorInverseIterator.getType());
		} catch (Exception e) {
