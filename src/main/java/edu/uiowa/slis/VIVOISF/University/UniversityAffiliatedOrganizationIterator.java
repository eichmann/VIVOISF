...
public class UniversityAffiliatedOrganizationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UniversityAffiliatedOrganizationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UniversityAffiliatedOrganizationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in UniversityAffiliatedOrganizationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in UniversityAffiliatedOrganizationIterator doStartTag");
		}
