...
public class UniversityHasSuccessorOrganizationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UniversityHasSuccessorOrganizationType currentInstance = null;
	private static final Log log = LogFactory.getLog(UniversityHasSuccessorOrganizationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUniversityHasSuccessorOrganizationIterator.getType());
		} catch (Exception e) {
