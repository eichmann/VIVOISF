...
public class UniversityOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UniversityOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(UniversityOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUniversityOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
