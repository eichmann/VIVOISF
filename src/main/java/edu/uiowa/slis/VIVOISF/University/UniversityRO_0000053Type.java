...
public class UniversityRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UniversityRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UniversityRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUniversityRO_0000053Iterator.getType());
		} catch (Exception e) {
