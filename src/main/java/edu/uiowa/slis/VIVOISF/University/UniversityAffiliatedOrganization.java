...
public class UniversityAffiliatedOrganization extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UniversityAffiliatedOrganization currentInstance = null;
	private static final Log log = LogFactory.getLog(UniversityAffiliatedOrganization.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUniversityAffiliatedOrganizationIterator.getAffiliatedOrganization());
		} catch (Exception e) {
