...
public class UniversityERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UniversityERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UniversityERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUniversityERO_0000031Iterator.getType());
		} catch (Exception e) {
