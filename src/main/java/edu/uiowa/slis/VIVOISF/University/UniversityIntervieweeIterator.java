...
public class UniversityIntervieweeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UniversityIntervieweeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UniversityIntervieweeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in UniversityIntervieweeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in UniversityIntervieweeIterator doStartTag");
		}
