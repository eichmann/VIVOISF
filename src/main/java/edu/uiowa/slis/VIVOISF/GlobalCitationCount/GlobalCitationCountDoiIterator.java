...
public class GlobalCitationCountDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GlobalCitationCountDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GlobalCitationCountDoiIterator.class);
