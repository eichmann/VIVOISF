...
public class GlobalCitationCountRO_0000056 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GlobalCitationCountRO_0000056 currentInstance = null;
	private static final Log log = LogFactory.getLog(GlobalCitationCountRO_0000056.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGlobalCitationCountRO_0000056Iterator.getRO_0000056());
		} catch (Exception e) {
