...
public class GlobalCitationCountIAO_0000221 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GlobalCitationCountIAO_0000221 currentInstance = null;
	private static final Log log = LogFactory.getLog(GlobalCitationCountIAO_0000221.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGlobalCitationCountIAO_0000221Iterator.getIAO_0000221());
		} catch (Exception e) {
