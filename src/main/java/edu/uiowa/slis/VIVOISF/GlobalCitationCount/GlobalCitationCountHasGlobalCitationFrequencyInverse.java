...
public class GlobalCitationCountHasGlobalCitationFrequencyInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GlobalCitationCountHasGlobalCitationFrequencyInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(GlobalCitationCountHasGlobalCitationFrequencyInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGlobalCitationCountHasGlobalCitationFrequencyInverseIterator.getHasGlobalCitationFrequencyInverse());
		} catch (Exception e) {
