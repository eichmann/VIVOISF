...
public class GlobalCitationCountTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GlobalCitationCountTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GlobalCitationCountTheAbstractIterator.class);
