...
public class AdministratorRoleRO_0000056 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AdministratorRoleRO_0000056 currentInstance = null;
	private static final Log log = LogFactory.getLog(AdministratorRoleRO_0000056.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAdministratorRoleRO_0000056Iterator.getRO_0000056());
		} catch (Exception e) {
