...
public class AdministratorRoleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AdministratorRoleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AdministratorRoleIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#AdministratorRole> . "+
			...
			log.error("Exception raised in AdministratorRoleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AdministratorRoleIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in AdministratorRoleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in AdministratorRoleIterator doAfterBody");
		}
