...
public class CategoryRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CategoryRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CategoryRankIterator.class);
