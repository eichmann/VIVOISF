...
public class CategoryUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CategoryUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CategoryUrlIterator.class);
