...
public class CategoryIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CategoryIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CategoryIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(Prefix_1_4+
					" SELECT ?s ?l where { "+
						"?s rdfs:label ?l . "+
						"?s rdf:type <http://www.w3.org/2006/vcard/ns#Category> . "+
					"} ORDER BY ?l");
			if(rs.hasNext()) {
