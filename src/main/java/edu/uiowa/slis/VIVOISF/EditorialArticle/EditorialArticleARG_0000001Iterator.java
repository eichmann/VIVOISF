...
public class EditorialArticleARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleARG_0000001Iterator.class);
