...
public class EditorialArticleOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleOclcnumIterator.class);
