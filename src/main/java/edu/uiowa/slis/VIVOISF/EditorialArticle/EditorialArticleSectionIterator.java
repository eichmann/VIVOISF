...
public class EditorialArticleSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleSectionIterator.class);
