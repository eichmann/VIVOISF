...
public class EditorialArticlePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticlePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticlePagesIterator.class);
