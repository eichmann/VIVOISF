...
public class EditorialArticleCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleCodenIterator.class);
