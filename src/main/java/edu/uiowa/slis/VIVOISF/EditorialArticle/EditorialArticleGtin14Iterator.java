...
public class EditorialArticleGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleGtin14Iterator.class);
