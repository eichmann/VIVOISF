...
public class EditorialArticleIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleIsbn10Iterator.class);
