...
public class EditorialArticleVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleVolumeIterator.class);
