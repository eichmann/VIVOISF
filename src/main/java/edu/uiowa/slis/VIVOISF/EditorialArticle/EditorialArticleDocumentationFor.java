...
public class EditorialArticleDocumentationFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleDocumentationFor currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleDocumentationFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditorialArticleDocumentationForIterator.getDocumentationFor());
		} catch (Exception e) {
