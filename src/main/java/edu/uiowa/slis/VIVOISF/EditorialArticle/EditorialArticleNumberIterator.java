...
public class EditorialArticleNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleNumberIterator.class);
