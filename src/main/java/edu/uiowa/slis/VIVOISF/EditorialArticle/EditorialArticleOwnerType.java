...
public class EditorialArticleOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditorialArticleOwnerIterator.getType());
		} catch (Exception e) {
