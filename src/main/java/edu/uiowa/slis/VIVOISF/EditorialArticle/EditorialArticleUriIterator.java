...
public class EditorialArticleUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleUriIterator.class);
