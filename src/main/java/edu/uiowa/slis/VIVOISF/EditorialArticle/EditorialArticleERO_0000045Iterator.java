...
public class EditorialArticleERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleERO_0000045Iterator.class);
