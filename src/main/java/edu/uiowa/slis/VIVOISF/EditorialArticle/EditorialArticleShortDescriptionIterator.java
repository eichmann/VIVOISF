...
public class EditorialArticleShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleShortDescriptionIterator.class);
