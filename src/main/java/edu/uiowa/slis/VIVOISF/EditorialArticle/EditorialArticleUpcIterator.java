...
public class EditorialArticleUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleUpcIterator.class);
