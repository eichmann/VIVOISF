...
public class EditorialArticleNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleNumPagesIterator.class);
