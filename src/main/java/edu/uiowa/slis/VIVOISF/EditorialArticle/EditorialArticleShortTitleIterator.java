...
public class EditorialArticleShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleShortTitleIterator.class);
