...
public class EditorialArticleLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleLocatorIterator.class);
