...
public class EditorialArticleAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleAsinIterator.class);
