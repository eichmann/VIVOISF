...
public class EditorialArticleLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleLccnIterator.class);
