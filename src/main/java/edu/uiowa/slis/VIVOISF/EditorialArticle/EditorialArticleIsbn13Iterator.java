...
public class EditorialArticleIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleIsbn13Iterator.class);
