...
public class EditorialArticleTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleTheAbstractIterator.class);
