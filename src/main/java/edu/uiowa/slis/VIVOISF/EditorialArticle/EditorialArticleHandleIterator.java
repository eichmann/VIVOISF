...
public class EditorialArticleHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleHandleIterator.class);
