...
public class EditorialArticlePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticlePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticlePageStartIterator.class);
