...
public class EditorialArticleRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditorialArticleRO_0000056Iterator.getType());
		} catch (Exception e) {
