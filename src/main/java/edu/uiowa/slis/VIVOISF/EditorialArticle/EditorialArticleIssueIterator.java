...
public class EditorialArticleIssueIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleIssueIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleIssueIterator.class);
