...
public class EditorialArticleDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleDoiIterator.class);
