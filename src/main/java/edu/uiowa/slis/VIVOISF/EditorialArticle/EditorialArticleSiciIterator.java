...
public class EditorialArticleSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleSiciIterator.class);
