...
public class EditorialArticleIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorialArticleIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorialArticleIdentifierIterator.class);
