...
public class FoundationAffiliatedOrganizationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FoundationAffiliatedOrganizationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FoundationAffiliatedOrganizationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FoundationAffiliatedOrganizationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FoundationAffiliatedOrganizationIterator doStartTag");
		}
