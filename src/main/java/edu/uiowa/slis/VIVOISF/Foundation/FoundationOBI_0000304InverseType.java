...
public class FoundationOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FoundationOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(FoundationOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFoundationOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
