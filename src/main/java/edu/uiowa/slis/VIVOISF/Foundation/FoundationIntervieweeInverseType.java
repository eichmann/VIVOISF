...
public class FoundationIntervieweeInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FoundationIntervieweeInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(FoundationIntervieweeInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFoundationIntervieweeInverseIterator.getType());
		} catch (Exception e) {
