...
public class FoundationERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FoundationERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FoundationERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFoundationERO_0000037Iterator.getType());
		} catch (Exception e) {
