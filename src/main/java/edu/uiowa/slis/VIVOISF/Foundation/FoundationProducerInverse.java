...
public class FoundationProducerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FoundationProducerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(FoundationProducerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFoundationProducerInverseIterator.getProducerInverse());
		} catch (Exception e) {
