...
public class FoundationRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FoundationRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FoundationRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFoundationRO_0000056Iterator.getType());
		} catch (Exception e) {
