...
public class HospitalOrganizerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalOrganizerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalOrganizerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theHospitalOrganizerInverseIterator.getType());
		} catch (Exception e) {
