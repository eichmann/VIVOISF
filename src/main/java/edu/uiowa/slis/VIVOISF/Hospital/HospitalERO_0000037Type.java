...
public class HospitalERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theHospitalERO_0000037Iterator.getType());
		} catch (Exception e) {
