...
public class HospitalRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theHospitalRO_0000053Iterator.getType());
		} catch (Exception e) {
