...
public class HospitalERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theHospitalERO_0000031Iterator.getType());
		} catch (Exception e) {
