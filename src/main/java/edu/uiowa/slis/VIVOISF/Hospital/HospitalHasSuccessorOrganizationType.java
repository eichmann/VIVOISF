...
public class HospitalHasSuccessorOrganizationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalHasSuccessorOrganizationType currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalHasSuccessorOrganizationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theHospitalHasSuccessorOrganizationIterator.getType());
		} catch (Exception e) {
