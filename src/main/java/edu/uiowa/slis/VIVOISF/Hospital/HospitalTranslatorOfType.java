...
public class HospitalTranslatorOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalTranslatorOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalTranslatorOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theHospitalTranslatorOfIterator.getType());
		} catch (Exception e) {
