...
public class HospitalInterviewerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalInterviewerType currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalInterviewerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theHospitalInterviewerIterator.getType());
		} catch (Exception e) {
