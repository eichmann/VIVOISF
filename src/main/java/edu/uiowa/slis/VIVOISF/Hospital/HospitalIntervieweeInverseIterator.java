...
public class HospitalIntervieweeInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalIntervieweeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalIntervieweeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in HospitalIntervieweeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in HospitalIntervieweeInverseIterator doStartTag");
		}
