...
public class HospitalOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theHospitalOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
