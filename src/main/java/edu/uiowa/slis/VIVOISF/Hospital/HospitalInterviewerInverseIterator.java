...
public class HospitalInterviewerInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalInterviewerInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalInterviewerInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in HospitalInterviewerInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in HospitalInterviewerInverseIterator doStartTag");
		}
