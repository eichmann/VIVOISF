...
public class HospitalCourtInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HospitalCourtInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(HospitalCourtInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theHospitalCourtInverseIterator.getType());
		} catch (Exception e) {
