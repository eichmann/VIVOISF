...
public class InstantMessageRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InstantMessageRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InstantMessageRankIterator.class);
