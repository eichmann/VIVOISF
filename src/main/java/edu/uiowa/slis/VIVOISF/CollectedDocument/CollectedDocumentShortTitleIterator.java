...
public class CollectedDocumentShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentShortTitleIterator.class);
