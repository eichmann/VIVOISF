...
public class CollectedDocumentUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentUriIterator.class);
