...
public class CollectedDocumentHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentHandleIterator.class);
