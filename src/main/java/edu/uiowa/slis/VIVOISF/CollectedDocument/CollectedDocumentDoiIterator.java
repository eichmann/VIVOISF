...
public class CollectedDocumentDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentDoiIterator.class);
