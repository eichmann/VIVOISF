...
public class CollectedDocumentOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentOclcnumIterator.class);
