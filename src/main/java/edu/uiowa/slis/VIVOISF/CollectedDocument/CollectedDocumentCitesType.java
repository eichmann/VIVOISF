...
public class CollectedDocumentCitesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentCitesType currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentCitesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectedDocumentCitesIterator.getType());
		} catch (Exception e) {
