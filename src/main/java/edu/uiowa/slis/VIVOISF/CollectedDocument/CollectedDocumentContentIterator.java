...
public class CollectedDocumentContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentContentIterator.class);
