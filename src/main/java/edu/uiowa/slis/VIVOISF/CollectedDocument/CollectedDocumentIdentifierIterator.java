...
public class CollectedDocumentIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentIdentifierIterator.class);
