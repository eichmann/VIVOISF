...
public class CollectedDocumentPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentPmidIterator.class);
