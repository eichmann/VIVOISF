...
public class CollectedDocumentReproducedInIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(CollectedDocumentReproducedInIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectedDocumentReproducedInIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollectedDocumentReproducedInIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CollectedDocumentReproducedIn doEndTag", e);
			throw new JspTagException("Exception raised in CollectedDocumentReproducedIn doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
