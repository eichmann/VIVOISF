...
public class CollectedDocumentEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentEditionIterator.class);
