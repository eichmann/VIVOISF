...
public class CollectedDocumentEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentEanucc13Iterator.class);
