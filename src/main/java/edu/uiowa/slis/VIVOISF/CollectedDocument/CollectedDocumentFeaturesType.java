...
public class CollectedDocumentFeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentFeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentFeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollectedDocumentFeaturesIterator.getType());
		} catch (Exception e) {
