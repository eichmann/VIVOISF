...
public class CollectedDocumentERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentERO_0000045Iterator.class);
