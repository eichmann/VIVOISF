...
public class CollectedDocumentSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentSectionIterator.class);
