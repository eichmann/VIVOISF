...
public class CollectedDocumentIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentIsbn10Iterator.class);
