...
public class CollectedDocumentIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentIsbn13Iterator.class);
