...
public class CollectedDocumentGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentGtin14Iterator.class);
