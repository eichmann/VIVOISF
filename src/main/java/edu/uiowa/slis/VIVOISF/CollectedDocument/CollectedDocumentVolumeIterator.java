...
public class CollectedDocumentVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentVolumeIterator.class);
