...
public class CollectedDocumentPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentPagesIterator.class);
