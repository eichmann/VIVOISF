...
public class CollectedDocumentShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentShortDescriptionIterator.class);
