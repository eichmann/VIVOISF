...
public class CollectedDocumentTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentTheAbstractIterator.class);
