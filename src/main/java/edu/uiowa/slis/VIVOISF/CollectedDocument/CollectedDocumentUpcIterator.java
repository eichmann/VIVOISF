...
public class CollectedDocumentUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentUpcIterator.class);
