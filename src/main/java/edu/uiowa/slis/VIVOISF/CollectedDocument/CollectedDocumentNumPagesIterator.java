...
public class CollectedDocumentNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentNumPagesIterator.class);
