...
public class CollectedDocumentCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentCodenIterator.class);
