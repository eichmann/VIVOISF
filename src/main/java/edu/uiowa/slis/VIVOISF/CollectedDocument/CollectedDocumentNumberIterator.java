...
public class CollectedDocumentNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentNumberIterator.class);
