...
public class CollectedDocumentAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentAsinIterator.class);
