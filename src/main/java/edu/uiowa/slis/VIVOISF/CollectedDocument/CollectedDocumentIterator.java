...
public class CollectedDocumentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollectedDocumentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollectedDocumentIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/CollectedDocument> . "+
