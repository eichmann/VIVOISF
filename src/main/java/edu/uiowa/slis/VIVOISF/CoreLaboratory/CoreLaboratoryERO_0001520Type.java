...
public class CoreLaboratoryERO_0001520Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoreLaboratoryERO_0001520Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CoreLaboratoryERO_0001520Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCoreLaboratoryERO_0001520Iterator.getType());
		} catch (Exception e) {
