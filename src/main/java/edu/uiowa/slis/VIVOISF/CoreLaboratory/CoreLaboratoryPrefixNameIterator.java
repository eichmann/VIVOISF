...
public class CoreLaboratoryPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoreLaboratoryPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CoreLaboratoryPrefixNameIterator.class);
