...
public class CoreLaboratorySuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoreLaboratorySuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CoreLaboratorySuffixNameIterator.class);
