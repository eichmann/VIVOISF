...
public class CoreLaboratoryIssuerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoreLaboratoryIssuerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(CoreLaboratoryIssuerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCoreLaboratoryIssuerInverseIterator.getType());
		} catch (Exception e) {
