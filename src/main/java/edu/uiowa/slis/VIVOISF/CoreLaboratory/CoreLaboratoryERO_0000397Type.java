...
public class CoreLaboratoryERO_0000397Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoreLaboratoryERO_0000397Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CoreLaboratoryERO_0000397Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCoreLaboratoryERO_0000397Iterator.getType());
		} catch (Exception e) {
