...
public class CoreLaboratoryTranslatorOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoreLaboratoryTranslatorOf currentInstance = null;
	private static final Log log = LogFactory.getLog(CoreLaboratoryTranslatorOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCoreLaboratoryTranslatorOfIterator.getTranslatorOf());
		} catch (Exception e) {
