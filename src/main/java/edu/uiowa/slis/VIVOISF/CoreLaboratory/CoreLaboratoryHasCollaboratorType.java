...
public class CoreLaboratoryHasCollaboratorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoreLaboratoryHasCollaboratorType currentInstance = null;
	private static final Log log = LogFactory.getLog(CoreLaboratoryHasCollaboratorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCoreLaboratoryHasCollaboratorIterator.getType());
		} catch (Exception e) {
