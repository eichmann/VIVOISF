...
public class CoreLaboratoryOwnerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoreLaboratoryOwnerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(CoreLaboratoryOwnerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCoreLaboratoryOwnerInverseIterator.getType());
		} catch (Exception e) {
