...
public class CoreLaboratoryOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoreLaboratoryOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(CoreLaboratoryOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCoreLaboratoryOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
