...
public class CoreLaboratoryIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CoreLaboratoryIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CoreLaboratoryIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#CoreLaboratory> . "+
