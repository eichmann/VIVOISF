...
public class Phase_3RO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Phase_3RO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(Phase_3RO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePhase_3RO_0000057Iterator.getType());
		} catch (Exception e) {
