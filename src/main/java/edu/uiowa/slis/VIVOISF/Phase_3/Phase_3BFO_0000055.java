...
public class Phase_3BFO_0000055 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Phase_3BFO_0000055 currentInstance = null;
	private static final Log log = LogFactory.getLog(Phase_3BFO_0000055.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePhase_3BFO_0000055Iterator.getBFO_0000055());
		} catch (Exception e) {
