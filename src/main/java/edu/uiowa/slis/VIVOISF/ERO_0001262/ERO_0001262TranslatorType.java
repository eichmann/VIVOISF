...
public class ERO_0001262TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001262TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001262TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001262TranslatorIterator.getType());
		} catch (Exception e) {
