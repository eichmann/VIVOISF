...
public class BFO_0000038GeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038GeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038GeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000038GeographicFocusIterator.getType());
		} catch (Exception e) {
