...
public class BFO_0000038NameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameOfficialESIterator.class);
