...
public class BFO_0000038HasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038HasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038HasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000038HasPublicationVenueIterator.getType());
		} catch (Exception e) {
