...
public class BFO_0000038RelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038RelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038RelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000038RelatedByIterator.getType());
		} catch (Exception e) {
