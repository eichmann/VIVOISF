...
public class BFO_0000038LandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038LandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038LandAreaUnitIterator.class);
