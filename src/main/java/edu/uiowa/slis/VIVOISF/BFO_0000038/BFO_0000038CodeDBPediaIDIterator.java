...
public class BFO_0000038CodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038CodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038CodeDBPediaIDIterator.class);
