...
public class BFO_0000038HDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038HDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038HDINotesIterator.class);
