...
public class BFO_0000038LandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038LandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038LandAreaNotesIterator.class);
