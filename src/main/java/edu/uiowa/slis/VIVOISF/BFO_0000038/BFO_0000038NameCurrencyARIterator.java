...
public class BFO_0000038NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameCurrencyARIterator.class);
