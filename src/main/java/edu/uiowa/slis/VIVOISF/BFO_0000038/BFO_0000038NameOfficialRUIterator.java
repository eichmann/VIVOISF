...
public class BFO_0000038NameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameOfficialRUIterator.class);
