...
public class BFO_0000038NameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameListARIterator.class);
