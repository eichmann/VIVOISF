...
public class BFO_0000038NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NationalityARIterator.class);
