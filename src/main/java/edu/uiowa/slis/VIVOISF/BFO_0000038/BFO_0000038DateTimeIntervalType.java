...
public class BFO_0000038DateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038DateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038DateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000038DateTimeIntervalIterator.getType());
		} catch (Exception e) {
