...
public class BFO_0000038CountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038CountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038CountryAreaUnitIterator.class);
