...
public class BFO_0000038HasEmailType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038HasEmailType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038HasEmailType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000038HasEmailIterator.getType());
		} catch (Exception e) {
