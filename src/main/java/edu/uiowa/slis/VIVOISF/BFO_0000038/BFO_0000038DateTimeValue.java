...
public class BFO_0000038DateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038DateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038DateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000038DateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
