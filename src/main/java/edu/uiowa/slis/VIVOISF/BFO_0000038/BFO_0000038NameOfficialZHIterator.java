...
public class BFO_0000038NameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameOfficialZHIterator.class);
