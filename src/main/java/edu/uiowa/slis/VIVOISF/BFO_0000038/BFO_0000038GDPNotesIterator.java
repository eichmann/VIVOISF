...
public class BFO_0000038GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038GDPNotesIterator.class);
