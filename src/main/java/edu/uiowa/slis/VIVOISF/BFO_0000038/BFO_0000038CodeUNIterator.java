...
public class BFO_0000038CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038CodeUNIterator.class);
