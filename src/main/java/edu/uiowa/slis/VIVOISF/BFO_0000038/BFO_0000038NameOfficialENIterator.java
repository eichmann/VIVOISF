...
public class BFO_0000038NameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameOfficialENIterator.class);
