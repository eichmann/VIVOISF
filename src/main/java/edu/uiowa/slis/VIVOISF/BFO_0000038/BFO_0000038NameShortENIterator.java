...
public class BFO_0000038NameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameShortENIterator.class);
