...
public class BFO_0000038HasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038HasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038HasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000038HasSubjectAreaIterator.getType());
		} catch (Exception e) {
