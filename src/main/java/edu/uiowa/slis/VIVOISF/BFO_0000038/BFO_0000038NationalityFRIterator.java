...
public class BFO_0000038NationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NationalityFRIterator.class);
