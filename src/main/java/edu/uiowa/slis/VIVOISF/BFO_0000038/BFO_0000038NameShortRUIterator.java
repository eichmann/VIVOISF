...
public class BFO_0000038NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameShortRUIterator.class);
