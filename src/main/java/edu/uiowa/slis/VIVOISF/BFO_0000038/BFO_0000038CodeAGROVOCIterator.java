...
public class BFO_0000038CodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038CodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038CodeAGROVOCIterator.class);
