...
public class BFO_0000038CountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038CountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038CountryAreaYearIterator.class);
