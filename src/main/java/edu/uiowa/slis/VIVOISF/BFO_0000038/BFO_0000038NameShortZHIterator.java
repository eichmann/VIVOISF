...
public class BFO_0000038NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameShortZHIterator.class);
