...
public class BFO_0000038HasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038HasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038HasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000038HasNameIterator.getType());
		} catch (Exception e) {
