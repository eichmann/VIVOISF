...
public class BFO_0000038PublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038PublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038PublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000038PublisherIterator.getType());
		} catch (Exception e) {
