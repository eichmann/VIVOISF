...
public class BFO_0000038UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038UrlIterator.class);
