...
public class BFO_0000038DescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038DescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038DescriptionIterator.class);
