...
public class BFO_0000038PopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038PopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038PopulationTotalIterator.class);
