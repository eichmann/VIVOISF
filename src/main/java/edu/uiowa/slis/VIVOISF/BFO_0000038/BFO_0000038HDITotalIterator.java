...
public class BFO_0000038HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038HDITotalIterator.class);
