...
public class BFO_0000038NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameListRUIterator.class);
