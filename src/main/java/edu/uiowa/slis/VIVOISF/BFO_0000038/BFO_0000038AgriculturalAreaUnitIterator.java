...
public class BFO_0000038AgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038AgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038AgriculturalAreaUnitIterator.class);
