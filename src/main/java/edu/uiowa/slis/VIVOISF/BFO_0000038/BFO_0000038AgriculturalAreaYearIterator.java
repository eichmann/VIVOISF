...
public class BFO_0000038AgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038AgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038AgriculturalAreaYearIterator.class);
