...
public class BFO_0000038NameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000038NameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000038NameListESIterator.class);
