...
public class WorkshopSeriesBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WorkshopSeriesBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(WorkshopSeriesBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWorkshopSeriesBFO_0000055Iterator.getType());
		} catch (Exception e) {
