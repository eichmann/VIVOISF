...
public class DocumentGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentGDPYearIterator.class);
