...
public class DocumentCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodeAGROVOCIterator.class);
