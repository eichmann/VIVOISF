...
public class DocumentNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameCurrencyZHIterator.class);
