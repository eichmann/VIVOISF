...
public class DocumentPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPagesIterator.class);
