...
public class DocumentNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameOfficialENIterator.class);
