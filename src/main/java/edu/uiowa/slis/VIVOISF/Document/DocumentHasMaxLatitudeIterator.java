...
public class DocumentHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHasMaxLatitudeIterator.class);
