...
public class DocumentAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentAgriculturalAreaUnitIterator.class);
