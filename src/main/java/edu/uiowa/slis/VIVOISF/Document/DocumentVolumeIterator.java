...
public class DocumentVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentVolumeIterator.class);
