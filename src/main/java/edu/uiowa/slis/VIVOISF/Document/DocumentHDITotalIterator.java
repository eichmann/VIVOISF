...
public class DocumentHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHDITotalIterator.class);
