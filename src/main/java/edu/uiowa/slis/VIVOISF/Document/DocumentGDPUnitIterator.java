...
public class DocumentGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentGDPUnitIterator.class);
