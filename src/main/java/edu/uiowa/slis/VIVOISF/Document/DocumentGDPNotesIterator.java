...
public class DocumentGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentGDPNotesIterator.class);
