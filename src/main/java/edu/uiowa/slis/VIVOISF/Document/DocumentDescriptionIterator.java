...
public class DocumentDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentDescriptionIterator.class);
