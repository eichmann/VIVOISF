...
public class DocumentNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameShortENIterator.class);
