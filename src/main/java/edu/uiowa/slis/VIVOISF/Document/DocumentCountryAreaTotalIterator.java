...
public class DocumentCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCountryAreaTotalIterator.class);
