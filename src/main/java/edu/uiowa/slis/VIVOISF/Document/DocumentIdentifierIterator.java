...
public class DocumentIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentIdentifierIterator.class);
