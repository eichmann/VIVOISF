...
public class DocumentCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodenIterator.class);
