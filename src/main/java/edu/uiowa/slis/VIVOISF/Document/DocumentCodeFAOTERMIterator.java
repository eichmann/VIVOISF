...
public class DocumentCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodeFAOTERMIterator.class);
