...
public class DocumentCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCountryAreaUnitIterator.class);
