...
public class DocumentNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNationalityARIterator.class);
