...
public class DocumentContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentContentIterator.class);
