...
public class DocumentHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHasMinLongitudeIterator.class);
