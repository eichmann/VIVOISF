...
public class DocumentSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentSectionIterator.class);
