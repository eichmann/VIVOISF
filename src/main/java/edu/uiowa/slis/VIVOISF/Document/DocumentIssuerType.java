...
public class DocumentIssuerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentIssuerType currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentIssuerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentIssuerIterator.getType());
		} catch (Exception e) {
