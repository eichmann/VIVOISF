...
public class DocumentNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNationalityRUIterator.class);
