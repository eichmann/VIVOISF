...
public class DocumentAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentAsinIterator.class);
