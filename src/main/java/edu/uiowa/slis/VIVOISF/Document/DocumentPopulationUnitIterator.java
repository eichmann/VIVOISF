...
public class DocumentPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPopulationUnitIterator.class);
