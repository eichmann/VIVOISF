...
public class DocumentRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentRankIterator.class);
