...
public class DocumentHasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentHasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
