...
public class DocumentCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodeGAULIterator.class);
