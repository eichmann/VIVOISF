...
public class DocumentUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentUrlIterator.class);
