...
public class DocumentRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentRO_0001015Iterator.getType());
		} catch (Exception e) {
