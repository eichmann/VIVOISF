...
public class DocumentPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPopulationYearIterator.class);
