...
public class DocumentCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodeCurrencyIterator.class);
