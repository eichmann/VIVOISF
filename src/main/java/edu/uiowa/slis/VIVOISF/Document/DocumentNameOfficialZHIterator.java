...
public class DocumentNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameOfficialZHIterator.class);
