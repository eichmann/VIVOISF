...
public class DocumentEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentEanucc13Iterator.class);
