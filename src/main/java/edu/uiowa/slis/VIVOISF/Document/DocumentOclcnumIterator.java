...
public class DocumentOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentOclcnumIterator.class);
