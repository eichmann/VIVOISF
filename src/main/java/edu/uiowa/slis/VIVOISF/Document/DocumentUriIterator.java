...
public class DocumentUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentUriIterator.class);
