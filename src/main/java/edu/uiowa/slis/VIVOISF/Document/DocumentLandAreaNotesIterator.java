...
public class DocumentLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentLandAreaNotesIterator.class);
