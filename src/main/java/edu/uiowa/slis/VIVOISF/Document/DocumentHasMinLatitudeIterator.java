...
public class DocumentHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHasMinLatitudeIterator.class);
