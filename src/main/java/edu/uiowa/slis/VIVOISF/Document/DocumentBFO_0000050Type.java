...
public class DocumentBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentBFO_0000050Iterator.getType());
		} catch (Exception e) {
