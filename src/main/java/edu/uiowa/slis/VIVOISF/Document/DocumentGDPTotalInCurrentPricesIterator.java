...
public class DocumentGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentGDPTotalInCurrentPricesIterator.class);
