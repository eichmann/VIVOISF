...
public class DocumentHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHasMaxLongitudeIterator.class);
