...
public class DocumentPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPopulationNotesIterator.class);
