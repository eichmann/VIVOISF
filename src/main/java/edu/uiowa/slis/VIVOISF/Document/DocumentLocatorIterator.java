...
public class DocumentLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentLocatorIterator.class);
