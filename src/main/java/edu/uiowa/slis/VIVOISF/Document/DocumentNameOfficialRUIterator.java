...
public class DocumentNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameOfficialRUIterator.class);
