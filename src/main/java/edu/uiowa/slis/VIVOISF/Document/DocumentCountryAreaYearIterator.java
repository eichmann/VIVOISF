...
public class DocumentCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCountryAreaYearIterator.class);
