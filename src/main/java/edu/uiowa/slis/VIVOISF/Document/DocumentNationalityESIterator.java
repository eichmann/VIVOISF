...
public class DocumentNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNationalityESIterator.class);
