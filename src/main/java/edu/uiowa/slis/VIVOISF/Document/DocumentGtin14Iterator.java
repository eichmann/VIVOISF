...
public class DocumentGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentGtin14Iterator.class);
