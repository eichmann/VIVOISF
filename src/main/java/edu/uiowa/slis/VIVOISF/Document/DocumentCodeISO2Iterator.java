...
public class DocumentCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodeISO2Iterator.class);
