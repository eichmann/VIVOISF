...
public class DocumentNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameShortARIterator.class);
