...
public class DocumentCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCountryAreaNotesIterator.class);
