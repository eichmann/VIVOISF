...
public class DocumentCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodeISO3Iterator.class);
