...
public class DocumentAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentAgriculturalAreaYearIterator.class);
