...
public class DocumentUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentUpcIterator.class);
