...
public class DocumentNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameListRUIterator.class);
