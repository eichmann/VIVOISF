...
public class DocumentTranscriptOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentTranscriptOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentTranscriptOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentTranscriptOfIterator.getType());
		} catch (Exception e) {
