...
public class DocumentHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHDINotesIterator.class);
