...
public class DocumentNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameShortITIterator.class);
