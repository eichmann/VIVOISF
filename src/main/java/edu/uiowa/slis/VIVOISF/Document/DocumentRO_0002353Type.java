...
public class DocumentRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentRO_0002353Iterator.getType());
		} catch (Exception e) {
