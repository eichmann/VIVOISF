...
public class DocumentNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameListITIterator.class);
