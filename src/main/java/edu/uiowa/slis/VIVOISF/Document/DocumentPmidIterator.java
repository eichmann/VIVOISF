...
public class DocumentPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPmidIterator.class);
