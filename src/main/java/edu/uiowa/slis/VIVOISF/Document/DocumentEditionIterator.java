...
public class DocumentEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentEditionIterator.class);
