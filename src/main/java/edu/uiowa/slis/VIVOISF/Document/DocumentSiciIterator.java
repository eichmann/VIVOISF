...
public class DocumentSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentSiciIterator.class);
