...
public class DocumentRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in DocumentRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DocumentRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DocumentRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DocumentRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DocumentRelates doEndTag", e);
			throw new JspTagException("Exception raised in DocumentRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DocumentRelatesIterator");
