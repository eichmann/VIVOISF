...
public class DocumentLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentLandAreaUnitIterator.class);
