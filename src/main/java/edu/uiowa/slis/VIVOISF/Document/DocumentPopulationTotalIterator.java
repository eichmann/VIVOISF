...
public class DocumentPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentPopulationTotalIterator.class);
