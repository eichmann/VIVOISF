...
public class DocumentFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentFreetextKeywordIterator.class);
