...
public class DocumentLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentLccnIterator.class);
