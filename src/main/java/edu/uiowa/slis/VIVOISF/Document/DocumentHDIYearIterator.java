...
public class DocumentHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHDIYearIterator.class);
