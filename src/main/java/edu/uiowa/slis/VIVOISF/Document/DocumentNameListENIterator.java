...
public class DocumentNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameListENIterator.class);
