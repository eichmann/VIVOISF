...
public class DocumentNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNationalityITIterator.class);
