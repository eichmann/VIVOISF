...
public class DocumentHasEmail extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHasEmail currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHasEmail.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentHasEmailIterator.getHasEmail());
		} catch (Exception e) {
