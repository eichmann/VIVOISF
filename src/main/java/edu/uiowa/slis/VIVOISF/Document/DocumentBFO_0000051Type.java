...
public class DocumentBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentBFO_0000051Iterator.getType());
		} catch (Exception e) {
