...
public class DocumentHasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentHasResearchAreaIterator.getType());
		} catch (Exception e) {
