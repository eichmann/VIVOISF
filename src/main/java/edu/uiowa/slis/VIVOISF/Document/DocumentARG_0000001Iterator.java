...
public class DocumentARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentARG_0000001Iterator.class);
