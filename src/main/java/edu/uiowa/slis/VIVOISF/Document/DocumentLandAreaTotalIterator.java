...
public class DocumentLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentLandAreaTotalIterator.class);
