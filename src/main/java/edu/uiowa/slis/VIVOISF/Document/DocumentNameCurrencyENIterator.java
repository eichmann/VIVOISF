...
public class DocumentNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameCurrencyENIterator.class);
