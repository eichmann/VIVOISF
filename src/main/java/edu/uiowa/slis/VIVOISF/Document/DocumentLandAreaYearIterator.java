...
public class DocumentLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentLandAreaYearIterator.class);
