...
public class DocumentNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameOfficialFRIterator.class);
