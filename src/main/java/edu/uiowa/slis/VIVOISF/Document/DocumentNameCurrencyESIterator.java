...
public class DocumentNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameCurrencyESIterator.class);
