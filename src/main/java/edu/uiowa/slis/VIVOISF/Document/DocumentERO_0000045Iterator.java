...
public class DocumentERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentERO_0000045Iterator.class);
