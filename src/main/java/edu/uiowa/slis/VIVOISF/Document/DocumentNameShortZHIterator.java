...
public class DocumentNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameShortZHIterator.class);
