...
public class DocumentNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameShortFRIterator.class);
