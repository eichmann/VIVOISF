...
public class DocumentCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodeUNDPIterator.class);
