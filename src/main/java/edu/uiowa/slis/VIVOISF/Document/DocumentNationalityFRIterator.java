...
public class DocumentNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNationalityFRIterator.class);
