...
public class DocumentNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameOfficialESIterator.class);
