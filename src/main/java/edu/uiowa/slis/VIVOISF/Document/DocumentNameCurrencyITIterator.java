...
public class DocumentNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameCurrencyITIterator.class);
