...
public class DocumentCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodeDBPediaIDIterator.class);
