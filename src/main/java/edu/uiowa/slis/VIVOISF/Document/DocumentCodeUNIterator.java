...
public class DocumentCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodeUNIterator.class);
