...
public class DocumentHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHandleIterator.class);
