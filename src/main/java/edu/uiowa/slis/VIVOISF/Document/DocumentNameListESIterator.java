...
public class DocumentNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameListESIterator.class);
