...
public class DocumentHasTranslation extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentHasTranslation currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentHasTranslation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDocumentHasTranslationIterator.getHasTranslation());
		} catch (Exception e) {
