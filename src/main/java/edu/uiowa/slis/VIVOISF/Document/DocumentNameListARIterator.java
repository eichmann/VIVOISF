...
public class DocumentNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameListARIterator.class);
