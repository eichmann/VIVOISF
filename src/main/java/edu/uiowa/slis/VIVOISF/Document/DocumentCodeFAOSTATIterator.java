...
public class DocumentCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentCodeFAOSTATIterator.class);
