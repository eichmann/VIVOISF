...
public class DocumentTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentTheAbstractIterator.class);
