...
public class DocumentShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentShortDescriptionIterator.class);
