...
public class DocumentAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentAgriculturalAreaNotesIterator.class);
