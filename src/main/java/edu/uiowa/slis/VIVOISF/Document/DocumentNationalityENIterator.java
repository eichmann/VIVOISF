...
public class DocumentNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNationalityENIterator.class);
