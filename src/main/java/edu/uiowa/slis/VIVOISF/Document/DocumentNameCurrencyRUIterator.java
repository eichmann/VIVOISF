...
public class DocumentNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNameCurrencyRUIterator.class);
