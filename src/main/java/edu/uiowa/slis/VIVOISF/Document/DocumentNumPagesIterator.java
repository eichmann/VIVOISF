...
public class DocumentNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentNumPagesIterator.class);
