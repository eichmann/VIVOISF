...
public class DocumentShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DocumentShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DocumentShortTitleIterator.class);
