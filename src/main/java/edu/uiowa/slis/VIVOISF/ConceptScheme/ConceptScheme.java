...
public class ConceptScheme extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (this.getParent() instanceof edu.uiowa.slis.VIVOISF.Concept.ConceptTopConceptOfIterator) {
				subjectURI = ((edu.uiowa.slis.VIVOISF.Concept.ConceptTopConceptOfIterator)this.getParent()).getTopConceptOf();
			}

			edu.uiowa.slis.VIVOISF.Concept.ConceptTopConceptOfIterator theConceptTopConceptOfIterator = (edu.uiowa.slis.VIVOISF.Concept.ConceptTopConceptOfIterator) findAncestorWithClass(this, edu.uiowa.slis.VIVOISF.Concept.ConceptTopConceptOfIterator.class);
