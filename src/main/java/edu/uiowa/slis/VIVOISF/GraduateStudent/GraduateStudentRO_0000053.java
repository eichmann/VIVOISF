...
public class GraduateStudentRO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GraduateStudentRO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(GraduateStudentRO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGraduateStudentRO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
