...
public class GraduateStudentRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GraduateStudentRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GraduateStudentRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGraduateStudentRO_0001025Iterator.getType());
		} catch (Exception e) {
