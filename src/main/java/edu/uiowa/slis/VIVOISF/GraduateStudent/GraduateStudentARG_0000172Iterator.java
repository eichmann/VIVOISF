...
public class GraduateStudentARG_0000172Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GraduateStudentARG_0000172Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GraduateStudentARG_0000172Iterator.class);
