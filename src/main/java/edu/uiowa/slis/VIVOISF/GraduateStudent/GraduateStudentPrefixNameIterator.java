...
public class GraduateStudentPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GraduateStudentPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GraduateStudentPrefixNameIterator.class);
