...
public class GraduateStudentIntervieweeInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GraduateStudentIntervieweeInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(GraduateStudentIntervieweeInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGraduateStudentIntervieweeInverseIterator.getIntervieweeInverse());
		} catch (Exception e) {
