...
public class GraduateStudentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GraduateStudentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GraduateStudentIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#GraduateStudent> . "+
