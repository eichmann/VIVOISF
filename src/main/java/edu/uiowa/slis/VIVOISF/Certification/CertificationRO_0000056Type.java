...
public class CertificationRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CertificationRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CertificationRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCertificationRO_0000056Iterator.getType());
		} catch (Exception e) {
