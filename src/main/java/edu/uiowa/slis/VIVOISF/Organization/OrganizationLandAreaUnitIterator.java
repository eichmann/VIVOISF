...
public class OrganizationLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationLandAreaUnitIterator.class);
