...
public class OrganizationCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationCodeUNIterator.class);
