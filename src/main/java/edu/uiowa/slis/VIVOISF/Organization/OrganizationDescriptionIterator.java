...
public class OrganizationDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationDescriptionIterator.class);
