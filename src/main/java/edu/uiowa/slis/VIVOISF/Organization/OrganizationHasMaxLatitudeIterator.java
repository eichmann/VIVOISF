...
public class OrganizationHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationHasMaxLatitudeIterator.class);
