...
public class OrganizationNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNameShortZHIterator.class);
