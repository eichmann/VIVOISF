...
public class OrganizationPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationPopulationTotalIterator.class);
