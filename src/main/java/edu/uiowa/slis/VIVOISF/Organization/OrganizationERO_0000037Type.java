...
public class OrganizationERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationERO_0000037Iterator.getType());
		} catch (Exception e) {
