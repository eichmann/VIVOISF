...
public class OrganizationRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationRO_0000056Iterator.getType());
		} catch (Exception e) {
