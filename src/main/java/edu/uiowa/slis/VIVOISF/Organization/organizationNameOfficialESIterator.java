...
public class organizationNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameOfficialESIterator.class);
