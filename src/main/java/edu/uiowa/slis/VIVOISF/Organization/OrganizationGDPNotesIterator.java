...
public class OrganizationGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationGDPNotesIterator.class);
