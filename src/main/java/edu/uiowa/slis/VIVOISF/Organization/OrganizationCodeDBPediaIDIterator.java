...
public class OrganizationCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationCodeDBPediaIDIterator.class);
