...
public class organizationCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationCodeFAOTERMIterator.class);
