...
public class OrganizationARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationARG_2000028Iterator.getType());
		} catch (Exception e) {
