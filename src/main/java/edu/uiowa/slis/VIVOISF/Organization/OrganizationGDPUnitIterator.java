...
public class OrganizationGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationGDPUnitIterator.class);
