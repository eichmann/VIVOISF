...
public class organizationHasCodeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationHasCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationHasCodeIterator.class);
