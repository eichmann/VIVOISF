...
public class OrganizationHasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationHasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationHasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationHasResearchAreaIterator.getType());
		} catch (Exception e) {
