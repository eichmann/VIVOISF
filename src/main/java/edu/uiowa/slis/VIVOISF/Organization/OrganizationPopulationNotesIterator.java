...
public class OrganizationPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationPopulationNotesIterator.class);
