...
public class OrganizationCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationCodeUNDPIterator.class);
