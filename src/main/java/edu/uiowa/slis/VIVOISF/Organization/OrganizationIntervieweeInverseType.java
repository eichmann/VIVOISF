...
public class OrganizationIntervieweeInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationIntervieweeInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationIntervieweeInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationIntervieweeInverseIterator.getType());
		} catch (Exception e) {
