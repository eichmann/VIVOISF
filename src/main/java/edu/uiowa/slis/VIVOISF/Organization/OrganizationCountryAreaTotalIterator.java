...
public class OrganizationCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationCountryAreaTotalIterator.class);
