...
public class OrganizationHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationHDITotalIterator.class);
