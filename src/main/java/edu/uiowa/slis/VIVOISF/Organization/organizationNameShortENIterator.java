...
public class organizationNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameShortENIterator.class);
