...
public class organizationNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameShortITIterator.class);
