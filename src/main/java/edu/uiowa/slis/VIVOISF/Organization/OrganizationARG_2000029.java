...
public class OrganizationARG_2000029 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationARG_2000029 currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationARG_2000029.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationARG_2000029Iterator.getARG_2000029());
		} catch (Exception e) {
