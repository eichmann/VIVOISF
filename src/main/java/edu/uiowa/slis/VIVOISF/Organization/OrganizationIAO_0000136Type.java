...
public class OrganizationIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationIAO_0000136Iterator.getType());
		} catch (Exception e) {
