...
public class OrganizationHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationHasMinLatitudeIterator.class);
