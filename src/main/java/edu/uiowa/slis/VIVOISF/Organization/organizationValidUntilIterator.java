...
public class organizationValidUntilIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationValidUntilIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationValidUntilIterator.class);
