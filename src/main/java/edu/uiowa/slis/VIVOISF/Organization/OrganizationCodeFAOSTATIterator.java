...
public class OrganizationCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationCodeFAOSTATIterator.class);
