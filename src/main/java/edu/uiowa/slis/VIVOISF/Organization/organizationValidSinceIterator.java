...
public class organizationValidSinceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationValidSinceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationValidSinceIterator.class);
