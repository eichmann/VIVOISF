...
public class OrganizationCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationCountryAreaNotesIterator.class);
