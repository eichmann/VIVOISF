...
public class OrganizationSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationSuffixNameIterator.class);
