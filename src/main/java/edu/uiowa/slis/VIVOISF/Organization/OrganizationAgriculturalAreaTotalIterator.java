...
public class OrganizationAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationAgriculturalAreaTotalIterator.class);
