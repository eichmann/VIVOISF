...
public class OrganizationFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationFreetextKeywordIterator.class);
