...
public class OrganizationOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
