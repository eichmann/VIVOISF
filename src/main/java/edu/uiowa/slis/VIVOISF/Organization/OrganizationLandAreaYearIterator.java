...
public class OrganizationLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationLandAreaYearIterator.class);
