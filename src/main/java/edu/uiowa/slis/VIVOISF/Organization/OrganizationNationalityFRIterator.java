...
public class OrganizationNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNationalityFRIterator.class);
