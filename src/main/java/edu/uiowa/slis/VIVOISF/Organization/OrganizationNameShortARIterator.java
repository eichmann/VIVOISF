...
public class OrganizationNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNameShortARIterator.class);
