...
public class organizationNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameShortFRIterator.class);
