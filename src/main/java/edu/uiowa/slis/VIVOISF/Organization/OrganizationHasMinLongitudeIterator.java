...
public class OrganizationHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationHasMinLongitudeIterator.class);
