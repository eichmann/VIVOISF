...
public class organizationNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameListENIterator.class);
