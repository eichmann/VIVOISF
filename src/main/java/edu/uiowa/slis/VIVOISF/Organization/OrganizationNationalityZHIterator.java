...
public class OrganizationNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNationalityZHIterator.class);
