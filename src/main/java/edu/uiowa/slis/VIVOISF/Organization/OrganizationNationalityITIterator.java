...
public class OrganizationNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNationalityITIterator.class);
