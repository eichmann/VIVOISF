...
public class OrganizationRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationRO_0001015Iterator.getType());
		} catch (Exception e) {
