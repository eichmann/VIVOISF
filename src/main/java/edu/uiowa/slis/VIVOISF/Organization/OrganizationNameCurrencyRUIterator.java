...
public class OrganizationNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNameCurrencyRUIterator.class);
