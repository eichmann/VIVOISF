...
public class organizationNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameShortRUIterator.class);
