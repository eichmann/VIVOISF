...
public class OrganizationGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationGDPTotalInCurrentPricesIterator.class);
