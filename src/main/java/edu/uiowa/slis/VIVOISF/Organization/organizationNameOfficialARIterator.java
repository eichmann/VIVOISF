...
public class organizationNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameOfficialARIterator.class);
