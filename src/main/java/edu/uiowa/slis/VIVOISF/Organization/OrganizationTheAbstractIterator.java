...
public class OrganizationTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationTheAbstractIterator.class);
