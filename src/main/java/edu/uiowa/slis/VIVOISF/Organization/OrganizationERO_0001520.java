...
public class OrganizationERO_0001520 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationERO_0001520 currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationERO_0001520.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationERO_0001520Iterator.getERO_0001520());
		} catch (Exception e) {
