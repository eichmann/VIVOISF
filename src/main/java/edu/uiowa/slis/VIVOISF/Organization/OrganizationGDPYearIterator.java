...
public class OrganizationGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationGDPYearIterator.class);
