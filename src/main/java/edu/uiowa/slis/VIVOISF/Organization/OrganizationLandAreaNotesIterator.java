...
public class OrganizationLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationLandAreaNotesIterator.class);
