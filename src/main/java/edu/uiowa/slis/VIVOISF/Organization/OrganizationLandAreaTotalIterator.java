...
public class OrganizationLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationLandAreaTotalIterator.class);
