...
public class organizationNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameListZHIterator.class);
