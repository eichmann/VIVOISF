...
public class organizationHasOfficialNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationHasOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationHasOfficialNameIterator.class);
