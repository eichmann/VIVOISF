...
public class OrganizationRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationRankIterator.class);
