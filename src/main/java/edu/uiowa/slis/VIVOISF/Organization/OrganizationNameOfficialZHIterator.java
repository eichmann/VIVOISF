...
public class OrganizationNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNameOfficialZHIterator.class);
