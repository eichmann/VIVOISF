...
public class organizationTopDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationTopDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationTopDataPropertyIterator.class);
