...
public class OrganizationERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationERO_0000031Iterator.getType());
		} catch (Exception e) {
