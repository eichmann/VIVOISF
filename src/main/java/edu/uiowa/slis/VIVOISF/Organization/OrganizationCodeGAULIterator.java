...
public class OrganizationCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationCodeGAULIterator.class);
