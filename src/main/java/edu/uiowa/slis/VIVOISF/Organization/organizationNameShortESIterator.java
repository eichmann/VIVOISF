...
public class organizationNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameShortESIterator.class);
