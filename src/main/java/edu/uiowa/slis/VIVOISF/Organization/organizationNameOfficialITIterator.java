...
public class organizationNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameOfficialITIterator.class);
