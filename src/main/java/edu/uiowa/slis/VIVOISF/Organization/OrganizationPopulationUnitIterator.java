...
public class OrganizationPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationPopulationUnitIterator.class);
