...
public class OrganizationHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationHDINotesIterator.class);
