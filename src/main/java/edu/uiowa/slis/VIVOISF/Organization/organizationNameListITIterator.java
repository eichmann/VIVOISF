...
public class organizationNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameListITIterator.class);
