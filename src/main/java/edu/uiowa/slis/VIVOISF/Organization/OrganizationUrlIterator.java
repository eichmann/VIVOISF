...
public class OrganizationUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationUrlIterator.class);
