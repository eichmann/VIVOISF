...
public class OrganizationNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNationalityESIterator.class);
