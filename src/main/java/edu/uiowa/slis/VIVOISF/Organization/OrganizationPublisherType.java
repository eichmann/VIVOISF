...
public class OrganizationPublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationPublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationPublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationPublisherIterator.getType());
		} catch (Exception e) {
