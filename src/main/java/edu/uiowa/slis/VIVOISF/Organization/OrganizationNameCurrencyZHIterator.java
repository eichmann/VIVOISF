...
public class OrganizationNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNameCurrencyZHIterator.class);
