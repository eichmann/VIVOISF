...
public class OrganizationNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNameCurrencyARIterator.class);
