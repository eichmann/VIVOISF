...
public class organizationHasShortNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationHasShortNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationHasShortNameIterator.class);
