...
public class OrganizationHasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationHasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationHasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationHasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
