...
public class OrganizationPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationPrefixNameIterator.class);
