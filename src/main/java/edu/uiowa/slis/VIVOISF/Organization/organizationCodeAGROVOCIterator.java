...
public class organizationCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationCodeAGROVOCIterator.class);
