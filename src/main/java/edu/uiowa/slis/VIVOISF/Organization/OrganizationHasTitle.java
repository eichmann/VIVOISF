...
public class OrganizationHasTitle extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationHasTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationHasTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationHasTitleIterator.getHasTitle());
		} catch (Exception e) {
