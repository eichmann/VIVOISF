...
public class OrganizationCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationCodeISO3Iterator.class);
