...
public class OrganizationPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationPopulationYearIterator.class);
