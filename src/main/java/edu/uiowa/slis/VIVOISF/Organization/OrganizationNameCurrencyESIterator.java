...
public class OrganizationNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNameCurrencyESIterator.class);
