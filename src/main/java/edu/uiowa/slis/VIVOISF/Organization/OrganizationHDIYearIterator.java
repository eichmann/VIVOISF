...
public class OrganizationHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationHDIYearIterator.class);
