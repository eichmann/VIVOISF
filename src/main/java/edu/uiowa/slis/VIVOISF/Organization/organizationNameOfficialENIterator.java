...
public class organizationNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameOfficialENIterator.class);
