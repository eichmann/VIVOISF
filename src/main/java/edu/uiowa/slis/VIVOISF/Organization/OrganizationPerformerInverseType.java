...
public class OrganizationPerformerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationPerformerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationPerformerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOrganizationPerformerInverseIterator.getType());
		} catch (Exception e) {
