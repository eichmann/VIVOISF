...
public class OrganizationNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNameCurrencyENIterator.class);
