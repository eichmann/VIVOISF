...
public class organizationNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static organizationNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(organizationNameListARIterator.class);
