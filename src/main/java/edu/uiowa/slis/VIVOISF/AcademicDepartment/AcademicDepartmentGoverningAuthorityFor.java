...
public class AcademicDepartmentGoverningAuthorityFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicDepartmentGoverningAuthorityFor currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicDepartmentGoverningAuthorityFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicDepartmentGoverningAuthorityForIterator.getGoverningAuthorityFor());
		} catch (Exception e) {
