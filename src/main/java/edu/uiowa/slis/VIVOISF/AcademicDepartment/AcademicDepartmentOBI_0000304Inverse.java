...
public class AcademicDepartmentOBI_0000304Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicDepartmentOBI_0000304Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicDepartmentOBI_0000304Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicDepartmentOBI_0000304InverseIterator.getOBI_0000304Inverse());
		} catch (Exception e) {
