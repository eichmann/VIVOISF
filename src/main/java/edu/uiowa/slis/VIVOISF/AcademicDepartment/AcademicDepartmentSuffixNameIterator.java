...
public class AcademicDepartmentSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicDepartmentSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicDepartmentSuffixNameIterator.class);
