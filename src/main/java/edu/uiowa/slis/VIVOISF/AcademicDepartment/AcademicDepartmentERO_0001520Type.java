...
public class AcademicDepartmentERO_0001520Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicDepartmentERO_0001520Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicDepartmentERO_0001520Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicDepartmentERO_0001520Iterator.getType());
		} catch (Exception e) {
