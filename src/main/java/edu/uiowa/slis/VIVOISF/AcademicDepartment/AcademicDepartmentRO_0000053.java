...
public class AcademicDepartmentRO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AcademicDepartmentRO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(AcademicDepartmentRO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAcademicDepartmentRO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
