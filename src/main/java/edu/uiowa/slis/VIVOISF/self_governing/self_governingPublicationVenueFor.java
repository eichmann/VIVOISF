...
public class self_governingPublicationVenueFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingPublicationVenueFor currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingPublicationVenueFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingPublicationVenueForIterator.getPublicationVenueFor());
		} catch (Exception e) {
