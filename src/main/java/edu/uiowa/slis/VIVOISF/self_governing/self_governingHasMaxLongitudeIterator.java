...
public class self_governingHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasMaxLongitudeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#hasMaxLongitude> ?s } ");
			if(rs.hasNext()) {
