...
public class self_governingHasCodeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasCodeIterator.class);
