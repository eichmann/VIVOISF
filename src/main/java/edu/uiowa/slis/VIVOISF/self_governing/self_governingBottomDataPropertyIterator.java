...
public class self_governingBottomDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingBottomDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingBottomDataPropertyIterator.class);
