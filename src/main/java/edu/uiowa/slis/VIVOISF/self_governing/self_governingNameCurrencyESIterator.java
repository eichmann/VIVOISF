...
public class self_governingNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameCurrencyESIterator.class);
