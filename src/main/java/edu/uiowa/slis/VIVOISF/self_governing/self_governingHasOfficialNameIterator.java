...
public class self_governingHasOfficialNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasOfficialNameIterator.class);
