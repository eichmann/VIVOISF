...
public class self_governingSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingSameAsIterator.class);
