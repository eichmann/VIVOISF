...
public class self_governingHasCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasCurrencyIterator.class);
