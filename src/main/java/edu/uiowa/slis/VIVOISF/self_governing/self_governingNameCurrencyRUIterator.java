...
public class self_governingNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameCurrencyRUIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#nameCurrencyRU> ?s } ");
			if(rs.hasNext()) {
