...
public class self_governingNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNationalityARIterator.class);
