...
public class self_governingNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameShortENIterator.class);
