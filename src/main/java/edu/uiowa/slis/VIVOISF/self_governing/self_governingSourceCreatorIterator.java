...
public class self_governingSourceCreatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingSourceCreatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingSourceCreatorIterator.class);
