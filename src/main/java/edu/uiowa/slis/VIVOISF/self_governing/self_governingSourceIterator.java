...
public class self_governingSourceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingSourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingSourceIterator.class);
