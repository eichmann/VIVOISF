...
public class self_governingMiddleNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingMiddleNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingMiddleNameIterator.class);
