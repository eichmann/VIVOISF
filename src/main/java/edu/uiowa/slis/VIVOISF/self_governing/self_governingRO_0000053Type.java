...
public class self_governingRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingRO_0000053Iterator.getType());
		} catch (Exception e) {
