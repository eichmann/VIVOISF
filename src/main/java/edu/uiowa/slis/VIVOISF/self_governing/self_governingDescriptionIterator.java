...
public class self_governingDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingDescriptionIterator.class);
