...
public class self_governingNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameOfficialESIterator.class);
