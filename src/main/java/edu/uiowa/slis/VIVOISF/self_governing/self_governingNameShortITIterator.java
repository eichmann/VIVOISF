...
public class self_governingNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameShortITIterator.class);
