...
public class self_governingResearchAreaOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingResearchAreaOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingResearchAreaOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingResearchAreaOfIterator.getType());
		} catch (Exception e) {
