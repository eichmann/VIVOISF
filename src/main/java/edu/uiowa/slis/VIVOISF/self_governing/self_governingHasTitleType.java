...
public class self_governingHasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingHasTitleIterator.getType());
		} catch (Exception e) {
