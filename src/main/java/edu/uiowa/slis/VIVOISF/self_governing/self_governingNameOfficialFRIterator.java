...
public class self_governingNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameOfficialFRIterator.class);
