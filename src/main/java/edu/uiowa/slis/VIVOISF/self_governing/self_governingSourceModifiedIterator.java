...
public class self_governingSourceModifiedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingSourceModifiedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingSourceModifiedIterator.class);
