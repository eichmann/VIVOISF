...
public class self_governingPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingPopulationYearIterator.class);
