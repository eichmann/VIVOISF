...
public class self_governingLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingLandAreaUnitIterator.class);
