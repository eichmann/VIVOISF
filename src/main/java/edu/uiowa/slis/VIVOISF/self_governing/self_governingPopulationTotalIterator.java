...
public class self_governingPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingPopulationTotalIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#populationTotal> ?s } ");
			if(rs.hasNext()) {
