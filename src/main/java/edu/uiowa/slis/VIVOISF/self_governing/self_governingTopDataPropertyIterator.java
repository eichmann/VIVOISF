...
public class self_governingTopDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingTopDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingTopDataPropertyIterator.class);
