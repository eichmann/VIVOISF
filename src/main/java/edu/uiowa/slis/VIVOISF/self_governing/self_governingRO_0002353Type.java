...
public class self_governingRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingRO_0002353Iterator.getType());
		} catch (Exception e) {
