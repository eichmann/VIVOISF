...
public class self_governingNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameCurrencyENIterator.class);
