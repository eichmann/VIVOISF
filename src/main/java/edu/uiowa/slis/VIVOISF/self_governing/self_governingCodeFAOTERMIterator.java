...
public class self_governingCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingCodeFAOTERMIterator.class);
