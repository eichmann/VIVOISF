...
public class self_governingDateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingDateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingDateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingDateTimeIntervalIterator.getType());
		} catch (Exception e) {
