...
public class self_governingHasStatisticsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasStatisticsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasStatisticsIterator.class);
