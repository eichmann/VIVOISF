...
public class self_governingRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingRO_0001025Iterator.getType());
		} catch (Exception e) {
