...
public class self_governingHasShortNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasShortNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasShortNameIterator.class);
