...
public class self_governingValidSinceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingValidSinceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingValidSinceIterator.class);
