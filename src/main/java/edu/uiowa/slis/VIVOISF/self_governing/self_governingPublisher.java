...
public class self_governingPublisher extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingPublisher currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingPublisher.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingPublisherIterator.getPublisher());
		} catch (Exception e) {
