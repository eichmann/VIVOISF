...
public class self_governingHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHDINotesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://aims.fao.org/aos/geopolitical.owl#HDINotes> ?s } ");
			if(rs.hasNext()) {
