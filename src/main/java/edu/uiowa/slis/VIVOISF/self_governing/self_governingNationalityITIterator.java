...
public class self_governingNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNationalityITIterator.class);
