...
public class self_governingCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingCodeFAOSTATIterator.class);
