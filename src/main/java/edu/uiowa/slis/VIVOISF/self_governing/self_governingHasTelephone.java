...
public class self_governingHasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingHasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
