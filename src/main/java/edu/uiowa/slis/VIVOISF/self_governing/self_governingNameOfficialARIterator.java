...
public class self_governingNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameOfficialARIterator.class);
