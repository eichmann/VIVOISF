...
public class self_governingUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingUrlIterator.class);
