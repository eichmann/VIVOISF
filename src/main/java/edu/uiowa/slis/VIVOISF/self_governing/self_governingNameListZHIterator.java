...
public class self_governingNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameListZHIterator.class);
