...
public class self_governingTelephoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingTelephoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingTelephoneIterator.class);
