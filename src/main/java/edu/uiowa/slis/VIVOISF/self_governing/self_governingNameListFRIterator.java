...
public class self_governingNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameListFRIterator.class);
