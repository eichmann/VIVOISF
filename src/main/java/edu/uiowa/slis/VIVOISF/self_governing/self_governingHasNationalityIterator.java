...
public class self_governingHasNationalityIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasNationalityIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasNationalityIterator.class);
