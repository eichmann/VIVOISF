...
public class self_governingSourceIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingSourceIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingSourceIdentifierIterator.class);
