...
public class self_governingHasListNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasListNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasListNameIterator.class);
