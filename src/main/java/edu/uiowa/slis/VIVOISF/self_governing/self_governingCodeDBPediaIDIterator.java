...
public class self_governingCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingCodeDBPediaIDIterator.class);
