...
public class self_governingBottomObjectPropertyInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingBottomObjectPropertyInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingBottomObjectPropertyInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingBottomObjectPropertyInverseIterator.getType());
		} catch (Exception e) {
