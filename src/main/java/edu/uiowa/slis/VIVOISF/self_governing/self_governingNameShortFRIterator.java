...
public class self_governingNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameShortFRIterator.class);
