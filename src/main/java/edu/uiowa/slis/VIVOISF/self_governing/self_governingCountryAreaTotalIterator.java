...
public class self_governingCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingCountryAreaTotalIterator.class);
