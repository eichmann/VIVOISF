...
public class self_governingNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameListARIterator.class);
