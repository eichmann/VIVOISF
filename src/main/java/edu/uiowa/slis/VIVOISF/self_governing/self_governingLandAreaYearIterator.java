...
public class self_governingLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingLandAreaYearIterator.class);
