...
public class self_governingNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameCurrencyITIterator.class);
