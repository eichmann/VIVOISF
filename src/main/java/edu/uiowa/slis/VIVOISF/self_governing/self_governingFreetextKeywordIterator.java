...
public class self_governingFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingFreetextKeywordIterator.class);
