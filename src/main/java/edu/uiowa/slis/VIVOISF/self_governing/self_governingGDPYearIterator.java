...
public class self_governingGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingGDPYearIterator.class);
