...
public class self_governingDateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingDateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingDateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theself_governingDateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
