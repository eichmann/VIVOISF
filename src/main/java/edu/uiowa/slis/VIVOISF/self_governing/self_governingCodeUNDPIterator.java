...
public class self_governingCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingCodeUNDPIterator.class);
