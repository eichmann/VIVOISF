...
public class self_governingNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameOfficialENIterator.class);
