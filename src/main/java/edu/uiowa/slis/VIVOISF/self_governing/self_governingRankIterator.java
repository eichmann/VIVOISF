...
public class self_governingRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingRankIterator.class);
