...
public class self_governingHasCoordinateIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingHasCoordinateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingHasCoordinateIterator.class);
