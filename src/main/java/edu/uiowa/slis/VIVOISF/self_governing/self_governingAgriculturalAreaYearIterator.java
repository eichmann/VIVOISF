...
public class self_governingAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingAgriculturalAreaYearIterator.class);
