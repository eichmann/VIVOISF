...
public class self_governingNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static self_governingNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(self_governingNameListITIterator.class);
