...
public class LetterAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterAsinIterator.class);
