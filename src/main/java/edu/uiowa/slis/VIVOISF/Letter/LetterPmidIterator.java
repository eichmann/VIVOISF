...
public class LetterPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterPmidIterator.class);
