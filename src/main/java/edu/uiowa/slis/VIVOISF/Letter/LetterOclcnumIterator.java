...
public class LetterOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterOclcnumIterator.class);
