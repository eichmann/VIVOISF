...
public class LetterShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterShortTitleIterator.class);
