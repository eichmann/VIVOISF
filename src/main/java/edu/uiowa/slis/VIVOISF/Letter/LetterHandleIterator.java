...
public class LetterHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterHandleIterator.class);
