...
public class LetterPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterPageStartIterator.class);
