...
public class LetterTranslationOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterTranslationOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterTranslationOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLetterTranslationOfIterator.getType());
		} catch (Exception e) {
