...
public class LetterSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterSiciIterator.class);
