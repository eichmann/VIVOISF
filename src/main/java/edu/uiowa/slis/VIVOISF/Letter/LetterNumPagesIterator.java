...
public class LetterNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterNumPagesIterator.class);
