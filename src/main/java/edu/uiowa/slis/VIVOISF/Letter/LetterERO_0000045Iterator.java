...
public class LetterERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterERO_0000045Iterator.class);
