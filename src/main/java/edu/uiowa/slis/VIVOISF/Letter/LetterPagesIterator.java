...
public class LetterPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterPagesIterator.class);
