...
public class LetterUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterUriIterator.class);
