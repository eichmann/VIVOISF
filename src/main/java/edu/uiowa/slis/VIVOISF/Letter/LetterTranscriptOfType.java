...
public class LetterTranscriptOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterTranscriptOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterTranscriptOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLetterTranscriptOfIterator.getType());
		} catch (Exception e) {
