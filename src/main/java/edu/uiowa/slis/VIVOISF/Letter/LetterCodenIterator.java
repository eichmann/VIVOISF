...
public class LetterCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterCodenIterator.class);
