...
public class LetterContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterContentIterator.class);
