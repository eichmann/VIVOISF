...
public class LetterIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterIsbn13Iterator.class);
