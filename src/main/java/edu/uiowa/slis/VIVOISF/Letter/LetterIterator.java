...
public class LetterIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/Letter> . "+
