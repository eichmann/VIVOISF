...
public class LetterUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterUpcIterator.class);
