...
public class LetterShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterShortDescriptionIterator.class);
