...
public class LetterEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterEditionIterator.class);
