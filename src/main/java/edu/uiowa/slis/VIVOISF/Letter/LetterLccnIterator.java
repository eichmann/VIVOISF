...
public class LetterLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterLccnIterator.class);
