...
public class LetterGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterGtin14Iterator.class);
