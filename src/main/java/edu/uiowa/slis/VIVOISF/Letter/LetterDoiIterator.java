...
public class LetterDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterDoiIterator.class);
