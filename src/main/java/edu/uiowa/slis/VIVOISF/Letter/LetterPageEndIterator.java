...
public class LetterPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterPageEndIterator.class);
