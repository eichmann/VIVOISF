...
public class LetterTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterTheAbstractIterator.class);
