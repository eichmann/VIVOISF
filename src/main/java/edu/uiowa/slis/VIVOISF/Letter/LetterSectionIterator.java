...
public class LetterSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterSectionIterator.class);
