...
public class LetterVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterVolumeIterator.class);
