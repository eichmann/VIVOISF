...
public class LetterIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterIdentifierIterator.class);
