...
public class LetterIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LetterIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LetterIsbn10Iterator.class);
