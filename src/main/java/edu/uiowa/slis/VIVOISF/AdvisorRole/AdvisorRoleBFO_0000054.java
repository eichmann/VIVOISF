...
public class AdvisorRoleBFO_0000054 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AdvisorRoleBFO_0000054 currentInstance = null;
	private static final Log log = LogFactory.getLog(AdvisorRoleBFO_0000054.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAdvisorRoleBFO_0000054Iterator.getBFO_0000054());
		} catch (Exception e) {
