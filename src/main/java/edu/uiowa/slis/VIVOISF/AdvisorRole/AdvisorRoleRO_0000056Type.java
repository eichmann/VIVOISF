...
public class AdvisorRoleRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AdvisorRoleRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AdvisorRoleRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAdvisorRoleRO_0000056Iterator.getType());
		} catch (Exception e) {
