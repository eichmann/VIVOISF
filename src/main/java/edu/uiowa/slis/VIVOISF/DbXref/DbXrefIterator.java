...
public class DbXrefIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DbXrefIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DbXrefIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://www.geneontology.org/formats/oboInOwl#DbXref> . "+
