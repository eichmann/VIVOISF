...
public class DbXrefFeatures extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DbXrefFeatures currentInstance = null;
	private static final Log log = LogFactory.getLog(DbXrefFeatures.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDbXrefFeaturesIterator.getFeatures());
		} catch (Exception e) {
