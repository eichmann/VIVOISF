...
public class DbXrefIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DbXrefIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DbXrefIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDbXrefIAO_0000136Iterator.getType());
		} catch (Exception e) {
