...
public class DbXrefTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DbXrefTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DbXrefTheAbstractIterator.class);
