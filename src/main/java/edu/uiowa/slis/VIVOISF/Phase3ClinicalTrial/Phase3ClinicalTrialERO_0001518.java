...
public class Phase3ClinicalTrialERO_0001518 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Phase3ClinicalTrialERO_0001518 currentInstance = null;
	private static final Log log = LogFactory.getLog(Phase3ClinicalTrialERO_0001518.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePhase3ClinicalTrialERO_0001518Iterator.getERO_0001518());
		} catch (Exception e) {
