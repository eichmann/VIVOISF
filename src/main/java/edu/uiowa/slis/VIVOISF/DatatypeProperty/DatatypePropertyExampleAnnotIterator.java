...
public class DatatypePropertyExampleAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatatypePropertyExampleAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypePropertyExampleAnnotIterator.class);
