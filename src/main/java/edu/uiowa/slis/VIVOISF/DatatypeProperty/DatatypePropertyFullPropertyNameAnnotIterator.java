...
public class DatatypePropertyFullPropertyNameAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatatypePropertyFullPropertyNameAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypePropertyFullPropertyNameAnnotIterator.class);
