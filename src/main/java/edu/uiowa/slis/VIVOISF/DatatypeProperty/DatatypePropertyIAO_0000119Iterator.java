...
public class DatatypePropertyIAO_0000119Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatatypePropertyIAO_0000119Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypePropertyIAO_0000119Iterator.class);

	static boolean firstInstance = false;
	static boolean lastInstance = false;

	String subjectURI = null;
	String IAO_0000119 = null;
	ResultSet rs = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://purl.obolibrary.org/obo/IAO_0000119> ?s } ");
			if(rs.hasNext()) {
				QuerySolution sol = rs.nextSolution();
				IAO_0000119 = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setIAO_0000119(String theIAO_0000119) {
		IAO_0000119 = theIAO_0000119;
	}

	public String getIAO_0000119() {
		return IAO_0000119;
	}
