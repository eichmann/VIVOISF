...
public class DatatypePropertyIsDefinedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatatypePropertyIsDefinedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypePropertyIsDefinedByIterator.class);
