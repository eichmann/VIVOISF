...
public class DatatypePropertySourceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatatypePropertySourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypePropertySourceIterator.class);
