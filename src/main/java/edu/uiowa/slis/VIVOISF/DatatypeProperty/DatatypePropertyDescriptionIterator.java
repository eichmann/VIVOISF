...
public class DatatypePropertyDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatatypePropertyDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypePropertyDescriptionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://purl.org/dc/terms/description> ?s } ");
			if(rs.hasNext()) {
