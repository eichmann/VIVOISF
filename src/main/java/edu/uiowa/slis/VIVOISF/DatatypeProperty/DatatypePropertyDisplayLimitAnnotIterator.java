...
public class DatatypePropertyDisplayLimitAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatatypePropertyDisplayLimitAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypePropertyDisplayLimitAnnotIterator.class);
