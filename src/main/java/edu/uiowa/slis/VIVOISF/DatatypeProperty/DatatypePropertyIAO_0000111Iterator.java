...
public class DatatypePropertyIAO_0000111Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatatypePropertyIAO_0000111Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatatypePropertyIAO_0000111Iterator.class);

	static boolean firstInstance = false;
	static boolean lastInstance = false;

	String subjectURI = null;
	String IAO_0000111 = null;
	ResultSet rs = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://purl.obolibrary.org/obo/IAO_0000111> ?s } ");
			if(rs.hasNext()) {
				QuerySolution sol = rs.nextSolution();
				IAO_0000111 = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setIAO_0000111(String theIAO_0000111) {
		IAO_0000111 = theIAO_0000111;
	}

	public String getIAO_0000111() {
		return IAO_0000111;
	}
