...
public class URLMiddleNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static URLMiddleNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(URLMiddleNameIterator.class);
