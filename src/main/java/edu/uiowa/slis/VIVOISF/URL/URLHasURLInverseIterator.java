	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				hasURLInverse = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
	...
	public void setHasURLInverse(String theHasURLInverse) {
		hasURLInverse = theHasURLInverse;
	}
