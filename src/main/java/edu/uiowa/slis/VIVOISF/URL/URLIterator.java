...
public class URLIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static URLIterator currentInstance = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://www.w3.org/2006/vcard/ns#URL> . "+
