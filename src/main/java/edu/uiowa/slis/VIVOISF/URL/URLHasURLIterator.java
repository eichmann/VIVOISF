...
public class URLHasURLIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static URLHasURLIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(URLHasURLIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in URLHasURLIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in URLHasURLIterator doStartTag");
		}
