...
public class URLRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static URLRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(URLRankIterator.class);
