...
public class URLRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static URLRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(URLRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in URLRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in URLRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in URLRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in URLRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in URLRelates doEndTag", e);
			throw new JspTagException("Exception raised in URLRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to URLRelatesIterator");
