...
public class NonFacultyAcademicHasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicHasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicHasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicHasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
