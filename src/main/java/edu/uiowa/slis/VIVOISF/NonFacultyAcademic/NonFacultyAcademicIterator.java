...
public class NonFacultyAcademicIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#NonFacultyAcademic> . "+
