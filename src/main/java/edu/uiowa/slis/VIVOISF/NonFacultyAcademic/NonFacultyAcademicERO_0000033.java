...
public class NonFacultyAcademicERO_0000033 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicERO_0000033 currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicERO_0000033.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicERO_0000033Iterator.getERO_0000033());
		} catch (Exception e) {
