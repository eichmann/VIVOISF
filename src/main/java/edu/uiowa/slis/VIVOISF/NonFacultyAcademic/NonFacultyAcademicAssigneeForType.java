...
public class NonFacultyAcademicAssigneeForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicAssigneeForType currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicAssigneeForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicAssigneeForIterator.getType());
		} catch (Exception e) {
