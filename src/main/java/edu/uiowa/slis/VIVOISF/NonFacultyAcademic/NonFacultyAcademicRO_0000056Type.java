...
public class NonFacultyAcademicRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicRO_0000056Iterator.getType());
		} catch (Exception e) {
