...
public class NonFacultyAcademicSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicSuffixNameIterator.class);
