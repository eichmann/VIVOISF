...
public class NonFacultyAcademicERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicERO_0000037Iterator.getType());
		} catch (Exception e) {
