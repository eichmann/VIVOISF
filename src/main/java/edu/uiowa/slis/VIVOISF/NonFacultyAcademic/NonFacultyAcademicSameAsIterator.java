...
public class NonFacultyAcademicSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicSameAsIterator.class);
