...
public class NonFacultyAcademicScopusIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicScopusIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicScopusIdIterator.class);
