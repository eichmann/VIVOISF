...
public class NonFacultyAcademicRecipientInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicRecipientInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicRecipientInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicRecipientInverseIterator.getType());
		} catch (Exception e) {
