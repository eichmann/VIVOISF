...
public class NonFacultyAcademicFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicFreetextKeywordIterator.class);
