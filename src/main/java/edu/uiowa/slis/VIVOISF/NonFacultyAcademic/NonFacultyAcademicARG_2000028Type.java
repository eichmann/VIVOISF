...
public class NonFacultyAcademicARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicARG_2000028Iterator.getType());
		} catch (Exception e) {
