...
public class NonFacultyAcademicARG_0000197Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicARG_0000197Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicARG_0000197Iterator.class);
