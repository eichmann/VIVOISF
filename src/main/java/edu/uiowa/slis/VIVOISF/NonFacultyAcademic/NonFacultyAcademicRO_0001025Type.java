...
public class NonFacultyAcademicRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicRO_0001025Iterator.getType());
		} catch (Exception e) {
