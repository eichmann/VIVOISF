...
public class NonFacultyAcademicERO_0000397Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonFacultyAcademicERO_0000397Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonFacultyAcademicERO_0000397Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonFacultyAcademicERO_0000397Iterator.getType());
		} catch (Exception e) {
