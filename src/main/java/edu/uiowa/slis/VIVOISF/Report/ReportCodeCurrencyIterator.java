...
public class ReportCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodeCurrencyIterator.class);
