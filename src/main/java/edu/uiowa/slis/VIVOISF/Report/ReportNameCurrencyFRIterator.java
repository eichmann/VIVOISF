...
public class ReportNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameCurrencyFRIterator.class);
