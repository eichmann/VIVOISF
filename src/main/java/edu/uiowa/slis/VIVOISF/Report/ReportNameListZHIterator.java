...
public class ReportNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameListZHIterator.class);
