...
public class ReportNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameOfficialESIterator.class);
