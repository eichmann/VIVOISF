...
public class ReportNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNumberIterator.class);
