...
public class ReportGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportGtin14Iterator.class);
