...
public class ReportIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportIsbn10Iterator.class);
