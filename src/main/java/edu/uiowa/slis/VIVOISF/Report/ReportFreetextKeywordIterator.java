...
public class ReportFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportFreetextKeywordIterator.class);
