...
public class ReportNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameListFRIterator.class);
