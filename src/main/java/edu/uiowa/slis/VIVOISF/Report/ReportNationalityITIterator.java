...
public class ReportNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNationalityITIterator.class);
