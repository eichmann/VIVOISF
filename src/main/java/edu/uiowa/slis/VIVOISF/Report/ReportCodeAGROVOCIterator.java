...
public class ReportCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodeAGROVOCIterator.class);
