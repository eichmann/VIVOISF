...
public class ReportCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCountryAreaUnitIterator.class);
