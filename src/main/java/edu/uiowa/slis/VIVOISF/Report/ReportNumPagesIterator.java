...
public class ReportNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNumPagesIterator.class);
