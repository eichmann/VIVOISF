...
public class ReportCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCountryAreaNotesIterator.class);
