...
public class ReportOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportOclcnumIterator.class);
