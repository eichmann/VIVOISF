...
public class ReportNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameListENIterator.class);
