...
public class ReportNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameListRUIterator.class);
