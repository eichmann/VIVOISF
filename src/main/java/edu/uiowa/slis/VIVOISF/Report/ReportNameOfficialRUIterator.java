...
public class ReportNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameOfficialRUIterator.class);
