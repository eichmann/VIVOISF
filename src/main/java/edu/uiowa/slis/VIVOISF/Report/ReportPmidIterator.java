...
public class ReportPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportPmidIterator.class);
