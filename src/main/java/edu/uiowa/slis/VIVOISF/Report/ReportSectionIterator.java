...
public class ReportSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportSectionIterator.class);
