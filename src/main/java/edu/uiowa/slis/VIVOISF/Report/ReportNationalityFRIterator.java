...
public class ReportNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNationalityFRIterator.class);
