...
public class ReportNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameListITIterator.class);
