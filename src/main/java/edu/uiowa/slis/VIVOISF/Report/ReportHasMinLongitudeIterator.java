...
public class ReportHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportHasMinLongitudeIterator.class);
