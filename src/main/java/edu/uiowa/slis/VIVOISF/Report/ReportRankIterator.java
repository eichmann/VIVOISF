...
public class ReportRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportRankIterator.class);
