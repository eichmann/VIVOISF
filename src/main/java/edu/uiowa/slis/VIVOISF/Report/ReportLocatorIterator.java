...
public class ReportLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportLocatorIterator.class);
