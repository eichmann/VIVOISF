...
public class ReportNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameCurrencyZHIterator.class);
