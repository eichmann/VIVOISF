...
public class ReportNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameOfficialFRIterator.class);
