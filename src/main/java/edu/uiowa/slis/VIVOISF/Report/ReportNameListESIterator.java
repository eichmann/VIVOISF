...
public class ReportNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameListESIterator.class);
