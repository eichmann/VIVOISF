...
public class ReportCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodeUNDPIterator.class);
