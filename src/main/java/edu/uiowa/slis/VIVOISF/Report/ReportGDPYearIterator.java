...
public class ReportGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportGDPYearIterator.class);
