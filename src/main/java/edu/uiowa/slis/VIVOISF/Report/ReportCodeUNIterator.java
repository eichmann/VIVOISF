...
public class ReportCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodeUNIterator.class);
