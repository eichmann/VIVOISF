...
public class ReportNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameShortZHIterator.class);
