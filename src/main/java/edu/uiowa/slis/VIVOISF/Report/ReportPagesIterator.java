...
public class ReportPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportPagesIterator.class);
