...
public class ReportHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportHasMaxLongitudeIterator.class);
