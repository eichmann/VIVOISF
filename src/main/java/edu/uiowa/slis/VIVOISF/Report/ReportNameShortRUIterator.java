...
public class ReportNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameShortRUIterator.class);
