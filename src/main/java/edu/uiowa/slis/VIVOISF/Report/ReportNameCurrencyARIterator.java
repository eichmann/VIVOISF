...
public class ReportNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameCurrencyARIterator.class);
