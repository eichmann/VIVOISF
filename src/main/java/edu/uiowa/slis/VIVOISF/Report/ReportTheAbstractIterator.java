...
public class ReportTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportTheAbstractIterator.class);
