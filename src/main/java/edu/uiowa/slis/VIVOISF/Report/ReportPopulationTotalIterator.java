...
public class ReportPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportPopulationTotalIterator.class);
