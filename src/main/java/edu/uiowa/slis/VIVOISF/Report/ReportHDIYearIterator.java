...
public class ReportHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportHDIYearIterator.class);
