...
public class ReportARG_2000028 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportARG_2000028 currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportARG_2000028.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReportARG_2000028Iterator.getARG_2000028());
		} catch (Exception e) {
