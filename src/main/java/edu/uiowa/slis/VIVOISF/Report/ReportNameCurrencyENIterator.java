...
public class ReportNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameCurrencyENIterator.class);
