...
public class ReportNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameOfficialITIterator.class);
