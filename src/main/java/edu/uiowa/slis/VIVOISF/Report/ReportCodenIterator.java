...
public class ReportCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodenIterator.class);
