...
public class ReportCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodeFAOSTATIterator.class);
