...
public class ReportUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportUpcIterator.class);
