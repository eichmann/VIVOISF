...
public class ReportGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportGDPNotesIterator.class);
