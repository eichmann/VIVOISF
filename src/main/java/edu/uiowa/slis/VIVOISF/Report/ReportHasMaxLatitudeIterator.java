...
public class ReportHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportHasMaxLatitudeIterator.class);
