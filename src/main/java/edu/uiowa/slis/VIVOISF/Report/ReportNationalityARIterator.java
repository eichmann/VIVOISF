...
public class ReportNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNationalityARIterator.class);
