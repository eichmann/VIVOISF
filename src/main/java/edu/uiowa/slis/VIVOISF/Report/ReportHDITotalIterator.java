...
public class ReportHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportHDITotalIterator.class);
