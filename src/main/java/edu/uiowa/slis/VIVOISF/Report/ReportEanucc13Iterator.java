...
public class ReportEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportEanucc13Iterator.class);
