...
public class ReportUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportUrlIterator.class);
