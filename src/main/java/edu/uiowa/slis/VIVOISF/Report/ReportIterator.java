...
public class ReportIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://purl.org/ontology/bibo/Report> . "+
