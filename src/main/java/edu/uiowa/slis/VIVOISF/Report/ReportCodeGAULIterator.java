...
public class ReportCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodeGAULIterator.class);
