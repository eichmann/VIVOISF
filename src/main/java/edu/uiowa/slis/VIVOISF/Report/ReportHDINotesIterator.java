...
public class ReportHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportHDINotesIterator.class);
