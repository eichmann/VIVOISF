...
public class ReportLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportLandAreaTotalIterator.class);
