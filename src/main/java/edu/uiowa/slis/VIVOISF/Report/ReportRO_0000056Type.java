...
public class ReportRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReportRO_0000056Iterator.getType());
		} catch (Exception e) {
