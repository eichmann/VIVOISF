...
public class ReportLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportLandAreaNotesIterator.class);
