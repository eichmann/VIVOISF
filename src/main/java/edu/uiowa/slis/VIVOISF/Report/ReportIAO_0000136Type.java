...
public class ReportIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReportIAO_0000136Iterator.getType());
		} catch (Exception e) {
