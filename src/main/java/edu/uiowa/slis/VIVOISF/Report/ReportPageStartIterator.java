...
public class ReportPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportPageStartIterator.class);
