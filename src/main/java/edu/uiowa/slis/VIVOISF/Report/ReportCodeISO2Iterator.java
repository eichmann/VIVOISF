...
public class ReportCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodeISO2Iterator.class);
