...
public class ReportHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportHandleIterator.class);
