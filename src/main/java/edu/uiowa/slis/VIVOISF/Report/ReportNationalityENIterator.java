...
public class ReportNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNationalityENIterator.class);
