...
public class ReportLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportLandAreaUnitIterator.class);
