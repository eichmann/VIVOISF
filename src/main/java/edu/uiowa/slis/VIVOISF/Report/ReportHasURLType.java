...
public class ReportHasURLType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportHasURLType currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportHasURLType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReportHasURLIterator.getType());
		} catch (Exception e) {
