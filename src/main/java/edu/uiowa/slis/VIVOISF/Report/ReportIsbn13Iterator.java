...
public class ReportIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportIsbn13Iterator.class);
