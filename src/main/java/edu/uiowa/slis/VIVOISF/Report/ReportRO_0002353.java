...
public class ReportRO_0002353 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportRO_0002353 currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportRO_0002353.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReportRO_0002353Iterator.getRO_0002353());
		} catch (Exception e) {
