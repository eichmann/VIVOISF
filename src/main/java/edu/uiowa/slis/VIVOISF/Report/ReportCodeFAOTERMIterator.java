...
public class ReportCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodeFAOTERMIterator.class);
