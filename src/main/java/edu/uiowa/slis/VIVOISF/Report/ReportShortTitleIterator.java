...
public class ReportShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportShortTitleIterator.class);
