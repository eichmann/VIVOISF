...
public class ReportPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportPageEndIterator.class);
