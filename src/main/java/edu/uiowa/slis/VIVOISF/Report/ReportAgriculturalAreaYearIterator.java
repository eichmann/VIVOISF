...
public class ReportAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportAgriculturalAreaYearIterator.class);
