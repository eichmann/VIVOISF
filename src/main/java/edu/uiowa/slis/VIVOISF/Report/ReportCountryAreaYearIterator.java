...
public class ReportCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCountryAreaYearIterator.class);
