...
public class ReportPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportPopulationUnitIterator.class);
