...
public class ReportNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNationalityZHIterator.class);
