...
public class ReportNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameCurrencyRUIterator.class);
