...
public class ReportGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportGDPUnitIterator.class);
