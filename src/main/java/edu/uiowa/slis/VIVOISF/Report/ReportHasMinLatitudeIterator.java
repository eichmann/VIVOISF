...
public class ReportHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportHasMinLatitudeIterator.class);
