...
public class ReportDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportDescriptionIterator.class);
