...
public class ReportAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportAgriculturalAreaUnitIterator.class);
