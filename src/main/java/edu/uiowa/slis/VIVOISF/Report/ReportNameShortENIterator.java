...
public class ReportNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameShortENIterator.class);
