...
public class ReportNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameListARIterator.class);
