...
public class ReportCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodeISO3Iterator.class);
