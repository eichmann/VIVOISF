...
public class ReportRO_0001015 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportRO_0001015 currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportRO_0001015.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReportRO_0001015Iterator.getRO_0001015());
		} catch (Exception e) {
