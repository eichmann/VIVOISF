...
public class ReportAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportAgriculturalAreaTotalIterator.class);
