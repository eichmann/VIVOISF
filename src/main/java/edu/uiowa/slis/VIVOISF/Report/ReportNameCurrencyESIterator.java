...
public class ReportNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameCurrencyESIterator.class);
