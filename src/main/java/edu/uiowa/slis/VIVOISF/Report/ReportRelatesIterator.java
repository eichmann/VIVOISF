...
public class ReportRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ReportRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ReportRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ReportRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ReportRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ReportRelates doEndTag", e);
			throw new JspTagException("Exception raised in ReportRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ReportRelatesIterator");
