...
public class ReportNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNationalityRUIterator.class);
