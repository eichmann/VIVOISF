...
public class ReportDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportDoiIterator.class);
