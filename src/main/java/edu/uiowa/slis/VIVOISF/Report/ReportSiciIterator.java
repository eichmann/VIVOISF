...
public class ReportSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportSiciIterator.class);
