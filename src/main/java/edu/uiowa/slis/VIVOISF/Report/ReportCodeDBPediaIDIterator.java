...
public class ReportCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportCodeDBPediaIDIterator.class);
