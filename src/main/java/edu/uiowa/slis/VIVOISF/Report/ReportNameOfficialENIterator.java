...
public class ReportNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNameOfficialENIterator.class);
