...
public class ReportUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportUriIterator.class);
