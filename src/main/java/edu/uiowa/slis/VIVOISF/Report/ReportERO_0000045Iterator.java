...
public class ReportERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportERO_0000045Iterator.class);
