...
public class ReportPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportPopulationYearIterator.class);
