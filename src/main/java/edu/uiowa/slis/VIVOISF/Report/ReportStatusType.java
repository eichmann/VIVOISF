...
public class ReportStatusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportStatusType currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportStatusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReportStatusIterator.getType());
		} catch (Exception e) {
