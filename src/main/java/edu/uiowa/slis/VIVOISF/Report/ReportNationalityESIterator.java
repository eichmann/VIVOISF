...
public class ReportNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportNationalityESIterator.class);
