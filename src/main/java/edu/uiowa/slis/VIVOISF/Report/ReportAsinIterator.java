...
public class ReportAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportAsinIterator.class);
