...
public class ReportVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportVolumeIterator.class);
