...
public class ReportLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportLandAreaYearIterator.class);
