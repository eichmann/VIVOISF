...
public class ReportContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReportContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReportContentIterator.class);
