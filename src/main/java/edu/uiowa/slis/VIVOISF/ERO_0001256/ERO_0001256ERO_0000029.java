...
public class ERO_0001256ERO_0000029 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001256ERO_0000029 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001256ERO_0000029.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001256ERO_0000029Iterator.getERO_0000029());
		} catch (Exception e) {
