...
public class ERO_0001256ERO_0000482 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001256ERO_0000482 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001256ERO_0000482.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001256ERO_0000482Iterator.getERO_0000482());
		} catch (Exception e) {
