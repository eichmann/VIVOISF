...
public class ERO_0001256Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001256Features currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001256Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001256FeaturesIterator.getFeatures());
		} catch (Exception e) {
