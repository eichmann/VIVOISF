...
public class ExcerptReproducedIn extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExcerptReproducedIn currentInstance = null;
	private static final Log log = LogFactory.getLog(ExcerptReproducedIn.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExcerptReproducedInIterator.getReproducedIn());
		} catch (Exception e) {
