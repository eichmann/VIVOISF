...
public class ExcerptContributorList extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExcerptContributorList currentInstance = null;
	private static final Log log = LogFactory.getLog(ExcerptContributorList.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExcerptContributorListIterator.getContributorList());
		} catch (Exception e) {
