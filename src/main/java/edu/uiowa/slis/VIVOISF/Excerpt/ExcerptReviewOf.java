...
public class ExcerptReviewOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ExcerptReviewOf currentInstance = null;
	private static final Log log = LogFactory.getLog(ExcerptReviewOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theExcerptReviewOfIterator.getReviewOf());
		} catch (Exception e) {
