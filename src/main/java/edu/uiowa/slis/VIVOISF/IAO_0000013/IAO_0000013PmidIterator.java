...
public class IAO_0000013PmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013PmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013PmidIterator.class);
