...
public class IAO_0000013Cites extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013Cites currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013Cites.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013CitesIterator.getCites());
		} catch (Exception e) {
