...
public class IAO_0000013PresentedAtType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013PresentedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013PresentedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013PresentedAtIterator.getType());
		} catch (Exception e) {
