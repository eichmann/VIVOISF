...
public class IAO_0000013SectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013SectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013SectionIterator.class);
