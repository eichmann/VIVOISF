...
public class IAO_0000013DateTimeValueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013DateTimeValueType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013DateTimeValueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013DateTimeValueIterator.getType());
		} catch (Exception e) {
