...
public class IAO_0000013AuthorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013AuthorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013AuthorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013AuthorListIterator.getType());
		} catch (Exception e) {
