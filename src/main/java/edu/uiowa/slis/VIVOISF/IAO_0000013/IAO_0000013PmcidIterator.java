...
public class IAO_0000013PmcidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013PmcidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013PmcidIterator.class);
