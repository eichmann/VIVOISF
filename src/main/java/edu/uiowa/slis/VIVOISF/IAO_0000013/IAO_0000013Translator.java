...
public class IAO_0000013Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013TranslatorIterator.getTranslator());
		} catch (Exception e) {
