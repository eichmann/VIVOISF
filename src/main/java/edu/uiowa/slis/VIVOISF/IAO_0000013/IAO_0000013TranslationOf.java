...
public class IAO_0000013TranslationOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013TranslationOf currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013TranslationOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013TranslationOfIterator.getTranslationOf());
		} catch (Exception e) {
