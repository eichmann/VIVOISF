...
public class IAO_0000013HasTranslation extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013HasTranslation currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013HasTranslation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013HasTranslationIterator.getHasTranslation());
		} catch (Exception e) {
