...
public class IAO_0000013CodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013CodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013CodenIterator.class);
