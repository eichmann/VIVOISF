...
public class IAO_0000013TranscriptOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013TranscriptOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013TranscriptOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013TranscriptOfIterator.getType());
		} catch (Exception e) {
