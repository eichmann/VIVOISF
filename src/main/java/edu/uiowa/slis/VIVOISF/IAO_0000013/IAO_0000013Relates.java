...
public class IAO_0000013Relates extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013Relates currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013Relates.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013RelatesIterator.getRelates());
		} catch (Exception e) {
