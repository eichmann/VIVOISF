...
public class IAO_0000013Status extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013Status currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013Status.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013StatusIterator.getStatus());
		} catch (Exception e) {
