...
public class IAO_0000013Eanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013Eanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013Eanucc13Iterator.class);
