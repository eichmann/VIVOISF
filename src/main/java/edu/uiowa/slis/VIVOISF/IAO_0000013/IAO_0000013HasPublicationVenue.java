...
public class IAO_0000013HasPublicationVenue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013HasPublicationVenue currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013HasPublicationVenue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013HasPublicationVenueIterator.getHasPublicationVenue());
		} catch (Exception e) {
