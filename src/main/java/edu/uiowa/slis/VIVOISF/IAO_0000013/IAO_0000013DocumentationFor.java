...
public class IAO_0000013DocumentationFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013DocumentationFor currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013DocumentationFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013DocumentationForIterator.getDocumentationFor());
		} catch (Exception e) {
