...
public class IAO_0000013EditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013EditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013EditionIterator.class);
