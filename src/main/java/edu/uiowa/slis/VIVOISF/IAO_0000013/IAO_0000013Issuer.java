...
public class IAO_0000013Issuer extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013Issuer currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013Issuer.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013IssuerIterator.getIssuer());
		} catch (Exception e) {
