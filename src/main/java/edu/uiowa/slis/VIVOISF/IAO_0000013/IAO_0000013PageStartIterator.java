...
public class IAO_0000013PageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013PageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013PageStartIterator.class);
