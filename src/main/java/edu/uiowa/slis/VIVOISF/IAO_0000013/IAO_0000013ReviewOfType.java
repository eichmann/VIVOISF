...
public class IAO_0000013ReviewOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013ReviewOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013ReviewOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013ReviewOfIterator.getType());
		} catch (Exception e) {
