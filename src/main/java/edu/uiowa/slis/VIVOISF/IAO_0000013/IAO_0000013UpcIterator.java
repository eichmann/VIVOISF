...
public class IAO_0000013UpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013UpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013UpcIterator.class);
