...
public class IAO_0000013SiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013SiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013SiciIterator.class);
