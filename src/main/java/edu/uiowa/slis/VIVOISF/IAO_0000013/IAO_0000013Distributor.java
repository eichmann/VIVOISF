...
public class IAO_0000013Distributor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013Distributor currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013Distributor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013DistributorIterator.getDistributor());
		} catch (Exception e) {
