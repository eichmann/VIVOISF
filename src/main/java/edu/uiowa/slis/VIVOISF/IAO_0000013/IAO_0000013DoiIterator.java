...
public class IAO_0000013DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013DoiIterator.class);
