...
public class IAO_0000013NumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013NumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013NumPagesIterator.class);
