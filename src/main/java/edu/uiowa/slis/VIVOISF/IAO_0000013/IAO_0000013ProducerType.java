...
public class IAO_0000013ProducerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013ProducerType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013ProducerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013ProducerIterator.getType());
		} catch (Exception e) {
