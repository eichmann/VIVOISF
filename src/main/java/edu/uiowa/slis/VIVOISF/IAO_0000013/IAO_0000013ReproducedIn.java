...
public class IAO_0000013ReproducedIn extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013ReproducedIn currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013ReproducedIn.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013ReproducedInIterator.getReproducedIn());
		} catch (Exception e) {
