...
public class IAO_0000013HandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013HandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013HandleIterator.class);
