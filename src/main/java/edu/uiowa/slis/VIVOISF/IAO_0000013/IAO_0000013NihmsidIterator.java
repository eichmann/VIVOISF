...
public class IAO_0000013NihmsidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013NihmsidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013NihmsidIterator.class);
