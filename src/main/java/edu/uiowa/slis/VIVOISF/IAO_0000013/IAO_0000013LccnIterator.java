...
public class IAO_0000013LccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013LccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013LccnIterator.class);
