...
public class IAO_0000013HasSubjectArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013HasSubjectArea currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013HasSubjectArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013HasSubjectAreaIterator.getHasSubjectArea());
		} catch (Exception e) {
