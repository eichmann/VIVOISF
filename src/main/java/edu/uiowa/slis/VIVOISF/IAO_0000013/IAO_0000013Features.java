...
public class IAO_0000013Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013Features currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013FeaturesIterator.getFeatures());
		} catch (Exception e) {
