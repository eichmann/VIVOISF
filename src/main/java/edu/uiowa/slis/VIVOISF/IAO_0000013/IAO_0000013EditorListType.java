...
public class IAO_0000013EditorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013EditorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013EditorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013EditorListIterator.getType());
		} catch (Exception e) {
