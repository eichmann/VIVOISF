...
public class IAO_0000013ContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013ContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013ContentIterator.class);
