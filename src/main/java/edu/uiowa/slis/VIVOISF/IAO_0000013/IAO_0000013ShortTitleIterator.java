...
public class IAO_0000013ShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013ShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013ShortTitleIterator.class);
