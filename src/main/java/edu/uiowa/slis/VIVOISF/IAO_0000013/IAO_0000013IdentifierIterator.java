...
public class IAO_0000013IdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013IdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013IdentifierIterator.class);
