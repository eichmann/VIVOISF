...
public class IAO_0000013Isbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013Isbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013Isbn10Iterator.class);
