...
public class IAO_0000013ReproducesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013ReproducesType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013ReproducesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013ReproducesIterator.getType());
		} catch (Exception e) {
