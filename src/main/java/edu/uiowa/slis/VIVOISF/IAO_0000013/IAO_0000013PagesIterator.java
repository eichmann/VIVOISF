...
public class IAO_0000013PagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013PagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013PagesIterator.class);
