...
public class IAO_0000013VolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013VolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013VolumeIterator.class);
