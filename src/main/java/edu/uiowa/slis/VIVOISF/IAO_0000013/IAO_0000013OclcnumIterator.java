...
public class IAO_0000013OclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013OclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013OclcnumIterator.class);
