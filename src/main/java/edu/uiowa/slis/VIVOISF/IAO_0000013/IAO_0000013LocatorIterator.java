...
public class IAO_0000013LocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013LocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013LocatorIterator.class);
