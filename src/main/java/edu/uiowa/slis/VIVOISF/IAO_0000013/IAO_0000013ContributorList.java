...
public class IAO_0000013ContributorList extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013ContributorList currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013ContributorList.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013ContributorListIterator.getContributorList());
		} catch (Exception e) {
