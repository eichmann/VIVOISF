...
public class IAO_0000013UriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013UriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013UriIterator.class);
