...
public class IAO_0000013CitedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013CitedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013CitedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013CitedByIterator.getCitedBy());
		} catch (Exception e) {
