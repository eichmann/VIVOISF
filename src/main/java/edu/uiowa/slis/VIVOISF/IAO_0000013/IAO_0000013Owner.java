...
public class IAO_0000013Owner extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000013Owner currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000013Owner.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000013OwnerIterator.getOwner());
		} catch (Exception e) {
