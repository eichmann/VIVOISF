...
public class MeetingBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MeetingBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMeetingBFO_0000055Iterator.getType());
		} catch (Exception e) {
