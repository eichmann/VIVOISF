...
public class MeetingRO_0000057 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MeetingRO_0000057 currentInstance = null;
	private static final Log log = LogFactory.getLog(MeetingRO_0000057.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMeetingRO_0000057Iterator.getRO_0000057());
		} catch (Exception e) {
