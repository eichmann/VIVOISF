...
public class OrganizationNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OrganizationNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OrganizationNameIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://www.w3.org/2006/vcard/ns#OrganizationName> . "+
