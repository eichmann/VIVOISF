...
public class NamedIndividualIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NamedIndividualIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NamedIndividualIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.w3.org/2002/07/owl#NamedIndividual> . "+
