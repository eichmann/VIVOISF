	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				hasTitleInverse = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
	...
	public void setHasTitleInverse(String theHasTitleInverse) {
		hasTitleInverse = theHasTitleInverse;
	}
