...
public class AnnotationPropertyDisplayLimitAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AnnotationPropertyDisplayLimitAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AnnotationPropertyDisplayLimitAnnotIterator.class);
