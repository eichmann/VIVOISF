...
public class AnnotationPropertyTheTypeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AnnotationPropertyTheTypeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AnnotationPropertyTheTypeIterator.class);
