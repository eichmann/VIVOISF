...
public class AnnotationPropertyLabelIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AnnotationPropertyLabelIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AnnotationPropertyLabelIterator.class);
