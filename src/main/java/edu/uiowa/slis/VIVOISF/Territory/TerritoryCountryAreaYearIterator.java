...
public class TerritoryCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryCountryAreaYearIterator.class);
