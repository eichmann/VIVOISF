...
public class TerritoryNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameOfficialITIterator.class);
