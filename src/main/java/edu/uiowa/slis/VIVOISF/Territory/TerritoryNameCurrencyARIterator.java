...
public class TerritoryNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameCurrencyARIterator.class);
