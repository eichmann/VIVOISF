...
public class TerritoryCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryCountryAreaUnitIterator.class);
