...
public class TerritoryCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryCodeDBPediaIDIterator.class);
