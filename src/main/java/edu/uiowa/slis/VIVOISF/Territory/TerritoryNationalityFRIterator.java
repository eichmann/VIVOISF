...
public class TerritoryNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNationalityFRIterator.class);
