...
public class TerritoryGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryGDPYearIterator.class);
