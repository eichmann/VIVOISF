...
public class TerritoryNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameOfficialARIterator.class);
