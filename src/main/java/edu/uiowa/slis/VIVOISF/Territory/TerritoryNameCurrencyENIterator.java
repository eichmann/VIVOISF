...
public class TerritoryNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameCurrencyENIterator.class);
