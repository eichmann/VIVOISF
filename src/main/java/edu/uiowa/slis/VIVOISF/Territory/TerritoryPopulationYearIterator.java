...
public class TerritoryPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryPopulationYearIterator.class);
