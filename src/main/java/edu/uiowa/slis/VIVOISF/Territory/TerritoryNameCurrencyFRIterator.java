...
public class TerritoryNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameCurrencyFRIterator.class);
