...
public class TerritoryGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryGDPUnitIterator.class);
