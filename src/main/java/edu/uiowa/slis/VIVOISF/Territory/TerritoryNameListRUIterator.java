...
public class TerritoryNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameListRUIterator.class);
