...
public class TerritoryLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryLandAreaUnitIterator.class);
