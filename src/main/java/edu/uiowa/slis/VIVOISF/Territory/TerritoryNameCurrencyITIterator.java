...
public class TerritoryNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameCurrencyITIterator.class);
