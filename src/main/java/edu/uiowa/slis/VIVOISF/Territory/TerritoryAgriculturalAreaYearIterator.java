...
public class TerritoryAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryAgriculturalAreaYearIterator.class);
