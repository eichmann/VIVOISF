...
public class TerritoryHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryHasMinLatitudeIterator.class);
