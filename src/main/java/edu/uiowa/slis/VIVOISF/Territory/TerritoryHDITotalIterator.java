...
public class TerritoryHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryHDITotalIterator.class);
