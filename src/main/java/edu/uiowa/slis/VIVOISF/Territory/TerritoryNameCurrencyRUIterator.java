...
public class TerritoryNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameCurrencyRUIterator.class);
