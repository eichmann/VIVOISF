...
public class TerritoryLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryLandAreaNotesIterator.class);
