...
public class TerritoryNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameCurrencyZHIterator.class);
