...
public class TerritoryNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameOfficialESIterator.class);
