...
public class TerritoryNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNationalityRUIterator.class);
