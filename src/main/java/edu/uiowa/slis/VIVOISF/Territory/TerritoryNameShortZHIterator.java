...
public class TerritoryNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameShortZHIterator.class);
