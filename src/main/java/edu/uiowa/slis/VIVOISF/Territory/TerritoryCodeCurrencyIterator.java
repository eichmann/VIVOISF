...
public class TerritoryCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryCodeCurrencyIterator.class);
