...
public class TerritoryCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryCodeISO2Iterator.class);
