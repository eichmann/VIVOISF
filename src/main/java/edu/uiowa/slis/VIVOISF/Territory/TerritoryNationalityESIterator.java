...
public class TerritoryNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNationalityESIterator.class);
