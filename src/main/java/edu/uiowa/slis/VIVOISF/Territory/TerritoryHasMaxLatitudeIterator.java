...
public class TerritoryHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryHasMaxLatitudeIterator.class);
