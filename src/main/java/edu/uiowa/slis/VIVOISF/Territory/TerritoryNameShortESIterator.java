...
public class TerritoryNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameShortESIterator.class);
