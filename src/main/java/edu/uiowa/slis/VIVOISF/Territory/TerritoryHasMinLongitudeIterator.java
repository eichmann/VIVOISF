...
public class TerritoryHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryHasMinLongitudeIterator.class);
