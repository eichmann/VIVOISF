...
public class TerritoryNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameListFRIterator.class);
