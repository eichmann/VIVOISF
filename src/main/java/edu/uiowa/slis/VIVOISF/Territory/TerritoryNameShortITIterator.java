...
public class TerritoryNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameShortITIterator.class);
