...
public class TerritoryCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryCodeAGROVOCIterator.class);
