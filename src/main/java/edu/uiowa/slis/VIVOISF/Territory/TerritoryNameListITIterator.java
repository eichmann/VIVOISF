...
public class TerritoryNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameListITIterator.class);
