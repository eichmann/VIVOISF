...
public class TerritoryCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryCountryAreaNotesIterator.class);
