...
public class TerritoryGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryGDPNotesIterator.class);
