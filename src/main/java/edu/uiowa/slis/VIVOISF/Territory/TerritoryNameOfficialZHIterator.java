...
public class TerritoryNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameOfficialZHIterator.class);
