...
public class TerritoryCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryCodeISO3Iterator.class);
