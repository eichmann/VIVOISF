...
public class TerritoryLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryLandAreaTotalIterator.class);
