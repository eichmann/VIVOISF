...
public class TerritoryCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryCodeGAULIterator.class);
