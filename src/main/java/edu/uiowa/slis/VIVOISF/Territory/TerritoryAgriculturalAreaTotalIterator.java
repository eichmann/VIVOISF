...
public class TerritoryAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryAgriculturalAreaTotalIterator.class);
