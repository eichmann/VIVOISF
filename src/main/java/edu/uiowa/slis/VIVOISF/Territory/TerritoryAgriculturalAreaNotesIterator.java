...
public class TerritoryAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryAgriculturalAreaNotesIterator.class);
