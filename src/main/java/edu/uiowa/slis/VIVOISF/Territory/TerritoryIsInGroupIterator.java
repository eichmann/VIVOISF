	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				isInGroup = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
	...
	public void setIsInGroup(String theIsInGroup) {
		isInGroup = theIsInGroup;
	}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to TerritoryIsInGroupIterator");
