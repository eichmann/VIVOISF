...
public class TerritoryNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNationalityZHIterator.class);
