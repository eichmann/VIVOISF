...
public class TerritoryPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryPopulationTotalIterator.class);
