...
public class TerritoryValidUntilIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryValidUntilIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryValidUntilIterator.class);
