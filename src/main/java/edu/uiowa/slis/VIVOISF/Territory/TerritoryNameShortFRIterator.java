...
public class TerritoryNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameShortFRIterator.class);
