...
public class TerritoryNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TerritoryNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TerritoryNameListESIterator.class);
