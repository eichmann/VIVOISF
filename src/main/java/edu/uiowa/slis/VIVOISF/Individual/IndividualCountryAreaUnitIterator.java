...
public class IndividualCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCountryAreaUnitIterator.class);
