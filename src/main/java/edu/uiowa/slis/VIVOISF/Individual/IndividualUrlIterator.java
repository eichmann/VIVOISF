...
public class IndividualUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualUrlIterator.class);
