...
public class IndividualNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameShortZHIterator.class);
