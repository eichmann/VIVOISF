...
public class IndividualLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualLandAreaUnitIterator.class);
