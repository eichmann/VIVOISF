...
public class IndividualHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualHasMinLongitudeIterator.class);
