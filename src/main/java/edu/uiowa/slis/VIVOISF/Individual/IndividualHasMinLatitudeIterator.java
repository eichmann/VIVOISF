...
public class IndividualHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualHasMinLatitudeIterator.class);
