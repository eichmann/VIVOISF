...
public class IndividualAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualAgriculturalAreaTotalIterator.class);
