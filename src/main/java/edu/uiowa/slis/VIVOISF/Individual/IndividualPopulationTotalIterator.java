...
public class IndividualPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualPopulationTotalIterator.class);
