...
public class IndividualNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNationalityARIterator.class);
