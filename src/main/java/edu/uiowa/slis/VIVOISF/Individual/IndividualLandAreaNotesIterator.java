...
public class IndividualLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualLandAreaNotesIterator.class);
