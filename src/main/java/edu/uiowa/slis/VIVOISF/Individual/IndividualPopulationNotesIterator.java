...
public class IndividualPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualPopulationNotesIterator.class);
