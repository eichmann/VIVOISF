...
public class IndividualGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualGDPYearIterator.class);
