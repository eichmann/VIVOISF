...
public class IndividualCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCodeISO2Iterator.class);
