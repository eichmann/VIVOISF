...
public class IndividualBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndividualBFO_0000051Iterator.getType());
		} catch (Exception e) {
