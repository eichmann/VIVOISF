...
public class IndividualNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameShortENIterator.class);
