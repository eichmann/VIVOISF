...
public class IndividualDateTimeInterval extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualDateTimeInterval currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualDateTimeInterval.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndividualDateTimeIntervalIterator.getDateTimeInterval());
		} catch (Exception e) {
