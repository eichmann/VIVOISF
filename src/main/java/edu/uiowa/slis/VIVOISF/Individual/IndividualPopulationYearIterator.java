...
public class IndividualPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualPopulationYearIterator.class);
