...
public class IndividualAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualAgriculturalAreaUnitIterator.class);
