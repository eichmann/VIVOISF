...
public class IndividualLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualLandAreaYearIterator.class);
