...
public class IndividualRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualRankIterator.class);
