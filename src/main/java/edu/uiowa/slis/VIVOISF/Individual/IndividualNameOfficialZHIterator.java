...
public class IndividualNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameOfficialZHIterator.class);
