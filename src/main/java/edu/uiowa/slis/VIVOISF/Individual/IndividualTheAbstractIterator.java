...
public class IndividualTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualTheAbstractIterator.class);
