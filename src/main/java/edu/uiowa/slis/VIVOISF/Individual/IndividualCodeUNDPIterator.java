...
public class IndividualCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCodeUNDPIterator.class);
