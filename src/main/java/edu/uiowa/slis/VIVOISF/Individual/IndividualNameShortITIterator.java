...
public class IndividualNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameShortITIterator.class);
