...
public class IndividualNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameOfficialITIterator.class);
