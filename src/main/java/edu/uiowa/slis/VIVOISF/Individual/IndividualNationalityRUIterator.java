...
public class IndividualNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNationalityRUIterator.class);
