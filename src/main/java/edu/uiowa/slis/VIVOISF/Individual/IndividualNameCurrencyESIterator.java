...
public class IndividualNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameCurrencyESIterator.class);
