...
public class IndividualHasMemberInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualHasMemberInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualHasMemberInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndividualHasMemberInverseIterator.getType());
		} catch (Exception e) {
