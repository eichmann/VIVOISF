...
public class IndividualHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualHDIYearIterator.class);
