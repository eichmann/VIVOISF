...
public class IndividualNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameListARIterator.class);
