...
public class IndividualPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualPopulationUnitIterator.class);
