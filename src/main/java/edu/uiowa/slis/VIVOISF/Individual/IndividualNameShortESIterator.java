...
public class IndividualNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameShortESIterator.class);
