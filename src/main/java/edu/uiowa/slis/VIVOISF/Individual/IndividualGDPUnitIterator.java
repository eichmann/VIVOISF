...
public class IndividualGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualGDPUnitIterator.class);
