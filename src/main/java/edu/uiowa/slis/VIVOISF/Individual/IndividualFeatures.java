...
public class IndividualFeatures extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualFeatures currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualFeatures.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndividualFeaturesIterator.getFeatures());
		} catch (Exception e) {
