...
public class IndividualCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCountryAreaNotesIterator.class);
