...
public class IndividualNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameShortFRIterator.class);
