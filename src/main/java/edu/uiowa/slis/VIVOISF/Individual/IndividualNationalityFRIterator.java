...
public class IndividualNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNationalityFRIterator.class);
