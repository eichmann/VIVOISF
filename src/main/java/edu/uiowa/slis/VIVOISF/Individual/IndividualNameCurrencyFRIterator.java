...
public class IndividualNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameCurrencyFRIterator.class);
