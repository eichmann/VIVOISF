...
public class IndividualCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCountryAreaYearIterator.class);
