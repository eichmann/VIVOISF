...
public class IndividualRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndividualRO_0001015Iterator.getType());
		} catch (Exception e) {
