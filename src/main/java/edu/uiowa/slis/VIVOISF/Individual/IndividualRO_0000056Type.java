...
public class IndividualRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndividualRO_0000056Iterator.getType());
		} catch (Exception e) {
