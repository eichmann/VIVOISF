...
public class IndividualNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameListFRIterator.class);
