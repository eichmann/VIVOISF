...
public class IndividualBirthdateIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualBirthdateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualBirthdateIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://www.w3.org/2006/vcard/ns#birthdate> ?s } ");
			if(rs.hasNext()) {
