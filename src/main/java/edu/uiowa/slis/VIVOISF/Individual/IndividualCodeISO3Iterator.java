...
public class IndividualCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCodeISO3Iterator.class);
