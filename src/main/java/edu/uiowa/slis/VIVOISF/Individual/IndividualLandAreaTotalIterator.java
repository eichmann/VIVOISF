...
public class IndividualLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualLandAreaTotalIterator.class);
