...
public class IndividualNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNationalityZHIterator.class);
