...
public class IndividualNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameCurrencyENIterator.class);
