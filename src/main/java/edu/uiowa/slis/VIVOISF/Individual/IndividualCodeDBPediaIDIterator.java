...
public class IndividualCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCodeDBPediaIDIterator.class);
