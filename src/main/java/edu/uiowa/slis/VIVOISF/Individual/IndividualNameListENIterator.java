...
public class IndividualNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameListENIterator.class);
