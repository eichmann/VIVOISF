...
public class IndividualCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCodeGAULIterator.class);
