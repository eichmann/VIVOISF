...
public class IndividualHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualHasMaxLongitudeIterator.class);
