...
public class IndividualCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCountryAreaTotalIterator.class);
