...
public class IndividualNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameShortRUIterator.class);
