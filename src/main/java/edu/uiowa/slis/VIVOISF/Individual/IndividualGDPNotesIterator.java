...
public class IndividualGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualGDPNotesIterator.class);
