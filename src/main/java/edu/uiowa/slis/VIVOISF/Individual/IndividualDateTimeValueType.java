...
public class IndividualDateTimeValueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualDateTimeValueType currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualDateTimeValueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndividualDateTimeValueIterator.getType());
		} catch (Exception e) {
