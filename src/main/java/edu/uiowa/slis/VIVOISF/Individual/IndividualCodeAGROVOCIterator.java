...
public class IndividualCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCodeAGROVOCIterator.class);
