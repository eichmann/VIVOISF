...
public class IndividualGenderIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualGenderIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualGenderIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://www.w3.org/2006/vcard/ns#gender> ?s } ");
			if(rs.hasNext()) {
