...
public class IndividualNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameListITIterator.class);
