...
public class IndividualIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualIterator.class);
