...
public class IndividualNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameOfficialARIterator.class);
