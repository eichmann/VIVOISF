...
public class IndividualNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNationalityITIterator.class);
