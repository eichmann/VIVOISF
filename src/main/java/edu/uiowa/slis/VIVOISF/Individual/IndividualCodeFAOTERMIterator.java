...
public class IndividualCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCodeFAOTERMIterator.class);
