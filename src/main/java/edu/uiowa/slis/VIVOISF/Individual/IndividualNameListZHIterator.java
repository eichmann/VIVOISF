...
public class IndividualNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameListZHIterator.class);
