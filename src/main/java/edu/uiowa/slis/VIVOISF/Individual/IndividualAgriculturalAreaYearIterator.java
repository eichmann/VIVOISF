...
public class IndividualAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualAgriculturalAreaYearIterator.class);
