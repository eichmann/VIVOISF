...
public class IndividualCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCodeFAOSTATIterator.class);
