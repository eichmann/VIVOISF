...
public class IndividualNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameCurrencyZHIterator.class);
