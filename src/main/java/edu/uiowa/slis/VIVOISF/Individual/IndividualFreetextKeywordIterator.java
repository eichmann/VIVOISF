...
public class IndividualFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualFreetextKeywordIterator.class);
