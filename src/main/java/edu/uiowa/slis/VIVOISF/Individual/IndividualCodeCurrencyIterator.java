...
public class IndividualCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCodeCurrencyIterator.class);
