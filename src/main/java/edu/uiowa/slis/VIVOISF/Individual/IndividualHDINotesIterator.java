...
public class IndividualHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualHDINotesIterator.class);
