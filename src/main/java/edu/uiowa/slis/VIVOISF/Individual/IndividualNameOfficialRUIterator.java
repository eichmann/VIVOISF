...
public class IndividualNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameOfficialRUIterator.class);
