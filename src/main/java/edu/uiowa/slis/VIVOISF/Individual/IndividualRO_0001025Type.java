...
public class IndividualRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIndividualRO_0001025Iterator.getType());
		} catch (Exception e) {
