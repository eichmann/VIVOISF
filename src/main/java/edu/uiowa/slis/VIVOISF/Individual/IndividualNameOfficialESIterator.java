...
public class IndividualNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameOfficialESIterator.class);
