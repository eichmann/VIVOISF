...
public class IndividualCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualCodeUNIterator.class);
