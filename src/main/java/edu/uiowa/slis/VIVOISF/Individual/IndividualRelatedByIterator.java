...
public class IndividualRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualRelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualRelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IndividualRelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IndividualRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IndividualRelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IndividualRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IndividualRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in IndividualRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IndividualRelatedByIterator");
