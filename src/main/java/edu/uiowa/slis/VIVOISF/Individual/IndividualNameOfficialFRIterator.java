...
public class IndividualNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameOfficialFRIterator.class);
