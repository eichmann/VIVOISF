...
public class IndividualNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IndividualNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IndividualNameCurrencyARIterator.class);
