...
public class DatabaseDistributorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseDistributorType currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseDistributorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatabaseDistributorIterator.getType());
		} catch (Exception e) {
