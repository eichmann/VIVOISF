...
public class DatabaseUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseUpcIterator.class);
