...
public class DatabaseVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseVolumeIterator.class);
