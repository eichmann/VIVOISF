...
public class DatabaseIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseIdentifierIterator.class);
