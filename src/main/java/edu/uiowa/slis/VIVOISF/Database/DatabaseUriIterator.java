...
public class DatabaseUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseUriIterator.class);
