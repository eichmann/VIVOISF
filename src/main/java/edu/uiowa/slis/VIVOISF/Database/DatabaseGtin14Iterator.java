...
public class DatabaseGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseGtin14Iterator.class);
