...
public class DatabaseIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseIsbn10Iterator.class);
