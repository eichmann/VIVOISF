...
public class DatabaseEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseEditionIterator.class);
