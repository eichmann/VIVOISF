...
public class DatabaseAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseAsinIterator.class);
