...
public class DatabaseShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseShortDescriptionIterator.class);
