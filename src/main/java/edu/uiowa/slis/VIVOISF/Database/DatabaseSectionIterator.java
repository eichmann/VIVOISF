...
public class DatabaseSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseSectionIterator.class);
