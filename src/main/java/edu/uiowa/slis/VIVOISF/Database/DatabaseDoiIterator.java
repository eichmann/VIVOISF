...
public class DatabaseDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseDoiIterator.class);
