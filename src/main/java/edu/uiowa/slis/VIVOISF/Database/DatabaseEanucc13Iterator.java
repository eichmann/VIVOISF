...
public class DatabaseEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseEanucc13Iterator.class);
