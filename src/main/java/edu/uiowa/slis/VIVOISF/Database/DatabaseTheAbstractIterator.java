...
public class DatabaseTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseTheAbstractIterator.class);
