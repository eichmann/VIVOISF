...
public class DatabaseNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseNumberIterator.class);
