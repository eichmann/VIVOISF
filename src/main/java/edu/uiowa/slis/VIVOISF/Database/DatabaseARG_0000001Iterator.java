...
public class DatabaseARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseARG_0000001Iterator.class);
