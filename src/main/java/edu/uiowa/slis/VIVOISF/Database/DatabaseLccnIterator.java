...
public class DatabaseLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseLccnIterator.class);
