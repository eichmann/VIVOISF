...
public class DatabaseShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseShortTitleIterator.class);
