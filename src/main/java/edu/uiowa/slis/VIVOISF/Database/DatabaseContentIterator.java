...
public class DatabaseContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseContentIterator.class);
