...
public class DatabaseIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDatabaseIAO_0000136Iterator.getType());
		} catch (Exception e) {
