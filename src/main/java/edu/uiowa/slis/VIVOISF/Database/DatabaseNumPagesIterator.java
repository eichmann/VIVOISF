...
public class DatabaseNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseNumPagesIterator.class);
