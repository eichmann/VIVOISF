...
public class DatabaseIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseIsbn13Iterator.class);
