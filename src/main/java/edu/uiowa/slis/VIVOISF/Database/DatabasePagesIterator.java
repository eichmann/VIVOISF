...
public class DatabasePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabasePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabasePagesIterator.class);
