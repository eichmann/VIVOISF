...
public class DatabaseLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseLocatorIterator.class);
