...
public class DatabasePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabasePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabasePmidIterator.class);
