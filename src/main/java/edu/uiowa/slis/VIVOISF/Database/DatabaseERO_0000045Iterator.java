...
public class DatabaseERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseERO_0000045Iterator.class);
