...
public class DatabaseOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseOclcnumIterator.class);
