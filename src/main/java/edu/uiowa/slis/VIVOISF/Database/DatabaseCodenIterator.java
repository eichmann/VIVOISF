...
public class DatabaseCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DatabaseCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DatabaseCodenIterator.class);
