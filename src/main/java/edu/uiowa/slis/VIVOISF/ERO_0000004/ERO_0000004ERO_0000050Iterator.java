...
public class ERO_0000004ERO_0000050Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000004ERO_0000050Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000004ERO_0000050Iterator.class);

	String subjectURI = null;
	String ERO_0000050 = null;
	ResultSet rs = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(Prefix_1_4+"SELECT ?s where { <" + subjectURI + "> <http://purl.obolibrary.org/obo/ERO_0000050> ?s } ");
			if(rs.hasNext()) {
				QuerySolution sol = rs.nextSolution();
				ERO_0000050 = sol.get("?s").toString();
	...
	public void setERO_0000050(String ERO_0000050) {
		this.ERO_0000050 = ERO_0000050;
	}

	public String getERO_0000050() {
		return ERO_0000050;
	}
