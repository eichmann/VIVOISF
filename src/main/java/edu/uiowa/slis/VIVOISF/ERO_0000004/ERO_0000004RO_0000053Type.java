...
public class ERO_0000004RO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000004RO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000004RO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000004RO_0000053Iterator.getType());
		} catch (Exception e) {
