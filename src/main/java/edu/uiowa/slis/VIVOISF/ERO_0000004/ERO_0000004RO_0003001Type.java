...
public class ERO_0000004RO_0003001Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000004RO_0003001Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000004RO_0003001Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000004RO_0003001Iterator.getType());
		} catch (Exception e) {
