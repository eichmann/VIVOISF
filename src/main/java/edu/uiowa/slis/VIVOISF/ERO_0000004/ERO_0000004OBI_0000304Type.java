...
public class ERO_0000004OBI_0000304Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000004OBI_0000304Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000004OBI_0000304Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000004OBI_0000304Iterator.getType());
		} catch (Exception e) {
