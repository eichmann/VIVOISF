...
public class ERO_0000004ERO_0000460 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000004ERO_0000460 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000004ERO_0000460.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000004ERO_0000460Iterator.getERO_0000460());
		} catch (Exception e) {
