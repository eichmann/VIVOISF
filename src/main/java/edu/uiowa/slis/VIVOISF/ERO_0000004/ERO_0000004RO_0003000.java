...
public class ERO_0000004RO_0003000 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000004RO_0003000 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000004RO_0003000.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000004RO_0003000Iterator.getRO_0003000());
		} catch (Exception e) {
