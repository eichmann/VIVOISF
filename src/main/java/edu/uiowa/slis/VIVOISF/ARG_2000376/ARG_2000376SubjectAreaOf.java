...
public class ARG_2000376SubjectAreaOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376SubjectAreaOf currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376SubjectAreaOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000376SubjectAreaOfIterator.getSubjectAreaOf());
		} catch (Exception e) {
