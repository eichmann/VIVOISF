...
public class ARG_2000376RelatedInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376RelatedInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376RelatedInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ARG_2000376RelatedInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ARG_2000376RelatedInverseIterator doStartTag");
		}
