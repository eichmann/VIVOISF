...
public class ARG_2000376TopConceptOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376TopConceptOf currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376TopConceptOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000376TopConceptOfIterator.getTopConceptOf());
		} catch (Exception e) {
