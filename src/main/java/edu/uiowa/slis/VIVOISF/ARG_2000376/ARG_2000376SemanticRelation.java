...
public class ARG_2000376SemanticRelation extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376SemanticRelation currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376SemanticRelation.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000376SemanticRelationIterator.getSemanticRelation());
		} catch (Exception e) {
