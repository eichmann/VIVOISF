...
public class ARG_2000376NarrowerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376NarrowerType currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376NarrowerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000376NarrowerIterator.getType());
		} catch (Exception e) {
