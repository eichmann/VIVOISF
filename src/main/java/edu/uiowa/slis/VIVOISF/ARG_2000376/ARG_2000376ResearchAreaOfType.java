...
public class ARG_2000376ResearchAreaOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376ResearchAreaOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376ResearchAreaOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000376ResearchAreaOfIterator.getType());
		} catch (Exception e) {
