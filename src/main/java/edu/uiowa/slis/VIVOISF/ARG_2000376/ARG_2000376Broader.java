...
public class ARG_2000376Broader extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376Broader currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376Broader.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000376BroaderIterator.getBroader());
		} catch (Exception e) {
