...
public class ARG_2000376RelatedInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376RelatedInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376RelatedInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000376RelatedInverseIterator.getType());
		} catch (Exception e) {
