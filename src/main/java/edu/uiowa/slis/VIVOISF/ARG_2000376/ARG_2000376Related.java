...
public class ARG_2000376Related extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376Related currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376Related.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000376RelatedIterator.getRelated());
		} catch (Exception e) {
