...
public class ARG_2000376MemberInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376MemberInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376MemberInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000376MemberInverseIterator.getMemberInverse());
		} catch (Exception e) {
