...
public class ARG_2000376SemanticRelationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376SemanticRelationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376SemanticRelationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ARG_2000376SemanticRelationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ARG_2000376SemanticRelationIterator doStartTag");
		}
