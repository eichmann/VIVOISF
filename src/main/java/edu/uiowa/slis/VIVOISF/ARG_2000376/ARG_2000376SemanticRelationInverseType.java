...
public class ARG_2000376SemanticRelationInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000376SemanticRelationInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000376SemanticRelationInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000376SemanticRelationInverseIterator.getType());
		} catch (Exception e) {
