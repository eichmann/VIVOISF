...
public class IAO_0000009LandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009LandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009LandAreaNotesIterator.class);
