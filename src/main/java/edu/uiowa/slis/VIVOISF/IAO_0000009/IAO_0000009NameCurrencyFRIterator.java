...
public class IAO_0000009NameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameCurrencyFRIterator.class);
