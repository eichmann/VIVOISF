...
public class IAO_0000009NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NationalityARIterator.class);
