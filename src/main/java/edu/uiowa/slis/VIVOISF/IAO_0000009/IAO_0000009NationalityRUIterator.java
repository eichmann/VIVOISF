...
public class IAO_0000009NationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NationalityRUIterator.class);
