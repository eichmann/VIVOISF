...
public class IAO_0000009GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009GDPNotesIterator.class);
