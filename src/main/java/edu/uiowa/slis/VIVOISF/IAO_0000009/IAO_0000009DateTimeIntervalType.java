...
public class IAO_0000009DateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009DateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009DateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009DateTimeIntervalIterator.getType());
		} catch (Exception e) {
