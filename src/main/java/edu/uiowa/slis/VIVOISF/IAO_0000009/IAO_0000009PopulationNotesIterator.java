...
public class IAO_0000009PopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009PopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009PopulationNotesIterator.class);
