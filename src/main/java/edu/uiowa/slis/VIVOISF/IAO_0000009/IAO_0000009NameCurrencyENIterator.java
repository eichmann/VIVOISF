...
public class IAO_0000009NameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameCurrencyENIterator.class);
