...
public class IAO_0000009NameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameListARIterator.class);
