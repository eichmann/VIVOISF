...
public class IAO_0000009NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameListRUIterator.class);
