...
public class IAO_0000009HasURL extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HasURL currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HasURL.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009HasURLIterator.getHasURL());
		} catch (Exception e) {
