...
public class IAO_0000009CodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CodeISO3Iterator.class);
