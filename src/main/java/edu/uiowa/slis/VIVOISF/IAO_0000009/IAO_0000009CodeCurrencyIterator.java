...
public class IAO_0000009CodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CodeCurrencyIterator.class);
