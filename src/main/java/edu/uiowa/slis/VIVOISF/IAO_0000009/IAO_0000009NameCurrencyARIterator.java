...
public class IAO_0000009NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameCurrencyARIterator.class);
