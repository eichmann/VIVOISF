...
public class IAO_0000009NationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NationalityFRIterator.class);
