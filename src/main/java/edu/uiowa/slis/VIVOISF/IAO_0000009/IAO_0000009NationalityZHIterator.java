...
public class IAO_0000009NationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NationalityZHIterator.class);
