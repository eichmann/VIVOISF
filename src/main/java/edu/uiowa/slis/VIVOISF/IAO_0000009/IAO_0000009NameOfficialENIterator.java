...
public class IAO_0000009NameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameOfficialENIterator.class);
