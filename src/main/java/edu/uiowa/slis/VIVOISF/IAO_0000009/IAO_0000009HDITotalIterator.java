...
public class IAO_0000009HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HDITotalIterator.class);
