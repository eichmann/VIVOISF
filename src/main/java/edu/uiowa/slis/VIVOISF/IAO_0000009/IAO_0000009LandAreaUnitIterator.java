...
public class IAO_0000009LandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009LandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009LandAreaUnitIterator.class);
