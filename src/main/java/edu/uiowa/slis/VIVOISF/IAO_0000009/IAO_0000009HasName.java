...
public class IAO_0000009HasName extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HasName currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HasName.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009HasNameIterator.getHasName());
		} catch (Exception e) {
