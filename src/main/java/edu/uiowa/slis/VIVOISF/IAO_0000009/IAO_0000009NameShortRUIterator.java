...
public class IAO_0000009NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameShortRUIterator.class);
