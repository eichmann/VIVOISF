...
public class IAO_0000009HasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HasMaxLongitudeIterator.class);
