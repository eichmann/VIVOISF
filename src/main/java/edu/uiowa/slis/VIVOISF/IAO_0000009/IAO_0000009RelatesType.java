...
public class IAO_0000009RelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009RelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009RelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009RelatesIterator.getType());
		} catch (Exception e) {
