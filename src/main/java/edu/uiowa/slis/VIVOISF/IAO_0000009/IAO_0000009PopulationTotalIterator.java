...
public class IAO_0000009PopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009PopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009PopulationTotalIterator.class);
