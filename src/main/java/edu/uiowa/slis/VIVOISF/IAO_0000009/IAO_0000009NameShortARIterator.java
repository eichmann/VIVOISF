...
public class IAO_0000009NameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameShortARIterator.class);
