...
public class IAO_0000009NameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameShortENIterator.class);
