...
public class IAO_0000009NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameListZHIterator.class);
