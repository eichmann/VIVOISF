...
public class IAO_0000009NameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameOfficialZHIterator.class);
