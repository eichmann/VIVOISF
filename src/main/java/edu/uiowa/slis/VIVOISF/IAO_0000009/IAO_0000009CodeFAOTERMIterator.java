...
public class IAO_0000009CodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CodeFAOTERMIterator.class);
