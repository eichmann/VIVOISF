...
public class IAO_0000009NameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameListESIterator.class);
