...
public class IAO_0000009CodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CodeAGROVOCIterator.class);
