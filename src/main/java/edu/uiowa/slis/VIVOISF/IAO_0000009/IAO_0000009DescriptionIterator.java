...
public class IAO_0000009DescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009DescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009DescriptionIterator.class);
