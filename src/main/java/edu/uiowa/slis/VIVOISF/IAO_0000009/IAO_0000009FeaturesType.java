...
public class IAO_0000009FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009FeaturesIterator.getType());
		} catch (Exception e) {
