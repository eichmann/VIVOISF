...
public class IAO_0000009NameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameShortITIterator.class);
