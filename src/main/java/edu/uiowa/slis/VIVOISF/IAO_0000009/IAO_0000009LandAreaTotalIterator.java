...
public class IAO_0000009LandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009LandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009LandAreaTotalIterator.class);
