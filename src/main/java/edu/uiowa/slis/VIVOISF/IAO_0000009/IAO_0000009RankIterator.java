...
public class IAO_0000009RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009RankIterator.class);
