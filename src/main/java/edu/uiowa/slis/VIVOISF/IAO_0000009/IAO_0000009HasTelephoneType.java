...
public class IAO_0000009HasTelephoneType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HasTelephoneType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HasTelephoneType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009HasTelephoneIterator.getType());
		} catch (Exception e) {
