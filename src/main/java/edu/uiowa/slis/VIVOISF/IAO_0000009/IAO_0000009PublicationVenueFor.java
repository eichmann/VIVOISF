...
public class IAO_0000009PublicationVenueFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009PublicationVenueFor currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009PublicationVenueFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009PublicationVenueForIterator.getPublicationVenueFor());
		} catch (Exception e) {
