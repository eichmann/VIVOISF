...
public class IAO_0000009PopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009PopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009PopulationUnitIterator.class);
