...
public class IAO_0000009NameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameCurrencyESIterator.class);
