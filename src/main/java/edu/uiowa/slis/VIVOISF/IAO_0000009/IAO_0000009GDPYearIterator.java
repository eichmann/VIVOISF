...
public class IAO_0000009GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009GDPYearIterator.class);
