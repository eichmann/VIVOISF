...
public class IAO_0000009RO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009RO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009RO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009RO_0001025Iterator.getType());
		} catch (Exception e) {
