...
public class IAO_0000009NameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameCurrencyITIterator.class);
