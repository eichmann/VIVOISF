...
public class IAO_0000009DateTimeValueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009DateTimeValueType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009DateTimeValueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009DateTimeValueIterator.getType());
		} catch (Exception e) {
