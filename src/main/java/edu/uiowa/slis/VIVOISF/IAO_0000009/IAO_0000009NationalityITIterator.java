...
public class IAO_0000009NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NationalityITIterator.class);
