...
public class IAO_0000009TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009TheAbstractIterator.class);
