...
public class IAO_0000009PopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009PopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009PopulationYearIterator.class);
