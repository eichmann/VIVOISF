...
public class IAO_0000009HasTitle extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HasTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HasTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009HasTitleIterator.getHasTitle());
		} catch (Exception e) {
