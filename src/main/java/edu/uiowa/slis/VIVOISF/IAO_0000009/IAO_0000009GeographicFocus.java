...
public class IAO_0000009GeographicFocus extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009GeographicFocus currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009GeographicFocus.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009GeographicFocusIterator.getGeographicFocus());
		} catch (Exception e) {
