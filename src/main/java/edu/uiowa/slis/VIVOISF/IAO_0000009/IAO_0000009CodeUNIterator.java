...
public class IAO_0000009CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CodeUNIterator.class);
