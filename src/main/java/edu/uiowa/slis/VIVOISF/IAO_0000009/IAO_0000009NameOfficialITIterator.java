...
public class IAO_0000009NameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameOfficialITIterator.class);
