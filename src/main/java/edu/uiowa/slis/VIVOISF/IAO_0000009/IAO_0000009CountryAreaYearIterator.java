...
public class IAO_0000009CountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CountryAreaYearIterator.class);
