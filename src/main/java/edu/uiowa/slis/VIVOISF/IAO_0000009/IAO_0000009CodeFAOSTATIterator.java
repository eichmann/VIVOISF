...
public class IAO_0000009CodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CodeFAOSTATIterator.class);
