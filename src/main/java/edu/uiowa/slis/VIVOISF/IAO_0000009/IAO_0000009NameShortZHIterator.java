...
public class IAO_0000009NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameShortZHIterator.class);
