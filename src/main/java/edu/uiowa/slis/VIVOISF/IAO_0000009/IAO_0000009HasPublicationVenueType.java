...
public class IAO_0000009HasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009HasPublicationVenueIterator.getType());
		} catch (Exception e) {
