...
public class IAO_0000009FreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009FreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009FreetextKeywordIterator.class);
