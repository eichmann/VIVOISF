...
public class IAO_0000009AgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009AgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009AgriculturalAreaUnitIterator.class);
