...
public class IAO_0000009Publisher extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009Publisher currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009Publisher.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009PublisherIterator.getPublisher());
		} catch (Exception e) {
