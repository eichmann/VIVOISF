...
public class IAO_0000009CountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CountryAreaTotalIterator.class);
