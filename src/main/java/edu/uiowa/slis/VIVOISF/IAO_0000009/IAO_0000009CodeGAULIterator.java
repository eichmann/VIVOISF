...
public class IAO_0000009CodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CodeGAULIterator.class);
