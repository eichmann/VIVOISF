...
public class IAO_0000009HasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HasMinLatitudeIterator.class);
