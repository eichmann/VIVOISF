...
public class IAO_0000009HasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009HasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
