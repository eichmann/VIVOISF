...
public class IAO_0000009RO_0002353 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009RO_0002353 currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009RO_0002353.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009RO_0002353Iterator.getRO_0002353());
		} catch (Exception e) {
