...
public class IAO_0000009CodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CodeUNDPIterator.class);
