...
public class IAO_0000009BFO_0000051 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009BFO_0000051 currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009BFO_0000051.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009BFO_0000051Iterator.getBFO_0000051());
		} catch (Exception e) {
