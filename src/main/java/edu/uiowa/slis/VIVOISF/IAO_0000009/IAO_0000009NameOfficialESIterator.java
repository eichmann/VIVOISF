...
public class IAO_0000009NameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameOfficialESIterator.class);
