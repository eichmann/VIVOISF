...
public class IAO_0000009NameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameCurrencyRUIterator.class);
