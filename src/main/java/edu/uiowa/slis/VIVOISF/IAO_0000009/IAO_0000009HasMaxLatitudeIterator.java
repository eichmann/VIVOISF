...
public class IAO_0000009HasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HasMaxLatitudeIterator.class);
