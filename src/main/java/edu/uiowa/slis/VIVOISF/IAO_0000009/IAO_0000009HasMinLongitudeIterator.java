...
public class IAO_0000009HasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009HasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009HasMinLongitudeIterator.class);
