...
public class IAO_0000009NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameListITIterator.class);
