...
public class IAO_0000009RelatedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009RelatedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009RelatedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009RelatedByIterator.getRelatedBy());
		} catch (Exception e) {
