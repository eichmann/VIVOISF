...
public class IAO_0000009NameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameOfficialARIterator.class);
