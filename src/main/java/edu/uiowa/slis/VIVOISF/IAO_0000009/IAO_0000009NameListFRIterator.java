...
public class IAO_0000009NameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameListFRIterator.class);
