...
public class IAO_0000009Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000009TranslatorIterator.getTranslator());
		} catch (Exception e) {
