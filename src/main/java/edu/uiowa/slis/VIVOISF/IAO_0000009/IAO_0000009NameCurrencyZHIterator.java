...
public class IAO_0000009NameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009NameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009NameCurrencyZHIterator.class);
