...
public class IAO_0000009CountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000009CountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000009CountryAreaNotesIterator.class);
