...
public class ClinicalOrganizationRelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalOrganizationRelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalOrganizationRelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalOrganizationRelatedByIterator.getType());
		} catch (Exception e) {
