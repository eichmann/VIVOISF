...
public class ClinicalOrganizationHasEquipmentType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalOrganizationHasEquipmentType currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalOrganizationHasEquipmentType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalOrganizationHasEquipmentIterator.getType());
		} catch (Exception e) {
