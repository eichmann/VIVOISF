...
public class ClinicalOrganizationRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalOrganizationRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalOrganizationRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalOrganizationRO_0000053Iterator.getType());
		} catch (Exception e) {
