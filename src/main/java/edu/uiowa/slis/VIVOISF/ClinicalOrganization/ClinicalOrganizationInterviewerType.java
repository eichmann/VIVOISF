...
public class ClinicalOrganizationInterviewerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalOrganizationInterviewerType currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalOrganizationInterviewerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalOrganizationInterviewerIterator.getType());
		} catch (Exception e) {
