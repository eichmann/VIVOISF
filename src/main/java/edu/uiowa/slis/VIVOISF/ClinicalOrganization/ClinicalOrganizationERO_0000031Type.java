...
public class ClinicalOrganizationERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalOrganizationERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalOrganizationERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalOrganizationERO_0000031Iterator.getType());
		} catch (Exception e) {
