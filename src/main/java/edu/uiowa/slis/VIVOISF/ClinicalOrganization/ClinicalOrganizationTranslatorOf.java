...
public class ClinicalOrganizationTranslatorOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalOrganizationTranslatorOf currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalOrganizationTranslatorOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalOrganizationTranslatorOfIterator.getTranslatorOf());
		} catch (Exception e) {
