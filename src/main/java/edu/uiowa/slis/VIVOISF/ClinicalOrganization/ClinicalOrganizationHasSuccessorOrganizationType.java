...
public class ClinicalOrganizationHasSuccessorOrganizationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalOrganizationHasSuccessorOrganizationType currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalOrganizationHasSuccessorOrganizationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalOrganizationHasSuccessorOrganizationIterator.getType());
		} catch (Exception e) {
