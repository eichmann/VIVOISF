...
public class ClinicalOrganizationHasPredecessorOrganization extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalOrganizationHasPredecessorOrganization currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalOrganizationHasPredecessorOrganization.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalOrganizationHasPredecessorOrganizationIterator.getHasPredecessorOrganization());
		} catch (Exception e) {
