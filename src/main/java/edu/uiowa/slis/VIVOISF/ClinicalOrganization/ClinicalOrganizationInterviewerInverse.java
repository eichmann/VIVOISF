...
public class ClinicalOrganizationInterviewerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalOrganizationInterviewerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalOrganizationInterviewerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalOrganizationInterviewerInverseIterator.getInterviewerInverse());
		} catch (Exception e) {
