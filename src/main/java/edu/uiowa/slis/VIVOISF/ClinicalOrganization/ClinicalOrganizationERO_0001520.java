...
public class ClinicalOrganizationERO_0001520 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ClinicalOrganizationERO_0001520 currentInstance = null;
	private static final Log log = LogFactory.getLog(ClinicalOrganizationERO_0001520.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theClinicalOrganizationERO_0001520Iterator.getERO_0001520());
		} catch (Exception e) {
