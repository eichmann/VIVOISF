...
public class PresentationBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PresentationBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PresentationBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePresentationBFO_0000055Iterator.getType());
		} catch (Exception e) {
