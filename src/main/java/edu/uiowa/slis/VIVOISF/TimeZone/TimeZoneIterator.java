...
public class TimeZoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TimeZoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(TimeZoneIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://www.w3.org/2006/vcard/ns#TimeZone> . "+
