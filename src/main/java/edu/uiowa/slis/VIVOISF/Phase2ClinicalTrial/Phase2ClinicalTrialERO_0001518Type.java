...
public class Phase2ClinicalTrialERO_0001518Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Phase2ClinicalTrialERO_0001518Type currentInstance = null;
	private static final Log log = LogFactory.getLog(Phase2ClinicalTrialERO_0001518Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePhase2ClinicalTrialERO_0001518Iterator.getType());
		} catch (Exception e) {
