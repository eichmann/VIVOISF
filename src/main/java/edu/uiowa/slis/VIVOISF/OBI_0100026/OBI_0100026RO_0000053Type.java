...
public class OBI_0100026RO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0100026RO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0100026RO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0100026RO_0000053Iterator.getType());
		} catch (Exception e) {
