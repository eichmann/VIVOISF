...
public class OBI_0100026Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0100026Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0100026Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.obolibrary.org/obo/OBI_0100026> . "+
