...
public class OBI_0100026RO_0003000Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0100026RO_0003000Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0100026RO_0003000Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0100026RO_0003000Iterator.getType());
		} catch (Exception e) {
