...
public class AwardReceiptRO_0000052 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AwardReceiptRO_0000052 currentInstance = null;
	private static final Log log = LogFactory.getLog(AwardReceiptRO_0000052.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAwardReceiptRO_0000052Iterator.getRO_0000052());
		} catch (Exception e) {
