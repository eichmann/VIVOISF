...
public class CalendarRequestIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CalendarRequestIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CalendarRequestIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(Prefix_1_4+
					" SELECT ?s ?l where { "+
						"?s rdfs:label ?l . "+
						"?s rdf:type <http://www.w3.org/2006/vcard/ns#CalendarRequest> . "+
					"} ORDER BY ?l");
			if(rs.hasNext()) {
