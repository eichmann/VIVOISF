...
public class BFO_0000015HasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015HasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015HasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015HasResearchAreaIterator.getType());
		} catch (Exception e) {
