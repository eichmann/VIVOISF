...
public class BFO_0000015NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameShortRUIterator.class);
