...
public class BFO_0000015NameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameCurrencyENIterator.class);
