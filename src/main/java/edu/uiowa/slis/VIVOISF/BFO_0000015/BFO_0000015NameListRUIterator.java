...
public class BFO_0000015NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameListRUIterator.class);
