...
public class BFO_0000015RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015RankIterator.class);
