...
public class BFO_0000015NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameListENIterator.class);
