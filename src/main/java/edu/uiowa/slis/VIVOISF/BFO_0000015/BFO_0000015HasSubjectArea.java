...
public class BFO_0000015HasSubjectArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015HasSubjectArea currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015HasSubjectArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015HasSubjectAreaIterator.getHasSubjectArea());
		} catch (Exception e) {
