...
public class BFO_0000015RelatedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015RelatedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015RelatedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015RelatedByIterator.getRelatedBy());
		} catch (Exception e) {
