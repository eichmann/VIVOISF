...
public class BFO_0000015BFO_0000055 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015BFO_0000055 currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015BFO_0000055.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015BFO_0000055Iterator.getBFO_0000055());
		} catch (Exception e) {
