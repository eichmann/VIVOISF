...
public class BFO_0000015DateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015DateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015DateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015DateTimeIntervalIterator.getType());
		} catch (Exception e) {
