...
public class BFO_0000015CodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015CodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015CodeUNDPIterator.class);
