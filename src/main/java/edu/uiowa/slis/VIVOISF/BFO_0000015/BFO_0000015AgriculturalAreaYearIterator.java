...
public class BFO_0000015AgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015AgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015AgriculturalAreaYearIterator.class);
