...
public class BFO_0000015NationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NationalityRUIterator.class);
