...
public class BFO_0000015HasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015HasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015HasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015HasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
