...
public class BFO_0000015HasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015HasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015HasMinLongitudeIterator.class);
