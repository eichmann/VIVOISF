...
public class BFO_0000015LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015LandAreaYearIterator.class);
