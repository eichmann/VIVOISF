...
public class BFO_0000015NameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameShortENIterator.class);
