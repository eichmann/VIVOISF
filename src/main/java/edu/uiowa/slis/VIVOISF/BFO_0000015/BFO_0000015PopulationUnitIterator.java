...
public class BFO_0000015PopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015PopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015PopulationUnitIterator.class);
