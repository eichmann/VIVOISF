...
public class BFO_0000015HDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015HDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015HDIYearIterator.class);
