...
public class BFO_0000015HasURLType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015HasURLType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015HasURLType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015HasURLIterator.getType());
		} catch (Exception e) {
