...
public class BFO_0000015HasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015HasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015HasMaxLatitudeIterator.class);
