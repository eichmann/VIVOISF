...
public class BFO_0000015NameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameShortARIterator.class);
