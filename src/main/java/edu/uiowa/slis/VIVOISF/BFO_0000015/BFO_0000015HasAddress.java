...
public class BFO_0000015HasAddress extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015HasAddress currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015HasAddress.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015HasAddressIterator.getHasAddress());
		} catch (Exception e) {
