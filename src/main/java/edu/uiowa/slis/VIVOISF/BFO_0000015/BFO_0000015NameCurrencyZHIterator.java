...
public class BFO_0000015NameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameCurrencyZHIterator.class);
