...
public class BFO_0000015GeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015GeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015GeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015GeographicFocusIterator.getType());
		} catch (Exception e) {
