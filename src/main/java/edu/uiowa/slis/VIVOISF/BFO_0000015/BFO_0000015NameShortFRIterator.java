...
public class BFO_0000015NameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameShortFRIterator.class);
