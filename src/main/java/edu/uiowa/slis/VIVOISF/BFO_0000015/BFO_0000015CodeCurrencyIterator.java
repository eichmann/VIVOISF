...
public class BFO_0000015CodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015CodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015CodeCurrencyIterator.class);
