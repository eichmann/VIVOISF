...
public class BFO_0000015NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NationalityITIterator.class);
