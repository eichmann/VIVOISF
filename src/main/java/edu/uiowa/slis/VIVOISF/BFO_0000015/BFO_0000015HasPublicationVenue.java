...
public class BFO_0000015HasPublicationVenue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015HasPublicationVenue currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015HasPublicationVenue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015HasPublicationVenueIterator.getHasPublicationVenue());
		} catch (Exception e) {
