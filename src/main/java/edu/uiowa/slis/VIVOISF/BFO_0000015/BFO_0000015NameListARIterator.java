...
public class BFO_0000015NameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameListARIterator.class);
