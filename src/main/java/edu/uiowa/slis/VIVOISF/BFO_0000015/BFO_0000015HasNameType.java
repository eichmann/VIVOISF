...
public class BFO_0000015HasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015HasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015HasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015HasNameIterator.getType());
		} catch (Exception e) {
