...
public class BFO_0000015NameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameCurrencyITIterator.class);
