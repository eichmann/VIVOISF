...
public class BFO_0000015Relates extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015Relates currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015Relates.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000015RelatesIterator.getRelates());
		} catch (Exception e) {
