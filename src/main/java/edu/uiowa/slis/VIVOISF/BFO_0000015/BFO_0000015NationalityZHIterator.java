...
public class BFO_0000015NationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NationalityZHIterator.class);
