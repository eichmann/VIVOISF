...
public class BFO_0000015PopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015PopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015PopulationYearIterator.class);
