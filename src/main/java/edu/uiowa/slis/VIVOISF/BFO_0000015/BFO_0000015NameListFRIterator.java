...
public class BFO_0000015NameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameListFRIterator.class);
