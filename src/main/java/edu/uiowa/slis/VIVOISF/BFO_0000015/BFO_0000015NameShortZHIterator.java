...
public class BFO_0000015NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015NameShortZHIterator.class);
