...
public class BFO_0000015GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015GDPYearIterator.class);
