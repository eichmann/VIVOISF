...
public class BFO_0000015CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000015CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000015CodeUNIterator.class);
