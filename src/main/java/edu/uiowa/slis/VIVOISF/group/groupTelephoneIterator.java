...
public class groupTelephoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupTelephoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupTelephoneIterator.class);
