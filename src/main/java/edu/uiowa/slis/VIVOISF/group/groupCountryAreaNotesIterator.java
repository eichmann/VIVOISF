...
public class groupCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupCountryAreaNotesIterator.class);
