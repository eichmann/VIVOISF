...
public class groupPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupPopulationNotesIterator.class);
