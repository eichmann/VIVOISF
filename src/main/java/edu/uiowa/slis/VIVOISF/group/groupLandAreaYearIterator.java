...
public class groupLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupLandAreaYearIterator.class);
