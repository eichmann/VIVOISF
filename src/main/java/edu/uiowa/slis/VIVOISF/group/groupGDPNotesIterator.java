...
public class groupGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupGDPNotesIterator.class);
