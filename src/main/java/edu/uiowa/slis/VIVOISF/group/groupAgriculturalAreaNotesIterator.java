...
public class groupAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupAgriculturalAreaNotesIterator.class);
