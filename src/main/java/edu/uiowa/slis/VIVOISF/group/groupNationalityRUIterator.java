...
public class groupNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNationalityRUIterator.class);
