...
public class groupGeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupGeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(groupGeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegroupGeographicFocusIterator.getType());
		} catch (Exception e) {
