...
public class groupRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(groupRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegroupRO_0002234Iterator.getType());
		} catch (Exception e) {
