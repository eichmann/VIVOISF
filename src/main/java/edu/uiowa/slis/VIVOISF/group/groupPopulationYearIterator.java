...
public class groupPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupPopulationYearIterator.class);
