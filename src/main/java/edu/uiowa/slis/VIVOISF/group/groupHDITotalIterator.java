...
public class groupHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHDITotalIterator.class);
