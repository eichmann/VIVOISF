...
public class groupNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNationalityARIterator.class);
