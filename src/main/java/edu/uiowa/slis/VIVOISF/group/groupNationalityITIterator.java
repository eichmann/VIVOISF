...
public class groupNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNationalityITIterator.class);
