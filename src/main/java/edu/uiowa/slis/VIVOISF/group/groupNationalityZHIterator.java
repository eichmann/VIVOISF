...
public class groupNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNationalityZHIterator.class);
