...
public class groupLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupLandAreaUnitIterator.class);
