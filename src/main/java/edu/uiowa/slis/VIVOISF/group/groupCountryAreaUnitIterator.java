...
public class groupCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupCountryAreaUnitIterator.class);
