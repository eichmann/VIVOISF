...
public class groupNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNationalityENIterator.class);
