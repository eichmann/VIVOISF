...
public class groupHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHDINotesIterator.class);
