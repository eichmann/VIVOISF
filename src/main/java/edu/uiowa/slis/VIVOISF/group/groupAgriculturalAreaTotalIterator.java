...
public class groupAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupAgriculturalAreaTotalIterator.class);
