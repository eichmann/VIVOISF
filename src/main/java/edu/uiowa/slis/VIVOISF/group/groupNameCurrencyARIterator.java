...
public class groupNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNameCurrencyARIterator.class);
