...
public class groupLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupLandAreaNotesIterator.class);
