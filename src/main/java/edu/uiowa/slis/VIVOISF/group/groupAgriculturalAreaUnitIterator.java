...
public class groupAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupAgriculturalAreaUnitIterator.class);
