...
public class groupHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHasMinLatitudeIterator.class);
