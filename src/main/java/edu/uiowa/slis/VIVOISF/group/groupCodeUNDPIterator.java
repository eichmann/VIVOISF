...
public class groupCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupCodeUNDPIterator.class);
