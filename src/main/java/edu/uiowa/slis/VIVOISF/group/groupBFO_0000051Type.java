...
public class groupBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(groupBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegroupBFO_0000051Iterator.getType());
		} catch (Exception e) {
