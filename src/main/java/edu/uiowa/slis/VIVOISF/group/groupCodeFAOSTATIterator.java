...
public class groupCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupCodeFAOSTATIterator.class);
