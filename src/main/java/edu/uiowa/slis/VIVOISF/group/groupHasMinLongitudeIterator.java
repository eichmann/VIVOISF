...
public class groupHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHasMinLongitudeIterator.class);
