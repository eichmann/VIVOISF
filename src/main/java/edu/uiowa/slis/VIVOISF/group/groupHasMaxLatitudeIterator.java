...
public class groupHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHasMaxLatitudeIterator.class);
