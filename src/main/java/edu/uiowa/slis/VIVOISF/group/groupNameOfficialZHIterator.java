...
public class groupNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNameOfficialZHIterator.class);
