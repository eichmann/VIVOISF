...
public class groupNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNameCurrencyZHIterator.class);
