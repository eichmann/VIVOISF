...
public class groupPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupPopulationTotalIterator.class);
