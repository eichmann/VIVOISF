...
public class groupCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupCodeISO3Iterator.class);
