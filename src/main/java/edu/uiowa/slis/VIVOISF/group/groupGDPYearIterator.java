...
public class groupGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupGDPYearIterator.class);
