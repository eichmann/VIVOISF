...
public class groupNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNameCurrencyRUIterator.class);
