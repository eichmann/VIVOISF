...
public class groupDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupDescriptionIterator.class);
