...
public class groupCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupCodeGAULIterator.class);
