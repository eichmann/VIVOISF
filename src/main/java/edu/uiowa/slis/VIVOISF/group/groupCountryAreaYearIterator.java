...
public class groupCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupCountryAreaYearIterator.class);
