...
public class groupHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHDIYearIterator.class);
