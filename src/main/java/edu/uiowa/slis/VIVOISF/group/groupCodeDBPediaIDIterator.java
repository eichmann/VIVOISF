...
public class groupCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupCodeDBPediaIDIterator.class);
