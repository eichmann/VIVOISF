...
public class groupCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupCodeCurrencyIterator.class);
