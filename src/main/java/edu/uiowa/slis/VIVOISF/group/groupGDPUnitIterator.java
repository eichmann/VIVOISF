...
public class groupGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupGDPUnitIterator.class);
