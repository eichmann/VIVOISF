...
public class groupHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHasMaxLongitudeIterator.class);
