...
public class groupNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNameCurrencyITIterator.class);
