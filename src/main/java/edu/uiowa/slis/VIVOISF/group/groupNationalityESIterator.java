...
public class groupNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNationalityESIterator.class);
