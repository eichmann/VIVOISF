...
public class groupNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNationalityFRIterator.class);
