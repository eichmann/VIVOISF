...
public class groupNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNameShortENIterator.class);
