...
public class groupNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNameCurrencyFRIterator.class);
