...
public class groupAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupAgriculturalAreaYearIterator.class);
