...
public class groupHasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegroupHasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
