...
public class groupNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNameShortARIterator.class);
