...
public class groupNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNameCurrencyESIterator.class);
