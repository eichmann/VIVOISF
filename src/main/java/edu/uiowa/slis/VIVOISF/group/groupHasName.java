...
public class groupHasName extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupHasName currentInstance = null;
	private static final Log log = LogFactory.getLog(groupHasName.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thegroupHasNameIterator.getHasName());
		} catch (Exception e) {
