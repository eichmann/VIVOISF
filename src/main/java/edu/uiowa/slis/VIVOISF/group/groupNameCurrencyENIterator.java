...
public class groupNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupNameCurrencyENIterator.class);
