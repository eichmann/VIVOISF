...
public class groupCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static groupCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(groupCountryAreaTotalIterator.class);
