...
public class IAO_0000109TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000109TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000109TheAbstractIterator.class);
