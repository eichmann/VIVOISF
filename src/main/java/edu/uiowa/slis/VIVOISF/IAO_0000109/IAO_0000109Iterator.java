...
public class IAO_0000109Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000109Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000109Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(Prefix_1_4+
					" SELECT ?s ?l where { "+
						"?s rdfs:label ?l . "+
						"?s rdf:type <http://purl.obolibrary.org/obo/IAO_0000109> . "+
					"} ORDER BY ?l");
			if(rs.hasNext()) {
