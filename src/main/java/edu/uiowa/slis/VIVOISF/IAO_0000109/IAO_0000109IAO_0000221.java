...
public class IAO_0000109IAO_0000221 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000109IAO_0000221 currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000109IAO_0000221.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000109IAO_0000221Iterator.getIAO_0000221());
		} catch (Exception e) {
