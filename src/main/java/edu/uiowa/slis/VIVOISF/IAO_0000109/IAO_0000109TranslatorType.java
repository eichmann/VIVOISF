...
public class IAO_0000109TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000109TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000109TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000109TranslatorIterator.getType());
		} catch (Exception e) {
