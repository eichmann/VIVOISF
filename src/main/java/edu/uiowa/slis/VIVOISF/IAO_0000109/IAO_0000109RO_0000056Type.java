...
public class IAO_0000109RO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000109RO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000109RO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000109RO_0000056Iterator.getType());
		} catch (Exception e) {
