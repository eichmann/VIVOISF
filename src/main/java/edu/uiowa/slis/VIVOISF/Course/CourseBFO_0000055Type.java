...
public class CourseBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourseBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CourseBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCourseBFO_0000055Iterator.getType());
		} catch (Exception e) {
