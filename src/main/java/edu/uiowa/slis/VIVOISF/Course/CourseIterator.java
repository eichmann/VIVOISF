...
public class CourseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CourseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CourseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Course> . "+
			...
			log.error("Exception raised in CourseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CourseIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in CourseIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CourseIterator doAfterBody");
		}
