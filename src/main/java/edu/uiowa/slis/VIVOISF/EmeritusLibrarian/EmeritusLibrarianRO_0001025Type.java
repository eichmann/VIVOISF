...
public class EmeritusLibrarianRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusLibrarianRO_0001025Iterator.getType());
		} catch (Exception e) {
