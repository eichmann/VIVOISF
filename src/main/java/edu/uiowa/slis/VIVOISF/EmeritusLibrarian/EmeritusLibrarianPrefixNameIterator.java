...
public class EmeritusLibrarianPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianPrefixNameIterator.class);
