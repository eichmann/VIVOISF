...
public class EmeritusLibrarianARG_0000172Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianARG_0000172Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianARG_0000172Iterator.class);
