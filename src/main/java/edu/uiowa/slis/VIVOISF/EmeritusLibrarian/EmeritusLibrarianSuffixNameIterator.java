...
public class EmeritusLibrarianSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianSuffixNameIterator.class);
