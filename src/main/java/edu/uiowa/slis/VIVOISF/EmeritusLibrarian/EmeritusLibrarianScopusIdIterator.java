...
public class EmeritusLibrarianScopusIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianScopusIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianScopusIdIterator.class);
