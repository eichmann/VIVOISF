...
public class EmeritusLibrarianARG_0000197Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianARG_0000197Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianARG_0000197Iterator.class);
