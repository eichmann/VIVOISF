...
public class EmeritusLibrarianIntervieweeInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianIntervieweeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianIntervieweeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EmeritusLibrarianIntervieweeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EmeritusLibrarianIntervieweeInverseIterator doStartTag");
		}
