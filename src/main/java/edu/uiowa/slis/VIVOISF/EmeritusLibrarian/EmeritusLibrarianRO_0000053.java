...
public class EmeritusLibrarianRO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianRO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianRO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusLibrarianRO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
