...
public class EmeritusLibrarianRO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		try {
			EmeritusLibrarianRO_0001025Iterator theEmeritusLibrarian = (EmeritusLibrarianRO_0001025Iterator)findAncestorWithClass(this, EmeritusLibrarianRO_0001025Iterator.class);
			pageContext.getOut().print(theEmeritusLibrarian.getRO_0001025());
		} catch (Exception e) {
