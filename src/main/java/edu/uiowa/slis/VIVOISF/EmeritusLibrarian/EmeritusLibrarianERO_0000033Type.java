...
public class EmeritusLibrarianERO_0000033Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianERO_0000033Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianERO_0000033Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusLibrarianERO_0000033Iterator.getType());
		} catch (Exception e) {
