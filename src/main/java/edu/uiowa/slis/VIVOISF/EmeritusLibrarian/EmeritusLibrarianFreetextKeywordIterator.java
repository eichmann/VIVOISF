...
public class EmeritusLibrarianFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianFreetextKeywordIterator.class);
