...
public class EmeritusLibrarianERACommonsIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianERACommonsIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianERACommonsIdIterator.class);
