...
public class EmeritusLibrarianARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusLibrarianARG_2000028Iterator.getType());
		} catch (Exception e) {
