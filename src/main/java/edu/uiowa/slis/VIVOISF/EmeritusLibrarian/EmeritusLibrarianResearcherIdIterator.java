...
public class EmeritusLibrarianResearcherIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusLibrarianResearcherIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusLibrarianResearcherIdIterator.class);
