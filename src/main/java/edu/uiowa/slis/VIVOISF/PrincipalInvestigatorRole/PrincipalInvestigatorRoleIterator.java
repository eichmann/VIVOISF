...
public class PrincipalInvestigatorRoleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrincipalInvestigatorRoleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PrincipalInvestigatorRoleIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#PrincipalInvestigatorRole> . "+
			...
			log.error("Exception raised in PrincipalInvestigatorRoleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PrincipalInvestigatorRoleIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in PrincipalInvestigatorRoleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PrincipalInvestigatorRoleIterator doAfterBody");
		}
