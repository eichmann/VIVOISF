...
public class PrincipalInvestigatorRoleRO_0000052 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PrincipalInvestigatorRoleRO_0000052 currentInstance = null;
	private static final Log log = LogFactory.getLog(PrincipalInvestigatorRoleRO_0000052.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePrincipalInvestigatorRoleRO_0000052Iterator.getRO_0000052());
		} catch (Exception e) {
