...
public class areaMiddleNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaMiddleNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaMiddleNameIterator.class);
