...
public class areaHasOfficialNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaHasOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaHasOfficialNameIterator.class);
