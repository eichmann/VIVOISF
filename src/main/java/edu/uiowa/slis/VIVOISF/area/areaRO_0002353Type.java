...
public class areaRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(areaRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theareaRO_0002353Iterator.getType());
		} catch (Exception e) {
