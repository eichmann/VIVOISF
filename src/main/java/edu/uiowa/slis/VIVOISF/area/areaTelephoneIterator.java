...
public class areaTelephoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaTelephoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaTelephoneIterator.class);
