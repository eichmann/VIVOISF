...
public class areaHasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaHasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(areaHasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theareaHasPublicationVenueIterator.getType());
		} catch (Exception e) {
