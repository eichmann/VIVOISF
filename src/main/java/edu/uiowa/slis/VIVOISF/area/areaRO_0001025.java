...
public class areaRO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaRO_0001025 currentInstance = null;
	private static final Log log = LogFactory.getLog(areaRO_0001025.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theareaRO_0001025Iterator.getRO_0001025());
		} catch (Exception e) {
