...
public class areaValidUntilIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaValidUntilIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaValidUntilIterator.class);
