...
public class areaHasShortNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaHasShortNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaHasShortNameIterator.class);
