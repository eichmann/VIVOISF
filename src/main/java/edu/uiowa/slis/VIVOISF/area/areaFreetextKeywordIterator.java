...
public class areaFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaFreetextKeywordIterator.class);
