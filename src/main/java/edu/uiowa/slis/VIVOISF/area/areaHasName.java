...
public class areaHasName extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaHasName currentInstance = null;
	private static final Log log = LogFactory.getLog(areaHasName.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theareaHasNameIterator.getHasName());
		} catch (Exception e) {
