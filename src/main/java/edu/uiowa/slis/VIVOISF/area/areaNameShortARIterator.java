...
public class areaNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaNameShortARIterator.class);
