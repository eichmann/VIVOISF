...
public class areaDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaDescriptionIterator.class);
