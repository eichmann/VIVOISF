...
public class areaBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(areaBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theareaBFO_0000051Iterator.getType());
		} catch (Exception e) {
