...
public class areaCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaCodeUNIterator.class);
