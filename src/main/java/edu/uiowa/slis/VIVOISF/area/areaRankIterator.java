...
public class areaRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaRankIterator.class);
