...
public class areaNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaNameCurrencyENIterator.class);
