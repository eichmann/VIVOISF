...
public class areaCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaCodeISO3Iterator.class);
