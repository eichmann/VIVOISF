...
public class areaValidSinceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaValidSinceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaValidSinceIterator.class);
