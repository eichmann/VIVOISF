...
public class areaIAO_0000115Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaIAO_0000115Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaIAO_0000115Iterator.class);
