...
public class areaHasListNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaHasListNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaHasListNameIterator.class);
