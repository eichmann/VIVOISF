...
public class areaTopDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaTopDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaTopDataPropertyIterator.class);
