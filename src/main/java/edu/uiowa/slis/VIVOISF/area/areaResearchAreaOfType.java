...
public class areaResearchAreaOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaResearchAreaOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(areaResearchAreaOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theareaResearchAreaOfIterator.getType());
		} catch (Exception e) {
