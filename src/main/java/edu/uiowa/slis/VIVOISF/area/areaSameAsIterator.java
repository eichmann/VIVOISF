...
public class areaSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaSameAsIterator.class);
