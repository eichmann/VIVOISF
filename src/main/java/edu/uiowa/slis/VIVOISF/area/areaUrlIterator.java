...
public class areaUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaUrlIterator.class);
