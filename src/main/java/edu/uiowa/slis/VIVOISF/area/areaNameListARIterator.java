...
public class areaNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static areaNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(areaNameListARIterator.class);
