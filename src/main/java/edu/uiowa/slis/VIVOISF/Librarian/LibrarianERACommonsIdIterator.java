...
public class LibrarianERACommonsIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianERACommonsIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianERACommonsIdIterator.class);
