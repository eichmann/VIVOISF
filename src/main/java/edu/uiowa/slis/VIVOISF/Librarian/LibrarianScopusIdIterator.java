...
public class LibrarianScopusIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianScopusIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianScopusIdIterator.class);
