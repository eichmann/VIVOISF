...
public class LibrarianERO_0000033Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianERO_0000033Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianERO_0000033Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianERO_0000033Iterator.getType());
		} catch (Exception e) {
