...
public class LibrarianRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianRO_0000056Iterator.getType());
		} catch (Exception e) {
