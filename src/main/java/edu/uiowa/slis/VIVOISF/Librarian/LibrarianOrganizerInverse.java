...
public class LibrarianOrganizerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianOrganizerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianOrganizerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianOrganizerInverseIterator.getOrganizerInverse());
		} catch (Exception e) {
