...
public class LibrarianFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianFreetextKeywordIterator.class);
