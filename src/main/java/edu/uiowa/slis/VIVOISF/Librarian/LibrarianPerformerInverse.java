...
public class LibrarianPerformerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianPerformerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianPerformerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianPerformerInverseIterator.getPerformerInverse());
		} catch (Exception e) {
