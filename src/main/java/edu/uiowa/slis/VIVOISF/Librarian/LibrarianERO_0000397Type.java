...
public class LibrarianERO_0000397Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianERO_0000397Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianERO_0000397Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLibrarianERO_0000397Iterator.getType());
		} catch (Exception e) {
