...
public class LibrarianIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Librarian> . "+
