...
public class LibrarianARG_0000172Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LibrarianARG_0000172Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LibrarianARG_0000172Iterator.class);
