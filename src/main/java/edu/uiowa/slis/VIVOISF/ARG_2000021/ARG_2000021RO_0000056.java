...
public class ARG_2000021RO_0000056 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000021RO_0000056 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000021RO_0000056.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000021RO_0000056Iterator.getRO_0000056());
		} catch (Exception e) {
