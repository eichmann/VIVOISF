...
public class AttendingProcessRO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AttendingProcessRO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AttendingProcessRO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAttendingProcessRO_0000057Iterator.getType());
		} catch (Exception e) {
