...
public class NicknameUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NicknameUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NicknameUrlIterator.class);
