...
public class NicknameHasNicknameInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NicknameHasNicknameInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(NicknameHasNicknameInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNicknameHasNicknameInverseIterator.getType());
		} catch (Exception e) {
