...
public class SlideshowIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowIsbn13Iterator.class);
