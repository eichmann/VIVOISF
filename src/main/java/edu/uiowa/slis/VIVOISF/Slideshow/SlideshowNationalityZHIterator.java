...
public class SlideshowNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNationalityZHIterator.class);
