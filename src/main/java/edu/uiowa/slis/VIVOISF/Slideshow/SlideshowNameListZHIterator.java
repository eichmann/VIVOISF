...
public class SlideshowNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameListZHIterator.class);
