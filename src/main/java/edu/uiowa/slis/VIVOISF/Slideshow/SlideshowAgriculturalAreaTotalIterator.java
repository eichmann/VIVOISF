...
public class SlideshowAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowAgriculturalAreaTotalIterator.class);
