...
public class SlideshowPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowPageStartIterator.class);
