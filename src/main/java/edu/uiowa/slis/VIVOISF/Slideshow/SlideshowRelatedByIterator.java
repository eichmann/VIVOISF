...
public class SlideshowRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowRelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowRelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in SlideshowRelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SlideshowRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in SlideshowRelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in SlideshowRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in SlideshowRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in SlideshowRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to SlideshowRelatedByIterator");
