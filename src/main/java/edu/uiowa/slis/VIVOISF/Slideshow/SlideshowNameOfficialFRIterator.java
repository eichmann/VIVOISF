...
public class SlideshowNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameOfficialFRIterator.class);
