...
public class SlideshowCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodenIterator.class);
