...
public class SlideshowNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameShortENIterator.class);
