...
public class SlideshowNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameCurrencyRUIterator.class);
