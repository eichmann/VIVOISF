...
public class SlideshowHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHandleIterator.class);
