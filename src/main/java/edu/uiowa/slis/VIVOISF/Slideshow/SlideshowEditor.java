...
public class SlideshowEditor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowEditor currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowEditor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowEditorIterator.getEditor());
		} catch (Exception e) {
