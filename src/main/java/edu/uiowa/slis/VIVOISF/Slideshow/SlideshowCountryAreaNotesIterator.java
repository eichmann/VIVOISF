...
public class SlideshowCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCountryAreaNotesIterator.class);
