...
public class SlideshowLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowLocatorIterator.class);
