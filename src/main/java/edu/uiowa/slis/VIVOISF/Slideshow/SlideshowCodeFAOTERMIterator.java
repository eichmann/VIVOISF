...
public class SlideshowCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodeFAOTERMIterator.class);
