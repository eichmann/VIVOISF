...
public class SlideshowBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowBFO_0000050Iterator.getType());
		} catch (Exception e) {
