...
public class SlideshowBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowBFO_0000051Iterator.getType());
		} catch (Exception e) {
