...
public class SlideshowNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameCurrencyFRIterator.class);
