...
public class SlideshowNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNumberIterator.class);
