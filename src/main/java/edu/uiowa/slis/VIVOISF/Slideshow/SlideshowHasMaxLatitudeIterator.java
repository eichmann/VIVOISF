...
public class SlideshowHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHasMaxLatitudeIterator.class);
