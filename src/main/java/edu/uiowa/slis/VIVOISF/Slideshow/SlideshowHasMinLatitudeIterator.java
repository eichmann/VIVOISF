...
public class SlideshowHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHasMinLatitudeIterator.class);
