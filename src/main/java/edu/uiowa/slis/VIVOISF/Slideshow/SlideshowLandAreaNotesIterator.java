...
public class SlideshowLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowLandAreaNotesIterator.class);
