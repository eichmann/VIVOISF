...
public class SlideshowNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameOfficialESIterator.class);
