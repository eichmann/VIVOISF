...
public class SlideshowAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowAgriculturalAreaNotesIterator.class);
