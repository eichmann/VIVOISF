...
public class SlideshowGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowGDPUnitIterator.class);
