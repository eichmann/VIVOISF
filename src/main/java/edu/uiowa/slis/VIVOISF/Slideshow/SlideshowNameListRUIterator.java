...
public class SlideshowNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameListRUIterator.class);
