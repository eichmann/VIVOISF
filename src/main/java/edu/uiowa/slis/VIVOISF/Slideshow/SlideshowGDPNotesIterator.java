...
public class SlideshowGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowGDPNotesIterator.class);
