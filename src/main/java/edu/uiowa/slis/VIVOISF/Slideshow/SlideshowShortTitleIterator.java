...
public class SlideshowShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowShortTitleIterator.class);
