...
public class SlideshowIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/Slideshow> . "+
