...
public class SlideshowNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameCurrencyESIterator.class);
