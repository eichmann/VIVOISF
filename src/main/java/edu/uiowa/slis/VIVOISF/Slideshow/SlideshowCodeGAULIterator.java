...
public class SlideshowCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodeGAULIterator.class);
