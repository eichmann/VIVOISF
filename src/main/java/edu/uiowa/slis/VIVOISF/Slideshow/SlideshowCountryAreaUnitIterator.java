...
public class SlideshowCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCountryAreaUnitIterator.class);
