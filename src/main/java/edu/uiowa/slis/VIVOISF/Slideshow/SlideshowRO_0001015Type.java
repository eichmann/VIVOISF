...
public class SlideshowRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowRO_0001015Iterator.getType());
		} catch (Exception e) {
