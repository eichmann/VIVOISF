...
public class SlideshowOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowOclcnumIterator.class);
