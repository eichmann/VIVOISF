...
public class SlideshowNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNationalityFRIterator.class);
