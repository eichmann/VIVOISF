...
public class SlideshowPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowPagesIterator.class);
