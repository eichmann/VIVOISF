...
public class SlideshowCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodeISO2Iterator.class);
