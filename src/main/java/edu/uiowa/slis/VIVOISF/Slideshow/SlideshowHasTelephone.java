...
public class SlideshowHasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowHasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
