...
public class SlideshowAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowAsinIterator.class);
