...
public class SlideshowUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowUrlIterator.class);
