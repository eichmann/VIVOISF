...
public class SlideshowNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameListENIterator.class);
