...
public class SlideshowSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowSectionIterator.class);
