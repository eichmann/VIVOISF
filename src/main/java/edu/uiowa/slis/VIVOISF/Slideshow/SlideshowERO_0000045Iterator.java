...
public class SlideshowERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowERO_0000045Iterator.class);
