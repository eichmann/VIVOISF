...
public class SlideshowSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowSiciIterator.class);
