...
public class SlideshowNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameShortRUIterator.class);
