...
public class SlideshowHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHDITotalIterator.class);
