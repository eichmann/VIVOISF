...
public class SlideshowNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameListFRIterator.class);
