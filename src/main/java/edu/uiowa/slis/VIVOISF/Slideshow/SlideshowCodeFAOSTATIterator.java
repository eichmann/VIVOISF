...
public class SlideshowCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodeFAOSTATIterator.class);
