...
public class SlideshowCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodeISO3Iterator.class);
