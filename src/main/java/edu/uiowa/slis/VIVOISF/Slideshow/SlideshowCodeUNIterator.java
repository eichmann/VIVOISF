...
public class SlideshowCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodeUNIterator.class);
