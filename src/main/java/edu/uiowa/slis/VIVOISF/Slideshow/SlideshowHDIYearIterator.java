...
public class SlideshowHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHDIYearIterator.class);
