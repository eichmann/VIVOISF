...
public class SlideshowPresentedAtType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowPresentedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowPresentedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowPresentedAtIterator.getType());
		} catch (Exception e) {
