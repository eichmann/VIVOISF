...
public class SlideshowNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNationalityARIterator.class);
