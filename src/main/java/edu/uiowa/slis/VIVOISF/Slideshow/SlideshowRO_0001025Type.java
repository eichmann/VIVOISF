...
public class SlideshowRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowRO_0001025Iterator.getType());
		} catch (Exception e) {
