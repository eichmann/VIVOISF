...
public class SlideshowHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHasMinLongitudeIterator.class);
