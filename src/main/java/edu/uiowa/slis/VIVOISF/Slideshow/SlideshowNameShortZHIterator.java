...
public class SlideshowNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameShortZHIterator.class);
