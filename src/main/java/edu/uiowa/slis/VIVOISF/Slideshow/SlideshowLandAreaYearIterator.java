...
public class SlideshowLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowLandAreaYearIterator.class);
