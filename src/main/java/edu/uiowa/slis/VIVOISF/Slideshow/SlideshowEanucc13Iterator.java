...
public class SlideshowEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowEanucc13Iterator.class);
