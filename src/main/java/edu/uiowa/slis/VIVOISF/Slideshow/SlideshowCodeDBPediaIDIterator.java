...
public class SlideshowCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodeDBPediaIDIterator.class);
