...
public class SlideshowPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowPageEndIterator.class);
