...
public class SlideshowRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowRO_0000056Iterator.getType());
		} catch (Exception e) {
