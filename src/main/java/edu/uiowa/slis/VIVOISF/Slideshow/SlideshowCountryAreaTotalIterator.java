...
public class SlideshowCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCountryAreaTotalIterator.class);
