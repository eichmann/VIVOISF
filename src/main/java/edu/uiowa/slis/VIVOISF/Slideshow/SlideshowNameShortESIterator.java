...
public class SlideshowNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameShortESIterator.class);
