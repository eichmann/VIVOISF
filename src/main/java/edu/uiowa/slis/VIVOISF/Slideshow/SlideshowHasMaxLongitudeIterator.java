...
public class SlideshowHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHasMaxLongitudeIterator.class);
