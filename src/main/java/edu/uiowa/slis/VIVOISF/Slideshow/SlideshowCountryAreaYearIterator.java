...
public class SlideshowCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCountryAreaYearIterator.class);
