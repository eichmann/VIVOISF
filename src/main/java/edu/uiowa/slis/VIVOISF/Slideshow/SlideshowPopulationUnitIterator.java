...
public class SlideshowPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowPopulationUnitIterator.class);
