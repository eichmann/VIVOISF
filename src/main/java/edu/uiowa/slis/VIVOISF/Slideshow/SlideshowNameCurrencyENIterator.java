...
public class SlideshowNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameCurrencyENIterator.class);
