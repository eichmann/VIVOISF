...
public class SlideshowContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowContentIterator.class);
