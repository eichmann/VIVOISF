...
public class SlideshowCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodeUNDPIterator.class);
