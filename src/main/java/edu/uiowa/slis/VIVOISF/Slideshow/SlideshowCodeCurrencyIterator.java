...
public class SlideshowCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodeCurrencyIterator.class);
