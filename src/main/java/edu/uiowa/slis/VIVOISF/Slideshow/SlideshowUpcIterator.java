...
public class SlideshowUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowUpcIterator.class);
