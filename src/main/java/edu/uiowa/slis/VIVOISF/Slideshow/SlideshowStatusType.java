...
public class SlideshowStatusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowStatusType currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowStatusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowStatusIterator.getType());
		} catch (Exception e) {
