...
public class SlideshowNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameOfficialENIterator.class);
