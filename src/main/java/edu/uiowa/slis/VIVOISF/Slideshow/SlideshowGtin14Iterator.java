...
public class SlideshowGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowGtin14Iterator.class);
