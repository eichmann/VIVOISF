...
public class SlideshowDocumentationForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowDocumentationForType currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowDocumentationForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowDocumentationForIterator.getType());
		} catch (Exception e) {
