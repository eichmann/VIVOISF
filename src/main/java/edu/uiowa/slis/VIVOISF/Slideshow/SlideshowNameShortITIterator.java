...
public class SlideshowNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameShortITIterator.class);
