...
public class SlideshowIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowIsbn10Iterator.class);
