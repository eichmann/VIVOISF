...
public class SlideshowNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameShortFRIterator.class);
