...
public class SlideshowPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowPopulationTotalIterator.class);
