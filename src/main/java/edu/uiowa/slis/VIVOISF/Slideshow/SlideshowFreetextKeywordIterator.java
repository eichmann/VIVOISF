...
public class SlideshowFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowFreetextKeywordIterator.class);
