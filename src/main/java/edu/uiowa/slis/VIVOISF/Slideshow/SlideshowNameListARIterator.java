...
public class SlideshowNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameListARIterator.class);
