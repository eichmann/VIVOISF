...
public class SlideshowDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowDoiIterator.class);
