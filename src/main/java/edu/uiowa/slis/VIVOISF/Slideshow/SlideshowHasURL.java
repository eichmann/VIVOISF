...
public class SlideshowHasURL extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHasURL currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHasURL.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowHasURLIterator.getHasURL());
		} catch (Exception e) {
