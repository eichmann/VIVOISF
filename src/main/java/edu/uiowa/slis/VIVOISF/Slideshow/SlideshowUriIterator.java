...
public class SlideshowUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowUriIterator.class);
