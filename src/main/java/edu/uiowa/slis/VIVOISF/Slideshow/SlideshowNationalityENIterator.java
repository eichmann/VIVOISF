...
public class SlideshowNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNationalityENIterator.class);
