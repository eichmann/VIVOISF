...
public class SlideshowNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameOfficialZHIterator.class);
