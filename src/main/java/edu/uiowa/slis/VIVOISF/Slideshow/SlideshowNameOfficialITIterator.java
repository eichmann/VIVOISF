...
public class SlideshowNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameOfficialITIterator.class);
