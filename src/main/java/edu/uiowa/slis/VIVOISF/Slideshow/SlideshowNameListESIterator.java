...
public class SlideshowNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameListESIterator.class);
