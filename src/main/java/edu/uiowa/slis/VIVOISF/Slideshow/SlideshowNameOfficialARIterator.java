...
public class SlideshowNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameOfficialARIterator.class);
