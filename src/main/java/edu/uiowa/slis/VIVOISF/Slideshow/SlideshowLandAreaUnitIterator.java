...
public class SlideshowLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowLandAreaUnitIterator.class);
