...
public class SlideshowShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowShortDescriptionIterator.class);
