...
public class SlideshowInformationResourceSupportedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowInformationResourceSupportedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowInformationResourceSupportedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowInformationResourceSupportedByIterator.getType());
		} catch (Exception e) {
