...
public class SlideshowGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowGDPYearIterator.class);
