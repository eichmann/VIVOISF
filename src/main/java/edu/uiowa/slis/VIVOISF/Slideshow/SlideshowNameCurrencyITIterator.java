...
public class SlideshowNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameCurrencyITIterator.class);
