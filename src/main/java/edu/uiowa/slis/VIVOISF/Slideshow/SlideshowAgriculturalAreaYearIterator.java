...
public class SlideshowAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowAgriculturalAreaYearIterator.class);
