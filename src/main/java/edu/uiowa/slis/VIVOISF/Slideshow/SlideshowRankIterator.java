...
public class SlideshowRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowRankIterator.class);
