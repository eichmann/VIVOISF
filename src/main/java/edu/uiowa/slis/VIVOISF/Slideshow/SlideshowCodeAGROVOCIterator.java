...
public class SlideshowCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowCodeAGROVOCIterator.class);
