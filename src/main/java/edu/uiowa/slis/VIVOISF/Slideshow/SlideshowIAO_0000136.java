...
public class SlideshowIAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowIAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowIAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowIAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
