...
public class SlideshowLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowLandAreaTotalIterator.class);
