...
public class SlideshowNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNationalityRUIterator.class);
