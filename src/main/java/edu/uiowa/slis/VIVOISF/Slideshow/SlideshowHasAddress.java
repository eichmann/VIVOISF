...
public class SlideshowHasAddress extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHasAddress currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHasAddress.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowHasAddressIterator.getHasAddress());
		} catch (Exception e) {
