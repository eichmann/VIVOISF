...
public class SlideshowPublicationVenueForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowPublicationVenueForType currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowPublicationVenueForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowPublicationVenueForIterator.getType());
		} catch (Exception e) {
