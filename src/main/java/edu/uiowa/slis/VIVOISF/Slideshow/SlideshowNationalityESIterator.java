...
public class SlideshowNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNationalityESIterator.class);
