...
public class SlideshowNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNumPagesIterator.class);
