...
public class SlideshowHasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowHasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowHasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSlideshowHasPublicationVenueIterator.getType());
		} catch (Exception e) {
