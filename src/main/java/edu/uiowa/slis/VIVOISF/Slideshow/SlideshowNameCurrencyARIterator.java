...
public class SlideshowNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameCurrencyARIterator.class);
