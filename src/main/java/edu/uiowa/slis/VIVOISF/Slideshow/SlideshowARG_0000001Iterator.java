...
public class SlideshowARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowARG_0000001Iterator.class);
