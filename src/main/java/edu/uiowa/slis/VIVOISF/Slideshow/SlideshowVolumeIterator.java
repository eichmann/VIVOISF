...
public class SlideshowVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowVolumeIterator.class);
