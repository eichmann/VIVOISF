...
public class SlideshowPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowPmidIterator.class);
