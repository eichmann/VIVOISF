...
public class SlideshowNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameCurrencyZHIterator.class);
