...
public class SlideshowIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowIdentifierIterator.class);
