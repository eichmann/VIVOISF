...
public class SlideshowPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowPopulationYearIterator.class);
