...
public class SlideshowDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowDescriptionIterator.class);
