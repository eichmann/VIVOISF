...
public class SlideshowNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameListITIterator.class);
