...
public class SlideshowNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameShortARIterator.class);
