...
public class SlideshowNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SlideshowNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SlideshowNameOfficialRUIterator.class);
