...
public class MuseumIssuerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MuseumIssuerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(MuseumIssuerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMuseumIssuerInverseIterator.getIssuerInverse());
		} catch (Exception e) {
