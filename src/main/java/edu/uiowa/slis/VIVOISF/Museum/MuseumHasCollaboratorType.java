...
public class MuseumHasCollaboratorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MuseumHasCollaboratorType currentInstance = null;
	private static final Log log = LogFactory.getLog(MuseumHasCollaboratorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMuseumHasCollaboratorIterator.getType());
		} catch (Exception e) {
