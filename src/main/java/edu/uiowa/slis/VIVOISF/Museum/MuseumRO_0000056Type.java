...
public class MuseumRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MuseumRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(MuseumRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMuseumRO_0000056Iterator.getType());
		} catch (Exception e) {
