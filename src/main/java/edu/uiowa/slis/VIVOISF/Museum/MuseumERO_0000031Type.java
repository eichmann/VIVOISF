...
public class MuseumERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MuseumERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(MuseumERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMuseumERO_0000031Iterator.getType());
		} catch (Exception e) {
