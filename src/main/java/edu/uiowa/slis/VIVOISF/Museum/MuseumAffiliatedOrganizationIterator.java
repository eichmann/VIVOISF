...
public class MuseumAffiliatedOrganizationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MuseumAffiliatedOrganizationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(MuseumAffiliatedOrganizationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in MuseumAffiliatedOrganizationIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in MuseumAffiliatedOrganizationIterator doStartTag");
		}
