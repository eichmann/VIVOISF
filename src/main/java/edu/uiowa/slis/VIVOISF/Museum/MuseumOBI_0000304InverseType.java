...
public class MuseumOBI_0000304InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MuseumOBI_0000304InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(MuseumOBI_0000304InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMuseumOBI_0000304InverseIterator.getType());
		} catch (Exception e) {
