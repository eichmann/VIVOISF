...
public class MuseumAssigneeFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MuseumAssigneeFor currentInstance = null;
	private static final Log log = LogFactory.getLog(MuseumAssigneeFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMuseumAssigneeForIterator.getAssigneeFor());
		} catch (Exception e) {
