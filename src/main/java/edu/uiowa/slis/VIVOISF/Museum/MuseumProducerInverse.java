...
public class MuseumProducerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MuseumProducerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(MuseumProducerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMuseumProducerInverseIterator.getProducerInverse());
		} catch (Exception e) {
