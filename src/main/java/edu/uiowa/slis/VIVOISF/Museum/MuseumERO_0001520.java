...
public class MuseumERO_0001520 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static MuseumERO_0001520 currentInstance = null;
	private static final Log log = LogFactory.getLog(MuseumERO_0001520.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theMuseumERO_0001520Iterator.getERO_0001520());
		} catch (Exception e) {
