...
public class ERO_0000396IAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000396IAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000396IAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000396IAO_0000136Iterator.getType());
		} catch (Exception e) {
