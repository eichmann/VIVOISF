...
public class ERO_0000396TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000396TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000396TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000396TranslatorIterator.getType());
		} catch (Exception e) {
