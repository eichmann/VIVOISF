...
public class ERO_0000396RO_0000056 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000396RO_0000056 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000396RO_0000056.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000396RO_0000056Iterator.getRO_0000056());
		} catch (Exception e) {
