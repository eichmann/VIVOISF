...
public class AttendeeRoleRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AttendeeRoleRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AttendeeRoleRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAttendeeRoleRO_0000052Iterator.getType());
		} catch (Exception e) {
