...
public class AttendeeRoleRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AttendeeRoleRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AttendeeRoleRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAttendeeRoleRO_0000056Iterator.getType());
		} catch (Exception e) {
