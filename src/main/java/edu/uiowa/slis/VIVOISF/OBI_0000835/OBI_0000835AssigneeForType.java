...
public class OBI_0000835AssigneeForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835AssigneeForType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835AssigneeForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835AssigneeForIterator.getType());
		} catch (Exception e) {
