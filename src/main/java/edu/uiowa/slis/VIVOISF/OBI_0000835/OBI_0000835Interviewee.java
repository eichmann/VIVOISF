...
public class OBI_0000835Interviewee extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835Interviewee currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835Interviewee.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835IntervieweeIterator.getInterviewee());
		} catch (Exception e) {
