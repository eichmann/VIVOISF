...
public class OBI_0000835OrganizerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835OrganizerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835OrganizerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835OrganizerInverseIterator.getOrganizerInverse());
		} catch (Exception e) {
