...
public class OBI_0000835OwnerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835OwnerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835OwnerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835OwnerInverseIterator.getType());
		} catch (Exception e) {
