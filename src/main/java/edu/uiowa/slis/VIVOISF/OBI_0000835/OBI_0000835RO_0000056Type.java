...
public class OBI_0000835RO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835RO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835RO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835RO_0000056Iterator.getType());
		} catch (Exception e) {
