...
public class OBI_0000835Interviewer extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835Interviewer currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835Interviewer.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835InterviewerIterator.getInterviewer());
		} catch (Exception e) {
