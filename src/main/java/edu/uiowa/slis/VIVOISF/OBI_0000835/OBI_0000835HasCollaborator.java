...
public class OBI_0000835HasCollaborator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835HasCollaborator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835HasCollaborator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835HasCollaboratorIterator.getHasCollaborator());
		} catch (Exception e) {
