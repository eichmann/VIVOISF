...
public class OBI_0000835DirectorInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835DirectorInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835DirectorInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835DirectorInverseIterator.getType());
		} catch (Exception e) {
