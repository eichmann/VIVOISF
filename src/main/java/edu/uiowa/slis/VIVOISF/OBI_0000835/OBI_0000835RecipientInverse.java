...
public class OBI_0000835RecipientInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835RecipientInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835RecipientInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835RecipientInverseIterator.getRecipientInverse());
		} catch (Exception e) {
