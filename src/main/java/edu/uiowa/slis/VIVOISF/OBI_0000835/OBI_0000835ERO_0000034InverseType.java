...
public class OBI_0000835ERO_0000034InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835ERO_0000034InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835ERO_0000034InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835ERO_0000034InverseIterator.getType());
		} catch (Exception e) {
