...
public class OBI_0000835InterviewerIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835InterviewerIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835InterviewerIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in OBI_0000835InterviewerIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OBI_0000835InterviewerIterator doStartTag");
		}
