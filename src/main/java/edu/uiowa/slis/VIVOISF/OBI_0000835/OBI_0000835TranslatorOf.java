...
public class OBI_0000835TranslatorOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835TranslatorOf currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835TranslatorOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835TranslatorOfIterator.getTranslatorOf());
		} catch (Exception e) {
