...
public class OBI_0000835RO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835RO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835RO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835RO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
