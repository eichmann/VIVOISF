...
public class OBI_0000835InterviewerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000835InterviewerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000835InterviewerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000835InterviewerInverseIterator.getInterviewerInverse());
		} catch (Exception e) {
