...
public class WebsiteTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteTheAbstractIterator.class);
