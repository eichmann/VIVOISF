...
public class WebsiteIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.org/ontology/bibo/Website> . "+
