...
public class WebsiteFeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteFeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteFeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWebsiteFeaturesIterator.getType());
		} catch (Exception e) {
