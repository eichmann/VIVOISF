...
public class WebsiteSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteSiciIterator.class);
