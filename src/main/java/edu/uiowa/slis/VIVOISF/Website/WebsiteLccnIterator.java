...
public class WebsiteLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteLccnIterator.class);
