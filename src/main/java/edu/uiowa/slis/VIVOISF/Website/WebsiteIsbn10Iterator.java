...
public class WebsiteIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteIsbn10Iterator.class);
