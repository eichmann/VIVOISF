...
public class WebsiteIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteIsbn13Iterator.class);
