...
public class WebsiteEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteEanucc13Iterator.class);
