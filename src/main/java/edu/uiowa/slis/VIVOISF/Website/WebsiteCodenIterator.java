...
public class WebsiteCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteCodenIterator.class);
