...
public class WebsiteIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteIdentifierIterator.class);
