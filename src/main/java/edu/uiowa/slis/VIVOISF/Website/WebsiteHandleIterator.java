...
public class WebsiteHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteHandleIterator.class);
