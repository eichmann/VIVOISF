...
public class WebsiteIssnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteIssnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteIssnIterator.class);
