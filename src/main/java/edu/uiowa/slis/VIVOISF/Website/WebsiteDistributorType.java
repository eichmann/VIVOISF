...
public class WebsiteDistributorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteDistributorType currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteDistributorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWebsiteDistributorIterator.getType());
		} catch (Exception e) {
