...
public class WebsitePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsitePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsitePmidIterator.class);
