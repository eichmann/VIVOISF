...
public class WebsiteDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteDoiIterator.class);
