...
public class WebsiteIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theWebsiteIAO_0000136Iterator.getType());
		} catch (Exception e) {
