...
public class WebsiteUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteUriIterator.class);
