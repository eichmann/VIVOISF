...
public class WebsiteOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static WebsiteOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(WebsiteOclcnumIterator.class);
