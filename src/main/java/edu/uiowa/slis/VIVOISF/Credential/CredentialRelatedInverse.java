...
public class CredentialRelatedInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CredentialRelatedInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(CredentialRelatedInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCredentialRelatedInverseIterator.getRelatedInverse());
		} catch (Exception e) {
