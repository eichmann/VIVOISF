...
public class NonAcademicInterviewer extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicInterviewer currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicInterviewer.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicInterviewerIterator.getInterviewer());
		} catch (Exception e) {
