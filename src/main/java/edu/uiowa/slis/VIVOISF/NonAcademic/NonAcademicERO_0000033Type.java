...
public class NonAcademicERO_0000033Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicERO_0000033Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicERO_0000033Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicERO_0000033Iterator.getType());
		} catch (Exception e) {
