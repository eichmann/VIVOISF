...
public class NonAcademicRO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		try {
			NonAcademicRO_0001025Iterator theNonAcademic = (NonAcademicRO_0001025Iterator)findAncestorWithClass(this, NonAcademicRO_0001025Iterator.class);
			pageContext.getOut().print(theNonAcademic.getRO_0001025());
		} catch (Exception e) {
