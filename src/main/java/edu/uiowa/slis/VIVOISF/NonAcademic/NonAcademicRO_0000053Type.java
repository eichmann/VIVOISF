...
public class NonAcademicRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicRO_0000053Iterator.getType());
		} catch (Exception e) {
