...
public class NonAcademicIntervieweeInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicIntervieweeInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicIntervieweeInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicIntervieweeInverseIterator.getIntervieweeInverse());
		} catch (Exception e) {
