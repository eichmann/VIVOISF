...
public class NonAcademicIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#NonAcademic> . "+
