...
public class NonAcademicRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NonAcademicRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(NonAcademicRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonAcademicRO_0001025Iterator.getType());
		} catch (Exception e) {
