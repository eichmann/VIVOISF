...
public class PostdocPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocPrefixNameIterator.class);
