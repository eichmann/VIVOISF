...
public class PostdocARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocARG_2000028Iterator.getType());
		} catch (Exception e) {
