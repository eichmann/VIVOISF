...
public class PostdocRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocRO_0000053Iterator.getType());
		} catch (Exception e) {
