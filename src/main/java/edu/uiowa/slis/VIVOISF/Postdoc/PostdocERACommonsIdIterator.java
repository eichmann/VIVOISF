...
public class PostdocERACommonsIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocERACommonsIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocERACommonsIdIterator.class);
