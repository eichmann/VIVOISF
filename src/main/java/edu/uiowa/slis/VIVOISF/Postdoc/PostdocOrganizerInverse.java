...
public class PostdocOrganizerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocOrganizerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocOrganizerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocOrganizerInverseIterator.getOrganizerInverse());
		} catch (Exception e) {
