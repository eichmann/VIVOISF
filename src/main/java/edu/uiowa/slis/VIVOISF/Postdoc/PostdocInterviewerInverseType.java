...
public class PostdocInterviewerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocInterviewerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocInterviewerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocInterviewerInverseIterator.getType());
		} catch (Exception e) {
