...
public class PostdocFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocFreetextKeywordIterator.class);
