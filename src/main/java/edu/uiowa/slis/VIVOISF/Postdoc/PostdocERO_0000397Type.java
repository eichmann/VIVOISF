...
public class PostdocERO_0000397Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocERO_0000397Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocERO_0000397Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocERO_0000397Iterator.getType());
		} catch (Exception e) {
