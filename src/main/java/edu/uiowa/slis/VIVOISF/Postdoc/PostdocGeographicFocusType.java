...
public class PostdocGeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocGeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocGeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocGeographicFocusIterator.getType());
		} catch (Exception e) {
