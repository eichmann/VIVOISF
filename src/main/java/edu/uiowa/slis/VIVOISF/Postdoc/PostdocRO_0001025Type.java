...
public class PostdocRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePostdocRO_0001025Iterator.getType());
		} catch (Exception e) {
