...
public class PostdocIntervieweeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocIntervieweeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocIntervieweeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PostdocIntervieweeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PostdocIntervieweeIterator doStartTag");
		}
