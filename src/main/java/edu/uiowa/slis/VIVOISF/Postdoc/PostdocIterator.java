...
public class PostdocIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Postdoc> . "+
