...
public class PostdocRO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		try {
			PostdocRO_0001025Iterator thePostdoc = (PostdocRO_0001025Iterator)findAncestorWithClass(this, PostdocRO_0001025Iterator.class);
			pageContext.getOut().print(thePostdoc.getRO_0001025());
		} catch (Exception e) {
