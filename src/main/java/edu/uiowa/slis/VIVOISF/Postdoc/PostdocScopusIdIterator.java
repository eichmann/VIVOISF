...
public class PostdocScopusIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdocScopusIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdocScopusIdIterator.class);
