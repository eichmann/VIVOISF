...
public class DefinitionTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DefinitionTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DefinitionTheAbstractIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			Definition ancestorInstance = (Definition) findAncestorWithClass(this, Definition.class);
