...
public class DefinitionFeatures extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DefinitionFeatures currentInstance = null;
	private static final Log log = LogFactory.getLog(DefinitionFeatures.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDefinitionFeaturesIterator.getFeatures());
		} catch (Exception e) {
