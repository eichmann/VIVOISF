...
public class DefinitionDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DefinitionDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DefinitionDoiIterator.class);
