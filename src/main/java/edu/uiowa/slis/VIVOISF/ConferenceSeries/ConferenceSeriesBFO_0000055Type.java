...
public class ConferenceSeriesBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceSeriesBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceSeriesBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferenceSeriesBFO_0000055Iterator.getType());
		} catch (Exception e) {
