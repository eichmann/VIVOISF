...
public class IAO_0000144DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000144DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000144DoiIterator.class);
