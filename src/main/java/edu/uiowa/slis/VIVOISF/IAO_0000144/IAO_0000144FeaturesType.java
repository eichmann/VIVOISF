...
public class IAO_0000144FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000144FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000144FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000144FeaturesIterator.getType());
		} catch (Exception e) {
