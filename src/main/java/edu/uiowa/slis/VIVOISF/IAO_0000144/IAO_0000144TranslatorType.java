...
public class IAO_0000144TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000144TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000144TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000144TranslatorIterator.getType());
		} catch (Exception e) {
