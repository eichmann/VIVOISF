...
public class OBI_0001554Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0001554Features currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0001554Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0001554FeaturesIterator.getFeatures());
		} catch (Exception e) {
