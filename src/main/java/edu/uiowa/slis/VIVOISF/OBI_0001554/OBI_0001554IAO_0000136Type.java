...
public class OBI_0001554IAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0001554IAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0001554IAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0001554IAO_0000136Iterator.getType());
		} catch (Exception e) {
