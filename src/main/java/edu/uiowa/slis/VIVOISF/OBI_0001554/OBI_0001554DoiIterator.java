...
public class OBI_0001554DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0001554DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0001554DoiIterator.class);
