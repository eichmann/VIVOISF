...
public class OBI_0001554IAO_0000136Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(OBI_0001554IAO_0000136Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OBI_0001554IAO_0000136Iterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OBI_0001554IAO_0000136Iterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in OBI_0001554IAO_0000136 doEndTag", e);
			throw new JspTagException("Exception raised in OBI_0001554IAO_0000136 doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
