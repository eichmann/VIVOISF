...
public class OutreachProviderRoleRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OutreachProviderRoleRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OutreachProviderRoleRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOutreachProviderRoleRO_0000056Iterator.getType());
		} catch (Exception e) {
