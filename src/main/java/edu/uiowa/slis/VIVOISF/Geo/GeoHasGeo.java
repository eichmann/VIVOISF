...
public class GeoHasGeo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeoHasGeo currentInstance = null;
	private static final Log log = LogFactory.getLog(GeoHasGeo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeoHasGeoIterator.getHasGeo());
		} catch (Exception e) {
