...
public class GeoHasGeoInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeoHasGeoInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(GeoHasGeoInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeoHasGeoInverseIterator.getType());
		} catch (Exception e) {
