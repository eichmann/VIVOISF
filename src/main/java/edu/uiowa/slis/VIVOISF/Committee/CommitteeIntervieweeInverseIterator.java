...
public class CommitteeIntervieweeInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommitteeIntervieweeInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommitteeIntervieweeInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CommitteeIntervieweeInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CommitteeIntervieweeInverseIterator doStartTag");
		}
