...
public class CommitteeHasCollaboratorInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommitteeHasCollaboratorInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(CommitteeHasCollaboratorInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCommitteeHasCollaboratorInverseIterator.getType());
		} catch (Exception e) {
