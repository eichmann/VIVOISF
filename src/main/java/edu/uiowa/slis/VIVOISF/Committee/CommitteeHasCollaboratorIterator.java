...
public class CommitteeHasCollaboratorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommitteeHasCollaboratorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CommitteeHasCollaboratorIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CommitteeHasCollaboratorIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CommitteeHasCollaboratorIterator doStartTag");
		}
