...
public class CommitteeRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommitteeRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CommitteeRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCommitteeRO_0000053Iterator.getType());
		} catch (Exception e) {
