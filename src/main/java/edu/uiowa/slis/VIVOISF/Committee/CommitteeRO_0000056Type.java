...
public class CommitteeRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CommitteeRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CommitteeRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCommitteeRO_0000056Iterator.getType());
		} catch (Exception e) {
