...
public class PersonAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonAgriculturalAreaUnitIterator.class);
