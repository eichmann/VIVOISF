...
public class PersonNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNationalityFRIterator.class);
