...
public class PersonNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNationalityESIterator.class);
