...
public class PersonHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonHasMinLongitudeIterator.class);
