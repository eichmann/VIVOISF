...
public class PersonNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNationalityRUIterator.class);
