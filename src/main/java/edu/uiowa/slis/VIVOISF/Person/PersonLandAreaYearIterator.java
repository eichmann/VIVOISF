...
public class PersonLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonLandAreaYearIterator.class);
