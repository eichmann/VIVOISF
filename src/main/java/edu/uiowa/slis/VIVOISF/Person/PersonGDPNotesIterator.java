...
public class PersonGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonGDPNotesIterator.class);
