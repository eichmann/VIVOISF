...
public class PersonBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonBFO_0000051Iterator.getType());
		} catch (Exception e) {
