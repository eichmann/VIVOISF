...
public class PersonPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonPopulationNotesIterator.class);
