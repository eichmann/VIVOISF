...
public class PersonLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonLandAreaUnitIterator.class);
