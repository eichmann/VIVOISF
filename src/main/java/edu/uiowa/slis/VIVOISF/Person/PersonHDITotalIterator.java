...
public class PersonHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonHDITotalIterator.class);
