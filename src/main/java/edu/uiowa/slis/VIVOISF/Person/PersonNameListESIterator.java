...
public class PersonNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameListESIterator.class);
