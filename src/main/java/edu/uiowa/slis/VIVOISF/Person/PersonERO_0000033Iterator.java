...
public class PersonERO_0000033Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(PersonERO_0000033Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PersonERO_0000033Iterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PersonERO_0000033Iterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PersonERO_0000033 doEndTag", e);
			throw new JspTagException("Exception raised in PersonERO_0000033 doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
