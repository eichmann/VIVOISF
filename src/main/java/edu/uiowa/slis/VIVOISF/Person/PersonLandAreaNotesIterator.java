...
public class PersonLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonLandAreaNotesIterator.class);
