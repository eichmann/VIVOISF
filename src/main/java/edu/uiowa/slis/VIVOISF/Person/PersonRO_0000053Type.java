...
public class PersonRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonRO_0000053Iterator.getType());
		} catch (Exception e) {
