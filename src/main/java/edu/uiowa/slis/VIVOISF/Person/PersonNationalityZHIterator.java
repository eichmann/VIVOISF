...
public class PersonNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNationalityZHIterator.class);
