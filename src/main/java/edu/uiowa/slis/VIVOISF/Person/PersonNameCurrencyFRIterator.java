...
public class PersonNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameCurrencyFRIterator.class);
