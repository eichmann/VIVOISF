...
public class PersonRO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		try {
			PersonRO_0001025Iterator thePerson = (PersonRO_0001025Iterator)findAncestorWithClass(this, PersonRO_0001025Iterator.class);
			pageContext.getOut().print(thePerson.getRO_0001025());
		} catch (Exception e) {
