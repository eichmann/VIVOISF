...
public class PersonARG_0000172Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonARG_0000172Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonARG_0000172Iterator.class);
