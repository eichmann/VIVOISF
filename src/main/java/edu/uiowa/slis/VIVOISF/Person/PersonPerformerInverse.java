...
public class PersonPerformerInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonPerformerInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonPerformerInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonPerformerInverseIterator.getPerformerInverse());
		} catch (Exception e) {
