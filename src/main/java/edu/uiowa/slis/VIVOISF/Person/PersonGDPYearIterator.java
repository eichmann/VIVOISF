...
public class PersonGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonGDPYearIterator.class);
