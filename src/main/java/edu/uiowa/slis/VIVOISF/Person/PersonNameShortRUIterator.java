...
public class PersonNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameShortRUIterator.class);
