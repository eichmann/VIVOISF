...
public class Person extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (this.getParent() instanceof edu.uiowa.slis.VIVOISF.Thing.ThingOrcidIdInverseIterator) {
				subjectURI = ((edu.uiowa.slis.VIVOISF.Thing.ThingOrcidIdInverseIterator)this.getParent()).getOrcidIdInverse();
			}
			...
			if (thePersonIterator == null && subjectURI == null) {
				...
				+ " SELECT ?label ?foafName ?schemaName ?rdfValue  ?teachingOverview ?outreachOverview ?researchOverview ?teachingOverview ?outreachOverview ?researchOverview ?overview where {"
