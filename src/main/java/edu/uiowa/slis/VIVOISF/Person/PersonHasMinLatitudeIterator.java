...
public class PersonHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonHasMinLatitudeIterator.class);
