...
public class PersonCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCodeCurrencyIterator.class);
