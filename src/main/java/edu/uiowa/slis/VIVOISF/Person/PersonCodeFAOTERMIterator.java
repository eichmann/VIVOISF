...
public class PersonCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCodeFAOTERMIterator.class);
