...
public class PersonLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonLandAreaTotalIterator.class);
