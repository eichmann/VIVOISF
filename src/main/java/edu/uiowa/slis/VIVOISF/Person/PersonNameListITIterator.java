...
public class PersonNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameListITIterator.class);
