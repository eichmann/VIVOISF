...
public class PersonNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameCurrencyESIterator.class);
