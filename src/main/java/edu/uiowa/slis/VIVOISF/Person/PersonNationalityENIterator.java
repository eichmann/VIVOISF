...
public class PersonNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNationalityENIterator.class);
