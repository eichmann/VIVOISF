...
public class PersonHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonHasMaxLongitudeIterator.class);
