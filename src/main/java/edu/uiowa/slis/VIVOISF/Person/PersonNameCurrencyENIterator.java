...
public class PersonNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameCurrencyENIterator.class);
