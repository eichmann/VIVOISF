...
public class PersonNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameShortITIterator.class);
