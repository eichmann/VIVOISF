...
public class PersonCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCodeDBPediaIDIterator.class);
