...
public class PersonNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameOfficialZHIterator.class);
