...
public class PersonHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonHasMaxLatitudeIterator.class);
