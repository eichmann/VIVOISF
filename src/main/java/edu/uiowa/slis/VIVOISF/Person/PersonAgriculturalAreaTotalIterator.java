...
public class PersonAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonAgriculturalAreaTotalIterator.class);
