...
public class PersonNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameCurrencyRUIterator.class);
