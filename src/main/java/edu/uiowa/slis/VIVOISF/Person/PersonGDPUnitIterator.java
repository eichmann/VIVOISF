...
public class PersonGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonGDPUnitIterator.class);
