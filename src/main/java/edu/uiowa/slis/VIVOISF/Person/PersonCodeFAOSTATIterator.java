...
public class PersonCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCodeFAOSTATIterator.class);
