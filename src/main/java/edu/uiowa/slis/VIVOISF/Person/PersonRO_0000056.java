...
public class PersonRO_0000056 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonRO_0000056 currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonRO_0000056.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonRO_0000056Iterator.getRO_0000056());
		} catch (Exception e) {
