...
public class PersonNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameCurrencyZHIterator.class);
