...
public class PersonNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameListZHIterator.class);
