...
public class PersonNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameListENIterator.class);
