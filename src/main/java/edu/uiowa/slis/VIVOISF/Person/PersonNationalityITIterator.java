...
public class PersonNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNationalityITIterator.class);
