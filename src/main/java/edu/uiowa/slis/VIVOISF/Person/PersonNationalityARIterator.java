...
public class PersonNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNationalityARIterator.class);
