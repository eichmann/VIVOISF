...
public class PersonNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameOfficialENIterator.class);
