...
public class PersonRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonRankIterator.class);
