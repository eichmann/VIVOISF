...
public class PersonUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonUrlIterator.class);
