...
public class PersonCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCodeISO3Iterator.class);
