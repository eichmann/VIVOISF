...
public class PersonNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameListRUIterator.class);
