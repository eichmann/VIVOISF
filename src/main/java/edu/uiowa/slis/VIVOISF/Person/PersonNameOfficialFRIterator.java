...
public class PersonNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameOfficialFRIterator.class);
