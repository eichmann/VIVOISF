...
public class PersonNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameListFRIterator.class);
