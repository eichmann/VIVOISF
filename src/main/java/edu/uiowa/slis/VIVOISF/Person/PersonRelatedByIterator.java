...
public class PersonRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(PersonRelatedByIterator.class);
...
//					continue;
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PersonRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in PersonRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in PersonRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in PersonRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
