...
public class PersonCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCountryAreaYearIterator.class);
