...
public class PersonNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameOfficialRUIterator.class);
