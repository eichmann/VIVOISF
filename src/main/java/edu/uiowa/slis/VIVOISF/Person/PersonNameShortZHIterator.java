...
public class PersonNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameShortZHIterator.class);
