...
public class PersonNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameOfficialESIterator.class);
