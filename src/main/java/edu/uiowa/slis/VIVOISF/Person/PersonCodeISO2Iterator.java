...
public class PersonCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCodeISO2Iterator.class);
