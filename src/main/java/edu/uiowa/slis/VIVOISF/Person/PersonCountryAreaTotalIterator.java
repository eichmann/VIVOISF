...
public class PersonCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCountryAreaTotalIterator.class);
