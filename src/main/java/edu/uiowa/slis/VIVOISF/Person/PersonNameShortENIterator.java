...
public class PersonNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameShortENIterator.class);
