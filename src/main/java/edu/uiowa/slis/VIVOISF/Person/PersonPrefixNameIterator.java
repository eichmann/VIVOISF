...
public class PersonPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonPrefixNameIterator.class);
