...
public class PersonNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameShortARIterator.class);
