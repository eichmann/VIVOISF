...
public class PersonCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCodeGAULIterator.class);
