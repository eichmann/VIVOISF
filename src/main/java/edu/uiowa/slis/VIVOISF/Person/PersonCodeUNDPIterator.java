...
public class PersonCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCodeUNDPIterator.class);
