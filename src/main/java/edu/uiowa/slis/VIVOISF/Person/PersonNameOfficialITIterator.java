...
public class PersonNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameOfficialITIterator.class);
