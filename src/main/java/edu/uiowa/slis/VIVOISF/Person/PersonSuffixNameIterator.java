...
public class PersonSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonSuffixNameIterator.class);
