...
public class PersonNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameShortFRIterator.class);
