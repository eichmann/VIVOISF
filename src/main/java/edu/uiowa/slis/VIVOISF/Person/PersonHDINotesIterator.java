...
public class PersonHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonHDINotesIterator.class);
