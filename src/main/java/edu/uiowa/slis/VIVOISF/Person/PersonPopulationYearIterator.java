...
public class PersonPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonPopulationYearIterator.class);
