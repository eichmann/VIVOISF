...
public class PersonNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameCurrencyARIterator.class);
