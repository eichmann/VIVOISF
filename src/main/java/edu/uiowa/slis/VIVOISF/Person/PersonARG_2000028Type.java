...
public class PersonARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonARG_2000028Iterator.getType());
		} catch (Exception e) {
