...
public class PersonCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCountryAreaUnitIterator.class);
