...
public class PersonPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonPopulationTotalIterator.class);
