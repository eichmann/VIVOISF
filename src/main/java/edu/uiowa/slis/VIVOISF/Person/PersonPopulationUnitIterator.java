...
public class PersonPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonPopulationUnitIterator.class);
