...
public class PersonRelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonRelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonRelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonRelatesIterator.getType());
		} catch (Exception e) {
