...
public class PersonNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameOfficialARIterator.class);
