...
public class PersonCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCodeAGROVOCIterator.class);
