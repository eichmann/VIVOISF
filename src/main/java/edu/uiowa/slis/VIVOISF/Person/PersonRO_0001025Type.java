...
public class PersonRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePersonRO_0001025Iterator.getType());
		} catch (Exception e) {
