...
public class PersonCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonCountryAreaNotesIterator.class);
