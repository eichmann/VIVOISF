...
public class PersonNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameCurrencyITIterator.class);
