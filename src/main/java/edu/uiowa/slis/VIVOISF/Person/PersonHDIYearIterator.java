...
public class PersonHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PersonHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonHDIYearIterator.class);
