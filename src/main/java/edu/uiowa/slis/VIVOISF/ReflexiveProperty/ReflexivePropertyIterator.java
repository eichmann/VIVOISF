...
public class ReflexivePropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReflexivePropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReflexivePropertyIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.w3.org/2002/07/owl#ReflexiveProperty> . "+
