...
public class PostdoctoralTrainingMajorFieldIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PostdoctoralTrainingMajorFieldIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PostdoctoralTrainingMajorFieldIterator.class);
