...
public class UndergraduateStudentRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUndergraduateStudentRO_0000056Iterator.getType());
		} catch (Exception e) {
