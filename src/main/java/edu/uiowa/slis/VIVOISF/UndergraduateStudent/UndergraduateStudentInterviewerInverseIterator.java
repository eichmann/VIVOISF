...
public class UndergraduateStudentInterviewerInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentInterviewerInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentInterviewerInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in UndergraduateStudentInterviewerInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in UndergraduateStudentInterviewerInverseIterator doStartTag");
		}
