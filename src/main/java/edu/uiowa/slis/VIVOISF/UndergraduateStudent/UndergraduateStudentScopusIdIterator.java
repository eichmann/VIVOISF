...
public class UndergraduateStudentScopusIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentScopusIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentScopusIdIterator.class);
