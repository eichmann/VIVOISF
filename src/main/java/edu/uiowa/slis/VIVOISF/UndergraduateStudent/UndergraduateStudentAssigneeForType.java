...
public class UndergraduateStudentAssigneeForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentAssigneeForType currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentAssigneeForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUndergraduateStudentAssigneeForIterator.getType());
		} catch (Exception e) {
