...
public class UndergraduateStudentPerformerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentPerformerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentPerformerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUndergraduateStudentPerformerInverseIterator.getType());
		} catch (Exception e) {
