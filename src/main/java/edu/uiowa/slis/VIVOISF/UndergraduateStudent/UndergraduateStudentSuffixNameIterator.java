...
public class UndergraduateStudentSuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentSuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentSuffixNameIterator.class);
