...
public class UndergraduateStudentERO_0000033Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentERO_0000033Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentERO_0000033Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUndergraduateStudentERO_0000033Iterator.getType());
		} catch (Exception e) {
