...
public class UndergraduateStudentERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUndergraduateStudentERO_0000037Iterator.getType());
		} catch (Exception e) {
