...
public class UndergraduateStudentRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUndergraduateStudentRO_0000053Iterator.getType());
		} catch (Exception e) {
