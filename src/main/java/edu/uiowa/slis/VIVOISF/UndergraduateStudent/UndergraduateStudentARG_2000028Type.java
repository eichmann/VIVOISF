...
public class UndergraduateStudentARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theUndergraduateStudentARG_2000028Iterator.getType());
		} catch (Exception e) {
