...
public class UndergraduateStudentSameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentSameAsIterator.class);
