...
public class UndergraduateStudentFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static UndergraduateStudentFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(UndergraduateStudentFreetextKeywordIterator.class);
