...
public class IdentificationHasAddress extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IdentificationHasAddress currentInstance = null;
	private static final Log log = LogFactory.getLog(IdentificationHasAddress.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIdentificationHasAddressIterator.getHasAddress());
		} catch (Exception e) {
