...
public class IdentificationHasEmail extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IdentificationHasEmail currentInstance = null;
	private static final Log log = LogFactory.getLog(IdentificationHasEmail.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIdentificationHasEmailIterator.getHasEmail());
		} catch (Exception e) {
