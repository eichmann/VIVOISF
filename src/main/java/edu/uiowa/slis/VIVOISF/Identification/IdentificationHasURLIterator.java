...
public class IdentificationHasURLIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IdentificationHasURLIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IdentificationHasURLIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IdentificationHasURLIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IdentificationHasURLIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IdentificationHasURLIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IdentificationHasURLIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IdentificationHasURL doEndTag", e);
			throw new JspTagException("Exception raised in IdentificationHasURL doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IdentificationHasURLIterator");
