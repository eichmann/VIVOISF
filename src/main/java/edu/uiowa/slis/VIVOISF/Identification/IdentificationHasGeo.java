...
public class IdentificationHasGeo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IdentificationHasGeo currentInstance = null;
	private static final Log log = LogFactory.getLog(IdentificationHasGeo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIdentificationHasGeoIterator.getHasGeo());
		} catch (Exception e) {
