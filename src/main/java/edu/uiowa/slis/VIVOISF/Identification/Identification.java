...
public class Identification extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Identification currentInstance = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			IdentificationIterator theIdentificationIterator = (IdentificationIterator) findAncestorWithClass(this, IdentificationIterator.class);

			if (theIdentificationIterator != null) {
				subjectURI = theIdentificationIterator.getSubjectURI();
				label = theIdentificationIterator.getLabel();
			}
			...
			if (theIdentificationIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in Identification doStartTag", e);
			throw new JspTagException("Exception raised in Identification doStartTag");
		} finally {
			freeConnection();
		}
