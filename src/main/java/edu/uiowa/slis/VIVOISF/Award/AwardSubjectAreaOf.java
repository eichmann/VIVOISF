...
public class AwardSubjectAreaOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AwardSubjectAreaOf currentInstance = null;
	private static final Log log = LogFactory.getLog(AwardSubjectAreaOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAwardSubjectAreaOfIterator.getSubjectAreaOf());
		} catch (Exception e) {
