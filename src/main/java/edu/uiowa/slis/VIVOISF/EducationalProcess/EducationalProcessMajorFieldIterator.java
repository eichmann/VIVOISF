...
public class EducationalProcessMajorFieldIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EducationalProcessMajorFieldIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EducationalProcessMajorFieldIterator.class);
