...
public class EducationalProcessBFO_0000055 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EducationalProcessBFO_0000055 currentInstance = null;
	private static final Log log = LogFactory.getLog(EducationalProcessBFO_0000055.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEducationalProcessBFO_0000055Iterator.getBFO_0000055());
		} catch (Exception e) {
