...
public class EducationalProcessRO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EducationalProcessRO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EducationalProcessRO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEducationalProcessRO_0000057Iterator.getType());
		} catch (Exception e) {
