...
public class CountryHasBorderWithIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryHasBorderWithIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryHasBorderWithIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CountryHasBorderWithIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CountryHasBorderWithIterator doStartTag");
		}
