...
public class CountryNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNationalityZHIterator.class);
