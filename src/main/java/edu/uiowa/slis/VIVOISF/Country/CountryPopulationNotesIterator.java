...
public class CountryPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryPopulationNotesIterator.class);
