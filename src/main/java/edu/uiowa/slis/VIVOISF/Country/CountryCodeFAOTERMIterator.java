...
public class CountryCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCodeFAOTERMIterator.class);
