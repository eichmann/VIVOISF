...
public class CountryNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameShortRUIterator.class);
