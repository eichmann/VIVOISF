...
public class CountryCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCountryAreaYearIterator.class);
