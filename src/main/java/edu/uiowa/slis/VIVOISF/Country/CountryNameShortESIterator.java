...
public class CountryNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameShortESIterator.class);
