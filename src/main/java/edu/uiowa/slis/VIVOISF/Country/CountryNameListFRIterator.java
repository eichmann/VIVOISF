...
public class CountryNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameListFRIterator.class);
