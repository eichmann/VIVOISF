...
public class CountryCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCountryAreaUnitIterator.class);
