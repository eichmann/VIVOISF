...
public class CountryCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCodeUNDPIterator.class);
