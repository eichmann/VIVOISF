...
public class CountryCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCountryAreaTotalIterator.class);
