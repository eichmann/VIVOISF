...
public class CountryNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameOfficialENIterator.class);
