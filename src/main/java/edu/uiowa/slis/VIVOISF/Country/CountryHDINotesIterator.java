...
public class CountryHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryHDINotesIterator.class);
