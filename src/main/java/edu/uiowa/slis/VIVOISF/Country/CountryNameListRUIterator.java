...
public class CountryNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameListRUIterator.class);
