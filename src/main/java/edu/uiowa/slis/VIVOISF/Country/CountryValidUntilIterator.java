...
public class CountryValidUntilIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryValidUntilIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryValidUntilIterator.class);
