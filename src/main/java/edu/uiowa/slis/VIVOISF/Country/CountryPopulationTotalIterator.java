...
public class CountryPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryPopulationTotalIterator.class);
