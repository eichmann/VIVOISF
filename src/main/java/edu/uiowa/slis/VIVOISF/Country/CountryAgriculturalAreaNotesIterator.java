...
public class CountryAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryAgriculturalAreaNotesIterator.class);
