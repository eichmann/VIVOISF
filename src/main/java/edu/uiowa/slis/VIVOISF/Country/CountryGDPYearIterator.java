...
public class CountryGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryGDPYearIterator.class);
