...
public class CountryLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryLandAreaTotalIterator.class);
