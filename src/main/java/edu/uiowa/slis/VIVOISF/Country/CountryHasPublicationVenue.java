...
public class CountryHasPublicationVenue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryHasPublicationVenue currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryHasPublicationVenue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCountryHasPublicationVenueIterator.getHasPublicationVenue());
		} catch (Exception e) {
