...
public class CountryBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCountryBFO_0000051Iterator.getType());
		} catch (Exception e) {
