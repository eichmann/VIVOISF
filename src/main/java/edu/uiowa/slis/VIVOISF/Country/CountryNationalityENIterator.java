...
public class CountryNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNationalityENIterator.class);
