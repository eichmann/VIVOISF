...
public class CountryCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCodeISO2Iterator.class);
