...
public class CountryNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameOfficialESIterator.class);
