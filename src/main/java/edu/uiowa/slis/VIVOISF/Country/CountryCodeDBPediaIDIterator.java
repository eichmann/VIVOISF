...
public class CountryCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCodeDBPediaIDIterator.class);
