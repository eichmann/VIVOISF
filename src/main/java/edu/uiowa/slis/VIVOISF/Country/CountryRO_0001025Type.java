...
public class CountryRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCountryRO_0001025Iterator.getType());
		} catch (Exception e) {
