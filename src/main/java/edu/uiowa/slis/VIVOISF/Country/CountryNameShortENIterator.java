...
public class CountryNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameShortENIterator.class);
