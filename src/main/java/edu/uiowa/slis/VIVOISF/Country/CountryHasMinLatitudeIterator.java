...
public class CountryHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryHasMinLatitudeIterator.class);
