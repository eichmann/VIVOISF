...
public class CountryNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNationalityFRIterator.class);
