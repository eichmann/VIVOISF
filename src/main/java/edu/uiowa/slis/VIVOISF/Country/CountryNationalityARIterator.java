...
public class CountryNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNationalityARIterator.class);
