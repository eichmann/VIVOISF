...
public class CountryAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryAgriculturalAreaTotalIterator.class);
