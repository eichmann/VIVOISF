...
public class CountryNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameOfficialFRIterator.class);
