...
public class CountryNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameListZHIterator.class);
