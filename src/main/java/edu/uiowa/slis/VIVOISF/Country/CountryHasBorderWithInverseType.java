...
public class CountryHasBorderWithInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryHasBorderWithInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryHasBorderWithInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCountryHasBorderWithInverseIterator.getType());
		} catch (Exception e) {
