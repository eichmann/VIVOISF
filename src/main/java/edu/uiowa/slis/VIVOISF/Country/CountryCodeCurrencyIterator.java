...
public class CountryCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCodeCurrencyIterator.class);
