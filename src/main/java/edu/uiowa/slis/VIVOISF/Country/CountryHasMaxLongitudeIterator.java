...
public class CountryHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryHasMaxLongitudeIterator.class);
