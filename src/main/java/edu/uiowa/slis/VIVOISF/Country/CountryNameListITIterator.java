...
public class CountryNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameListITIterator.class);
