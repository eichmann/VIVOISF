...
public class CountryIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Country> . "+
