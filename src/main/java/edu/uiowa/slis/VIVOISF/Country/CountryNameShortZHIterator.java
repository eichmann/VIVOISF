...
public class CountryNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameShortZHIterator.class);
