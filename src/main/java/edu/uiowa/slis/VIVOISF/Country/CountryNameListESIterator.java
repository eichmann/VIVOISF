...
public class CountryNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameListESIterator.class);
