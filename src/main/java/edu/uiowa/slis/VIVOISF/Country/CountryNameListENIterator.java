...
public class CountryNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameListENIterator.class);
