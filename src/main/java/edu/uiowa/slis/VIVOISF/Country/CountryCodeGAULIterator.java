...
public class CountryCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCodeGAULIterator.class);
