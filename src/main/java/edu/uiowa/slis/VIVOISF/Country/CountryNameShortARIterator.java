...
public class CountryNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameShortARIterator.class);
