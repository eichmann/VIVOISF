...
public class CountryNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameListARIterator.class);
