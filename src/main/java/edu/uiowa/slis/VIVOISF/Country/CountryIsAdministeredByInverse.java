...
public class CountryIsAdministeredByInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryIsAdministeredByInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryIsAdministeredByInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCountryIsAdministeredByInverseIterator.getIsAdministeredByInverse());
		} catch (Exception e) {
