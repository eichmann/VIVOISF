...
public class CountryHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryHDIYearIterator.class);
