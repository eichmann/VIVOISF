...
public class CountryGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryGDPUnitIterator.class);
