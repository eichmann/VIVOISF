...
public class CountryValidSinceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryValidSinceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryValidSinceIterator.class);
