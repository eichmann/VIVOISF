...
public class CountryNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameOfficialITIterator.class);
