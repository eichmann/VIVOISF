...
public class CountryNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNationalityRUIterator.class);
