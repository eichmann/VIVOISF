...
public class CountryCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCodeISO3Iterator.class);
