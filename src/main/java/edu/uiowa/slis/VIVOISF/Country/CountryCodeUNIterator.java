...
public class CountryCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCodeUNIterator.class);
