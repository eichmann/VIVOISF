...
public class CountryNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameCurrencyFRIterator.class);
