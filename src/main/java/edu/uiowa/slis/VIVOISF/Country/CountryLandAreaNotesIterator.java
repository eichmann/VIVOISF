...
public class CountryLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryLandAreaNotesIterator.class);
