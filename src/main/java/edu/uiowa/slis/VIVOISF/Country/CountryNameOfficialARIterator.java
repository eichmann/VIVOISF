...
public class CountryNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameOfficialARIterator.class);
