...
public class CountryCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCodeFAOSTATIterator.class);
