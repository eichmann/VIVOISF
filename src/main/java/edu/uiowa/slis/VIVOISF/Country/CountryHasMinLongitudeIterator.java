...
public class CountryHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryHasMinLongitudeIterator.class);
