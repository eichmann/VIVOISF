...
public class CountryCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCountryAreaNotesIterator.class);
