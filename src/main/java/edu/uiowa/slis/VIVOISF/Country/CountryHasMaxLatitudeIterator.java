...
public class CountryHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryHasMaxLatitudeIterator.class);
