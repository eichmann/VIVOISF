...
public class CountryDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryDescriptionIterator.class);
