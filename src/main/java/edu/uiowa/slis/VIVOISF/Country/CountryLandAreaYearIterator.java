...
public class CountryLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryLandAreaYearIterator.class);
