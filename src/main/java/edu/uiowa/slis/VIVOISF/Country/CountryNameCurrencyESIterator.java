...
public class CountryNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameCurrencyESIterator.class);
