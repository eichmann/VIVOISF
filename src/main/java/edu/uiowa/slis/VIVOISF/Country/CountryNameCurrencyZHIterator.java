...
public class CountryNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameCurrencyZHIterator.class);
