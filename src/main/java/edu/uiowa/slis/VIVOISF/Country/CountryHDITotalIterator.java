...
public class CountryHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryHDITotalIterator.class);
