...
public class CountryNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameCurrencyENIterator.class);
