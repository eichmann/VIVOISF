...
public class CountryNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameShortFRIterator.class);
