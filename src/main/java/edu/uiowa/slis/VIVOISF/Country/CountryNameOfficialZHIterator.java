...
public class CountryNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameOfficialZHIterator.class);
