...
public class CountryNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameCurrencyARIterator.class);
