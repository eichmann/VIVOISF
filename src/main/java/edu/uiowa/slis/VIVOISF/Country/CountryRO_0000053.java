...
public class CountryRO_0000053 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryRO_0000053 currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryRO_0000053.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCountryRO_0000053Iterator.getRO_0000053());
		} catch (Exception e) {
