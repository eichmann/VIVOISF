...
public class CountryRelates extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryRelates currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryRelates.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCountryRelatesIterator.getRelates());
		} catch (Exception e) {
