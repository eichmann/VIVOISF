...
public class CountryNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNameShortITIterator.class);
