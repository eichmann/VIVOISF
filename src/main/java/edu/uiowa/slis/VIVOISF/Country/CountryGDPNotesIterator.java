...
public class CountryGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryGDPNotesIterator.class);
