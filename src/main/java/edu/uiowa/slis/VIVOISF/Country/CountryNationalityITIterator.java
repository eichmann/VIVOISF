...
public class CountryNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryNationalityITIterator.class);
