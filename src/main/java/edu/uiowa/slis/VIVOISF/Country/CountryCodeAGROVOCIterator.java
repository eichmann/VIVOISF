...
public class CountryCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CountryCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CountryCodeAGROVOCIterator.class);
