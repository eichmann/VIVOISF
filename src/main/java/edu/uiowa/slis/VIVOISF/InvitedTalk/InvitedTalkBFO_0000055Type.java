...
public class InvitedTalkBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InvitedTalkBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(InvitedTalkBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInvitedTalkBFO_0000055Iterator.getType());
		} catch (Exception e) {
