...
public class InvitedTalkRO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InvitedTalkRO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(InvitedTalkRO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theInvitedTalkRO_0000057Iterator.getType());
		} catch (Exception e) {
