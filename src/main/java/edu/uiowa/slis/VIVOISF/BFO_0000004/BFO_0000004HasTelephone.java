...
public class BFO_0000004HasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004HasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004HasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000004HasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
