...
public class BFO_0000004HDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004HDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004HDINotesIterator.class);
