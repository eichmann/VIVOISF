...
public class BFO_0000004NationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NationalityENIterator.class);
