...
public class BFO_0000004HasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004HasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004HasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000004HasPublicationVenueIterator.getType());
		} catch (Exception e) {
