...
public class BFO_0000004NameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameCurrencyRUIterator.class);
