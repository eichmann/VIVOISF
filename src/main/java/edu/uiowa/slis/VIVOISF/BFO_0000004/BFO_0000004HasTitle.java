...
public class BFO_0000004HasTitle extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004HasTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004HasTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000004HasTitleIterator.getHasTitle());
		} catch (Exception e) {
