...
public class BFO_0000004NameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameListESIterator.class);
