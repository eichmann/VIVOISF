...
public class BFO_0000004NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameListITIterator.class);
