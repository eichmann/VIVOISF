...
public class BFO_0000004NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameCurrencyARIterator.class);
