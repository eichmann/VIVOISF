...
public class BFO_0000004CodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004CodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004CodeFAOTERMIterator.class);
