...
public class BFO_0000004NameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameShortESIterator.class);
