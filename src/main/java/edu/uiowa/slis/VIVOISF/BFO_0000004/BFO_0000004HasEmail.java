...
public class BFO_0000004HasEmail extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004HasEmail currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004HasEmail.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000004HasEmailIterator.getHasEmail());
		} catch (Exception e) {
