...
public class BFO_0000004HasURLType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004HasURLType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004HasURLType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000004HasURLIterator.getType());
		} catch (Exception e) {
