...
public class BFO_0000004ARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004ARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004ARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000004ARG_2000028Iterator.getType());
		} catch (Exception e) {
