...
public class BFO_0000004PublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004PublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004PublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000004PublisherIterator.getType());
		} catch (Exception e) {
