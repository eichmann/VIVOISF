...
public class BFO_0000004NameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameShortITIterator.class);
