...
public class BFO_0000004LandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004LandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004LandAreaNotesIterator.class);
