...
public class BFO_0000004HasAddress extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004HasAddress currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004HasAddress.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000004HasAddressIterator.getHasAddress());
		} catch (Exception e) {
