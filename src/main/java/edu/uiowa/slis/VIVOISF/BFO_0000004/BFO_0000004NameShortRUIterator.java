...
public class BFO_0000004NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameShortRUIterator.class);
