...
public class BFO_0000004RelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004RelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004RelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000004RelatedByIterator.getType());
		} catch (Exception e) {
