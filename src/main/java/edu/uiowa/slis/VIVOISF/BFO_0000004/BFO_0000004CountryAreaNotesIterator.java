...
public class BFO_0000004CountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004CountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004CountryAreaNotesIterator.class);
