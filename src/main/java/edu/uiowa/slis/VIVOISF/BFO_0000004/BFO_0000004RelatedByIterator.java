...
public class BFO_0000004RelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004RelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004RelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000004RelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000004RelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000004RelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000004RelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000004RelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000004RelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000004RelatedByIterator");
