...
public class BFO_0000004GDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004GDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004GDPTotalInCurrentPricesIterator.class);
