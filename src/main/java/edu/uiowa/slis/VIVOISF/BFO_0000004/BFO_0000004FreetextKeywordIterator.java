...
public class BFO_0000004FreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004FreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004FreetextKeywordIterator.class);
