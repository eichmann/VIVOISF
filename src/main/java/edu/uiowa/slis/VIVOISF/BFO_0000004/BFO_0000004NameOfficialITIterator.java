...
public class BFO_0000004NameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameOfficialITIterator.class);
