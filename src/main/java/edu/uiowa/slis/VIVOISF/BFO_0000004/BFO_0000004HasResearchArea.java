...
public class BFO_0000004HasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004HasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004HasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000004HasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
