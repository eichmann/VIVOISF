...
public class BFO_0000004NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameListZHIterator.class);
