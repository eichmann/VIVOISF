...
public class BFO_0000004LandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004LandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004LandAreaUnitIterator.class);
