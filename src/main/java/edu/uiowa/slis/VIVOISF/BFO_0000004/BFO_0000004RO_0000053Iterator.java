...
public class BFO_0000004RO_0000053Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004RO_0000053Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004RO_0000053Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				RO_0000053 = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
			...
			log.error("Exception raised in BFO_0000004RO_0000053Iterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000004RO_0000053Iterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000004RO_0000053Iterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000004RO_0000053Iterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000004RO_0000053 doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000004RO_0000053 doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setRO_0000053(String theRO_0000053) {
		RO_0000053 = theRO_0000053;
	}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000004RO_0000053Iterator");
