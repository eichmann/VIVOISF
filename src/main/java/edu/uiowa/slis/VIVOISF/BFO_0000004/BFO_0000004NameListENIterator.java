...
public class BFO_0000004NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameListENIterator.class);
