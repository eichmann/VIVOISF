...
public class BFO_0000004NameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameOfficialRUIterator.class);
