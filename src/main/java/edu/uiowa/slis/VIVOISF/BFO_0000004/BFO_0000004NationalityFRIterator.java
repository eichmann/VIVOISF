...
public class BFO_0000004NationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NationalityFRIterator.class);
