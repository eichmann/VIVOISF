...
public class BFO_0000004GDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004GDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004GDPUnitIterator.class);
