...
public class BFO_0000004NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004NameListRUIterator.class);
