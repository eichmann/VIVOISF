...
public class BFO_0000004GeographicFocusIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000004GeographicFocusIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000004GeographicFocusIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000004GeographicFocusIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000004GeographicFocusIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000004GeographicFocusIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000004GeographicFocusIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000004GeographicFocus doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000004GeographicFocus doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000004GeographicFocusIterator");
