...
public class EquipmentOBI_0000304Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(EquipmentOBI_0000304Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EquipmentOBI_0000304Iterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EquipmentOBI_0000304Iterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EquipmentOBI_0000304 doEndTag", e);
			throw new JspTagException("Exception raised in EquipmentOBI_0000304 doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
