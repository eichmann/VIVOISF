...
public class EquipmentRO_0003000 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EquipmentRO_0003000 currentInstance = null;
	private static final Log log = LogFactory.getLog(EquipmentRO_0003000.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEquipmentRO_0003000Iterator.getRO_0003000());
		} catch (Exception e) {
