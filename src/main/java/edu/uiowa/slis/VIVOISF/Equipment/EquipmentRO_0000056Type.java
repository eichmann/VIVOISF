...
public class EquipmentRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EquipmentRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EquipmentRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEquipmentRO_0000056Iterator.getType());
		} catch (Exception e) {
