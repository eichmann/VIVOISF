...
public class EquipmentRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EquipmentRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EquipmentRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEquipmentRO_0000053Iterator.getType());
		} catch (Exception e) {
