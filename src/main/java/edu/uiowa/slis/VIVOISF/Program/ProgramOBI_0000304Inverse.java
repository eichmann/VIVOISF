...
public class ProgramOBI_0000304Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProgramOBI_0000304Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(ProgramOBI_0000304Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProgramOBI_0000304InverseIterator.getOBI_0000304Inverse());
		} catch (Exception e) {
