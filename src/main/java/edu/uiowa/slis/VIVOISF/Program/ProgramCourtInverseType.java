...
public class ProgramCourtInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProgramCourtInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(ProgramCourtInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProgramCourtInverseIterator.getType());
		} catch (Exception e) {
