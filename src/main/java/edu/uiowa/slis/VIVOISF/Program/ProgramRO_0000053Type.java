...
public class ProgramRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ProgramRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ProgramRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theProgramRO_0000053Iterator.getType());
		} catch (Exception e) {
