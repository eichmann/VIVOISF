...
public class ScreenplayOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayOclcnumIterator.class);
