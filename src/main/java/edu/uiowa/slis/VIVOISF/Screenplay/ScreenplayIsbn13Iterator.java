...
public class ScreenplayIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayIsbn13Iterator.class);
