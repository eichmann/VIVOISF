...
public class ScreenplayIAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayIAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayIAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theScreenplayIAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
