...
public class ScreenplayReviewOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayReviewOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayReviewOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theScreenplayReviewOfIterator.getType());
		} catch (Exception e) {
