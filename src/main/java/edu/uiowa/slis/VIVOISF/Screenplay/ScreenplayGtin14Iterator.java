...
public class ScreenplayGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayGtin14Iterator.class);
