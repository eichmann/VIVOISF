...
public class ScreenplayAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayAsinIterator.class);
