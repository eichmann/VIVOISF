...
public class ScreenplayTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayTheAbstractIterator.class);
