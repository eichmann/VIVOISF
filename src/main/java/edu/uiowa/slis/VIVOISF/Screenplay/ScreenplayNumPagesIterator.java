...
public class ScreenplayNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayNumPagesIterator.class);
