...
public class ScreenplaySectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplaySectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplaySectionIterator.class);
