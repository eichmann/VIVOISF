...
public class ScreenplayPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayPageStartIterator.class);
