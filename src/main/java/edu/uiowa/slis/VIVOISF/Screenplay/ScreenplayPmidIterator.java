...
public class ScreenplayPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayPmidIterator.class);
