...
public class ScreenplayLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayLccnIterator.class);
