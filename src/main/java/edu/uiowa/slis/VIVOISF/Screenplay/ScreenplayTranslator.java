...
public class ScreenplayTranslator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayTranslator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayTranslator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theScreenplayTranslatorIterator.getTranslator());
		} catch (Exception e) {
