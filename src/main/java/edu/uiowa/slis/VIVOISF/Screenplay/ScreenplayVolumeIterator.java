...
public class ScreenplayVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayVolumeIterator.class);
