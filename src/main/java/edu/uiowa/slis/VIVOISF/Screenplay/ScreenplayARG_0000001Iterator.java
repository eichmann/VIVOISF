...
public class ScreenplayARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayARG_0000001Iterator.class);
