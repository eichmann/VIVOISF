...
public class ScreenplayOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theScreenplayOwnerIterator.getType());
		} catch (Exception e) {
