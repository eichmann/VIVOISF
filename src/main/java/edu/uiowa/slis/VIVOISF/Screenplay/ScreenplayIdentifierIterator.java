...
public class ScreenplayIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayIdentifierIterator.class);
