...
public class ScreenplayUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayUriIterator.class);
