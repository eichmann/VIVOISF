...
public class ScreenplayShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayShortDescriptionIterator.class);
