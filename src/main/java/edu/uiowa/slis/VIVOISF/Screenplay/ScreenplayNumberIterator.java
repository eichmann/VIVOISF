...
public class ScreenplayNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayNumberIterator.class);
