...
public class ScreenplaySiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplaySiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplaySiciIterator.class);
