...
public class ScreenplayDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayDoiIterator.class);
