...
public class ScreenplayLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayLocatorIterator.class);
