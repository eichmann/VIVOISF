...
public class ScreenplayEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayEanucc13Iterator.class);
