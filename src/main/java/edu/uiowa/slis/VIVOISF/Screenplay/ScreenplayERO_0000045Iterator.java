...
public class ScreenplayERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayERO_0000045Iterator.class);
