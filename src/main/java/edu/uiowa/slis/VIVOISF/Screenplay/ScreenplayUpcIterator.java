...
public class ScreenplayUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ScreenplayUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ScreenplayUpcIterator.class);
