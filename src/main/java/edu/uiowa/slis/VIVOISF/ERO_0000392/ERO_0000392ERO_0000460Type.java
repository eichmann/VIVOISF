...
public class ERO_0000392ERO_0000460Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000392ERO_0000460Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000392ERO_0000460Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000392ERO_0000460Iterator.getType());
		} catch (Exception e) {
