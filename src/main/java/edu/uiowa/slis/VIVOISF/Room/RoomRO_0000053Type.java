...
public class RoomRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RoomRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(RoomRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theRoomRO_0000053Iterator.getType());
		} catch (Exception e) {
