...
public class RoomRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RoomRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(RoomRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theRoomRO_0000056Iterator.getType());
		} catch (Exception e) {
