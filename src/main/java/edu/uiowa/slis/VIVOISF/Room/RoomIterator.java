...
public class RoomIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static RoomIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(RoomIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Room> . "+
			...
			log.error("Exception raised in RoomIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RoomIterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in RoomIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in RoomIterator doAfterBody");
		}
