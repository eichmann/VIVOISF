...
public class OCRE100038ERO_0001518InverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OCRE100038ERO_0001518InverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(OCRE100038ERO_0001518InverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOCRE100038ERO_0001518InverseIterator.getType());
		} catch (Exception e) {
