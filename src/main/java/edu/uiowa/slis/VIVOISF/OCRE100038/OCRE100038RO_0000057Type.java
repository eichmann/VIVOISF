...
public class OCRE100038RO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OCRE100038RO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(OCRE100038RO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOCRE100038RO_0000057Iterator.getType());
		} catch (Exception e) {
