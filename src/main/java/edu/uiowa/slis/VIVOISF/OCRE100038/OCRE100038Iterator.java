...
public class OCRE100038Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OCRE100038Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OCRE100038Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/net/OCRe/study_design.owl#OCRE100038> . "+
			...
			log.error("Exception raised in OCRE100038Iterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OCRE100038Iterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in OCRE100038Iterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in OCRE100038Iterator doAfterBody");
		}
