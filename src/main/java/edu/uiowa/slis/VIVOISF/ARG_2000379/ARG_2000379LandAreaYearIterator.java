...
public class ARG_2000379LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379LandAreaYearIterator.class);
