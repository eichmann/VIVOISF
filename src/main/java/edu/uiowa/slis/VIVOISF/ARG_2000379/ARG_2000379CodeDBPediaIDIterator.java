...
public class ARG_2000379CodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CodeDBPediaIDIterator.class);
