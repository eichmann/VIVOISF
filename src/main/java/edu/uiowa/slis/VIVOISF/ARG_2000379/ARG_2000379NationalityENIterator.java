...
public class ARG_2000379NationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NationalityENIterator.class);
