...
public class ARG_2000379DescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379DescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379DescriptionIterator.class);
