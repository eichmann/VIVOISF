...
public class ARG_2000379ARG_2000028 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379ARG_2000028 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379ARG_2000028.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379ARG_2000028Iterator.getARG_2000028());
		} catch (Exception e) {
