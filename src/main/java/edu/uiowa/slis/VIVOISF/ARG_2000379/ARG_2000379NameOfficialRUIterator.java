...
public class ARG_2000379NameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameOfficialRUIterator.class);
