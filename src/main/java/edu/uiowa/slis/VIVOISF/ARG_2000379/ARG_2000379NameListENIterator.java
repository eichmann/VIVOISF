...
public class ARG_2000379NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameListENIterator.class);
