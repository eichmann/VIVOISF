...
public class ARG_2000379NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameListRUIterator.class);
