...
public class ARG_2000379NameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameCurrencyESIterator.class);
