...
public class ARG_2000379NationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NationalityZHIterator.class);
