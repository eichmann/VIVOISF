...
public class ARG_2000379DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379DoiIterator.class);
