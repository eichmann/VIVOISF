...
public class ARG_2000379AgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379AgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379AgriculturalAreaNotesIterator.class);
