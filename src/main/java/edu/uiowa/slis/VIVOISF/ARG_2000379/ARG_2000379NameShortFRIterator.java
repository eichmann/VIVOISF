...
public class ARG_2000379NameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameShortFRIterator.class);
