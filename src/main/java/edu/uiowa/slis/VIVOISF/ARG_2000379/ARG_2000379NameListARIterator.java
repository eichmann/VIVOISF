...
public class ARG_2000379NameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameListARIterator.class);
