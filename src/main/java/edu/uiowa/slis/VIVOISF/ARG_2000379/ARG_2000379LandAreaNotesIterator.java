...
public class ARG_2000379LandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379LandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379LandAreaNotesIterator.class);
