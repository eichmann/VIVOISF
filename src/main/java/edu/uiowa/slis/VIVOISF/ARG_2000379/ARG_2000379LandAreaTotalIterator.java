...
public class ARG_2000379LandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379LandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379LandAreaTotalIterator.class);
