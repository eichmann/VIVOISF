...
public class ARG_2000379NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameListZHIterator.class);
