...
public class ARG_2000379CountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CountryAreaUnitIterator.class);
