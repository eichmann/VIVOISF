...
public class ARG_2000379HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HDITotalIterator.class);
