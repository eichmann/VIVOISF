...
public class ARG_2000379PopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379PopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379PopulationYearIterator.class);
