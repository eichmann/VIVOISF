...
public class ARG_2000379HasPublicationVenue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasPublicationVenue currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasPublicationVenue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379HasPublicationVenueIterator.getHasPublicationVenue());
		} catch (Exception e) {
