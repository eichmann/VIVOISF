...
public class ARG_2000379BFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379BFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379BFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379BFO_0000050Iterator.getType());
		} catch (Exception e) {
