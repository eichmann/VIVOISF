...
public class ARG_2000379RelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379RelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379RelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ARG_2000379RelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ARG_2000379RelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ARG_2000379RelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ARG_2000379RelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ARG_2000379Relates doEndTag", e);
			throw new JspTagException("Exception raised in ARG_2000379Relates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ARG_2000379RelatesIterator");
