...
public class ARG_2000379GDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379GDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379GDPTotalInCurrentPricesIterator.class);
