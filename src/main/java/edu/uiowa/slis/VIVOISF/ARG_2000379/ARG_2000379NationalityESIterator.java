...
public class ARG_2000379NationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NationalityESIterator.class);
