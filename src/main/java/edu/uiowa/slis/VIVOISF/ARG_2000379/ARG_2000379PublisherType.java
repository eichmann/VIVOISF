...
public class ARG_2000379PublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379PublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379PublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379PublisherIterator.getType());
		} catch (Exception e) {
