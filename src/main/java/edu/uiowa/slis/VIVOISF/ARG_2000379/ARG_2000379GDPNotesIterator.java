...
public class ARG_2000379GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379GDPNotesIterator.class);
