...
public class ARG_2000379CodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CodeCurrencyIterator.class);
