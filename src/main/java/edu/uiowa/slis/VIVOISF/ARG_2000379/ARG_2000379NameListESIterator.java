...
public class ARG_2000379NameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameListESIterator.class);
