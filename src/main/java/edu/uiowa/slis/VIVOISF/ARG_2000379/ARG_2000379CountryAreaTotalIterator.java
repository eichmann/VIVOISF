...
public class ARG_2000379CountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CountryAreaTotalIterator.class);
