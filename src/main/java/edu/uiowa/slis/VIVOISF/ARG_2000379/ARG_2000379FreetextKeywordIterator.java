...
public class ARG_2000379FreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379FreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379FreetextKeywordIterator.class);
