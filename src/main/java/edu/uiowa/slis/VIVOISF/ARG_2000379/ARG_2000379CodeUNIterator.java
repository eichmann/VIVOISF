...
public class ARG_2000379CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CodeUNIterator.class);
