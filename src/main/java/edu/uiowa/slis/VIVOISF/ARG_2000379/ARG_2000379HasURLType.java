...
public class ARG_2000379HasURLType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasURLType currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasURLType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379HasURLIterator.getType());
		} catch (Exception e) {
