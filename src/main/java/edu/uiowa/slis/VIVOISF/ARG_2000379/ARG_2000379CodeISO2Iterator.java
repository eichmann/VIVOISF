...
public class ARG_2000379CodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CodeISO2Iterator.class);
