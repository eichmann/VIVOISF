...
public class ARG_2000379CountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CountryAreaNotesIterator.class);
