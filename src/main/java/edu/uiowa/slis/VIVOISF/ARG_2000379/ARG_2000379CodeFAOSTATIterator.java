...
public class ARG_2000379CodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CodeFAOSTATIterator.class);
