...
public class ARG_2000379PopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379PopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379PopulationNotesIterator.class);
