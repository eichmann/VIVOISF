...
public class ARG_2000379GeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379GeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379GeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379GeographicFocusIterator.getType());
		} catch (Exception e) {
