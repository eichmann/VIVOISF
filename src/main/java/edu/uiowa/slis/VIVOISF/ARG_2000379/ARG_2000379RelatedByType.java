...
public class ARG_2000379RelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379RelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379RelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379RelatedByIterator.getType());
		} catch (Exception e) {
