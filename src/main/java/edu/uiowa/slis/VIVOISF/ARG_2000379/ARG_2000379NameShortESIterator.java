...
public class ARG_2000379NameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameShortESIterator.class);
