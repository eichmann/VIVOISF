...
public class ARG_2000379HasEmailIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasEmailIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasEmailIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ARG_2000379HasEmailIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ARG_2000379HasEmailIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ARG_2000379HasEmailIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ARG_2000379HasEmailIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ARG_2000379HasEmail doEndTag", e);
			throw new JspTagException("Exception raised in ARG_2000379HasEmail doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ARG_2000379HasEmailIterator");
