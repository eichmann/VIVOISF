...
public class ARG_2000379HasGeoIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasGeoIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasGeoIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ARG_2000379HasGeoIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ARG_2000379HasGeoIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ARG_2000379HasGeoIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ARG_2000379HasGeoIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ARG_2000379HasGeo doEndTag", e);
			throw new JspTagException("Exception raised in ARG_2000379HasGeo doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ARG_2000379HasGeoIterator");
