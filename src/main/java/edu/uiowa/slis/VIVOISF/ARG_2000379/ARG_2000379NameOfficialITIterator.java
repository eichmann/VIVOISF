...
public class ARG_2000379NameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameOfficialITIterator.class);
