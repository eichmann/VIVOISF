...
public class ARG_2000379HasTitle extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasTitle currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasTitle.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379HasTitleIterator.getHasTitle());
		} catch (Exception e) {
