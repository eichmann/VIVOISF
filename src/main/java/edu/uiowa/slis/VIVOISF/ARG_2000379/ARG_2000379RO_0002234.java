...
public class ARG_2000379RO_0002234 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379RO_0002234 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379RO_0002234.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379RO_0002234Iterator.getRO_0002234());
		} catch (Exception e) {
