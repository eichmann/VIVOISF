...
public class ARG_2000379NameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameOfficialENIterator.class);
