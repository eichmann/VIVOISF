...
public class ARG_2000379GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379GDPYearIterator.class);
