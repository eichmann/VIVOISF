...
public class ARG_2000379RO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379RO_0001025 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379RO_0001025.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379RO_0001025Iterator.getRO_0001025());
		} catch (Exception e) {
