...
public class ARG_2000379CodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CodeAGROVOCIterator.class);
