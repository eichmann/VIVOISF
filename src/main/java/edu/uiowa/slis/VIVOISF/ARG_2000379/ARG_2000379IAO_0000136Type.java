...
public class ARG_2000379IAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379IAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379IAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379IAO_0000136Iterator.getType());
		} catch (Exception e) {
