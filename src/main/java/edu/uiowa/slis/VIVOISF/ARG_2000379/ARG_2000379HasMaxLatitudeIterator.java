...
public class ARG_2000379HasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasMaxLatitudeIterator.class);
