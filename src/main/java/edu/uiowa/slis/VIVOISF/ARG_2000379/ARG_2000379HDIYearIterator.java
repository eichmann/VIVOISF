...
public class ARG_2000379HDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HDIYearIterator.class);
