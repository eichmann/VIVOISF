...
public class ARG_2000379NameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameShortARIterator.class);
