...
public class ARG_2000379NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameShortRUIterator.class);
