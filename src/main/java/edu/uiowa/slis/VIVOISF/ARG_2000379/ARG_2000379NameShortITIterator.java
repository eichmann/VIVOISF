...
public class ARG_2000379NameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameShortITIterator.class);
