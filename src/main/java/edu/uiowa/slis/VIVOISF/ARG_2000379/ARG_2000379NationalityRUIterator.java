...
public class ARG_2000379NationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NationalityRUIterator.class);
