...
public class ARG_2000379ARG_2000029Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379ARG_2000029Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379ARG_2000029Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379ARG_2000029Iterator.getType());
		} catch (Exception e) {
