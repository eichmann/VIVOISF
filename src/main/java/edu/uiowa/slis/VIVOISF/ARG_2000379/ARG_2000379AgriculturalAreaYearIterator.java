...
public class ARG_2000379AgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379AgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379AgriculturalAreaYearIterator.class);
