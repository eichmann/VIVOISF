...
public class ARG_2000379NameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameCurrencyZHIterator.class);
