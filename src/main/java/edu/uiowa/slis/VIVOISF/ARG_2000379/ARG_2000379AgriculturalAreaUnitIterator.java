...
public class ARG_2000379AgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379AgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379AgriculturalAreaUnitIterator.class);
