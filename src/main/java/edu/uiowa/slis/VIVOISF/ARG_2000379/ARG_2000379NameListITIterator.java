...
public class ARG_2000379NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameListITIterator.class);
