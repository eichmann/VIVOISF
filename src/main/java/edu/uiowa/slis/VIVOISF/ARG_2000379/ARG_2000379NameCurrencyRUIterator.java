...
public class ARG_2000379NameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameCurrencyRUIterator.class);
