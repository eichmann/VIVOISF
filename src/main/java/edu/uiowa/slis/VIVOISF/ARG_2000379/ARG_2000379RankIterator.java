...
public class ARG_2000379RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379RankIterator.class);
