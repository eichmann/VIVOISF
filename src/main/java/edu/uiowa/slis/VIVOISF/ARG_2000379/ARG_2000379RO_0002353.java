...
public class ARG_2000379RO_0002353 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379RO_0002353 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379RO_0002353.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379RO_0002353Iterator.getRO_0002353());
		} catch (Exception e) {
