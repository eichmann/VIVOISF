...
public class ARG_2000379NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NationalityARIterator.class);
