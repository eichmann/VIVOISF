...
public class ARG_2000379UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379UrlIterator.class);
