...
public class ARG_2000379HasGeo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasGeo currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasGeo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379HasGeoIterator.getHasGeo());
		} catch (Exception e) {
