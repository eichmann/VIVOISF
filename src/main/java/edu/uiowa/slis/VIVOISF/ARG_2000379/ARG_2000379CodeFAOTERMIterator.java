...
public class ARG_2000379CodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CodeFAOTERMIterator.class);
