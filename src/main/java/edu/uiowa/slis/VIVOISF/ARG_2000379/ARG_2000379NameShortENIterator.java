...
public class ARG_2000379NameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameShortENIterator.class);
