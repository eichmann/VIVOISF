...
public class ARG_2000379NameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameCurrencyENIterator.class);
