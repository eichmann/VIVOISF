...
public class ARG_2000379NameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameOfficialESIterator.class);
