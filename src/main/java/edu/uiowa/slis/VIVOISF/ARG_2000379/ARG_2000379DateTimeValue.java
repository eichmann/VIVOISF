...
public class ARG_2000379DateTimeValue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379DateTimeValue currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379DateTimeValue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379DateTimeValueIterator.getDateTimeValue());
		} catch (Exception e) {
