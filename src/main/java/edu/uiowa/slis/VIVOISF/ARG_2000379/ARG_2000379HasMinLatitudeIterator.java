...
public class ARG_2000379HasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasMinLatitudeIterator.class);
