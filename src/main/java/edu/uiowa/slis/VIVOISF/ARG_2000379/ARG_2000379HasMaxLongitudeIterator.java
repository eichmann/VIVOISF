...
public class ARG_2000379HasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasMaxLongitudeIterator.class);
