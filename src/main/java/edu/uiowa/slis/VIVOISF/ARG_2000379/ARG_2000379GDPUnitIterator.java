...
public class ARG_2000379GDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379GDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379GDPUnitIterator.class);
