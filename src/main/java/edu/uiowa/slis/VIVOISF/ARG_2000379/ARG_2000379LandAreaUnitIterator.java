...
public class ARG_2000379LandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379LandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379LandAreaUnitIterator.class);
