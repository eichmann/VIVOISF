...
public class ARG_2000379HasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasMinLongitudeIterator.class);
