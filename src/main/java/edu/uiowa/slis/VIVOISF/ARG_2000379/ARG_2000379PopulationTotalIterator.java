...
public class ARG_2000379PopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379PopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379PopulationTotalIterator.class);
