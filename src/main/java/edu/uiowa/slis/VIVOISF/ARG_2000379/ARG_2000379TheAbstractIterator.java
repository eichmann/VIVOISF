...
public class ARG_2000379TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379TheAbstractIterator.class);
