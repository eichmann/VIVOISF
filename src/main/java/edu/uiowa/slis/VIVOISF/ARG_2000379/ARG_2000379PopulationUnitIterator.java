...
public class ARG_2000379PopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379PopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379PopulationUnitIterator.class);
