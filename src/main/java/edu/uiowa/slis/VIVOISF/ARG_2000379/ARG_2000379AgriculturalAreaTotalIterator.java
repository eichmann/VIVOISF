...
public class ARG_2000379AgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379AgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379AgriculturalAreaTotalIterator.class);
