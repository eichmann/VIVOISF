...
public class ARG_2000379CodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CodeGAULIterator.class);
