...
public class ARG_2000379CountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CountryAreaYearIterator.class);
