...
public class ARG_2000379NationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NationalityFRIterator.class);
