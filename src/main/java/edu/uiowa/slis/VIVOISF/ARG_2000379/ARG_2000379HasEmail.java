...
public class ARG_2000379HasEmail extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasEmail currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasEmail.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379HasEmailIterator.getHasEmail());
		} catch (Exception e) {
