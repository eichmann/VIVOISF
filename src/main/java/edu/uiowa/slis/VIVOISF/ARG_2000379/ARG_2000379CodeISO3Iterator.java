...
public class ARG_2000379CodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CodeISO3Iterator.class);
