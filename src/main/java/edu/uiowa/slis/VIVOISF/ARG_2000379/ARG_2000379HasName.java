...
public class ARG_2000379HasName extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HasName currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HasName.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000379HasNameIterator.getHasName());
		} catch (Exception e) {
