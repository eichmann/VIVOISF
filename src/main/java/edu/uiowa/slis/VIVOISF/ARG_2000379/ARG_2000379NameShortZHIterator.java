...
public class ARG_2000379NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameShortZHIterator.class);
