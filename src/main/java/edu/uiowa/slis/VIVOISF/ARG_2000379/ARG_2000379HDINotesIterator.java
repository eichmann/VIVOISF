...
public class ARG_2000379HDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379HDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379HDINotesIterator.class);
