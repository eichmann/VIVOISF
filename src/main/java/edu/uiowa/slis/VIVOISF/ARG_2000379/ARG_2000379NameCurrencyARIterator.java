...
public class ARG_2000379NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379NameCurrencyARIterator.class);
