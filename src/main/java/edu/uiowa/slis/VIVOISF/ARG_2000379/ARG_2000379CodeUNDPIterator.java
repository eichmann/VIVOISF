...
public class ARG_2000379CodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000379CodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000379CodeUNDPIterator.class);
