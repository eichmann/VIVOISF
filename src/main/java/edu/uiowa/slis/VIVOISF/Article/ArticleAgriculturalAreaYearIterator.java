...
public class ArticleAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleAgriculturalAreaYearIterator.class);
