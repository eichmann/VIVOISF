...
public class ArticleNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameCurrencyRUIterator.class);
