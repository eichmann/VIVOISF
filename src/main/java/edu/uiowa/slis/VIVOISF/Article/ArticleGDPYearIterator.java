...
public class ArticleGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleGDPYearIterator.class);
