...
public class ArticleAuthorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleAuthorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleAuthorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticleAuthorListIterator.getType());
		} catch (Exception e) {
