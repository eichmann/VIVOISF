...
public class ArticleDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleDoiIterator.class);
