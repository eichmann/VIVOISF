...
public class ArticleHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleHasMaxLatitudeIterator.class);
