...
public class ArticleIssueIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleIssueIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleIssueIterator.class);
