...
public class ArticleHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleHDINotesIterator.class);
