...
public class ArticlePopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticlePopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticlePopulationTotalIterator.class);
