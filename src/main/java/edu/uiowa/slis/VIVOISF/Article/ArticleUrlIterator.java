...
public class ArticleUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleUrlIterator.class);
