...
public class ArticleGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleGDPUnitIterator.class);
