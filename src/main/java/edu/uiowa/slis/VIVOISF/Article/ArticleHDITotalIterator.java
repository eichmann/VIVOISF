...
public class ArticleHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleHDITotalIterator.class);
