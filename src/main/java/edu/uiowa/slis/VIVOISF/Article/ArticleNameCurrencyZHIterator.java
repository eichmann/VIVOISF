...
public class ArticleNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameCurrencyZHIterator.class);
