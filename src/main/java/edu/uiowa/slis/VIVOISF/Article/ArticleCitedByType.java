...
public class ArticleCitedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCitedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCitedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticleCitedByIterator.getType());
		} catch (Exception e) {
