...
public class ArticleNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameShortITIterator.class);
