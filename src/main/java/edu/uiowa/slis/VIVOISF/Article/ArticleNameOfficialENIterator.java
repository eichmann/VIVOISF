...
public class ArticleNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameOfficialENIterator.class);
