...
public class ArticleUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleUriIterator.class);
