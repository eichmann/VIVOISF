...
public class ArticleCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCountryAreaTotalIterator.class);
