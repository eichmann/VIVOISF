...
public class ArticleBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticleBFO_0000050Iterator.getType());
		} catch (Exception e) {
