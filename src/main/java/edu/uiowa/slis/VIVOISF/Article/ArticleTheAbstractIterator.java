...
public class ArticleTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleTheAbstractIterator.class);
