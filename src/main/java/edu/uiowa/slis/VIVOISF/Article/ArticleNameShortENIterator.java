...
public class ArticleNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameShortENIterator.class);
