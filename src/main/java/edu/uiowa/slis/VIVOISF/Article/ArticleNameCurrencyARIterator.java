...
public class ArticleNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameCurrencyARIterator.class);
