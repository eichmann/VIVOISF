...
public class ArticleLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleLocatorIterator.class);
