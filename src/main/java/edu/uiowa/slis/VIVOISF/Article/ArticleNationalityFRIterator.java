...
public class ArticleNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNationalityFRIterator.class);
