...
public class ArticlePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticlePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticlePageEndIterator.class);
