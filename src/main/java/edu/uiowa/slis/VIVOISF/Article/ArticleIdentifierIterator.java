...
public class ArticleIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleIdentifierIterator.class);
