...
public class ArticleShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleShortDescriptionIterator.class);
