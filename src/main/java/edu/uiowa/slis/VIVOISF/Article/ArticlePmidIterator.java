...
public class ArticlePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticlePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticlePmidIterator.class);
