...
public class ArticleGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleGtin14Iterator.class);
