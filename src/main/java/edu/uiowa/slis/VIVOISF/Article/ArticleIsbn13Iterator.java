...
public class ArticleIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleIsbn13Iterator.class);
