...
public class ArticleNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameShortARIterator.class);
