...
public class ArticleNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameOfficialITIterator.class);
