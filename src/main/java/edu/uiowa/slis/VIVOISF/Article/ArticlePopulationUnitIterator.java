...
public class ArticlePopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticlePopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticlePopulationUnitIterator.class);
