...
public class ArticleNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameCurrencyFRIterator.class);
