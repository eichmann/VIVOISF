...
public class ArticleCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCodeGAULIterator.class);
