...
public class ArticleNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameListFRIterator.class);
