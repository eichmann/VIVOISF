...
public class ArticleLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleLandAreaYearIterator.class);
