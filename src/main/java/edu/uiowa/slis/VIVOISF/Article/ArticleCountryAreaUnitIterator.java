...
public class ArticleCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCountryAreaUnitIterator.class);
