...
public class ArticleNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameOfficialESIterator.class);
