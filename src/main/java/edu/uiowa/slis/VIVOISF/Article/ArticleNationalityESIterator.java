...
public class ArticleNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNationalityESIterator.class);
