...
public class ArticlePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticlePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticlePagesIterator.class);
