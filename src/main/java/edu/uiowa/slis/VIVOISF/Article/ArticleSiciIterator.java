...
public class ArticleSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleSiciIterator.class);
