...
public class ArticlePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticlePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticlePageStartIterator.class);
