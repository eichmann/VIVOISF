...
public class ArticleNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameShortZHIterator.class);
