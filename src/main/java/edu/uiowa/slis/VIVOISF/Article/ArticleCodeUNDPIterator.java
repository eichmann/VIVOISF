...
public class ArticleCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCodeUNDPIterator.class);
