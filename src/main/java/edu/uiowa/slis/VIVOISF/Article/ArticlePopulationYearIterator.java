...
public class ArticlePopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticlePopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticlePopulationYearIterator.class);
