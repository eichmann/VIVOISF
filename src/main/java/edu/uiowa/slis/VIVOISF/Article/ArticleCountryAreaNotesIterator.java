...
public class ArticleCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCountryAreaNotesIterator.class);
