...
public class ArticleNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameShortFRIterator.class);
