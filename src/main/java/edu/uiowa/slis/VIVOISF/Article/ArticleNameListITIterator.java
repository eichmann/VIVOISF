...
public class ArticleNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameListITIterator.class);
