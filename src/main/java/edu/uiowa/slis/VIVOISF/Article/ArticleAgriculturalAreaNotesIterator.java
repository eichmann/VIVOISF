...
public class ArticleAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleAgriculturalAreaNotesIterator.class);
