...
public class ArticleVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleVolumeIterator.class);
