...
public class ArticleNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameOfficialFRIterator.class);
