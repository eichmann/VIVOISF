...
public class ArticleCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCodeFAOSTATIterator.class);
