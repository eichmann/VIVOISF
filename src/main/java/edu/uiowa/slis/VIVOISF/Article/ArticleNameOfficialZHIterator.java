...
public class ArticleNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameOfficialZHIterator.class);
