...
public class ArticleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://purl.org/ontology/bibo/Article> . "+
