...
public class ArticleHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleHasMinLongitudeIterator.class);
