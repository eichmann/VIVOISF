...
public class ArticleGeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleGeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleGeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticleGeographicFocusIterator.getType());
		} catch (Exception e) {
