...
public class ArticleNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNationalityZHIterator.class);
