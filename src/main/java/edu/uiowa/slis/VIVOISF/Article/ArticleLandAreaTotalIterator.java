...
public class ArticleLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleLandAreaTotalIterator.class);
