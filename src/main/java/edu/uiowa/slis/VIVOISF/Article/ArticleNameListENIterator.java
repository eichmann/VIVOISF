...
public class ArticleNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameListENIterator.class);
