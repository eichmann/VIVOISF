...
public class ArticleNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNationalityRUIterator.class);
