...
public class ArticleNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameCurrencyESIterator.class);
