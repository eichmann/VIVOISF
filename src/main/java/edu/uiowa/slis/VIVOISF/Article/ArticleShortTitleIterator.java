...
public class ArticleShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleShortTitleIterator.class);
