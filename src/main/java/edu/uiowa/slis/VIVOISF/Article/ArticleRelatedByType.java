...
public class ArticleRelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleRelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleRelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticleRelatedByIterator.getType());
		} catch (Exception e) {
