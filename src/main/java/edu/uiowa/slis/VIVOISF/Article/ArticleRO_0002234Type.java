...
public class ArticleRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticleRO_0002234Iterator.getType());
		} catch (Exception e) {
