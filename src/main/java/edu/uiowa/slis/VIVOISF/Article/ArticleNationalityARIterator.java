...
public class ArticleNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNationalityARIterator.class);
