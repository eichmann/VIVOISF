...
public class ArticleLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleLandAreaNotesIterator.class);
