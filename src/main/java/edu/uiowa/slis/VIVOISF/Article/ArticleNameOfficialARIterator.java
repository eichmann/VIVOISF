...
public class ArticleNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameOfficialARIterator.class);
