...
public class ArticleHasEmail extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleHasEmail currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleHasEmail.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticleHasEmailIterator.getHasEmail());
		} catch (Exception e) {
