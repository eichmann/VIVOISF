...
public class ArticleRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleRankIterator.class);
