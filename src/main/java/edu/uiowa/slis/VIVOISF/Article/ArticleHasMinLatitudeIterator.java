...
public class ArticleHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleHasMinLatitudeIterator.class);
