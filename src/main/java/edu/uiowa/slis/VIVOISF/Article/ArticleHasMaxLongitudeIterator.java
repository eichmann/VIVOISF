...
public class ArticleHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleHasMaxLongitudeIterator.class);
