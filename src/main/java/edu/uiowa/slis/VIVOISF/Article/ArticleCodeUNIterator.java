...
public class ArticleCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCodeUNIterator.class);
