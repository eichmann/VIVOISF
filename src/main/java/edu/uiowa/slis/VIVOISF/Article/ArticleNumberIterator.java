...
public class ArticleNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNumberIterator.class);
