...
public class ArticleCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCodeAGROVOCIterator.class);
