...
public class ArticleCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCodeFAOTERMIterator.class);
