...
public class ArticleDistributor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleDistributor currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleDistributor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticleDistributorIterator.getDistributor());
		} catch (Exception e) {
