...
public class ArticleEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleEanucc13Iterator.class);
