...
public class ArticleLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleLandAreaUnitIterator.class);
