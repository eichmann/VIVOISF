...
public class ArticleGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleGDPNotesIterator.class);
