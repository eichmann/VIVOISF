...
public class ArticleContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleContentIterator.class);
