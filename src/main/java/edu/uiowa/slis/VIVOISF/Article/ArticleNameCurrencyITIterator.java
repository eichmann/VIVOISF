...
public class ArticleNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameCurrencyITIterator.class);
