...
public class ArticleNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameShortESIterator.class);
