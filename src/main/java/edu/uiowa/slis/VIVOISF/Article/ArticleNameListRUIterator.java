...
public class ArticleNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameListRUIterator.class);
