...
public class ArticlePopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticlePopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticlePopulationNotesIterator.class);
