...
public class ArticleNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameCurrencyENIterator.class);
