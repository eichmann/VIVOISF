...
public class ArticleDocumentationForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleDocumentationForType currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleDocumentationForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticleDocumentationForIterator.getType());
		} catch (Exception e) {
