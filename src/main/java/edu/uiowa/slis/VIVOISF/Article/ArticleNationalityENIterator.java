...
public class ArticleNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNationalityENIterator.class);
