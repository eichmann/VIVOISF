...
public class ArticleAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleAgriculturalAreaUnitIterator.class);
