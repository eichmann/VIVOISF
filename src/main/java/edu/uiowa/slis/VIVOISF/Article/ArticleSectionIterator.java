...
public class ArticleSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleSectionIterator.class);
