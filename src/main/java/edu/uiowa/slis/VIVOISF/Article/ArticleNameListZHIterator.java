...
public class ArticleNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameListZHIterator.class);
