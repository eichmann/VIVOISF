...
public class ArticleAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleAgriculturalAreaTotalIterator.class);
