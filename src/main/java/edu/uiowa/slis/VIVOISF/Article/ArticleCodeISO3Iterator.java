...
public class ArticleCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCodeISO3Iterator.class);
