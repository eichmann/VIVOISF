...
public class ArticleAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleAsinIterator.class);
