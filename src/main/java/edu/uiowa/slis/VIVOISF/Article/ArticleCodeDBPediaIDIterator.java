...
public class ArticleCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCodeDBPediaIDIterator.class);
