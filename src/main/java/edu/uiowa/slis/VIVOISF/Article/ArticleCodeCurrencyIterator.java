...
public class ArticleCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCodeCurrencyIterator.class);
