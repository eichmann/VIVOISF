...
public class ArticleUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleUpcIterator.class);
