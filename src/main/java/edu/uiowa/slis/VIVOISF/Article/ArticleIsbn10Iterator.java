...
public class ArticleIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleIsbn10Iterator.class);
