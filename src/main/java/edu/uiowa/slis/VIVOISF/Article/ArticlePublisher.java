...
public class ArticlePublisher extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticlePublisher currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticlePublisher.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticlePublisherIterator.getPublisher());
		} catch (Exception e) {
