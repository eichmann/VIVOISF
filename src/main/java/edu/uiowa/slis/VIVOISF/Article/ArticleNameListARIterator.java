...
public class ArticleNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameListARIterator.class);
