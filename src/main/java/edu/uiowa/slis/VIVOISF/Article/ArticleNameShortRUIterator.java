...
public class ArticleNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleNameShortRUIterator.class);
