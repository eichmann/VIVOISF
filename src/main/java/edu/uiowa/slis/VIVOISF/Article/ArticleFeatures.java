...
public class ArticleFeatures extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleFeatures currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleFeatures.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArticleFeaturesIterator.getFeatures());
		} catch (Exception e) {
