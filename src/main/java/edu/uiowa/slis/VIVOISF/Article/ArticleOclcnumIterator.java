...
public class ArticleOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleOclcnumIterator.class);
