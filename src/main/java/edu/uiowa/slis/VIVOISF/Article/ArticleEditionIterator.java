...
public class ArticleEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleEditionIterator.class);
