...
public class ArticleFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleFreetextKeywordIterator.class);
