...
public class ArticleHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleHandleIterator.class);
