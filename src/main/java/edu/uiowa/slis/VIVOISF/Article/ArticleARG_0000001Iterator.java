...
public class ArticleARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleARG_0000001Iterator.class);
