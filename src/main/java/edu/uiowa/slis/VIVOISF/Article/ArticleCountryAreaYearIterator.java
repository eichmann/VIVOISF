...
public class ArticleCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ArticleCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArticleCountryAreaYearIterator.class);
