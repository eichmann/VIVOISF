...
public class ThingNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameListARIterator.class);
