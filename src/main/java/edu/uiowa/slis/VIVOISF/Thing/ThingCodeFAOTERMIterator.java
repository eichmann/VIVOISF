...
public class ThingCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCodeFAOTERMIterator.class);
