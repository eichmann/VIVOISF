...
public class ThingCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCodeGAULIterator.class);
