...
public class ThingNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNationalityARIterator.class);
