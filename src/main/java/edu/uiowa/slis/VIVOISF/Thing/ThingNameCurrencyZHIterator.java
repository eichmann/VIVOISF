...
public class ThingNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameCurrencyZHIterator.class);
