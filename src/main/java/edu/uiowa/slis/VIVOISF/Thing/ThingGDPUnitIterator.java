...
public class ThingGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingGDPUnitIterator.class);
