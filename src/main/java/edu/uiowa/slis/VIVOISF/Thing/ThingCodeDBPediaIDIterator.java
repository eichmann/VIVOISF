...
public class ThingCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCodeDBPediaIDIterator.class);
