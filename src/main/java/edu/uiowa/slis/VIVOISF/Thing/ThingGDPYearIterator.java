...
public class ThingGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingGDPYearIterator.class);
