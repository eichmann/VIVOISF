...
public class ThingNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNationalityITIterator.class);
