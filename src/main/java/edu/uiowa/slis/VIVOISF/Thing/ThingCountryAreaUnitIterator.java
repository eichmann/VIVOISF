...
public class ThingCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCountryAreaUnitIterator.class);
