...
public class ThingPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingPopulationNotesIterator.class);
