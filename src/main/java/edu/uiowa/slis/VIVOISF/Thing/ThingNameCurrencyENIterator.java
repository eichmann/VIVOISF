...
public class ThingNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameCurrencyENIterator.class);
