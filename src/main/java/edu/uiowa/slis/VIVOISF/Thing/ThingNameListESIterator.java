...
public class ThingNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameListESIterator.class);
