...
public class ThingNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNumPagesIterator.class);
