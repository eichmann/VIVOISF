...
public class ThingNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNationalityENIterator.class);
