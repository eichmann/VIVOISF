...
public class ThingBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThingBFO_0000051Iterator.getType());
		} catch (Exception e) {
