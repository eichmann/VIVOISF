...
public class ThingAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingAgriculturalAreaTotalIterator.class);
