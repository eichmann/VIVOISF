...
public class ThingAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingAgriculturalAreaYearIterator.class);
