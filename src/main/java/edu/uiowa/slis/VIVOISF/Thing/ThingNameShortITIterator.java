...
public class ThingNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameShortITIterator.class);
