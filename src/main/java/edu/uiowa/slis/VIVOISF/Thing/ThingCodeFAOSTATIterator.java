...
public class ThingCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCodeFAOSTATIterator.class);
