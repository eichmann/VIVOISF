...
public class ThingAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingAgriculturalAreaNotesIterator.class);
