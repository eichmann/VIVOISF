...
public class ThingRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingRelates doEndTag", e);
			throw new JspTagException("Exception raised in ThingRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingRelatesIterator");
