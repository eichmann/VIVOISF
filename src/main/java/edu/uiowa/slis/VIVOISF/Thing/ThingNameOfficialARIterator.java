...
public class ThingNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameOfficialARIterator.class);
