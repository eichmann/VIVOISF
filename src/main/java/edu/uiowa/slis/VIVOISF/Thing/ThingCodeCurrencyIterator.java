...
public class ThingCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCodeCurrencyIterator.class);
