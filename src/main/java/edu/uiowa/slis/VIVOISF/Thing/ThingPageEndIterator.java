...
public class ThingPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingPageEndIterator.class);
