...
public class ThingNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNationalityZHIterator.class);
