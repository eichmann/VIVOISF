...
public class ThingCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCodeISO2Iterator.class);
