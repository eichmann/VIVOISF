...
public class ThingLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingLandAreaUnitIterator.class);
