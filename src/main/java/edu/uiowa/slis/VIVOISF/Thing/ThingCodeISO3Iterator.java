...
public class ThingCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCodeISO3Iterator.class);
