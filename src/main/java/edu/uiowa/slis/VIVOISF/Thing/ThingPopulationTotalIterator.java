...
public class ThingPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingPopulationTotalIterator.class);
