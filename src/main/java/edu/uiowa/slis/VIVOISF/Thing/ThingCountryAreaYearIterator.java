...
public class ThingCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCountryAreaYearIterator.class);
