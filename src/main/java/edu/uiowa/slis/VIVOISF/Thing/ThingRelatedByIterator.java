...
public class ThingRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingRelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingRelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingRelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingRelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in ThingRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingRelatedByIterator");
