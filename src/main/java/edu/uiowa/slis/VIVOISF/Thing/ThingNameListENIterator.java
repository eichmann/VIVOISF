...
public class ThingNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameListENIterator.class);
