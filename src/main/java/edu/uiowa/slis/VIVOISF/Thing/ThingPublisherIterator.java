...
public class ThingPublisherIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingPublisherIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingPublisherIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingPublisherIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingPublisherIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingPublisherIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingPublisherIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingPublisher doEndTag", e);
			throw new JspTagException("Exception raised in ThingPublisher doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingPublisherIterator");
