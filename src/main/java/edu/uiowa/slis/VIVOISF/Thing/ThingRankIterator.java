...
public class ThingRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingRankIterator.class);
