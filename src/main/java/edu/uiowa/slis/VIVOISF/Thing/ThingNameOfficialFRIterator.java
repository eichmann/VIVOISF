...
public class ThingNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameOfficialFRIterator.class);
