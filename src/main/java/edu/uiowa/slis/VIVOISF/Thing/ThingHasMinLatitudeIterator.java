...
public class ThingHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHasMinLatitudeIterator.class);
