...
public class ThingCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCodeUNIterator.class);
