...
public class ThingEissnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingEissnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingEissnIterator.class);
