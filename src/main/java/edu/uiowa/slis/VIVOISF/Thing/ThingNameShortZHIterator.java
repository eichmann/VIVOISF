...
public class ThingNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameShortZHIterator.class);
