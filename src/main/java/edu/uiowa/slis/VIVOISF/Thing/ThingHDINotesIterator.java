...
public class ThingHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHDINotesIterator.class);
