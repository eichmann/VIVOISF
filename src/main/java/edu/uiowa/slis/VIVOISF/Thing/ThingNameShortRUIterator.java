...
public class ThingNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameShortRUIterator.class);
