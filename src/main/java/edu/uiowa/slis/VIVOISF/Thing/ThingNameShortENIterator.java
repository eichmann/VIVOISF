...
public class ThingNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameShortENIterator.class);
