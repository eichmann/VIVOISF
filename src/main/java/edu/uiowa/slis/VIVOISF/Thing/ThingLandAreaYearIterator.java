...
public class ThingLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingLandAreaYearIterator.class);
