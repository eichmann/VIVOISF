...
public class ThingNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameOfficialITIterator.class);
