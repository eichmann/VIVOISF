...
public class ThingNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameCurrencyESIterator.class);
