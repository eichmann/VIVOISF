...
public class ThingHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHasMinLongitudeIterator.class);
