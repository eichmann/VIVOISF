...
public class ThingNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameCurrencyARIterator.class);
