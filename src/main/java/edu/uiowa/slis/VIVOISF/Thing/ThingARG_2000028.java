...
public class ThingARG_2000028 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingARG_2000028 currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingARG_2000028.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThingARG_2000028Iterator.getARG_2000028());
		} catch (Exception e) {
