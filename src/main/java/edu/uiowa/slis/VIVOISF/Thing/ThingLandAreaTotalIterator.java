...
public class ThingLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingLandAreaTotalIterator.class);
