...
public class ThingNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameCurrencyITIterator.class);
