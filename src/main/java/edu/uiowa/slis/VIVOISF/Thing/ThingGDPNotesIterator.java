...
public class ThingGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingGDPNotesIterator.class);
