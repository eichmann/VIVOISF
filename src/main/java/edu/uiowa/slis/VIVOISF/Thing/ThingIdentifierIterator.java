...
public class ThingIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingIdentifierIterator.class);
