...
public class ThingSourceCreatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingSourceCreatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingSourceCreatorIterator.class);
