...
public class ThingNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNationalityESIterator.class);
