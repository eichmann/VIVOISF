...
public class ThingNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameOfficialZHIterator.class);
