...
public class ThingNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameShortARIterator.class);
