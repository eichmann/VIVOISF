...
public class ThingCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCodeAGROVOCIterator.class);
