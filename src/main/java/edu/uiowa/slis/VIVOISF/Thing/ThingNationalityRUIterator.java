...
public class ThingNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNationalityRUIterator.class);
