...
public class ThingNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNationalityFRIterator.class);
