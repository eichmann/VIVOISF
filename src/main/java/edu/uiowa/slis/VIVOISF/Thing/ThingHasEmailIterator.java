...
public class ThingHasEmailIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHasEmailIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHasEmailIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingHasEmailIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingHasEmailIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingHasEmailIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingHasEmailIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingHasEmail doEndTag", e);
			throw new JspTagException("Exception raised in ThingHasEmail doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingHasEmailIterator");
