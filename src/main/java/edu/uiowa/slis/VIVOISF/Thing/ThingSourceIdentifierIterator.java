...
public class ThingSourceIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingSourceIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingSourceIdentifierIterator.class);
