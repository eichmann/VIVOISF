...
public class ThingHasTelephoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHasTelephoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHasTelephoneIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingHasTelephoneIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingHasTelephoneIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingHasTelephoneIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingHasTelephoneIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingHasTelephone doEndTag", e);
			throw new JspTagException("Exception raised in ThingHasTelephone doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingHasTelephoneIterator");
