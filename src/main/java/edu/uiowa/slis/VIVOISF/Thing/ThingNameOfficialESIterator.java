...
public class ThingNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameOfficialESIterator.class);
