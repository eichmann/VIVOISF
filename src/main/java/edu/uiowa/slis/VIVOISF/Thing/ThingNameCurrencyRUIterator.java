...
public class ThingNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameCurrencyRUIterator.class);
