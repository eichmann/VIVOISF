...
public class ThingSourceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingSourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingSourceIterator.class);
