...
public class ThingRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThingRO_0001025Iterator.getType());
		} catch (Exception e) {
