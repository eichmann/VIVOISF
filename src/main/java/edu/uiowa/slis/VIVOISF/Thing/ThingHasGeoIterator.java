...
public class ThingHasGeoIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHasGeoIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHasGeoIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingHasGeoIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingHasGeoIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingHasGeoIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingHasGeoIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingHasGeo doEndTag", e);
			throw new JspTagException("Exception raised in ThingHasGeo doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingHasGeoIterator");
