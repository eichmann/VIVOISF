...
public class ThingHasAddressIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHasAddressIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHasAddressIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ThingHasAddressIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingHasAddressIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ThingHasAddressIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ThingHasAddressIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ThingHasAddress doEndTag", e);
			throw new JspTagException("Exception raised in ThingHasAddress doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ThingHasAddressIterator");
