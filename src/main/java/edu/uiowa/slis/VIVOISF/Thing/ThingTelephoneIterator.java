...
public class ThingTelephoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingTelephoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingTelephoneIterator.class);
