...
public class ThingPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingPopulationUnitIterator.class);
