...
public class ThingHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHasMaxLatitudeIterator.class);
