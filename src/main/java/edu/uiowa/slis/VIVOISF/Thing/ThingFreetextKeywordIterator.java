...
public class ThingFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingFreetextKeywordIterator.class);
