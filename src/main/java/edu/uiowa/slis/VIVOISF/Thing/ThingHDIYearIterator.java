...
public class ThingHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHDIYearIterator.class);
