...
public class ThingHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHasMaxLongitudeIterator.class);
