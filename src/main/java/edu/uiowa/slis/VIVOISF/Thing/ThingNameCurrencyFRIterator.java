...
public class ThingNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameCurrencyFRIterator.class);
