...
public class ThingNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameListRUIterator.class);
