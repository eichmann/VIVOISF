...
public class ThingNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameListITIterator.class);
