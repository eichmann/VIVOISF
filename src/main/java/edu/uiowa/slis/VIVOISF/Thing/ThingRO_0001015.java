...
public class ThingRO_0001015 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingRO_0001015 currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingRO_0001015.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theThingRO_0001015Iterator.getRO_0001015());
		} catch (Exception e) {
