...
public class ThingPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingPopulationYearIterator.class);
