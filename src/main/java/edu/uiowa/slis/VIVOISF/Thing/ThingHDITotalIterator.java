...
public class ThingHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingHDITotalIterator.class);
