...
public class ThingUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingUrlIterator.class);
