...
public class ThingNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameListFRIterator.class);
