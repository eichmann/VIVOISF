...
public class ThingNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameListZHIterator.class);
