...
public class ThingCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingCountryAreaTotalIterator.class);
