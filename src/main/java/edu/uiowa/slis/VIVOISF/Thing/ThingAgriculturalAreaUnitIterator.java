...
public class ThingAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingAgriculturalAreaUnitIterator.class);
