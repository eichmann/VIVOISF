...
public class ThingNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameOfficialRUIterator.class);
