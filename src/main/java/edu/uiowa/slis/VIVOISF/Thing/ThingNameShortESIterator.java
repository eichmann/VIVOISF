...
public class ThingNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameShortESIterator.class);
