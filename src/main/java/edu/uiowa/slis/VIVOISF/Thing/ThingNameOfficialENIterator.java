...
public class ThingNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingNameOfficialENIterator.class);
