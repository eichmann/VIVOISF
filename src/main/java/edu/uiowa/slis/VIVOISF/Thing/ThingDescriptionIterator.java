...
public class ThingDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ThingDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ThingDescriptionIterator.class);
