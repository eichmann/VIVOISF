...
public class AddressRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AddressRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AddressRankIterator.class);
