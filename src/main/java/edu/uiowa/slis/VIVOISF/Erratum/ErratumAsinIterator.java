...
public class ErratumAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumAsinIterator.class);
