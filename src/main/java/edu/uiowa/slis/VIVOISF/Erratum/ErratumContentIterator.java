...
public class ErratumContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumContentIterator.class);
