...
public class ErratumNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumNumberIterator.class);
