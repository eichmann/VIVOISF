...
public class ErratumCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumCodenIterator.class);
