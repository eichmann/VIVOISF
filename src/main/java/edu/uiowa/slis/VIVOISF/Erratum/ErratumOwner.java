...
public class ErratumOwner extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumOwner currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumOwner.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theErratumOwnerIterator.getOwner());
		} catch (Exception e) {
