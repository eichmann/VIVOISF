...
public class ErratumIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumIsbn10Iterator.class);
