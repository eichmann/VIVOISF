...
public class ErratumUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumUriIterator.class);
