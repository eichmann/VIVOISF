...
public class ErratumEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumEanucc13Iterator.class);
