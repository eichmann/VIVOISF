...
public class ErratumSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumSectionIterator.class);
