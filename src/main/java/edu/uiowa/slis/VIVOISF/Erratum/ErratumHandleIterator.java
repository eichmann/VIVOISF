...
public class ErratumHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumHandleIterator.class);
