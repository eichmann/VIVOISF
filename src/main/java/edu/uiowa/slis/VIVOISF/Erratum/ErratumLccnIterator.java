...
public class ErratumLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumLccnIterator.class);
