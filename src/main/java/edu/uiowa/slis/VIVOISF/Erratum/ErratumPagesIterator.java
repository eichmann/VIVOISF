...
public class ErratumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumPagesIterator.class);
