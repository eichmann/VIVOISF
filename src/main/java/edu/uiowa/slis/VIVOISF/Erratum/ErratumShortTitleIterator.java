...
public class ErratumShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumShortTitleIterator.class);
