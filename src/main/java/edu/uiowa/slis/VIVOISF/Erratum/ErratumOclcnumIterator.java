...
public class ErratumOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumOclcnumIterator.class);
