...
public class ErratumPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumPageStartIterator.class);
