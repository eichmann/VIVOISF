...
public class ErratumLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumLocatorIterator.class);
