...
public class ErratumVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumVolumeIterator.class);
