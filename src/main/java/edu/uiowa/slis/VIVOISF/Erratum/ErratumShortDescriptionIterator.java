...
public class ErratumShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumShortDescriptionIterator.class);
