...
public class ErratumARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumARG_0000001Iterator.class);
