...
public class ErratumCites extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumCites currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumCites.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theErratumCitesIterator.getCites());
		} catch (Exception e) {
