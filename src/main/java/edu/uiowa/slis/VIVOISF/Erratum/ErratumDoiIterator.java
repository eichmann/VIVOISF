...
public class ErratumDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumDoiIterator.class);
