...
public class ErratumIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumIdentifierIterator.class);
