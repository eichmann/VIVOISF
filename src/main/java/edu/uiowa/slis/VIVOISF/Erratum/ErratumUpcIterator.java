...
public class ErratumUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumUpcIterator.class);
