...
public class ErratumDocumentationFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumDocumentationFor currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumDocumentationFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theErratumDocumentationForIterator.getDocumentationFor());
		} catch (Exception e) {
