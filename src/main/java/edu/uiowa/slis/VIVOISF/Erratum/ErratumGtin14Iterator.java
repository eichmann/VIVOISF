...
public class ErratumGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumGtin14Iterator.class);
