...
public class ErratumERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumERO_0000045Iterator.class);
