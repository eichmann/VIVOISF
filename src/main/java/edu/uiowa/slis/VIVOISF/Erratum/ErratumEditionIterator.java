...
public class ErratumEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumEditionIterator.class);
