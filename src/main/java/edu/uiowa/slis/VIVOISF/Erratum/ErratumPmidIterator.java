...
public class ErratumPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumPmidIterator.class);
