...
public class ErratumNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumNumPagesIterator.class);
