...
public class ErratumIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumIsbn13Iterator.class);
