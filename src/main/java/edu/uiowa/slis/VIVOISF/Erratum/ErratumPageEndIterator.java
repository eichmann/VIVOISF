...
public class ErratumPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumPageEndIterator.class);
