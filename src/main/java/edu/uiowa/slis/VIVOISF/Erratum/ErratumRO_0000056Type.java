...
public class ErratumRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ErratumRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ErratumRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theErratumRO_0000056Iterator.getType());
		} catch (Exception e) {
