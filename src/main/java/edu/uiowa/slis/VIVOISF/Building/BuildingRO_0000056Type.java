...
public class BuildingRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BuildingRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BuildingRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBuildingRO_0000056Iterator.getType());
		} catch (Exception e) {
