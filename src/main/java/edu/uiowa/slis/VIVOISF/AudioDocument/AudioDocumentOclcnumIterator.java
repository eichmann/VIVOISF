...
public class AudioDocumentOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentOclcnumIterator.class);
