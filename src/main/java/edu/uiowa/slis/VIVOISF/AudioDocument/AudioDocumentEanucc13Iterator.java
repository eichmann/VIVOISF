...
public class AudioDocumentEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentEanucc13Iterator.class);
