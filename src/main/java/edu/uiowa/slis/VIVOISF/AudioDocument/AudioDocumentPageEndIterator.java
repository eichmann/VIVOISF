...
public class AudioDocumentPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentPageEndIterator.class);
