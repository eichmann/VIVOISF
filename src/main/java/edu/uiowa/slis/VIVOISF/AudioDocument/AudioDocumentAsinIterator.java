...
public class AudioDocumentAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentAsinIterator.class);
