...
public class AudioDocumentPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentPmidIterator.class);
