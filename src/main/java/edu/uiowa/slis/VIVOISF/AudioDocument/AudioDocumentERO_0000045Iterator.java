...
public class AudioDocumentERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentERO_0000045Iterator.class);
