...
public class AudioDocumentPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentPagesIterator.class);
