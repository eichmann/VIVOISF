...
public class AudioDocumentIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioDocumentIAO_0000136Iterator.getType());
		} catch (Exception e) {
