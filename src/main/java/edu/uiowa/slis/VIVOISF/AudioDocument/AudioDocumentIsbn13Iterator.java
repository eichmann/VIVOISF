...
public class AudioDocumentIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentIsbn13Iterator.class);
