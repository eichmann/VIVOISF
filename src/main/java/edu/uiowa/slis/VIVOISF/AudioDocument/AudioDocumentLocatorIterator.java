...
public class AudioDocumentLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentLocatorIterator.class);
