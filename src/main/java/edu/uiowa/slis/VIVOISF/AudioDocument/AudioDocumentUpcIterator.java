...
public class AudioDocumentUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentUpcIterator.class);
