...
public class AudioDocumentVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentVolumeIterator.class);
