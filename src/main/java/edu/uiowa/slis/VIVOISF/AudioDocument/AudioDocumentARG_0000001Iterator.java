...
public class AudioDocumentARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentARG_0000001Iterator.class);
