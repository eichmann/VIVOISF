...
public class AudioDocumentGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentGtin14Iterator.class);
