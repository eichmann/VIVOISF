...
public class AudioDocumentShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentShortDescriptionIterator.class);
