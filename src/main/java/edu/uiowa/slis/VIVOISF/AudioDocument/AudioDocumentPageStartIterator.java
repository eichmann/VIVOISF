...
public class AudioDocumentPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentPageStartIterator.class);
