...
public class AudioDocumentDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentDoiIterator.class);
