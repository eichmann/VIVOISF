...
public class AudioDocumentEditorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentEditorType currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentEditorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioDocumentEditorIterator.getType());
		} catch (Exception e) {
