...
public class AudioDocumentEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentEditionIterator.class);
