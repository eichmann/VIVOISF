...
public class AudioDocumentSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentSiciIterator.class);
