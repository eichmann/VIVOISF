...
public class AudioDocumentSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentSectionIterator.class);
