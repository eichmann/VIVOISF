...
public class AudioDocumentIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentIdentifierIterator.class);
