...
public class AudioDocumentOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAudioDocumentOwnerIterator.getType());
		} catch (Exception e) {
