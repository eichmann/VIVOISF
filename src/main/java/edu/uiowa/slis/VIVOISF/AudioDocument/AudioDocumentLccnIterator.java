...
public class AudioDocumentLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentLccnIterator.class);
