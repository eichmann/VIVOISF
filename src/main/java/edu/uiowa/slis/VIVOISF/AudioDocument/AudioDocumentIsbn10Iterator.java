...
public class AudioDocumentIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentIsbn10Iterator.class);
