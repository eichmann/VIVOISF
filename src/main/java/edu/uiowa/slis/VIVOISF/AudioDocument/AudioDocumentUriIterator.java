...
public class AudioDocumentUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentUriIterator.class);
