...
public class AudioDocumentTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentTheAbstractIterator.class);
