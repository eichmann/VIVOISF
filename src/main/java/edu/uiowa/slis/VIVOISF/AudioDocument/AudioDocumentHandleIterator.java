...
public class AudioDocumentHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AudioDocumentHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AudioDocumentHandleIterator.class);
