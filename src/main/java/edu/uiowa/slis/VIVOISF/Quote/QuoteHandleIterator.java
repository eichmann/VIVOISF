...
public class QuoteHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteHandleIterator.class);
