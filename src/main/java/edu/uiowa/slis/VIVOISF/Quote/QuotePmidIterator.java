...
public class QuotePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuotePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuotePmidIterator.class);
