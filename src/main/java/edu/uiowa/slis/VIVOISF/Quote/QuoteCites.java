...
public class QuoteCites extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteCites currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteCites.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theQuoteCitesIterator.getCites());
		} catch (Exception e) {
