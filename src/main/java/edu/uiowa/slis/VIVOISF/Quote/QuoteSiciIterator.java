...
public class QuoteSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteSiciIterator.class);
