...
public class QuoteGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteGtin14Iterator.class);
