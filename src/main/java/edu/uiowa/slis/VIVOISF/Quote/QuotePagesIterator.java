...
public class QuotePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuotePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuotePagesIterator.class);
