...
public class QuoteReproducedInType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteReproducedInType currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteReproducedInType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theQuoteReproducedInIterator.getType());
		} catch (Exception e) {
