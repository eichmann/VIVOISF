...
public class QuoteEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteEanucc13Iterator.class);
