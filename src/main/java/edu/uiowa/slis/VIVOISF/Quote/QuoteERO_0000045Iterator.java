...
public class QuoteERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteERO_0000045Iterator.class);
