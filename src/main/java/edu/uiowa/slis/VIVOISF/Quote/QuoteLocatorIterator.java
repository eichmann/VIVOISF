...
public class QuoteLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteLocatorIterator.class);
