...
public class QuoteShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteShortDescriptionIterator.class);
