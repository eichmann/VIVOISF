...
public class QuoteIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteIdentifierIterator.class);
