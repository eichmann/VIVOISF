...
public class QuoteTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteTheAbstractIterator.class);
