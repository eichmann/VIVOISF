...
public class QuoteIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteIsbn13Iterator.class);
