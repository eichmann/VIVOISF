...
public class QuoteShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteShortTitleIterator.class);
