...
public class QuoteSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteSectionIterator.class);
