...
public class QuoteOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteOclcnumIterator.class);
