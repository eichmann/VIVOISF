...
public class QuoteNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteNumPagesIterator.class);
