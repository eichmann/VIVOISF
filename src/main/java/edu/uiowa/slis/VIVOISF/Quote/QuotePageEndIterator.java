...
public class QuotePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuotePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuotePageEndIterator.class);
