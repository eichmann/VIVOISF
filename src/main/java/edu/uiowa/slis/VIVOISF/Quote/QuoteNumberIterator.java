...
public class QuoteNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteNumberIterator.class);
