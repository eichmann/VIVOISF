...
public class QuoteDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteDoiIterator.class);
