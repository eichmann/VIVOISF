...
public class QuoteIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteIsbn10Iterator.class);
