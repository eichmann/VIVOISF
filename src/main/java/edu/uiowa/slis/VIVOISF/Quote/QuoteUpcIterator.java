...
public class QuoteUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteUpcIterator.class);
