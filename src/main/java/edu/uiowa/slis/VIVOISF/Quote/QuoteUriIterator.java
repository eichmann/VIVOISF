...
public class QuoteUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteUriIterator.class);
