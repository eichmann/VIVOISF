...
public class QuoteEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static QuoteEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(QuoteEditionIterator.class);
