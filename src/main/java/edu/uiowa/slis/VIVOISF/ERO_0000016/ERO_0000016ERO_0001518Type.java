...
public class ERO_0000016ERO_0001518Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000016ERO_0001518Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000016ERO_0001518Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000016ERO_0001518Iterator.getType());
		} catch (Exception e) {
