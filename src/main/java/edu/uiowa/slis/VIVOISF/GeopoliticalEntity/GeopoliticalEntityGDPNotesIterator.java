...
public class GeopoliticalEntityGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityGDPNotesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				GDPNotes = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setGDPNotes(String theGDPNotes) {
		GDPNotes = theGDPNotes;
	}
