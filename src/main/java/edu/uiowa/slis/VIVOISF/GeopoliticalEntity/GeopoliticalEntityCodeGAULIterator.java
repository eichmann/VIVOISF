...
public class GeopoliticalEntityCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCodeGAULIterator.class);
