...
public class GeopoliticalEntityGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityGDPTotalInCurrentPricesIterator.class);
