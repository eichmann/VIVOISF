...
public class GeopoliticalEntityHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityHasMinLongitudeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				hasMinLongitude = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setHasMinLongitude(String theHasMinLongitude) {
		hasMinLongitude = theHasMinLongitude;
	}
