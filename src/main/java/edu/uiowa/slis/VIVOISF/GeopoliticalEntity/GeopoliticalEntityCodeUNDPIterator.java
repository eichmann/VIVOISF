...
public class GeopoliticalEntityCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCodeUNDPIterator.class);
