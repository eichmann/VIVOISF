...
public class GeopoliticalEntityNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityNameCurrencyESIterator.class);
