...
public class GeopoliticalEntityDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityDescriptionIterator.class);
