...
public class GeopoliticalEntityRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeopoliticalEntityRO_0002234Iterator.getType());
		} catch (Exception e) {
