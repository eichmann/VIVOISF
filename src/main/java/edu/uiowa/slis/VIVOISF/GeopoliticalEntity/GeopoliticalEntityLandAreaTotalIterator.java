...
public class GeopoliticalEntityLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityLandAreaTotalIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				landAreaTotal = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setLandAreaTotal(String theLandAreaTotal) {
		landAreaTotal = theLandAreaTotal;
	}
