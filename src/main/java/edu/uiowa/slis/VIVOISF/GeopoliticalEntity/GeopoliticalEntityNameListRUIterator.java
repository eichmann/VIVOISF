...
public class GeopoliticalEntityNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityNameListRUIterator.class);
