...
public class GeopoliticalEntityNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityNationalityZHIterator.class);
