...
public class GeopoliticalEntityFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityFreetextKeywordIterator.class);
