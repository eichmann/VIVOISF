...
public class GeopoliticalEntityHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityHDINotesIterator.class);
