...
public class GeopoliticalEntityCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCodeUNIterator.class);
