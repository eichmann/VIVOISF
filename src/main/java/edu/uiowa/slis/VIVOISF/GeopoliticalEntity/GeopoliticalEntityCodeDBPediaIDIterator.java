...
public class GeopoliticalEntityCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCodeDBPediaIDIterator.class);
