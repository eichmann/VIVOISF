...
public class GeopoliticalEntityHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityHasMinLatitudeIterator.class);
