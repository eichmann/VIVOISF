...
public class GeopoliticalEntityBFO_0000050 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityBFO_0000050 currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityBFO_0000050.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeopoliticalEntityBFO_0000050Iterator.getBFO_0000050());
		} catch (Exception e) {
