...
public class GeopoliticalEntityCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCodeISO2Iterator.class);
