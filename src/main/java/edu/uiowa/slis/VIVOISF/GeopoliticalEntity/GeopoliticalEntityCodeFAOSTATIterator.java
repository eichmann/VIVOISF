...
public class GeopoliticalEntityCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCodeFAOSTATIterator.class);
