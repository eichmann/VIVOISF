...
public class GeopoliticalEntityHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityHDIYearIterator.class);
