...
public class GeopoliticalEntityRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeopoliticalEntityRO_0000053Iterator.getType());
		} catch (Exception e) {
