...
public class GeopoliticalEntityHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityHDITotalIterator.class);
