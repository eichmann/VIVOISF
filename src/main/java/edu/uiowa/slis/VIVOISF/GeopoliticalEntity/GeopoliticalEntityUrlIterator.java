...
public class GeopoliticalEntityUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityUrlIterator.class);
