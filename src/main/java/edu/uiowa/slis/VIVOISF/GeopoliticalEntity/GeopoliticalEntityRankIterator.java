...
public class GeopoliticalEntityRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityRankIterator.class);
