...
public class GeopoliticalEntityCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCountryAreaTotalIterator.class);
