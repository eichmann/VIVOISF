...
public class GeopoliticalEntityHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityHasMaxLatitudeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				hasMaxLatitude = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setHasMaxLatitude(String theHasMaxLatitude) {
		hasMaxLatitude = theHasMaxLatitude;
	}
