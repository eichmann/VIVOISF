...
public class GeopoliticalEntityPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityPopulationUnitIterator.class);
