...
public class GeopoliticalEntityCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCodeCurrencyIterator.class);
