...
public class GeopoliticalEntityAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityAgriculturalAreaTotalIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				agriculturalAreaTotal = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setAgriculturalAreaTotal(String theAgriculturalAreaTotal) {
		agriculturalAreaTotal = theAgriculturalAreaTotal;
	}
