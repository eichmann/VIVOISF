...
public class GeopoliticalEntityNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityNameListENIterator.class);
