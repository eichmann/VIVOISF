...
public class GeopoliticalEntityCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCountryAreaUnitIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				countryAreaUnit = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setCountryAreaUnit(String theCountryAreaUnit) {
		countryAreaUnit = theCountryAreaUnit;
	}
