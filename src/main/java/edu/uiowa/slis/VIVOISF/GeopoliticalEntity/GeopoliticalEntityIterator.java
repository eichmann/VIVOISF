...
public class GeopoliticalEntityIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#GeopoliticalEntity> . "+
