...
public class GeopoliticalEntityPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityPopulationNotesIterator.class);
