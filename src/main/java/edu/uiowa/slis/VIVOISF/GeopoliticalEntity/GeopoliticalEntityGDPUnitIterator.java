...
public class GeopoliticalEntityGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityGDPUnitIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				GDPUnit = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setGDPUnit(String theGDPUnit) {
		GDPUnit = theGDPUnit;
	}
