...
public class GeopoliticalEntityBFO_0000051 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityBFO_0000051 currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityBFO_0000051.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeopoliticalEntityBFO_0000051Iterator.getBFO_0000051());
		} catch (Exception e) {
