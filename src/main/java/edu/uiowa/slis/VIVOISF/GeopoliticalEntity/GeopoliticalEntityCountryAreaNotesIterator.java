...
public class GeopoliticalEntityCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCountryAreaNotesIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				countryAreaNotes = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setCountryAreaNotes(String theCountryAreaNotes) {
		countryAreaNotes = theCountryAreaNotes;
	}
