...
public class GeopoliticalEntityRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeopoliticalEntityRO_0001015Iterator.getType());
		} catch (Exception e) {
