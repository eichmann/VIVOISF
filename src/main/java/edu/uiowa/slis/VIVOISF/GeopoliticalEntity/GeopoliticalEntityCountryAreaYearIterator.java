...
public class GeopoliticalEntityCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCountryAreaYearIterator.class);
