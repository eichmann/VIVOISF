...
public class GeopoliticalEntityARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeopoliticalEntityARG_2000028Iterator.getType());
		} catch (Exception e) {
