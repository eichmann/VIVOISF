...
public class GeopoliticalEntityCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCodeFAOTERMIterator.class);
