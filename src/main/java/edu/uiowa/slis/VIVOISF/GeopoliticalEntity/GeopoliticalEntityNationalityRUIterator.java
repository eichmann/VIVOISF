...
public class GeopoliticalEntityNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityNationalityRUIterator.class);
