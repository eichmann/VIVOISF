...
public class GeopoliticalEntityHasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityHasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityHasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeopoliticalEntityHasPublicationVenueIterator.getType());
		} catch (Exception e) {
