...
public class GeopoliticalEntityNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityNationalityENIterator.class);
