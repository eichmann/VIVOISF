...
public class GeopoliticalEntityLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityLandAreaNotesIterator.class);
