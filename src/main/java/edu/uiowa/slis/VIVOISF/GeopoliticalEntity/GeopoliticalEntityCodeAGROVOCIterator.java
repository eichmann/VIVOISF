...
public class GeopoliticalEntityCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityCodeAGROVOCIterator.class);
