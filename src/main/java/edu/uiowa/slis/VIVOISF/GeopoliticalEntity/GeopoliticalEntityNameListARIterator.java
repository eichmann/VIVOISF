...
public class GeopoliticalEntityNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityNameListARIterator.class);
