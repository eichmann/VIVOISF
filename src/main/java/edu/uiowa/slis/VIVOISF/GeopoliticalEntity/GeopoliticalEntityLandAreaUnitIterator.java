...
public class GeopoliticalEntityLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeopoliticalEntityLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeopoliticalEntityLandAreaUnitIterator.class);
