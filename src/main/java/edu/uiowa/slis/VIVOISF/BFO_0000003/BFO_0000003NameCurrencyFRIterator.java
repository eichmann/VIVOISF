...
public class BFO_0000003NameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameCurrencyFRIterator.class);
