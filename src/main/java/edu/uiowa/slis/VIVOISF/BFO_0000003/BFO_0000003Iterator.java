...
public class BFO_0000003Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.obolibrary.org/obo/BFO_0000003> . "+
