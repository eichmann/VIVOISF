...
public class BFO_0000003NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameShortRUIterator.class);
