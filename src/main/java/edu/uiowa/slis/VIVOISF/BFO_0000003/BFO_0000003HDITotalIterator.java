...
public class BFO_0000003HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003HDITotalIterator.class);
