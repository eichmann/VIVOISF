...
public class BFO_0000003NameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameCurrencyESIterator.class);
