...
public class BFO_0000003NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameCurrencyARIterator.class);
