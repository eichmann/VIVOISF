...
public class BFO_0000003NameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameShortARIterator.class);
