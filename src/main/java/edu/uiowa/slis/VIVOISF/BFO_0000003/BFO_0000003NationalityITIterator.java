...
public class BFO_0000003NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NationalityITIterator.class);
