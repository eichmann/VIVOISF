...
public class BFO_0000003CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003CodeUNIterator.class);
