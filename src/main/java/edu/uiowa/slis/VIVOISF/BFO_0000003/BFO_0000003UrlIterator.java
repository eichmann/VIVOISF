...
public class BFO_0000003UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003UrlIterator.class);
