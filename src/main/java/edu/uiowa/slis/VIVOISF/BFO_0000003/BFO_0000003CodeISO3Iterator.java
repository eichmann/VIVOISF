...
public class BFO_0000003CodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003CodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003CodeISO3Iterator.class);
