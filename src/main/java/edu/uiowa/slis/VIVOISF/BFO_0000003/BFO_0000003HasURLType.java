...
public class BFO_0000003HasURLType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003HasURLType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003HasURLType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003HasURLIterator.getType());
		} catch (Exception e) {
