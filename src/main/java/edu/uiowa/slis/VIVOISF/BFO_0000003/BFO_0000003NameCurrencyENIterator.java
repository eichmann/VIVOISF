...
public class BFO_0000003NameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameCurrencyENIterator.class);
