...
public class BFO_0000003CountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003CountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003CountryAreaYearIterator.class);
