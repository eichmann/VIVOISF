...
public class BFO_0000003HasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003HasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003HasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003HasNameIterator.getType());
		} catch (Exception e) {
