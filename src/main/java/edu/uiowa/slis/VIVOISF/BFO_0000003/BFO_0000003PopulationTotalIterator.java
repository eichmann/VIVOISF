...
public class BFO_0000003PopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003PopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003PopulationTotalIterator.class);
