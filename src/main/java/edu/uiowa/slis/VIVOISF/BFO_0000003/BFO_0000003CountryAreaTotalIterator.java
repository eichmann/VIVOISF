...
public class BFO_0000003CountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003CountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003CountryAreaTotalIterator.class);
