...
public class BFO_0000003NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameListENIterator.class);
