...
public class BFO_0000003NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameListRUIterator.class);
