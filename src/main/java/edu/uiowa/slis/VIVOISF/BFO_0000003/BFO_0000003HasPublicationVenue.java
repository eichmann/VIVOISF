...
public class BFO_0000003HasPublicationVenue extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003HasPublicationVenue currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003HasPublicationVenue.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003HasPublicationVenueIterator.getHasPublicationVenue());
		} catch (Exception e) {
