...
public class BFO_0000003LandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003LandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003LandAreaUnitIterator.class);
