...
public class BFO_0000003HasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003HasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003HasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003HasSubjectAreaIterator.getType());
		} catch (Exception e) {
