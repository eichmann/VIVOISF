...
public class BFO_0000003RelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003RelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003RelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003RelatesIterator.getType());
		} catch (Exception e) {
