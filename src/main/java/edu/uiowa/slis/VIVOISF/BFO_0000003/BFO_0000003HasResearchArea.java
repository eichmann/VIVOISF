...
public class BFO_0000003HasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003HasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003HasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003HasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
