...
public class BFO_0000003HasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003HasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003HasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003HasTitleIterator.getType());
		} catch (Exception e) {
