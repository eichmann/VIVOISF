...
public class BFO_0000003NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameListZHIterator.class);
