...
public class BFO_0000003NameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameListFRIterator.class);
