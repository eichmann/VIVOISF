...
public class BFO_0000003NameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameOfficialZHIterator.class);
