...
public class BFO_0000003GeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003GeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003GeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003GeographicFocusIterator.getType());
		} catch (Exception e) {
