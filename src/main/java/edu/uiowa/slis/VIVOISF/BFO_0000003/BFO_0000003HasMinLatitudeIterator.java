...
public class BFO_0000003HasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003HasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003HasMinLatitudeIterator.class);
