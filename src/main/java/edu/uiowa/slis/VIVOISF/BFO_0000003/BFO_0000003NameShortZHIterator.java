...
public class BFO_0000003NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameShortZHIterator.class);
