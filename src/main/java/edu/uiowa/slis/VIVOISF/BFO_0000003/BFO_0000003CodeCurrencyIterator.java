...
public class BFO_0000003CodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003CodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003CodeCurrencyIterator.class);
