...
public class BFO_0000003NameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameOfficialFRIterator.class);
