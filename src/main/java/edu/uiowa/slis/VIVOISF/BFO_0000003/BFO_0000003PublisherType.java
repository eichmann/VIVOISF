...
public class BFO_0000003PublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003PublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003PublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003PublisherIterator.getType());
		} catch (Exception e) {
