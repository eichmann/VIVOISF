...
public class BFO_0000003NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameListITIterator.class);
