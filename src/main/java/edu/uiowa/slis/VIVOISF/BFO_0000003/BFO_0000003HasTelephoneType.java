...
public class BFO_0000003HasTelephoneType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003HasTelephoneType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003HasTelephoneType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003HasTelephoneIterator.getType());
		} catch (Exception e) {
