...
public class BFO_0000003LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003LandAreaYearIterator.class);
