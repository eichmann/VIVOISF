...
public class BFO_0000003DateTimeInterval extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003DateTimeInterval currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003DateTimeInterval.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000003DateTimeIntervalIterator.getDateTimeInterval());
		} catch (Exception e) {
