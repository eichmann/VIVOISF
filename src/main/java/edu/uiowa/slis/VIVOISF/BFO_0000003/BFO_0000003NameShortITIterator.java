...
public class BFO_0000003NameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameShortITIterator.class);
