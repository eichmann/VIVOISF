...
public class BFO_0000003NameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003NameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003NameOfficialENIterator.class);
