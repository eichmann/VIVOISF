...
public class BFO_0000003DateTimeIntervalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000003DateTimeIntervalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000003DateTimeIntervalIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BFO_0000003DateTimeIntervalIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000003DateTimeIntervalIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BFO_0000003DateTimeIntervalIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000003DateTimeIntervalIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BFO_0000003DateTimeInterval doEndTag", e);
			throw new JspTagException("Exception raised in BFO_0000003DateTimeInterval doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BFO_0000003DateTimeIntervalIterator");
