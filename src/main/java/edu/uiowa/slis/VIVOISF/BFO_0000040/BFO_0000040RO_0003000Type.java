...
public class BFO_0000040RO_0003000Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000040RO_0003000Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000040RO_0003000Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000040RO_0003000Iterator.getType());
		} catch (Exception e) {
