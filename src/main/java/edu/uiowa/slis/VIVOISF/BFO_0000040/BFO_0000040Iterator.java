...
public class BFO_0000040Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000040Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000040Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.obolibrary.org/obo/BFO_0000040> . "+
			...
			log.error("Exception raised in BFO_0000040Iterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000040Iterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			log.error("Exception raised in BFO_0000040Iterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BFO_0000040Iterator doAfterBody");
		}
