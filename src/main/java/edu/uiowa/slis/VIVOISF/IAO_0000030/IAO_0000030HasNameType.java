...
public class IAO_0000030HasNameType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasNameType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasNameType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030HasNameIterator.getType());
		} catch (Exception e) {
