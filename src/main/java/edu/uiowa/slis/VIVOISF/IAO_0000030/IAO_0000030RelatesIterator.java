...
public class IAO_0000030RelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030RelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030RelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IAO_0000030RelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IAO_0000030RelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IAO_0000030RelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IAO_0000030RelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IAO_0000030Relates doEndTag", e);
			throw new JspTagException("Exception raised in IAO_0000030Relates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IAO_0000030RelatesIterator");
