...
public class IAO_0000030LandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030LandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030LandAreaUnitIterator.class);
