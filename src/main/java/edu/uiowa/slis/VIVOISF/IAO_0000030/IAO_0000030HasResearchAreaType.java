...
public class IAO_0000030HasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030HasResearchAreaIterator.getType());
		} catch (Exception e) {
