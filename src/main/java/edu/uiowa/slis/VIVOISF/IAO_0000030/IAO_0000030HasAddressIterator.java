...
public class IAO_0000030HasAddressIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasAddressIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasAddressIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IAO_0000030HasAddressIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IAO_0000030HasAddressIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IAO_0000030HasAddressIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IAO_0000030HasAddressIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IAO_0000030HasAddress doEndTag", e);
			throw new JspTagException("Exception raised in IAO_0000030HasAddress doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IAO_0000030HasAddressIterator");
