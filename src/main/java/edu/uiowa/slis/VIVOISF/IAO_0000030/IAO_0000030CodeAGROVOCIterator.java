...
public class IAO_0000030CodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030CodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030CodeAGROVOCIterator.class);
