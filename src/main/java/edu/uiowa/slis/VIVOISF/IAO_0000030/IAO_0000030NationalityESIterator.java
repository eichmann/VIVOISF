...
public class IAO_0000030NationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NationalityESIterator.class);
