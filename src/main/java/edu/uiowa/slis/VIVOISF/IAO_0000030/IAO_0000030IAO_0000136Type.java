...
public class IAO_0000030IAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030IAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030IAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030IAO_0000136Iterator.getType());
		} catch (Exception e) {
