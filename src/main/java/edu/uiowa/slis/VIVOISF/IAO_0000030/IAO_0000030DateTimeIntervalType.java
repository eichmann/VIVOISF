...
public class IAO_0000030DateTimeIntervalType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030DateTimeIntervalType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030DateTimeIntervalType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030DateTimeIntervalIterator.getType());
		} catch (Exception e) {
