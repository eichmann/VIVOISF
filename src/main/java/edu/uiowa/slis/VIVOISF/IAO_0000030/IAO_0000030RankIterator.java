...
public class IAO_0000030RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030RankIterator.class);
