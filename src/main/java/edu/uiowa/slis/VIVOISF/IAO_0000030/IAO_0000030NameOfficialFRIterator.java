...
public class IAO_0000030NameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameOfficialFRIterator.class);
