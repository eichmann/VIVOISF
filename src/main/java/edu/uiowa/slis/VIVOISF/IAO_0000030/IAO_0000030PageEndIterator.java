...
public class IAO_0000030PageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030PageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030PageEndIterator.class);
