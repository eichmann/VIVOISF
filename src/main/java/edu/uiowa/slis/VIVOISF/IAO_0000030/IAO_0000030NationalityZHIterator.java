...
public class IAO_0000030NationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NationalityZHIterator.class);
