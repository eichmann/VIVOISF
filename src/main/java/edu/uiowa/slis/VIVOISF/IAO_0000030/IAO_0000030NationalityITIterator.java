...
public class IAO_0000030NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NationalityITIterator.class);
