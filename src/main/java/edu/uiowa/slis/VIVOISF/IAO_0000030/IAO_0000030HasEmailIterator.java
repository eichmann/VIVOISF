...
public class IAO_0000030HasEmailIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasEmailIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasEmailIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IAO_0000030HasEmailIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IAO_0000030HasEmailIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IAO_0000030HasEmailIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IAO_0000030HasEmailIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IAO_0000030HasEmail doEndTag", e);
			throw new JspTagException("Exception raised in IAO_0000030HasEmail doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IAO_0000030HasEmailIterator");
