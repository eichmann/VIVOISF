...
public class IAO_0000030PopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030PopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030PopulationYearIterator.class);
