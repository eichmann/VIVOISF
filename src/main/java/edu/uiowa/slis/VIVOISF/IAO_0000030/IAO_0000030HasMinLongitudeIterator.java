...
public class IAO_0000030HasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasMinLongitudeIterator.class);
