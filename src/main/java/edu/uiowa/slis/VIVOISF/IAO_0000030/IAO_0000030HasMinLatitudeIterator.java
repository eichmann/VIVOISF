...
public class IAO_0000030HasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasMinLatitudeIterator.class);
