...
public class IAO_0000030HasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasMaxLongitudeIterator.class);
