...
public class IAO_0000030EissnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030EissnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030EissnIterator.class);
