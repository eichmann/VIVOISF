...
public class IAO_0000030UrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030UrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030UrlIterator.class);
