...
public class IAO_0000030ARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030ARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030ARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030ARG_2000028Iterator.getType());
		} catch (Exception e) {
