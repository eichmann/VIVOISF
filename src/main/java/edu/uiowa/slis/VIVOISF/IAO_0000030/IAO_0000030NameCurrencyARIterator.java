...
public class IAO_0000030NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameCurrencyARIterator.class);
