...
public class IAO_0000030RO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030RO_0001025 currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030RO_0001025.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030RO_0001025Iterator.getRO_0001025());
		} catch (Exception e) {
