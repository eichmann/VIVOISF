...
public class IAO_0000030GDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030GDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030GDPTotalInCurrentPricesIterator.class);
