...
public class IAO_0000030Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030Features currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030FeaturesIterator.getFeatures());
		} catch (Exception e) {
