...
public class IAO_0000030DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030DoiIterator.class);
