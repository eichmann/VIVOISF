...
public class IAO_0000030NameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameCurrencyZHIterator.class);
