...
public class IAO_0000030CodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030CodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030CodeFAOSTATIterator.class);
