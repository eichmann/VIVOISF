...
public class IAO_0000030NameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameOfficialESIterator.class);
