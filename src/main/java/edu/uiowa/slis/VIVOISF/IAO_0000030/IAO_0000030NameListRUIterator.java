...
public class IAO_0000030NameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameListRUIterator.class);
