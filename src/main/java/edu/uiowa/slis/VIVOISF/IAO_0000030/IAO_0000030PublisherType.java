...
public class IAO_0000030PublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030PublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030PublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030PublisherIterator.getType());
		} catch (Exception e) {
