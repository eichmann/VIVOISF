...
public class IAO_0000030NameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameListESIterator.class);
