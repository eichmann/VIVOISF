...
public class IAO_0000030HasAddress extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasAddress currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasAddress.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030HasAddressIterator.getHasAddress());
		} catch (Exception e) {
