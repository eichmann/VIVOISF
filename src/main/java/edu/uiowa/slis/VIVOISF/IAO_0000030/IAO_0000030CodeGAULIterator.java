...
public class IAO_0000030CodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030CodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030CodeGAULIterator.class);
