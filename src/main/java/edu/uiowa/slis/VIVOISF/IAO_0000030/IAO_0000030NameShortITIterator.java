...
public class IAO_0000030NameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameShortITIterator.class);
