...
public class IAO_0000030NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameListITIterator.class);
