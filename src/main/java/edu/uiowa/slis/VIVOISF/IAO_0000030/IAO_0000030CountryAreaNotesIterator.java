...
public class IAO_0000030CountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030CountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030CountryAreaNotesIterator.class);
