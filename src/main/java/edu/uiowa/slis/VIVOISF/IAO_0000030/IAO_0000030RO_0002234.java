...
public class IAO_0000030RO_0002234 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030RO_0002234 currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030RO_0002234.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030RO_0002234Iterator.getRO_0002234());
		} catch (Exception e) {
