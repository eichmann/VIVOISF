...
public class IAO_0000030HasGeoType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasGeoType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasGeoType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030HasGeoIterator.getType());
		} catch (Exception e) {
