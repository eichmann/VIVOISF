...
public class IAO_0000030PopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030PopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030PopulationTotalIterator.class);
