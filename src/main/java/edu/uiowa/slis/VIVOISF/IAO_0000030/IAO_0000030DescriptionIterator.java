...
public class IAO_0000030DescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030DescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030DescriptionIterator.class);
