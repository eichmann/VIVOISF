...
public class IAO_0000030CountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030CountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030CountryAreaUnitIterator.class);
