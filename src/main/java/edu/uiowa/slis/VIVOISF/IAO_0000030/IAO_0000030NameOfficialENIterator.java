...
public class IAO_0000030NameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameOfficialENIterator.class);
