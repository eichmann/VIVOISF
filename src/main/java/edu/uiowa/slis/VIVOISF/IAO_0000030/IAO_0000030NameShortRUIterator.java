...
public class IAO_0000030NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameShortRUIterator.class);
