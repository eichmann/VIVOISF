...
public class IAO_0000030Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.obolibrary.org/obo/IAO_0000030> . "+
