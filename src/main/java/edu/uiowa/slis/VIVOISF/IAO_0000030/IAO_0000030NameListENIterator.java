...
public class IAO_0000030NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameListENIterator.class);
