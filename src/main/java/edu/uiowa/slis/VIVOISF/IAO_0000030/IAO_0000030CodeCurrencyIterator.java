...
public class IAO_0000030CodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030CodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030CodeCurrencyIterator.class);
