...
public class IAO_0000030HasTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasTitleIterator.class);
...
//					continue;
			...
			log.error("Exception raised in IAO_0000030HasTitleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IAO_0000030HasTitleIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in IAO_0000030HasTitleIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in IAO_0000030HasTitleIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in IAO_0000030HasTitle doEndTag", e);
			throw new JspTagException("Exception raised in IAO_0000030HasTitle doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to IAO_0000030HasTitleIterator");
