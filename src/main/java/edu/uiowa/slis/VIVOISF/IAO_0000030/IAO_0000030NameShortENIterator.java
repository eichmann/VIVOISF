...
public class IAO_0000030NameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameShortENIterator.class);
