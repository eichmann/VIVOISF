...
public class IAO_0000030TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030TheAbstractIterator.class);
