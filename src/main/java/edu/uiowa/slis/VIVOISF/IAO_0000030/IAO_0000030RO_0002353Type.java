...
public class IAO_0000030RO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030RO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030RO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030RO_0002353Iterator.getType());
		} catch (Exception e) {
