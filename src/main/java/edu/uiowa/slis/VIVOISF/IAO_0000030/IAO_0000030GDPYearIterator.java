...
public class IAO_0000030GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030GDPYearIterator.class);
