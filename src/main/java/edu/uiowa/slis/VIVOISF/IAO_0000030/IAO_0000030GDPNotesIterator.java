...
public class IAO_0000030GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030GDPNotesIterator.class);
