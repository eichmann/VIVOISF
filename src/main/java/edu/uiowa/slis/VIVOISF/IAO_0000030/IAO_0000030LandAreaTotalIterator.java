...
public class IAO_0000030LandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030LandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030LandAreaTotalIterator.class);
