...
public class IAO_0000030HasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030HasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
