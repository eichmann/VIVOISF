...
public class IAO_0000030NameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameCurrencyFRIterator.class);
