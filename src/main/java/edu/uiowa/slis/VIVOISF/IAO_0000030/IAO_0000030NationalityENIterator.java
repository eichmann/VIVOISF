...
public class IAO_0000030NationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NationalityENIterator.class);
