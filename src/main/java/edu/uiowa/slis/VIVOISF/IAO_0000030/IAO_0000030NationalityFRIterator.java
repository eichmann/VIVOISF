...
public class IAO_0000030NationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NationalityFRIterator.class);
