...
public class IAO_0000030LandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030LandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030LandAreaYearIterator.class);
