...
public class IAO_0000030RO_0001015 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030RO_0001015 currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030RO_0001015.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030RO_0001015Iterator.getRO_0001015());
		} catch (Exception e) {
