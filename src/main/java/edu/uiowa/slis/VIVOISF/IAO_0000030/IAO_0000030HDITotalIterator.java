...
public class IAO_0000030HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030HDITotalIterator.class);
