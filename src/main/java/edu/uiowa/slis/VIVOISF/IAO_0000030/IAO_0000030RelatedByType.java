...
public class IAO_0000030RelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030RelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030RelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theIAO_0000030RelatedByIterator.getType());
		} catch (Exception e) {
