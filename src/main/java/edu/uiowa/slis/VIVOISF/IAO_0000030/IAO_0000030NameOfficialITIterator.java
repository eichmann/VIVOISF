...
public class IAO_0000030NameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameOfficialITIterator.class);
