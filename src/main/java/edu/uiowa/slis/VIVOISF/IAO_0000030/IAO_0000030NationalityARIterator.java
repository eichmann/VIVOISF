...
public class IAO_0000030NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NationalityARIterator.class);
