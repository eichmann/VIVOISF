...
public class IAO_0000030PopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030PopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030PopulationUnitIterator.class);
