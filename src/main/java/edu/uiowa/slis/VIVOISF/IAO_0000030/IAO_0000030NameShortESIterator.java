...
public class IAO_0000030NameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameShortESIterator.class);
