...
public class IAO_0000030NameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameShortFRIterator.class);
