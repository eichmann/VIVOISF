...
public class IAO_0000030NameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameListARIterator.class);
