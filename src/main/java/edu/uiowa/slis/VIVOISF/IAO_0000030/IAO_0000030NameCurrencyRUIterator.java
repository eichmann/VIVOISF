...
public class IAO_0000030NameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameCurrencyRUIterator.class);
