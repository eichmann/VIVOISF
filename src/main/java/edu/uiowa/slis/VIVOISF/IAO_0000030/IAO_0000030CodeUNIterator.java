...
public class IAO_0000030CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030CodeUNIterator.class);
