...
public class IAO_0000030NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameShortZHIterator.class);
