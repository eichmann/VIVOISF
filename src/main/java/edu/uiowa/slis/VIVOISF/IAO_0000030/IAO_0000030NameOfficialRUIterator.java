...
public class IAO_0000030NameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameOfficialRUIterator.class);
