...
public class IAO_0000030NameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameCurrencyITIterator.class);
