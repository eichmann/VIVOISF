...
public class IAO_0000030CodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030CodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030CodeFAOTERMIterator.class);
