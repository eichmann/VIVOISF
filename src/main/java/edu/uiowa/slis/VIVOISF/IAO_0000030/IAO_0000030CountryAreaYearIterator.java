...
public class IAO_0000030CountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030CountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030CountryAreaYearIterator.class);
