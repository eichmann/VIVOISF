...
public class IAO_0000030NameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030NameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030NameCurrencyESIterator.class);
