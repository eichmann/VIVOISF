...
public class IAO_0000030PopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static IAO_0000030PopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(IAO_0000030PopulationNotesIterator.class);
