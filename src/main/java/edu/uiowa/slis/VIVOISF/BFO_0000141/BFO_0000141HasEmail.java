...
public class BFO_0000141HasEmail extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141HasEmail currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141HasEmail.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000141HasEmailIterator.getHasEmail());
		} catch (Exception e) {
