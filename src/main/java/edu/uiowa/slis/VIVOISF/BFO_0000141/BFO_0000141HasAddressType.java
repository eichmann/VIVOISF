...
public class BFO_0000141HasAddressType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141HasAddressType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141HasAddressType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000141HasAddressIterator.getType());
		} catch (Exception e) {
