...
public class BFO_0000141CodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141CodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141CodeUNDPIterator.class);
