...
public class BFO_0000141CodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141CodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141CodeCurrencyIterator.class);
