...
public class BFO_0000141CodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141CodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141CodeFAOSTATIterator.class);
