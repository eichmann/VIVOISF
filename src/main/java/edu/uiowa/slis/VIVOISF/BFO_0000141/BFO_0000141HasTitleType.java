...
public class BFO_0000141HasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141HasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141HasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000141HasTitleIterator.getType());
		} catch (Exception e) {
