...
public class BFO_0000141AgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141AgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141AgriculturalAreaUnitIterator.class);
