...
public class BFO_0000141CodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141CodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141CodeDBPediaIDIterator.class);
