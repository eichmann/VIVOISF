...
public class BFO_0000141HasResearchArea extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141HasResearchArea currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141HasResearchArea.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000141HasResearchAreaIterator.getHasResearchArea());
		} catch (Exception e) {
