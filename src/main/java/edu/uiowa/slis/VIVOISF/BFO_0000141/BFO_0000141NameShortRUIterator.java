...
public class BFO_0000141NameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141NameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141NameShortRUIterator.class);
