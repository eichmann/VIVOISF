...
public class BFO_0000141HasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141HasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141HasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000141HasSubjectAreaIterator.getType());
		} catch (Exception e) {
