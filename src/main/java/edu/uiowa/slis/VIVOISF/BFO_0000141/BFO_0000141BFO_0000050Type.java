...
public class BFO_0000141BFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141BFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141BFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000141BFO_0000050Iterator.getType());
		} catch (Exception e) {
