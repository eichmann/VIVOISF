...
public class BFO_0000141LandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141LandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141LandAreaTotalIterator.class);
