...
public class BFO_0000141NameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141NameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141NameListITIterator.class);
