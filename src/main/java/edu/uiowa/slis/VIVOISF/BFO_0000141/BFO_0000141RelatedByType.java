...
public class BFO_0000141RelatedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141RelatedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141RelatedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000141RelatedByIterator.getType());
		} catch (Exception e) {
