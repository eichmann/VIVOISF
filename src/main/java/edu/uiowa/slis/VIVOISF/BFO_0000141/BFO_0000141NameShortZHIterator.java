...
public class BFO_0000141NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141NameShortZHIterator.class);
