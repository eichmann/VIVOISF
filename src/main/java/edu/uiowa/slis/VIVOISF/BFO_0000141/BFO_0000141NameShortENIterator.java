...
public class BFO_0000141NameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141NameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141NameShortENIterator.class);
