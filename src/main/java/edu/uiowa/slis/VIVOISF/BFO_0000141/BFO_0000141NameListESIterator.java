...
public class BFO_0000141NameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141NameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141NameListESIterator.class);
