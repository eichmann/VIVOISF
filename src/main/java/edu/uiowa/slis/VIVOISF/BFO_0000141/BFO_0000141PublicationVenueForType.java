...
public class BFO_0000141PublicationVenueForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141PublicationVenueForType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141PublicationVenueForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000141PublicationVenueForIterator.getType());
		} catch (Exception e) {
