...
public class BFO_0000141NameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141NameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141NameListZHIterator.class);
