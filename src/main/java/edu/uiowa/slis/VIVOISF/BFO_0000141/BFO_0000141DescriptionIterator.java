...
public class BFO_0000141DescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141DescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141DescriptionIterator.class);
