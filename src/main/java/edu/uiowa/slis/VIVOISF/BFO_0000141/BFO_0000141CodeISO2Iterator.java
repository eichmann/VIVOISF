...
public class BFO_0000141CodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141CodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141CodeISO2Iterator.class);
