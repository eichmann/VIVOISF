...
public class BFO_0000141NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141NameCurrencyARIterator.class);
