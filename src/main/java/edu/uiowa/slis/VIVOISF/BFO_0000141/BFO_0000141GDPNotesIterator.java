...
public class BFO_0000141GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000141GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000141GDPNotesIterator.class);
