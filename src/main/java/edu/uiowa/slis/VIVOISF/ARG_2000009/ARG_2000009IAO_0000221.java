...
public class ARG_2000009IAO_0000221 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000009IAO_0000221 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000009IAO_0000221.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000009IAO_0000221Iterator.getIAO_0000221());
		} catch (Exception e) {
