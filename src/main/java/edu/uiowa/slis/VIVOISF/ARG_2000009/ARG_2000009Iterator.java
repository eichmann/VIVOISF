...
public class ARG_2000009Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000009Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000009Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.obolibrary.org/obo/ARG_2000009> . "+
