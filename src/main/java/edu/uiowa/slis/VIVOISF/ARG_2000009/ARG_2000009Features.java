...
public class ARG_2000009Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000009Features currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000009Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000009FeaturesIterator.getFeatures());
		} catch (Exception e) {
