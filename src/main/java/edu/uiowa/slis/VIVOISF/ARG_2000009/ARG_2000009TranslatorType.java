...
public class ARG_2000009TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000009TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000009TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000009TranslatorIterator.getType());
		} catch (Exception e) {
