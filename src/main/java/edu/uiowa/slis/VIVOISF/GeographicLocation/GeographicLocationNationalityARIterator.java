...
public class GeographicLocationNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNationalityARIterator.class);
