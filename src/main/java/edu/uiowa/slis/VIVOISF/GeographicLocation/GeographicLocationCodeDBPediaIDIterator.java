...
public class GeographicLocationCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCodeDBPediaIDIterator.class);
