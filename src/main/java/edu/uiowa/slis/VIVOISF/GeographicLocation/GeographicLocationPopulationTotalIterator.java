...
public class GeographicLocationPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationPopulationTotalIterator.class);
