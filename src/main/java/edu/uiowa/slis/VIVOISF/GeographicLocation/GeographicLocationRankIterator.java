...
public class GeographicLocationRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationRankIterator.class);
