...
public class GeographicLocationUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationUrlIterator.class);
