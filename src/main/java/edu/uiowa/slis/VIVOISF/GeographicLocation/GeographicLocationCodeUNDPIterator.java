...
public class GeographicLocationCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCodeUNDPIterator.class);
