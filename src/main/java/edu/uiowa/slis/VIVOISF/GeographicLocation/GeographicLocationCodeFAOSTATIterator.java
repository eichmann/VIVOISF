...
public class GeographicLocationCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCodeFAOSTATIterator.class);
