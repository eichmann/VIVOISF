...
public class GeographicLocationNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameListENIterator.class);
