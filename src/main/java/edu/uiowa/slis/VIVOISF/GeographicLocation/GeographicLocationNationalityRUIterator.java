...
public class GeographicLocationNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNationalityRUIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nationalityRU = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNationalityRU(String theNationalityRU) {
		nationalityRU = theNationalityRU;
	}
