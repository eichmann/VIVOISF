...
public class GeographicLocationCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCodeCurrencyIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				codeCurrency = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setCodeCurrency(String theCodeCurrency) {
		codeCurrency = theCodeCurrency;
	}
