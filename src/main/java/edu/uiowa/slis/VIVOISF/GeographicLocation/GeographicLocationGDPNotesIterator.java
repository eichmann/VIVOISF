...
public class GeographicLocationGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationGDPNotesIterator.class);
