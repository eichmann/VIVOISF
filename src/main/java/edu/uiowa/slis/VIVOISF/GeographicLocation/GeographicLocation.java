...
public class GeographicLocation extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocation currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocation.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			GeographicLocationIterator theGeographicLocationIterator = (GeographicLocationIterator) findAncestorWithClass(this, GeographicLocationIterator.class);

			if (theGeographicLocationIterator != null) {
				subjectURI = theGeographicLocationIterator.getSubjectURI();
				label = theGeographicLocationIterator.getLabel();
			}
			...
			if (theGeographicLocationIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in GeographicLocation doStartTag", e);
			throw new JspTagException("Exception raised in GeographicLocation doStartTag");
		} finally {
			freeConnection();
		}
