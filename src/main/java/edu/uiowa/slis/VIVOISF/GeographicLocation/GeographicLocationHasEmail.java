...
public class GeographicLocationHasEmail extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationHasEmail currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationHasEmail.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeographicLocationHasEmailIterator.getHasEmail());
		} catch (Exception e) {
