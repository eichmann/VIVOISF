...
public class GeographicLocationIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://vivoweb.org/ontology/core#GeographicLocation> . "+
