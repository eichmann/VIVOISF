...
public class GeographicLocationNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameListARIterator.class);
