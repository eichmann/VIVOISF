...
public class GeographicLocationNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameShortENIterator.class);
