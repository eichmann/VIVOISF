...
public class GeographicLocationNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameShortZHIterator.class);
