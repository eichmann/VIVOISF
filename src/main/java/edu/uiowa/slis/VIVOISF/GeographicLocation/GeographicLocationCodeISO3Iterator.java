...
public class GeographicLocationCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCodeISO3Iterator.class);
