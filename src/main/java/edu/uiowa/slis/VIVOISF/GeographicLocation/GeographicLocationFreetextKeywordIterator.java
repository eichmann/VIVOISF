...
public class GeographicLocationFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationFreetextKeywordIterator.class);
