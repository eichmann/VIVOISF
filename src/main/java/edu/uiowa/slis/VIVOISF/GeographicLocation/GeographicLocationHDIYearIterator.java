...
public class GeographicLocationHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationHDIYearIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				HDIYear = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setHDIYear(String theHDIYear) {
		HDIYear = theHDIYear;
	}
