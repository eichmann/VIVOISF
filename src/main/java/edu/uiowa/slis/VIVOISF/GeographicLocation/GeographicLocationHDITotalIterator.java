...
public class GeographicLocationHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationHDITotalIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				HDITotal = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setHDITotal(String theHDITotal) {
		HDITotal = theHDITotal;
	}
