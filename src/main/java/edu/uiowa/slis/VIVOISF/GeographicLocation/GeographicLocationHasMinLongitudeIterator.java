...
public class GeographicLocationHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationHasMinLongitudeIterator.class);
