...
public class GeographicLocationHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationHasMinLatitudeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				hasMinLatitude = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setHasMinLatitude(String theHasMinLatitude) {
		hasMinLatitude = theHasMinLatitude;
	}
