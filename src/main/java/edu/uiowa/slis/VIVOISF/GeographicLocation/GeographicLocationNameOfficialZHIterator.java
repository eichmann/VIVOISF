...
public class GeographicLocationNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameOfficialZHIterator.class);
