...
public class GeographicLocationCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCodeAGROVOCIterator.class);
