...
public class GeographicLocationNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNationalityZHIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nationalityZH = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNationalityZH(String theNationalityZH) {
		nationalityZH = theNationalityZH;
	}
