...
public class GeographicLocationCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCodeUNIterator.class);
