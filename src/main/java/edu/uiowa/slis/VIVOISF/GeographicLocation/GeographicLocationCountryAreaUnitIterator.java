...
public class GeographicLocationCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCountryAreaUnitIterator.class);
