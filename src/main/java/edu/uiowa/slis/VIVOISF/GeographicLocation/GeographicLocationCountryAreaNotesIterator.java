...
public class GeographicLocationCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCountryAreaNotesIterator.class);
