...
public class GeographicLocationNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameListFRIterator.class);
