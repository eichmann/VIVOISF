...
public class GeographicLocationNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNationalityESIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nationalityES = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNationalityES(String theNationalityES) {
		nationalityES = theNationalityES;
	}
