...
public class GeographicLocationLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationLandAreaYearIterator.class);
