...
public class GeographicLocationNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameShortESIterator.class);
