...
public class GeographicLocationGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationGDPUnitIterator.class);
