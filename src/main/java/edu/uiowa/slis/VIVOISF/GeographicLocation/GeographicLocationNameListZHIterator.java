...
public class GeographicLocationNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameListZHIterator.class);
