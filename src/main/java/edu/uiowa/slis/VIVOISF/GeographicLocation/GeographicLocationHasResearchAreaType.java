...
public class GeographicLocationHasResearchAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationHasResearchAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationHasResearchAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeographicLocationHasResearchAreaIterator.getType());
		} catch (Exception e) {
