...
public class GeographicLocationNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameOfficialRUIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nameOfficialRU = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNameOfficialRU(String theNameOfficialRU) {
		nameOfficialRU = theNameOfficialRU;
	}
