...
public class GeographicLocationCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCodeISO2Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				codeISO2 = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setCodeISO2(String theCodeISO2) {
		codeISO2 = theCodeISO2;
	}
