...
public class GeographicLocationNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameOfficialFRIterator.class);
