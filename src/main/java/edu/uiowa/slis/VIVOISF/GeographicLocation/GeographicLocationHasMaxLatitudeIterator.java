...
public class GeographicLocationHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationHasMaxLatitudeIterator.class);
