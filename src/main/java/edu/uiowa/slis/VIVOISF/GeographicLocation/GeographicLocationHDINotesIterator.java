...
public class GeographicLocationHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationHDINotesIterator.class);
