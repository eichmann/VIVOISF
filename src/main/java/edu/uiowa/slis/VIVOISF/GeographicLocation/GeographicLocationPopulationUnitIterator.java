...
public class GeographicLocationPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationPopulationUnitIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				populationUnit = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setPopulationUnit(String thePopulationUnit) {
		populationUnit = thePopulationUnit;
	}
