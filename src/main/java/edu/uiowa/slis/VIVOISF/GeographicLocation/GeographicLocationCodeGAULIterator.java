...
public class GeographicLocationCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationCodeGAULIterator.class);
