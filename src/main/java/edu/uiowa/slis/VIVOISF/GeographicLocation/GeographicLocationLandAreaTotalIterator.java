...
public class GeographicLocationLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationLandAreaTotalIterator.class);
