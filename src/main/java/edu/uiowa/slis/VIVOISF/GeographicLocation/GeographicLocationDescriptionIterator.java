...
public class GeographicLocationDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationDescriptionIterator.class);
