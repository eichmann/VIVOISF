...
public class GeographicLocationNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameShortITIterator.class);
