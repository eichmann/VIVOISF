...
public class GeographicLocationARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGeographicLocationARG_2000028Iterator.getType());
		} catch (Exception e) {
