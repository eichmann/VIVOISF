...
public class GeographicLocationNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNationalityFRIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if(rs.hasNext()) {
				...
				nationalityFR = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setNationalityFR(String theNationalityFR) {
		nationalityFR = theNationalityFR;
	}
