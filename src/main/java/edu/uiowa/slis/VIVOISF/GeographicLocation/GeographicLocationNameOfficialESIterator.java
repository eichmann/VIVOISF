...
public class GeographicLocationNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationNameOfficialESIterator.class);
