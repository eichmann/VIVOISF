...
public class GeographicLocationGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicLocationGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicLocationGDPYearIterator.class);
