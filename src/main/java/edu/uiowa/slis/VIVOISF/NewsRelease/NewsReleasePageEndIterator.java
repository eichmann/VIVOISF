...
public class NewsReleasePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleasePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleasePageEndIterator.class);
