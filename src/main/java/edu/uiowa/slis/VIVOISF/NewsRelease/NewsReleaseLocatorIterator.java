...
public class NewsReleaseLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseLocatorIterator.class);
