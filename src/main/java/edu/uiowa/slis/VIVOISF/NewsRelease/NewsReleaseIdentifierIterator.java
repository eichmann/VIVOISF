...
public class NewsReleaseIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseIdentifierIterator.class);
