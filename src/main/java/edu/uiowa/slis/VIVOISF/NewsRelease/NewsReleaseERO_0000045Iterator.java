...
public class NewsReleaseERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseERO_0000045Iterator.class);
