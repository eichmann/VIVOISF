...
public class NewsReleasePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleasePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleasePmidIterator.class);
