...
public class NewsReleaseShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseShortDescriptionIterator.class);
