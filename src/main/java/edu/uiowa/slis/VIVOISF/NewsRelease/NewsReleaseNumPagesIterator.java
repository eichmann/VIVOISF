...
public class NewsReleaseNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseNumPagesIterator.class);
