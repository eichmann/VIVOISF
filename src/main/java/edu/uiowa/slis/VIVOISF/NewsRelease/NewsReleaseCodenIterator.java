...
public class NewsReleaseCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseCodenIterator.class);
