...
public class NewsReleaseInformationResourceSupportedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseInformationResourceSupportedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseInformationResourceSupportedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewsReleaseInformationResourceSupportedByIterator.getInformationResourceSupportedBy());
		} catch (Exception e) {
