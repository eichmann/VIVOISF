...
public class NewsReleaseTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseTheAbstractIterator.class);
