...
public class NewsReleaseHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseHandleIterator.class);
