...
public class NewsReleaseVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseVolumeIterator.class);
