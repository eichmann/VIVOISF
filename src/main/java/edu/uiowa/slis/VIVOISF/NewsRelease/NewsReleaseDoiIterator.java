...
public class NewsReleaseDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseDoiIterator.class);
