...
public class NewsReleaseEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseEanucc13Iterator.class);
