...
public class NewsReleaseUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseUriIterator.class);
