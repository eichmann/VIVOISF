...
public class NewsReleaseOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseOclcnumIterator.class);
