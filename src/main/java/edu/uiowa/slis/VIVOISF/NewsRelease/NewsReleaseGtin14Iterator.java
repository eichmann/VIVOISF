...
public class NewsReleaseGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseGtin14Iterator.class);
