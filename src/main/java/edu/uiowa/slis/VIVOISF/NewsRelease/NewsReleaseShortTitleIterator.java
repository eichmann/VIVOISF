...
public class NewsReleaseShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseShortTitleIterator.class);
