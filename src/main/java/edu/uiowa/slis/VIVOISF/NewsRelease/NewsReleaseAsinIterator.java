...
public class NewsReleaseAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseAsinIterator.class);
