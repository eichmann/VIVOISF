...
public class NewsReleaseNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseNumberIterator.class);
