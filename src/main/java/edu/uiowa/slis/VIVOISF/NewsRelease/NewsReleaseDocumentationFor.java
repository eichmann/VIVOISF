...
public class NewsReleaseDocumentationFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseDocumentationFor currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseDocumentationFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNewsReleaseDocumentationForIterator.getDocumentationFor());
		} catch (Exception e) {
