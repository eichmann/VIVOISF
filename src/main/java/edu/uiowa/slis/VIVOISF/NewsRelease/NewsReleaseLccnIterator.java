...
public class NewsReleaseLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseLccnIterator.class);
