...
public class NewsReleaseSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseSiciIterator.class);
