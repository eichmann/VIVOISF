...
public class NewsReleaseContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NewsReleaseContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NewsReleaseContentIterator.class);
