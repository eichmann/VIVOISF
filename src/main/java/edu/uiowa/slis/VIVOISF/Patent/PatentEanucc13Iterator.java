...
public class PatentEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentEanucc13Iterator.class);
