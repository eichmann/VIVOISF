...
public class PatentProducerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentProducerType currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentProducerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePatentProducerIterator.getType());
		} catch (Exception e) {
