...
public class PatentGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentGtin14Iterator.class);
