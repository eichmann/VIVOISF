...
public class PatentTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentTheAbstractIterator.class);
