...
public class PatentEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentEditionIterator.class);
