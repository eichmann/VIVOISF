...
public class PatentPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentPagesIterator.class);
