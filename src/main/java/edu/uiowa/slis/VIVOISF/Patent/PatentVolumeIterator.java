...
public class PatentVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentVolumeIterator.class);
