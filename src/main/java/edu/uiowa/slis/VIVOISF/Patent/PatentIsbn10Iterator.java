...
public class PatentIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentIsbn10Iterator.class);
