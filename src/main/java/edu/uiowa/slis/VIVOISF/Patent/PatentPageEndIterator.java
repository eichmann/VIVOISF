...
public class PatentPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentPageEndIterator.class);
