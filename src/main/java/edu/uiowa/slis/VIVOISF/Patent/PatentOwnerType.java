...
public class PatentOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePatentOwnerIterator.getType());
		} catch (Exception e) {
