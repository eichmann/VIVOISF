...
public class PatentNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentNumberIterator.class);
