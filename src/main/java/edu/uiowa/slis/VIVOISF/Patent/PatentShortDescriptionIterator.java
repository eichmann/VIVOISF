...
public class PatentShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentShortDescriptionIterator.class);
