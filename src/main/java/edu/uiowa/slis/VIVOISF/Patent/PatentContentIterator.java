...
public class PatentContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentContentIterator.class);
