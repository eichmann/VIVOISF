...
public class PatentIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentIdentifierIterator.class);
