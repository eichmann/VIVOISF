...
public class PatentDateFiledType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentDateFiledType currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentDateFiledType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePatentDateFiledIterator.getType());
		} catch (Exception e) {
