...
public class PatentERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentERO_0000045Iterator.class);
