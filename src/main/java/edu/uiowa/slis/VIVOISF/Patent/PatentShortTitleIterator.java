...
public class PatentShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentShortTitleIterator.class);
