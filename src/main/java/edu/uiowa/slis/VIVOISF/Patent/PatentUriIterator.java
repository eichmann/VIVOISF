...
public class PatentUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentUriIterator.class);
