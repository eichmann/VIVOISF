...
public class PatentAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentAsinIterator.class);
