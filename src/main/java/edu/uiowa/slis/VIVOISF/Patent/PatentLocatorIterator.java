...
public class PatentLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentLocatorIterator.class);
