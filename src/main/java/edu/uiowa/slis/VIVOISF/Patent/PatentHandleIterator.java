...
public class PatentHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentHandleIterator.class);
