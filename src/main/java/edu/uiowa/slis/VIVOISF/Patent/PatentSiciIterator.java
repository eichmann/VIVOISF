...
public class PatentSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentSiciIterator.class);
