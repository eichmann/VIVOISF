...
public class PatentReviewOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentReviewOf currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentReviewOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePatentReviewOfIterator.getReviewOf());
		} catch (Exception e) {
