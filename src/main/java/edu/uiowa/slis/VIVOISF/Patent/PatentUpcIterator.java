...
public class PatentUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentUpcIterator.class);
