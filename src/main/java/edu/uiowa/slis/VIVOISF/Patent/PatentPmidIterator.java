...
public class PatentPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentPmidIterator.class);
