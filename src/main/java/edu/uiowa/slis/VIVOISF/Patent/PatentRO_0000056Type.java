...
public class PatentRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePatentRO_0000056Iterator.getType());
		} catch (Exception e) {
