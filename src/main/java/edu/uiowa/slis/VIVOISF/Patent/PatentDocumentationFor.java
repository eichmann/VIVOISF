...
public class PatentDocumentationFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentDocumentationFor currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentDocumentationFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(thePatentDocumentationForIterator.getDocumentationFor());
		} catch (Exception e) {
