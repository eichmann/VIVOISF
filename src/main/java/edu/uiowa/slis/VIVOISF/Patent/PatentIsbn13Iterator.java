...
public class PatentIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentIsbn13Iterator.class);
