...
public class PatentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/Patent> . "+
