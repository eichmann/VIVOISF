...
public class PatentSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentSectionIterator.class);
