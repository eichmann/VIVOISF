...
public class PatentARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentARG_0000001Iterator.class);
