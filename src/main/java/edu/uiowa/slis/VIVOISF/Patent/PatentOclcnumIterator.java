...
public class PatentOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentOclcnumIterator.class);
