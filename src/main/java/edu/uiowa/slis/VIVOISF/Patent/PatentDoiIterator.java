...
public class PatentDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentDoiIterator.class);
