...
public class PatentLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static PatentLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PatentLccnIterator.class);
