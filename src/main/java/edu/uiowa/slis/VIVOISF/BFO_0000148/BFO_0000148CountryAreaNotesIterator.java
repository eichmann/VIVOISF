...
public class BFO_0000148CountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148CountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148CountryAreaNotesIterator.class);
