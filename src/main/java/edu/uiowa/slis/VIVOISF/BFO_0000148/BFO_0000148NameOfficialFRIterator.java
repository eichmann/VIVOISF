...
public class BFO_0000148NameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NameOfficialFRIterator.class);
