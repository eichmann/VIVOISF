...
public class BFO_0000148PublicationVenueForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148PublicationVenueForType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148PublicationVenueForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000148PublicationVenueForIterator.getType());
		} catch (Exception e) {
