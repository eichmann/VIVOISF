...
public class BFO_0000148RO_0002234 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148RO_0002234 currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148RO_0002234.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000148RO_0002234Iterator.getRO_0002234());
		} catch (Exception e) {
