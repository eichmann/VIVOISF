...
public class BFO_0000148CodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148CodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148CodeUNIterator.class);
