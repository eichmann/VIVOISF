...
public class BFO_0000148AgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148AgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148AgriculturalAreaYearIterator.class);
