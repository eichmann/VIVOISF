...
public class BFO_0000148HasAddress extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148HasAddress currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148HasAddress.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000148HasAddressIterator.getHasAddress());
		} catch (Exception e) {
