...
public class BFO_0000148RelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148RelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148RelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000148RelatesIterator.getType());
		} catch (Exception e) {
