...
public class BFO_0000148PublisherType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148PublisherType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148PublisherType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000148PublisherIterator.getType());
		} catch (Exception e) {
