...
public class BFO_0000148HasPublicationVenueType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148HasPublicationVenueType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148HasPublicationVenueType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000148HasPublicationVenueIterator.getType());
		} catch (Exception e) {
