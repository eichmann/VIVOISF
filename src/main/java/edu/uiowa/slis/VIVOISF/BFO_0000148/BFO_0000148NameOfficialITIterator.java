...
public class BFO_0000148NameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NameOfficialITIterator.class);
