...
public class BFO_0000148RankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148RankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148RankIterator.class);
