...
public class BFO_0000148AgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148AgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148AgriculturalAreaNotesIterator.class);
