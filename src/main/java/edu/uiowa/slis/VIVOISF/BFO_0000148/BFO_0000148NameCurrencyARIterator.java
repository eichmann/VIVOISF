...
public class BFO_0000148NameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NameCurrencyARIterator.class);
