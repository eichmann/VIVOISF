...
public class BFO_0000148HDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148HDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148HDITotalIterator.class);
