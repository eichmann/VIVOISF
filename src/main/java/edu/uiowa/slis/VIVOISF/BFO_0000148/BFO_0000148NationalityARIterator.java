...
public class BFO_0000148NationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NationalityARIterator.class);
