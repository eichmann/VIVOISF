...
public class BFO_0000148NationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NationalityITIterator.class);
