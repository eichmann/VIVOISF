...
public class BFO_0000148NameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NameCurrencyENIterator.class);
