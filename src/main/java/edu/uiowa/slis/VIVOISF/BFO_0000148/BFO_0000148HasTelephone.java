...
public class BFO_0000148HasTelephone extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148HasTelephone currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148HasTelephone.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000148HasTelephoneIterator.getHasTelephone());
		} catch (Exception e) {
