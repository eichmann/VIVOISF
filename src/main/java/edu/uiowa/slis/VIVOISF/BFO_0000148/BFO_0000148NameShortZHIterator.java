...
public class BFO_0000148NameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NameShortZHIterator.class);
