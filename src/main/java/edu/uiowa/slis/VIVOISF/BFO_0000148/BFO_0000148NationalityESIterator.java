...
public class BFO_0000148NationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NationalityESIterator.class);
