...
public class BFO_0000148FreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148FreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148FreetextKeywordIterator.class);
