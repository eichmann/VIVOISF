...
public class BFO_0000148GDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148GDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148GDPNotesIterator.class);
