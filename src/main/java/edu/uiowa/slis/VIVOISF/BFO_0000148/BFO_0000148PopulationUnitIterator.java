...
public class BFO_0000148PopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148PopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148PopulationUnitIterator.class);
