...
public class BFO_0000148NameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NameOfficialESIterator.class);
