...
public class BFO_0000148NationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NationalityRUIterator.class);
