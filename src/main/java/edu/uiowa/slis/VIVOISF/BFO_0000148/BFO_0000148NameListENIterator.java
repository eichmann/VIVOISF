...
public class BFO_0000148NameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NameListENIterator.class);
