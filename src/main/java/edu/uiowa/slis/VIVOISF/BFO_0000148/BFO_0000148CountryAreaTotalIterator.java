...
public class BFO_0000148CountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148CountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148CountryAreaTotalIterator.class);
