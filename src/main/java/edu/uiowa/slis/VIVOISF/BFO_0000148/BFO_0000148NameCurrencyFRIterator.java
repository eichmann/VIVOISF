...
public class BFO_0000148NameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NameCurrencyFRIterator.class);
