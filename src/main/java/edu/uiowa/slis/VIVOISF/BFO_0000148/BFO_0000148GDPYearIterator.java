...
public class BFO_0000148GDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148GDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148GDPYearIterator.class);
