...
public class BFO_0000148HasSubjectAreaType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148HasSubjectAreaType currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148HasSubjectAreaType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000148HasSubjectAreaIterator.getType());
		} catch (Exception e) {
