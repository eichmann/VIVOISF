...
public class BFO_0000148NameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148NameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148NameCurrencyESIterator.class);
