...
public class BFO_0000148HDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148HDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148HDIYearIterator.class);
