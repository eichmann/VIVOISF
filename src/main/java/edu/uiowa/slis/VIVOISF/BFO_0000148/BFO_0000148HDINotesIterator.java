...
public class BFO_0000148HDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148HDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148HDINotesIterator.class);
