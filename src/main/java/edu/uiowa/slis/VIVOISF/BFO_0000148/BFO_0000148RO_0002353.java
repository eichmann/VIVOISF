...
public class BFO_0000148RO_0002353 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BFO_0000148RO_0002353 currentInstance = null;
	private static final Log log = LogFactory.getLog(BFO_0000148RO_0002353.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBFO_0000148RO_0002353Iterator.getRO_0002353());
		} catch (Exception e) {
