...
public class territoryMiddleNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryMiddleNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryMiddleNameIterator.class);
