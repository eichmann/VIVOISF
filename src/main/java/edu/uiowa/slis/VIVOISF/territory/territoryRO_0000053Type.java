...
public class territoryRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theterritoryRO_0000053Iterator.getType());
		} catch (Exception e) {
