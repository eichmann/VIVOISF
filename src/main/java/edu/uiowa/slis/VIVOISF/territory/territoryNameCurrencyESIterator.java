...
public class territoryNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryNameCurrencyESIterator.class);
