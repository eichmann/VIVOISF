...
public class territoryCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryCodeFAOTERMIterator.class);
