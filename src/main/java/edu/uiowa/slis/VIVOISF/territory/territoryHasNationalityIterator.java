...
public class territoryHasNationalityIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryHasNationalityIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryHasNationalityIterator.class);
