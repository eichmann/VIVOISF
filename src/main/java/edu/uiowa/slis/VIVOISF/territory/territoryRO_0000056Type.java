...
public class territoryRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theterritoryRO_0000056Iterator.getType());
		} catch (Exception e) {
