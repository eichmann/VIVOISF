...
public class territoryNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryNameListZHIterator.class);
