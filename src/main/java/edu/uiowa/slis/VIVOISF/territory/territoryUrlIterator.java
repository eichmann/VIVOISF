...
public class territoryUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryUrlIterator.class);
