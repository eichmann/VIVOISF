...
public class territorySourceCreatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territorySourceCreatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territorySourceCreatorIterator.class);
