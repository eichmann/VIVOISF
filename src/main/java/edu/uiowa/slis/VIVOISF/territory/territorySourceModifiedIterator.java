...
public class territorySourceModifiedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territorySourceModifiedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territorySourceModifiedIterator.class);
