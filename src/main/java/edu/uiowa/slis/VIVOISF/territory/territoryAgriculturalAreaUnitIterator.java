...
public class territoryAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryAgriculturalAreaUnitIterator.class);
