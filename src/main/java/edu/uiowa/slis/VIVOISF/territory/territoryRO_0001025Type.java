...
public class territoryRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theterritoryRO_0001025Iterator.getType());
		} catch (Exception e) {
