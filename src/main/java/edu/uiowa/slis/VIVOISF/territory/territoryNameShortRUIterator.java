...
public class territoryNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryNameShortRUIterator.class);
