...
public class territoryHasTelephoneType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryHasTelephoneType currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryHasTelephoneType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theterritoryHasTelephoneIterator.getType());
		} catch (Exception e) {
