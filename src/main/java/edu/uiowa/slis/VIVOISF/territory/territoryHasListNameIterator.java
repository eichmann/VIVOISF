...
public class territoryHasListNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryHasListNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryHasListNameIterator.class);
