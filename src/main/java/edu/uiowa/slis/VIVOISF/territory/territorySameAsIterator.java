...
public class territorySameAsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territorySameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territorySameAsIterator.class);
