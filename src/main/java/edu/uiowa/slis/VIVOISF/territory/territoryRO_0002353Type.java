...
public class territoryRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theterritoryRO_0002353Iterator.getType());
		} catch (Exception e) {
