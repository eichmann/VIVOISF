...
public class territoryBottomDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryBottomDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryBottomDataPropertyIterator.class);
