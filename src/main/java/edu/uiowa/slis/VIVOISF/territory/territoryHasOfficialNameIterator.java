...
public class territoryHasOfficialNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryHasOfficialNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryHasOfficialNameIterator.class);
