...
public class territoryNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryNationalityARIterator.class);
