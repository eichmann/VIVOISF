...
public class territorySourceIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territorySourceIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territorySourceIdentifierIterator.class);
