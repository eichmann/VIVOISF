...
public class territoryTopObjectPropertyInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryTopObjectPropertyInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryTopObjectPropertyInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in territoryTopObjectPropertyInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in territoryTopObjectPropertyInverseIterator doStartTag");
		}
