...
public class territoryHasShortNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryHasShortNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryHasShortNameIterator.class);
