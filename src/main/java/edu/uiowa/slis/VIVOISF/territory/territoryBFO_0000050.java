...
public class territoryBFO_0000050 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryBFO_0000050 currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryBFO_0000050.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theterritoryBFO_0000050Iterator.getBFO_0000050());
		} catch (Exception e) {
