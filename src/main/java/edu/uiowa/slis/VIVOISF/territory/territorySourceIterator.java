...
public class territorySourceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territorySourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territorySourceIterator.class);
