...
public class territoryCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryCountryAreaTotalIterator.class);
