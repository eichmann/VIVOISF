...
public class territoryHasCodeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryHasCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryHasCodeIterator.class);
