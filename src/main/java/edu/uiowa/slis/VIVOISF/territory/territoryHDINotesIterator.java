...
public class territoryHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryHDINotesIterator.class);
