...
public class territoryARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theterritoryARG_2000028Iterator.getType());
		} catch (Exception e) {
