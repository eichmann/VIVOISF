...
public class territoryHasStatisticsIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryHasStatisticsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryHasStatisticsIterator.class);
