...
public class territoryTopDataPropertyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryTopDataPropertyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryTopDataPropertyIterator.class);
