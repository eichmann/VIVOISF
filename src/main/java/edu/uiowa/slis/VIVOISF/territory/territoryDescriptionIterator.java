...
public class territoryDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryDescriptionIterator.class);
