...
public class territoryFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryFreetextKeywordIterator.class);
