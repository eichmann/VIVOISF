...
public class territoryRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryRankIterator.class);
