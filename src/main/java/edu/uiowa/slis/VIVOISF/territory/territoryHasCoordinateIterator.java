...
public class territoryHasCoordinateIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryHasCoordinateIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryHasCoordinateIterator.class);
