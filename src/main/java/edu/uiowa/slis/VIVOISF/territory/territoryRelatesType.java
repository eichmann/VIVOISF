...
public class territoryRelatesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static territoryRelatesType currentInstance = null;
	private static final Log log = LogFactory.getLog(territoryRelatesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theterritoryRelatesIterator.getType());
		} catch (Exception e) {
