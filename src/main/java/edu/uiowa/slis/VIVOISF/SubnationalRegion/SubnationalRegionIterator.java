...
public class SubnationalRegionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SubnationalRegionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(SubnationalRegionIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#SubnationalRegion> . "+
