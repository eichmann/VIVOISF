...
public class SubnationalRegionRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SubnationalRegionRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SubnationalRegionRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSubnationalRegionRO_0000056Iterator.getType());
		} catch (Exception e) {
