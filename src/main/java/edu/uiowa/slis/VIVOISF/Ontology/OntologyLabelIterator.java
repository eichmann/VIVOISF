...
public class OntologyLabelIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OntologyLabelIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OntologyLabelIterator.class);
