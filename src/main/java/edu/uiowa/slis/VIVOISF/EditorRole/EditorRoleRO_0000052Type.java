...
public class EditorRoleRO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EditorRoleRO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EditorRoleRO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEditorRoleRO_0000052Iterator.getType());
		} catch (Exception e) {
