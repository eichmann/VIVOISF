...
public class GrantRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GrantRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GrantRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGrantRO_0000056Iterator.getType());
		} catch (Exception e) {
