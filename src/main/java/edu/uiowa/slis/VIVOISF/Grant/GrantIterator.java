...
public class GrantIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GrantIterator currentInstance = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#Grant> . "+
