...
public class ERO_0000786BFO_0000054 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000786BFO_0000054 currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000786BFO_0000054.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000786BFO_0000054Iterator.getBFO_0000054());
		} catch (Exception e) {
