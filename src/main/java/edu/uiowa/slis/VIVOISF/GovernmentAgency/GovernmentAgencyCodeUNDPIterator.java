...
public class GovernmentAgencyCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCodeUNDPIterator.class);
