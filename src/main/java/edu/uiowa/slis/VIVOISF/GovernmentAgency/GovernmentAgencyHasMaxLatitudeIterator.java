...
public class GovernmentAgencyHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyHasMaxLatitudeIterator.class);
