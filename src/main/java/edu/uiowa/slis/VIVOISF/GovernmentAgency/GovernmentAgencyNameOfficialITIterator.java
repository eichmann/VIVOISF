...
public class GovernmentAgencyNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameOfficialITIterator.class);
