...
public class GovernmentAgencyCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCodeCurrencyIterator.class);
