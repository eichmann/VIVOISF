...
public class GovernmentAgencyNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNationalityESIterator.class);
