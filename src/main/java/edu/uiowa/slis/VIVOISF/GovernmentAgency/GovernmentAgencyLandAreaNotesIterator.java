...
public class GovernmentAgencyLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyLandAreaNotesIterator.class);
