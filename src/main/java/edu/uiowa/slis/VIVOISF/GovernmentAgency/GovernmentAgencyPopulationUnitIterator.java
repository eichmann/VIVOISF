...
public class GovernmentAgencyPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyPopulationUnitIterator.class);
