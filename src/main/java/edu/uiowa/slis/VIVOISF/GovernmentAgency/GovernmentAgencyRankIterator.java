...
public class GovernmentAgencyRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyRankIterator.class);
