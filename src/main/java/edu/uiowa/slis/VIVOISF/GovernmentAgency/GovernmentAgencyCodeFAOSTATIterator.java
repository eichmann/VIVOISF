...
public class GovernmentAgencyCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCodeFAOSTATIterator.class);
