...
public class GovernmentAgencyERO_0001520Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyERO_0001520Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyERO_0001520Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencyERO_0001520Iterator.getType());
		} catch (Exception e) {
