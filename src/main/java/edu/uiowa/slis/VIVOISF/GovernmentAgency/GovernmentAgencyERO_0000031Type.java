...
public class GovernmentAgencyERO_0000031Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyERO_0000031Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyERO_0000031Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencyERO_0000031Iterator.getType());
		} catch (Exception e) {
