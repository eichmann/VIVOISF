...
public class GovernmentAgencyNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameOfficialARIterator.class);
