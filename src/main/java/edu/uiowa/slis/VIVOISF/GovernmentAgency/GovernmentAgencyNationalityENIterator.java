...
public class GovernmentAgencyNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNationalityENIterator.class);
