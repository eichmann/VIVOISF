...
public class GovernmentAgencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyIterator.class);
