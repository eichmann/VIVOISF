...
public class GovernmentAgencyCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCodeDBPediaIDIterator.class);
