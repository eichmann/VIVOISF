...
public class GovernmentAgencyBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencyBFO_0000051Iterator.getType());
		} catch (Exception e) {
