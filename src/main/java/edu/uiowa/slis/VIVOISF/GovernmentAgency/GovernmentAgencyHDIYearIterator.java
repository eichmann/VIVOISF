...
public class GovernmentAgencyHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyHDIYearIterator.class);
