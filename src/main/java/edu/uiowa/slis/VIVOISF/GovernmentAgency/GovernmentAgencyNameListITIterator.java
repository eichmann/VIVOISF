...
public class GovernmentAgencyNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameListITIterator.class);
