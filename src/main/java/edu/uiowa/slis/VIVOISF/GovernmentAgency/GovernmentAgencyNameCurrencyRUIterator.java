...
public class GovernmentAgencyNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameCurrencyRUIterator.class);
