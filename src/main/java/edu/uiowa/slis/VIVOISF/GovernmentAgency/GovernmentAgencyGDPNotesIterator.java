...
public class GovernmentAgencyGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyGDPNotesIterator.class);
