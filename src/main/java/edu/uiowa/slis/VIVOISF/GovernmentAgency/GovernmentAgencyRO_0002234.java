...
public class GovernmentAgencyRO_0002234 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyRO_0002234 currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyRO_0002234.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencyRO_0002234Iterator.getRO_0002234());
		} catch (Exception e) {
