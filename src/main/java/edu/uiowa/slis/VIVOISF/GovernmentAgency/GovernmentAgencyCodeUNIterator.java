...
public class GovernmentAgencyCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCodeUNIterator.class);
