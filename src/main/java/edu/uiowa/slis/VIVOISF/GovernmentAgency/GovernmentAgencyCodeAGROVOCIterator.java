...
public class GovernmentAgencyCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCodeAGROVOCIterator.class);
