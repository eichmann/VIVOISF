...
public class GovernmentAgencyGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyGDPYearIterator.class);
