...
public class GovernmentAgencyGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyGDPUnitIterator.class);
