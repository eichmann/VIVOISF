...
public class GovernmentAgencyNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameCurrencyESIterator.class);
