...
public class GovernmentAgencyHasURLType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyHasURLType currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyHasURLType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencyHasURLIterator.getType());
		} catch (Exception e) {
