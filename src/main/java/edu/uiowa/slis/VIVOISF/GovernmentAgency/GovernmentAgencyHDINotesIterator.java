...
public class GovernmentAgencyHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyHDINotesIterator.class);
