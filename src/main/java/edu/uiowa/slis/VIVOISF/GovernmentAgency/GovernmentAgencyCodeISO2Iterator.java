...
public class GovernmentAgencyCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCodeISO2Iterator.class);
