...
public class GovernmentAgencyNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameShortFRIterator.class);
