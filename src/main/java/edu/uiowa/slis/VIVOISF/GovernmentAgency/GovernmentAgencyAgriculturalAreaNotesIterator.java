...
public class GovernmentAgencyAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyAgriculturalAreaNotesIterator.class);
