...
public class GovernmentAgencyPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyPopulationTotalIterator.class);
