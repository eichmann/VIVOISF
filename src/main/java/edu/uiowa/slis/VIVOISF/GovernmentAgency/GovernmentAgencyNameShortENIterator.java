...
public class GovernmentAgencyNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameShortENIterator.class);
