...
public class GovernmentAgencySubcontractsGrantType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencySubcontractsGrantType currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencySubcontractsGrantType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencySubcontractsGrantIterator.getType());
		} catch (Exception e) {
