...
public class GovernmentAgencyNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameOfficialENIterator.class);
