...
public class GovernmentAgencyNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameListARIterator.class);
