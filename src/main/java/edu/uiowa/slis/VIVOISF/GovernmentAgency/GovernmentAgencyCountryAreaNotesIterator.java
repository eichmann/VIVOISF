...
public class GovernmentAgencyCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCountryAreaNotesIterator.class);
