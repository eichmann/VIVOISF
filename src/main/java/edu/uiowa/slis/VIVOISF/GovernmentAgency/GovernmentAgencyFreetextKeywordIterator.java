...
public class GovernmentAgencyFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyFreetextKeywordIterator.class);
