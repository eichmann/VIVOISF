...
public class GovernmentAgencyNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameShortRUIterator.class);
