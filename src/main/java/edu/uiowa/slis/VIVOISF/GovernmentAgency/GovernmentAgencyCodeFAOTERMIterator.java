...
public class GovernmentAgencyCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCodeFAOTERMIterator.class);
