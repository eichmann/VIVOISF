...
public class GovernmentAgencyNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameListZHIterator.class);
