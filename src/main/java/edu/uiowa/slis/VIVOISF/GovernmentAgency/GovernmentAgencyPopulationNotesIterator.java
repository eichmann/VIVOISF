...
public class GovernmentAgencyPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyPopulationNotesIterator.class);
