...
public class GovernmentAgencyHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyHasMaxLongitudeIterator.class);
