...
public class GovernmentAgencyNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameShortITIterator.class);
