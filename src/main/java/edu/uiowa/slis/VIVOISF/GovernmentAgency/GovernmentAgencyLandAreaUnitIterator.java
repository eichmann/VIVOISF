...
public class GovernmentAgencyLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyLandAreaUnitIterator.class);
