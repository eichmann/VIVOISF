...
public class GovernmentAgencyHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyHasMinLongitudeIterator.class);
