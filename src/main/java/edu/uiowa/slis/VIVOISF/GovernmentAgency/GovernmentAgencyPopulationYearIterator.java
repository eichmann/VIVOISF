...
public class GovernmentAgencyPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyPopulationYearIterator.class);
