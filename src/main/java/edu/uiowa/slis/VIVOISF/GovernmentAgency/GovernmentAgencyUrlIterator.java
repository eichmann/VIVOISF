...
public class GovernmentAgencyUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyUrlIterator.class);
