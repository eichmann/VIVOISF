...
public class GovernmentAgencyOBI_0000304Inverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyOBI_0000304Inverse currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyOBI_0000304Inverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencyOBI_0000304InverseIterator.getOBI_0000304Inverse());
		} catch (Exception e) {
