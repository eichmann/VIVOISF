...
public class GovernmentAgencyNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameListENIterator.class);
