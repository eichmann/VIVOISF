...
public class GovernmentAgencyNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameShortZHIterator.class);
