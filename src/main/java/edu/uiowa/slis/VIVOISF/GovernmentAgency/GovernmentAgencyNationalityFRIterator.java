...
public class GovernmentAgencyNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNationalityFRIterator.class);
