...
public class GovernmentAgencyHasCollaboratorInverseIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyHasCollaboratorInverseIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyHasCollaboratorInverseIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in GovernmentAgencyHasCollaboratorInverseIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in GovernmentAgencyHasCollaboratorInverseIterator doStartTag");
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to GovernmentAgencyHasCollaboratorIterator");
