...
public class GovernmentAgencyNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNationalityARIterator.class);
