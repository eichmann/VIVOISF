...
public class GovernmentAgencyInterviewerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyInterviewerType currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyInterviewerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencyInterviewerIterator.getType());
		} catch (Exception e) {
