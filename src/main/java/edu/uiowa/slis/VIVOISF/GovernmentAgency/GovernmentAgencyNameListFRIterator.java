...
public class GovernmentAgencyNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameListFRIterator.class);
