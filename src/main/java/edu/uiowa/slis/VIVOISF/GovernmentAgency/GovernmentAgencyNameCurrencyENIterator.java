...
public class GovernmentAgencyNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameCurrencyENIterator.class);
