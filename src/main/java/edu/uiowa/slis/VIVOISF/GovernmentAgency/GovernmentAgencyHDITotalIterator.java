...
public class GovernmentAgencyHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyHDITotalIterator.class);
