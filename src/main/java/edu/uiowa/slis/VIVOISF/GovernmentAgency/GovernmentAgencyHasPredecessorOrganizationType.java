...
public class GovernmentAgencyHasPredecessorOrganizationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyHasPredecessorOrganizationType currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyHasPredecessorOrganizationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencyHasPredecessorOrganizationIterator.getType());
		} catch (Exception e) {
