...
public class GovernmentAgencyNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameShortESIterator.class);
