...
public class GovernmentAgencyCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCodeISO3Iterator.class);
