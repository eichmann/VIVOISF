...
public class GovernmentAgencyGeographicFocusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyGeographicFocusType currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyGeographicFocusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencyGeographicFocusIterator.getType());
		} catch (Exception e) {
