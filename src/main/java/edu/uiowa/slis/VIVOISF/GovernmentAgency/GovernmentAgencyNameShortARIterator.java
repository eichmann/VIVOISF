...
public class GovernmentAgencyNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameShortARIterator.class);
