...
public class GovernmentAgencySuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencySuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencySuffixNameIterator.class);
