...
public class GovernmentAgencyRO_0002353 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyRO_0002353 currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyRO_0002353.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentAgencyRO_0002353Iterator.getRO_0002353());
		} catch (Exception e) {
