...
public class GovernmentAgencyPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyPrefixNameIterator.class);
