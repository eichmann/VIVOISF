...
public class GovernmentAgencyNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyNameOfficialFRIterator.class);
