...
public class GovernmentAgencyCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCountryAreaTotalIterator.class);
