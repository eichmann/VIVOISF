...
public class GovernmentAgencyCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyCodeGAULIterator.class);
