...
public class GovernmentAgencyLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GovernmentAgencyLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentAgencyLandAreaYearIterator.class);
