...
public class AdvisingProcessBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AdvisingProcessBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(AdvisingProcessBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theAdvisingProcessBFO_0000055Iterator.getType());
		} catch (Exception e) {
