...
public class FunctionalPropertyDisplayRankAnnotIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FunctionalPropertyDisplayRankAnnotIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FunctionalPropertyDisplayRankAnnotIterator.class);
