...
public class FunctionalPropertyIAO_0000112Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FunctionalPropertyIAO_0000112Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FunctionalPropertyIAO_0000112Iterator.class);

	static boolean firstInstance = false;
	static boolean lastInstance = false;

	String subjectURI = null;
	String IAO_0000112 = null;
	ResultSet rs = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://purl.obolibrary.org/obo/IAO_0000112> ?s } ");
			if(rs.hasNext()) {
				QuerySolution sol = rs.nextSolution();
				IAO_0000112 = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setIAO_0000112(String theIAO_0000112) {
		IAO_0000112 = theIAO_0000112;
	}

	public String getIAO_0000112() {
		return IAO_0000112;
	}
