...
public class FunctionalPropertyIAO_0000116Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FunctionalPropertyIAO_0000116Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FunctionalPropertyIAO_0000116Iterator.class);

	static boolean firstInstance = false;
	static boolean lastInstance = false;

	String subjectURI = null;
	String IAO_0000116 = null;
	ResultSet rs = null;
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://purl.obolibrary.org/obo/IAO_0000116> ?s } ");
			if(rs.hasNext()) {
				QuerySolution sol = rs.nextSolution();
				IAO_0000116 = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
				firstInstance = true;
	...
	public void setIAO_0000116(String theIAO_0000116) {
		IAO_0000116 = theIAO_0000116;
	}

	public String getIAO_0000116() {
		return IAO_0000116;
	}
