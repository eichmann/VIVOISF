...
public class FunctionalPropertyTheTypeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FunctionalPropertyTheTypeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FunctionalPropertyTheTypeIterator.class);
