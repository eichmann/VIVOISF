...
public class ERO_0000005Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000005Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000005Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.obolibrary.org/obo/ERO_0000005> . "+
