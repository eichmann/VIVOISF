...
public class ERO_0000005RO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000005RO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000005RO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000005RO_0000056Iterator.getType());
		} catch (Exception e) {
