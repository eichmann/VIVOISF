...
public class ERO_0000005TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000005TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000005TheAbstractIterator.class);
