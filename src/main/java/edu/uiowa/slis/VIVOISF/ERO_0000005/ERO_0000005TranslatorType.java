...
public class ERO_0000005TranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000005TranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000005TranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000005TranslatorIterator.getType());
		} catch (Exception e) {
