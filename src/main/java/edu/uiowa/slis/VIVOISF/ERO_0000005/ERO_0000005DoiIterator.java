...
public class ERO_0000005DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000005DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000005DoiIterator.class);
