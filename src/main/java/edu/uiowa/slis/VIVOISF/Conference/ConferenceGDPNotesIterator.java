...
public class ConferenceGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceGDPNotesIterator.class);
