...
public class ConferenceLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceLandAreaYearIterator.class);
