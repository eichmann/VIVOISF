...
public class ConferenceCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCodeUNIterator.class);
