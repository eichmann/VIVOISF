...
public class ConferenceNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameShortESIterator.class);
