...
public class ConferenceHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceHDITotalIterator.class);
