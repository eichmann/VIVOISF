...
public class ConferencePopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePopulationUnitIterator.class);
