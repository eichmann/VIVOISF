...
public class ConferenceLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceLandAreaUnitIterator.class);
