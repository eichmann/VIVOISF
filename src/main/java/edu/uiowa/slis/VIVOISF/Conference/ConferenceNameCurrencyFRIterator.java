...
public class ConferenceNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameCurrencyFRIterator.class);
