...
public class ConferenceNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNationalityESIterator.class);
