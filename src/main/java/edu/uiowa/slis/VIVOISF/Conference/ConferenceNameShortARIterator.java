...
public class ConferenceNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameShortARIterator.class);
