...
public class ConferenceNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameShortITIterator.class);
