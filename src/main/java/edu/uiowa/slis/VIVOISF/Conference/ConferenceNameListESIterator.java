...
public class ConferenceNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameListESIterator.class);
