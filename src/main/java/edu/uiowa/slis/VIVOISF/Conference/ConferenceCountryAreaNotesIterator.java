...
public class ConferenceCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCountryAreaNotesIterator.class);
