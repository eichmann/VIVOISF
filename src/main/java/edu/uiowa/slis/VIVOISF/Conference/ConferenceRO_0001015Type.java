...
public class ConferenceRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferenceRO_0001015Iterator.getType());
		} catch (Exception e) {
