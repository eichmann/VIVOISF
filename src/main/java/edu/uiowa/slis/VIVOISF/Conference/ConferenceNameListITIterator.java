...
public class ConferenceNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameListITIterator.class);
