...
public class ConferenceHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceHasMinLongitudeIterator.class);
