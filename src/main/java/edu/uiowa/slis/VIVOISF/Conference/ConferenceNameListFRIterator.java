...
public class ConferenceNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameListFRIterator.class);
