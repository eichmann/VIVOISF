...
public class ConferenceCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCodeGAULIterator.class);
