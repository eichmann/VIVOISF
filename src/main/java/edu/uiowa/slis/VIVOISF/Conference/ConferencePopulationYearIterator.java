...
public class ConferencePopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePopulationYearIterator.class);
