...
public class ConferenceAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceAgriculturalAreaYearIterator.class);
