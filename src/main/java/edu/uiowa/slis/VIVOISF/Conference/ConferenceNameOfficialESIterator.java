...
public class ConferenceNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameOfficialESIterator.class);
