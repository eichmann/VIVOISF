...
public class ConferenceCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCodeUNDPIterator.class);
