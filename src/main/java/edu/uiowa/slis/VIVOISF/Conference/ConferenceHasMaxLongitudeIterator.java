...
public class ConferenceHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceHasMaxLongitudeIterator.class);
