...
public class ConferenceNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameShortZHIterator.class);
