...
public class ConferenceNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameListENIterator.class);
