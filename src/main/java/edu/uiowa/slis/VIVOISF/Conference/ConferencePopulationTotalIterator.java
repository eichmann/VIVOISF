...
public class ConferencePopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePopulationTotalIterator.class);
