...
public class ConferenceNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameListZHIterator.class);
