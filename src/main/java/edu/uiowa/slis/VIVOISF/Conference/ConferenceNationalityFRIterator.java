...
public class ConferenceNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNationalityFRIterator.class);
