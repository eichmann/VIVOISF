...
public class ConferenceNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameCurrencyITIterator.class);
