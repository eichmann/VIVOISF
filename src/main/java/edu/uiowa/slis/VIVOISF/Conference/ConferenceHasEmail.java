...
public class ConferenceHasEmail extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceHasEmail currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceHasEmail.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferenceHasEmailIterator.getHasEmail());
		} catch (Exception e) {
