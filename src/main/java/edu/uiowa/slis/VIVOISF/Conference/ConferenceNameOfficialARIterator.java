...
public class ConferenceNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameOfficialARIterator.class);
