...
public class ConferenceNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameOfficialFRIterator.class);
