...
public class ConferenceCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCountryAreaYearIterator.class);
