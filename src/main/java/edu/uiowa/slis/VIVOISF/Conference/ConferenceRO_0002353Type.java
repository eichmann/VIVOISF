...
public class ConferenceRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferenceRO_0002353Iterator.getType());
		} catch (Exception e) {
