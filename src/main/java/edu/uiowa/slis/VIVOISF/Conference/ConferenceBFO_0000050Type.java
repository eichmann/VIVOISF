...
public class ConferenceBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferenceBFO_0000050Iterator.getType());
		} catch (Exception e) {
