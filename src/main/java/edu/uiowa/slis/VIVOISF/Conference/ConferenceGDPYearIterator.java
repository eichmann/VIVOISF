...
public class ConferenceGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceGDPYearIterator.class);
