...
public class ConferenceHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceHasMaxLatitudeIterator.class);
