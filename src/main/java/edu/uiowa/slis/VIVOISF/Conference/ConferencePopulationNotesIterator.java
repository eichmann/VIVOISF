...
public class ConferencePopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePopulationNotesIterator.class);
