...
public class ConferenceRO_0001025Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceRO_0001025Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceRO_0001025Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferenceRO_0001025Iterator.getType());
		} catch (Exception e) {
