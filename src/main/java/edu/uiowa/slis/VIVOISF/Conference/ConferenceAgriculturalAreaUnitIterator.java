...
public class ConferenceAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceAgriculturalAreaUnitIterator.class);
