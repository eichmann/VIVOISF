...
public class ConferenceHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceHDINotesIterator.class);
