...
public class ConferenceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://purl.org/ontology/bibo/Conference> . "+
