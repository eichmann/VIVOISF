...
public class ConferenceNameShortFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameShortFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameShortFRIterator.class);
