...
public class ConferenceNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameCurrencyZHIterator.class);
