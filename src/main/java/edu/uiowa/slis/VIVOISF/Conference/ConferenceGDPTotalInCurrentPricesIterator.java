...
public class ConferenceGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceGDPTotalInCurrentPricesIterator.class);
