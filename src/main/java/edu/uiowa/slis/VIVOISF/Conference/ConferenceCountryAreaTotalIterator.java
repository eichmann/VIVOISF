...
public class ConferenceCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCountryAreaTotalIterator.class);
