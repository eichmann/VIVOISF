...
public class ConferenceNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNationalityARIterator.class);
