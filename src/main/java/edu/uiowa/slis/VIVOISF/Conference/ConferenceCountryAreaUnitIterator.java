...
public class ConferenceCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCountryAreaUnitIterator.class);
