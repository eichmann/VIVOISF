...
public class ConferenceRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceRankIterator.class);
