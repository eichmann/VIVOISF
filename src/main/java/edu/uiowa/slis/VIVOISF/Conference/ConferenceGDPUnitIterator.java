...
public class ConferenceGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceGDPUnitIterator.class);
