...
public class ConferenceRO_0000057Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceRO_0000057Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceRO_0000057Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferenceRO_0000057Iterator.getType());
		} catch (Exception e) {
