...
public class ConferenceNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameListARIterator.class);
