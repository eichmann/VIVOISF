...
public class ConferenceNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNationalityRUIterator.class);
