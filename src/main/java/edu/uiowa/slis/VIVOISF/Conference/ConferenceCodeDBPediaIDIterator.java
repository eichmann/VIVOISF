...
public class ConferenceCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCodeDBPediaIDIterator.class);
