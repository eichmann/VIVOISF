...
public class ConferenceCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCodeFAOSTATIterator.class);
