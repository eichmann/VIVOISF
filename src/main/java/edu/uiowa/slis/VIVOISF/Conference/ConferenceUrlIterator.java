...
public class ConferenceUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceUrlIterator.class);
