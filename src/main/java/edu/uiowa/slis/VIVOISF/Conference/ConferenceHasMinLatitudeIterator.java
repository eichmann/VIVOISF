...
public class ConferenceHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceHasMinLatitudeIterator.class);
