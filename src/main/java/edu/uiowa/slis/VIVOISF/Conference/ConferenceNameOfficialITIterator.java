...
public class ConferenceNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameOfficialITIterator.class);
