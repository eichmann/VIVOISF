...
public class ConferenceCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCodeISO3Iterator.class);
