...
public class ConferenceNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameOfficialENIterator.class);
