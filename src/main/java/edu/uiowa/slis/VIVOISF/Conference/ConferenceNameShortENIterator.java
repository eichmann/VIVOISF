...
public class ConferenceNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameShortENIterator.class);
