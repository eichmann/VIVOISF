...
public class ConferenceFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceFreetextKeywordIterator.class);
