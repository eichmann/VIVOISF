...
public class ConferenceHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceHDIYearIterator.class);
