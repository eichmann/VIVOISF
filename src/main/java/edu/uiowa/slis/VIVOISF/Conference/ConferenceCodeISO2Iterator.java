...
public class ConferenceCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCodeISO2Iterator.class);
