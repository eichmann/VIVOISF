...
public class ConferenceCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCodeFAOTERMIterator.class);
