...
public class ConferenceLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceLandAreaTotalIterator.class);
