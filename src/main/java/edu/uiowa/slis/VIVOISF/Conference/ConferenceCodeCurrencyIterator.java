...
public class ConferenceCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceCodeCurrencyIterator.class);
