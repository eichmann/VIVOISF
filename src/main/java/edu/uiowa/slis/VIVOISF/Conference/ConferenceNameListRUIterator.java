...
public class ConferenceNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameListRUIterator.class);
