...
public class ConferenceNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceNameCurrencyESIterator.class);
