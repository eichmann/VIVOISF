...
public class ConferenceAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferenceAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferenceAgriculturalAreaNotesIterator.class);
