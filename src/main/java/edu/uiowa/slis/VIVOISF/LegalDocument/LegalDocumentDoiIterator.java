...
public class LegalDocumentDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentDoiIterator.class);
