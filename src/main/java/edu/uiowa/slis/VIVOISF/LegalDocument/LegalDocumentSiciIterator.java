...
public class LegalDocumentSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentSiciIterator.class);
