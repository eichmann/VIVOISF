...
public class LegalDocumentContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentContentIterator.class);
