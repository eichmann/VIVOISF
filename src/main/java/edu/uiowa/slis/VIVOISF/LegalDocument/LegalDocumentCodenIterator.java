...
public class LegalDocumentCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentCodenIterator.class);
