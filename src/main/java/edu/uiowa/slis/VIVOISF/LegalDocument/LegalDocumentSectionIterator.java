...
public class LegalDocumentSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentSectionIterator.class);
