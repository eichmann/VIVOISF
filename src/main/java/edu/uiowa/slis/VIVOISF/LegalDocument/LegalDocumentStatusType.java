...
public class LegalDocumentStatusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentStatusType currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentStatusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDocumentStatusIterator.getType());
		} catch (Exception e) {
