...
public class LegalDocumentArguedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentArguedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentArguedIterator.class);
