...
public class LegalDocumentNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentNumPagesIterator.class);
