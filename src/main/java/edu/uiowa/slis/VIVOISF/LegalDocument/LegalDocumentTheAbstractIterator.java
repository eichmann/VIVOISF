...
public class LegalDocumentTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentTheAbstractIterator.class);
