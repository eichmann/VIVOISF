...
public class LegalDocumentUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentUriIterator.class);
