...
public class LegalDocumentCourtType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentCourtType currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentCourtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDocumentCourtIterator.getType());
		} catch (Exception e) {
