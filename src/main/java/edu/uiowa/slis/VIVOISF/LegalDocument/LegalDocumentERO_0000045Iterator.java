...
public class LegalDocumentERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentERO_0000045Iterator.class);
