...
public class LegalDocumentShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentShortTitleIterator.class);
