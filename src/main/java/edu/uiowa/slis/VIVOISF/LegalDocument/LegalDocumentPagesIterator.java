...
public class LegalDocumentPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentPagesIterator.class);
