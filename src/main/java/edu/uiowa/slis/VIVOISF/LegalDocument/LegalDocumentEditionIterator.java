...
public class LegalDocumentEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentEditionIterator.class);
