...
public class LegalDocumentAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentAsinIterator.class);
