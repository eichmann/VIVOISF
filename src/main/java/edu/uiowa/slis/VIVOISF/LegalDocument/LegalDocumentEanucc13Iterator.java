...
public class LegalDocumentEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentEanucc13Iterator.class);
