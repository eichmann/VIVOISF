...
public class LegalDocumentIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentIsbn10Iterator.class);
