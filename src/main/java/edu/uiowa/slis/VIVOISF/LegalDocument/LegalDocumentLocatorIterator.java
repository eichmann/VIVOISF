...
public class LegalDocumentLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentLocatorIterator.class);
