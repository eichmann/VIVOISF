...
public class LegalDocumentPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentPageEndIterator.class);
