...
public class LegalDocumentIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentIsbn13Iterator.class);
