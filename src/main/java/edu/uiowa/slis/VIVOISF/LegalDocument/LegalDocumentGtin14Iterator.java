...
public class LegalDocumentGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentGtin14Iterator.class);
