...
public class LegalDocumentOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentOclcnumIterator.class);
