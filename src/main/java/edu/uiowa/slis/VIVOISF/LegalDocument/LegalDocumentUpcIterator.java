...
public class LegalDocumentUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentUpcIterator.class);
