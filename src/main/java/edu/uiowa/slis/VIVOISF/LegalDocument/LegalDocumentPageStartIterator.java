...
public class LegalDocumentPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentPageStartIterator.class);
