...
public class LegalDocumentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/LegalDocument> . "+
