...
public class LegalDocumentPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentPmidIterator.class);
