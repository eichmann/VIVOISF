...
public class LegalDocumentRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theLegalDocumentRO_0000056Iterator.getType());
		} catch (Exception e) {
