...
public class LegalDocumentLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentLccnIterator.class);
