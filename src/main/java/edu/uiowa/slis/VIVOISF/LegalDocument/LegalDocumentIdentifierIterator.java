...
public class LegalDocumentIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentIdentifierIterator.class);
