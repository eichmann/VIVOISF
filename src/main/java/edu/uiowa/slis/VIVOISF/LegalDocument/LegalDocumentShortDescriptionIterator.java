...
public class LegalDocumentShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentShortDescriptionIterator.class);
