...
public class LegalDocumentVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentVolumeIterator.class);
