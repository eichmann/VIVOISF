...
public class LegalDocumentHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static LegalDocumentHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(LegalDocumentHandleIterator.class);
