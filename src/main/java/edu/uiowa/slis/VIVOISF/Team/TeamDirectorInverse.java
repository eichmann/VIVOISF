...
public class TeamDirectorInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TeamDirectorInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(TeamDirectorInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTeamDirectorInverseIterator.getDirectorInverse());
		} catch (Exception e) {
