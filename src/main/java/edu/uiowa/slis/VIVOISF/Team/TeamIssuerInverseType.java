...
public class TeamIssuerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TeamIssuerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(TeamIssuerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTeamIssuerInverseIterator.getType());
		} catch (Exception e) {
