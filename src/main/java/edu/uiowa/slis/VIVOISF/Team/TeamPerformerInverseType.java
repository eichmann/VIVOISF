...
public class TeamPerformerInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TeamPerformerInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(TeamPerformerInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTeamPerformerInverseIterator.getType());
		} catch (Exception e) {
