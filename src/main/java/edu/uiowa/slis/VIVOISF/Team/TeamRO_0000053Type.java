...
public class TeamRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TeamRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(TeamRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTeamRO_0000053Iterator.getType());
		} catch (Exception e) {
