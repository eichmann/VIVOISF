...
public class TeamTranslatorOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static TeamTranslatorOf currentInstance = null;
	private static final Log log = LogFactory.getLog(TeamTranslatorOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theTeamTranslatorOfIterator.getTranslatorOf());
		} catch (Exception e) {
