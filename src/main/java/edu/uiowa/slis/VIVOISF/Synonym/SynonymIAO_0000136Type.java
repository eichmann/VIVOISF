...
public class SynonymIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static SynonymIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(SynonymIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theSynonymIAO_0000136Iterator.getType());
		} catch (Exception e) {
