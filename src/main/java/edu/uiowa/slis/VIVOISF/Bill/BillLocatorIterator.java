...
public class BillLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillLocatorIterator.class);
