...
public class BillNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillNumberIterator.class);
