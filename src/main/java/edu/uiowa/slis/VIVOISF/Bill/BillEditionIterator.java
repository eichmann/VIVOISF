...
public class BillEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillEditionIterator.class);
