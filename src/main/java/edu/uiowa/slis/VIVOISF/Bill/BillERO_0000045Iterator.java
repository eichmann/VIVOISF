...
public class BillERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillERO_0000045Iterator.class);
