...
public class BillContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillContentIterator.class);
