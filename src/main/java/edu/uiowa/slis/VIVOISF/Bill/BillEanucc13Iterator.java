...
public class BillEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillEanucc13Iterator.class);
