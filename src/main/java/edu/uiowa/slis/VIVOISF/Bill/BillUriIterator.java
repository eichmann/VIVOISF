...
public class BillUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillUriIterator.class);
