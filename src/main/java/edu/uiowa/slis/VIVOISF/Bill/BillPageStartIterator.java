...
public class BillPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillPageStartIterator.class);
