...
public class BillUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillUpcIterator.class);
