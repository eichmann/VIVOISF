...
public class BillGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillGtin14Iterator.class);
