...
public class BillRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BillRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBillRO_0000056Iterator.getType());
		} catch (Exception e) {
