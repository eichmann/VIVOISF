...
public class BillAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillAsinIterator.class);
