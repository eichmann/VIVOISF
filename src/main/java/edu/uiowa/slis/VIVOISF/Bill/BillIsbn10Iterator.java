...
public class BillIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillIsbn10Iterator.class);
