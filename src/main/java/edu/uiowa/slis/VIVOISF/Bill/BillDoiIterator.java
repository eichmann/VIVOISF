...
public class BillDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillDoiIterator.class);
