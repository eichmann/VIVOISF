...
public class BillIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillIsbn13Iterator.class);
