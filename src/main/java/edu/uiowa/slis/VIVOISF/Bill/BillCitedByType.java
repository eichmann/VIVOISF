...
public class BillCitedByType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillCitedByType currentInstance = null;
	private static final Log log = LogFactory.getLog(BillCitedByType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBillCitedByIterator.getType());
		} catch (Exception e) {
