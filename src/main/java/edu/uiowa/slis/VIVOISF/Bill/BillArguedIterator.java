...
public class BillArguedIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillArguedIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillArguedIterator.class);
