...
public class BillStatus extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillStatus currentInstance = null;
	private static final Log log = LogFactory.getLog(BillStatus.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBillStatusIterator.getStatus());
		} catch (Exception e) {
