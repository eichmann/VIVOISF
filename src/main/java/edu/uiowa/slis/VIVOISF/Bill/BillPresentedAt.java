...
public class BillPresentedAt extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillPresentedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(BillPresentedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBillPresentedAtIterator.getPresentedAt());
		} catch (Exception e) {
