...
public class BillShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillShortTitleIterator.class);
