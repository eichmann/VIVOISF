...
public class BillPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillPagesIterator.class);
