...
public class BillPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillPmidIterator.class);
