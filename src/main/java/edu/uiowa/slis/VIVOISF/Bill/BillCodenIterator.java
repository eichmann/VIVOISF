...
public class BillCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillCodenIterator.class);
