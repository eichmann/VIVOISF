...
public class BillSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillSiciIterator.class);
