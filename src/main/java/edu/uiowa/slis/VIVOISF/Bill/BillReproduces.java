...
public class BillReproduces extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillReproduces currentInstance = null;
	private static final Log log = LogFactory.getLog(BillReproduces.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBillReproducesIterator.getReproduces());
		} catch (Exception e) {
