...
public class BillVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillVolumeIterator.class);
