...
public class BillShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillShortDescriptionIterator.class);
