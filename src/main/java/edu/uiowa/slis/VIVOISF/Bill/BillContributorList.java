...
public class BillContributorList extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillContributorList currentInstance = null;
	private static final Log log = LogFactory.getLog(BillContributorList.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBillContributorListIterator.getContributorList());
		} catch (Exception e) {
