...
public class BillHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillHandleIterator.class);
