...
public class BillCites extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillCites currentInstance = null;
	private static final Log log = LogFactory.getLog(BillCites.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBillCitesIterator.getCites());
		} catch (Exception e) {
