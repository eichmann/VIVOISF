...
public class BillSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillSectionIterator.class);
