...
public class BillARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillARG_0000001Iterator.class);
