...
public class BillPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillPageEndIterator.class);
