...
public class BillOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillOclcnumIterator.class);
