...
public class BillIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillIdentifierIterator.class);
