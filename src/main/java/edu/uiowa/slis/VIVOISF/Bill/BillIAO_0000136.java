...
public class BillIAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillIAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(BillIAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBillIAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
