...
public class BillLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BillLccnIterator.class);
