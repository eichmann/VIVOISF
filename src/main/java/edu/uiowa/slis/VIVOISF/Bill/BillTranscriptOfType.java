...
public class BillTranscriptOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BillTranscriptOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(BillTranscriptOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBillTranscriptOfIterator.getType());
		} catch (Exception e) {
