...
public class CollegeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollegeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollegeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#College> . "+
