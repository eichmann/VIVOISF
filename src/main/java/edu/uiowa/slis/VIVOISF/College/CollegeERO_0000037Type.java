...
public class CollegeERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollegeERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(CollegeERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollegeERO_0000037Iterator.getType());
		} catch (Exception e) {
