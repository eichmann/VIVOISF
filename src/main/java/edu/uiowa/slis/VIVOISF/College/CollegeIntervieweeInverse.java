...
public class CollegeIntervieweeInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollegeIntervieweeInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(CollegeIntervieweeInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollegeIntervieweeInverseIterator.getIntervieweeInverse());
		} catch (Exception e) {
