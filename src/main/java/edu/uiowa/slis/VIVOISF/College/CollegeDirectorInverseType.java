...
public class CollegeDirectorInverseType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollegeDirectorInverseType currentInstance = null;
	private static final Log log = LogFactory.getLog(CollegeDirectorInverseType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCollegeDirectorInverseIterator.getType());
		} catch (Exception e) {
