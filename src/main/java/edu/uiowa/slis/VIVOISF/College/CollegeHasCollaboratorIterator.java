...
public class CollegeHasCollaboratorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static CollegeHasCollaboratorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CollegeHasCollaboratorIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in CollegeHasCollaboratorIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CollegeHasCollaboratorIterator doStartTag");
		}
