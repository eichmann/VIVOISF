...
public class ARG_2000008Features extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000008Features currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000008Features.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000008FeaturesIterator.getFeatures());
		} catch (Exception e) {
