...
public class ARG_2000008IAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ARG_2000008IAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(ARG_2000008IAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theARG_2000008IAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
