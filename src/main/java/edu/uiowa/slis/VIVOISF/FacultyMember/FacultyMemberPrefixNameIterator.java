...
public class FacultyMemberPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyMemberPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyMemberPrefixNameIterator.class);
