...
public class FacultyMemberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyMemberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyMemberIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#FacultyMember> . "+
