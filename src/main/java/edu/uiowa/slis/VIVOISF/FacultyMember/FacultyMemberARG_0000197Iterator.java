...
public class FacultyMemberARG_0000197Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyMemberARG_0000197Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyMemberARG_0000197Iterator.class);
