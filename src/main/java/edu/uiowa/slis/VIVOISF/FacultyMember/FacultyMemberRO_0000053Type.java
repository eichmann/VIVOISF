...
public class FacultyMemberRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyMemberRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyMemberRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacultyMemberRO_0000053Iterator.getType());
		} catch (Exception e) {
