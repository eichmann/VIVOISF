...
public class FacultyMemberIntervieweeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyMemberIntervieweeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyMemberIntervieweeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in FacultyMemberIntervieweeIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in FacultyMemberIntervieweeIterator doStartTag");
		}
