...
public class FacultyMember extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyMember currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyMember.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			FacultyMemberIterator theFacultyMemberIterator = (FacultyMemberIterator) findAncestorWithClass(this, FacultyMemberIterator.class);

			if (theFacultyMemberIterator != null) {
				subjectURI = theFacultyMemberIterator.getSubjectURI();
				label = theFacultyMemberIterator.getLabel();
			}

			if (theFacultyMemberIterator == null && subjectURI == null) {
			...
			log.error("Exception raised in FacultyMember doStartTag", e);
			throw new JspTagException("Exception raised in FacultyMember doStartTag");
		} finally {
			freeConnection();
		}
