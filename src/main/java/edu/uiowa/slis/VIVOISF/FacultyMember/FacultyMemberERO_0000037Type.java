...
public class FacultyMemberERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyMemberERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyMemberERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacultyMemberERO_0000037Iterator.getType());
		} catch (Exception e) {
