...
public class FacultyMemberERO_0000033Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FacultyMemberERO_0000033Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FacultyMemberERO_0000033Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFacultyMemberERO_0000033Iterator.getType());
		} catch (Exception e) {
