...
public class InverseFunctionalPropertyTheTypeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static InverseFunctionalPropertyTheTypeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(InverseFunctionalPropertyTheTypeIterator.class);
