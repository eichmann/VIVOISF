...
public class BookSectionLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionLccnIterator.class);
