...
public class BookSectionBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookSectionBFO_0000051Iterator.getType());
		} catch (Exception e) {
