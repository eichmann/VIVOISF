...
public class BookSectionContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionContentIterator.class);
