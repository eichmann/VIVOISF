...
public class BookSectionNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNationalityFRIterator.class);
