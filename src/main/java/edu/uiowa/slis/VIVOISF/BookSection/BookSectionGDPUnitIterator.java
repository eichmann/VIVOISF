...
public class BookSectionGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionGDPUnitIterator.class);
