...
public class BookSectionNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameOfficialENIterator.class);
