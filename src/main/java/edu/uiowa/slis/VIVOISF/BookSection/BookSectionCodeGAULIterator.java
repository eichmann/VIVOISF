...
public class BookSectionCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCodeGAULIterator.class);
