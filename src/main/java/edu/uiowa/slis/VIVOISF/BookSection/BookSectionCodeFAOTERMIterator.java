...
public class BookSectionCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCodeFAOTERMIterator.class);
