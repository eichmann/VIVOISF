...
public class BookSectionPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionPageEndIterator.class);
