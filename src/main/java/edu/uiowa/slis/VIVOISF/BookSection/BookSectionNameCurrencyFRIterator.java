...
public class BookSectionNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameCurrencyFRIterator.class);
