...
public class BookSectionSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionSectionIterator.class);
