...
public class BookSectionIAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionIAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionIAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookSectionIAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
