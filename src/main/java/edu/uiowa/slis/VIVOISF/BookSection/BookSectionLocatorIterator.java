...
public class BookSectionLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionLocatorIterator.class);
