...
public class BookSectionDistributorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionDistributorType currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionDistributorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookSectionDistributorIterator.getType());
		} catch (Exception e) {
