...
public class BookSectionPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionPopulationNotesIterator.class);
