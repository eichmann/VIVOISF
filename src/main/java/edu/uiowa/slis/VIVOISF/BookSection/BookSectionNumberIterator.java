...
public class BookSectionNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNumberIterator.class);
