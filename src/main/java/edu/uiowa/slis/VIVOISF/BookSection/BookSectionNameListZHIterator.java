...
public class BookSectionNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameListZHIterator.class);
