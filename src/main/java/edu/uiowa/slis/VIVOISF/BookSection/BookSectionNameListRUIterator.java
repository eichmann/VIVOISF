...
public class BookSectionNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameListRUIterator.class);
