...
public class BookSectionPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionPopulationUnitIterator.class);
