...
public class BookSectionReviewOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionReviewOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionReviewOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookSectionReviewOfIterator.getType());
		} catch (Exception e) {
