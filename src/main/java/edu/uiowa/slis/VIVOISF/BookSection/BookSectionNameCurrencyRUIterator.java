...
public class BookSectionNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameCurrencyRUIterator.class);
