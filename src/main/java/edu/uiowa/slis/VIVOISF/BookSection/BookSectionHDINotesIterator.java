...
public class BookSectionHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionHDINotesIterator.class);
