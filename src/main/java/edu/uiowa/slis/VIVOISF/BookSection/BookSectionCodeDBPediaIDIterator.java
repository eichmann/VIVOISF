...
public class BookSectionCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCodeDBPediaIDIterator.class);
