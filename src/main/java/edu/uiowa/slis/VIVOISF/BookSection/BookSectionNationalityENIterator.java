...
public class BookSectionNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNationalityENIterator.class);
