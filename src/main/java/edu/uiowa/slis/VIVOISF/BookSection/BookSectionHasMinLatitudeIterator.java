...
public class BookSectionHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionHasMinLatitudeIterator.class);
