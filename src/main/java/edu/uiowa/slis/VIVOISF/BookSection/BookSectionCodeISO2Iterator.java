...
public class BookSectionCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCodeISO2Iterator.class);
