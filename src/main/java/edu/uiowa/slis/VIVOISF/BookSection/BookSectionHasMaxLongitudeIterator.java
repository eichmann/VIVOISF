...
public class BookSectionHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionHasMaxLongitudeIterator.class);
