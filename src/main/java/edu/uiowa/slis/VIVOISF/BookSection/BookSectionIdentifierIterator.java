...
public class BookSectionIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionIdentifierIterator.class);
