...
public class BookSectionShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionShortDescriptionIterator.class);
