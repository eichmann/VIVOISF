...
public class BookSectionUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionUriIterator.class);
