...
public class BookSectionAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionAgriculturalAreaTotalIterator.class);
