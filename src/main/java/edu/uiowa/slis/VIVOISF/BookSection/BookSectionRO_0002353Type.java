...
public class BookSectionRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookSectionRO_0002353Iterator.getType());
		} catch (Exception e) {
