...
public class BookSectionPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionPopulationYearIterator.class);
