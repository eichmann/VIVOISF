...
public class BookSectionShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionShortTitleIterator.class);
