...
public class BookSectionCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCodeUNDPIterator.class);
