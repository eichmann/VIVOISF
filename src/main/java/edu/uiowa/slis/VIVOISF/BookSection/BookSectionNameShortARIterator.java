...
public class BookSectionNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameShortARIterator.class);
