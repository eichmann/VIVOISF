...
public class BookSectionVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionVolumeIterator.class);
