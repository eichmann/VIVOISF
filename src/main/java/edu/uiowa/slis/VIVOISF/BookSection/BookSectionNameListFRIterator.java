...
public class BookSectionNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameListFRIterator.class);
