...
public class BookSectionNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameOfficialFRIterator.class);
