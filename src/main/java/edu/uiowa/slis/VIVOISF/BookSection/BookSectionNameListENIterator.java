...
public class BookSectionNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameListENIterator.class);
