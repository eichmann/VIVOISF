...
public class BookSectionUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionUpcIterator.class);
