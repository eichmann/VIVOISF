...
public class BookSectionCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCodeAGROVOCIterator.class);
