...
public class BookSectionHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionHasMinLongitudeIterator.class);
