...
public class BookSectionNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNationalityESIterator.class);
