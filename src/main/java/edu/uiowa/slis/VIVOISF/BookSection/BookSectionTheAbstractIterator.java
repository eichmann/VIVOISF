...
public class BookSectionTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionTheAbstractIterator.class);
