...
public class BookSectionERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionERO_0000045Iterator.class);
