...
public class BookSectionUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionUrlIterator.class);
