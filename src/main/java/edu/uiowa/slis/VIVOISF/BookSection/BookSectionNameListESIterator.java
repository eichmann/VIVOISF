...
public class BookSectionNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameListESIterator.class);
