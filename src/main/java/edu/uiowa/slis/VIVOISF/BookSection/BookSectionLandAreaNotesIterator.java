...
public class BookSectionLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionLandAreaNotesIterator.class);
