...
public class BookSectionCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCodeFAOSTATIterator.class);
