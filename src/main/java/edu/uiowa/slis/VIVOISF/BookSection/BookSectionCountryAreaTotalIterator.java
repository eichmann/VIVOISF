...
public class BookSectionCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCountryAreaTotalIterator.class);
