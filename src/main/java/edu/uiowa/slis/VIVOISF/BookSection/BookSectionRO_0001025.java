...
public class BookSectionRO_0001025 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionRO_0001025 currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionRO_0001025.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookSectionRO_0001025Iterator.getRO_0001025());
		} catch (Exception e) {
