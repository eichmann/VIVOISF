...
public class BookSectionNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameOfficialZHIterator.class);
