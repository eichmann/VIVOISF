...
public class BookSectionTranslator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionTranslator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionTranslator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookSectionTranslatorIterator.getTranslator());
		} catch (Exception e) {
