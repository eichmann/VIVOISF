...
public class BookSectionNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameShortZHIterator.class);
