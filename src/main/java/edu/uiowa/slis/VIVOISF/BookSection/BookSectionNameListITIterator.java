...
public class BookSectionNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameListITIterator.class);
