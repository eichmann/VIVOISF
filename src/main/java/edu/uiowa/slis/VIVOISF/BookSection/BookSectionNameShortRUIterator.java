...
public class BookSectionNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameShortRUIterator.class);
