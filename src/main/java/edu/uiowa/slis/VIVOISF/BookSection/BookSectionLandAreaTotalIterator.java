...
public class BookSectionLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionLandAreaTotalIterator.class);
