...
public class BookSectionSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionSiciIterator.class);
