...
public class BookSectionNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameOfficialITIterator.class);
