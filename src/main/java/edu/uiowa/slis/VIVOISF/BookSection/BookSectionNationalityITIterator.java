...
public class BookSectionNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNationalityITIterator.class);
