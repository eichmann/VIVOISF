...
public class BookSectionIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionIsbn13Iterator.class);
