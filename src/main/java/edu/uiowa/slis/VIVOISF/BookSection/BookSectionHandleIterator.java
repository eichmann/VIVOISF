...
public class BookSectionHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionHandleIterator.class);
