...
public class BookSectionRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in BookSectionRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BookSectionRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in BookSectionRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in BookSectionRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in BookSectionRelates doEndTag", e);
			throw new JspTagException("Exception raised in BookSectionRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to BookSectionRelatesIterator");
