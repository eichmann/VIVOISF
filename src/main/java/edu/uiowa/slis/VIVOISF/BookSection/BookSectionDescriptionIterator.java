...
public class BookSectionDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionDescriptionIterator.class);
