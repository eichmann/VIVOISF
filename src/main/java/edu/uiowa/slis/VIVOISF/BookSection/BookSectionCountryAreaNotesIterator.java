...
public class BookSectionCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCountryAreaNotesIterator.class);
