...
public class BookSectionLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionLandAreaYearIterator.class);
