...
public class BookSectionNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameOfficialARIterator.class);
