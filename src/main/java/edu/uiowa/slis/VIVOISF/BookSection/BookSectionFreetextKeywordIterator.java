...
public class BookSectionFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionFreetextKeywordIterator.class);
