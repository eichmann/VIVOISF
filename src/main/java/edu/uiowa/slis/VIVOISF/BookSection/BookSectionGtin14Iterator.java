...
public class BookSectionGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionGtin14Iterator.class);
