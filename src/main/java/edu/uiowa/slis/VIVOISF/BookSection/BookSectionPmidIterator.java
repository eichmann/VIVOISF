...
public class BookSectionPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionPmidIterator.class);
