...
public class BookSectionPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionPageStartIterator.class);
