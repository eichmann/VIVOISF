...
public class BookSectionHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionHDITotalIterator.class);
