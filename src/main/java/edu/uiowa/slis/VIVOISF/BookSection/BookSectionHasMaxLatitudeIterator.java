...
public class BookSectionHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionHasMaxLatitudeIterator.class);
