...
public class BookSectionNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameCurrencyARIterator.class);
