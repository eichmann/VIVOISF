...
public class BookSectionOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionOclcnumIterator.class);
