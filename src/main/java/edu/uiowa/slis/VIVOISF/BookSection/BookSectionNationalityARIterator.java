...
public class BookSectionNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNationalityARIterator.class);
