...
public class BookSectionEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionEditionIterator.class);
