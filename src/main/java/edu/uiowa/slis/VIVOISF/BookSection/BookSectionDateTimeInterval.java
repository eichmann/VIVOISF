...
public class BookSectionDateTimeInterval extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionDateTimeInterval currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionDateTimeInterval.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theBookSectionDateTimeIntervalIterator.getDateTimeInterval());
		} catch (Exception e) {
