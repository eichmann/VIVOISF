...
public class BookSectionPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionPopulationTotalIterator.class);
