...
public class BookSectionNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNationalityRUIterator.class);
