...
public class BookSectionCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCountryAreaUnitIterator.class);
