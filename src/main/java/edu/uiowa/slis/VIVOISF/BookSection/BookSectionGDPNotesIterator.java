...
public class BookSectionGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionGDPNotesIterator.class);
