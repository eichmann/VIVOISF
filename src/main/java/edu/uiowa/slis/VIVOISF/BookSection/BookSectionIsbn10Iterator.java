...
public class BookSectionIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionIsbn10Iterator.class);
