...
public class BookSectionARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionARG_0000001Iterator.class);
