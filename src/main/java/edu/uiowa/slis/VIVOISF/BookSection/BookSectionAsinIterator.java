...
public class BookSectionAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionAsinIterator.class);
