...
public class BookSectionAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionAgriculturalAreaUnitIterator.class);
