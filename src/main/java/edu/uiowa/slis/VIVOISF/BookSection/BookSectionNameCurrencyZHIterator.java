...
public class BookSectionNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameCurrencyZHIterator.class);
