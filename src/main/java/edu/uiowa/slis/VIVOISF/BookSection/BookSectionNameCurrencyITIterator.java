...
public class BookSectionNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionNameCurrencyITIterator.class);
