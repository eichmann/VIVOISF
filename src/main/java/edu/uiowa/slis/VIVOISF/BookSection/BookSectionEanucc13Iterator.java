...
public class BookSectionEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionEanucc13Iterator.class);
