...
public class BookSectionCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCodeUNIterator.class);
