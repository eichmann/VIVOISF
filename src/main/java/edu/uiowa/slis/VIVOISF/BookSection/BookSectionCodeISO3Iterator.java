...
public class BookSectionCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static BookSectionCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(BookSectionCodeISO3Iterator.class);
