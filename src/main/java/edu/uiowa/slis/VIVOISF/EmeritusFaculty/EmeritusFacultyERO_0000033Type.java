...
public class EmeritusFacultyERO_0000033Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyERO_0000033Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyERO_0000033Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusFacultyERO_0000033Iterator.getType());
		} catch (Exception e) {
