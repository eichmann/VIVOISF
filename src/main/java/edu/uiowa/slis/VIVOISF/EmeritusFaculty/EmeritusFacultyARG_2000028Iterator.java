...
public class EmeritusFacultyARG_2000028Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	private static final Log log = LogFactory.getLog(EmeritusFacultyARG_2000028Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EmeritusFacultyARG_2000028Iterator doStartTag");
		}
	...
	public int doAfterBody() throws JspException {
		try {
			...
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EmeritusFacultyARG_2000028Iterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EmeritusFacultyARG_2000028 doEndTag", e);
			throw new JspTagException("Exception raised in EmeritusFacultyARG_2000028 doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
