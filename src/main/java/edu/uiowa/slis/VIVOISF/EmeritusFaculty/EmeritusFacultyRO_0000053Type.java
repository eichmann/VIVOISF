...
public class EmeritusFacultyRO_0000053Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyRO_0000053Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyRO_0000053Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusFacultyRO_0000053Iterator.getType());
		} catch (Exception e) {
