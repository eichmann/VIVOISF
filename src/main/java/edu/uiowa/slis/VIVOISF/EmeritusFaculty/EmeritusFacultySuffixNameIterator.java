...
public class EmeritusFacultySuffixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultySuffixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultySuffixNameIterator.class);
