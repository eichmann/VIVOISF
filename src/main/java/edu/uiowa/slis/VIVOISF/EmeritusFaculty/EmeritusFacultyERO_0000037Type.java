...
public class EmeritusFacultyERO_0000037Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyERO_0000037Type currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyERO_0000037Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusFacultyERO_0000037Iterator.getType());
		} catch (Exception e) {
