...
public class EmeritusFacultyHasCollaboratorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyHasCollaboratorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyHasCollaboratorIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in EmeritusFacultyHasCollaboratorIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in EmeritusFacultyHasCollaboratorIterator doStartTag");
		}
