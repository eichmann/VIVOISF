...
public class EmeritusFacultyAssigneeFor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyAssigneeFor currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyAssigneeFor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusFacultyAssigneeForIterator.getAssigneeFor());
		} catch (Exception e) {
