...
public class EmeritusFacultyFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyFreetextKeywordIterator.class);
