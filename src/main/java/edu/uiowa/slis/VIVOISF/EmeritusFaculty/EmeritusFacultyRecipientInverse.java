...
public class EmeritusFacultyRecipientInverse extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyRecipientInverse currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyRecipientInverse.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusFacultyRecipientInverseIterator.getRecipientInverse());
		} catch (Exception e) {
