...
public class EmeritusFacultyARG_0000197Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyARG_0000197Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyARG_0000197Iterator.class);
