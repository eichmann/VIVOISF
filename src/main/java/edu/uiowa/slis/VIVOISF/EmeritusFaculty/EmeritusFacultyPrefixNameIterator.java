...
public class EmeritusFacultyPrefixNameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyPrefixNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyPrefixNameIterator.class);
