...
public class EmeritusFacultyScopusIdIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyScopusIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyScopusIdIterator.class);
