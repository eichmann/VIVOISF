...
public class EmeritusFacultyARG_0000172Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyARG_0000172Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyARG_0000172Iterator.class);
