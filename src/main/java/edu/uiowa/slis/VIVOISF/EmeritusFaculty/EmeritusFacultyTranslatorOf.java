...
public class EmeritusFacultyTranslatorOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static EmeritusFacultyTranslatorOf currentInstance = null;
	private static final Log log = LogFactory.getLog(EmeritusFacultyTranslatorOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theEmeritusFacultyTranslatorOfIterator.getTranslatorOf());
		} catch (Exception e) {
