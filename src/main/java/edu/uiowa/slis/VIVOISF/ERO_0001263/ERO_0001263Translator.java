...
public class ERO_0001263Translator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001263Translator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001263Translator.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001263TranslatorIterator.getTranslator());
		} catch (Exception e) {
