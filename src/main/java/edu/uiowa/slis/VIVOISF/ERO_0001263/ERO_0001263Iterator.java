...
public class ERO_0001263Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001263Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001263Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.obolibrary.org/obo/ERO_0001263> . "+
