...
public class FilmSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmSectionIterator.class);
