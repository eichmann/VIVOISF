...
public class FilmAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmAsinIterator.class);
