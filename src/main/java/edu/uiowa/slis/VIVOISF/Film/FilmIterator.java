...
public class FilmIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://purl.org/ontology/bibo/Film> . "+
