...
public class FilmEditorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmEditorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmEditorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFilmEditorListIterator.getType());
		} catch (Exception e) {
