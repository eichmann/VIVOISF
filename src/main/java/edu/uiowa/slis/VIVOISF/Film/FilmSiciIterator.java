...
public class FilmSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmSiciIterator.class);
