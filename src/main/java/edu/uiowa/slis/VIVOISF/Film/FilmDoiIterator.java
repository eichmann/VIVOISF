...
public class FilmDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmDoiIterator.class);
