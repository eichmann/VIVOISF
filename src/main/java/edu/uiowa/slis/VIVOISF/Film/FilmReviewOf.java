...
public class FilmReviewOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmReviewOf currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmReviewOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFilmReviewOfIterator.getReviewOf());
		} catch (Exception e) {
