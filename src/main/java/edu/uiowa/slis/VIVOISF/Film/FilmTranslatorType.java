...
public class FilmTranslatorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmTranslatorType currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmTranslatorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFilmTranslatorIterator.getType());
		} catch (Exception e) {
