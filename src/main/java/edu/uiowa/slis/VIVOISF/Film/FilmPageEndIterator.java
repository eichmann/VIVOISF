...
public class FilmPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmPageEndIterator.class);
