...
public class FilmTranslationOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmTranslationOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmTranslationOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFilmTranslationOfIterator.getType());
		} catch (Exception e) {
