...
public class FilmNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmNumPagesIterator.class);
