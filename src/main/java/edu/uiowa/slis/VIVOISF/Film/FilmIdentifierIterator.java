...
public class FilmIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmIdentifierIterator.class);
