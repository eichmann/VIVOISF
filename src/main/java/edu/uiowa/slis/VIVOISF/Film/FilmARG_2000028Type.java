...
public class FilmARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFilmARG_2000028Iterator.getType());
		} catch (Exception e) {
