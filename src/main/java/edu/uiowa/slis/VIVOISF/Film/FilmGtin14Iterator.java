...
public class FilmGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmGtin14Iterator.class);
