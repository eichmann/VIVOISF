...
public class FilmCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmCodenIterator.class);
