...
public class FilmOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmOclcnumIterator.class);
