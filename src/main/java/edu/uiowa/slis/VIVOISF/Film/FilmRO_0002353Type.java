...
public class FilmRO_0002353Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmRO_0002353Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmRO_0002353Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFilmRO_0002353Iterator.getType());
		} catch (Exception e) {
