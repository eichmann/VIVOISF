...
public class FilmIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFilmIAO_0000136Iterator.getType());
		} catch (Exception e) {
