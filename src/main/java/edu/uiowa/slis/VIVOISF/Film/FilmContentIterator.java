...
public class FilmContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmContentIterator.class);
