...
public class FilmLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmLocatorIterator.class);
