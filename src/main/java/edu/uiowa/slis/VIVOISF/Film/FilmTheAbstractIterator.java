...
public class FilmTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmTheAbstractIterator.class);
