...
public class FilmProducerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmProducerType currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmProducerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFilmProducerIterator.getType());
		} catch (Exception e) {
