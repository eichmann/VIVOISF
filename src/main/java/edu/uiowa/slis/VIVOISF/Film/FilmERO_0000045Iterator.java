...
public class FilmERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmERO_0000045Iterator.class);
