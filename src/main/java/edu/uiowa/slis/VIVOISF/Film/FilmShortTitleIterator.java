...
public class FilmShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmShortTitleIterator.class);
