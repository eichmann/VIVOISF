...
public class FilmIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmIsbn10Iterator.class);
