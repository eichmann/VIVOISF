...
public class FilmPresentedAt extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmPresentedAt currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmPresentedAt.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theFilmPresentedAtIterator.getPresentedAt());
		} catch (Exception e) {
