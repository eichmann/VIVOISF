...
public class FilmLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmLccnIterator.class);
