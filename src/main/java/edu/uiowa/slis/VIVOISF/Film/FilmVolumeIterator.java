...
public class FilmVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmVolumeIterator.class);
