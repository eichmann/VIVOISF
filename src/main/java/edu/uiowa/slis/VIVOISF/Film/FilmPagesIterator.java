...
public class FilmPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmPagesIterator.class);
