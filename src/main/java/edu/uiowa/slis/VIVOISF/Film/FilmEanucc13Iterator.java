...
public class FilmEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmEanucc13Iterator.class);
