...
public class FilmEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmEditionIterator.class);
