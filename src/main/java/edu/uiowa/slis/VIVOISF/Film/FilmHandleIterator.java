...
public class FilmHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmHandleIterator.class);
