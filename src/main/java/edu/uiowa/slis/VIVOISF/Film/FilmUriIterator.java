...
public class FilmUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static FilmUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FilmUriIterator.class);
