...
public class ReviewVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewVolumeIterator.class);
