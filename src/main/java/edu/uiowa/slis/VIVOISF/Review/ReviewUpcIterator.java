...
public class ReviewUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewUpcIterator.class);
