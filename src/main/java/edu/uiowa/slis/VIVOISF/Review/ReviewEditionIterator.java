...
public class ReviewEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewEditionIterator.class);
