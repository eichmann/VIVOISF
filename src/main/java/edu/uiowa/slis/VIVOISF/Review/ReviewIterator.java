...
public class ReviewIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://vivoweb.org/ontology/core#Review> . "+
