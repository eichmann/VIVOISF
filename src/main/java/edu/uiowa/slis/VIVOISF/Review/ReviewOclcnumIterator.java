...
public class ReviewOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewOclcnumIterator.class);
