...
public class ReviewGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewGtin14Iterator.class);
