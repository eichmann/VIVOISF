...
public class ReviewERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewERO_0000045Iterator.class);
