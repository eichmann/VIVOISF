...
public class ReviewNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewNumberIterator.class);
