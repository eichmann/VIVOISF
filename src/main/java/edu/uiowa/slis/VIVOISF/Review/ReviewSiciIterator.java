...
public class ReviewSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewSiciIterator.class);
