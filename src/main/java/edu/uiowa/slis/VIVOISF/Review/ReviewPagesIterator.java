...
public class ReviewPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewPagesIterator.class);
