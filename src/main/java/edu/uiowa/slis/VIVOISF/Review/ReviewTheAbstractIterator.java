...
public class ReviewTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewTheAbstractIterator.class);
