...
public class ReviewPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewPmidIterator.class);
