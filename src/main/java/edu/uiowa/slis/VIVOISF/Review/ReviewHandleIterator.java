...
public class ReviewHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewHandleIterator.class);
