...
public class ReviewARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReviewARG_2000028Iterator.getType());
		} catch (Exception e) {
