...
public class ReviewAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewAsinIterator.class);
