...
public class ReviewIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewIsbn10Iterator.class);
