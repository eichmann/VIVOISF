...
public class ReviewShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewShortDescriptionIterator.class);
