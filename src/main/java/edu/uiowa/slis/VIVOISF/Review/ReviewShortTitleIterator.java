...
public class ReviewShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewShortTitleIterator.class);
