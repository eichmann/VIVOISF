...
public class ReviewNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewNumPagesIterator.class);
