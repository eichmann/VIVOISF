...
public class ReviewAuthorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewAuthorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewAuthorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReviewAuthorListIterator.getType());
		} catch (Exception e) {
