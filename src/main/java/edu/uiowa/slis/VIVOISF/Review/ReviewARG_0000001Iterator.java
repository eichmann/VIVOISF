...
public class ReviewARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewARG_0000001Iterator.class);
