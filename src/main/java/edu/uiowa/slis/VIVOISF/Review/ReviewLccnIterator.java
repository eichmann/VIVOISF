...
public class ReviewLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewLccnIterator.class);
