...
public class ReviewCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewCodenIterator.class);
