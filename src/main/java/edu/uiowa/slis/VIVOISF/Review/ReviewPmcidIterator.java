...
public class ReviewPmcidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewPmcidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewPmcidIterator.class);
