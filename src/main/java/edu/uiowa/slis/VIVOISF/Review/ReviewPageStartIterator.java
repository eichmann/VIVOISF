...
public class ReviewPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewPageStartIterator.class);
