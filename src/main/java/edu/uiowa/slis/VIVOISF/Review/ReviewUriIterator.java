...
public class ReviewUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewUriIterator.class);
