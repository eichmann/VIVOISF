...
public class ReviewSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewSectionIterator.class);
