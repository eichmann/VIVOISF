...
public class ReviewIssuerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewIssuerType currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewIssuerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theReviewIssuerIterator.getType());
		} catch (Exception e) {
