...
public class ReviewIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewIsbn13Iterator.class);
