...
public class ReviewPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewPageEndIterator.class);
