...
public class ReviewLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewLocatorIterator.class);
