...
public class ReviewIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewIdentifierIterator.class);
