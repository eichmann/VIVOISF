...
public class ReviewEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ReviewEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ReviewEanucc13Iterator.class);
