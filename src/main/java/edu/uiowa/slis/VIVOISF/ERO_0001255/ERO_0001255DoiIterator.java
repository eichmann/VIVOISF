...
public class ERO_0001255DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001255DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001255DoiIterator.class);
