...
public class ERO_0001255TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001255TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001255TheAbstractIterator.class);
