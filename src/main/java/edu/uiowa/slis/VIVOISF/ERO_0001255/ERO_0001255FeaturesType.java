...
public class ERO_0001255FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0001255FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0001255FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0001255FeaturesIterator.getType());
		} catch (Exception e) {
