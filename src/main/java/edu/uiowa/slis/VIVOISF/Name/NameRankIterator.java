...
public class NameRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NameRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NameRankIterator.class);
