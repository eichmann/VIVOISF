...
public class NameTelephoneIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NameTelephoneIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NameTelephoneIterator.class);
