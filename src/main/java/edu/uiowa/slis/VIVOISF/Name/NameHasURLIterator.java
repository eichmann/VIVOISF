...
public class NameHasURLIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NameHasURLIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NameHasURLIterator.class);
...
//					continue;
			...
			log.error("Exception raised in NameHasURLIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NameHasURLIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in NameHasURLIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NameHasURLIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NameHasURL doEndTag", e);
			throw new JspTagException("Exception raised in NameHasURL doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to NameHasURLIterator");
