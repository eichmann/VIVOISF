...
public class NameRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NameRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NameRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in NameRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NameRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in NameRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NameRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NameRelates doEndTag", e);
			throw new JspTagException("Exception raised in NameRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to NameRelatesIterator");
