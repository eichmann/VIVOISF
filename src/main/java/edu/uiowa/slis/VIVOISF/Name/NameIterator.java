...
public class NameIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NameIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.w3.org/2006/vcard/ns#Name> . "+
