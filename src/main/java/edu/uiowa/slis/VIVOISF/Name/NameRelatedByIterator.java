...
public class NameRelatedByIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NameRelatedByIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NameRelatedByIterator.class);
...
//					continue;
			...
			log.error("Exception raised in NameRelatedByIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NameRelatedByIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in NameRelatedByIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in NameRelatedByIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in NameRelatedBy doEndTag", e);
			throw new JspTagException("Exception raised in NameRelatedBy doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to NameRelatedByIterator");
