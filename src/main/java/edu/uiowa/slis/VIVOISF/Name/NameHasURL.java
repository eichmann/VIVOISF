...
public class NameHasURL extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NameHasURL currentInstance = null;
	private static final Log log = LogFactory.getLog(NameHasURL.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNameHasURLIterator.getHasURL());
		} catch (Exception e) {
