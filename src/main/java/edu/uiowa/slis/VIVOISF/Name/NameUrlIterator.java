...
public class NameUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static NameUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NameUrlIterator.class);
