...
public class DateTimeIntervalLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalLandAreaUnitIterator.class);
