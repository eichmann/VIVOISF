...
public class DateTimeIntervalNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameShortRUIterator.class);
