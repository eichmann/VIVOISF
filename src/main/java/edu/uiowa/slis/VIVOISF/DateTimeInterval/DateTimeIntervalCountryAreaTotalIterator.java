...
public class DateTimeIntervalCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCountryAreaTotalIterator.class);
