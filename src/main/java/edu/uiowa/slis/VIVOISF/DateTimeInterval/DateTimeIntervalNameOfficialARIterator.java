...
public class DateTimeIntervalNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameOfficialARIterator.class);
