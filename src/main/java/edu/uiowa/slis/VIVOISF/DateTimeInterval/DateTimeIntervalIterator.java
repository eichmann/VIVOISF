...
public class DateTimeIntervalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://vivoweb.org/ontology/core#DateTimeInterval> . "+
