...
public class DateTimeIntervalBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeIntervalBFO_0000050Iterator.getType());
		} catch (Exception e) {
