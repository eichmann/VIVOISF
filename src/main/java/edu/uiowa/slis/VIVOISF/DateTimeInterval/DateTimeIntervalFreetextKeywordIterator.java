...
public class DateTimeIntervalFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalFreetextKeywordIterator.class);
