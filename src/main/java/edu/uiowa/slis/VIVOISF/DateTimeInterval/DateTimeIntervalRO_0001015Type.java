...
public class DateTimeIntervalRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeIntervalRO_0001015Iterator.getType());
		} catch (Exception e) {
