...
public class DateTimeIntervalCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCodeISO3Iterator.class);
