...
public class DateTimeIntervalHasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalHasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalHasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeIntervalHasTitleIterator.getType());
		} catch (Exception e) {
