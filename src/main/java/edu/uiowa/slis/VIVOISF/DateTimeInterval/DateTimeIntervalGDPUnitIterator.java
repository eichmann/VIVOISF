...
public class DateTimeIntervalGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalGDPUnitIterator.class);
