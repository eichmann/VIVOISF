...
public class DateTimeIntervalNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameOfficialITIterator.class);
