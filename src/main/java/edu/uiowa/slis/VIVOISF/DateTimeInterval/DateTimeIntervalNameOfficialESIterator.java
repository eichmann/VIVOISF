...
public class DateTimeIntervalNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameOfficialESIterator.class);
