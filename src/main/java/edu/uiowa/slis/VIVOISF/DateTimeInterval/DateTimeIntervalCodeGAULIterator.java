...
public class DateTimeIntervalCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCodeGAULIterator.class);
