...
public class DateTimeIntervalHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalHasMinLongitudeIterator.class);
