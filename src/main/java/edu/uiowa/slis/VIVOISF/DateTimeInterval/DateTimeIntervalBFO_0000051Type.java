...
public class DateTimeIntervalBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeIntervalBFO_0000051Iterator.getType());
		} catch (Exception e) {
