...
public class DateTimeIntervalNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNationalityFRIterator.class);
