...
public class DateTimeIntervalHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalHDITotalIterator.class);
