...
public class DateTimeIntervalCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCodeCurrencyIterator.class);
