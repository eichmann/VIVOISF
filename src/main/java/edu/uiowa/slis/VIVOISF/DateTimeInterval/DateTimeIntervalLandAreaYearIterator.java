...
public class DateTimeIntervalLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalLandAreaYearIterator.class);
