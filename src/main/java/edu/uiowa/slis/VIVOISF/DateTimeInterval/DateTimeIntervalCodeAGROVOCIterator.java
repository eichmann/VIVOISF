...
public class DateTimeIntervalCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCodeAGROVOCIterator.class);
