...
public class DateTimeIntervalPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalPopulationTotalIterator.class);
