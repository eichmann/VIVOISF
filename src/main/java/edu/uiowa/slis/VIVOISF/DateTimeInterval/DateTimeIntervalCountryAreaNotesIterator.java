...
public class DateTimeIntervalCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCountryAreaNotesIterator.class);
