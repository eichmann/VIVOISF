...
public class DateTimeIntervalNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNationalityESIterator.class);
