...
public class DateTimeIntervalCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCodeFAOSTATIterator.class);
