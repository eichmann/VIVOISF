...
public class DateTimeIntervalNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameShortZHIterator.class);
