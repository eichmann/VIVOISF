...
public class DateTimeIntervalNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameCurrencyFRIterator.class);
