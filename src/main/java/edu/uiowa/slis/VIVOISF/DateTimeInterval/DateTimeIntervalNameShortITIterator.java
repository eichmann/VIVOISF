...
public class DateTimeIntervalNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameShortITIterator.class);
