...
public class DateTimeIntervalRO_0002234Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalRO_0002234Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalRO_0002234Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeIntervalRO_0002234Iterator.getType());
		} catch (Exception e) {
