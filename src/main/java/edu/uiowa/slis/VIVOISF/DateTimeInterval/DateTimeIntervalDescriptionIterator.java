...
public class DateTimeIntervalDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalDescriptionIterator.class);
