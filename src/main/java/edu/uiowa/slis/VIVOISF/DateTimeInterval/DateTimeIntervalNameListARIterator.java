...
public class DateTimeIntervalNameListARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameListARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameListARIterator.class);
