...
public class DateTimeIntervalUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalUrlIterator.class);
