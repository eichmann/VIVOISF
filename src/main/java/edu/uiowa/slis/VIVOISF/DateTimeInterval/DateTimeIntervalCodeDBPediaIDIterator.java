...
public class DateTimeIntervalCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCodeDBPediaIDIterator.class);
