...
public class DateTimeIntervalNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameOfficialFRIterator.class);
