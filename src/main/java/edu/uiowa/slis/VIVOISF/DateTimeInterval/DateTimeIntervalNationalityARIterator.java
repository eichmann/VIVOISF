...
public class DateTimeIntervalNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNationalityARIterator.class);
