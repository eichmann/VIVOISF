...
public class DateTimeIntervalNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNationalityITIterator.class);
