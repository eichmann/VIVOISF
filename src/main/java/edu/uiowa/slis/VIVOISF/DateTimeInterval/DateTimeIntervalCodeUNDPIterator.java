...
public class DateTimeIntervalCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCodeUNDPIterator.class);
