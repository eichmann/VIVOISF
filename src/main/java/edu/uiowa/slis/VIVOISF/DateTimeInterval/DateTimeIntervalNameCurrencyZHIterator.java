...
public class DateTimeIntervalNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameCurrencyZHIterator.class);
