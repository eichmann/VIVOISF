...
public class DateTimeIntervalRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalRankIterator.class);
