...
public class DateTimeIntervalLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalLandAreaTotalIterator.class);
