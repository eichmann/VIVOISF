...
public class DateTimeIntervalGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalGDPNotesIterator.class);
