...
public class DateTimeIntervalAgriculturalAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalAgriculturalAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalAgriculturalAreaNotesIterator.class);
