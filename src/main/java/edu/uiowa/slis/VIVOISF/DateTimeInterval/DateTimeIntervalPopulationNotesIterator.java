...
public class DateTimeIntervalPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalPopulationNotesIterator.class);
