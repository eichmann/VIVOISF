...
public class DateTimeIntervalNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameListENIterator.class);
