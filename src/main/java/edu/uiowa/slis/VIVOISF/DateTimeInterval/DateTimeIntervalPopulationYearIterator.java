...
public class DateTimeIntervalPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalPopulationYearIterator.class);
