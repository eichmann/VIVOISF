...
public class DateTimeIntervalNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameCurrencyRUIterator.class);
