...
public class DateTimeIntervalHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalHDIYearIterator.class);
