...
public class DateTimeIntervalNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameCurrencyARIterator.class);
