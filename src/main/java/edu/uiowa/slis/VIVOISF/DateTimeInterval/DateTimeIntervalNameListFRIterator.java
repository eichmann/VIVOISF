...
public class DateTimeIntervalNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameListFRIterator.class);
