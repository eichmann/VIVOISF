...
public class DateTimeIntervalEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalEndIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				end = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
			...
			log.error("Exception raised in DateTimeIntervalEndIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DateTimeIntervalEndIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in DateTimeIntervalEndIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in DateTimeIntervalEndIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in DateTimeIntervalEnd doEndTag", e);
			throw new JspTagException("Exception raised in DateTimeIntervalEnd doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setEnd(String theEnd) {
		end = theEnd;
	}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to DateTimeIntervalEndIterator");
