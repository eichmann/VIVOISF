...
public class DateTimeIntervalHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalHasMinLatitudeIterator.class);
