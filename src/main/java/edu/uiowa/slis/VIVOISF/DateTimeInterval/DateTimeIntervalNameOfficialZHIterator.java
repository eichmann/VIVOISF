...
public class DateTimeIntervalNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameOfficialZHIterator.class);
