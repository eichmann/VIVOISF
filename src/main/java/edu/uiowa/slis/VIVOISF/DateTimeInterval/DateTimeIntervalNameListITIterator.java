...
public class DateTimeIntervalNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameListITIterator.class);
