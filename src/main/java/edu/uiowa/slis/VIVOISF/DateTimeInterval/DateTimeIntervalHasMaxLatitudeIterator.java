...
public class DateTimeIntervalHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalHasMaxLatitudeIterator.class);
