...
public class DateTimeIntervalARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theDateTimeIntervalARG_2000028Iterator.getType());
		} catch (Exception e) {
