...
public class DateTimeIntervalNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameShortARIterator.class);
