...
public class DateTimeIntervalGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalGDPTotalInCurrentPricesIterator.class);
