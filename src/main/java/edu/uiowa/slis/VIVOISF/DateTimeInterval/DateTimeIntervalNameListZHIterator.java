...
public class DateTimeIntervalNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameListZHIterator.class);
