...
public class DateTimeIntervalGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalGDPYearIterator.class);
