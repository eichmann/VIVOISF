...
public class DateTimeIntervalCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCountryAreaYearIterator.class);
