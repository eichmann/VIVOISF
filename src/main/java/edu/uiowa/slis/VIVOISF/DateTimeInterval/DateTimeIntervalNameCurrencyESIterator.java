...
public class DateTimeIntervalNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalNameCurrencyESIterator.class);
