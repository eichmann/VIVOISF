...
public class DateTimeIntervalHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalHDINotesIterator.class);
