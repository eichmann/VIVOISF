...
public class DateTimeIntervalHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalHasMaxLongitudeIterator.class);
