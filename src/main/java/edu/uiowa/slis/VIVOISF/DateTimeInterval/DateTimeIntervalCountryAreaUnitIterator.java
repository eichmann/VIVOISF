...
public class DateTimeIntervalCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static DateTimeIntervalCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(DateTimeIntervalCountryAreaUnitIterator.class);
