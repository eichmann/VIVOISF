...
public class Self_governingGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingGDPNotesIterator.class);
