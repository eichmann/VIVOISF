...
public class Self_governingNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNationalityZHIterator.class);
