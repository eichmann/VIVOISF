...
public class Self_governingAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingAgriculturalAreaTotalIterator.class);
