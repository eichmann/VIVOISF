...
public class Self_governingHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingHasMinLongitudeIterator.class);
