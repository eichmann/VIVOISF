...
public class Self_governingHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingHDITotalIterator.class);
