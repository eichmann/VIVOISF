...
public class Self_governingNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNameCurrencyFRIterator.class);
