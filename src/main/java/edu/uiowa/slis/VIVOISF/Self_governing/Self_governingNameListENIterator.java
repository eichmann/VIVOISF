...
public class Self_governingNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNameListENIterator.class);
