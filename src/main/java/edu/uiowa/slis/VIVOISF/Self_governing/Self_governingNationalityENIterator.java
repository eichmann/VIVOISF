...
public class Self_governingNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNationalityENIterator.class);
