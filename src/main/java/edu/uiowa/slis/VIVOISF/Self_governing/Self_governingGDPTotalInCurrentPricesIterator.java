...
public class Self_governingGDPTotalInCurrentPricesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingGDPTotalInCurrentPricesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingGDPTotalInCurrentPricesIterator.class);
