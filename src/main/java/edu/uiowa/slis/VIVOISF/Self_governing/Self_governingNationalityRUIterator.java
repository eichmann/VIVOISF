...
public class Self_governingNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNationalityRUIterator.class);
