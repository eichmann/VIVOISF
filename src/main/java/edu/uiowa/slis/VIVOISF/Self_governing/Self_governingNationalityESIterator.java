...
public class Self_governingNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNationalityESIterator.class);
