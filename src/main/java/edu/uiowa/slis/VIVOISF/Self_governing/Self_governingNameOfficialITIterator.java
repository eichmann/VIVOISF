...
public class Self_governingNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNameOfficialITIterator.class);
