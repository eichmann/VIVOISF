...
public class Self_governingCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingCountryAreaNotesIterator.class);
