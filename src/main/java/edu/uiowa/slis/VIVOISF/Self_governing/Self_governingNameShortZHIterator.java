...
public class Self_governingNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNameShortZHIterator.class);
