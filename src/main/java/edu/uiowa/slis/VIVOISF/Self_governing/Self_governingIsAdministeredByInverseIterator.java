	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			while(rs.hasNext()) {
				...
				isAdministeredByInverse = sol.get("?s").isLiteral() ? sol.get("?s").asLiteral().getString() : sol.get("?s").toString();
...
//					continue;
	...
	public void setIsAdministeredByInverse(String theIsAdministeredByInverse) {
		isAdministeredByInverse = theIsAdministeredByInverse;
	}
