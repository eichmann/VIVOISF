...
public class Self_governingNameCurrencyZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNameCurrencyZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNameCurrencyZHIterator.class);
