...
public class Self_governingNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNationalityFRIterator.class);
