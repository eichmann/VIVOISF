...
public class Self_governingPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingPopulationUnitIterator.class);
