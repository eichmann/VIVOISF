...
public class Self_governingCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingCountryAreaUnitIterator.class);
