...
public class Self_governingCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingCodeISO2Iterator.class);
