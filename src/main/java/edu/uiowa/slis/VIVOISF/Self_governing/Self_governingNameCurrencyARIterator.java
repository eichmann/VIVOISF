...
public class Self_governingNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNameCurrencyARIterator.class);
