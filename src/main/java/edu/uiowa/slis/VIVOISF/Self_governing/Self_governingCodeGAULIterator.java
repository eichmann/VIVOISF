...
public class Self_governingCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingCodeGAULIterator.class);
