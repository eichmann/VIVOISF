...
public class Self_governingGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingGDPUnitIterator.class);
