...
public class Self_governingCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingCodeCurrencyIterator.class);
