...
public class Self_governingCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingCountryAreaYearIterator.class);
