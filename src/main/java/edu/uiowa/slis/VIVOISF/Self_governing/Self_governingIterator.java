...
public class Self_governingIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://aims.fao.org/aos/geopolitical.owl#self_governing> . "+
