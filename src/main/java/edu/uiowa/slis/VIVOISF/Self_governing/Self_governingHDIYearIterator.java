...
public class Self_governingHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingHDIYearIterator.class);
