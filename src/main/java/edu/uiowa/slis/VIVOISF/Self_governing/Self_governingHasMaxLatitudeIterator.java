...
public class Self_governingHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingHasMaxLatitudeIterator.class);
