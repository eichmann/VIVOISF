...
public class Self_governingNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNameOfficialRUIterator.class);
