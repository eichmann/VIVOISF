...
public class Self_governingLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingLandAreaTotalIterator.class);
