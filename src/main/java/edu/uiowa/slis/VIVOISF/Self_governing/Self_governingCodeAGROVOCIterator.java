...
public class Self_governingCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingCodeAGROVOCIterator.class);
