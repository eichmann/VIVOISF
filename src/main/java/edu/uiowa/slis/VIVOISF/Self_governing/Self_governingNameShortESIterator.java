...
public class Self_governingNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static Self_governingNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(Self_governingNameShortESIterator.class);
