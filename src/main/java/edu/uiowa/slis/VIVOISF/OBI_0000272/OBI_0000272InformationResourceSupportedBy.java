...
public class OBI_0000272InformationResourceSupportedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272InformationResourceSupportedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272InformationResourceSupportedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272InformationResourceSupportedByIterator.getInformationResourceSupportedBy());
		} catch (Exception e) {
