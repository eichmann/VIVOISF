...
public class OBI_0000272PmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272PmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272PmidIterator.class);
