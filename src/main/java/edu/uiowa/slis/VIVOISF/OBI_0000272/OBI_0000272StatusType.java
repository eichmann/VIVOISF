...
public class OBI_0000272StatusType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272StatusType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272StatusType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272StatusIterator.getType());
		} catch (Exception e) {
