...
public class OBI_0000272UriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272UriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272UriIterator.class);
