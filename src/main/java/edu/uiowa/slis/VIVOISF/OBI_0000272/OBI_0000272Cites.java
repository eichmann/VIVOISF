...
public class OBI_0000272Cites extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272Cites currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272Cites.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272CitesIterator.getCites());
		} catch (Exception e) {
