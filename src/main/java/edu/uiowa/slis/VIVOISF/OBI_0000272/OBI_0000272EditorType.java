...
public class OBI_0000272EditorType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272EditorType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272EditorType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272EditorIterator.getType());
		} catch (Exception e) {
