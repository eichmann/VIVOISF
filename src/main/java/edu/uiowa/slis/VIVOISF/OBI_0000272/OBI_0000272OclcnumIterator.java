...
public class OBI_0000272OclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272OclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272OclcnumIterator.class);
