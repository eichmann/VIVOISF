...
public class OBI_0000272ERO_0000460 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272ERO_0000460 currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272ERO_0000460.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272ERO_0000460Iterator.getERO_0000460());
		} catch (Exception e) {
