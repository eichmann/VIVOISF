...
public class OBI_0000272NumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272NumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272NumberIterator.class);
