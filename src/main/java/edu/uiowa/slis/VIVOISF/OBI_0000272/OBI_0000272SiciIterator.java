...
public class OBI_0000272SiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272SiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272SiciIterator.class);
