...
public class OBI_0000272FeaturesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272FeaturesType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272FeaturesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272FeaturesIterator.getType());
		} catch (Exception e) {
