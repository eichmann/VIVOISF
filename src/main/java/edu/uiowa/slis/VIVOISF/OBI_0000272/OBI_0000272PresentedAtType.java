...
public class OBI_0000272PresentedAtType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272PresentedAtType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272PresentedAtType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272PresentedAtIterator.getType());
		} catch (Exception e) {
