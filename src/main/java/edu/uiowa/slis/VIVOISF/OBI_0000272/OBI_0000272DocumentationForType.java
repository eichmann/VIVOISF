...
public class OBI_0000272DocumentationForType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272DocumentationForType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272DocumentationForType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272DocumentationForIterator.getType());
		} catch (Exception e) {
