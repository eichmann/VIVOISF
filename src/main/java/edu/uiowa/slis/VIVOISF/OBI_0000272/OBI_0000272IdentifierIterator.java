...
public class OBI_0000272IdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272IdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272IdentifierIterator.class);
