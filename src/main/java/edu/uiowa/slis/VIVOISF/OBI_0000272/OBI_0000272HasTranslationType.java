...
public class OBI_0000272HasTranslationType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272HasTranslationType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272HasTranslationType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272HasTranslationIterator.getType());
		} catch (Exception e) {
