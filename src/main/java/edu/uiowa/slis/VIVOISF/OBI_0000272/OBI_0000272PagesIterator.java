...
public class OBI_0000272PagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272PagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272PagesIterator.class);
