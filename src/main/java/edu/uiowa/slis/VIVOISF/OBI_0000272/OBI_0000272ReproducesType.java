...
public class OBI_0000272ReproducesType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272ReproducesType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272ReproducesType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272ReproducesIterator.getType());
		} catch (Exception e) {
