...
public class OBI_0000272Eanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272Eanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272Eanucc13Iterator.class);
