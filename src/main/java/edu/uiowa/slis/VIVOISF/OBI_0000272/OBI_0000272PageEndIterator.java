...
public class OBI_0000272PageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272PageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272PageEndIterator.class);
