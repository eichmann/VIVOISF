...
public class OBI_0000272PageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272PageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272PageStartIterator.class);
