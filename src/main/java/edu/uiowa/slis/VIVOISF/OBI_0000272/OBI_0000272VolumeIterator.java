...
public class OBI_0000272VolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272VolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272VolumeIterator.class);
