...
public class OBI_0000272ReproducedInType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272ReproducedInType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272ReproducedInType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272ReproducedInIterator.getType());
		} catch (Exception e) {
