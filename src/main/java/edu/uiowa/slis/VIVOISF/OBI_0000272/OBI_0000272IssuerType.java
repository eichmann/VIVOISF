...
public class OBI_0000272IssuerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272IssuerType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272IssuerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272IssuerIterator.getType());
		} catch (Exception e) {
