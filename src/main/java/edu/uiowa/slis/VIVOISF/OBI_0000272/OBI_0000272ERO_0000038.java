...
public class OBI_0000272ERO_0000038 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272ERO_0000038 currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272ERO_0000038.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272ERO_0000038Iterator.getERO_0000038());
		} catch (Exception e) {
