...
public class OBI_0000272Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272Iterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?l where { "+
						"?s rdf:type <http://purl.obolibrary.org/obo/OBI_0000272> . "+
