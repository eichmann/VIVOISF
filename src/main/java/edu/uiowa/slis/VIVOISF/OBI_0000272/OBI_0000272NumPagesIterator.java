...
public class OBI_0000272NumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272NumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272NumPagesIterator.class);
