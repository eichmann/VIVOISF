...
public class OBI_0000272ContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272ContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272ContentIterator.class);
