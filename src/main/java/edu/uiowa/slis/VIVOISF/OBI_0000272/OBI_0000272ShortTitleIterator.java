...
public class OBI_0000272ShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272ShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272ShortTitleIterator.class);
