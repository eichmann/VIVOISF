...
public class OBI_0000272LocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272LocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272LocatorIterator.class);
