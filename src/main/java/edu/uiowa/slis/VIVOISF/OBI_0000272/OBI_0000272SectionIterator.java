...
public class OBI_0000272SectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272SectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272SectionIterator.class);
