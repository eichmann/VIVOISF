...
public class OBI_0000272ERO_0000070 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272ERO_0000070 currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272ERO_0000070.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272ERO_0000070Iterator.getERO_0000070());
		} catch (Exception e) {
