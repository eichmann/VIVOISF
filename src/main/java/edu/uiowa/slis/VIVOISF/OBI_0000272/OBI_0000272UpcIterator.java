...
public class OBI_0000272UpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272UpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272UpcIterator.class);
