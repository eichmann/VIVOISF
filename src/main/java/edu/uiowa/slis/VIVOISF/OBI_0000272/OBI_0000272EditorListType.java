...
public class OBI_0000272EditorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272EditorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272EditorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272EditorListIterator.getType());
		} catch (Exception e) {
