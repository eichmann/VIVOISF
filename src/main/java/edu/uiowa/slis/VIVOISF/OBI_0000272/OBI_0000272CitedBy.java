...
public class OBI_0000272CitedBy extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272CitedBy currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272CitedBy.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272CitedByIterator.getCitedBy());
		} catch (Exception e) {
