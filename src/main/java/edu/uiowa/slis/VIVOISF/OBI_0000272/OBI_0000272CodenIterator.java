...
public class OBI_0000272CodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272CodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272CodenIterator.class);
