...
public class OBI_0000272TheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272TheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272TheAbstractIterator.class);
