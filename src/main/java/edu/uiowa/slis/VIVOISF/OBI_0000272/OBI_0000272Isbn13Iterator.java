...
public class OBI_0000272Isbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272Isbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272Isbn13Iterator.class);
