...
public class OBI_0000272Owner extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272Owner currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272Owner.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272OwnerIterator.getOwner());
		} catch (Exception e) {
