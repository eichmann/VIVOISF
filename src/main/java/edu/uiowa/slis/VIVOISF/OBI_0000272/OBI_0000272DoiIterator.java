...
public class OBI_0000272DoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272DoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272DoiIterator.class);
