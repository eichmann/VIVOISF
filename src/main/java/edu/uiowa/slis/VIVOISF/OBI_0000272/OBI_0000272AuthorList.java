...
public class OBI_0000272AuthorList extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272AuthorList currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272AuthorList.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272AuthorListIterator.getAuthorList());
		} catch (Exception e) {
