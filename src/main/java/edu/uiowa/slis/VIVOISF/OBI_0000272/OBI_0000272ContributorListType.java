...
public class OBI_0000272ContributorListType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272ContributorListType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272ContributorListType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272ContributorListIterator.getType());
		} catch (Exception e) {
