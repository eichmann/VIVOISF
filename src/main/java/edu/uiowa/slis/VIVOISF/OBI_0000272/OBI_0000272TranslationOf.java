...
public class OBI_0000272TranslationOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272TranslationOf currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272TranslationOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272TranslationOfIterator.getTranslationOf());
		} catch (Exception e) {
