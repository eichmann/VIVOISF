...
public class OBI_0000272Isbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272Isbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272Isbn10Iterator.class);
