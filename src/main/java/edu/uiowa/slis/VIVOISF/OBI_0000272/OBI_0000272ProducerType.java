...
public class OBI_0000272ProducerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272ProducerType currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272ProducerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272ProducerIterator.getType());
		} catch (Exception e) {
