...
public class OBI_0000272LccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272LccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272LccnIterator.class);
