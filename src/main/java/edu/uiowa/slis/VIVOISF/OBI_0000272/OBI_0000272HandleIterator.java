...
public class OBI_0000272HandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272HandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272HandleIterator.class);
