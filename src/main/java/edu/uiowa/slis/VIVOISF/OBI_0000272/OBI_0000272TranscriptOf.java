...
public class OBI_0000272TranscriptOf extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272TranscriptOf currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272TranscriptOf.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theOBI_0000272TranscriptOfIterator.getTranscriptOf());
		} catch (Exception e) {
