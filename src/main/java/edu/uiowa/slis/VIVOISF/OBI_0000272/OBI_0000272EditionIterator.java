...
public class OBI_0000272EditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static OBI_0000272EditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OBI_0000272EditionIterator.class);
