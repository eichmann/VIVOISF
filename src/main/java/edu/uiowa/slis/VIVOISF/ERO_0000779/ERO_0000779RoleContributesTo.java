...
public class ERO_0000779RoleContributesTo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000779RoleContributesTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000779RoleContributesTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000779RoleContributesToIterator.getRoleContributesTo());
		} catch (Exception e) {
