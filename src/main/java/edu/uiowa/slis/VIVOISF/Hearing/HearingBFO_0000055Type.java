...
public class HearingBFO_0000055Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static HearingBFO_0000055Type currentInstance = null;
	private static final Log log = LogFactory.getLog(HearingBFO_0000055Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theHearingBFO_0000055Iterator.getType());
		} catch (Exception e) {
