...
public class GeographicalHasGeoIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicalHasGeoIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicalHasGeoIterator.class);
...
//					continue;
			...
			log.error("Exception raised in GeographicalHasGeoIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in GeographicalHasGeoIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in GeographicalHasGeoIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in GeographicalHasGeoIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in GeographicalHasGeo doEndTag", e);
			throw new JspTagException("Exception raised in GeographicalHasGeo doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to GeographicalHasGeoIterator");
