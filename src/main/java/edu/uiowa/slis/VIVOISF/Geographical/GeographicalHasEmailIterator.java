...
public class GeographicalHasEmailIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static GeographicalHasEmailIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GeographicalHasEmailIterator.class);
...
//					continue;
			...
			log.error("Exception raised in GeographicalHasEmailIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in GeographicalHasEmailIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in GeographicalHasEmailIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in GeographicalHasEmailIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in GeographicalHasEmail doEndTag", e);
			throw new JspTagException("Exception raised in GeographicalHasEmail doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to GeographicalHasEmailIterator");
