...
public class ImageNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageNumberIterator.class);
