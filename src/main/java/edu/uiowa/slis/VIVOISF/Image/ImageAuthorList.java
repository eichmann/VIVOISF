...
public class ImageAuthorList extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageAuthorList currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageAuthorList.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theImageAuthorListIterator.getAuthorList());
		} catch (Exception e) {
