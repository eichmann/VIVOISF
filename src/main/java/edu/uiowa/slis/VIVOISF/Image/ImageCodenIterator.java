...
public class ImageCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageCodenIterator.class);
