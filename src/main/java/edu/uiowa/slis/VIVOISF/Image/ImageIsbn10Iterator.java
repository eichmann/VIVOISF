...
public class ImageIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageIsbn10Iterator.class);
