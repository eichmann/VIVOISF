...
public class ImageLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageLocatorIterator.class);
