...
public class ImageIAO_0000136 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageIAO_0000136 currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageIAO_0000136.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theImageIAO_0000136Iterator.getIAO_0000136());
		} catch (Exception e) {
