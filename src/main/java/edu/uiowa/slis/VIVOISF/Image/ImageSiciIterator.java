...
public class ImageSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageSiciIterator.class);
