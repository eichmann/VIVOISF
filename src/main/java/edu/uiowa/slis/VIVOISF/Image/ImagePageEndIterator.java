...
public class ImagePageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImagePageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImagePageEndIterator.class);
