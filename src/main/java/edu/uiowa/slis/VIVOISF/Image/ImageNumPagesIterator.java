...
public class ImageNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageNumPagesIterator.class);
