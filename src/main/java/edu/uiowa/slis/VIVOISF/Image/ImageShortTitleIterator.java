...
public class ImageShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageShortTitleIterator.class);
