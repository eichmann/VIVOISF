...
public class ImageTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageTheAbstractIterator.class);
