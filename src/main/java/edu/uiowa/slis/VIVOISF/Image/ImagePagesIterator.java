...
public class ImagePagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImagePagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImagePagesIterator.class);
