...
public class ImageIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageIsbn13Iterator.class);
