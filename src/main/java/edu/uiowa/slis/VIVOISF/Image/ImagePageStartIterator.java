...
public class ImagePageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImagePageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImagePageStartIterator.class);
