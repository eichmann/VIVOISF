...
public class ImageAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageAsinIterator.class);
