...
public class ImageEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageEanucc13Iterator.class);
