...
public class ImageHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageHandleIterator.class);
