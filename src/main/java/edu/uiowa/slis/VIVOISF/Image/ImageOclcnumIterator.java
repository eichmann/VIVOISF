...
public class ImageOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageOclcnumIterator.class);
