...
public class ImageUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageUriIterator.class);
