...
public class ImageERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageERO_0000045Iterator.class);
