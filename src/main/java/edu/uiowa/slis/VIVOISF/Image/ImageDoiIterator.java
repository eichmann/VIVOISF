...
public class ImageDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageDoiIterator.class);
