...
public class ImageRO_0000056Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageRO_0000056Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageRO_0000056Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theImageRO_0000056Iterator.getType());
		} catch (Exception e) {
