...
public class ImageLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageLccnIterator.class);
