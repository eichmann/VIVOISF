...
public class ImageARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageARG_0000001Iterator.class);
