...
public class ImagePmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImagePmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImagePmidIterator.class);
