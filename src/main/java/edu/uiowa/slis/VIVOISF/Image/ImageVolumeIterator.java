...
public class ImageVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageVolumeIterator.class);
