...
public class ImageSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageSectionIterator.class);
