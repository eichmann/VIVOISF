...
public class ImageReviewOfType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ImageReviewOfType currentInstance = null;
	private static final Log log = LogFactory.getLog(ImageReviewOfType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theImageReviewOfIterator.getType());
		} catch (Exception e) {
