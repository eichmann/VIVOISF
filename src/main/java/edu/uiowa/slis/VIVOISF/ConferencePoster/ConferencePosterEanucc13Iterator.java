...
public class ConferencePosterEanucc13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterEanucc13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterEanucc13Iterator.class);
