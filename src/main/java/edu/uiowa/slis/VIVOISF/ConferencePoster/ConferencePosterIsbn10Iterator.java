...
public class ConferencePosterIsbn10Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterIsbn10Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterIsbn10Iterator.class);
