...
public class ConferencePosterOclcnumIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterOclcnumIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterOclcnumIterator.class);
