...
public class ConferencePosterPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterPopulationYearIterator.class);
