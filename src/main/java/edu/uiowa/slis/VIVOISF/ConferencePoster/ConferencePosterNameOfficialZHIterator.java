...
public class ConferencePosterNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameOfficialZHIterator.class);
