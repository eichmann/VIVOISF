...
public class ConferencePosterNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameShortENIterator.class);
