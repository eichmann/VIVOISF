...
public class ConferencePosterNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameCurrencyARIterator.class);
