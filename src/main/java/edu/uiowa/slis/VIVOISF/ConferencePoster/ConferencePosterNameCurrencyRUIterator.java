...
public class ConferencePosterNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameCurrencyRUIterator.class);
