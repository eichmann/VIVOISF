...
public class ConferencePosterNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameListITIterator.class);
