...
public class ConferencePosterBFO_0000050Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterBFO_0000050Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterBFO_0000050Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePosterBFO_0000050Iterator.getType());
		} catch (Exception e) {
