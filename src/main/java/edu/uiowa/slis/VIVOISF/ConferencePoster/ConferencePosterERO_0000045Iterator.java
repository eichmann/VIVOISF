...
public class ConferencePosterERO_0000045Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterERO_0000045Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterERO_0000045Iterator.class);
