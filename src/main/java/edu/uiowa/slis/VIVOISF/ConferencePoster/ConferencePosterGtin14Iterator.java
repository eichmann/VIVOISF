...
public class ConferencePosterGtin14Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterGtin14Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterGtin14Iterator.class);
