...
public class ConferencePosterNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameListRUIterator.class);
