...
public class ConferencePosterHandleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterHandleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterHandleIterator.class);
