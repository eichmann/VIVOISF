...
public class ConferencePosterStatus extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterStatus currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterStatus.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePosterStatusIterator.getStatus());
		} catch (Exception e) {
