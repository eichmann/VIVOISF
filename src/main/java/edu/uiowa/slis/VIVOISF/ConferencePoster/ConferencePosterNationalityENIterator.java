...
public class ConferencePosterNationalityENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNationalityENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNationalityENIterator.class);
