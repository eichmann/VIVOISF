...
public class ConferencePosterSiciIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterSiciIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterSiciIterator.class);
