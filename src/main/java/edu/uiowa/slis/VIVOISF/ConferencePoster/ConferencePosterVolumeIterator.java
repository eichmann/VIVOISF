...
public class ConferencePosterVolumeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterVolumeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterVolumeIterator.class);
