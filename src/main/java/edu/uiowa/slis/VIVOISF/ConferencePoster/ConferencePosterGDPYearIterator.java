...
public class ConferencePosterGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterGDPYearIterator.class);
