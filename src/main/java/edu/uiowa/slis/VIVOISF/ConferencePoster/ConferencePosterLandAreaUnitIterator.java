...
public class ConferencePosterLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterLandAreaUnitIterator.class);
