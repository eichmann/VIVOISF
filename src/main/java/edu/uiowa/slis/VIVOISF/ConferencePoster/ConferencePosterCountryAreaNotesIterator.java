...
public class ConferencePosterCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCountryAreaNotesIterator.class);
