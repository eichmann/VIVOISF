...
public class ConferencePosterNameListESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameListESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameListESIterator.class);
