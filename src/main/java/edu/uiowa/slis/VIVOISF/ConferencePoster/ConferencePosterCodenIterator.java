...
public class ConferencePosterCodenIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCodenIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCodenIterator.class);
