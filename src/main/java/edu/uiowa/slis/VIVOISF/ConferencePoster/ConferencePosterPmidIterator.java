...
public class ConferencePosterPmidIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterPmidIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterPmidIterator.class);
