...
public class ConferencePosterHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterHasMaxLongitudeIterator.class);
