...
public class ConferencePosterRO_0001015Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterRO_0001015Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterRO_0001015Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePosterRO_0001015Iterator.getType());
		} catch (Exception e) {
