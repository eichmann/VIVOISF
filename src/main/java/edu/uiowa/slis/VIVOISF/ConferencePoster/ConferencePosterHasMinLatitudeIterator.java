...
public class ConferencePosterHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterHasMinLatitudeIterator.class);
