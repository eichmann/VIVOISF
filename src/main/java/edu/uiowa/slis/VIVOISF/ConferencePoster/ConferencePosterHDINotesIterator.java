...
public class ConferencePosterHDINotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterHDINotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterHDINotesIterator.class);
