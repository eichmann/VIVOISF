...
public class ConferencePosterNameListZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameListZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameListZHIterator.class);
