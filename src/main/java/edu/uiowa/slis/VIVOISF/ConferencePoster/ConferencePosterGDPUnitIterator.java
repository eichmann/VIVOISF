...
public class ConferencePosterGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterGDPUnitIterator.class);
