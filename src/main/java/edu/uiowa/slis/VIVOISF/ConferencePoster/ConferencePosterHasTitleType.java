...
public class ConferencePosterHasTitleType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterHasTitleType currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterHasTitleType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePosterHasTitleIterator.getType());
		} catch (Exception e) {
