...
public class ConferencePosterHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterHasMinLongitudeIterator.class);
