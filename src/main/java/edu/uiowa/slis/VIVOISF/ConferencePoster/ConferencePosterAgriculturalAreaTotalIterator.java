...
public class ConferencePosterAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterAgriculturalAreaTotalIterator.class);
