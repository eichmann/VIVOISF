...
public class ConferencePosterNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameOfficialENIterator.class);
