...
public class ConferencePosterCodeUNIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCodeUNIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCodeUNIterator.class);
