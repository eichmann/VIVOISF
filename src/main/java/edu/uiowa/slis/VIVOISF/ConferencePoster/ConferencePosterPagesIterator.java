...
public class ConferencePosterPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterPagesIterator.class);
