...
public class ConferencePosterCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCodeFAOTERMIterator.class);
