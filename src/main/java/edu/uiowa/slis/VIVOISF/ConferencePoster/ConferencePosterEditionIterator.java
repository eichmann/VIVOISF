...
public class ConferencePosterEditionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterEditionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterEditionIterator.class);
