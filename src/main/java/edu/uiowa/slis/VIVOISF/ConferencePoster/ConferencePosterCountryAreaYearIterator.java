...
public class ConferencePosterCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCountryAreaYearIterator.class);
