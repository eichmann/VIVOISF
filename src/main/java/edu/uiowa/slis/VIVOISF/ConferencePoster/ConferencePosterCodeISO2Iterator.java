...
public class ConferencePosterCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCodeISO2Iterator.class);
