...
public class ConferencePosterNameCurrencyENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameCurrencyENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameCurrencyENIterator.class);
