...
public class ConferencePosterCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCodeUNDPIterator.class);
