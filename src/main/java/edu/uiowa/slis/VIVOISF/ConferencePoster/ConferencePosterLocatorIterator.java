...
public class ConferencePosterLocatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterLocatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterLocatorIterator.class);
