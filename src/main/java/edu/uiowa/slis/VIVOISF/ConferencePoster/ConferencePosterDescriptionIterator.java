...
public class ConferencePosterDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterDescriptionIterator.class);
