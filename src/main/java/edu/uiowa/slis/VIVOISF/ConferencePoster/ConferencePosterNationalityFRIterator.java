...
public class ConferencePosterNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNationalityFRIterator.class);
