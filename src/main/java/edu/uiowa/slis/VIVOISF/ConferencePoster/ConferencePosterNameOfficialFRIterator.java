...
public class ConferencePosterNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameOfficialFRIterator.class);
