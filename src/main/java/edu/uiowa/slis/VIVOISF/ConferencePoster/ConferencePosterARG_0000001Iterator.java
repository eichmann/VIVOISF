...
public class ConferencePosterARG_0000001Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterARG_0000001Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterARG_0000001Iterator.class);
