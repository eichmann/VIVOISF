...
public class ConferencePosterIAO_0000136Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterIAO_0000136Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterIAO_0000136Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePosterIAO_0000136Iterator.getType());
		} catch (Exception e) {
