...
public class ConferencePosterIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://vivoweb.org/ontology/core#ConferencePoster> . "+
