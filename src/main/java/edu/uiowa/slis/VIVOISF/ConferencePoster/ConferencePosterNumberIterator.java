...
public class ConferencePosterNumberIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNumberIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNumberIterator.class);
