...
public class ConferencePosterCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCodeFAOSTATIterator.class);
