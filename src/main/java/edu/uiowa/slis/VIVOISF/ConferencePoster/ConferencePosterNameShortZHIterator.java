...
public class ConferencePosterNameShortZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameShortZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameShortZHIterator.class);
