...
public class ConferencePosterLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterLandAreaTotalIterator.class);
