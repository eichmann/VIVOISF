...
public class ConferencePosterTheAbstractIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterTheAbstractIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterTheAbstractIterator.class);
