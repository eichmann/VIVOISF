...
public class ConferencePosterFreetextKeywordIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterFreetextKeywordIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterFreetextKeywordIterator.class);
