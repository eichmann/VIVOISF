...
public class ConferencePosterAsinIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterAsinIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterAsinIterator.class);
