...
public class ConferencePosterSectionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterSectionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterSectionIterator.class);
