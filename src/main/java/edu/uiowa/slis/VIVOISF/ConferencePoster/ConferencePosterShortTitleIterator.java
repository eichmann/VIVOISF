...
public class ConferencePosterShortTitleIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterShortTitleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterShortTitleIterator.class);
