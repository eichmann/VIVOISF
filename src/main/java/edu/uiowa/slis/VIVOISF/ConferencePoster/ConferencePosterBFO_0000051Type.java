...
public class ConferencePosterBFO_0000051Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterBFO_0000051Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterBFO_0000051Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePosterBFO_0000051Iterator.getType());
		} catch (Exception e) {
