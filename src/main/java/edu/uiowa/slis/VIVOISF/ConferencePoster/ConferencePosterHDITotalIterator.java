...
public class ConferencePosterHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterHDITotalIterator.class);
