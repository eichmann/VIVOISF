...
public class ConferencePosterRO_0002234 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterRO_0002234 currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterRO_0002234.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePosterRO_0002234Iterator.getRO_0002234());
		} catch (Exception e) {
