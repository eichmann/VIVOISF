...
public class ConferencePosterHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterHDIYearIterator.class);
