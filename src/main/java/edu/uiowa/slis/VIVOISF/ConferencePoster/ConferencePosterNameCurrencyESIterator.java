...
public class ConferencePosterNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameCurrencyESIterator.class);
