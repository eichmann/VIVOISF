...
public class ConferencePosterNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameOfficialESIterator.class);
