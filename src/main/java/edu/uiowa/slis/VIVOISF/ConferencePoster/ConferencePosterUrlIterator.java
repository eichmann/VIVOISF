...
public class ConferencePosterUrlIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterUrlIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterUrlIterator.class);
