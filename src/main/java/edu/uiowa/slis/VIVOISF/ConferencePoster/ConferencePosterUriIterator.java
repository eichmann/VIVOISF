...
public class ConferencePosterUriIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterUriIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterUriIterator.class);
