...
public class ConferencePosterRelatesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterRelatesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterRelatesIterator.class);
...
//					continue;
			...
			log.error("Exception raised in ConferencePosterRelatesIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConferencePosterRelatesIterator doStartTag");
		}
...
//					continue;
			...
			log.error("Exception raised in ConferencePosterRelatesIterator doAfterBody", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in ConferencePosterRelatesIterator doAfterBody");
		}
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			log.error("Exception raised in ConferencePosterRelates doEndTag", e);
			throw new JspTagException("Exception raised in ConferencePosterRelates doEndTag");
		} finally {
			clearServiceState();
			freeConnection();
		}
	...
	public void setClassFilter(String filterString) {
		...
		for (String filterClass : classFilterArray) {
			log.info("adding filterClass " + filterClass + " to ConferencePosterRelatesIterator");
