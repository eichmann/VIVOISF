...
public class ConferencePosterIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterIdentifierIterator.class);
