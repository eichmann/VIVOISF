...
public class ConferencePosterNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameCurrencyITIterator.class);
