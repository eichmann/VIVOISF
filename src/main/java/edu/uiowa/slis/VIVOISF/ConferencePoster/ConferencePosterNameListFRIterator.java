...
public class ConferencePosterNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameListFRIterator.class);
