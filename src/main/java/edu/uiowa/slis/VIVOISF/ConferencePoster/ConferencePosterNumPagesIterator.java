...
public class ConferencePosterNumPagesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNumPagesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNumPagesIterator.class);
