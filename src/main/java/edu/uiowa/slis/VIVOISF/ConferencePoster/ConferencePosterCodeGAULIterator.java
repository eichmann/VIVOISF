...
public class ConferencePosterCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCodeGAULIterator.class);
