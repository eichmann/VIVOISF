...
public class ConferencePosterLandAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterLandAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterLandAreaYearIterator.class);
