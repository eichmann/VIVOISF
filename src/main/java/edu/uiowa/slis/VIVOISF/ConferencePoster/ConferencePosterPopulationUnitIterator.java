...
public class ConferencePosterPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterPopulationUnitIterator.class);
