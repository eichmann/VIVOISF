...
public class ConferencePosterCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCountryAreaTotalIterator.class);
