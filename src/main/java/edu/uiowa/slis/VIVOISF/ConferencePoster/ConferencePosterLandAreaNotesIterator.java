...
public class ConferencePosterLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterLandAreaNotesIterator.class);
