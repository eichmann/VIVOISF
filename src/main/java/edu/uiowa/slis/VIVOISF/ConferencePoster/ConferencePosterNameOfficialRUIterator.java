...
public class ConferencePosterNameOfficialRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameOfficialRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameOfficialRUIterator.class);
