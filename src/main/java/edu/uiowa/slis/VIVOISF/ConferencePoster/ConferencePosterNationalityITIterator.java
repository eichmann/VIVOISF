...
public class ConferencePosterNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNationalityITIterator.class);
