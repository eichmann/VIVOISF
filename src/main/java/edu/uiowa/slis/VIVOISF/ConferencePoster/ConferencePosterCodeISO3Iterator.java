...
public class ConferencePosterCodeISO3Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCodeISO3Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCodeISO3Iterator.class);
