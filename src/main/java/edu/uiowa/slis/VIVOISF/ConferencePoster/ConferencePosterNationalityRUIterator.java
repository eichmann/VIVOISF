...
public class ConferencePosterNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNationalityRUIterator.class);
