...
public class ConferencePosterDoiIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterDoiIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterDoiIterator.class);
