...
public class ConferencePosterCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCodeAGROVOCIterator.class);
