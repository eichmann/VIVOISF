...
public class ConferencePosterNameShortARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameShortARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameShortARIterator.class);
