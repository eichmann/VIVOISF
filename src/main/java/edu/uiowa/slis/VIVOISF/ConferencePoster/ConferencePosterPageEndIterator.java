...
public class ConferencePosterPageEndIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterPageEndIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterPageEndIterator.class);
