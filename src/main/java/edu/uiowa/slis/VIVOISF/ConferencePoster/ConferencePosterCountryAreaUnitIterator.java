...
public class ConferencePosterCountryAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCountryAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCountryAreaUnitIterator.class);
