...
public class ConferencePosterOwnerType extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterOwnerType currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterOwnerType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePosterOwnerIterator.getType());
		} catch (Exception e) {
