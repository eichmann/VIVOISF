...
public class ConferencePosterUpcIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterUpcIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterUpcIterator.class);
