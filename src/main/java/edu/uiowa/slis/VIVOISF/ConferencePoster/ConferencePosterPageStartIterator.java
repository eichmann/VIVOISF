...
public class ConferencePosterPageStartIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterPageStartIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterPageStartIterator.class);
