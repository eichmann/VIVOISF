...
public class ConferencePosterContentIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterContentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterContentIterator.class);
