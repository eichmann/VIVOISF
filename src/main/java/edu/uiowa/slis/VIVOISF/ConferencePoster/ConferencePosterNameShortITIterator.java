...
public class ConferencePosterNameShortITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameShortITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameShortITIterator.class);
