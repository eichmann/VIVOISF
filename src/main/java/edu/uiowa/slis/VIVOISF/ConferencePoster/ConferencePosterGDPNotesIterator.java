...
public class ConferencePosterGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterGDPNotesIterator.class);
