...
public class ConferencePosterIsbn13Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterIsbn13Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterIsbn13Iterator.class);
