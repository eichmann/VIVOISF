...
public class ConferencePosterPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterPopulationNotesIterator.class);
