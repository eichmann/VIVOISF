...
public class ConferencePosterRankIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterRankIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterRankIterator.class);
