...
public class ConferencePosterNameShortESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNameShortESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNameShortESIterator.class);
