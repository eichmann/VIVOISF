...
public class ConferencePosterRO_0002353 extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		try {
			ConferencePosterRO_0002353Iterator theConferencePoster = (ConferencePosterRO_0002353Iterator)findAncestorWithClass(this, ConferencePosterRO_0002353Iterator.class);
			pageContext.getOut().print(theConferencePoster.getRO_0002353());
		} catch (Exception e) {
