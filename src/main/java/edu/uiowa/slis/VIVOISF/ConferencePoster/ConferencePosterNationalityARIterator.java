...
public class ConferencePosterNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterNationalityARIterator.class);
