...
public class ConferencePosterHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterHasMaxLatitudeIterator.class);
