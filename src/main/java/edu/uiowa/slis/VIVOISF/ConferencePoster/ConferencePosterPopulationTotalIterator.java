...
public class ConferencePosterPopulationTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterPopulationTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterPopulationTotalIterator.class);
