...
public class ConferencePosterCodeDBPediaIDIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterCodeDBPediaIDIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterCodeDBPediaIDIterator.class);
