...
public class ConferencePosterEditor extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterEditor currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterEditor.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePosterEditorIterator.getEditor());
		} catch (Exception e) {
