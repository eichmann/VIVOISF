...
public class ConferencePosterShortDescriptionIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterShortDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterShortDescriptionIterator.class);
