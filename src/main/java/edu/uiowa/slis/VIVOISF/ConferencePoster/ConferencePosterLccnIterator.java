...
public class ConferencePosterLccnIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterLccnIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterLccnIterator.class);
