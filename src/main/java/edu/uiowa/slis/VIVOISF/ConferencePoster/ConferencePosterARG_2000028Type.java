...
public class ConferencePosterARG_2000028Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ConferencePosterARG_2000028Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ConferencePosterARG_2000028Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theConferencePosterARG_2000028Iterator.getType());
		} catch (Exception e) {
