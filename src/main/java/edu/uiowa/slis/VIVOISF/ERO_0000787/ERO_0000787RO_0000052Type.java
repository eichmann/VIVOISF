...
public class ERO_0000787RO_0000052Type extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000787RO_0000052Type currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000787RO_0000052Type.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000787RO_0000052Iterator.getType());
		} catch (Exception e) {
