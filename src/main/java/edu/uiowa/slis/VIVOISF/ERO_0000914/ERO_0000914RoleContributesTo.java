...
public class ERO_0000914RoleContributesTo extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static ERO_0000914RoleContributesTo currentInstance = null;
	private static final Log log = LogFactory.getLog(ERO_0000914RoleContributesTo.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theERO_0000914RoleContributesToIterator.getRoleContributesTo());
		} catch (Exception e) {
