...
public class AreaNationalityZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNationalityZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNationalityZHIterator.class);
