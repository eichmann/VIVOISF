...
public class AreaLandAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaLandAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaLandAreaTotalIterator.class);
