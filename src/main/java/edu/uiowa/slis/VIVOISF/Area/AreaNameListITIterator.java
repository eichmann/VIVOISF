...
public class AreaNameListITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameListITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameListITIterator.class);
