...
public class AreaAgriculturalAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaAgriculturalAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaAgriculturalAreaUnitIterator.class);
