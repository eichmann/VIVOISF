...
public class AreaSourceIdentifierIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaSourceIdentifierIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaSourceIdentifierIterator.class);
