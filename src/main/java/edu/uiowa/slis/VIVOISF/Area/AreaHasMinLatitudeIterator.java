...
public class AreaHasMinLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaHasMinLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaHasMinLatitudeIterator.class);
