...
public class AreaLandAreaUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaLandAreaUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaLandAreaUnitIterator.class);
