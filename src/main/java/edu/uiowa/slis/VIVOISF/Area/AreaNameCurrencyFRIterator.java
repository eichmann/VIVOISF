...
public class AreaNameCurrencyFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameCurrencyFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameCurrencyFRIterator.class);
