...
public class AreaNationalityARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNationalityARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNationalityARIterator.class);
