...
public class AreaNameCurrencyITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameCurrencyITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameCurrencyITIterator.class);
