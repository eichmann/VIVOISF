...
public class AreaNameShortENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameShortENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameShortENIterator.class);
