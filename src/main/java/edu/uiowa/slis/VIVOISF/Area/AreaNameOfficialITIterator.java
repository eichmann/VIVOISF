...
public class AreaNameOfficialITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameOfficialITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameOfficialITIterator.class);
