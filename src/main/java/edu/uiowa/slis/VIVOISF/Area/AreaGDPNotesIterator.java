...
public class AreaGDPNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaGDPNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaGDPNotesIterator.class);
