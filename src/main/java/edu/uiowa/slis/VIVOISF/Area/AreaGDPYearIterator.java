...
public class AreaGDPYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaGDPYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaGDPYearIterator.class);
