...
public class AreaGDPUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaGDPUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaGDPUnitIterator.class);
