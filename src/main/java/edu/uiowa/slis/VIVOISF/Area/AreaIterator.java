...
public class AreaIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					...
					"  ?s rdf:type <http://aims.fao.org/aos/geopolitical.owl#area> . "+
