...
public class AreaNameOfficialZHIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameOfficialZHIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameOfficialZHIterator.class);
