...
public class AreaLandAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaLandAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaLandAreaNotesIterator.class);
