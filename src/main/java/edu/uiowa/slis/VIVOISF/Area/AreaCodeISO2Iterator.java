...
public class AreaCodeISO2Iterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaCodeISO2Iterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaCodeISO2Iterator.class);
