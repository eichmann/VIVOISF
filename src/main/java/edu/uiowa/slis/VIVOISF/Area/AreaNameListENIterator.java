...
public class AreaNameListENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameListENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameListENIterator.class);
