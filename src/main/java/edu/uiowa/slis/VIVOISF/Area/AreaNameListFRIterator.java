...
public class AreaNameListFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameListFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameListFRIterator.class);
