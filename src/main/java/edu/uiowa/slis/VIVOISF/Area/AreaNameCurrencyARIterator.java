...
public class AreaNameCurrencyARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameCurrencyARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameCurrencyARIterator.class);
