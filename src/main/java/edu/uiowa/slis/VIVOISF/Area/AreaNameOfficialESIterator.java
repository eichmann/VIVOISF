...
public class AreaNameOfficialESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameOfficialESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameOfficialESIterator.class);
