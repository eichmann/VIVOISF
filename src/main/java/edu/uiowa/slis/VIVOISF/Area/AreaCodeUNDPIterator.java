...
public class AreaCodeUNDPIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaCodeUNDPIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaCodeUNDPIterator.class);
