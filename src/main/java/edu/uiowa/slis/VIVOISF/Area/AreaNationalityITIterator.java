...
public class AreaNationalityITIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNationalityITIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNationalityITIterator.class);
