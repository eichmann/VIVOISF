...
public class AreaNationalityESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNationalityESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNationalityESIterator.class);
