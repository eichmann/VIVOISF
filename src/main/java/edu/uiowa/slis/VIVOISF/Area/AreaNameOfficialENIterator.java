...
public class AreaNameOfficialENIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameOfficialENIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameOfficialENIterator.class);
