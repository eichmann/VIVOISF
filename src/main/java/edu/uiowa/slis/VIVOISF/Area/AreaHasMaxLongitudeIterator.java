...
public class AreaHasMaxLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaHasMaxLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaHasMaxLongitudeIterator.class);
