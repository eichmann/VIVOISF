...
public class AreaCountryAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaCountryAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaCountryAreaYearIterator.class);
