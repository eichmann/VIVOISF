...
public class AreaCodeGAULIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaCodeGAULIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaCodeGAULIterator.class);
