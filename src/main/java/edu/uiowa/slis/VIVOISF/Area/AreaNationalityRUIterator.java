...
public class AreaNationalityRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNationalityRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNationalityRUIterator.class);
