...
public class AreaCodeCurrencyIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaCodeCurrencyIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaCodeCurrencyIterator.class);
