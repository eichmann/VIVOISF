...
public class AreaNameListRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameListRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameListRUIterator.class);
