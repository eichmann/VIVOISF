...
public class AreaPopulationNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaPopulationNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaPopulationNotesIterator.class);
