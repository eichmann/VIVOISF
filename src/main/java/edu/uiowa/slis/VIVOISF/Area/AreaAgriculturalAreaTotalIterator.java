...
public class AreaAgriculturalAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaAgriculturalAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaAgriculturalAreaTotalIterator.class);
