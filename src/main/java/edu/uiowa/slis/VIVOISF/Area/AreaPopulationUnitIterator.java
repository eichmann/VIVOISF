...
public class AreaPopulationUnitIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaPopulationUnitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaPopulationUnitIterator.class);
