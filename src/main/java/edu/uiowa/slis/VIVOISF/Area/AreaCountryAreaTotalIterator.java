...
public class AreaCountryAreaTotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaCountryAreaTotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaCountryAreaTotalIterator.class);
