...
public class AreaNameOfficialFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameOfficialFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameOfficialFRIterator.class);
