...
public class AreaNameOfficialARIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameOfficialARIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameOfficialARIterator.class);
