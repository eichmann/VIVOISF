...
public class AreaNameCurrencyESIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameCurrencyESIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameCurrencyESIterator.class);
