...
public class AreaHDIYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaHDIYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaHDIYearIterator.class);
