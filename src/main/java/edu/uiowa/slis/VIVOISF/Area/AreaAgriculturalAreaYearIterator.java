...
public class AreaAgriculturalAreaYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaAgriculturalAreaYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaAgriculturalAreaYearIterator.class);
