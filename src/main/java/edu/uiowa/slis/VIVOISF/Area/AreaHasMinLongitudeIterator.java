...
public class AreaHasMinLongitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaHasMinLongitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaHasMinLongitudeIterator.class);
