...
public class AreaSourceCreatorIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaSourceCreatorIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaSourceCreatorIterator.class);
