...
public class AreaHDITotalIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaHDITotalIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaHDITotalIterator.class);
