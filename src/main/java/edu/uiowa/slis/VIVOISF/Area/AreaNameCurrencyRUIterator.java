...
public class AreaNameCurrencyRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameCurrencyRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameCurrencyRUIterator.class);
