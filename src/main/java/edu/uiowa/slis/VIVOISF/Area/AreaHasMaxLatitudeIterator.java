...
public class AreaHasMaxLatitudeIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaHasMaxLatitudeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaHasMaxLatitudeIterator.class);
