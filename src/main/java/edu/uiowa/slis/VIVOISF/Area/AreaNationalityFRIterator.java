...
public class AreaNationalityFRIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNationalityFRIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNationalityFRIterator.class);
