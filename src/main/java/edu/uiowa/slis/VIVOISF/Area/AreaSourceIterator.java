...
public class AreaSourceIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaSourceIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaSourceIterator.class);
