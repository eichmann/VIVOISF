...
public class AreaPopulationYearIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaPopulationYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaPopulationYearIterator.class);
