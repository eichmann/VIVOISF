...
public class AreaCodeAGROVOCIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaCodeAGROVOCIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaCodeAGROVOCIterator.class);
