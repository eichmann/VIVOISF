...
public class AreaNameShortRUIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaNameShortRUIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaNameShortRUIterator.class);
