...
public class AreaCodeFAOTERMIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaCodeFAOTERMIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaCodeFAOTERMIterator.class);
