...
public class AreaCodeFAOSTATIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaCodeFAOSTATIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaCodeFAOSTATIterator.class);
