...
public class AreaCountryAreaNotesIterator extends edu.uiowa.slis.VIVOISF.TagLibSupport {
	static AreaCountryAreaNotesIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AreaCountryAreaNotesIterator.class);
